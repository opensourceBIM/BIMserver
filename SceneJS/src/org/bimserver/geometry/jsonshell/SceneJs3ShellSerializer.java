...
public class SceneJs3ShellSerializer extends AbstractGeometrySerializer {
	private static final Logger LOGGER = LoggerFactory.getLogger(SceneJs3ShellSerializer.class);
	...
	private void writeVisualScenes(JsonWriter jsonWriter) throws IOException {
		...
		if (Double.isInfinite(extentsDiff[2]))
			extentsDiff[2] = 50.0f;
		double extentsDiffLength = Math.sqrt((double) (extentsDiff[0] * extentsDiff[0] + extentsDiff[1] * extentsDiff[1] + extentsDiff[2] * extentsDiff[2]));
