...
public class ExploderActivity extends Activity {
	...
	@Override
	public void newLogAction(SLogAction logAction, String serviceName, String profileIdentifier, SToken token, String apiUrl) throws UserException, ServerException {
