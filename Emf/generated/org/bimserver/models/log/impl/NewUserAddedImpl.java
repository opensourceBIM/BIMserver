...
public class NewUserAddedImpl extends LogActionImpl implements NewUserAdded {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.NEW_USER_ADDED;
	}
	 ...
	 */
	public User getUser() {
		return (User) eGet(Ifc2x3tc1Package.Literals.NEW_USER_ADDED__USER, true);
	}
	...
	public void setUser(User newUser) {
		eSet(Ifc2x3tc1Package.Literals.NEW_USER_ADDED__USER, newUser);
	}
