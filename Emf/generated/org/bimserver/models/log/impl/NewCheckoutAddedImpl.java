...
public class NewCheckoutAddedImpl extends LogActionImpl implements NewCheckoutAdded {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.NEW_CHECKOUT_ADDED;
	}
	...
	public Checkout getCheckout() {
		return (Checkout) eGet(Ifc2x3tc1Package.Literals.NEW_CHECKOUT_ADDED__CHECKOUT, true);
	}
	...
	public void setCheckout(Checkout newCheckout) {
		eSet(Ifc2x3tc1Package.Literals.NEW_CHECKOUT_ADDED__CHECKOUT, newCheckout);
	}
