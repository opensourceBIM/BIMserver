...
public class RevisionBranchedImpl extends LogActionImpl implements RevisionBranched {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.REVISION_BRANCHED;
	}
	...
	public Revision getOldrevision() {
		return (Revision) eGet(Ifc2x3tc1Package.Literals.REVISION_BRANCHED__OLDREVISION, true);
	}
	...
	public void setOldrevision(Revision newOldrevision) {
		eSet(Ifc2x3tc1Package.Literals.REVISION_BRANCHED__OLDREVISION, newOldrevision);
	}
	...
	public Revision getNewrevision() {
		return (Revision) eGet(Ifc2x3tc1Package.Literals.REVISION_BRANCHED__NEWREVISION, true);
	}
	...
	public void setNewrevision(Revision newNewrevision) {
		eSet(Ifc2x3tc1Package.Literals.REVISION_BRANCHED__NEWREVISION, newNewrevision);
	}
