...
public class ClashDetectionSettingsUpdatedImpl extends LogActionImpl implements ClashDetectionSettingsUpdated {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.CLASH_DETECTION_SETTINGS_UPDATED;
	}
	...
	public ClashDetectionSettings getClashDetectionSettings() {
		return (ClashDetectionSettings) eGet(Ifc2x3tc1Package.Literals.CLASH_DETECTION_SETTINGS_UPDATED__CLASH_DETECTION_SETTINGS, true);
	}
	...
	public void setClashDetectionSettings(ClashDetectionSettings newClashDetectionSettings) {
		eSet(Ifc2x3tc1Package.Literals.CLASH_DETECTION_SETTINGS_UPDATED__CLASH_DETECTION_SETTINGS, newClashDetectionSettings);
	}
