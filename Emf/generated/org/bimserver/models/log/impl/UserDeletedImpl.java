...
public class UserDeletedImpl extends LogActionImpl implements UserDeleted {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.USER_DELETED;
	}
	 ...
	 */
	public User getUser() {
		return (User) eGet(Ifc2x3tc1Package.Literals.USER_DELETED__USER, true);
	}
	...
	public void setUser(User newUser) {
		eSet(Ifc2x3tc1Package.Literals.USER_DELETED__USER, newUser);
	}
