...
public class PasswordChangedImpl extends LogActionImpl implements PasswordChanged {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.PASSWORD_CHANGED;
	}
	 ...
	 */
	public User getUser() {
		return (User) eGet(Ifc2x3tc1Package.Literals.PASSWORD_CHANGED__USER, true);
	}
	...
	public void setUser(User newUser) {
		eSet(Ifc2x3tc1Package.Literals.PASSWORD_CHANGED__USER, newUser);
	}
