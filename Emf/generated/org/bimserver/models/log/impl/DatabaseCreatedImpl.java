...
public class DatabaseCreatedImpl extends LogActionImpl implements DatabaseCreated {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.DATABASE_CREATED;
	}
	...
	public String getPath() {
		return (String) eGet(Ifc2x3tc1Package.Literals.DATABASE_CREATED__PATH, true);
	}
	...
	public void setPath(String newPath) {
		eSet(Ifc2x3tc1Package.Literals.DATABASE_CREATED__PATH, newPath);
	}
	...
	public Integer getVersion() {
		return (Integer) eGet(Ifc2x3tc1Package.Literals.DATABASE_CREATED__VERSION, true);
	}
	...
	public void setVersion(Integer newVersion) {
		eSet(Ifc2x3tc1Package.Literals.DATABASE_CREATED__VERSION, newVersion);
	}
