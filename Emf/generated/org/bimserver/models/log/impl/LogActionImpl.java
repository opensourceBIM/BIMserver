...
public class LogActionImpl extends IdEObjectImpl implements LogAction {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.LOG_ACTION;
	}
	 ...
	 */
	public Date getDate() {
		return (Date) eGet(Ifc2x3tc1Package.Literals.LOG_ACTION__DATE, true);
	}
	...
	public void setDate(Date newDate) {
		eSet(Ifc2x3tc1Package.Literals.LOG_ACTION__DATE, newDate);
	}
	...
	public User getExecutor() {
		return (User) eGet(Ifc2x3tc1Package.Literals.LOG_ACTION__EXECUTOR, true);
	}
	...
	public void setExecutor(User newExecutor) {
		eSet(Ifc2x3tc1Package.Literals.LOG_ACTION__EXECUTOR, newExecutor);
	}
	...
	public AccessMethod getAccessMethod() {
		return (AccessMethod) eGet(Ifc2x3tc1Package.Literals.LOG_ACTION__ACCESS_METHOD, true);
	}
	...
	public void setAccessMethod(AccessMethod newAccessMethod) {
		eSet(Ifc2x3tc1Package.Literals.LOG_ACTION__ACCESS_METHOD, newAccessMethod);
	}
