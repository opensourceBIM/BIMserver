...
public class UserUndeletedImpl extends LogActionImpl implements UserUndeleted {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.USER_UNDELETED;
	}
	 ...
	 */
	public User getUser() {
		return (User) eGet(Ifc2x3tc1Package.Literals.USER_UNDELETED__USER, true);
	}
	...
	public void setUser(User newUser) {
		eSet(Ifc2x3tc1Package.Literals.USER_UNDELETED__USER, newUser);
	}
