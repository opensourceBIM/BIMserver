...
public class PasswordResetImpl extends LogActionImpl implements PasswordReset {
	...
	protected EClass eStaticClass() {
		return Ifc2x3tc1Package.Literals.PASSWORD_RESET;
	}
	 ...
	 */
	public User getUser() {
		return (User) eGet(Ifc2x3tc1Package.Literals.PASSWORD_RESET__USER, true);
	}
	...
	public void setUser(User newUser) {
		eSet(Ifc2x3tc1Package.Literals.PASSWORD_RESET__USER, newUser);
	}
