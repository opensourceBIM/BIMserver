...
public class IfcElectricGeneratorTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcElectricGeneratorType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_ELECTRIC_GENERATOR_TYPE;
	}
	...
	public IfcElectricGeneratorTypeEnum getPredefinedType() {
		return (IfcElectricGeneratorTypeEnum) eGet(Ifc2x3Package.Literals.IFC_ELECTRIC_GENERATOR_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcElectricGeneratorTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_ELECTRIC_GENERATOR_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_ELECTRIC_GENERATOR_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_ELECTRIC_GENERATOR_TYPE__PREDEFINED_TYPE);
	}
