...
public class IfcSoundValueImpl extends IfcPropertySetDefinitionImpl implements IfcSoundValue {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SOUND_VALUE;
	}
	...
	public IfcTimeSeries getSoundLevelTimeSeries() {
		return (IfcTimeSeries) eGet(Ifc2x3Package.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_TIME_SERIES, true);
	}
	...
	public void setSoundLevelTimeSeries(IfcTimeSeries newSoundLevelTimeSeries) {
		eSet(Ifc2x3Package.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_TIME_SERIES, newSoundLevelTimeSeries);
	}
	...
	public void unsetSoundLevelTimeSeries() {
		eUnset(Ifc2x3Package.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_TIME_SERIES);
	}
	...
	public boolean isSetSoundLevelTimeSeries() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_TIME_SERIES);
	}
	...
	public IfcDerivedMeasureValue getSoundLevelSingleValue() {
		return (IfcDerivedMeasureValue) eGet(Ifc2x3Package.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_SINGLE_VALUE, true);
	}
	...
	public void setSoundLevelSingleValue(IfcDerivedMeasureValue newSoundLevelSingleValue) {
		eSet(Ifc2x3Package.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_SINGLE_VALUE, newSoundLevelSingleValue);
	}
	...
	public void unsetSoundLevelSingleValue() {
		eUnset(Ifc2x3Package.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_SINGLE_VALUE);
	}
	...
	public boolean isSetSoundLevelSingleValue() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_SINGLE_VALUE);
	}
