...
public class IfcGeometricRepresentationContextImpl extends IfcRepresentationContextImpl implements IfcGeometricRepresentationContext {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT;
	}
	...
	public int getCoordinateSpaceDimension() {
		return (Integer) eGet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__COORDINATE_SPACE_DIMENSION, true);
	}
	...
	public void setCoordinateSpaceDimension(int newCoordinateSpaceDimension) {
		eSet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__COORDINATE_SPACE_DIMENSION, newCoordinateSpaceDimension);
	}
	...
	public void unsetPrecision() {
		eUnset(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION);
	}
	...
	public boolean isSetPrecision() {
		return eIsSet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION);
	}
	...
	public String getPrecisionAsString() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION_AS_STRING, true);
	}
	...
	public void setPrecisionAsString(String newPrecisionAsString) {
		eSet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION_AS_STRING, newPrecisionAsString);
	}
	...
	public void unsetPrecisionAsString() {
		eUnset(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION_AS_STRING);
	}
	...
	public boolean isSetPrecisionAsString() {
		return eIsSet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION_AS_STRING);
	}
	...
	public IfcAxis2Placement getWorldCoordinateSystem() {
		return (IfcAxis2Placement) eGet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__WORLD_COORDINATE_SYSTEM, true);
	}
	...
	public IfcDirection getTrueNorth() {
		return (IfcDirection) eGet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__TRUE_NORTH, true);
	}
	...
	public void setTrueNorth(IfcDirection newTrueNorth) {
		eSet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__TRUE_NORTH, newTrueNorth);
	}
	...
	public void unsetTrueNorth() {
		eUnset(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__TRUE_NORTH);
	}
	...
	public boolean isSetTrueNorth() {
		return eIsSet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__TRUE_NORTH);
	}
	...
	public EList<IfcGeometricRepresentationSubContext> getHasSubContexts() {
		return (EList<IfcGeometricRepresentationSubContext>) eGet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__HAS_SUB_CONTEXTS, true);
	}
	...
	public void unsetHasSubContexts() {
		eUnset(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__HAS_SUB_CONTEXTS);
	}
	...
	public boolean isSetHasSubContexts() {
		return eIsSet(Ifc2x3Package.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__HAS_SUB_CONTEXTS);
	}
