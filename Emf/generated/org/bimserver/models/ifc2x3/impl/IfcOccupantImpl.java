...
public class IfcOccupantImpl extends IfcActorImpl implements IfcOccupant {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_OCCUPANT;
	}
	...
	public IfcOccupantTypeEnum getPredefinedType() {
		return (IfcOccupantTypeEnum) eGet(Ifc2x3Package.Literals.IFC_OCCUPANT__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcOccupantTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_OCCUPANT__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_OCCUPANT__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_OCCUPANT__PREDEFINED_TYPE);
	}
