...
public class IfcCircleHollowProfileDefImpl extends IfcCircleProfileDefImpl implements IfcCircleHollowProfileDef {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF;
	}
	...
	public double getWallThickness() {
		return (Double) eGet(Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS, true);
	}
	...
	public void setWallThickness(double newWallThickness) {
		eSet(Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS, newWallThickness);
	}
	...
	public void unsetWallThickness() {
		eUnset(Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS);
	}
	...
	public boolean isSetWallThickness() {
		return eIsSet(Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS);
	}
	...
	public String getWallThicknessAsString() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING, true);
	}
	...
	public void setWallThicknessAsString(String newWallThicknessAsString) {
		eSet(Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING, newWallThicknessAsString);
	}
	...
	public void unsetWallThicknessAsString() {
		eUnset(Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING);
	}
	...
	public boolean isSetWallThicknessAsString() {
		return eIsSet(Ifc2x3Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING);
	}
