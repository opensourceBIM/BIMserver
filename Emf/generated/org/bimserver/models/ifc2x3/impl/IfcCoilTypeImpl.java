...
public class IfcCoilTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCoilType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_COIL_TYPE;
	}
	...
	public IfcCoilTypeEnum getPredefinedType() {
		return (IfcCoilTypeEnum) eGet(Ifc2x3Package.Literals.IFC_COIL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCoilTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_COIL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_COIL_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_COIL_TYPE__PREDEFINED_TYPE);
	}
