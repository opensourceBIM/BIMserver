...
public class IfcSlabTypeImpl extends IfcBuildingElementTypeImpl implements IfcSlabType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SLAB_TYPE;
	}
	...
	public IfcSlabTypeEnum getPredefinedType() {
		return (IfcSlabTypeEnum) eGet(Ifc2x3Package.Literals.IFC_SLAB_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSlabTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_SLAB_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_SLAB_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SLAB_TYPE__PREDEFINED_TYPE);
	}
