...
public class IfcRailingTypeImpl extends IfcBuildingElementTypeImpl implements IfcRailingType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_RAILING_TYPE;
	}
	...
	public IfcRailingTypeEnum getPredefinedType() {
		return (IfcRailingTypeEnum) eGet(Ifc2x3Package.Literals.IFC_RAILING_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcRailingTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_RAILING_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_RAILING_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_RAILING_TYPE__PREDEFINED_TYPE);
	}
