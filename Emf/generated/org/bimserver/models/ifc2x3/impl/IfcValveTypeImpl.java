...
public class IfcValveTypeImpl extends IfcFlowControllerTypeImpl implements IfcValveType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_VALVE_TYPE;
	}
	...
	public IfcValveTypeEnum getPredefinedType() {
		return (IfcValveTypeEnum) eGet(Ifc2x3Package.Literals.IFC_VALVE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcValveTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_VALVE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_VALVE_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_VALVE_TYPE__PREDEFINED_TYPE);
	}
