...
public class IfcCompressorTypeImpl extends IfcFlowMovingDeviceTypeImpl implements IfcCompressorType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_COMPRESSOR_TYPE;
	}
	...
	public IfcCompressorTypeEnum getPredefinedType() {
		return (IfcCompressorTypeEnum) eGet(Ifc2x3Package.Literals.IFC_COMPRESSOR_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCompressorTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_COMPRESSOR_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_COMPRESSOR_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_COMPRESSOR_TYPE__PREDEFINED_TYPE);
	}
