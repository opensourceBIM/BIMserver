...
public class IfcFlowInstrumentTypeImpl extends IfcDistributionControlElementTypeImpl implements IfcFlowInstrumentType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_FLOW_INSTRUMENT_TYPE;
	}
	...
	public IfcFlowInstrumentTypeEnum getPredefinedType() {
		return (IfcFlowInstrumentTypeEnum) eGet(Ifc2x3Package.Literals.IFC_FLOW_INSTRUMENT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcFlowInstrumentTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_FLOW_INSTRUMENT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_FLOW_INSTRUMENT_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_FLOW_INSTRUMENT_TYPE__PREDEFINED_TYPE);
	}
