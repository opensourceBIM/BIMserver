...
public class IfcMaterialLayerSetUsageImpl extends IdEObjectImpl implements IfcMaterialLayerSetUsage {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE;
	}
	...
	public IfcMaterialLayerSet getForLayerSet() {
		return (IfcMaterialLayerSet) eGet(Ifc2x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__FOR_LAYER_SET, true);
	}
	...
	public void setForLayerSet(IfcMaterialLayerSet newForLayerSet) {
		eSet(Ifc2x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__FOR_LAYER_SET, newForLayerSet);
	}
	...
	public IfcDirectionSenseEnum getDirectionSense() {
		return (IfcDirectionSenseEnum) eGet(Ifc2x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__DIRECTION_SENSE, true);
	}
	...
	public void setDirectionSense(IfcDirectionSenseEnum newDirectionSense) {
		eSet(Ifc2x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__DIRECTION_SENSE, newDirectionSense);
	}
