...
public class IfcVolumetricFlowRateMeasureImpl extends WrappedValueImpl implements IfcVolumetricFlowRateMeasure {
	...
	public double getWrappedValue() {
		return (Double) eGet(Ifc2x3Package.Literals.IFC_VOLUMETRIC_FLOW_RATE_MEASURE__WRAPPED_VALUE, true);
	}
	...
	public void unsetWrappedValue() {
		eUnset(Ifc2x3Package.Literals.IFC_VOLUMETRIC_FLOW_RATE_MEASURE__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(Ifc2x3Package.Literals.IFC_VOLUMETRIC_FLOW_RATE_MEASURE__WRAPPED_VALUE);
	}
	...
	public void unsetWrappedValueAsString() {
		eUnset(Ifc2x3Package.Literals.IFC_VOLUMETRIC_FLOW_RATE_MEASURE__WRAPPED_VALUE_AS_STRING);
	}
	...
	public boolean isSetWrappedValueAsString() {
		return eIsSet(Ifc2x3Package.Literals.IFC_VOLUMETRIC_FLOW_RATE_MEASURE__WRAPPED_VALUE_AS_STRING);
	}
