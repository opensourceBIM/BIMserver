...
public class IfcTextureCoordinateGeneratorImpl extends IfcTextureCoordinateImpl implements IfcTextureCoordinateGenerator {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_TEXTURE_COORDINATE_GENERATOR;
	}
	...
	public String getMode() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_TEXTURE_COORDINATE_GENERATOR__MODE, true);
	}
	...
	public void setMode(String newMode) {
		eSet(Ifc2x3Package.Literals.IFC_TEXTURE_COORDINATE_GENERATOR__MODE, newMode);
	}
