...
public class IfcActorImpl extends IfcObjectImpl implements IfcActor {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_ACTOR;
	}
	...
	public IfcActorSelect getTheActor() {
		return (IfcActorSelect) eGet(Ifc2x3Package.Literals.IFC_ACTOR__THE_ACTOR, true);
	}
	...
	public void setTheActor(IfcActorSelect newTheActor) {
		eSet(Ifc2x3Package.Literals.IFC_ACTOR__THE_ACTOR, newTheActor);
	}
	...
	public void unsetIsActingUpon() {
		eUnset(Ifc2x3Package.Literals.IFC_ACTOR__IS_ACTING_UPON);
	}
	...
	public boolean isSetIsActingUpon() {
		return eIsSet(Ifc2x3Package.Literals.IFC_ACTOR__IS_ACTING_UPON);
	}
