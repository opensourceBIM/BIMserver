...
public class IfcIntegerCountRateMeasureImpl extends WrappedValueImpl implements IfcIntegerCountRateMeasure {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_INTEGER_COUNT_RATE_MEASURE;
	}
	...
	public int getWrappedValue() {
		return (Integer) eGet(Ifc2x3Package.Literals.IFC_INTEGER_COUNT_RATE_MEASURE__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(int newWrappedValue) {
		eSet(Ifc2x3Package.Literals.IFC_INTEGER_COUNT_RATE_MEASURE__WRAPPED_VALUE, newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(Ifc2x3Package.Literals.IFC_INTEGER_COUNT_RATE_MEASURE__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(Ifc2x3Package.Literals.IFC_INTEGER_COUNT_RATE_MEASURE__WRAPPED_VALUE);
	}
