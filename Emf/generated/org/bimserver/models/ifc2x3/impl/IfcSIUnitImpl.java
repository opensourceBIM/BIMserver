...
public class IfcSIUnitImpl extends IfcNamedUnitImpl implements IfcSIUnit {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SI_UNIT;
	}
	...
	public IfcSIPrefix getPrefix() {
		return (IfcSIPrefix) eGet(Ifc2x3Package.Literals.IFC_SI_UNIT__PREFIX, true);
	}
	...
	public void setPrefix(IfcSIPrefix newPrefix) {
		eSet(Ifc2x3Package.Literals.IFC_SI_UNIT__PREFIX, newPrefix);
	}
	...
	public void unsetPrefix() {
		eUnset(Ifc2x3Package.Literals.IFC_SI_UNIT__PREFIX);
	}
	...
	public boolean isSetPrefix() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SI_UNIT__PREFIX);
	}
	...
	public IfcSIUnitName getName() {
		return (IfcSIUnitName) eGet(Ifc2x3Package.Literals.IFC_SI_UNIT__NAME, true);
	}
