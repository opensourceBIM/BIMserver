...
public class IfcRelConnectsPortToElementImpl extends IfcRelConnectsImpl implements IfcRelConnectsPortToElement {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORT_TO_ELEMENT;
	}
	...
	public IfcPort getRelatingPort() {
		return (IfcPort) eGet(Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORT_TO_ELEMENT__RELATING_PORT, true);
	}
	...
	public void setRelatingPort(IfcPort newRelatingPort) {
		eSet(Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORT_TO_ELEMENT__RELATING_PORT, newRelatingPort);
	}
