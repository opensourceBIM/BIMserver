...
public class IfcApprovalRelationshipImpl extends IdEObjectImpl implements IfcApprovalRelationship {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_APPROVAL_RELATIONSHIP;
	}
	...
	public IfcApproval getRelatedApproval() {
		return (IfcApproval) eGet(Ifc2x3Package.Literals.IFC_APPROVAL_RELATIONSHIP__RELATED_APPROVAL, true);
	}
	...
	public void setRelatedApproval(IfcApproval newRelatedApproval) {
		eSet(Ifc2x3Package.Literals.IFC_APPROVAL_RELATIONSHIP__RELATED_APPROVAL, newRelatedApproval);
	}
	...
	public String getDescription() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_APPROVAL_RELATIONSHIP__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(Ifc2x3Package.Literals.IFC_APPROVAL_RELATIONSHIP__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(Ifc2x3Package.Literals.IFC_APPROVAL_RELATIONSHIP__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(Ifc2x3Package.Literals.IFC_APPROVAL_RELATIONSHIP__DESCRIPTION);
	}
	...
	public String getName() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_APPROVAL_RELATIONSHIP__NAME, true);
	}
