...
public class IfcSwitchingDeviceTypeImpl extends IfcFlowControllerTypeImpl implements IfcSwitchingDeviceType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SWITCHING_DEVICE_TYPE;
	}
	...
	public IfcSwitchingDeviceTypeEnum getPredefinedType() {
		return (IfcSwitchingDeviceTypeEnum) eGet(Ifc2x3Package.Literals.IFC_SWITCHING_DEVICE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSwitchingDeviceTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_SWITCHING_DEVICE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_SWITCHING_DEVICE_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SWITCHING_DEVICE_TYPE__PREDEFINED_TYPE);
	}
