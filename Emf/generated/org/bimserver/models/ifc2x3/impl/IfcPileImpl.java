...
public class IfcPileImpl extends IfcBuildingElementImpl implements IfcPile {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PILE;
	}
	...
	public IfcPileTypeEnum getPredefinedType() {
		return (IfcPileTypeEnum) eGet(Ifc2x3Package.Literals.IFC_PILE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcPileTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_PILE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void setConstructionType(IfcPileConstructionEnum newConstructionType) {
		eSet(Ifc2x3Package.Literals.IFC_PILE__CONSTRUCTION_TYPE, newConstructionType);
	}
	...
	public void unsetConstructionType() {
		eUnset(Ifc2x3Package.Literals.IFC_PILE__CONSTRUCTION_TYPE);
	}
	...
	public boolean isSetConstructionType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_PILE__CONSTRUCTION_TYPE);
	}
