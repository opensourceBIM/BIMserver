...
public class IfcCoveringImpl extends IfcBuildingElementImpl implements IfcCovering {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_COVERING;
	}
	...
	public IfcCoveringTypeEnum getPredefinedType() {
		return (IfcCoveringTypeEnum) eGet(Ifc2x3Package.Literals.IFC_COVERING__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCoveringTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_COVERING__PREDEFINED_TYPE, newPredefinedType);
	}
