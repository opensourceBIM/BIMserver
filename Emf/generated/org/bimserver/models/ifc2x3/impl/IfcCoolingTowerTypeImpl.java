...
public class IfcCoolingTowerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCoolingTowerType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_COOLING_TOWER_TYPE;
	}
	...
	public IfcCoolingTowerTypeEnum getPredefinedType() {
		return (IfcCoolingTowerTypeEnum) eGet(Ifc2x3Package.Literals.IFC_COOLING_TOWER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCoolingTowerTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_COOLING_TOWER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_COOLING_TOWER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_COOLING_TOWER_TYPE__PREDEFINED_TYPE);
	}
