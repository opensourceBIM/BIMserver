...
public class IfcBeamTypeImpl extends IfcBuildingElementTypeImpl implements IfcBeamType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_BEAM_TYPE;
	}
	...
	public IfcBeamTypeEnum getPredefinedType() {
		return (IfcBeamTypeEnum) eGet(Ifc2x3Package.Literals.IFC_BEAM_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcBeamTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_BEAM_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_BEAM_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_BEAM_TYPE__PREDEFINED_TYPE);
	}
