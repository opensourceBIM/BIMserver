...
public class IfcProductDefinitionShapeImpl extends IfcProductRepresentationImpl implements IfcProductDefinitionShape {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE;
	}
	...
	public EList<IfcProduct> getShapeOfProduct() {
		return (EList<IfcProduct>) eGet(Ifc2x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE__SHAPE_OF_PRODUCT, true);
	}
