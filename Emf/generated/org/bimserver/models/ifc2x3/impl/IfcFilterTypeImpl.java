...
public class IfcFilterTypeImpl extends IfcFlowTreatmentDeviceTypeImpl implements IfcFilterType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_FILTER_TYPE;
	}
	...
	public IfcFilterTypeEnum getPredefinedType() {
		return (IfcFilterTypeEnum) eGet(Ifc2x3Package.Literals.IFC_FILTER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcFilterTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_FILTER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_FILTER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_FILTER_TYPE__PREDEFINED_TYPE);
	}
