...
public class IfcSpecificHeatCapacityMeasureImpl extends WrappedValueImpl implements IfcSpecificHeatCapacityMeasure {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SPECIFIC_HEAT_CAPACITY_MEASURE;
	}
	...
	public double getWrappedValue() {
		return (Double) eGet(Ifc2x3Package.Literals.IFC_SPECIFIC_HEAT_CAPACITY_MEASURE__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc2x3Package.Literals.IFC_SPECIFIC_HEAT_CAPACITY_MEASURE__WRAPPED_VALUE, newWrappedValue);
	}
