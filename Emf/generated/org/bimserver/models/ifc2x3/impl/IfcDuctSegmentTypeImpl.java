...
public class IfcDuctSegmentTypeImpl extends IfcFlowSegmentTypeImpl implements IfcDuctSegmentType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_DUCT_SEGMENT_TYPE;
	}
	...
	public IfcDuctSegmentTypeEnum getPredefinedType() {
		return (IfcDuctSegmentTypeEnum) eGet(Ifc2x3Package.Literals.IFC_DUCT_SEGMENT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcDuctSegmentTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_DUCT_SEGMENT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_DUCT_SEGMENT_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_DUCT_SEGMENT_TYPE__PREDEFINED_TYPE);
	}
