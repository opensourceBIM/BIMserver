...
public class IfcRampFlightTypeImpl extends IfcBuildingElementTypeImpl implements IfcRampFlightType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_RAMP_FLIGHT_TYPE;
	}
	...
	public IfcRampFlightTypeEnum getPredefinedType() {
		return (IfcRampFlightTypeEnum) eGet(Ifc2x3Package.Literals.IFC_RAMP_FLIGHT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcRampFlightTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_RAMP_FLIGHT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_RAMP_FLIGHT_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_RAMP_FLIGHT_TYPE__PREDEFINED_TYPE);
	}
