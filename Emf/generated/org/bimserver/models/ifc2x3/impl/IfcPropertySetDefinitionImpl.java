...
public class IfcPropertySetDefinitionImpl extends IfcPropertyDefinitionImpl implements IfcPropertySetDefinition {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PROPERTY_SET_DEFINITION;
	}
	...
	public EList<IfcRelDefinesByProperties> getPropertyDefinitionOf() {
		return (EList<IfcRelDefinesByProperties>) eGet(Ifc2x3Package.Literals.IFC_PROPERTY_SET_DEFINITION__PROPERTY_DEFINITION_OF, true);
	}
