...
public class IfcCenterLineProfileDefImpl extends IfcArbitraryOpenProfileDefImpl implements IfcCenterLineProfileDef {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_CENTER_LINE_PROFILE_DEF;
	}
	...
	public double getThickness() {
		return (Double) eGet(Ifc2x3Package.Literals.IFC_CENTER_LINE_PROFILE_DEF__THICKNESS, true);
	}
	...
	public void setThickness(double newThickness) {
		eSet(Ifc2x3Package.Literals.IFC_CENTER_LINE_PROFILE_DEF__THICKNESS, newThickness);
	}
