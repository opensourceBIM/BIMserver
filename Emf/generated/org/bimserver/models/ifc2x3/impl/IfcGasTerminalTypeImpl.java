...
public class IfcGasTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcGasTerminalType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_GAS_TERMINAL_TYPE;
	}
	...
	public IfcGasTerminalTypeEnum getPredefinedType() {
		return (IfcGasTerminalTypeEnum) eGet(Ifc2x3Package.Literals.IFC_GAS_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcGasTerminalTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_GAS_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_GAS_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_GAS_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
