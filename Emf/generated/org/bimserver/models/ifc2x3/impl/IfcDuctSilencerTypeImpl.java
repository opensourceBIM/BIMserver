...
public class IfcDuctSilencerTypeImpl extends IfcFlowTreatmentDeviceTypeImpl implements IfcDuctSilencerType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_DUCT_SILENCER_TYPE;
	}
	...
	public IfcDuctSilencerTypeEnum getPredefinedType() {
		return (IfcDuctSilencerTypeEnum) eGet(Ifc2x3Package.Literals.IFC_DUCT_SILENCER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcDuctSilencerTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_DUCT_SILENCER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_DUCT_SILENCER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_DUCT_SILENCER_TYPE__PREDEFINED_TYPE);
	}
