...
public class IfcFanTypeImpl extends IfcFlowMovingDeviceTypeImpl implements IfcFanType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_FAN_TYPE;
	}
	...
	public IfcFanTypeEnum getPredefinedType() {
		return (IfcFanTypeEnum) eGet(Ifc2x3Package.Literals.IFC_FAN_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcFanTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_FAN_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_FAN_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_FAN_TYPE__PREDEFINED_TYPE);
	}
