...
public class IfcMemberTypeImpl extends IfcBuildingElementTypeImpl implements IfcMemberType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_MEMBER_TYPE;
	}
	...
	public IfcMemberTypeEnum getPredefinedType() {
		return (IfcMemberTypeEnum) eGet(Ifc2x3Package.Literals.IFC_MEMBER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcMemberTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_MEMBER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_MEMBER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_MEMBER_TYPE__PREDEFINED_TYPE);
	}
