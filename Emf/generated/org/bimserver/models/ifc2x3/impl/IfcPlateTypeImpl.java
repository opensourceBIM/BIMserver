...
public class IfcPlateTypeImpl extends IfcBuildingElementTypeImpl implements IfcPlateType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PLATE_TYPE;
	}
	...
	public IfcPlateTypeEnum getPredefinedType() {
		return (IfcPlateTypeEnum) eGet(Ifc2x3Package.Literals.IFC_PLATE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcPlateTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_PLATE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_PLATE_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_PLATE_TYPE__PREDEFINED_TYPE);
	}
