...
public class IfcStructuralMemberImpl extends IfcStructuralItemImpl implements IfcStructuralMember {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_STRUCTURAL_MEMBER;
	}
	...
	public EList<IfcRelConnectsStructuralElement> getReferencesElement() {
		return (EList<IfcRelConnectsStructuralElement>) eGet(Ifc2x3Package.Literals.IFC_STRUCTURAL_MEMBER__REFERENCES_ELEMENT, true);
	}
