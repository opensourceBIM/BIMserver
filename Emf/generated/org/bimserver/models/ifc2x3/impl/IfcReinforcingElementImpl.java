...
public class IfcReinforcingElementImpl extends IfcBuildingElementComponentImpl implements IfcReinforcingElement {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_REINFORCING_ELEMENT;
	}
	...
	public String getSteelGrade() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_REINFORCING_ELEMENT__STEEL_GRADE, true);
	}
	...
	public void setSteelGrade(String newSteelGrade) {
		eSet(Ifc2x3Package.Literals.IFC_REINFORCING_ELEMENT__STEEL_GRADE, newSteelGrade);
	}
	...
	public void unsetSteelGrade() {
		eUnset(Ifc2x3Package.Literals.IFC_REINFORCING_ELEMENT__STEEL_GRADE);
	}
	...
	public boolean isSetSteelGrade() {
		return eIsSet(Ifc2x3Package.Literals.IFC_REINFORCING_ELEMENT__STEEL_GRADE);
	}
