...
public class IfcWallTypeImpl extends IfcBuildingElementTypeImpl implements IfcWallType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_WALL_TYPE;
	}
	...
	public IfcWallTypeEnum getPredefinedType() {
		return (IfcWallTypeEnum) eGet(Ifc2x3Package.Literals.IFC_WALL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcWallTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_WALL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_WALL_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_WALL_TYPE__PREDEFINED_TYPE);
	}
