...
public class IfcTankTypeImpl extends IfcFlowStorageDeviceTypeImpl implements IfcTankType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_TANK_TYPE;
	}
	...
	public IfcTankTypeEnum getPredefinedType() {
		return (IfcTankTypeEnum) eGet(Ifc2x3Package.Literals.IFC_TANK_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTankTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_TANK_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_TANK_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_TANK_TYPE__PREDEFINED_TYPE);
	}
