...
public class IfcTransformerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcTransformerType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_TRANSFORMER_TYPE;
	}
	...
	public IfcTransformerTypeEnum getPredefinedType() {
		return (IfcTransformerTypeEnum) eGet(Ifc2x3Package.Literals.IFC_TRANSFORMER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTransformerTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_TRANSFORMER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_TRANSFORMER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_TRANSFORMER_TYPE__PREDEFINED_TYPE);
	}
