...
public class IfcStackTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcStackTerminalType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_STACK_TERMINAL_TYPE;
	}
	...
	public IfcStackTerminalTypeEnum getPredefinedType() {
		return (IfcStackTerminalTypeEnum) eGet(Ifc2x3Package.Literals.IFC_STACK_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcStackTerminalTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_STACK_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_STACK_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_STACK_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
