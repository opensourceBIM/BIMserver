...
public class IfcRelAssignsTasksImpl extends IfcRelAssignsToControlImpl implements IfcRelAssignsTasks {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_REL_ASSIGNS_TASKS;
	}
	...
	public IfcScheduleTimeControl getTimeForTask() {
		return (IfcScheduleTimeControl) eGet(Ifc2x3Package.Literals.IFC_REL_ASSIGNS_TASKS__TIME_FOR_TASK, true);
	}
	...
	public void setTimeForTask(IfcScheduleTimeControl newTimeForTask) {
		eSet(Ifc2x3Package.Literals.IFC_REL_ASSIGNS_TASKS__TIME_FOR_TASK, newTimeForTask);
	}
	...
	public void unsetTimeForTask() {
		eUnset(Ifc2x3Package.Literals.IFC_REL_ASSIGNS_TASKS__TIME_FOR_TASK);
	}
	...
	public boolean isSetTimeForTask() {
		return eIsSet(Ifc2x3Package.Literals.IFC_REL_ASSIGNS_TASKS__TIME_FOR_TASK);
	}
