...
public class IfcRelServicesBuildingsImpl extends IfcRelConnectsImpl implements IfcRelServicesBuildings {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_REL_SERVICES_BUILDINGS;
	}
	...
	public IfcSystem getRelatingSystem() {
		return (IfcSystem) eGet(Ifc2x3Package.Literals.IFC_REL_SERVICES_BUILDINGS__RELATING_SYSTEM, true);
	}
	...
	public void setRelatingSystem(IfcSystem newRelatingSystem) {
		eSet(Ifc2x3Package.Literals.IFC_REL_SERVICES_BUILDINGS__RELATING_SYSTEM, newRelatingSystem);
	}
