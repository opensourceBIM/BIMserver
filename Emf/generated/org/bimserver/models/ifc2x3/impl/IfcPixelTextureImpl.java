...
public class IfcPixelTextureImpl extends IfcSurfaceTextureImpl implements IfcPixelTexture {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PIXEL_TEXTURE;
	}
	 ...
	 */
	public int getWidth() {
		return (Integer) eGet(Ifc2x3Package.Literals.IFC_PIXEL_TEXTURE__WIDTH, true);
	}
	...
	public void setWidth(int newWidth) {
		eSet(Ifc2x3Package.Literals.IFC_PIXEL_TEXTURE__WIDTH, newWidth);
	}
	...
	public void setHeight(int newHeight) {
		eSet(Ifc2x3Package.Literals.IFC_PIXEL_TEXTURE__HEIGHT, newHeight);
	}
