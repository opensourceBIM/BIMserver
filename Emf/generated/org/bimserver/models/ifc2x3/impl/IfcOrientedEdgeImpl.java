...
public class IfcOrientedEdgeImpl extends IfcEdgeImpl implements IfcOrientedEdge {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_ORIENTED_EDGE;
	}
	...
	public IfcEdge getEdgeElement() {
		return (IfcEdge) eGet(Ifc2x3Package.Literals.IFC_ORIENTED_EDGE__EDGE_ELEMENT, true);
	}
	...
	public void setEdgeElement(IfcEdge newEdgeElement) {
		eSet(Ifc2x3Package.Literals.IFC_ORIENTED_EDGE__EDGE_ELEMENT, newEdgeElement);
	}
