...
public class IfcMappedItemImpl extends IfcRepresentationItemImpl implements IfcMappedItem {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_MAPPED_ITEM;
	}
	...
	public IfcRepresentationMap getMappingSource() {
		return (IfcRepresentationMap) eGet(Ifc2x3Package.Literals.IFC_MAPPED_ITEM__MAPPING_SOURCE, true);
	}
	...
	public void setMappingSource(IfcRepresentationMap newMappingSource) {
		eSet(Ifc2x3Package.Literals.IFC_MAPPED_ITEM__MAPPING_SOURCE, newMappingSource);
	}
