...
public class IfcVibrationIsolatorTypeImpl extends IfcDiscreteAccessoryTypeImpl implements IfcVibrationIsolatorType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_VIBRATION_ISOLATOR_TYPE;
	}
	...
	public IfcVibrationIsolatorTypeEnum getPredefinedType() {
		return (IfcVibrationIsolatorTypeEnum) eGet(Ifc2x3Package.Literals.IFC_VIBRATION_ISOLATOR_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcVibrationIsolatorTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_VIBRATION_ISOLATOR_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_VIBRATION_ISOLATOR_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_VIBRATION_ISOLATOR_TYPE__PREDEFINED_TYPE);
	}
