...
public class IfcRelDecomposesImpl extends IfcRelationshipImpl implements IfcRelDecomposes {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_REL_DECOMPOSES;
	}
	...
	public IfcObjectDefinition getRelatingObject() {
		return (IfcObjectDefinition) eGet(Ifc2x3Package.Literals.IFC_REL_DECOMPOSES__RELATING_OBJECT, true);
	}
	...
	public void setRelatingObject(IfcObjectDefinition newRelatingObject) {
		eSet(Ifc2x3Package.Literals.IFC_REL_DECOMPOSES__RELATING_OBJECT, newRelatingObject);
	}
