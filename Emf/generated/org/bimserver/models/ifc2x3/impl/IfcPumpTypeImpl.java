...
public class IfcPumpTypeImpl extends IfcFlowMovingDeviceTypeImpl implements IfcPumpType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PUMP_TYPE;
	}
	...
	public IfcPumpTypeEnum getPredefinedType() {
		return (IfcPumpTypeEnum) eGet(Ifc2x3Package.Literals.IFC_PUMP_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcPumpTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_PUMP_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_PUMP_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_PUMP_TYPE__PREDEFINED_TYPE);
	}
