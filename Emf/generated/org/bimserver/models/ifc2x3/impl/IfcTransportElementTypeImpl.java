...
public class IfcTransportElementTypeImpl extends IfcElementTypeImpl implements IfcTransportElementType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_TRANSPORT_ELEMENT_TYPE;
	}
	...
	public IfcTransportElementTypeEnum getPredefinedType() {
		return (IfcTransportElementTypeEnum) eGet(Ifc2x3Package.Literals.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTransportElementTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE);
	}
