...
public class IfcProfilePropertiesImpl extends IdEObjectImpl implements IfcProfileProperties {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES;
	}
	...
	public String getProfileName() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES__PROFILE_NAME, true);
	}
	...
	public void setProfileName(String newProfileName) {
		eSet(Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES__PROFILE_NAME, newProfileName);
	}
	...
	public void unsetProfileName() {
		eUnset(Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES__PROFILE_NAME);
	}
	...
	public boolean isSetProfileName() {
		return eIsSet(Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES__PROFILE_NAME);
	}
	...
	public IfcProfileDef getProfileDefinition() {
		return (IfcProfileDef) eGet(Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES__PROFILE_DEFINITION, true);
	}
	...
	public void setProfileDefinition(IfcProfileDef newProfileDefinition) {
		eSet(Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES__PROFILE_DEFINITION, newProfileDefinition);
	}
	...
	public void unsetProfileDefinition() {
		eUnset(Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES__PROFILE_DEFINITION);
	}
	...
	public boolean isSetProfileDefinition() {
		return eIsSet(Ifc2x3Package.Literals.IFC_PROFILE_PROPERTIES__PROFILE_DEFINITION);
	}
