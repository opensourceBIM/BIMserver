...
public class IfcAnnotationFillAreaImpl extends IfcGeometricRepresentationItemImpl implements IfcAnnotationFillArea {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_ANNOTATION_FILL_AREA;
	}
	...
	public IfcCurve getOuterBoundary() {
		return (IfcCurve) eGet(Ifc2x3Package.Literals.IFC_ANNOTATION_FILL_AREA__OUTER_BOUNDARY, true);
	}
	...
	public void setOuterBoundary(IfcCurve newOuterBoundary) {
		eSet(Ifc2x3Package.Literals.IFC_ANNOTATION_FILL_AREA__OUTER_BOUNDARY, newOuterBoundary);
	}
	...
	public void unsetInnerBoundaries() {
		eUnset(Ifc2x3Package.Literals.IFC_ANNOTATION_FILL_AREA__INNER_BOUNDARIES);
	}
	...
	public boolean isSetInnerBoundaries() {
		return eIsSet(Ifc2x3Package.Literals.IFC_ANNOTATION_FILL_AREA__INNER_BOUNDARIES);
	}
