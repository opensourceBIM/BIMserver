...
public class IfcHumidifierTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcHumidifierType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_HUMIDIFIER_TYPE;
	}
	...
	public IfcHumidifierTypeEnum getPredefinedType() {
		return (IfcHumidifierTypeEnum) eGet(Ifc2x3Package.Literals.IFC_HUMIDIFIER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcHumidifierTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_HUMIDIFIER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_HUMIDIFIER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_HUMIDIFIER_TYPE__PREDEFINED_TYPE);
	}
