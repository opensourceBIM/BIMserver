...
public class IfcEvaporatorTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcEvaporatorType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_EVAPORATOR_TYPE;
	}
	...
	public IfcEvaporatorTypeEnum getPredefinedType() {
		return (IfcEvaporatorTypeEnum) eGet(Ifc2x3Package.Literals.IFC_EVAPORATOR_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcEvaporatorTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_EVAPORATOR_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_EVAPORATOR_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_EVAPORATOR_TYPE__PREDEFINED_TYPE);
	}
