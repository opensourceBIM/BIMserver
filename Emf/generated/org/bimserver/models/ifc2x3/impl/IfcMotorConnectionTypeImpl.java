...
public class IfcMotorConnectionTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcMotorConnectionType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_MOTOR_CONNECTION_TYPE;
	}
	...
	public IfcMotorConnectionTypeEnum getPredefinedType() {
		return (IfcMotorConnectionTypeEnum) eGet(Ifc2x3Package.Literals.IFC_MOTOR_CONNECTION_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcMotorConnectionTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_MOTOR_CONNECTION_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_MOTOR_CONNECTION_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_MOTOR_CONNECTION_TYPE__PREDEFINED_TYPE);
	}
