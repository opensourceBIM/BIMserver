...
public class IfcEdgeImpl extends IfcTopologicalRepresentationItemImpl implements IfcEdge {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_EDGE;
	}
	...
	public IfcVertex getEdgeStart() {
		return (IfcVertex) eGet(Ifc2x3Package.Literals.IFC_EDGE__EDGE_START, true);
	}
	...
	public void setEdgeStart(IfcVertex newEdgeStart) {
		eSet(Ifc2x3Package.Literals.IFC_EDGE__EDGE_START, newEdgeStart);
	}
