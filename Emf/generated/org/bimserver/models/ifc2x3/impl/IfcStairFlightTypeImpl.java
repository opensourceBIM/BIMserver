...
public class IfcStairFlightTypeImpl extends IfcBuildingElementTypeImpl implements IfcStairFlightType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_STAIR_FLIGHT_TYPE;
	}
	...
	public IfcStairFlightTypeEnum getPredefinedType() {
		return (IfcStairFlightTypeEnum) eGet(Ifc2x3Package.Literals.IFC_STAIR_FLIGHT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcStairFlightTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_STAIR_FLIGHT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_STAIR_FLIGHT_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_STAIR_FLIGHT_TYPE__PREDEFINED_TYPE);
	}
