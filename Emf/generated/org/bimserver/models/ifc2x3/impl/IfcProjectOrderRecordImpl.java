...
public class IfcProjectOrderRecordImpl extends IfcControlImpl implements IfcProjectOrderRecord {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PROJECT_ORDER_RECORD;
	}
	...
	public EList<IfcRelAssignsToProjectOrder> getRecords() {
		return (EList<IfcRelAssignsToProjectOrder>) eGet(Ifc2x3Package.Literals.IFC_PROJECT_ORDER_RECORD__RECORDS, true);
	}
