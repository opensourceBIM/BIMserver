...
public class IfcCooledBeamTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCooledBeamType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_COOLED_BEAM_TYPE;
	}
	...
	public IfcCooledBeamTypeEnum getPredefinedType() {
		return (IfcCooledBeamTypeEnum) eGet(Ifc2x3Package.Literals.IFC_COOLED_BEAM_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCooledBeamTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_COOLED_BEAM_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_COOLED_BEAM_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_COOLED_BEAM_TYPE__PREDEFINED_TYPE);
	}
