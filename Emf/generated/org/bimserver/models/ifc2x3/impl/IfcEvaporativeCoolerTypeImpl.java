...
public class IfcEvaporativeCoolerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcEvaporativeCoolerType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_EVAPORATIVE_COOLER_TYPE;
	}
	...
	public IfcEvaporativeCoolerTypeEnum getPredefinedType() {
		return (IfcEvaporativeCoolerTypeEnum) eGet(Ifc2x3Package.Literals.IFC_EVAPORATIVE_COOLER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcEvaporativeCoolerTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_EVAPORATIVE_COOLER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_EVAPORATIVE_COOLER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_EVAPORATIVE_COOLER_TYPE__PREDEFINED_TYPE);
	}
