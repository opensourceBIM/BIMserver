...
public class IfcSpaceTypeImpl extends IfcSpatialStructureElementTypeImpl implements IfcSpaceType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SPACE_TYPE;
	}
	...
	public IfcSpaceTypeEnum getPredefinedType() {
		return (IfcSpaceTypeEnum) eGet(Ifc2x3Package.Literals.IFC_SPACE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSpaceTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_SPACE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_SPACE_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SPACE_TYPE__PREDEFINED_TYPE);
	}
