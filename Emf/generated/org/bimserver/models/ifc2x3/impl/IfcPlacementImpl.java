...
public class IfcPlacementImpl extends IfcGeometricRepresentationItemImpl implements IfcPlacement {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PLACEMENT;
	}
	...
	public IfcCartesianPoint getLocation() {
		return (IfcCartesianPoint) eGet(Ifc2x3Package.Literals.IFC_PLACEMENT__LOCATION, true);
	}
	...
	public void setLocation(IfcCartesianPoint newLocation) {
		eSet(Ifc2x3Package.Literals.IFC_PLACEMENT__LOCATION, newLocation);
	}
