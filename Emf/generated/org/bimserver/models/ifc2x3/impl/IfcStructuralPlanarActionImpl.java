...
public class IfcStructuralPlanarActionImpl extends IfcStructuralActionImpl implements IfcStructuralPlanarAction {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_STRUCTURAL_PLANAR_ACTION;
	}
	...
	public IfcProjectedOrTrueLengthEnum getProjectedOrTrue() {
		return (IfcProjectedOrTrueLengthEnum) eGet(Ifc2x3Package.Literals.IFC_STRUCTURAL_PLANAR_ACTION__PROJECTED_OR_TRUE, true);
	}
	...
	public void setProjectedOrTrue(IfcProjectedOrTrueLengthEnum newProjectedOrTrue) {
		eSet(Ifc2x3Package.Literals.IFC_STRUCTURAL_PLANAR_ACTION__PROJECTED_OR_TRUE, newProjectedOrTrue);
	}
	...
	public void unsetProjectedOrTrue() {
		eUnset(Ifc2x3Package.Literals.IFC_STRUCTURAL_PLANAR_ACTION__PROJECTED_OR_TRUE);
	}
	...
	public boolean isSetProjectedOrTrue() {
		return eIsSet(Ifc2x3Package.Literals.IFC_STRUCTURAL_PLANAR_ACTION__PROJECTED_OR_TRUE);
	}
