...
public class IfcDraughtingCalloutRelationshipImpl extends IdEObjectImpl implements IfcDraughtingCalloutRelationship {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP;
	}
	...
	public String getName() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__NAME);
	}
	...
	public String getDescription() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__DESCRIPTION);
	}
	...
	public IfcDraughtingCallout getRelatingDraughtingCallout() {
		return (IfcDraughtingCallout) eGet(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__RELATING_DRAUGHTING_CALLOUT, true);
	}
	...
	public void setRelatingDraughtingCallout(IfcDraughtingCallout newRelatingDraughtingCallout) {
		eSet(Ifc2x3Package.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__RELATING_DRAUGHTING_CALLOUT, newRelatingDraughtingCallout);
	}
