...
public class IfcControllerTypeImpl extends IfcDistributionControlElementTypeImpl implements IfcControllerType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_CONTROLLER_TYPE;
	}
	...
	public IfcControllerTypeEnum getPredefinedType() {
		return (IfcControllerTypeEnum) eGet(Ifc2x3Package.Literals.IFC_CONTROLLER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcControllerTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_CONTROLLER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_CONTROLLER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_CONTROLLER_TYPE__PREDEFINED_TYPE);
	}
