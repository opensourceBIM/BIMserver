...
public class IfcHeatExchangerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcHeatExchangerType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_HEAT_EXCHANGER_TYPE;
	}
	...
	public IfcHeatExchangerTypeEnum getPredefinedType() {
		return (IfcHeatExchangerTypeEnum) eGet(Ifc2x3Package.Literals.IFC_HEAT_EXCHANGER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcHeatExchangerTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_HEAT_EXCHANGER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_HEAT_EXCHANGER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_HEAT_EXCHANGER_TYPE__PREDEFINED_TYPE);
	}
