...
public class IfcTwoDirectionRepeatFactorImpl extends IfcOneDirectionRepeatFactorImpl implements IfcTwoDirectionRepeatFactor {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_TWO_DIRECTION_REPEAT_FACTOR;
	}
	...
	public IfcVector getSecondRepeatFactor() {
		return (IfcVector) eGet(Ifc2x3Package.Literals.IFC_TWO_DIRECTION_REPEAT_FACTOR__SECOND_REPEAT_FACTOR, true);
	}
