...
public class IfcFlowMeterTypeImpl extends IfcFlowControllerTypeImpl implements IfcFlowMeterType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_FLOW_METER_TYPE;
	}
	...
	public IfcFlowMeterTypeEnum getPredefinedType() {
		return (IfcFlowMeterTypeEnum) eGet(Ifc2x3Package.Literals.IFC_FLOW_METER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcFlowMeterTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_FLOW_METER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_FLOW_METER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_FLOW_METER_TYPE__PREDEFINED_TYPE);
	}
