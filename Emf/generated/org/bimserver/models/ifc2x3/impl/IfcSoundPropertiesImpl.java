...
public class IfcSoundPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcSoundProperties {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SOUND_PROPERTIES;
	}
	...
	public Tristate getIsAttenuating() {
		return (Tristate) eGet(Ifc2x3Package.Literals.IFC_SOUND_PROPERTIES__IS_ATTENUATING, true);
	}
	...
	public void setIsAttenuating(Tristate newIsAttenuating) {
		eSet(Ifc2x3Package.Literals.IFC_SOUND_PROPERTIES__IS_ATTENUATING, newIsAttenuating);
	}
	...
	public void setSoundScale(IfcSoundScaleEnum newSoundScale) {
		eSet(Ifc2x3Package.Literals.IFC_SOUND_PROPERTIES__SOUND_SCALE, newSoundScale);
	}
	...
	public void unsetSoundScale() {
		eUnset(Ifc2x3Package.Literals.IFC_SOUND_PROPERTIES__SOUND_SCALE);
	}
	...
	public boolean isSetSoundScale() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SOUND_PROPERTIES__SOUND_SCALE);
	}
