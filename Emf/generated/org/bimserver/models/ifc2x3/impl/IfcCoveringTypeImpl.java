...
public class IfcCoveringTypeImpl extends IfcBuildingElementTypeImpl implements IfcCoveringType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_COVERING_TYPE;
	}
	...
	public IfcCoveringTypeEnum getPredefinedType() {
		return (IfcCoveringTypeEnum) eGet(Ifc2x3Package.Literals.IFC_COVERING_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCoveringTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_COVERING_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_COVERING_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_COVERING_TYPE__PREDEFINED_TYPE);
	}
