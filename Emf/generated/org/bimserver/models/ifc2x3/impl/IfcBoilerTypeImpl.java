...
public class IfcBoilerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcBoilerType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_BOILER_TYPE;
	}
	...
	public IfcBoilerTypeEnum getPredefinedType() {
		return (IfcBoilerTypeEnum) eGet(Ifc2x3Package.Literals.IFC_BOILER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcBoilerTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_BOILER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_BOILER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_BOILER_TYPE__PREDEFINED_TYPE);
	}
