...
public class IfcWasteTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcWasteTerminalType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_WASTE_TERMINAL_TYPE;
	}
	...
	public IfcWasteTerminalTypeEnum getPredefinedType() {
		return (IfcWasteTerminalTypeEnum) eGet(Ifc2x3Package.Literals.IFC_WASTE_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcWasteTerminalTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_WASTE_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_WASTE_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_WASTE_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
