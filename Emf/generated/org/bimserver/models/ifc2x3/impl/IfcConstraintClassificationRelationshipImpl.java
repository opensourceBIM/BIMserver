...
public class IfcConstraintClassificationRelationshipImpl extends IdEObjectImpl implements IfcConstraintClassificationRelationship {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_CONSTRAINT_CLASSIFICATION_RELATIONSHIP;
	}
	...
	public IfcConstraint getClassifiedConstraint() {
		return (IfcConstraint) eGet(Ifc2x3Package.Literals.IFC_CONSTRAINT_CLASSIFICATION_RELATIONSHIP__CLASSIFIED_CONSTRAINT, true);
	}
	...
	public void setClassifiedConstraint(IfcConstraint newClassifiedConstraint) {
		eSet(Ifc2x3Package.Literals.IFC_CONSTRAINT_CLASSIFICATION_RELATIONSHIP__CLASSIFIED_CONSTRAINT, newClassifiedConstraint);
	}
