...
public class IfcApprovalPropertyRelationshipImpl extends IdEObjectImpl implements IfcApprovalPropertyRelationship {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_APPROVAL_PROPERTY_RELATIONSHIP;
	}
	...
	public EList<IfcProperty> getApprovedProperties() {
		return (EList<IfcProperty>) eGet(Ifc2x3Package.Literals.IFC_APPROVAL_PROPERTY_RELATIONSHIP__APPROVED_PROPERTIES, true);
	}
