...
public class IfcAirTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcAirTerminalType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_AIR_TERMINAL_TYPE;
	}
	...
	public IfcAirTerminalTypeEnum getPredefinedType() {
		return (IfcAirTerminalTypeEnum) eGet(Ifc2x3Package.Literals.IFC_AIR_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcAirTerminalTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_AIR_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_AIR_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_AIR_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
