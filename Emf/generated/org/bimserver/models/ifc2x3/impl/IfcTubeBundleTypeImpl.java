...
public class IfcTubeBundleTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcTubeBundleType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_TUBE_BUNDLE_TYPE;
	}
	...
	public IfcTubeBundleTypeEnum getPredefinedType() {
		return (IfcTubeBundleTypeEnum) eGet(Ifc2x3Package.Literals.IFC_TUBE_BUNDLE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTubeBundleTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_TUBE_BUNDLE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_TUBE_BUNDLE_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_TUBE_BUNDLE_TYPE__PREDEFINED_TYPE);
	}
