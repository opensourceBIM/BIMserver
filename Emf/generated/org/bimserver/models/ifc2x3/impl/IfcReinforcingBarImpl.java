...
public class IfcReinforcingBarImpl extends IfcReinforcingElementImpl implements IfcReinforcingBar {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_REINFORCING_BAR;
	}
	...
	public void unsetBarLength() {
		eUnset(Ifc2x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH);
	}
	...
	public boolean isSetBarLength() {
		return eIsSet(Ifc2x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH);
	}
	...
	public String getBarLengthAsString() {
		return (String) eGet(Ifc2x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING, true);
	}
	...
	public void setBarLengthAsString(String newBarLengthAsString) {
		eSet(Ifc2x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING, newBarLengthAsString);
	}
	...
	public void unsetBarLengthAsString() {
		eUnset(Ifc2x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING);
	}
	...
	public boolean isSetBarLengthAsString() {
		return eIsSet(Ifc2x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING);
	}
	...
	public IfcReinforcingBarRoleEnum getBarRole() {
		return (IfcReinforcingBarRoleEnum) eGet(Ifc2x3Package.Literals.IFC_REINFORCING_BAR__BAR_ROLE, true);
	}
	...
	public void setBarRole(IfcReinforcingBarRoleEnum newBarRole) {
		eSet(Ifc2x3Package.Literals.IFC_REINFORCING_BAR__BAR_ROLE, newBarRole);
	}
