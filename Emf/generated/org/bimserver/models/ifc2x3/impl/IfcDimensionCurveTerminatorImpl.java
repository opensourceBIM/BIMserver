...
public class IfcDimensionCurveTerminatorImpl extends IfcTerminatorSymbolImpl implements IfcDimensionCurveTerminator {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_DIMENSION_CURVE_TERMINATOR;
	}
	...
	public IfcDimensionExtentUsage getRole() {
		return (IfcDimensionExtentUsage) eGet(Ifc2x3Package.Literals.IFC_DIMENSION_CURVE_TERMINATOR__ROLE, true);
	}
