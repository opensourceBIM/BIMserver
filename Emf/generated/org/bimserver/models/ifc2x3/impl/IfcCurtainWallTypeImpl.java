...
public class IfcCurtainWallTypeImpl extends IfcBuildingElementTypeImpl implements IfcCurtainWallType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_CURTAIN_WALL_TYPE;
	}
	...
	public IfcCurtainWallTypeEnum getPredefinedType() {
		return (IfcCurtainWallTypeEnum) eGet(Ifc2x3Package.Literals.IFC_CURTAIN_WALL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCurtainWallTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_CURTAIN_WALL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_CURTAIN_WALL_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_CURTAIN_WALL_TYPE__PREDEFINED_TYPE);
	}
