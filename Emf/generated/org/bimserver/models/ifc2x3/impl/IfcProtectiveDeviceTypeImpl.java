...
public class IfcProtectiveDeviceTypeImpl extends IfcFlowControllerTypeImpl implements IfcProtectiveDeviceType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PROTECTIVE_DEVICE_TYPE;
	}
	...
	public IfcProtectiveDeviceTypeEnum getPredefinedType() {
		return (IfcProtectiveDeviceTypeEnum) eGet(Ifc2x3Package.Literals.IFC_PROTECTIVE_DEVICE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcProtectiveDeviceTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_PROTECTIVE_DEVICE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_PROTECTIVE_DEVICE_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_PROTECTIVE_DEVICE_TYPE__PREDEFINED_TYPE);
	}
