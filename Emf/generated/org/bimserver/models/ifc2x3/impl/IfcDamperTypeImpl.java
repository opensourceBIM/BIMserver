...
public class IfcDamperTypeImpl extends IfcFlowControllerTypeImpl implements IfcDamperType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_DAMPER_TYPE;
	}
	...
	public IfcDamperTypeEnum getPredefinedType() {
		return (IfcDamperTypeEnum) eGet(Ifc2x3Package.Literals.IFC_DAMPER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcDamperTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_DAMPER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_DAMPER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_DAMPER_TYPE__PREDEFINED_TYPE);
	}
