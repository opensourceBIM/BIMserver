...
public class IfcLightSourceDirectionalImpl extends IfcLightSourceImpl implements IfcLightSourceDirectional {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_LIGHT_SOURCE_DIRECTIONAL;
	}
	...
	public IfcDirection getOrientation() {
		return (IfcDirection) eGet(Ifc2x3Package.Literals.IFC_LIGHT_SOURCE_DIRECTIONAL__ORIENTATION, true);
	}
