...
public class IfcPipeFittingTypeImpl extends IfcFlowFittingTypeImpl implements IfcPipeFittingType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PIPE_FITTING_TYPE;
	}
	...
	public IfcPipeFittingTypeEnum getPredefinedType() {
		return (IfcPipeFittingTypeEnum) eGet(Ifc2x3Package.Literals.IFC_PIPE_FITTING_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcPipeFittingTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_PIPE_FITTING_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_PIPE_FITTING_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_PIPE_FITTING_TYPE__PREDEFINED_TYPE);
	}
