...
public class IfcBuildingElementProxyImpl extends IfcBuildingElementImpl implements IfcBuildingElementProxy {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_BUILDING_ELEMENT_PROXY;
	}
	...
	public IfcElementCompositionEnum getCompositionType() {
		return (IfcElementCompositionEnum) eGet(Ifc2x3Package.Literals.IFC_BUILDING_ELEMENT_PROXY__COMPOSITION_TYPE, true);
	}
