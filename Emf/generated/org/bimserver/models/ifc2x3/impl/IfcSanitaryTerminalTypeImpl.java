...
public class IfcSanitaryTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcSanitaryTerminalType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SANITARY_TERMINAL_TYPE;
	}
	...
	public IfcSanitaryTerminalTypeEnum getPredefinedType() {
		return (IfcSanitaryTerminalTypeEnum) eGet(Ifc2x3Package.Literals.IFC_SANITARY_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSanitaryTerminalTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_SANITARY_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_SANITARY_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SANITARY_TERMINAL_TYPE__PREDEFINED_TYPE);
	}
