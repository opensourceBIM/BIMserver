...
public class IfcOutletTypeImpl extends IfcFlowTerminalTypeImpl implements IfcOutletType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_OUTLET_TYPE;
	}
	...
	public IfcOutletTypeEnum getPredefinedType() {
		return (IfcOutletTypeEnum) eGet(Ifc2x3Package.Literals.IFC_OUTLET_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcOutletTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_OUTLET_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_OUTLET_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_OUTLET_TYPE__PREDEFINED_TYPE);
	}
