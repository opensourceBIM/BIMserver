...
public class IfcAlarmTypeImpl extends IfcDistributionControlElementTypeImpl implements IfcAlarmType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_ALARM_TYPE;
	}
	...
	public IfcAlarmTypeEnum getPredefinedType() {
		return (IfcAlarmTypeEnum) eGet(Ifc2x3Package.Literals.IFC_ALARM_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcAlarmTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_ALARM_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_ALARM_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_ALARM_TYPE__PREDEFINED_TYPE);
	}
