...
public class IfcRelVoidsElementImpl extends IfcRelConnectsImpl implements IfcRelVoidsElement {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_REL_VOIDS_ELEMENT;
	}
	...
	public IfcElement getRelatingBuildingElement() {
		return (IfcElement) eGet(Ifc2x3Package.Literals.IFC_REL_VOIDS_ELEMENT__RELATING_BUILDING_ELEMENT, true);
	}
	...
	public void setRelatingBuildingElement(IfcElement newRelatingBuildingElement) {
		eSet(Ifc2x3Package.Literals.IFC_REL_VOIDS_ELEMENT__RELATING_BUILDING_ELEMENT, newRelatingBuildingElement);
	}
