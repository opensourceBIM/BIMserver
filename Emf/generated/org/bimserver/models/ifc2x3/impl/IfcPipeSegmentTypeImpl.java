...
public class IfcPipeSegmentTypeImpl extends IfcFlowSegmentTypeImpl implements IfcPipeSegmentType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_PIPE_SEGMENT_TYPE;
	}
	...
	public IfcPipeSegmentTypeEnum getPredefinedType() {
		return (IfcPipeSegmentTypeEnum) eGet(Ifc2x3Package.Literals.IFC_PIPE_SEGMENT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcPipeSegmentTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_PIPE_SEGMENT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_PIPE_SEGMENT_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_PIPE_SEGMENT_TYPE__PREDEFINED_TYPE);
	}
