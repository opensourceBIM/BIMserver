...
public class IfcFootingImpl extends IfcBuildingElementImpl implements IfcFooting {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_FOOTING;
	}
	...
	public IfcFootingTypeEnum getPredefinedType() {
		return (IfcFootingTypeEnum) eGet(Ifc2x3Package.Literals.IFC_FOOTING__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcFootingTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_FOOTING__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_FOOTING__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_FOOTING__PREDEFINED_TYPE);
	}
