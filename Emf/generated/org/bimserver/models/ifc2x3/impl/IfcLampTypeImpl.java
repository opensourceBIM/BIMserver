...
public class IfcLampTypeImpl extends IfcFlowTerminalTypeImpl implements IfcLampType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_LAMP_TYPE;
	}
	...
	public IfcLampTypeEnum getPredefinedType() {
		return (IfcLampTypeEnum) eGet(Ifc2x3Package.Literals.IFC_LAMP_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcLampTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_LAMP_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_LAMP_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_LAMP_TYPE__PREDEFINED_TYPE);
	}
