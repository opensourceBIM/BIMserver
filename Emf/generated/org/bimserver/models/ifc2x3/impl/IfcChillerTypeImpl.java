...
public class IfcChillerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcChillerType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_CHILLER_TYPE;
	}
	...
	public IfcChillerTypeEnum getPredefinedType() {
		return (IfcChillerTypeEnum) eGet(Ifc2x3Package.Literals.IFC_CHILLER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcChillerTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_CHILLER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_CHILLER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_CHILLER_TYPE__PREDEFINED_TYPE);
	}
