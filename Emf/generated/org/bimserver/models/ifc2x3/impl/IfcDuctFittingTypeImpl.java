...
public class IfcDuctFittingTypeImpl extends IfcFlowFittingTypeImpl implements IfcDuctFittingType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_DUCT_FITTING_TYPE;
	}
	...
	public IfcDuctFittingTypeEnum getPredefinedType() {
		return (IfcDuctFittingTypeEnum) eGet(Ifc2x3Package.Literals.IFC_DUCT_FITTING_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcDuctFittingTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_DUCT_FITTING_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_DUCT_FITTING_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_DUCT_FITTING_TYPE__PREDEFINED_TYPE);
	}
