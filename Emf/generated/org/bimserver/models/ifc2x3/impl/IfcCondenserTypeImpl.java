...
public class IfcCondenserTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCondenserType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_CONDENSER_TYPE;
	}
	...
	public IfcCondenserTypeEnum getPredefinedType() {
		return (IfcCondenserTypeEnum) eGet(Ifc2x3Package.Literals.IFC_CONDENSER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCondenserTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_CONDENSER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_CONDENSER_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_CONDENSER_TYPE__PREDEFINED_TYPE);
	}
