...
public class IfcColumnTypeImpl extends IfcBuildingElementTypeImpl implements IfcColumnType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_COLUMN_TYPE;
	}
	...
	public IfcColumnTypeEnum getPredefinedType() {
		return (IfcColumnTypeEnum) eGet(Ifc2x3Package.Literals.IFC_COLUMN_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcColumnTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_COLUMN_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_COLUMN_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_COLUMN_TYPE__PREDEFINED_TYPE);
	}
