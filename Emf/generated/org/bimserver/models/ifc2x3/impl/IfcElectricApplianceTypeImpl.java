...
public class IfcElectricApplianceTypeImpl extends IfcFlowTerminalTypeImpl implements IfcElectricApplianceType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_ELECTRIC_APPLIANCE_TYPE;
	}
	...
	public IfcElectricApplianceTypeEnum getPredefinedType() {
		return (IfcElectricApplianceTypeEnum) eGet(Ifc2x3Package.Literals.IFC_ELECTRIC_APPLIANCE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcElectricApplianceTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_ELECTRIC_APPLIANCE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_ELECTRIC_APPLIANCE_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_ELECTRIC_APPLIANCE_TYPE__PREDEFINED_TYPE);
	}
