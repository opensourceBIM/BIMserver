...
public class IfcTimeSeriesReferenceRelationshipImpl extends IdEObjectImpl implements IfcTimeSeriesReferenceRelationship {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_TIME_SERIES_REFERENCE_RELATIONSHIP;
	}
	...
	public IfcTimeSeries getReferencedTimeSeries() {
		return (IfcTimeSeries) eGet(Ifc2x3Package.Literals.IFC_TIME_SERIES_REFERENCE_RELATIONSHIP__REFERENCED_TIME_SERIES, true);
	}
	...
	public void setReferencedTimeSeries(IfcTimeSeries newReferencedTimeSeries) {
		eSet(Ifc2x3Package.Literals.IFC_TIME_SERIES_REFERENCE_RELATIONSHIP__REFERENCED_TIME_SERIES, newReferencedTimeSeries);
	}
