...
public class IfcCableSegmentTypeImpl extends IfcFlowSegmentTypeImpl implements IfcCableSegmentType {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_CABLE_SEGMENT_TYPE;
	}
	...
	public IfcCableSegmentTypeEnum getPredefinedType() {
		return (IfcCableSegmentTypeEnum) eGet(Ifc2x3Package.Literals.IFC_CABLE_SEGMENT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCableSegmentTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_CABLE_SEGMENT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_CABLE_SEGMENT_TYPE__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_CABLE_SEGMENT_TYPE__PREDEFINED_TYPE);
	}
