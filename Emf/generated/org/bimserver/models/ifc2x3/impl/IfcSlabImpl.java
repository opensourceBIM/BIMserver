...
public class IfcSlabImpl extends IfcBuildingElementImpl implements IfcSlab {
	...
	protected EClass eStaticClass() {
		return Ifc2x3Package.Literals.IFC_SLAB;
	}
	...
	public IfcSlabTypeEnum getPredefinedType() {
		return (IfcSlabTypeEnum) eGet(Ifc2x3Package.Literals.IFC_SLAB__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSlabTypeEnum newPredefinedType) {
		eSet(Ifc2x3Package.Literals.IFC_SLAB__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc2x3Package.Literals.IFC_SLAB__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc2x3Package.Literals.IFC_SLAB__PREDEFINED_TYPE);
	}
