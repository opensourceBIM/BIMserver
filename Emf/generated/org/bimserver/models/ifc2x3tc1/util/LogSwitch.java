 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc2x3tc1.LogPackage
 * @generated
 */
public class LogSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case LogPackage.IFC_ACTOR_SELECT: {
		...
		case LogPackage.IFC_APPLIED_VALUE_SELECT: {
		...
		case LogPackage.IFC_AXIS2_PLACEMENT: {
		...
		case LogPackage.IFC_BOOLEAN_OPERAND: {
		...
		case LogPackage.IFC_CHARACTER_STYLE_SELECT: {
		...
		case LogPackage.IFC_CLASSIFICATION_NOTATION_SELECT: {
		...
		case LogPackage.IFC_COLOUR_OR_FACTOR: {
		...
		case LogPackage.IFC_CONDITION_CRITERION_SELECT: {
		...
		case LogPackage.IFC_CSG_SELECT: {
		...
		case LogPackage.IFC_CURVE_FONT_OR_SCALED_CURVE_FONT_SELECT: {
		...
		case LogPackage.IFC_CURVE_OR_EDGE_CURVE: {
		...
		case LogPackage.IFC_CURVE_STYLE_FONT_SELECT: {
		...
		case LogPackage.IFC_DATE_TIME_SELECT: {
		...
		case LogPackage.IFC_DEFINED_SYMBOL_SELECT: {
		...
		case LogPackage.IFC_DERIVED_MEASURE_VALUE: {
		...
		case LogPackage.IFC_DOCUMENT_SELECT: {
		...
		case LogPackage.IFC_DRAUGHTING_CALLOUT_ELEMENT: {
		...
		case LogPackage.IFC_FILL_AREA_STYLE_TILE_SHAPE_SELECT: {
		...
		case LogPackage.IFC_FILL_STYLE_SELECT: {
		...
		case LogPackage.IFC_GEOMETRIC_SET_SELECT: {
		...
		case LogPackage.IFC_HATCH_LINE_DISTANCE_SELECT: {
		...
		case LogPackage.IFC_LAYERED_ITEM: {
		...
		case LogPackage.IFC_LIBRARY_SELECT: {
		...
		case LogPackage.IFC_LIGHT_DISTRIBUTION_DATA_SOURCE_SELECT: {
		...
		case LogPackage.IFC_MATERIAL_SELECT: {
		...
		case LogPackage.IFC_MEASURE_VALUE: {
		...
		case LogPackage.IFC_METRIC_VALUE_SELECT: {
		...
		case LogPackage.IFC_OBJECT_REFERENCE_SELECT: {
		...
		case LogPackage.IFC_ORIENTATION_SELECT: {
		...
		case LogPackage.IFC_POINT_OR_VERTEX_POINT: {
		...
		case LogPackage.IFC_PRESENTATION_STYLE_SELECT: {
		...
		case LogPackage.IFC_SIMPLE_VALUE: {
		...
		case LogPackage.IFC_SIZE_SELECT: {
		...
		case LogPackage.IFC_SPECULAR_HIGHLIGHT_SELECT: {
		...
		case LogPackage.IFC_STRUCTURAL_ACTIVITY_ASSIGNMENT_SELECT: {
		...
		case LogPackage.IFC_SURFACE_OR_FACE_SURFACE: {
		...
		case LogPackage.IFC_SURFACE_STYLE_ELEMENT_SELECT: {
		...
		case LogPackage.IFC_SYMBOL_STYLE_SELECT: {
		...
		case LogPackage.IFC_TEXT_FONT_SELECT: {
		...
		case LogPackage.IFC_TEXT_STYLE_SELECT: {
		...
		case LogPackage.IFC_TRIMMING_SELECT: {
		...
		case LogPackage.IFC_VECTOR_OR_DIRECTION: {
