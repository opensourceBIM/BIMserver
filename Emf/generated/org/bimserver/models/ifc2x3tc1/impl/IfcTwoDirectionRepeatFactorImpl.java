...
public class IfcTwoDirectionRepeatFactorImpl extends IfcOneDirectionRepeatFactorImpl implements IfcTwoDirectionRepeatFactor {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TWO_DIRECTION_REPEAT_FACTOR;
	}
	...
	public IfcVector getSecondRepeatFactor() {
		return (IfcVector) eGet(LogPackage.Literals.IFC_TWO_DIRECTION_REPEAT_FACTOR__SECOND_REPEAT_FACTOR, true);
	}
	...
	public void setSecondRepeatFactor(IfcVector newSecondRepeatFactor) {
		eSet(LogPackage.Literals.IFC_TWO_DIRECTION_REPEAT_FACTOR__SECOND_REPEAT_FACTOR, newSecondRepeatFactor);
	}
