...
public class IfcObjectiveImpl extends IfcConstraintImpl implements IfcObjective {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_OBJECTIVE;
	}
	...
	public IfcMetric getBenchmarkValues() {
		return (IfcMetric) eGet(LogPackage.Literals.IFC_OBJECTIVE__BENCHMARK_VALUES, true);
	}
	...
	public void setBenchmarkValues(IfcMetric newBenchmarkValues) {
		eSet(LogPackage.Literals.IFC_OBJECTIVE__BENCHMARK_VALUES, newBenchmarkValues);
	}
	...
	public void unsetBenchmarkValues() {
		eUnset(LogPackage.Literals.IFC_OBJECTIVE__BENCHMARK_VALUES);
	}
	...
	public boolean isSetBenchmarkValues() {
		return eIsSet(LogPackage.Literals.IFC_OBJECTIVE__BENCHMARK_VALUES);
	}
	...
	public IfcMetric getResultValues() {
		return (IfcMetric) eGet(LogPackage.Literals.IFC_OBJECTIVE__RESULT_VALUES, true);
	}
	...
	public void setResultValues(IfcMetric newResultValues) {
		eSet(LogPackage.Literals.IFC_OBJECTIVE__RESULT_VALUES, newResultValues);
	}
	...
	public void unsetResultValues() {
		eUnset(LogPackage.Literals.IFC_OBJECTIVE__RESULT_VALUES);
	}
	...
	public boolean isSetResultValues() {
		return eIsSet(LogPackage.Literals.IFC_OBJECTIVE__RESULT_VALUES);
	}
	...
	public IfcObjectiveEnum getObjectiveQualifier() {
		return (IfcObjectiveEnum) eGet(LogPackage.Literals.IFC_OBJECTIVE__OBJECTIVE_QUALIFIER, true);
	}
	...
	public void setObjectiveQualifier(IfcObjectiveEnum newObjectiveQualifier) {
		eSet(LogPackage.Literals.IFC_OBJECTIVE__OBJECTIVE_QUALIFIER, newObjectiveQualifier);
	}
	...
	public String getUserDefinedQualifier() {
		return (String) eGet(LogPackage.Literals.IFC_OBJECTIVE__USER_DEFINED_QUALIFIER, true);
	}
	...
	public void setUserDefinedQualifier(String newUserDefinedQualifier) {
		eSet(LogPackage.Literals.IFC_OBJECTIVE__USER_DEFINED_QUALIFIER, newUserDefinedQualifier);
	}
	...
	public void unsetUserDefinedQualifier() {
		eUnset(LogPackage.Literals.IFC_OBJECTIVE__USER_DEFINED_QUALIFIER);
	}
	...
	public boolean isSetUserDefinedQualifier() {
		return eIsSet(LogPackage.Literals.IFC_OBJECTIVE__USER_DEFINED_QUALIFIER);
	}
