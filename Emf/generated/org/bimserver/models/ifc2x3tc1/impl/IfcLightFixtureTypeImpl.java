...
public class IfcLightFixtureTypeImpl extends IfcFlowTerminalTypeImpl implements IfcLightFixtureType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LIGHT_FIXTURE_TYPE;
	}
	...
	public IfcLightFixtureTypeEnum getPredefinedType() {
		return (IfcLightFixtureTypeEnum) eGet(LogPackage.Literals.IFC_LIGHT_FIXTURE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcLightFixtureTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_LIGHT_FIXTURE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
