...
public class IfcStructuralSurfaceMemberVaryingImpl extends IfcStructuralSurfaceMemberImpl implements IfcStructuralSurfaceMemberVarying {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING;
	}
	...
	public EList<Double> getSubsequentThickness() {
		return (EList<Double>) eGet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__SUBSEQUENT_THICKNESS, true);
	}
	...
	public EList<String> getSubsequentThicknessAsString() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__SUBSEQUENT_THICKNESS_AS_STRING, true);
	}
	...
	public IfcShapeAspect getVaryingThicknessLocation() {
		return (IfcShapeAspect) eGet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS_LOCATION, true);
	}
	...
	public void setVaryingThicknessLocation(IfcShapeAspect newVaryingThicknessLocation) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS_LOCATION, newVaryingThicknessLocation);
	}
	...
	public double getVaryingThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS, true);
	}
	...
	public void setVaryingThickness(double newVaryingThickness) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS, newVaryingThickness);
	}
	...
	public void unsetVaryingThickness() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS);
	}
	...
	public boolean isSetVaryingThickness() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS);
	}
	...
	public String getVaryingThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS_AS_STRING, true);
	}
	...
	public void setVaryingThicknessAsString(String newVaryingThicknessAsString) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS_AS_STRING, newVaryingThicknessAsString);
	}
	...
	public void unsetVaryingThicknessAsString() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS_AS_STRING);
	}
	...
	public boolean isSetVaryingThicknessAsString() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING__VARYING_THICKNESS_AS_STRING);
	}
