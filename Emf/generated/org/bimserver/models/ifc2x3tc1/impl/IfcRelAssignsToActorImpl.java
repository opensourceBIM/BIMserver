...
public class IfcRelAssignsToActorImpl extends IfcRelAssignsImpl implements IfcRelAssignsToActor {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSIGNS_TO_ACTOR;
	}
	...
	public IfcActor getRelatingActor() {
		return (IfcActor) eGet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_ACTOR__RELATING_ACTOR, true);
	}
	...
	public void setRelatingActor(IfcActor newRelatingActor) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_ACTOR__RELATING_ACTOR, newRelatingActor);
	}
	...
	public IfcActorRole getActingRole() {
		return (IfcActorRole) eGet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_ACTOR__ACTING_ROLE, true);
	}
	...
	public void setActingRole(IfcActorRole newActingRole) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_ACTOR__ACTING_ROLE, newActingRole);
	}
	...
	public void unsetActingRole() {
		eUnset(LogPackage.Literals.IFC_REL_ASSIGNS_TO_ACTOR__ACTING_ROLE);
	}
	...
	public boolean isSetActingRole() {
		return eIsSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_ACTOR__ACTING_ROLE);
	}
