...
public class IfcCircleImpl extends IfcConicImpl implements IfcCircle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CIRCLE;
	}
	...
	public double getRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_CIRCLE__RADIUS, true);
	}
	...
	public void setRadius(double newRadius) {
		eSet(LogPackage.Literals.IFC_CIRCLE__RADIUS, newRadius);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CIRCLE__RADIUS_AS_STRING, true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(LogPackage.Literals.IFC_CIRCLE__RADIUS_AS_STRING, newRadiusAsString);
	}
