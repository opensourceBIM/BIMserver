...
public class IfcRelCoversSpacesImpl extends IfcRelConnectsImpl implements IfcRelCoversSpaces {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_COVERS_SPACES;
	}
	...
	public IfcSpace getRelatedSpace() {
		return (IfcSpace) eGet(LogPackage.Literals.IFC_REL_COVERS_SPACES__RELATED_SPACE, true);
	}
	...
	public void setRelatedSpace(IfcSpace newRelatedSpace) {
		eSet(LogPackage.Literals.IFC_REL_COVERS_SPACES__RELATED_SPACE, newRelatedSpace);
	}
	...
	public EList<IfcCovering> getRelatedCoverings() {
		return (EList<IfcCovering>) eGet(LogPackage.Literals.IFC_REL_COVERS_SPACES__RELATED_COVERINGS, true);
	}
