...
public class IfcTextureVertexImpl extends IdEObjectImpl implements IfcTextureVertex {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEXTURE_VERTEX;
	}
	...
	public EList<Double> getCoordinates() {
		return (EList<Double>) eGet(LogPackage.Literals.IFC_TEXTURE_VERTEX__COORDINATES, true);
	}
	...
	public EList<String> getCoordinatesAsString() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_TEXTURE_VERTEX__COORDINATES_AS_STRING, true);
	}
