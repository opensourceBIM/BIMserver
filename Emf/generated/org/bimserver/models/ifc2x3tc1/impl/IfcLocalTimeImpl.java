...
public class IfcLocalTimeImpl extends IdEObjectImpl implements IfcLocalTime {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LOCAL_TIME;
	}
	...
	public int getHourComponent() {
		return (Integer) eGet(LogPackage.Literals.IFC_LOCAL_TIME__HOUR_COMPONENT, true);
	}
	...
	public void setHourComponent(int newHourComponent) {
		eSet(LogPackage.Literals.IFC_LOCAL_TIME__HOUR_COMPONENT, newHourComponent);
	}
	...
	public int getMinuteComponent() {
		return (Integer) eGet(LogPackage.Literals.IFC_LOCAL_TIME__MINUTE_COMPONENT, true);
	}
	...
	public void setMinuteComponent(int newMinuteComponent) {
		eSet(LogPackage.Literals.IFC_LOCAL_TIME__MINUTE_COMPONENT, newMinuteComponent);
	}
	...
	public void unsetMinuteComponent() {
		eUnset(LogPackage.Literals.IFC_LOCAL_TIME__MINUTE_COMPONENT);
	}
	...
	public boolean isSetMinuteComponent() {
		return eIsSet(LogPackage.Literals.IFC_LOCAL_TIME__MINUTE_COMPONENT);
	}
	...
	public double getSecondComponent() {
		return (Double) eGet(LogPackage.Literals.IFC_LOCAL_TIME__SECOND_COMPONENT, true);
	}
	...
	public void setSecondComponent(double newSecondComponent) {
		eSet(LogPackage.Literals.IFC_LOCAL_TIME__SECOND_COMPONENT, newSecondComponent);
	}
	...
	public void unsetSecondComponent() {
		eUnset(LogPackage.Literals.IFC_LOCAL_TIME__SECOND_COMPONENT);
	}
	...
	public boolean isSetSecondComponent() {
		return eIsSet(LogPackage.Literals.IFC_LOCAL_TIME__SECOND_COMPONENT);
	}
	...
	public String getSecondComponentAsString() {
		return (String) eGet(LogPackage.Literals.IFC_LOCAL_TIME__SECOND_COMPONENT_AS_STRING, true);
	}
	...
	public void setSecondComponentAsString(String newSecondComponentAsString) {
		eSet(LogPackage.Literals.IFC_LOCAL_TIME__SECOND_COMPONENT_AS_STRING, newSecondComponentAsString);
	}
	...
	public void unsetSecondComponentAsString() {
		eUnset(LogPackage.Literals.IFC_LOCAL_TIME__SECOND_COMPONENT_AS_STRING);
	}
	...
	public boolean isSetSecondComponentAsString() {
		return eIsSet(LogPackage.Literals.IFC_LOCAL_TIME__SECOND_COMPONENT_AS_STRING);
	}
	...
	public IfcCoordinatedUniversalTimeOffset getZone() {
		return (IfcCoordinatedUniversalTimeOffset) eGet(LogPackage.Literals.IFC_LOCAL_TIME__ZONE, true);
	}
	...
	public void setZone(IfcCoordinatedUniversalTimeOffset newZone) {
		eSet(LogPackage.Literals.IFC_LOCAL_TIME__ZONE, newZone);
	}
	...
	public void unsetZone() {
		eUnset(LogPackage.Literals.IFC_LOCAL_TIME__ZONE);
	}
	...
	public boolean isSetZone() {
		return eIsSet(LogPackage.Literals.IFC_LOCAL_TIME__ZONE);
	}
	...
	public int getDaylightSavingOffset() {
		return (Integer) eGet(LogPackage.Literals.IFC_LOCAL_TIME__DAYLIGHT_SAVING_OFFSET, true);
	}
	...
	public void setDaylightSavingOffset(int newDaylightSavingOffset) {
		eSet(LogPackage.Literals.IFC_LOCAL_TIME__DAYLIGHT_SAVING_OFFSET, newDaylightSavingOffset);
	}
	...
	public void unsetDaylightSavingOffset() {
		eUnset(LogPackage.Literals.IFC_LOCAL_TIME__DAYLIGHT_SAVING_OFFSET);
	}
	...
	public boolean isSetDaylightSavingOffset() {
		return eIsSet(LogPackage.Literals.IFC_LOCAL_TIME__DAYLIGHT_SAVING_OFFSET);
	}
