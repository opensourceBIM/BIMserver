...
public class IfcEvaporativeCoolerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcEvaporativeCoolerType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_EVAPORATIVE_COOLER_TYPE;
	}
	...
	public IfcEvaporativeCoolerTypeEnum getPredefinedType() {
		return (IfcEvaporativeCoolerTypeEnum) eGet(LogPackage.Literals.IFC_EVAPORATIVE_COOLER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcEvaporativeCoolerTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_EVAPORATIVE_COOLER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
