...
public class IfcRelAssociatesMaterialImpl extends IfcRelAssociatesImpl implements IfcRelAssociatesMaterial {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSOCIATES_MATERIAL;
	}
	...
	public IfcMaterialSelect getRelatingMaterial() {
		return (IfcMaterialSelect) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_MATERIAL__RELATING_MATERIAL, true);
	}
	...
	public void setRelatingMaterial(IfcMaterialSelect newRelatingMaterial) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_MATERIAL__RELATING_MATERIAL, newRelatingMaterial);
	}
