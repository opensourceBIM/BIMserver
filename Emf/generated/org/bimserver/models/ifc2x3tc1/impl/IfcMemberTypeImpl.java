...
public class IfcMemberTypeImpl extends IfcBuildingElementTypeImpl implements IfcMemberType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MEMBER_TYPE;
	}
	...
	public IfcMemberTypeEnum getPredefinedType() {
		return (IfcMemberTypeEnum) eGet(LogPackage.Literals.IFC_MEMBER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcMemberTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_MEMBER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
