...
public class IfcDefinedSymbolImpl extends IfcGeometricRepresentationItemImpl implements IfcDefinedSymbol {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DEFINED_SYMBOL;
	}
	...
	public IfcDefinedSymbolSelect getDefinition() {
		return (IfcDefinedSymbolSelect) eGet(LogPackage.Literals.IFC_DEFINED_SYMBOL__DEFINITION, true);
	}
	...
	public void setDefinition(IfcDefinedSymbolSelect newDefinition) {
		eSet(LogPackage.Literals.IFC_DEFINED_SYMBOL__DEFINITION, newDefinition);
	}
	...
	public IfcCartesianTransformationOperator2D getTarget() {
		return (IfcCartesianTransformationOperator2D) eGet(LogPackage.Literals.IFC_DEFINED_SYMBOL__TARGET, true);
	}
	...
	public void setTarget(IfcCartesianTransformationOperator2D newTarget) {
		eSet(LogPackage.Literals.IFC_DEFINED_SYMBOL__TARGET, newTarget);
	}
