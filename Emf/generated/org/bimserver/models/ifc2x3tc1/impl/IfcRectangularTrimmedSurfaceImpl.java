...
public class IfcRectangularTrimmedSurfaceImpl extends IfcBoundedSurfaceImpl implements IfcRectangularTrimmedSurface {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE;
	}
	...
	public IfcSurface getBasisSurface() {
		return (IfcSurface) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__BASIS_SURFACE, true);
	}
	...
	public void setBasisSurface(IfcSurface newBasisSurface) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__BASIS_SURFACE, newBasisSurface);
	}
	 ...
	 */
	public double getU1() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U1, true);
	}
	...
	public void setU1(double newU1) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U1, newU1);
	}
	...
	public String getU1AsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U1_AS_STRING, true);
	}
	...
	public void setU1AsString(String newU1AsString) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U1_AS_STRING, newU1AsString);
	}
	 ...
	 */
	public double getV1() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V1, true);
	}
	...
	public void setV1(double newV1) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V1, newV1);
	}
	...
	public String getV1AsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V1_AS_STRING, true);
	}
	...
	public void setV1AsString(String newV1AsString) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V1_AS_STRING, newV1AsString);
	}
	 ...
	 */
	public double getU2() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U2, true);
	}
	...
	public void setU2(double newU2) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U2, newU2);
	}
	...
	public String getU2AsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U2_AS_STRING, true);
	}
	...
	public void setU2AsString(String newU2AsString) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U2_AS_STRING, newU2AsString);
	}
	 ...
	 */
	public double getV2() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V2, true);
	}
	...
	public void setV2(double newV2) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V2, newV2);
	}
	...
	public String getV2AsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V2_AS_STRING, true);
	}
	...
	public void setV2AsString(String newV2AsString) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V2_AS_STRING, newV2AsString);
	}
	...
	public Tristate getUsense() {
		return (Tristate) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__USENSE, true);
	}
	...
	public void setUsense(Tristate newUsense) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__USENSE, newUsense);
	}
	...
	public Tristate getVsense() {
		return (Tristate) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__VSENSE, true);
	}
	...
	public void setVsense(Tristate newVsense) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__VSENSE, newVsense);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__DIM);
	}
