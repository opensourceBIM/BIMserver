...
public class IfcRectangleHollowProfileDefImpl extends IfcRectangleProfileDefImpl implements IfcRectangleHollowProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF;
	}
	...
	public double getWallThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS, true);
	}
	...
	public void setWallThickness(double newWallThickness) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS, newWallThickness);
	}
	...
	public String getWallThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING, true);
	}
	...
	public void setWallThicknessAsString(String newWallThicknessAsString) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING, newWallThicknessAsString);
	}
	...
	public double getInnerFilletRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS, true);
	}
	...
	public void setInnerFilletRadius(double newInnerFilletRadius) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS, newInnerFilletRadius);
	}
	...
	public void unsetInnerFilletRadius() {
		eUnset(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS);
	}
	...
	public boolean isSetInnerFilletRadius() {
		return eIsSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS);
	}
	...
	public String getInnerFilletRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS_AS_STRING, true);
	}
	...
	public void setInnerFilletRadiusAsString(String newInnerFilletRadiusAsString) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS_AS_STRING, newInnerFilletRadiusAsString);
	}
	...
	public void unsetInnerFilletRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS_AS_STRING);
	}
	...
	public boolean isSetInnerFilletRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS_AS_STRING);
	}
	...
	public double getOuterFilletRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS, true);
	}
	...
	public void setOuterFilletRadius(double newOuterFilletRadius) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS, newOuterFilletRadius);
	}
	...
	public void unsetOuterFilletRadius() {
		eUnset(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS);
	}
	...
	public boolean isSetOuterFilletRadius() {
		return eIsSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS);
	}
	...
	public String getOuterFilletRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS_AS_STRING, true);
	}
	...
	public void setOuterFilletRadiusAsString(String newOuterFilletRadiusAsString) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS_AS_STRING, newOuterFilletRadiusAsString);
	}
	...
	public void unsetOuterFilletRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS_AS_STRING);
	}
	...
	public boolean isSetOuterFilletRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS_AS_STRING);
	}
