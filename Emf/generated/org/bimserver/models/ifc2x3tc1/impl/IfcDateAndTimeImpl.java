...
public class IfcDateAndTimeImpl extends IdEObjectImpl implements IfcDateAndTime {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DATE_AND_TIME;
	}
	...
	public IfcCalendarDate getDateComponent() {
		return (IfcCalendarDate) eGet(LogPackage.Literals.IFC_DATE_AND_TIME__DATE_COMPONENT, true);
	}
	...
	public void setDateComponent(IfcCalendarDate newDateComponent) {
		eSet(LogPackage.Literals.IFC_DATE_AND_TIME__DATE_COMPONENT, newDateComponent);
	}
	...
	public IfcLocalTime getTimeComponent() {
		return (IfcLocalTime) eGet(LogPackage.Literals.IFC_DATE_AND_TIME__TIME_COMPONENT, true);
	}
	...
	public void setTimeComponent(IfcLocalTime newTimeComponent) {
		eSet(LogPackage.Literals.IFC_DATE_AND_TIME__TIME_COMPONENT, newTimeComponent);
	}
