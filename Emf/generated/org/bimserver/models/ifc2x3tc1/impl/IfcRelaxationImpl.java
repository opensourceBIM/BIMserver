...
public class IfcRelaxationImpl extends IdEObjectImpl implements IfcRelaxation {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RELAXATION;
	}
	...
	public double getRelaxationValue() {
		return (Double) eGet(LogPackage.Literals.IFC_RELAXATION__RELAXATION_VALUE, true);
	}
	...
	public void setRelaxationValue(double newRelaxationValue) {
		eSet(LogPackage.Literals.IFC_RELAXATION__RELAXATION_VALUE, newRelaxationValue);
	}
	...
	public String getRelaxationValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RELAXATION__RELAXATION_VALUE_AS_STRING, true);
	}
	...
	public void setRelaxationValueAsString(String newRelaxationValueAsString) {
		eSet(LogPackage.Literals.IFC_RELAXATION__RELAXATION_VALUE_AS_STRING, newRelaxationValueAsString);
	}
	...
	public double getInitialStress() {
		return (Double) eGet(LogPackage.Literals.IFC_RELAXATION__INITIAL_STRESS, true);
	}
	...
	public void setInitialStress(double newInitialStress) {
		eSet(LogPackage.Literals.IFC_RELAXATION__INITIAL_STRESS, newInitialStress);
	}
	...
	public String getInitialStressAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RELAXATION__INITIAL_STRESS_AS_STRING, true);
	}
	...
	public void setInitialStressAsString(String newInitialStressAsString) {
		eSet(LogPackage.Literals.IFC_RELAXATION__INITIAL_STRESS_AS_STRING, newInitialStressAsString);
	}
