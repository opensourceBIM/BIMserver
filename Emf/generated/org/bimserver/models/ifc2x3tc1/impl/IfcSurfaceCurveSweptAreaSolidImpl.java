...
public class IfcSurfaceCurveSweptAreaSolidImpl extends IfcSweptAreaSolidImpl implements IfcSurfaceCurveSweptAreaSolid {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID;
	}
	...
	public IfcCurve getDirectrix() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__DIRECTRIX, true);
	}
	...
	public void setDirectrix(IfcCurve newDirectrix) {
		eSet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__DIRECTRIX, newDirectrix);
	}
	...
	public double getStartParam() {
		return (Double) eGet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__START_PARAM, true);
	}
	...
	public void setStartParam(double newStartParam) {
		eSet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__START_PARAM, newStartParam);
	}
	...
	public String getStartParamAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__START_PARAM_AS_STRING, true);
	}
	...
	public void setStartParamAsString(String newStartParamAsString) {
		eSet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__START_PARAM_AS_STRING, newStartParamAsString);
	}
	...
	public double getEndParam() {
		return (Double) eGet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__END_PARAM, true);
	}
	...
	public void setEndParam(double newEndParam) {
		eSet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__END_PARAM, newEndParam);
	}
	...
	public String getEndParamAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__END_PARAM_AS_STRING, true);
	}
	...
	public void setEndParamAsString(String newEndParamAsString) {
		eSet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__END_PARAM_AS_STRING, newEndParamAsString);
	}
	...
	public IfcSurface getReferenceSurface() {
		return (IfcSurface) eGet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__REFERENCE_SURFACE, true);
	}
	...
	public void setReferenceSurface(IfcSurface newReferenceSurface) {
		eSet(LogPackage.Literals.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID__REFERENCE_SURFACE, newReferenceSurface);
	}
