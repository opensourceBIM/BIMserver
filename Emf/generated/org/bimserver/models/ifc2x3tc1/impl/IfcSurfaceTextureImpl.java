...
public class IfcSurfaceTextureImpl extends IdEObjectImpl implements IfcSurfaceTexture {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_TEXTURE;
	}
	...
	public Tristate getRepeatS() {
		return (Tristate) eGet(LogPackage.Literals.IFC_SURFACE_TEXTURE__REPEAT_S, true);
	}
	...
	public void setRepeatS(Tristate newRepeatS) {
		eSet(LogPackage.Literals.IFC_SURFACE_TEXTURE__REPEAT_S, newRepeatS);
	}
	...
	public Tristate getRepeatT() {
		return (Tristate) eGet(LogPackage.Literals.IFC_SURFACE_TEXTURE__REPEAT_T, true);
	}
	...
	public void setRepeatT(Tristate newRepeatT) {
		eSet(LogPackage.Literals.IFC_SURFACE_TEXTURE__REPEAT_T, newRepeatT);
	}
	...
	public IfcSurfaceTextureEnum getTextureType() {
		return (IfcSurfaceTextureEnum) eGet(LogPackage.Literals.IFC_SURFACE_TEXTURE__TEXTURE_TYPE, true);
	}
	...
	public void setTextureType(IfcSurfaceTextureEnum newTextureType) {
		eSet(LogPackage.Literals.IFC_SURFACE_TEXTURE__TEXTURE_TYPE, newTextureType);
	}
	...
	public IfcCartesianTransformationOperator2D getTextureTransform() {
		return (IfcCartesianTransformationOperator2D) eGet(LogPackage.Literals.IFC_SURFACE_TEXTURE__TEXTURE_TRANSFORM, true);
	}
	...
	public void setTextureTransform(IfcCartesianTransformationOperator2D newTextureTransform) {
		eSet(LogPackage.Literals.IFC_SURFACE_TEXTURE__TEXTURE_TRANSFORM, newTextureTransform);
	}
	...
	public void unsetTextureTransform() {
		eUnset(LogPackage.Literals.IFC_SURFACE_TEXTURE__TEXTURE_TRANSFORM);
	}
	...
	public boolean isSetTextureTransform() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_TEXTURE__TEXTURE_TRANSFORM);
	}
