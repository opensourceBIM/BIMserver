...
public class IfcBooleanResultImpl extends IfcGeometricRepresentationItemImpl implements IfcBooleanResult {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_BOOLEAN_RESULT;
	}
	...
	public IfcBooleanOperator getOperator() {
		return (IfcBooleanOperator) eGet(LogPackage.Literals.IFC_BOOLEAN_RESULT__OPERATOR, true);
	}
	...
	public void setOperator(IfcBooleanOperator newOperator) {
		eSet(LogPackage.Literals.IFC_BOOLEAN_RESULT__OPERATOR, newOperator);
	}
	...
	public IfcBooleanOperand getFirstOperand() {
		return (IfcBooleanOperand) eGet(LogPackage.Literals.IFC_BOOLEAN_RESULT__FIRST_OPERAND, true);
	}
	...
	public void setFirstOperand(IfcBooleanOperand newFirstOperand) {
		eSet(LogPackage.Literals.IFC_BOOLEAN_RESULT__FIRST_OPERAND, newFirstOperand);
	}
	...
	public IfcBooleanOperand getSecondOperand() {
		return (IfcBooleanOperand) eGet(LogPackage.Literals.IFC_BOOLEAN_RESULT__SECOND_OPERAND, true);
	}
	...
	public void setSecondOperand(IfcBooleanOperand newSecondOperand) {
		eSet(LogPackage.Literals.IFC_BOOLEAN_RESULT__SECOND_OPERAND, newSecondOperand);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_BOOLEAN_RESULT__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_BOOLEAN_RESULT__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_BOOLEAN_RESULT__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_BOOLEAN_RESULT__DIM);
	}
