...
public class IfcStructuralLoadSingleForceWarpingImpl extends IfcStructuralLoadSingleForceImpl implements IfcStructuralLoadSingleForceWarping {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING;
	}
	...
	public double getWarpingMoment() {
		return (Double) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING__WARPING_MOMENT, true);
	}
	...
	public void setWarpingMoment(double newWarpingMoment) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING__WARPING_MOMENT, newWarpingMoment);
	}
	...
	public void unsetWarpingMoment() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING__WARPING_MOMENT);
	}
	...
	public boolean isSetWarpingMoment() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING__WARPING_MOMENT);
	}
	...
	public String getWarpingMomentAsString() {
		return (String) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING__WARPING_MOMENT_AS_STRING, true);
	}
	...
	public void setWarpingMomentAsString(String newWarpingMomentAsString) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING__WARPING_MOMENT_AS_STRING, newWarpingMomentAsString);
	}
	...
	public void unsetWarpingMomentAsString() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING__WARPING_MOMENT_AS_STRING);
	}
	...
	public boolean isSetWarpingMomentAsString() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_FORCE_WARPING__WARPING_MOMENT_AS_STRING);
	}
