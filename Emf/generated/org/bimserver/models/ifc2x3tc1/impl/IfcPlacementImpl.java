...
public class IfcPlacementImpl extends IfcGeometricRepresentationItemImpl implements IfcPlacement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PLACEMENT;
	}
	...
	public IfcCartesianPoint getLocation() {
		return (IfcCartesianPoint) eGet(LogPackage.Literals.IFC_PLACEMENT__LOCATION, true);
	}
	...
	public void setLocation(IfcCartesianPoint newLocation) {
		eSet(LogPackage.Literals.IFC_PLACEMENT__LOCATION, newLocation);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_PLACEMENT__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_PLACEMENT__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_PLACEMENT__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_PLACEMENT__DIM);
	}
