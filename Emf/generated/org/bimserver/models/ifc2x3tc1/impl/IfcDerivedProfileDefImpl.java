...
public class IfcDerivedProfileDefImpl extends IfcProfileDefImpl implements IfcDerivedProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DERIVED_PROFILE_DEF;
	}
	...
	public IfcProfileDef getParentProfile() {
		return (IfcProfileDef) eGet(LogPackage.Literals.IFC_DERIVED_PROFILE_DEF__PARENT_PROFILE, true);
	}
	...
	public void setParentProfile(IfcProfileDef newParentProfile) {
		eSet(LogPackage.Literals.IFC_DERIVED_PROFILE_DEF__PARENT_PROFILE, newParentProfile);
	}
	...
	public IfcCartesianTransformationOperator2D getOperator() {
		return (IfcCartesianTransformationOperator2D) eGet(LogPackage.Literals.IFC_DERIVED_PROFILE_DEF__OPERATOR, true);
	}
	...
	public void setOperator(IfcCartesianTransformationOperator2D newOperator) {
		eSet(LogPackage.Literals.IFC_DERIVED_PROFILE_DEF__OPERATOR, newOperator);
	}
	...
	public String getLabel() {
		return (String) eGet(LogPackage.Literals.IFC_DERIVED_PROFILE_DEF__LABEL, true);
	}
	...
	public void setLabel(String newLabel) {
		eSet(LogPackage.Literals.IFC_DERIVED_PROFILE_DEF__LABEL, newLabel);
	}
	...
	public void unsetLabel() {
		eUnset(LogPackage.Literals.IFC_DERIVED_PROFILE_DEF__LABEL);
	}
	...
	public boolean isSetLabel() {
		return eIsSet(LogPackage.Literals.IFC_DERIVED_PROFILE_DEF__LABEL);
	}
