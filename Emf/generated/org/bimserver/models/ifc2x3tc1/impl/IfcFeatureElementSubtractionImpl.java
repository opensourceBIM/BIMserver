...
public class IfcFeatureElementSubtractionImpl extends IfcFeatureElementImpl implements IfcFeatureElementSubtraction {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FEATURE_ELEMENT_SUBTRACTION;
	}
	...
	public IfcRelVoidsElement getVoidsElements() {
		return (IfcRelVoidsElement) eGet(LogPackage.Literals.IFC_FEATURE_ELEMENT_SUBTRACTION__VOIDS_ELEMENTS, true);
	}
	...
	public void setVoidsElements(IfcRelVoidsElement newVoidsElements) {
		eSet(LogPackage.Literals.IFC_FEATURE_ELEMENT_SUBTRACTION__VOIDS_ELEMENTS, newVoidsElements);
	}
	...
	public void unsetVoidsElements() {
		eUnset(LogPackage.Literals.IFC_FEATURE_ELEMENT_SUBTRACTION__VOIDS_ELEMENTS);
	}
	...
	public boolean isSetVoidsElements() {
		return eIsSet(LogPackage.Literals.IFC_FEATURE_ELEMENT_SUBTRACTION__VOIDS_ELEMENTS);
	}
