...
public class IfcProtectiveDeviceTypeImpl extends IfcFlowControllerTypeImpl implements IfcProtectiveDeviceType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROTECTIVE_DEVICE_TYPE;
	}
	...
	public IfcProtectiveDeviceTypeEnum getPredefinedType() {
		return (IfcProtectiveDeviceTypeEnum) eGet(LogPackage.Literals.IFC_PROTECTIVE_DEVICE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcProtectiveDeviceTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_PROTECTIVE_DEVICE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
