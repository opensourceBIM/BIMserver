...
public class IfcObjectPlacementImpl extends IdEObjectImpl implements IfcObjectPlacement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_OBJECT_PLACEMENT;
	}
	...
	public EList<IfcProduct> getPlacesObject() {
		return (EList<IfcProduct>) eGet(LogPackage.Literals.IFC_OBJECT_PLACEMENT__PLACES_OBJECT, true);
	}
	...
	public void unsetPlacesObject() {
		eUnset(LogPackage.Literals.IFC_OBJECT_PLACEMENT__PLACES_OBJECT);
	}
	...
	public boolean isSetPlacesObject() {
		return eIsSet(LogPackage.Literals.IFC_OBJECT_PLACEMENT__PLACES_OBJECT);
	}
	...
	public EList<IfcLocalPlacement> getReferencedByPlacements() {
		return (EList<IfcLocalPlacement>) eGet(LogPackage.Literals.IFC_OBJECT_PLACEMENT__REFERENCED_BY_PLACEMENTS, true);
	}
	...
	public void unsetReferencedByPlacements() {
		eUnset(LogPackage.Literals.IFC_OBJECT_PLACEMENT__REFERENCED_BY_PLACEMENTS);
	}
	...
	public boolean isSetReferencedByPlacements() {
		return eIsSet(LogPackage.Literals.IFC_OBJECT_PLACEMENT__REFERENCED_BY_PLACEMENTS);
	}
