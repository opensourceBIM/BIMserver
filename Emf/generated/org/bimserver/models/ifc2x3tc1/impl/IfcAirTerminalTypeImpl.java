...
public class IfcAirTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcAirTerminalType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_AIR_TERMINAL_TYPE;
	}
	...
	public IfcAirTerminalTypeEnum getPredefinedType() {
		return (IfcAirTerminalTypeEnum) eGet(LogPackage.Literals.IFC_AIR_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcAirTerminalTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_AIR_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
