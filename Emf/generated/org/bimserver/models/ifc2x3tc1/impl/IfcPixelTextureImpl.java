...
public class IfcPixelTextureImpl extends IfcSurfaceTextureImpl implements IfcPixelTexture {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PIXEL_TEXTURE;
	}
	 ...
	 */
	public int getWidth() {
		return (Integer) eGet(LogPackage.Literals.IFC_PIXEL_TEXTURE__WIDTH, true);
	}
	...
	public void setWidth(int newWidth) {
		eSet(LogPackage.Literals.IFC_PIXEL_TEXTURE__WIDTH, newWidth);
	}
	...
	public int getHeight() {
		return (Integer) eGet(LogPackage.Literals.IFC_PIXEL_TEXTURE__HEIGHT, true);
	}
	...
	public void setHeight(int newHeight) {
		eSet(LogPackage.Literals.IFC_PIXEL_TEXTURE__HEIGHT, newHeight);
	}
	...
	public int getColourComponents() {
		return (Integer) eGet(LogPackage.Literals.IFC_PIXEL_TEXTURE__COLOUR_COMPONENTS, true);
	}
	...
	public void setColourComponents(int newColourComponents) {
		eSet(LogPackage.Literals.IFC_PIXEL_TEXTURE__COLOUR_COMPONENTS, newColourComponents);
	}
