...
public class IfcZShapeProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcZShapeProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF;
	}
	...
	public double getDepth() {
		return (Double) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__DEPTH, true);
	}
	...
	public void setDepth(double newDepth) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__DEPTH, newDepth);
	}
	...
	public String getDepthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__DEPTH_AS_STRING, true);
	}
	...
	public void setDepthAsString(String newDepthAsString) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__DEPTH_AS_STRING, newDepthAsString);
	}
	...
	public double getFlangeWidth() {
		return (Double) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FLANGE_WIDTH, true);
	}
	...
	public void setFlangeWidth(double newFlangeWidth) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FLANGE_WIDTH, newFlangeWidth);
	}
	...
	public String getFlangeWidthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FLANGE_WIDTH_AS_STRING, true);
	}
	...
	public void setFlangeWidthAsString(String newFlangeWidthAsString) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FLANGE_WIDTH_AS_STRING, newFlangeWidthAsString);
	}
	...
	public double getWebThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__WEB_THICKNESS, true);
	}
	...
	public void setWebThickness(double newWebThickness) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__WEB_THICKNESS, newWebThickness);
	}
	...
	public String getWebThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, true);
	}
	...
	public void setWebThicknessAsString(String newWebThicknessAsString) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, newWebThicknessAsString);
	}
	...
	public double getFlangeThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FLANGE_THICKNESS, true);
	}
	...
	public void setFlangeThickness(double newFlangeThickness) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FLANGE_THICKNESS, newFlangeThickness);
	}
	...
	public String getFlangeThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING, true);
	}
	...
	public void setFlangeThicknessAsString(String newFlangeThicknessAsString) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING, newFlangeThicknessAsString);
	}
	...
	public double getFilletRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FILLET_RADIUS, true);
	}
	...
	public void setFilletRadius(double newFilletRadius) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FILLET_RADIUS, newFilletRadius);
	}
	...
	public void unsetFilletRadius() {
		eUnset(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FILLET_RADIUS);
	}
	...
	public boolean isSetFilletRadius() {
		return eIsSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FILLET_RADIUS);
	}
	...
	public String getFilletRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING, true);
	}
	...
	public void setFilletRadiusAsString(String newFilletRadiusAsString) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING, newFilletRadiusAsString);
	}
	...
	public void unsetFilletRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING);
	}
	...
	public boolean isSetFilletRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING);
	}
	...
	public double getEdgeRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__EDGE_RADIUS, true);
	}
	...
	public void setEdgeRadius(double newEdgeRadius) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__EDGE_RADIUS, newEdgeRadius);
	}
	...
	public void unsetEdgeRadius() {
		eUnset(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__EDGE_RADIUS);
	}
	...
	public boolean isSetEdgeRadius() {
		return eIsSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__EDGE_RADIUS);
	}
	...
	public String getEdgeRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__EDGE_RADIUS_AS_STRING, true);
	}
	...
	public void setEdgeRadiusAsString(String newEdgeRadiusAsString) {
		eSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__EDGE_RADIUS_AS_STRING, newEdgeRadiusAsString);
	}
	...
	public void unsetEdgeRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__EDGE_RADIUS_AS_STRING);
	}
	...
	public boolean isSetEdgeRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_ZSHAPE_PROFILE_DEF__EDGE_RADIUS_AS_STRING);
	}
