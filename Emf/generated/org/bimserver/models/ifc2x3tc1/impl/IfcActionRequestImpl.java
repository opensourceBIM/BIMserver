...
public class IfcActionRequestImpl extends IfcControlImpl implements IfcActionRequest {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ACTION_REQUEST;
	}
	...
	public String getRequestID() {
		return (String) eGet(LogPackage.Literals.IFC_ACTION_REQUEST__REQUEST_ID, true);
	}
	...
	public void setRequestID(String newRequestID) {
		eSet(LogPackage.Literals.IFC_ACTION_REQUEST__REQUEST_ID, newRequestID);
	}
