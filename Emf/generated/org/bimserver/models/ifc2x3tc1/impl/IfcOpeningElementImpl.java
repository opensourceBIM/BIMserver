...
public class IfcOpeningElementImpl extends IfcFeatureElementSubtractionImpl implements IfcOpeningElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_OPENING_ELEMENT;
	}
	...
	public EList<IfcRelFillsElement> getHasFillings() {
		return (EList<IfcRelFillsElement>) eGet(LogPackage.Literals.IFC_OPENING_ELEMENT__HAS_FILLINGS, true);
	}
	...
	public void unsetHasFillings() {
		eUnset(LogPackage.Literals.IFC_OPENING_ELEMENT__HAS_FILLINGS);
	}
	...
	public boolean isSetHasFillings() {
		return eIsSet(LogPackage.Literals.IFC_OPENING_ELEMENT__HAS_FILLINGS);
	}
