...
public class IfcQuantityWeightImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityWeight {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_QUANTITY_WEIGHT;
	}
	...
	public double getWeightValue() {
		return (Double) eGet(LogPackage.Literals.IFC_QUANTITY_WEIGHT__WEIGHT_VALUE, true);
	}
	...
	public void setWeightValue(double newWeightValue) {
		eSet(LogPackage.Literals.IFC_QUANTITY_WEIGHT__WEIGHT_VALUE, newWeightValue);
	}
	...
	public String getWeightValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_QUANTITY_WEIGHT__WEIGHT_VALUE_AS_STRING, true);
	}
	...
	public void setWeightValueAsString(String newWeightValueAsString) {
		eSet(LogPackage.Literals.IFC_QUANTITY_WEIGHT__WEIGHT_VALUE_AS_STRING, newWeightValueAsString);
	}
