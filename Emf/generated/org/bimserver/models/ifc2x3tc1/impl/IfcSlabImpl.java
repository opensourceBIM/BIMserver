...
public class IfcSlabImpl extends IfcBuildingElementImpl implements IfcSlab {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SLAB;
	}
	...
	public IfcSlabTypeEnum getPredefinedType() {
		return (IfcSlabTypeEnum) eGet(LogPackage.Literals.IFC_SLAB__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSlabTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_SLAB__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(LogPackage.Literals.IFC_SLAB__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(LogPackage.Literals.IFC_SLAB__PREDEFINED_TYPE);
	}
