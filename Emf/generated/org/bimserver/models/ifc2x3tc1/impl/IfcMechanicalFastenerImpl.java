...
public class IfcMechanicalFastenerImpl extends IfcFastenerImpl implements IfcMechanicalFastener {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MECHANICAL_FASTENER;
	}
	...
	public double getNominalDiameter() {
		return (Double) eGet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_DIAMETER, true);
	}
	...
	public void setNominalDiameter(double newNominalDiameter) {
		eSet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_DIAMETER, newNominalDiameter);
	}
	...
	public void unsetNominalDiameter() {
		eUnset(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_DIAMETER);
	}
	...
	public boolean isSetNominalDiameter() {
		return eIsSet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_DIAMETER);
	}
	...
	public String getNominalDiameterAsString() {
		return (String) eGet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_DIAMETER_AS_STRING, true);
	}
	...
	public void setNominalDiameterAsString(String newNominalDiameterAsString) {
		eSet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_DIAMETER_AS_STRING, newNominalDiameterAsString);
	}
	...
	public void unsetNominalDiameterAsString() {
		eUnset(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_DIAMETER_AS_STRING);
	}
	...
	public boolean isSetNominalDiameterAsString() {
		return eIsSet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_DIAMETER_AS_STRING);
	}
	...
	public double getNominalLength() {
		return (Double) eGet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_LENGTH, true);
	}
	...
	public void setNominalLength(double newNominalLength) {
		eSet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_LENGTH, newNominalLength);
	}
	...
	public void unsetNominalLength() {
		eUnset(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_LENGTH);
	}
	...
	public boolean isSetNominalLength() {
		return eIsSet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_LENGTH);
	}
	...
	public String getNominalLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_LENGTH_AS_STRING, true);
	}
	...
	public void setNominalLengthAsString(String newNominalLengthAsString) {
		eSet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_LENGTH_AS_STRING, newNominalLengthAsString);
	}
	...
	public void unsetNominalLengthAsString() {
		eUnset(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_LENGTH_AS_STRING);
	}
	...
	public boolean isSetNominalLengthAsString() {
		return eIsSet(LogPackage.Literals.IFC_MECHANICAL_FASTENER__NOMINAL_LENGTH_AS_STRING);
	}
