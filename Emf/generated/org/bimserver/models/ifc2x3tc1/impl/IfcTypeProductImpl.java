...
public class IfcTypeProductImpl extends IfcTypeObjectImpl implements IfcTypeProduct {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TYPE_PRODUCT;
	}
	...
	public EList<IfcRepresentationMap> getRepresentationMaps() {
		return (EList<IfcRepresentationMap>) eGet(LogPackage.Literals.IFC_TYPE_PRODUCT__REPRESENTATION_MAPS, true);
	}
	...
	public void unsetRepresentationMaps() {
		eUnset(LogPackage.Literals.IFC_TYPE_PRODUCT__REPRESENTATION_MAPS);
	}
	...
	public boolean isSetRepresentationMaps() {
		return eIsSet(LogPackage.Literals.IFC_TYPE_PRODUCT__REPRESENTATION_MAPS);
	}
	...
	public String getTag() {
		return (String) eGet(LogPackage.Literals.IFC_TYPE_PRODUCT__TAG, true);
	}
	...
	public void setTag(String newTag) {
		eSet(LogPackage.Literals.IFC_TYPE_PRODUCT__TAG, newTag);
	}
	...
	public void unsetTag() {
		eUnset(LogPackage.Literals.IFC_TYPE_PRODUCT__TAG);
	}
	...
	public boolean isSetTag() {
		return eIsSet(LogPackage.Literals.IFC_TYPE_PRODUCT__TAG);
	}
