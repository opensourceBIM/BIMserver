...
public class IfcEdgeFeatureImpl extends IfcFeatureElementSubtractionImpl implements IfcEdgeFeature {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_EDGE_FEATURE;
	}
	...
	public double getFeatureLength() {
		return (Double) eGet(LogPackage.Literals.IFC_EDGE_FEATURE__FEATURE_LENGTH, true);
	}
	...
	public void setFeatureLength(double newFeatureLength) {
		eSet(LogPackage.Literals.IFC_EDGE_FEATURE__FEATURE_LENGTH, newFeatureLength);
	}
	...
	public void unsetFeatureLength() {
		eUnset(LogPackage.Literals.IFC_EDGE_FEATURE__FEATURE_LENGTH);
	}
	...
	public boolean isSetFeatureLength() {
		return eIsSet(LogPackage.Literals.IFC_EDGE_FEATURE__FEATURE_LENGTH);
	}
	...
	public String getFeatureLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_EDGE_FEATURE__FEATURE_LENGTH_AS_STRING, true);
	}
	...
	public void setFeatureLengthAsString(String newFeatureLengthAsString) {
		eSet(LogPackage.Literals.IFC_EDGE_FEATURE__FEATURE_LENGTH_AS_STRING, newFeatureLengthAsString);
	}
	...
	public void unsetFeatureLengthAsString() {
		eUnset(LogPackage.Literals.IFC_EDGE_FEATURE__FEATURE_LENGTH_AS_STRING);
	}
	...
	public boolean isSetFeatureLengthAsString() {
		return eIsSet(LogPackage.Literals.IFC_EDGE_FEATURE__FEATURE_LENGTH_AS_STRING);
	}
