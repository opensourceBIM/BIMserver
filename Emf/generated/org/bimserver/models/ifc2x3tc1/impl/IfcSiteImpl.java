...
public class IfcSiteImpl extends IfcSpatialStructureElementImpl implements IfcSite {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SITE;
	}
	...
	public EList<Integer> getRefLatitude() {
		return (EList<Integer>) eGet(LogPackage.Literals.IFC_SITE__REF_LATITUDE, true);
	}
	...
	public void unsetRefLatitude() {
		eUnset(LogPackage.Literals.IFC_SITE__REF_LATITUDE);
	}
	...
	public boolean isSetRefLatitude() {
		return eIsSet(LogPackage.Literals.IFC_SITE__REF_LATITUDE);
	}
	...
	public EList<Integer> getRefLongitude() {
		return (EList<Integer>) eGet(LogPackage.Literals.IFC_SITE__REF_LONGITUDE, true);
	}
	...
	public void unsetRefLongitude() {
		eUnset(LogPackage.Literals.IFC_SITE__REF_LONGITUDE);
	}
	...
	public boolean isSetRefLongitude() {
		return eIsSet(LogPackage.Literals.IFC_SITE__REF_LONGITUDE);
	}
	...
	public double getRefElevation() {
		return (Double) eGet(LogPackage.Literals.IFC_SITE__REF_ELEVATION, true);
	}
	...
	public void setRefElevation(double newRefElevation) {
		eSet(LogPackage.Literals.IFC_SITE__REF_ELEVATION, newRefElevation);
	}
	...
	public void unsetRefElevation() {
		eUnset(LogPackage.Literals.IFC_SITE__REF_ELEVATION);
	}
	...
	public boolean isSetRefElevation() {
		return eIsSet(LogPackage.Literals.IFC_SITE__REF_ELEVATION);
	}
	...
	public String getRefElevationAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SITE__REF_ELEVATION_AS_STRING, true);
	}
	...
	public void setRefElevationAsString(String newRefElevationAsString) {
		eSet(LogPackage.Literals.IFC_SITE__REF_ELEVATION_AS_STRING, newRefElevationAsString);
	}
	...
	public void unsetRefElevationAsString() {
		eUnset(LogPackage.Literals.IFC_SITE__REF_ELEVATION_AS_STRING);
	}
	...
	public boolean isSetRefElevationAsString() {
		return eIsSet(LogPackage.Literals.IFC_SITE__REF_ELEVATION_AS_STRING);
	}
	...
	public String getLandTitleNumber() {
		return (String) eGet(LogPackage.Literals.IFC_SITE__LAND_TITLE_NUMBER, true);
	}
	...
	public void setLandTitleNumber(String newLandTitleNumber) {
		eSet(LogPackage.Literals.IFC_SITE__LAND_TITLE_NUMBER, newLandTitleNumber);
	}
	...
	public void unsetLandTitleNumber() {
		eUnset(LogPackage.Literals.IFC_SITE__LAND_TITLE_NUMBER);
	}
	...
	public boolean isSetLandTitleNumber() {
		return eIsSet(LogPackage.Literals.IFC_SITE__LAND_TITLE_NUMBER);
	}
	...
	public IfcPostalAddress getSiteAddress() {
		return (IfcPostalAddress) eGet(LogPackage.Literals.IFC_SITE__SITE_ADDRESS, true);
	}
	...
	public void setSiteAddress(IfcPostalAddress newSiteAddress) {
		eSet(LogPackage.Literals.IFC_SITE__SITE_ADDRESS, newSiteAddress);
	}
	...
	public void unsetSiteAddress() {
		eUnset(LogPackage.Literals.IFC_SITE__SITE_ADDRESS);
	}
	...
	public boolean isSetSiteAddress() {
		return eIsSet(LogPackage.Literals.IFC_SITE__SITE_ADDRESS);
	}
