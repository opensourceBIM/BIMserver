...
public class IfcFillAreaStyleTilesImpl extends IfcGeometricRepresentationItemImpl implements IfcFillAreaStyleTiles {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FILL_AREA_STYLE_TILES;
	}
	...
	public IfcOneDirectionRepeatFactor getTilingPattern() {
		return (IfcOneDirectionRepeatFactor) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILES__TILING_PATTERN, true);
	}
	...
	public void setTilingPattern(IfcOneDirectionRepeatFactor newTilingPattern) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILES__TILING_PATTERN, newTilingPattern);
	}
	...
	public EList<IfcFillAreaStyleTileShapeSelect> getTiles() {
		return (EList<IfcFillAreaStyleTileShapeSelect>) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILES__TILES, true);
	}
	...
	public double getTilingScale() {
		return (Double) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILES__TILING_SCALE, true);
	}
	...
	public void setTilingScale(double newTilingScale) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILES__TILING_SCALE, newTilingScale);
	}
	...
	public String getTilingScaleAsString() {
		return (String) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILES__TILING_SCALE_AS_STRING, true);
	}
	...
	public void setTilingScaleAsString(String newTilingScaleAsString) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILES__TILING_SCALE_AS_STRING, newTilingScaleAsString);
	}
