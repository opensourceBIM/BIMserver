...
public class IfcPermitImpl extends IfcControlImpl implements IfcPermit {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PERMIT;
	}
	...
	public String getPermitID() {
		return (String) eGet(LogPackage.Literals.IFC_PERMIT__PERMIT_ID, true);
	}
	...
	public void setPermitID(String newPermitID) {
		eSet(LogPackage.Literals.IFC_PERMIT__PERMIT_ID, newPermitID);
	}
