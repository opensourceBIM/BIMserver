...
public class IfcSweptDiskSolidImpl extends IfcSolidModelImpl implements IfcSweptDiskSolid {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SWEPT_DISK_SOLID;
	}
	...
	public IfcCurve getDirectrix() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__DIRECTRIX, true);
	}
	...
	public void setDirectrix(IfcCurve newDirectrix) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__DIRECTRIX, newDirectrix);
	}
	...
	public double getRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__RADIUS, true);
	}
	...
	public void setRadius(double newRadius) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__RADIUS, newRadius);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__RADIUS_AS_STRING, true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__RADIUS_AS_STRING, newRadiusAsString);
	}
	...
	public double getInnerRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__INNER_RADIUS, true);
	}
	...
	public void setInnerRadius(double newInnerRadius) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__INNER_RADIUS, newInnerRadius);
	}
	...
	public void unsetInnerRadius() {
		eUnset(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__INNER_RADIUS);
	}
	...
	public boolean isSetInnerRadius() {
		return eIsSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__INNER_RADIUS);
	}
	...
	public String getInnerRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__INNER_RADIUS_AS_STRING, true);
	}
	...
	public void setInnerRadiusAsString(String newInnerRadiusAsString) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__INNER_RADIUS_AS_STRING, newInnerRadiusAsString);
	}
	...
	public void unsetInnerRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__INNER_RADIUS_AS_STRING);
	}
	...
	public boolean isSetInnerRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__INNER_RADIUS_AS_STRING);
	}
	...
	public double getStartParam() {
		return (Double) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__START_PARAM, true);
	}
	...
	public void setStartParam(double newStartParam) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__START_PARAM, newStartParam);
	}
	...
	public String getStartParamAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__START_PARAM_AS_STRING, true);
	}
	...
	public void setStartParamAsString(String newStartParamAsString) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__START_PARAM_AS_STRING, newStartParamAsString);
	}
	...
	public double getEndParam() {
		return (Double) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__END_PARAM, true);
	}
	...
	public void setEndParam(double newEndParam) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__END_PARAM, newEndParam);
	}
	...
	public String getEndParamAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__END_PARAM_AS_STRING, true);
	}
	...
	public void setEndParamAsString(String newEndParamAsString) {
		eSet(LogPackage.Literals.IFC_SWEPT_DISK_SOLID__END_PARAM_AS_STRING, newEndParamAsString);
	}
