...
public class IfcReinforcingElementImpl extends IfcBuildingElementComponentImpl implements IfcReinforcingElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REINFORCING_ELEMENT;
	}
	...
	public String getSteelGrade() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_ELEMENT__STEEL_GRADE, true);
	}
	...
	public void setSteelGrade(String newSteelGrade) {
		eSet(LogPackage.Literals.IFC_REINFORCING_ELEMENT__STEEL_GRADE, newSteelGrade);
	}
	...
	public void unsetSteelGrade() {
		eUnset(LogPackage.Literals.IFC_REINFORCING_ELEMENT__STEEL_GRADE);
	}
	...
	public boolean isSetSteelGrade() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCING_ELEMENT__STEEL_GRADE);
	}
