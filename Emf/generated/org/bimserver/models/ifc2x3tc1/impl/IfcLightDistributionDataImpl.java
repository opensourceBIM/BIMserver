...
public class IfcLightDistributionDataImpl extends IdEObjectImpl implements IfcLightDistributionData {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA;
	}
	...
	public double getMainPlaneAngle() {
		return (Double) eGet(LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA__MAIN_PLANE_ANGLE, true);
	}
	...
	public void setMainPlaneAngle(double newMainPlaneAngle) {
		eSet(LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA__MAIN_PLANE_ANGLE, newMainPlaneAngle);
	}
	...
	public String getMainPlaneAngleAsString() {
		return (String) eGet(LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA__MAIN_PLANE_ANGLE_AS_STRING, true);
	}
	...
	public void setMainPlaneAngleAsString(String newMainPlaneAngleAsString) {
		eSet(LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA__MAIN_PLANE_ANGLE_AS_STRING, newMainPlaneAngleAsString);
	}
	...
	public EList<Double> getSecondaryPlaneAngle() {
		return (EList<Double>) eGet(LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA__SECONDARY_PLANE_ANGLE, true);
	}
	...
	public EList<String> getSecondaryPlaneAngleAsString() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA__SECONDARY_PLANE_ANGLE_AS_STRING, true);
	}
	...
	public EList<Double> getLuminousIntensity() {
		return (EList<Double>) eGet(LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA__LUMINOUS_INTENSITY, true);
	}
	...
	public EList<String> getLuminousIntensityAsString() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_LIGHT_DISTRIBUTION_DATA__LUMINOUS_INTENSITY_AS_STRING, true);
	}
