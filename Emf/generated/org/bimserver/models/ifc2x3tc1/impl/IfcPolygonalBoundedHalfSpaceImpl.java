...
public class IfcPolygonalBoundedHalfSpaceImpl extends IfcHalfSpaceSolidImpl implements IfcPolygonalBoundedHalfSpace {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_POLYGONAL_BOUNDED_HALF_SPACE;
	}
	...
	public IfcAxis2Placement3D getPosition() {
		return (IfcAxis2Placement3D) eGet(LogPackage.Literals.IFC_POLYGONAL_BOUNDED_HALF_SPACE__POSITION, true);
	}
	...
	public void setPosition(IfcAxis2Placement3D newPosition) {
		eSet(LogPackage.Literals.IFC_POLYGONAL_BOUNDED_HALF_SPACE__POSITION, newPosition);
	}
	...
	public IfcBoundedCurve getPolygonalBoundary() {
		return (IfcBoundedCurve) eGet(LogPackage.Literals.IFC_POLYGONAL_BOUNDED_HALF_SPACE__POLYGONAL_BOUNDARY, true);
	}
	...
	public void setPolygonalBoundary(IfcBoundedCurve newPolygonalBoundary) {
		eSet(LogPackage.Literals.IFC_POLYGONAL_BOUNDED_HALF_SPACE__POLYGONAL_BOUNDARY, newPolygonalBoundary);
	}
