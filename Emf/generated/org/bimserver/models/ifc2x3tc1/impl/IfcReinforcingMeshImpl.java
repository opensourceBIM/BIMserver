...
public class IfcReinforcingMeshImpl extends IfcReinforcingElementImpl implements IfcReinforcingMesh {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REINFORCING_MESH;
	}
	...
	public double getMeshLength() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_LENGTH, true);
	}
	...
	public void setMeshLength(double newMeshLength) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_LENGTH, newMeshLength);
	}
	...
	public void unsetMeshLength() {
		eUnset(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_LENGTH);
	}
	...
	public boolean isSetMeshLength() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_LENGTH);
	}
	...
	public String getMeshLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_LENGTH_AS_STRING, true);
	}
	...
	public void setMeshLengthAsString(String newMeshLengthAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_LENGTH_AS_STRING, newMeshLengthAsString);
	}
	...
	public void unsetMeshLengthAsString() {
		eUnset(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_LENGTH_AS_STRING);
	}
	...
	public boolean isSetMeshLengthAsString() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_LENGTH_AS_STRING);
	}
	...
	public double getMeshWidth() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_WIDTH, true);
	}
	...
	public void setMeshWidth(double newMeshWidth) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_WIDTH, newMeshWidth);
	}
	...
	public void unsetMeshWidth() {
		eUnset(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_WIDTH);
	}
	...
	public boolean isSetMeshWidth() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_WIDTH);
	}
	...
	public String getMeshWidthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_WIDTH_AS_STRING, true);
	}
	...
	public void setMeshWidthAsString(String newMeshWidthAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_WIDTH_AS_STRING, newMeshWidthAsString);
	}
	...
	public void unsetMeshWidthAsString() {
		eUnset(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_WIDTH_AS_STRING);
	}
	...
	public boolean isSetMeshWidthAsString() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCING_MESH__MESH_WIDTH_AS_STRING);
	}
	...
	public double getLongitudinalBarNominalDiameter() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_NOMINAL_DIAMETER, true);
	}
	...
	public void setLongitudinalBarNominalDiameter(double newLongitudinalBarNominalDiameter) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_NOMINAL_DIAMETER, newLongitudinalBarNominalDiameter);
	}
	...
	public String getLongitudinalBarNominalDiameterAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_NOMINAL_DIAMETER_AS_STRING, true);
	}
	...
	public void setLongitudinalBarNominalDiameterAsString(String newLongitudinalBarNominalDiameterAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_NOMINAL_DIAMETER_AS_STRING, newLongitudinalBarNominalDiameterAsString);
	}
	...
	public double getTransverseBarNominalDiameter() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_NOMINAL_DIAMETER, true);
	}
	...
	public void setTransverseBarNominalDiameter(double newTransverseBarNominalDiameter) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_NOMINAL_DIAMETER, newTransverseBarNominalDiameter);
	}
	...
	public String getTransverseBarNominalDiameterAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_NOMINAL_DIAMETER_AS_STRING, true);
	}
	...
	public void setTransverseBarNominalDiameterAsString(String newTransverseBarNominalDiameterAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_NOMINAL_DIAMETER_AS_STRING, newTransverseBarNominalDiameterAsString);
	}
	...
	public double getLongitudinalBarCrossSectionArea() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_CROSS_SECTION_AREA, true);
	}
	...
	public void setLongitudinalBarCrossSectionArea(double newLongitudinalBarCrossSectionArea) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_CROSS_SECTION_AREA, newLongitudinalBarCrossSectionArea);
	}
	...
	public String getLongitudinalBarCrossSectionAreaAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_CROSS_SECTION_AREA_AS_STRING, true);
	}
	...
	public void setLongitudinalBarCrossSectionAreaAsString(String newLongitudinalBarCrossSectionAreaAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_CROSS_SECTION_AREA_AS_STRING, newLongitudinalBarCrossSectionAreaAsString);
	}
	...
	public double getTransverseBarCrossSectionArea() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_CROSS_SECTION_AREA, true);
	}
	...
	public void setTransverseBarCrossSectionArea(double newTransverseBarCrossSectionArea) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_CROSS_SECTION_AREA, newTransverseBarCrossSectionArea);
	}
	...
	public String getTransverseBarCrossSectionAreaAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_CROSS_SECTION_AREA_AS_STRING, true);
	}
	...
	public void setTransverseBarCrossSectionAreaAsString(String newTransverseBarCrossSectionAreaAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_CROSS_SECTION_AREA_AS_STRING, newTransverseBarCrossSectionAreaAsString);
	}
	...
	public double getLongitudinalBarSpacing() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_SPACING, true);
	}
	...
	public void setLongitudinalBarSpacing(double newLongitudinalBarSpacing) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_SPACING, newLongitudinalBarSpacing);
	}
	...
	public String getLongitudinalBarSpacingAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_SPACING_AS_STRING, true);
	}
	...
	public void setLongitudinalBarSpacingAsString(String newLongitudinalBarSpacingAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_SPACING_AS_STRING, newLongitudinalBarSpacingAsString);
	}
	...
	public double getTransverseBarSpacing() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_SPACING, true);
	}
	...
	public void setTransverseBarSpacing(double newTransverseBarSpacing) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_SPACING, newTransverseBarSpacing);
	}
	...
	public String getTransverseBarSpacingAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_SPACING_AS_STRING, true);
	}
	...
	public void setTransverseBarSpacingAsString(String newTransverseBarSpacingAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_SPACING_AS_STRING, newTransverseBarSpacingAsString);
	}
