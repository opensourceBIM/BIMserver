...
public class IfcRelAssignsToResourceImpl extends IfcRelAssignsImpl implements IfcRelAssignsToResource {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSIGNS_TO_RESOURCE;
	}
	...
	public IfcResource getRelatingResource() {
		return (IfcResource) eGet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_RESOURCE__RELATING_RESOURCE, true);
	}
	...
	public void setRelatingResource(IfcResource newRelatingResource) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_RESOURCE__RELATING_RESOURCE, newRelatingResource);
	}
