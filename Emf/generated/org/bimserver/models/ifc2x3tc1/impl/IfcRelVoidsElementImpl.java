...
public class IfcRelVoidsElementImpl extends IfcRelConnectsImpl implements IfcRelVoidsElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_VOIDS_ELEMENT;
	}
	...
	public IfcElement getRelatingBuildingElement() {
		return (IfcElement) eGet(LogPackage.Literals.IFC_REL_VOIDS_ELEMENT__RELATING_BUILDING_ELEMENT, true);
	}
	...
	public void setRelatingBuildingElement(IfcElement newRelatingBuildingElement) {
		eSet(LogPackage.Literals.IFC_REL_VOIDS_ELEMENT__RELATING_BUILDING_ELEMENT, newRelatingBuildingElement);
	}
	...
	public IfcFeatureElementSubtraction getRelatedOpeningElement() {
		return (IfcFeatureElementSubtraction) eGet(LogPackage.Literals.IFC_REL_VOIDS_ELEMENT__RELATED_OPENING_ELEMENT, true);
	}
	...
	public void setRelatedOpeningElement(IfcFeatureElementSubtraction newRelatedOpeningElement) {
		eSet(LogPackage.Literals.IFC_REL_VOIDS_ELEMENT__RELATED_OPENING_ELEMENT, newRelatedOpeningElement);
	}
