...
public class IfcStructuralItemImpl extends IfcProductImpl implements IfcStructuralItem {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_ITEM;
	}
	...
	public EList<IfcRelConnectsStructuralActivity> getAssignedStructuralActivity() {
		return (EList<IfcRelConnectsStructuralActivity>) eGet(LogPackage.Literals.IFC_STRUCTURAL_ITEM__ASSIGNED_STRUCTURAL_ACTIVITY, true);
	}
	...
	public void unsetAssignedStructuralActivity() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_ITEM__ASSIGNED_STRUCTURAL_ACTIVITY);
	}
	...
	public boolean isSetAssignedStructuralActivity() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_ITEM__ASSIGNED_STRUCTURAL_ACTIVITY);
	}
