...
public class IfcOrientedEdgeImpl extends IfcEdgeImpl implements IfcOrientedEdge {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ORIENTED_EDGE;
	}
	...
	public IfcEdge getEdgeElement() {
		return (IfcEdge) eGet(LogPackage.Literals.IFC_ORIENTED_EDGE__EDGE_ELEMENT, true);
	}
	...
	public void setEdgeElement(IfcEdge newEdgeElement) {
		eSet(LogPackage.Literals.IFC_ORIENTED_EDGE__EDGE_ELEMENT, newEdgeElement);
	}
	...
	public Tristate getOrientation() {
		return (Tristate) eGet(LogPackage.Literals.IFC_ORIENTED_EDGE__ORIENTATION, true);
	}
	...
	public void setOrientation(Tristate newOrientation) {
		eSet(LogPackage.Literals.IFC_ORIENTED_EDGE__ORIENTATION, newOrientation);
	}
