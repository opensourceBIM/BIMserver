...
public class IfcPointOnSurfaceImpl extends IfcPointImpl implements IfcPointOnSurface {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_POINT_ON_SURFACE;
	}
	...
	public IfcSurface getBasisSurface() {
		return (IfcSurface) eGet(LogPackage.Literals.IFC_POINT_ON_SURFACE__BASIS_SURFACE, true);
	}
	...
	public void setBasisSurface(IfcSurface newBasisSurface) {
		eSet(LogPackage.Literals.IFC_POINT_ON_SURFACE__BASIS_SURFACE, newBasisSurface);
	}
	...
	public double getPointParameterU() {
		return (Double) eGet(LogPackage.Literals.IFC_POINT_ON_SURFACE__POINT_PARAMETER_U, true);
	}
	...
	public void setPointParameterU(double newPointParameterU) {
		eSet(LogPackage.Literals.IFC_POINT_ON_SURFACE__POINT_PARAMETER_U, newPointParameterU);
	}
	...
	public String getPointParameterUAsString() {
		return (String) eGet(LogPackage.Literals.IFC_POINT_ON_SURFACE__POINT_PARAMETER_UAS_STRING, true);
	}
	...
	public void setPointParameterUAsString(String newPointParameterUAsString) {
		eSet(LogPackage.Literals.IFC_POINT_ON_SURFACE__POINT_PARAMETER_UAS_STRING, newPointParameterUAsString);
	}
	...
	public double getPointParameterV() {
		return (Double) eGet(LogPackage.Literals.IFC_POINT_ON_SURFACE__POINT_PARAMETER_V, true);
	}
	...
	public void setPointParameterV(double newPointParameterV) {
		eSet(LogPackage.Literals.IFC_POINT_ON_SURFACE__POINT_PARAMETER_V, newPointParameterV);
	}
	...
	public String getPointParameterVAsString() {
		return (String) eGet(LogPackage.Literals.IFC_POINT_ON_SURFACE__POINT_PARAMETER_VAS_STRING, true);
	}
	...
	public void setPointParameterVAsString(String newPointParameterVAsString) {
		eSet(LogPackage.Literals.IFC_POINT_ON_SURFACE__POINT_PARAMETER_VAS_STRING, newPointParameterVAsString);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_POINT_ON_SURFACE__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_POINT_ON_SURFACE__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_POINT_ON_SURFACE__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_POINT_ON_SURFACE__DIM);
	}
