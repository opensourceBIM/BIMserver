...
public class IfcUnitaryEquipmentTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcUnitaryEquipmentType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_UNITARY_EQUIPMENT_TYPE;
	}
	...
	public IfcUnitaryEquipmentTypeEnum getPredefinedType() {
		return (IfcUnitaryEquipmentTypeEnum) eGet(LogPackage.Literals.IFC_UNITARY_EQUIPMENT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcUnitaryEquipmentTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_UNITARY_EQUIPMENT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
