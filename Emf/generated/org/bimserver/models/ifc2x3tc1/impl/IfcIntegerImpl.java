...
public class IfcIntegerImpl extends WrappedValueImpl implements IfcInteger {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_INTEGER;
	}
	...
	public int getWrappedValue() {
		return (Integer) eGet(LogPackage.Literals.IFC_INTEGER__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(int newWrappedValue) {
		eSet(LogPackage.Literals.IFC_INTEGER__WRAPPED_VALUE, newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(LogPackage.Literals.IFC_INTEGER__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(LogPackage.Literals.IFC_INTEGER__WRAPPED_VALUE);
	}
