...
public class IfcVirtualGridIntersectionImpl extends IdEObjectImpl implements IfcVirtualGridIntersection {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_VIRTUAL_GRID_INTERSECTION;
	}
	...
	public EList<IfcGridAxis> getIntersectingAxes() {
		return (EList<IfcGridAxis>) eGet(LogPackage.Literals.IFC_VIRTUAL_GRID_INTERSECTION__INTERSECTING_AXES, true);
	}
	...
	public EList<Double> getOffsetDistances() {
		return (EList<Double>) eGet(LogPackage.Literals.IFC_VIRTUAL_GRID_INTERSECTION__OFFSET_DISTANCES, true);
	}
	...
	public EList<String> getOffsetDistancesAsString() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_VIRTUAL_GRID_INTERSECTION__OFFSET_DISTANCES_AS_STRING, true);
	}
