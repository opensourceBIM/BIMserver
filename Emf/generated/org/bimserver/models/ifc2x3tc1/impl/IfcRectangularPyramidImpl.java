...
public class IfcRectangularPyramidImpl extends IfcCsgPrimitive3DImpl implements IfcRectangularPyramid {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RECTANGULAR_PYRAMID;
	}
	...
	public double getXLength() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__XLENGTH, true);
	}
	...
	public void setXLength(double newXLength) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__XLENGTH, newXLength);
	}
	...
	public String getXLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__XLENGTH_AS_STRING, true);
	}
	...
	public void setXLengthAsString(String newXLengthAsString) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__XLENGTH_AS_STRING, newXLengthAsString);
	}
	...
	public double getYLength() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__YLENGTH, true);
	}
	...
	public void setYLength(double newYLength) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__YLENGTH, newYLength);
	}
	...
	public String getYLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__YLENGTH_AS_STRING, true);
	}
	...
	public void setYLengthAsString(String newYLengthAsString) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__YLENGTH_AS_STRING, newYLengthAsString);
	}
	...
	public double getHeight() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__HEIGHT, true);
	}
	...
	public void setHeight(double newHeight) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__HEIGHT, newHeight);
	}
	...
	public String getHeightAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__HEIGHT_AS_STRING, true);
	}
	...
	public void setHeightAsString(String newHeightAsString) {
		eSet(LogPackage.Literals.IFC_RECTANGULAR_PYRAMID__HEIGHT_AS_STRING, newHeightAsString);
	}
