...
public class IfcRelAssignsToGroupImpl extends IfcRelAssignsImpl implements IfcRelAssignsToGroup {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSIGNS_TO_GROUP;
	}
	...
	public IfcGroup getRelatingGroup() {
		return (IfcGroup) eGet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_GROUP__RELATING_GROUP, true);
	}
	...
	public void setRelatingGroup(IfcGroup newRelatingGroup) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_GROUP__RELATING_GROUP, newRelatingGroup);
	}
