...
public class IfcShapeModelImpl extends IfcRepresentationImpl implements IfcShapeModel {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SHAPE_MODEL;
	}
	...
	public EList<IfcShapeAspect> getOfShapeAspect() {
		return (EList<IfcShapeAspect>) eGet(LogPackage.Literals.IFC_SHAPE_MODEL__OF_SHAPE_ASPECT, true);
	}
	...
	public void unsetOfShapeAspect() {
		eUnset(LogPackage.Literals.IFC_SHAPE_MODEL__OF_SHAPE_ASPECT);
	}
	...
	public boolean isSetOfShapeAspect() {
		return eIsSet(LogPackage.Literals.IFC_SHAPE_MODEL__OF_SHAPE_ASPECT);
	}
