...
public class IfcRelConnectsWithRealizingElementsImpl extends IfcRelConnectsElementsImpl implements IfcRelConnectsWithRealizingElements {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS;
	}
	...
	public EList<IfcElement> getRealizingElements() {
		return (EList<IfcElement>) eGet(LogPackage.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS__REALIZING_ELEMENTS, true);
	}
	...
	public String getConnectionType() {
		return (String) eGet(LogPackage.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS__CONNECTION_TYPE, true);
	}
	...
	public void setConnectionType(String newConnectionType) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS__CONNECTION_TYPE, newConnectionType);
	}
	...
	public void unsetConnectionType() {
		eUnset(LogPackage.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS__CONNECTION_TYPE);
	}
	...
	public boolean isSetConnectionType() {
		return eIsSet(LogPackage.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS__CONNECTION_TYPE);
	}
