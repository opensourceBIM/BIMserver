...
public class IfcAirTerminalBoxTypeImpl extends IfcFlowControllerTypeImpl implements IfcAirTerminalBoxType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_AIR_TERMINAL_BOX_TYPE;
	}
	...
	public IfcAirTerminalBoxTypeEnum getPredefinedType() {
		return (IfcAirTerminalBoxTypeEnum) eGet(LogPackage.Literals.IFC_AIR_TERMINAL_BOX_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcAirTerminalBoxTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_AIR_TERMINAL_BOX_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
