...
public class IfcMoveImpl extends IfcTaskImpl implements IfcMove {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MOVE;
	}
	...
	public IfcSpatialStructureElement getMoveFrom() {
		return (IfcSpatialStructureElement) eGet(LogPackage.Literals.IFC_MOVE__MOVE_FROM, true);
	}
	...
	public void setMoveFrom(IfcSpatialStructureElement newMoveFrom) {
		eSet(LogPackage.Literals.IFC_MOVE__MOVE_FROM, newMoveFrom);
	}
	...
	public IfcSpatialStructureElement getMoveTo() {
		return (IfcSpatialStructureElement) eGet(LogPackage.Literals.IFC_MOVE__MOVE_TO, true);
	}
	...
	public void setMoveTo(IfcSpatialStructureElement newMoveTo) {
		eSet(LogPackage.Literals.IFC_MOVE__MOVE_TO, newMoveTo);
	}
	...
	public EList<String> getPunchList() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_MOVE__PUNCH_LIST, true);
	}
	...
	public void unsetPunchList() {
		eUnset(LogPackage.Literals.IFC_MOVE__PUNCH_LIST);
	}
	...
	public boolean isSetPunchList() {
		return eIsSet(LogPackage.Literals.IFC_MOVE__PUNCH_LIST);
	}
