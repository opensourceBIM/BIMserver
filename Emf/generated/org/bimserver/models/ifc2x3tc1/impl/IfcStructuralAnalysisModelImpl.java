...
public class IfcStructuralAnalysisModelImpl extends IfcSystemImpl implements IfcStructuralAnalysisModel {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL;
	}
	...
	public IfcAnalysisModelTypeEnum getPredefinedType() {
		return (IfcAnalysisModelTypeEnum) eGet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcAnalysisModelTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public IfcAxis2Placement3D getOrientationOf2DPlane() {
		return (IfcAxis2Placement3D) eGet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__ORIENTATION_OF2_DPLANE, true);
	}
	...
	public void setOrientationOf2DPlane(IfcAxis2Placement3D newOrientationOf2DPlane) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__ORIENTATION_OF2_DPLANE, newOrientationOf2DPlane);
	}
	...
	public void unsetOrientationOf2DPlane() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__ORIENTATION_OF2_DPLANE);
	}
	...
	public boolean isSetOrientationOf2DPlane() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__ORIENTATION_OF2_DPLANE);
	}
	...
	public EList<IfcStructuralLoadGroup> getLoadedBy() {
		return (EList<IfcStructuralLoadGroup>) eGet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__LOADED_BY, true);
	}
	...
	public void unsetLoadedBy() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__LOADED_BY);
	}
	...
	public boolean isSetLoadedBy() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__LOADED_BY);
	}
	...
	public EList<IfcStructuralResultGroup> getHasResults() {
		return (EList<IfcStructuralResultGroup>) eGet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__HAS_RESULTS, true);
	}
	...
	public void unsetHasResults() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__HAS_RESULTS);
	}
	...
	public boolean isSetHasResults() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__HAS_RESULTS);
	}
