...
public class IfcRelSpaceBoundaryImpl extends IfcRelConnectsImpl implements IfcRelSpaceBoundary {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_SPACE_BOUNDARY;
	}
	...
	public IfcSpace getRelatingSpace() {
		return (IfcSpace) eGet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__RELATING_SPACE, true);
	}
	...
	public void setRelatingSpace(IfcSpace newRelatingSpace) {
		eSet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__RELATING_SPACE, newRelatingSpace);
	}
	...
	public IfcElement getRelatedBuildingElement() {
		return (IfcElement) eGet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__RELATED_BUILDING_ELEMENT, true);
	}
	...
	public void setRelatedBuildingElement(IfcElement newRelatedBuildingElement) {
		eSet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__RELATED_BUILDING_ELEMENT, newRelatedBuildingElement);
	}
	...
	public void unsetRelatedBuildingElement() {
		eUnset(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__RELATED_BUILDING_ELEMENT);
	}
	...
	public boolean isSetRelatedBuildingElement() {
		return eIsSet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__RELATED_BUILDING_ELEMENT);
	}
	...
	public IfcConnectionGeometry getConnectionGeometry() {
		return (IfcConnectionGeometry) eGet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__CONNECTION_GEOMETRY, true);
	}
	...
	public void setConnectionGeometry(IfcConnectionGeometry newConnectionGeometry) {
		eSet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__CONNECTION_GEOMETRY, newConnectionGeometry);
	}
	...
	public void unsetConnectionGeometry() {
		eUnset(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__CONNECTION_GEOMETRY);
	}
	...
	public boolean isSetConnectionGeometry() {
		return eIsSet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__CONNECTION_GEOMETRY);
	}
	...
	public IfcPhysicalOrVirtualEnum getPhysicalOrVirtualBoundary() {
		return (IfcPhysicalOrVirtualEnum) eGet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__PHYSICAL_OR_VIRTUAL_BOUNDARY, true);
	}
	...
	public void setPhysicalOrVirtualBoundary(IfcPhysicalOrVirtualEnum newPhysicalOrVirtualBoundary) {
		eSet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__PHYSICAL_OR_VIRTUAL_BOUNDARY, newPhysicalOrVirtualBoundary);
	}
	...
	public IfcInternalOrExternalEnum getInternalOrExternalBoundary() {
		return (IfcInternalOrExternalEnum) eGet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__INTERNAL_OR_EXTERNAL_BOUNDARY, true);
	}
	...
	public void setInternalOrExternalBoundary(IfcInternalOrExternalEnum newInternalOrExternalBoundary) {
		eSet(LogPackage.Literals.IFC_REL_SPACE_BOUNDARY__INTERNAL_OR_EXTERNAL_BOUNDARY, newInternalOrExternalBoundary);
	}
