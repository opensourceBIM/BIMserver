...
public class IfcStyledItemImpl extends IfcRepresentationItemImpl implements IfcStyledItem {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STYLED_ITEM;
	}
	...
	public IfcRepresentationItem getItem() {
		return (IfcRepresentationItem) eGet(LogPackage.Literals.IFC_STYLED_ITEM__ITEM, true);
	}
	...
	public void setItem(IfcRepresentationItem newItem) {
		eSet(LogPackage.Literals.IFC_STYLED_ITEM__ITEM, newItem);
	}
	...
	public void unsetItem() {
		eUnset(LogPackage.Literals.IFC_STYLED_ITEM__ITEM);
	}
	...
	public boolean isSetItem() {
		return eIsSet(LogPackage.Literals.IFC_STYLED_ITEM__ITEM);
	}
	...
	public EList<IfcPresentationStyleAssignment> getStyles() {
		return (EList<IfcPresentationStyleAssignment>) eGet(LogPackage.Literals.IFC_STYLED_ITEM__STYLES, true);
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_STYLED_ITEM__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_STYLED_ITEM__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_STYLED_ITEM__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_STYLED_ITEM__NAME);
	}
