...
public class IfcBooleanImpl extends WrappedValueImpl implements IfcBoolean {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_BOOLEAN;
	}
	...
	public Tristate getWrappedValue() {
		return (Tristate) eGet(LogPackage.Literals.IFC_BOOLEAN__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(Tristate newWrappedValue) {
		eSet(LogPackage.Literals.IFC_BOOLEAN__WRAPPED_VALUE, newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(LogPackage.Literals.IFC_BOOLEAN__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(LogPackage.Literals.IFC_BOOLEAN__WRAPPED_VALUE);
	}
