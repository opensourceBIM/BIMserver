...
public class IfcApprovalRelationshipImpl extends IdEObjectImpl implements IfcApprovalRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP;
	}
	...
	public IfcApproval getRelatedApproval() {
		return (IfcApproval) eGet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__RELATED_APPROVAL, true);
	}
	...
	public void setRelatedApproval(IfcApproval newRelatedApproval) {
		eSet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__RELATED_APPROVAL, newRelatedApproval);
	}
	...
	public IfcApproval getRelatingApproval() {
		return (IfcApproval) eGet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__RELATING_APPROVAL, true);
	}
	...
	public void setRelatingApproval(IfcApproval newRelatingApproval) {
		eSet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__RELATING_APPROVAL, newRelatingApproval);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__DESCRIPTION);
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_APPROVAL_RELATIONSHIP__NAME, newName);
	}
