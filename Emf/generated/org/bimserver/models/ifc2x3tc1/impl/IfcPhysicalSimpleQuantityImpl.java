...
public class IfcPhysicalSimpleQuantityImpl extends IfcPhysicalQuantityImpl implements IfcPhysicalSimpleQuantity {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY;
	}
	...
	public IfcNamedUnit getUnit() {
		return (IfcNamedUnit) eGet(LogPackage.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY__UNIT, true);
	}
	...
	public void setUnit(IfcNamedUnit newUnit) {
		eSet(LogPackage.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY__UNIT, newUnit);
	}
	...
	public void unsetUnit() {
		eUnset(LogPackage.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY__UNIT);
	}
	...
	public boolean isSetUnit() {
		return eIsSet(LogPackage.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY__UNIT);
	}
