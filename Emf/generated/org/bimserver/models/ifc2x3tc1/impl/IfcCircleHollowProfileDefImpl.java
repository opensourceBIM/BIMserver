...
public class IfcCircleHollowProfileDefImpl extends IfcCircleProfileDefImpl implements IfcCircleHollowProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF;
	}
	...
	public double getWallThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS, true);
	}
	...
	public void setWallThickness(double newWallThickness) {
		eSet(LogPackage.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS, newWallThickness);
	}
	...
	public String getWallThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING, true);
	}
	...
	public void setWallThicknessAsString(String newWallThicknessAsString) {
		eSet(LogPackage.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING, newWallThicknessAsString);
	}
