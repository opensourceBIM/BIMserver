...
public class IfcAxis2Placement3DImpl extends IfcPlacementImpl implements IfcAxis2Placement3D {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D;
	}
	...
	public IfcDirection getAxis() {
		return (IfcDirection) eGet(LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D__AXIS, true);
	}
	...
	public void setAxis(IfcDirection newAxis) {
		eSet(LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D__AXIS, newAxis);
	}
	...
	public void unsetAxis() {
		eUnset(LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D__AXIS);
	}
	...
	public boolean isSetAxis() {
		return eIsSet(LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D__AXIS);
	}
	...
	public IfcDirection getRefDirection() {
		return (IfcDirection) eGet(LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D__REF_DIRECTION, true);
	}
	...
	public void setRefDirection(IfcDirection newRefDirection) {
		eSet(LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D__REF_DIRECTION, newRefDirection);
	}
	...
	public void unsetRefDirection() {
		eUnset(LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D__REF_DIRECTION);
	}
	...
	public boolean isSetRefDirection() {
		return eIsSet(LogPackage.Literals.IFC_AXIS2_PLACEMENT3_D__REF_DIRECTION);
	}
