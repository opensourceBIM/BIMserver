...
public class IfcStackTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcStackTerminalType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STACK_TERMINAL_TYPE;
	}
	...
	public IfcStackTerminalTypeEnum getPredefinedType() {
		return (IfcStackTerminalTypeEnum) eGet(LogPackage.Literals.IFC_STACK_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcStackTerminalTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_STACK_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
