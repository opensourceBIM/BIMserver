...
public class IfcQuantityCountImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityCount {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_QUANTITY_COUNT;
	}
	...
	public double getCountValue() {
		return (Double) eGet(LogPackage.Literals.IFC_QUANTITY_COUNT__COUNT_VALUE, true);
	}
	...
	public void setCountValue(double newCountValue) {
		eSet(LogPackage.Literals.IFC_QUANTITY_COUNT__COUNT_VALUE, newCountValue);
	}
	...
	public String getCountValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_QUANTITY_COUNT__COUNT_VALUE_AS_STRING, true);
	}
	...
	public void setCountValueAsString(String newCountValueAsString) {
		eSet(LogPackage.Literals.IFC_QUANTITY_COUNT__COUNT_VALUE_AS_STRING, newCountValueAsString);
	}
