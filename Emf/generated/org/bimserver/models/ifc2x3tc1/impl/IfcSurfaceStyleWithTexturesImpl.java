...
public class IfcSurfaceStyleWithTexturesImpl extends IdEObjectImpl implements IfcSurfaceStyleWithTextures {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_STYLE_WITH_TEXTURES;
	}
	...
	public EList<IfcSurfaceTexture> getTextures() {
		return (EList<IfcSurfaceTexture>) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_WITH_TEXTURES__TEXTURES, true);
	}
