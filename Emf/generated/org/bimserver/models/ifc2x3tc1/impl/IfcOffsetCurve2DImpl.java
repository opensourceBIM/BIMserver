...
public class IfcOffsetCurve2DImpl extends IfcCurveImpl implements IfcOffsetCurve2D {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_OFFSET_CURVE2_D;
	}
	...
	public IfcCurve getBasisCurve() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_OFFSET_CURVE2_D__BASIS_CURVE, true);
	}
	...
	public void setBasisCurve(IfcCurve newBasisCurve) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE2_D__BASIS_CURVE, newBasisCurve);
	}
	...
	public double getDistance() {
		return (Double) eGet(LogPackage.Literals.IFC_OFFSET_CURVE2_D__DISTANCE, true);
	}
	...
	public void setDistance(double newDistance) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE2_D__DISTANCE, newDistance);
	}
	...
	public String getDistanceAsString() {
		return (String) eGet(LogPackage.Literals.IFC_OFFSET_CURVE2_D__DISTANCE_AS_STRING, true);
	}
	...
	public void setDistanceAsString(String newDistanceAsString) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE2_D__DISTANCE_AS_STRING, newDistanceAsString);
	}
	...
	public boolean isSelfIntersect() {
		return (Boolean) eGet(LogPackage.Literals.IFC_OFFSET_CURVE2_D__SELF_INTERSECT, true);
	}
	...
	public void setSelfIntersect(boolean newSelfIntersect) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE2_D__SELF_INTERSECT, newSelfIntersect);
	}
