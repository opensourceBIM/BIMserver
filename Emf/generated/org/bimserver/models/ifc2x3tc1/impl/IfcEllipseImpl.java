...
public class IfcEllipseImpl extends IfcConicImpl implements IfcEllipse {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ELLIPSE;
	}
	...
	public double getSemiAxis1() {
		return (Double) eGet(LogPackage.Literals.IFC_ELLIPSE__SEMI_AXIS1, true);
	}
	...
	public void setSemiAxis1(double newSemiAxis1) {
		eSet(LogPackage.Literals.IFC_ELLIPSE__SEMI_AXIS1, newSemiAxis1);
	}
	...
	public String getSemiAxis1AsString() {
		return (String) eGet(LogPackage.Literals.IFC_ELLIPSE__SEMI_AXIS1_AS_STRING, true);
	}
	...
	public void setSemiAxis1AsString(String newSemiAxis1AsString) {
		eSet(LogPackage.Literals.IFC_ELLIPSE__SEMI_AXIS1_AS_STRING, newSemiAxis1AsString);
	}
	...
	public double getSemiAxis2() {
		return (Double) eGet(LogPackage.Literals.IFC_ELLIPSE__SEMI_AXIS2, true);
	}
	...
	public void setSemiAxis2(double newSemiAxis2) {
		eSet(LogPackage.Literals.IFC_ELLIPSE__SEMI_AXIS2, newSemiAxis2);
	}
	...
	public String getSemiAxis2AsString() {
		return (String) eGet(LogPackage.Literals.IFC_ELLIPSE__SEMI_AXIS2_AS_STRING, true);
	}
	...
	public void setSemiAxis2AsString(String newSemiAxis2AsString) {
		eSet(LogPackage.Literals.IFC_ELLIPSE__SEMI_AXIS2_AS_STRING, newSemiAxis2AsString);
	}
