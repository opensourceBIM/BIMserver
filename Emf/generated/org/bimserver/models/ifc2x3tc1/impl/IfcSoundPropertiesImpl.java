...
public class IfcSoundPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcSoundProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SOUND_PROPERTIES;
	}
	...
	public Tristate getIsAttenuating() {
		return (Tristate) eGet(LogPackage.Literals.IFC_SOUND_PROPERTIES__IS_ATTENUATING, true);
	}
	...
	public void setIsAttenuating(Tristate newIsAttenuating) {
		eSet(LogPackage.Literals.IFC_SOUND_PROPERTIES__IS_ATTENUATING, newIsAttenuating);
	}
	...
	public IfcSoundScaleEnum getSoundScale() {
		return (IfcSoundScaleEnum) eGet(LogPackage.Literals.IFC_SOUND_PROPERTIES__SOUND_SCALE, true);
	}
	...
	public void setSoundScale(IfcSoundScaleEnum newSoundScale) {
		eSet(LogPackage.Literals.IFC_SOUND_PROPERTIES__SOUND_SCALE, newSoundScale);
	}
	...
	public void unsetSoundScale() {
		eUnset(LogPackage.Literals.IFC_SOUND_PROPERTIES__SOUND_SCALE);
	}
	...
	public boolean isSetSoundScale() {
		return eIsSet(LogPackage.Literals.IFC_SOUND_PROPERTIES__SOUND_SCALE);
	}
	...
	public EList<IfcSoundValue> getSoundValues() {
		return (EList<IfcSoundValue>) eGet(LogPackage.Literals.IFC_SOUND_PROPERTIES__SOUND_VALUES, true);
	}
