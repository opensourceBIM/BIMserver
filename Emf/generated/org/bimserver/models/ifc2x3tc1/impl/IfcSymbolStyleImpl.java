...
public class IfcSymbolStyleImpl extends IfcPresentationStyleImpl implements IfcSymbolStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SYMBOL_STYLE;
	}
	...
	public IfcSymbolStyleSelect getStyleOfSymbol() {
		return (IfcSymbolStyleSelect) eGet(LogPackage.Literals.IFC_SYMBOL_STYLE__STYLE_OF_SYMBOL, true);
	}
	...
	public void setStyleOfSymbol(IfcSymbolStyleSelect newStyleOfSymbol) {
		eSet(LogPackage.Literals.IFC_SYMBOL_STYLE__STYLE_OF_SYMBOL, newStyleOfSymbol);
	}
