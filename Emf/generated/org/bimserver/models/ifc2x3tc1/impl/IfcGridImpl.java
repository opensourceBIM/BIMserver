...
public class IfcGridImpl extends IfcProductImpl implements IfcGrid {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_GRID;
	}
	...
	public EList<IfcGridAxis> getUAxes() {
		return (EList<IfcGridAxis>) eGet(LogPackage.Literals.IFC_GRID__UAXES, true);
	}
	...
	public EList<IfcGridAxis> getVAxes() {
		return (EList<IfcGridAxis>) eGet(LogPackage.Literals.IFC_GRID__VAXES, true);
	}
	...
	public EList<IfcGridAxis> getWAxes() {
		return (EList<IfcGridAxis>) eGet(LogPackage.Literals.IFC_GRID__WAXES, true);
	}
	...
	public void unsetWAxes() {
		eUnset(LogPackage.Literals.IFC_GRID__WAXES);
	}
	...
	public boolean isSetWAxes() {
		return eIsSet(LogPackage.Literals.IFC_GRID__WAXES);
	}
	...
	public EList<IfcRelContainedInSpatialStructure> getContainedInStructure() {
		return (EList<IfcRelContainedInSpatialStructure>) eGet(LogPackage.Literals.IFC_GRID__CONTAINED_IN_STRUCTURE, true);
	}
	...
	public void unsetContainedInStructure() {
		eUnset(LogPackage.Literals.IFC_GRID__CONTAINED_IN_STRUCTURE);
	}
	...
	public boolean isSetContainedInStructure() {
		return eIsSet(LogPackage.Literals.IFC_GRID__CONTAINED_IN_STRUCTURE);
	}
