...
public class IfcRelAssociatesApprovalImpl extends IfcRelAssociatesImpl implements IfcRelAssociatesApproval {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSOCIATES_APPROVAL;
	}
	...
	public IfcApproval getRelatingApproval() {
		return (IfcApproval) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_APPROVAL__RELATING_APPROVAL, true);
	}
	...
	public void setRelatingApproval(IfcApproval newRelatingApproval) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_APPROVAL__RELATING_APPROVAL, newRelatingApproval);
	}
