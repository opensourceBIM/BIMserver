...
public class IfcMaterialPropertiesImpl extends IdEObjectImpl implements IfcMaterialProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MATERIAL_PROPERTIES;
	}
	...
	public IfcMaterial getMaterial() {
		return (IfcMaterial) eGet(LogPackage.Literals.IFC_MATERIAL_PROPERTIES__MATERIAL, true);
	}
	...
	public void setMaterial(IfcMaterial newMaterial) {
		eSet(LogPackage.Literals.IFC_MATERIAL_PROPERTIES__MATERIAL, newMaterial);
	}
