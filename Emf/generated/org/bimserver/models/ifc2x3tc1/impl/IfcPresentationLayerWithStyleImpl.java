...
public class IfcPresentationLayerWithStyleImpl extends IfcPresentationLayerAssignmentImpl implements IfcPresentationLayerWithStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PRESENTATION_LAYER_WITH_STYLE;
	}
	...
	public boolean isLayerOn() {
		return (Boolean) eGet(LogPackage.Literals.IFC_PRESENTATION_LAYER_WITH_STYLE__LAYER_ON, true);
	}
	...
	public void setLayerOn(boolean newLayerOn) {
		eSet(LogPackage.Literals.IFC_PRESENTATION_LAYER_WITH_STYLE__LAYER_ON, newLayerOn);
	}
	...
	public boolean isLayerFrozen() {
		return (Boolean) eGet(LogPackage.Literals.IFC_PRESENTATION_LAYER_WITH_STYLE__LAYER_FROZEN, true);
	}
	...
	public void setLayerFrozen(boolean newLayerFrozen) {
		eSet(LogPackage.Literals.IFC_PRESENTATION_LAYER_WITH_STYLE__LAYER_FROZEN, newLayerFrozen);
	}
	...
	public boolean isLayerBlocked() {
		return (Boolean) eGet(LogPackage.Literals.IFC_PRESENTATION_LAYER_WITH_STYLE__LAYER_BLOCKED, true);
	}
	...
	public void setLayerBlocked(boolean newLayerBlocked) {
		eSet(LogPackage.Literals.IFC_PRESENTATION_LAYER_WITH_STYLE__LAYER_BLOCKED, newLayerBlocked);
	}
	...
	public EList<IfcPresentationStyleSelect> getLayerStyles() {
		return (EList<IfcPresentationStyleSelect>) eGet(LogPackage.Literals.IFC_PRESENTATION_LAYER_WITH_STYLE__LAYER_STYLES, true);
	}
