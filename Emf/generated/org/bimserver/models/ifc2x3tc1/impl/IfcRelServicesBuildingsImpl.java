...
public class IfcRelServicesBuildingsImpl extends IfcRelConnectsImpl implements IfcRelServicesBuildings {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_SERVICES_BUILDINGS;
	}
	...
	public IfcSystem getRelatingSystem() {
		return (IfcSystem) eGet(LogPackage.Literals.IFC_REL_SERVICES_BUILDINGS__RELATING_SYSTEM, true);
	}
	...
	public void setRelatingSystem(IfcSystem newRelatingSystem) {
		eSet(LogPackage.Literals.IFC_REL_SERVICES_BUILDINGS__RELATING_SYSTEM, newRelatingSystem);
	}
	...
	public EList<IfcSpatialStructureElement> getRelatedBuildings() {
		return (EList<IfcSpatialStructureElement>) eGet(LogPackage.Literals.IFC_REL_SERVICES_BUILDINGS__RELATED_BUILDINGS, true);
	}
