...
public class IfcRelConnectsPortToElementImpl extends IfcRelConnectsImpl implements IfcRelConnectsPortToElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_CONNECTS_PORT_TO_ELEMENT;
	}
	...
	public IfcPort getRelatingPort() {
		return (IfcPort) eGet(LogPackage.Literals.IFC_REL_CONNECTS_PORT_TO_ELEMENT__RELATING_PORT, true);
	}
	...
	public void setRelatingPort(IfcPort newRelatingPort) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_PORT_TO_ELEMENT__RELATING_PORT, newRelatingPort);
	}
	...
	public IfcElement getRelatedElement() {
		return (IfcElement) eGet(LogPackage.Literals.IFC_REL_CONNECTS_PORT_TO_ELEMENT__RELATED_ELEMENT, true);
	}
	...
	public void setRelatedElement(IfcElement newRelatedElement) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_PORT_TO_ELEMENT__RELATED_ELEMENT, newRelatedElement);
	}
