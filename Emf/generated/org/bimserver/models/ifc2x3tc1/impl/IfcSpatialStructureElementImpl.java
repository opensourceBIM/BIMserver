...
public class IfcSpatialStructureElementImpl extends IfcProductImpl implements IfcSpatialStructureElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT;
	}
	...
	public String getLongName() {
		return (String) eGet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__LONG_NAME, true);
	}
	...
	public void setLongName(String newLongName) {
		eSet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__LONG_NAME, newLongName);
	}
	...
	public void unsetLongName() {
		eUnset(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__LONG_NAME);
	}
	...
	public boolean isSetLongName() {
		return eIsSet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__LONG_NAME);
	}
	...
	public IfcElementCompositionEnum getCompositionType() {
		return (IfcElementCompositionEnum) eGet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__COMPOSITION_TYPE, true);
	}
	...
	public void setCompositionType(IfcElementCompositionEnum newCompositionType) {
		eSet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__COMPOSITION_TYPE, newCompositionType);
	}
	...
	public EList<IfcRelReferencedInSpatialStructure> getReferencesElements() {
		return (EList<IfcRelReferencedInSpatialStructure>) eGet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__REFERENCES_ELEMENTS, true);
	}
	...
	public void unsetReferencesElements() {
		eUnset(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__REFERENCES_ELEMENTS);
	}
	...
	public boolean isSetReferencesElements() {
		return eIsSet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__REFERENCES_ELEMENTS);
	}
	...
	public EList<IfcRelServicesBuildings> getServicedBySystems() {
		return (EList<IfcRelServicesBuildings>) eGet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__SERVICED_BY_SYSTEMS, true);
	}
	...
	public void unsetServicedBySystems() {
		eUnset(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__SERVICED_BY_SYSTEMS);
	}
	...
	public boolean isSetServicedBySystems() {
		return eIsSet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__SERVICED_BY_SYSTEMS);
	}
	...
	public EList<IfcRelContainedInSpatialStructure> getContainsElements() {
		return (EList<IfcRelContainedInSpatialStructure>) eGet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__CONTAINS_ELEMENTS, true);
	}
	...
	public void unsetContainsElements() {
		eUnset(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__CONTAINS_ELEMENTS);
	}
	...
	public boolean isSetContainsElements() {
		return eIsSet(LogPackage.Literals.IFC_SPATIAL_STRUCTURE_ELEMENT__CONTAINS_ELEMENTS);
	}
