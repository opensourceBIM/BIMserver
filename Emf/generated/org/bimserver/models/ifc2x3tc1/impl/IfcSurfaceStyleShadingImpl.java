...
public class IfcSurfaceStyleShadingImpl extends IdEObjectImpl implements IfcSurfaceStyleShading {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_STYLE_SHADING;
	}
	...
	public IfcColourRgb getSurfaceColour() {
		return (IfcColourRgb) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_SHADING__SURFACE_COLOUR, true);
	}
	...
	public void setSurfaceColour(IfcColourRgb newSurfaceColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_SHADING__SURFACE_COLOUR, newSurfaceColour);
	}
