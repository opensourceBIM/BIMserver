...
public class IfcOccupantImpl extends IfcActorImpl implements IfcOccupant {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_OCCUPANT;
	}
	...
	public IfcOccupantTypeEnum getPredefinedType() {
		return (IfcOccupantTypeEnum) eGet(LogPackage.Literals.IFC_OCCUPANT__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcOccupantTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_OCCUPANT__PREDEFINED_TYPE, newPredefinedType);
	}
