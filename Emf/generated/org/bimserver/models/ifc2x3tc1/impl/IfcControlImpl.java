...
public class IfcControlImpl extends IfcObjectImpl implements IfcControl {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONTROL;
	}
	...
	public EList<IfcRelAssignsToControl> getControls() {
		return (EList<IfcRelAssignsToControl>) eGet(LogPackage.Literals.IFC_CONTROL__CONTROLS, true);
	}
	...
	public void unsetControls() {
		eUnset(LogPackage.Literals.IFC_CONTROL__CONTROLS);
	}
	...
	public boolean isSetControls() {
		return eIsSet(LogPackage.Literals.IFC_CONTROL__CONTROLS);
	}
