...
public class IfcDistributionPortImpl extends IfcPortImpl implements IfcDistributionPort {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DISTRIBUTION_PORT;
	}
	...
	public IfcFlowDirectionEnum getFlowDirection() {
		return (IfcFlowDirectionEnum) eGet(LogPackage.Literals.IFC_DISTRIBUTION_PORT__FLOW_DIRECTION, true);
	}
	...
	public void setFlowDirection(IfcFlowDirectionEnum newFlowDirection) {
		eSet(LogPackage.Literals.IFC_DISTRIBUTION_PORT__FLOW_DIRECTION, newFlowDirection);
	}
	...
	public void unsetFlowDirection() {
		eUnset(LogPackage.Literals.IFC_DISTRIBUTION_PORT__FLOW_DIRECTION);
	}
	...
	public boolean isSetFlowDirection() {
		return eIsSet(LogPackage.Literals.IFC_DISTRIBUTION_PORT__FLOW_DIRECTION);
	}
