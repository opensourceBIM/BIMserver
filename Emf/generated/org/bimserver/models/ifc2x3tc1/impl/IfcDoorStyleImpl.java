...
public class IfcDoorStyleImpl extends IfcTypeProductImpl implements IfcDoorStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DOOR_STYLE;
	}
	...
	public IfcDoorStyleOperationEnum getOperationType() {
		return (IfcDoorStyleOperationEnum) eGet(LogPackage.Literals.IFC_DOOR_STYLE__OPERATION_TYPE, true);
	}
	...
	public void setOperationType(IfcDoorStyleOperationEnum newOperationType) {
		eSet(LogPackage.Literals.IFC_DOOR_STYLE__OPERATION_TYPE, newOperationType);
	}
	...
	public IfcDoorStyleConstructionEnum getConstructionType() {
		return (IfcDoorStyleConstructionEnum) eGet(LogPackage.Literals.IFC_DOOR_STYLE__CONSTRUCTION_TYPE, true);
	}
	...
	public void setConstructionType(IfcDoorStyleConstructionEnum newConstructionType) {
		eSet(LogPackage.Literals.IFC_DOOR_STYLE__CONSTRUCTION_TYPE, newConstructionType);
	}
	...
	public Tristate getParameterTakesPrecedence() {
		return (Tristate) eGet(LogPackage.Literals.IFC_DOOR_STYLE__PARAMETER_TAKES_PRECEDENCE, true);
	}
	...
	public void setParameterTakesPrecedence(Tristate newParameterTakesPrecedence) {
		eSet(LogPackage.Literals.IFC_DOOR_STYLE__PARAMETER_TAKES_PRECEDENCE, newParameterTakesPrecedence);
	}
	...
	public Tristate getSizeable() {
		return (Tristate) eGet(LogPackage.Literals.IFC_DOOR_STYLE__SIZEABLE, true);
	}
	...
	public void setSizeable(Tristate newSizeable) {
		eSet(LogPackage.Literals.IFC_DOOR_STYLE__SIZEABLE, newSizeable);
	}
