...
public class IfcSpaceThermalLoadPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcSpaceThermalLoadProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES;
	}
	...
	public double getApplicableValueRatio() {
		return (Double) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__APPLICABLE_VALUE_RATIO, true);
	}
	...
	public void setApplicableValueRatio(double newApplicableValueRatio) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__APPLICABLE_VALUE_RATIO, newApplicableValueRatio);
	}
	...
	public void unsetApplicableValueRatio() {
		eUnset(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__APPLICABLE_VALUE_RATIO);
	}
	...
	public boolean isSetApplicableValueRatio() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__APPLICABLE_VALUE_RATIO);
	}
	...
	public String getApplicableValueRatioAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__APPLICABLE_VALUE_RATIO_AS_STRING, true);
	}
	...
	public void setApplicableValueRatioAsString(String newApplicableValueRatioAsString) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__APPLICABLE_VALUE_RATIO_AS_STRING, newApplicableValueRatioAsString);
	}
	...
	public void unsetApplicableValueRatioAsString() {
		eUnset(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__APPLICABLE_VALUE_RATIO_AS_STRING);
	}
	...
	public boolean isSetApplicableValueRatioAsString() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__APPLICABLE_VALUE_RATIO_AS_STRING);
	}
	...
	public IfcThermalLoadSourceEnum getThermalLoadSource() {
		return (IfcThermalLoadSourceEnum) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__THERMAL_LOAD_SOURCE, true);
	}
	...
	public void setThermalLoadSource(IfcThermalLoadSourceEnum newThermalLoadSource) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__THERMAL_LOAD_SOURCE, newThermalLoadSource);
	}
	...
	public IfcPropertySourceEnum getPropertySource() {
		return (IfcPropertySourceEnum) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__PROPERTY_SOURCE, true);
	}
	...
	public void setPropertySource(IfcPropertySourceEnum newPropertySource) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__PROPERTY_SOURCE, newPropertySource);
	}
	...
	public String getSourceDescription() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__SOURCE_DESCRIPTION, true);
	}
	...
	public void setSourceDescription(String newSourceDescription) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__SOURCE_DESCRIPTION, newSourceDescription);
	}
	...
	public void unsetSourceDescription() {
		eUnset(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__SOURCE_DESCRIPTION);
	}
	...
	public boolean isSetSourceDescription() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__SOURCE_DESCRIPTION);
	}
	...
	public double getMaximumValue() {
		return (Double) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MAXIMUM_VALUE, true);
	}
	...
	public void setMaximumValue(double newMaximumValue) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MAXIMUM_VALUE, newMaximumValue);
	}
	...
	public String getMaximumValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MAXIMUM_VALUE_AS_STRING, true);
	}
	...
	public void setMaximumValueAsString(String newMaximumValueAsString) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MAXIMUM_VALUE_AS_STRING, newMaximumValueAsString);
	}
	...
	public double getMinimumValue() {
		return (Double) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MINIMUM_VALUE, true);
	}
	...
	public void setMinimumValue(double newMinimumValue) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MINIMUM_VALUE, newMinimumValue);
	}
	...
	public void unsetMinimumValue() {
		eUnset(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MINIMUM_VALUE);
	}
	...
	public boolean isSetMinimumValue() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MINIMUM_VALUE);
	}
	...
	public String getMinimumValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MINIMUM_VALUE_AS_STRING, true);
	}
	...
	public void setMinimumValueAsString(String newMinimumValueAsString) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MINIMUM_VALUE_AS_STRING, newMinimumValueAsString);
	}
	...
	public void unsetMinimumValueAsString() {
		eUnset(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MINIMUM_VALUE_AS_STRING);
	}
	...
	public boolean isSetMinimumValueAsString() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__MINIMUM_VALUE_AS_STRING);
	}
	...
	public IfcTimeSeries getThermalLoadTimeSeriesValues() {
		return (IfcTimeSeries) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__THERMAL_LOAD_TIME_SERIES_VALUES, true);
	}
	...
	public void setThermalLoadTimeSeriesValues(IfcTimeSeries newThermalLoadTimeSeriesValues) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__THERMAL_LOAD_TIME_SERIES_VALUES, newThermalLoadTimeSeriesValues);
	}
	...
	public void unsetThermalLoadTimeSeriesValues() {
		eUnset(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__THERMAL_LOAD_TIME_SERIES_VALUES);
	}
	...
	public boolean isSetThermalLoadTimeSeriesValues() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__THERMAL_LOAD_TIME_SERIES_VALUES);
	}
	...
	public String getUserDefinedThermalLoadSource() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__USER_DEFINED_THERMAL_LOAD_SOURCE, true);
	}
	...
	public void setUserDefinedThermalLoadSource(String newUserDefinedThermalLoadSource) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__USER_DEFINED_THERMAL_LOAD_SOURCE, newUserDefinedThermalLoadSource);
	}
	...
	public void unsetUserDefinedThermalLoadSource() {
		eUnset(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__USER_DEFINED_THERMAL_LOAD_SOURCE);
	}
	...
	public boolean isSetUserDefinedThermalLoadSource() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__USER_DEFINED_THERMAL_LOAD_SOURCE);
	}
	...
	public String getUserDefinedPropertySource() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__USER_DEFINED_PROPERTY_SOURCE, true);
	}
	...
	public void setUserDefinedPropertySource(String newUserDefinedPropertySource) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__USER_DEFINED_PROPERTY_SOURCE, newUserDefinedPropertySource);
	}
	...
	public void unsetUserDefinedPropertySource() {
		eUnset(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__USER_DEFINED_PROPERTY_SOURCE);
	}
	...
	public boolean isSetUserDefinedPropertySource() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__USER_DEFINED_PROPERTY_SOURCE);
	}
	...
	public IfcThermalLoadTypeEnum getThermalLoadType() {
		return (IfcThermalLoadTypeEnum) eGet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__THERMAL_LOAD_TYPE, true);
	}
	...
	public void setThermalLoadType(IfcThermalLoadTypeEnum newThermalLoadType) {
		eSet(LogPackage.Literals.IFC_SPACE_THERMAL_LOAD_PROPERTIES__THERMAL_LOAD_TYPE, newThermalLoadType);
	}
