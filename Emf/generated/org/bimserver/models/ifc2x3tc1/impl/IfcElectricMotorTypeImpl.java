...
public class IfcElectricMotorTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcElectricMotorType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ELECTRIC_MOTOR_TYPE;
	}
	...
	public IfcElectricMotorTypeEnum getPredefinedType() {
		return (IfcElectricMotorTypeEnum) eGet(LogPackage.Literals.IFC_ELECTRIC_MOTOR_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcElectricMotorTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_ELECTRIC_MOTOR_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
