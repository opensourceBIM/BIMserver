...
public class IfcGridPlacementImpl extends IfcObjectPlacementImpl implements IfcGridPlacement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_GRID_PLACEMENT;
	}
	...
	public IfcVirtualGridIntersection getPlacementLocation() {
		return (IfcVirtualGridIntersection) eGet(LogPackage.Literals.IFC_GRID_PLACEMENT__PLACEMENT_LOCATION, true);
	}
	...
	public void setPlacementLocation(IfcVirtualGridIntersection newPlacementLocation) {
		eSet(LogPackage.Literals.IFC_GRID_PLACEMENT__PLACEMENT_LOCATION, newPlacementLocation);
	}
	...
	public IfcVirtualGridIntersection getPlacementRefDirection() {
		return (IfcVirtualGridIntersection) eGet(LogPackage.Literals.IFC_GRID_PLACEMENT__PLACEMENT_REF_DIRECTION, true);
	}
	...
	public void setPlacementRefDirection(IfcVirtualGridIntersection newPlacementRefDirection) {
		eSet(LogPackage.Literals.IFC_GRID_PLACEMENT__PLACEMENT_REF_DIRECTION, newPlacementRefDirection);
	}
	...
	public void unsetPlacementRefDirection() {
		eUnset(LogPackage.Literals.IFC_GRID_PLACEMENT__PLACEMENT_REF_DIRECTION);
	}
	...
	public boolean isSetPlacementRefDirection() {
		return eIsSet(LogPackage.Literals.IFC_GRID_PLACEMENT__PLACEMENT_REF_DIRECTION);
	}
