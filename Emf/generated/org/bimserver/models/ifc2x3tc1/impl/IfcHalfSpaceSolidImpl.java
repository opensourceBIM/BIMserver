...
public class IfcHalfSpaceSolidImpl extends IfcGeometricRepresentationItemImpl implements IfcHalfSpaceSolid {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_HALF_SPACE_SOLID;
	}
	...
	public IfcSurface getBaseSurface() {
		return (IfcSurface) eGet(LogPackage.Literals.IFC_HALF_SPACE_SOLID__BASE_SURFACE, true);
	}
	...
	public void setBaseSurface(IfcSurface newBaseSurface) {
		eSet(LogPackage.Literals.IFC_HALF_SPACE_SOLID__BASE_SURFACE, newBaseSurface);
	}
	...
	public Tristate getAgreementFlag() {
		return (Tristate) eGet(LogPackage.Literals.IFC_HALF_SPACE_SOLID__AGREEMENT_FLAG, true);
	}
	...
	public void setAgreementFlag(Tristate newAgreementFlag) {
		eSet(LogPackage.Literals.IFC_HALF_SPACE_SOLID__AGREEMENT_FLAG, newAgreementFlag);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_HALF_SPACE_SOLID__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_HALF_SPACE_SOLID__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_HALF_SPACE_SOLID__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_HALF_SPACE_SOLID__DIM);
	}
