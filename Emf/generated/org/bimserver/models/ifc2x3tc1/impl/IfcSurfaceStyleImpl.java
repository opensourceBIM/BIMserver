...
public class IfcSurfaceStyleImpl extends IfcPresentationStyleImpl implements IfcSurfaceStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_STYLE;
	}
	...
	public IfcSurfaceSide getSide() {
		return (IfcSurfaceSide) eGet(LogPackage.Literals.IFC_SURFACE_STYLE__SIDE, true);
	}
	...
	public void setSide(IfcSurfaceSide newSide) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE__SIDE, newSide);
	}
	...
	public EList<IfcSurfaceStyleElementSelect> getStyles() {
		return (EList<IfcSurfaceStyleElementSelect>) eGet(LogPackage.Literals.IFC_SURFACE_STYLE__STYLES, true);
	}
