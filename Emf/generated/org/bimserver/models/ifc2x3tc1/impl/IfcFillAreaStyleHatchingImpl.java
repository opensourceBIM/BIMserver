...
public class IfcFillAreaStyleHatchingImpl extends IfcGeometricRepresentationItemImpl implements IfcFillAreaStyleHatching {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING;
	}
	...
	public IfcCurveStyle getHatchLineAppearance() {
		return (IfcCurveStyle) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__HATCH_LINE_APPEARANCE, true);
	}
	...
	public void setHatchLineAppearance(IfcCurveStyle newHatchLineAppearance) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__HATCH_LINE_APPEARANCE, newHatchLineAppearance);
	}
	...
	public IfcHatchLineDistanceSelect getStartOfNextHatchLine() {
		return (IfcHatchLineDistanceSelect) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__START_OF_NEXT_HATCH_LINE, true);
	}
	...
	public void setStartOfNextHatchLine(IfcHatchLineDistanceSelect newStartOfNextHatchLine) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__START_OF_NEXT_HATCH_LINE, newStartOfNextHatchLine);
	}
	...
	public IfcCartesianPoint getPointOfReferenceHatchLine() {
		return (IfcCartesianPoint) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__POINT_OF_REFERENCE_HATCH_LINE, true);
	}
	...
	public void setPointOfReferenceHatchLine(IfcCartesianPoint newPointOfReferenceHatchLine) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__POINT_OF_REFERENCE_HATCH_LINE, newPointOfReferenceHatchLine);
	}
	...
	public void unsetPointOfReferenceHatchLine() {
		eUnset(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__POINT_OF_REFERENCE_HATCH_LINE);
	}
	...
	public boolean isSetPointOfReferenceHatchLine() {
		return eIsSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__POINT_OF_REFERENCE_HATCH_LINE);
	}
	...
	public IfcCartesianPoint getPatternStart() {
		return (IfcCartesianPoint) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__PATTERN_START, true);
	}
	...
	public void setPatternStart(IfcCartesianPoint newPatternStart) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__PATTERN_START, newPatternStart);
	}
	...
	public void unsetPatternStart() {
		eUnset(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__PATTERN_START);
	}
	...
	public boolean isSetPatternStart() {
		return eIsSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__PATTERN_START);
	}
	...
	public double getHatchLineAngle() {
		return (Double) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__HATCH_LINE_ANGLE, true);
	}
	...
	public void setHatchLineAngle(double newHatchLineAngle) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__HATCH_LINE_ANGLE, newHatchLineAngle);
	}
	...
	public String getHatchLineAngleAsString() {
		return (String) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__HATCH_LINE_ANGLE_AS_STRING, true);
	}
	...
	public void setHatchLineAngleAsString(String newHatchLineAngleAsString) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_HATCHING__HATCH_LINE_ANGLE_AS_STRING, newHatchLineAngleAsString);
	}
