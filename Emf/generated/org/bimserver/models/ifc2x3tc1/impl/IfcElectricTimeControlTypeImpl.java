...
public class IfcElectricTimeControlTypeImpl extends IfcFlowControllerTypeImpl implements IfcElectricTimeControlType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ELECTRIC_TIME_CONTROL_TYPE;
	}
	...
	public IfcElectricTimeControlTypeEnum getPredefinedType() {
		return (IfcElectricTimeControlTypeEnum) eGet(LogPackage.Literals.IFC_ELECTRIC_TIME_CONTROL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcElectricTimeControlTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_ELECTRIC_TIME_CONTROL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
