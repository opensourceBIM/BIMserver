...
public class IfcProjectImpl extends IfcObjectImpl implements IfcProject {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROJECT;
	}
	...
	public String getLongName() {
		return (String) eGet(LogPackage.Literals.IFC_PROJECT__LONG_NAME, true);
	}
	...
	public void setLongName(String newLongName) {
		eSet(LogPackage.Literals.IFC_PROJECT__LONG_NAME, newLongName);
	}
	...
	public void unsetLongName() {
		eUnset(LogPackage.Literals.IFC_PROJECT__LONG_NAME);
	}
	...
	public boolean isSetLongName() {
		return eIsSet(LogPackage.Literals.IFC_PROJECT__LONG_NAME);
	}
	...
	public String getPhase() {
		return (String) eGet(LogPackage.Literals.IFC_PROJECT__PHASE, true);
	}
	...
	public void setPhase(String newPhase) {
		eSet(LogPackage.Literals.IFC_PROJECT__PHASE, newPhase);
	}
	...
	public void unsetPhase() {
		eUnset(LogPackage.Literals.IFC_PROJECT__PHASE);
	}
	...
	public boolean isSetPhase() {
		return eIsSet(LogPackage.Literals.IFC_PROJECT__PHASE);
	}
	...
	public EList<IfcRepresentationContext> getRepresentationContexts() {
		return (EList<IfcRepresentationContext>) eGet(LogPackage.Literals.IFC_PROJECT__REPRESENTATION_CONTEXTS, true);
	}
	...
	public IfcUnitAssignment getUnitsInContext() {
		return (IfcUnitAssignment) eGet(LogPackage.Literals.IFC_PROJECT__UNITS_IN_CONTEXT, true);
	}
	...
	public void setUnitsInContext(IfcUnitAssignment newUnitsInContext) {
		eSet(LogPackage.Literals.IFC_PROJECT__UNITS_IN_CONTEXT, newUnitsInContext);
	}
