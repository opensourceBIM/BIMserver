...
public class IfcFaceBasedSurfaceModelImpl extends IfcGeometricRepresentationItemImpl implements IfcFaceBasedSurfaceModel {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FACE_BASED_SURFACE_MODEL;
	}
	...
	public EList<IfcConnectedFaceSet> getFbsmFaces() {
		return (EList<IfcConnectedFaceSet>) eGet(LogPackage.Literals.IFC_FACE_BASED_SURFACE_MODEL__FBSM_FACES, true);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_FACE_BASED_SURFACE_MODEL__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_FACE_BASED_SURFACE_MODEL__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_FACE_BASED_SURFACE_MODEL__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_FACE_BASED_SURFACE_MODEL__DIM);
	}
