...
public class IfcPropertyReferenceValueImpl extends IfcSimplePropertyImpl implements IfcPropertyReferenceValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROPERTY_REFERENCE_VALUE;
	}
	...
	public String getUsageName() {
		return (String) eGet(LogPackage.Literals.IFC_PROPERTY_REFERENCE_VALUE__USAGE_NAME, true);
	}
	...
	public void setUsageName(String newUsageName) {
		eSet(LogPackage.Literals.IFC_PROPERTY_REFERENCE_VALUE__USAGE_NAME, newUsageName);
	}
	...
	public void unsetUsageName() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_REFERENCE_VALUE__USAGE_NAME);
	}
	...
	public boolean isSetUsageName() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_REFERENCE_VALUE__USAGE_NAME);
	}
	...
	public IfcObjectReferenceSelect getPropertyReference() {
		return (IfcObjectReferenceSelect) eGet(LogPackage.Literals.IFC_PROPERTY_REFERENCE_VALUE__PROPERTY_REFERENCE, true);
	}
	...
	public void setPropertyReference(IfcObjectReferenceSelect newPropertyReference) {
		eSet(LogPackage.Literals.IFC_PROPERTY_REFERENCE_VALUE__PROPERTY_REFERENCE, newPropertyReference);
	}
