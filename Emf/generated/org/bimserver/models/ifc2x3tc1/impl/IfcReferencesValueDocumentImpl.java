...
public class IfcReferencesValueDocumentImpl extends IdEObjectImpl implements IfcReferencesValueDocument {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT;
	}
	...
	public IfcDocumentSelect getReferencedDocument() {
		return (IfcDocumentSelect) eGet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__REFERENCED_DOCUMENT, true);
	}
	...
	public void setReferencedDocument(IfcDocumentSelect newReferencedDocument) {
		eSet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__REFERENCED_DOCUMENT, newReferencedDocument);
	}
	...
	public EList<IfcAppliedValue> getReferencingValues() {
		return (EList<IfcAppliedValue>) eGet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__REFERENCING_VALUES, true);
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__NAME);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_REFERENCES_VALUE_DOCUMENT__DESCRIPTION);
	}
