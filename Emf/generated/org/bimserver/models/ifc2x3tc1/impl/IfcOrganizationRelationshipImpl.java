...
public class IfcOrganizationRelationshipImpl extends IdEObjectImpl implements IfcOrganizationRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__NAME, newName);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__DESCRIPTION);
	}
	...
	public IfcOrganization getRelatingOrganization() {
		return (IfcOrganization) eGet(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__RELATING_ORGANIZATION, true);
	}
	...
	public void setRelatingOrganization(IfcOrganization newRelatingOrganization) {
		eSet(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__RELATING_ORGANIZATION, newRelatingOrganization);
	}
	...
	public EList<IfcOrganization> getRelatedOrganizations() {
		return (EList<IfcOrganization>) eGet(LogPackage.Literals.IFC_ORGANIZATION_RELATIONSHIP__RELATED_ORGANIZATIONS, true);
	}
