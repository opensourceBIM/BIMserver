...
public class IfcMaterialDefinitionRepresentationImpl extends IfcProductRepresentationImpl implements IfcMaterialDefinitionRepresentation {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MATERIAL_DEFINITION_REPRESENTATION;
	}
	...
	public IfcMaterial getRepresentedMaterial() {
		return (IfcMaterial) eGet(LogPackage.Literals.IFC_MATERIAL_DEFINITION_REPRESENTATION__REPRESENTED_MATERIAL, true);
	}
	...
	public void setRepresentedMaterial(IfcMaterial newRepresentedMaterial) {
		eSet(LogPackage.Literals.IFC_MATERIAL_DEFINITION_REPRESENTATION__REPRESENTED_MATERIAL, newRepresentedMaterial);
	}
