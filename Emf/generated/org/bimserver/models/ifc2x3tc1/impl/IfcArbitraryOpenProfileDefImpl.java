...
public class IfcArbitraryOpenProfileDefImpl extends IfcProfileDefImpl implements IfcArbitraryOpenProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ARBITRARY_OPEN_PROFILE_DEF;
	}
	...
	public IfcBoundedCurve getCurve() {
		return (IfcBoundedCurve) eGet(LogPackage.Literals.IFC_ARBITRARY_OPEN_PROFILE_DEF__CURVE, true);
	}
	...
	public void setCurve(IfcBoundedCurve newCurve) {
		eSet(LogPackage.Literals.IFC_ARBITRARY_OPEN_PROFILE_DEF__CURVE, newCurve);
	}
