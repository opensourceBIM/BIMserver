...
public class IfcRepresentationImpl extends IdEObjectImpl implements IfcRepresentation {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REPRESENTATION;
	}
	...
	public IfcRepresentationContext getContextOfItems() {
		return (IfcRepresentationContext) eGet(LogPackage.Literals.IFC_REPRESENTATION__CONTEXT_OF_ITEMS, true);
	}
	...
	public void setContextOfItems(IfcRepresentationContext newContextOfItems) {
		eSet(LogPackage.Literals.IFC_REPRESENTATION__CONTEXT_OF_ITEMS, newContextOfItems);
	}
	...
	public String getRepresentationIdentifier() {
		return (String) eGet(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_IDENTIFIER, true);
	}
	...
	public void setRepresentationIdentifier(String newRepresentationIdentifier) {
		eSet(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_IDENTIFIER, newRepresentationIdentifier);
	}
	...
	public void unsetRepresentationIdentifier() {
		eUnset(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_IDENTIFIER);
	}
	...
	public boolean isSetRepresentationIdentifier() {
		return eIsSet(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_IDENTIFIER);
	}
	...
	public String getRepresentationType() {
		return (String) eGet(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_TYPE, true);
	}
	...
	public void setRepresentationType(String newRepresentationType) {
		eSet(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_TYPE, newRepresentationType);
	}
	...
	public void unsetRepresentationType() {
		eUnset(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_TYPE);
	}
	...
	public boolean isSetRepresentationType() {
		return eIsSet(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_TYPE);
	}
	...
	public EList<IfcRepresentationItem> getItems() {
		return (EList<IfcRepresentationItem>) eGet(LogPackage.Literals.IFC_REPRESENTATION__ITEMS, true);
	}
	...
	public EList<IfcRepresentationMap> getRepresentationMap() {
		return (EList<IfcRepresentationMap>) eGet(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_MAP, true);
	}
	...
	public void unsetRepresentationMap() {
		eUnset(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_MAP);
	}
	...
	public boolean isSetRepresentationMap() {
		return eIsSet(LogPackage.Literals.IFC_REPRESENTATION__REPRESENTATION_MAP);
	}
	...
	public EList<IfcPresentationLayerAssignment> getLayerAssignments() {
		return (EList<IfcPresentationLayerAssignment>) eGet(LogPackage.Literals.IFC_REPRESENTATION__LAYER_ASSIGNMENTS, true);
	}
	...
	public void unsetLayerAssignments() {
		eUnset(LogPackage.Literals.IFC_REPRESENTATION__LAYER_ASSIGNMENTS);
	}
	...
	public boolean isSetLayerAssignments() {
		return eIsSet(LogPackage.Literals.IFC_REPRESENTATION__LAYER_ASSIGNMENTS);
	}
	...
	public EList<IfcProductRepresentation> getOfProductRepresentation() {
		return (EList<IfcProductRepresentation>) eGet(LogPackage.Literals.IFC_REPRESENTATION__OF_PRODUCT_REPRESENTATION, true);
	}
	...
	public void unsetOfProductRepresentation() {
		eUnset(LogPackage.Literals.IFC_REPRESENTATION__OF_PRODUCT_REPRESENTATION);
	}
	...
	public boolean isSetOfProductRepresentation() {
		return eIsSet(LogPackage.Literals.IFC_REPRESENTATION__OF_PRODUCT_REPRESENTATION);
	}
