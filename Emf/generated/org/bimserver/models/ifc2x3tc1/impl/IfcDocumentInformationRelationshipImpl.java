...
public class IfcDocumentInformationRelationshipImpl extends IdEObjectImpl implements IfcDocumentInformationRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP;
	}
	...
	public IfcDocumentInformation getRelatingDocument() {
		return (IfcDocumentInformation) eGet(LogPackage.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATING_DOCUMENT, true);
	}
	...
	public void setRelatingDocument(IfcDocumentInformation newRelatingDocument) {
		eSet(LogPackage.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATING_DOCUMENT, newRelatingDocument);
	}
	...
	public EList<IfcDocumentInformation> getRelatedDocuments() {
		return (EList<IfcDocumentInformation>) eGet(LogPackage.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATED_DOCUMENTS, true);
	}
	...
	public String getRelationshipType() {
		return (String) eGet(LogPackage.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATIONSHIP_TYPE, true);
	}
	...
	public void setRelationshipType(String newRelationshipType) {
		eSet(LogPackage.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATIONSHIP_TYPE, newRelationshipType);
	}
	...
	public void unsetRelationshipType() {
		eUnset(LogPackage.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATIONSHIP_TYPE);
	}
	...
	public boolean isSetRelationshipType() {
		return eIsSet(LogPackage.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATIONSHIP_TYPE);
	}
