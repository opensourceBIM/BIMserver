...
public class IfcMotorConnectionTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcMotorConnectionType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MOTOR_CONNECTION_TYPE;
	}
	...
	public IfcMotorConnectionTypeEnum getPredefinedType() {
		return (IfcMotorConnectionTypeEnum) eGet(LogPackage.Literals.IFC_MOTOR_CONNECTION_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcMotorConnectionTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_MOTOR_CONNECTION_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
