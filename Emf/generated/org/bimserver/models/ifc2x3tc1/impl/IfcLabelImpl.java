...
public class IfcLabelImpl extends WrappedValueImpl implements IfcLabel {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LABEL;
	}
	...
	public String getWrappedValue() {
		return (String) eGet(LogPackage.Literals.IFC_LABEL__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(String newWrappedValue) {
		eSet(LogPackage.Literals.IFC_LABEL__WRAPPED_VALUE, newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(LogPackage.Literals.IFC_LABEL__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(LogPackage.Literals.IFC_LABEL__WRAPPED_VALUE);
	}
