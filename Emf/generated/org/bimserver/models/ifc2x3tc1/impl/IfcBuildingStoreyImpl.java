...
public class IfcBuildingStoreyImpl extends IfcSpatialStructureElementImpl implements IfcBuildingStorey {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_BUILDING_STOREY;
	}
	...
	public double getElevation() {
		return (Double) eGet(LogPackage.Literals.IFC_BUILDING_STOREY__ELEVATION, true);
	}
	...
	public void setElevation(double newElevation) {
		eSet(LogPackage.Literals.IFC_BUILDING_STOREY__ELEVATION, newElevation);
	}
	...
	public void unsetElevation() {
		eUnset(LogPackage.Literals.IFC_BUILDING_STOREY__ELEVATION);
	}
	...
	public boolean isSetElevation() {
		return eIsSet(LogPackage.Literals.IFC_BUILDING_STOREY__ELEVATION);
	}
	...
	public String getElevationAsString() {
		return (String) eGet(LogPackage.Literals.IFC_BUILDING_STOREY__ELEVATION_AS_STRING, true);
	}
	...
	public void setElevationAsString(String newElevationAsString) {
		eSet(LogPackage.Literals.IFC_BUILDING_STOREY__ELEVATION_AS_STRING, newElevationAsString);
	}
	...
	public void unsetElevationAsString() {
		eUnset(LogPackage.Literals.IFC_BUILDING_STOREY__ELEVATION_AS_STRING);
	}
	...
	public boolean isSetElevationAsString() {
		return eIsSet(LogPackage.Literals.IFC_BUILDING_STOREY__ELEVATION_AS_STRING);
	}
