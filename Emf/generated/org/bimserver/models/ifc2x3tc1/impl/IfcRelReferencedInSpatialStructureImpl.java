...
public class IfcRelReferencedInSpatialStructureImpl extends IfcRelConnectsImpl implements IfcRelReferencedInSpatialStructure {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE;
	}
	...
	public EList<IfcProduct> getRelatedElements() {
		return (EList<IfcProduct>) eGet(LogPackage.Literals.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATED_ELEMENTS, true);
	}
	...
	public IfcSpatialStructureElement getRelatingStructure() {
		return (IfcSpatialStructureElement) eGet(LogPackage.Literals.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATING_STRUCTURE, true);
	}
	...
	public void setRelatingStructure(IfcSpatialStructureElement newRelatingStructure) {
		eSet(LogPackage.Literals.IFC_REL_REFERENCED_IN_SPATIAL_STRUCTURE__RELATING_STRUCTURE, newRelatingStructure);
	}
