...
public class IfcArbitraryClosedProfileDefImpl extends IfcProfileDefImpl implements IfcArbitraryClosedProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ARBITRARY_CLOSED_PROFILE_DEF;
	}
	...
	public IfcCurve getOuterCurve() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_ARBITRARY_CLOSED_PROFILE_DEF__OUTER_CURVE, true);
	}
	...
	public void setOuterCurve(IfcCurve newOuterCurve) {
		eSet(LogPackage.Literals.IFC_ARBITRARY_CLOSED_PROFILE_DEF__OUTER_CURVE, newOuterCurve);
	}
