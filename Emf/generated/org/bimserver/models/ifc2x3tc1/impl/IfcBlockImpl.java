 ...
 *   <li>{@link org.bimserver.models.ifc2x3tc1.impl.IfcBlockImpl#getYLength <em>YLength</em>}</li>
 *   <li>{@link org.bimserver.models.ifc2x3tc1.impl.IfcBlockImpl#getYLengthAsString <em>YLength As String</em>}</li>
...
public class IfcBlockImpl extends IfcCsgPrimitive3DImpl implements IfcBlock {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_BLOCK;
	}
	...
	public double getXLength() {
		return (Double) eGet(LogPackage.Literals.IFC_BLOCK__XLENGTH, true);
	}
	...
	public void setXLength(double newXLength) {
		eSet(LogPackage.Literals.IFC_BLOCK__XLENGTH, newXLength);
	}
	...
	public String getXLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_BLOCK__XLENGTH_AS_STRING, true);
	}
	...
	public void setXLengthAsString(String newXLengthAsString) {
		eSet(LogPackage.Literals.IFC_BLOCK__XLENGTH_AS_STRING, newXLengthAsString);
	}
	...
	public double getYLength() {
		return (Double) eGet(LogPackage.Literals.IFC_BLOCK__YLENGTH, true);
	}
	...
	public void setYLength(double newYLength) {
		eSet(LogPackage.Literals.IFC_BLOCK__YLENGTH, newYLength);
	}
	...
	public String getYLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_BLOCK__YLENGTH_AS_STRING, true);
	}
	...
	public void setYLengthAsString(String newYLengthAsString) {
		eSet(LogPackage.Literals.IFC_BLOCK__YLENGTH_AS_STRING, newYLengthAsString);
	}
	...
	public double getZLength() {
		return (Double) eGet(LogPackage.Literals.IFC_BLOCK__ZLENGTH, true);
	}
	...
	public void setZLength(double newZLength) {
		eSet(LogPackage.Literals.IFC_BLOCK__ZLENGTH, newZLength);
	}
	...
	public String getZLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_BLOCK__ZLENGTH_AS_STRING, true);
	}
	...
	public void setZLengthAsString(String newZLengthAsString) {
		eSet(LogPackage.Literals.IFC_BLOCK__ZLENGTH_AS_STRING, newZLengthAsString);
	}
