...
public class IfcStructuralMemberImpl extends IfcStructuralItemImpl implements IfcStructuralMember {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_MEMBER;
	}
	...
	public EList<IfcRelConnectsStructuralElement> getReferencesElement() {
		return (EList<IfcRelConnectsStructuralElement>) eGet(LogPackage.Literals.IFC_STRUCTURAL_MEMBER__REFERENCES_ELEMENT, true);
	}
	...
	public void unsetReferencesElement() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_MEMBER__REFERENCES_ELEMENT);
	}
	...
	public boolean isSetReferencesElement() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_MEMBER__REFERENCES_ELEMENT);
	}
	...
	public EList<IfcRelConnectsStructuralMember> getConnectedBy() {
		return (EList<IfcRelConnectsStructuralMember>) eGet(LogPackage.Literals.IFC_STRUCTURAL_MEMBER__CONNECTED_BY, true);
	}
	...
	public void unsetConnectedBy() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_MEMBER__CONNECTED_BY);
	}
	...
	public boolean isSetConnectedBy() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_MEMBER__CONNECTED_BY);
	}
