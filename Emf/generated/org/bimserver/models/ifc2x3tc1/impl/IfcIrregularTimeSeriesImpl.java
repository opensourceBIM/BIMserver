...
public class IfcIrregularTimeSeriesImpl extends IfcTimeSeriesImpl implements IfcIrregularTimeSeries {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_IRREGULAR_TIME_SERIES;
	}
	...
	public EList<IfcIrregularTimeSeriesValue> getValues() {
		return (EList<IfcIrregularTimeSeriesValue>) eGet(LogPackage.Literals.IFC_IRREGULAR_TIME_SERIES__VALUES, true);
	}
