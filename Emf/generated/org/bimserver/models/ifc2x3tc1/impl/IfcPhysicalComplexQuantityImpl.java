...
public class IfcPhysicalComplexQuantityImpl extends IfcPhysicalQuantityImpl implements IfcPhysicalComplexQuantity {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY;
	}
	...
	public EList<IfcPhysicalQuantity> getHasQuantities() {
		return (EList<IfcPhysicalQuantity>) eGet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__HAS_QUANTITIES, true);
	}
	...
	public String getDiscrimination() {
		return (String) eGet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__DISCRIMINATION, true);
	}
	...
	public void setDiscrimination(String newDiscrimination) {
		eSet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__DISCRIMINATION, newDiscrimination);
	}
	...
	public String getQuality() {
		return (String) eGet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__QUALITY, true);
	}
	...
	public void setQuality(String newQuality) {
		eSet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__QUALITY, newQuality);
	}
	...
	public void unsetQuality() {
		eUnset(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__QUALITY);
	}
	...
	public boolean isSetQuality() {
		return eIsSet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__QUALITY);
	}
	...
	public String getUsage() {
		return (String) eGet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__USAGE, true);
	}
	...
	public void setUsage(String newUsage) {
		eSet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__USAGE, newUsage);
	}
	...
	public void unsetUsage() {
		eUnset(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__USAGE);
	}
	...
	public boolean isSetUsage() {
		return eIsSet(LogPackage.Literals.IFC_PHYSICAL_COMPLEX_QUANTITY__USAGE);
	}
