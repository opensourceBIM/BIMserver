...
public class IfcPhysicalQuantityImpl extends IdEObjectImpl implements IfcPhysicalQuantity {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PHYSICAL_QUANTITY;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__NAME, newName);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__DESCRIPTION);
	}
	...
	public EList<IfcPhysicalComplexQuantity> getPartOfComplex() {
		return (EList<IfcPhysicalComplexQuantity>) eGet(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__PART_OF_COMPLEX, true);
	}
	...
	public void unsetPartOfComplex() {
		eUnset(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__PART_OF_COMPLEX);
	}
	...
	public boolean isSetPartOfComplex() {
		return eIsSet(LogPackage.Literals.IFC_PHYSICAL_QUANTITY__PART_OF_COMPLEX);
	}
