...
public class IfcMaterialClassificationRelationshipImpl extends IdEObjectImpl implements IfcMaterialClassificationRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MATERIAL_CLASSIFICATION_RELATIONSHIP;
	}
	...
	public EList<IfcClassificationNotationSelect> getMaterialClassifications() {
		return (EList<IfcClassificationNotationSelect>) eGet(LogPackage.Literals.IFC_MATERIAL_CLASSIFICATION_RELATIONSHIP__MATERIAL_CLASSIFICATIONS, true);
	}
	...
	public IfcMaterial getClassifiedMaterial() {
		return (IfcMaterial) eGet(LogPackage.Literals.IFC_MATERIAL_CLASSIFICATION_RELATIONSHIP__CLASSIFIED_MATERIAL, true);
	}
	...
	public void setClassifiedMaterial(IfcMaterial newClassifiedMaterial) {
		eSet(LogPackage.Literals.IFC_MATERIAL_CLASSIFICATION_RELATIONSHIP__CLASSIFIED_MATERIAL, newClassifiedMaterial);
	}
