...
public class IfcDocumentReferenceImpl extends IfcExternalReferenceImpl implements IfcDocumentReference {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DOCUMENT_REFERENCE;
	}
	...
	public EList<IfcDocumentInformation> getReferenceToDocument() {
		return (EList<IfcDocumentInformation>) eGet(LogPackage.Literals.IFC_DOCUMENT_REFERENCE__REFERENCE_TO_DOCUMENT, true);
	}
	...
	public void unsetReferenceToDocument() {
		eUnset(LogPackage.Literals.IFC_DOCUMENT_REFERENCE__REFERENCE_TO_DOCUMENT);
	}
	...
	public boolean isSetReferenceToDocument() {
		return eIsSet(LogPackage.Literals.IFC_DOCUMENT_REFERENCE__REFERENCE_TO_DOCUMENT);
	}
