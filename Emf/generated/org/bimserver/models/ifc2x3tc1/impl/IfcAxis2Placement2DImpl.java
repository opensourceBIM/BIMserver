...
public class IfcAxis2Placement2DImpl extends IfcPlacementImpl implements IfcAxis2Placement2D {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_AXIS2_PLACEMENT2_D;
	}
	...
	public IfcDirection getRefDirection() {
		return (IfcDirection) eGet(LogPackage.Literals.IFC_AXIS2_PLACEMENT2_D__REF_DIRECTION, true);
	}
	...
	public void setRefDirection(IfcDirection newRefDirection) {
		eSet(LogPackage.Literals.IFC_AXIS2_PLACEMENT2_D__REF_DIRECTION, newRefDirection);
	}
	...
	public void unsetRefDirection() {
		eUnset(LogPackage.Literals.IFC_AXIS2_PLACEMENT2_D__REF_DIRECTION);
	}
	...
	public boolean isSetRefDirection() {
		return eIsSet(LogPackage.Literals.IFC_AXIS2_PLACEMENT2_D__REF_DIRECTION);
	}
