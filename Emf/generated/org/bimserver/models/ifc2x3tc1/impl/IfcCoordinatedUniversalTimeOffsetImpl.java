...
public class IfcCoordinatedUniversalTimeOffsetImpl extends IdEObjectImpl implements IfcCoordinatedUniversalTimeOffset {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET;
	}
	...
	public int getHourOffset() {
		return (Integer) eGet(LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET__HOUR_OFFSET, true);
	}
	...
	public void setHourOffset(int newHourOffset) {
		eSet(LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET__HOUR_OFFSET, newHourOffset);
	}
	...
	public int getMinuteOffset() {
		return (Integer) eGet(LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET__MINUTE_OFFSET, true);
	}
	...
	public void setMinuteOffset(int newMinuteOffset) {
		eSet(LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET__MINUTE_OFFSET, newMinuteOffset);
	}
	...
	public void unsetMinuteOffset() {
		eUnset(LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET__MINUTE_OFFSET);
	}
	...
	public boolean isSetMinuteOffset() {
		return eIsSet(LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET__MINUTE_OFFSET);
	}
	...
	public IfcAheadOrBehind getSense() {
		return (IfcAheadOrBehind) eGet(LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET__SENSE, true);
	}
	...
	public void setSense(IfcAheadOrBehind newSense) {
		eSet(LogPackage.Literals.IFC_COORDINATED_UNIVERSAL_TIME_OFFSET__SENSE, newSense);
	}
