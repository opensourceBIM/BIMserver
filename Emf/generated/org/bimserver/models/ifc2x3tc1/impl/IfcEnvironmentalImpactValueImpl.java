...
public class IfcEnvironmentalImpactValueImpl extends IfcAppliedValueImpl implements IfcEnvironmentalImpactValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE;
	}
	...
	public String getImpactType() {
		return (String) eGet(LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE__IMPACT_TYPE, true);
	}
	...
	public void setImpactType(String newImpactType) {
		eSet(LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE__IMPACT_TYPE, newImpactType);
	}
	...
	public IfcEnvironmentalImpactCategoryEnum getCategory() {
		return (IfcEnvironmentalImpactCategoryEnum) eGet(LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE__CATEGORY, true);
	}
	...
	public void setCategory(IfcEnvironmentalImpactCategoryEnum newCategory) {
		eSet(LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE__CATEGORY, newCategory);
	}
	...
	public String getUserDefinedCategory() {
		return (String) eGet(LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE__USER_DEFINED_CATEGORY, true);
	}
	...
	public void setUserDefinedCategory(String newUserDefinedCategory) {
		eSet(LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE__USER_DEFINED_CATEGORY, newUserDefinedCategory);
	}
	...
	public void unsetUserDefinedCategory() {
		eUnset(LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE__USER_DEFINED_CATEGORY);
	}
	...
	public boolean isSetUserDefinedCategory() {
		return eIsSet(LogPackage.Literals.IFC_ENVIRONMENTAL_IMPACT_VALUE__USER_DEFINED_CATEGORY);
	}
