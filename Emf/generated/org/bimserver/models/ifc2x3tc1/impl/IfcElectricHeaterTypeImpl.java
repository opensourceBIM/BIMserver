...
public class IfcElectricHeaterTypeImpl extends IfcFlowTerminalTypeImpl implements IfcElectricHeaterType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ELECTRIC_HEATER_TYPE;
	}
	...
	public IfcElectricHeaterTypeEnum getPredefinedType() {
		return (IfcElectricHeaterTypeEnum) eGet(LogPackage.Literals.IFC_ELECTRIC_HEATER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcElectricHeaterTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_ELECTRIC_HEATER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
