...
public class IfcRampFlightTypeImpl extends IfcBuildingElementTypeImpl implements IfcRampFlightType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RAMP_FLIGHT_TYPE;
	}
	...
	public IfcRampFlightTypeEnum getPredefinedType() {
		return (IfcRampFlightTypeEnum) eGet(LogPackage.Literals.IFC_RAMP_FLIGHT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcRampFlightTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_RAMP_FLIGHT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
