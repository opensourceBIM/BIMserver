...
public class IfcInventoryImpl extends IfcGroupImpl implements IfcInventory {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_INVENTORY;
	}
	...
	public IfcInventoryTypeEnum getInventoryType() {
		return (IfcInventoryTypeEnum) eGet(LogPackage.Literals.IFC_INVENTORY__INVENTORY_TYPE, true);
	}
	...
	public void setInventoryType(IfcInventoryTypeEnum newInventoryType) {
		eSet(LogPackage.Literals.IFC_INVENTORY__INVENTORY_TYPE, newInventoryType);
	}
	...
	public IfcActorSelect getJurisdiction() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_INVENTORY__JURISDICTION, true);
	}
	...
	public void setJurisdiction(IfcActorSelect newJurisdiction) {
		eSet(LogPackage.Literals.IFC_INVENTORY__JURISDICTION, newJurisdiction);
	}
	...
	public EList<IfcPerson> getResponsiblePersons() {
		return (EList<IfcPerson>) eGet(LogPackage.Literals.IFC_INVENTORY__RESPONSIBLE_PERSONS, true);
	}
	...
	public IfcCalendarDate getLastUpdateDate() {
		return (IfcCalendarDate) eGet(LogPackage.Literals.IFC_INVENTORY__LAST_UPDATE_DATE, true);
	}
	...
	public void setLastUpdateDate(IfcCalendarDate newLastUpdateDate) {
		eSet(LogPackage.Literals.IFC_INVENTORY__LAST_UPDATE_DATE, newLastUpdateDate);
	}
	...
	public IfcCostValue getCurrentValue() {
		return (IfcCostValue) eGet(LogPackage.Literals.IFC_INVENTORY__CURRENT_VALUE, true);
	}
	...
	public void setCurrentValue(IfcCostValue newCurrentValue) {
		eSet(LogPackage.Literals.IFC_INVENTORY__CURRENT_VALUE, newCurrentValue);
	}
	...
	public void unsetCurrentValue() {
		eUnset(LogPackage.Literals.IFC_INVENTORY__CURRENT_VALUE);
	}
	...
	public boolean isSetCurrentValue() {
		return eIsSet(LogPackage.Literals.IFC_INVENTORY__CURRENT_VALUE);
	}
	...
	public IfcCostValue getOriginalValue() {
		return (IfcCostValue) eGet(LogPackage.Literals.IFC_INVENTORY__ORIGINAL_VALUE, true);
	}
	...
	public void setOriginalValue(IfcCostValue newOriginalValue) {
		eSet(LogPackage.Literals.IFC_INVENTORY__ORIGINAL_VALUE, newOriginalValue);
	}
	...
	public void unsetOriginalValue() {
		eUnset(LogPackage.Literals.IFC_INVENTORY__ORIGINAL_VALUE);
	}
	...
	public boolean isSetOriginalValue() {
		return eIsSet(LogPackage.Literals.IFC_INVENTORY__ORIGINAL_VALUE);
	}
