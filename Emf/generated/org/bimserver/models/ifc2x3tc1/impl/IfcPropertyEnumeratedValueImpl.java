...
public class IfcPropertyEnumeratedValueImpl extends IfcSimplePropertyImpl implements IfcPropertyEnumeratedValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROPERTY_ENUMERATED_VALUE;
	}
	...
	public EList<IfcValue> getEnumerationValues() {
		return (EList<IfcValue>) eGet(LogPackage.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_VALUES, true);
	}
	...
	public IfcPropertyEnumeration getEnumerationReference() {
		return (IfcPropertyEnumeration) eGet(LogPackage.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_REFERENCE, true);
	}
	...
	public void setEnumerationReference(IfcPropertyEnumeration newEnumerationReference) {
		eSet(LogPackage.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_REFERENCE, newEnumerationReference);
	}
	...
	public void unsetEnumerationReference() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_REFERENCE);
	}
	...
	public boolean isSetEnumerationReference() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_REFERENCE);
	}
