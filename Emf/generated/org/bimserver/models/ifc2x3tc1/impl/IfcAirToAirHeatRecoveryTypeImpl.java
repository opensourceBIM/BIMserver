...
public class IfcAirToAirHeatRecoveryTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcAirToAirHeatRecoveryType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_AIR_TO_AIR_HEAT_RECOVERY_TYPE;
	}
	...
	public IfcAirToAirHeatRecoveryTypeEnum getPredefinedType() {
		return (IfcAirToAirHeatRecoveryTypeEnum) eGet(LogPackage.Literals.IFC_AIR_TO_AIR_HEAT_RECOVERY_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcAirToAirHeatRecoveryTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_AIR_TO_AIR_HEAT_RECOVERY_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
