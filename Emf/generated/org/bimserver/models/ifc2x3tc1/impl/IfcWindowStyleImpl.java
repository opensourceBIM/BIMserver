...
public class IfcWindowStyleImpl extends IfcTypeProductImpl implements IfcWindowStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_WINDOW_STYLE;
	}
	...
	public IfcWindowStyleConstructionEnum getConstructionType() {
		return (IfcWindowStyleConstructionEnum) eGet(LogPackage.Literals.IFC_WINDOW_STYLE__CONSTRUCTION_TYPE, true);
	}
	...
	public void setConstructionType(IfcWindowStyleConstructionEnum newConstructionType) {
		eSet(LogPackage.Literals.IFC_WINDOW_STYLE__CONSTRUCTION_TYPE, newConstructionType);
	}
	...
	public IfcWindowStyleOperationEnum getOperationType() {
		return (IfcWindowStyleOperationEnum) eGet(LogPackage.Literals.IFC_WINDOW_STYLE__OPERATION_TYPE, true);
	}
	...
	public void setOperationType(IfcWindowStyleOperationEnum newOperationType) {
		eSet(LogPackage.Literals.IFC_WINDOW_STYLE__OPERATION_TYPE, newOperationType);
	}
	...
	public Tristate getParameterTakesPrecedence() {
		return (Tristate) eGet(LogPackage.Literals.IFC_WINDOW_STYLE__PARAMETER_TAKES_PRECEDENCE, true);
	}
	...
	public void setParameterTakesPrecedence(Tristate newParameterTakesPrecedence) {
		eSet(LogPackage.Literals.IFC_WINDOW_STYLE__PARAMETER_TAKES_PRECEDENCE, newParameterTakesPrecedence);
	}
	...
	public Tristate getSizeable() {
		return (Tristate) eGet(LogPackage.Literals.IFC_WINDOW_STYLE__SIZEABLE, true);
	}
	...
	public void setSizeable(Tristate newSizeable) {
		eSet(LogPackage.Literals.IFC_WINDOW_STYLE__SIZEABLE, newSizeable);
	}
