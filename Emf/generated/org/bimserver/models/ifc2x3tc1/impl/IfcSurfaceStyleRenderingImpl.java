...
public class IfcSurfaceStyleRenderingImpl extends IfcSurfaceStyleShadingImpl implements IfcSurfaceStyleRendering {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING;
	}
	...
	public double getTransparency() {
		return (Double) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSPARENCY, true);
	}
	...
	public void setTransparency(double newTransparency) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSPARENCY, newTransparency);
	}
	...
	public void unsetTransparency() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSPARENCY);
	}
	...
	public boolean isSetTransparency() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSPARENCY);
	}
	...
	public String getTransparencyAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSPARENCY_AS_STRING, true);
	}
	...
	public void setTransparencyAsString(String newTransparencyAsString) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSPARENCY_AS_STRING, newTransparencyAsString);
	}
	...
	public void unsetTransparencyAsString() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSPARENCY_AS_STRING);
	}
	...
	public boolean isSetTransparencyAsString() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSPARENCY_AS_STRING);
	}
	...
	public IfcColourOrFactor getDiffuseColour() {
		return (IfcColourOrFactor) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__DIFFUSE_COLOUR, true);
	}
	...
	public void setDiffuseColour(IfcColourOrFactor newDiffuseColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__DIFFUSE_COLOUR, newDiffuseColour);
	}
	...
	public void unsetDiffuseColour() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__DIFFUSE_COLOUR);
	}
	...
	public boolean isSetDiffuseColour() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__DIFFUSE_COLOUR);
	}
	...
	public IfcColourOrFactor getTransmissionColour() {
		return (IfcColourOrFactor) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSMISSION_COLOUR, true);
	}
	...
	public void setTransmissionColour(IfcColourOrFactor newTransmissionColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSMISSION_COLOUR, newTransmissionColour);
	}
	...
	public void unsetTransmissionColour() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSMISSION_COLOUR);
	}
	...
	public boolean isSetTransmissionColour() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__TRANSMISSION_COLOUR);
	}
	...
	public IfcColourOrFactor getDiffuseTransmissionColour() {
		return (IfcColourOrFactor) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__DIFFUSE_TRANSMISSION_COLOUR, true);
	}
	...
	public void setDiffuseTransmissionColour(IfcColourOrFactor newDiffuseTransmissionColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__DIFFUSE_TRANSMISSION_COLOUR, newDiffuseTransmissionColour);
	}
	...
	public void unsetDiffuseTransmissionColour() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__DIFFUSE_TRANSMISSION_COLOUR);
	}
	...
	public boolean isSetDiffuseTransmissionColour() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__DIFFUSE_TRANSMISSION_COLOUR);
	}
	...
	public IfcColourOrFactor getReflectionColour() {
		return (IfcColourOrFactor) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__REFLECTION_COLOUR, true);
	}
	...
	public void setReflectionColour(IfcColourOrFactor newReflectionColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__REFLECTION_COLOUR, newReflectionColour);
	}
	...
	public void unsetReflectionColour() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__REFLECTION_COLOUR);
	}
	...
	public boolean isSetReflectionColour() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__REFLECTION_COLOUR);
	}
	...
	public IfcColourOrFactor getSpecularColour() {
		return (IfcColourOrFactor) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__SPECULAR_COLOUR, true);
	}
	...
	public void setSpecularColour(IfcColourOrFactor newSpecularColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__SPECULAR_COLOUR, newSpecularColour);
	}
	...
	public void unsetSpecularColour() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__SPECULAR_COLOUR);
	}
	...
	public boolean isSetSpecularColour() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__SPECULAR_COLOUR);
	}
	...
	public IfcSpecularHighlightSelect getSpecularHighlight() {
		return (IfcSpecularHighlightSelect) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__SPECULAR_HIGHLIGHT, true);
	}
	...
	public void setSpecularHighlight(IfcSpecularHighlightSelect newSpecularHighlight) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__SPECULAR_HIGHLIGHT, newSpecularHighlight);
	}
	...
	public void unsetSpecularHighlight() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__SPECULAR_HIGHLIGHT);
	}
	...
	public boolean isSetSpecularHighlight() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__SPECULAR_HIGHLIGHT);
	}
	...
	public IfcReflectanceMethodEnum getReflectanceMethod() {
		return (IfcReflectanceMethodEnum) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__REFLECTANCE_METHOD, true);
	}
	...
	public void setReflectanceMethod(IfcReflectanceMethodEnum newReflectanceMethod) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_RENDERING__REFLECTANCE_METHOD, newReflectanceMethod);
	}
