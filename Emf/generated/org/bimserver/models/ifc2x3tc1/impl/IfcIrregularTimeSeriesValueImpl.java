...
public class IfcIrregularTimeSeriesValueImpl extends IdEObjectImpl implements IfcIrregularTimeSeriesValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_IRREGULAR_TIME_SERIES_VALUE;
	}
	...
	public IfcDateTimeSelect getTimeStamp() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_IRREGULAR_TIME_SERIES_VALUE__TIME_STAMP, true);
	}
	...
	public void setTimeStamp(IfcDateTimeSelect newTimeStamp) {
		eSet(LogPackage.Literals.IFC_IRREGULAR_TIME_SERIES_VALUE__TIME_STAMP, newTimeStamp);
	}
	...
	public EList<IfcValue> getListValues() {
		return (EList<IfcValue>) eGet(LogPackage.Literals.IFC_IRREGULAR_TIME_SERIES_VALUE__LIST_VALUES, true);
	}
