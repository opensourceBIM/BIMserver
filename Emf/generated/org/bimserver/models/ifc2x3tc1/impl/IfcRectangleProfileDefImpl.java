...
public class IfcRectangleProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcRectangleProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF;
	}
	...
	public double getXDim() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF__XDIM, true);
	}
	...
	public void setXDim(double newXDim) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF__XDIM, newXDim);
	}
	...
	public String getXDimAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF__XDIM_AS_STRING, true);
	}
	...
	public void setXDimAsString(String newXDimAsString) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF__XDIM_AS_STRING, newXDimAsString);
	}
	...
	public double getYDim() {
		return (Double) eGet(LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF__YDIM, true);
	}
	...
	public void setYDim(double newYDim) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF__YDIM, newYDim);
	}
	...
	public String getYDimAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF__YDIM_AS_STRING, true);
	}
	...
	public void setYDimAsString(String newYDimAsString) {
		eSet(LogPackage.Literals.IFC_RECTANGLE_PROFILE_DEF__YDIM_AS_STRING, newYDimAsString);
	}
