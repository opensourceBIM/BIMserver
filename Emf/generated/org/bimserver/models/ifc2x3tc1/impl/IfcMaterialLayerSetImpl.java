...
public class IfcMaterialLayerSetImpl extends IdEObjectImpl implements IfcMaterialLayerSet {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MATERIAL_LAYER_SET;
	}
	...
	public EList<IfcMaterialLayer> getMaterialLayers() {
		return (EList<IfcMaterialLayer>) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__MATERIAL_LAYERS, true);
	}
	...
	public String getLayerSetName() {
		return (String) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__LAYER_SET_NAME, true);
	}
	...
	public void setLayerSetName(String newLayerSetName) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__LAYER_SET_NAME, newLayerSetName);
	}
	...
	public void unsetLayerSetName() {
		eUnset(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__LAYER_SET_NAME);
	}
	...
	public boolean isSetLayerSetName() {
		return eIsSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__LAYER_SET_NAME);
	}
	...
	public double getTotalThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__TOTAL_THICKNESS, true);
	}
	...
	public void setTotalThickness(double newTotalThickness) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__TOTAL_THICKNESS, newTotalThickness);
	}
	...
	public void unsetTotalThickness() {
		eUnset(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__TOTAL_THICKNESS);
	}
	...
	public boolean isSetTotalThickness() {
		return eIsSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__TOTAL_THICKNESS);
	}
	...
	public String getTotalThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__TOTAL_THICKNESS_AS_STRING, true);
	}
	...
	public void setTotalThicknessAsString(String newTotalThicknessAsString) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__TOTAL_THICKNESS_AS_STRING, newTotalThicknessAsString);
	}
	...
	public void unsetTotalThicknessAsString() {
		eUnset(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__TOTAL_THICKNESS_AS_STRING);
	}
	...
	public boolean isSetTotalThicknessAsString() {
		return eIsSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET__TOTAL_THICKNESS_AS_STRING);
	}
