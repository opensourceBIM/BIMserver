...
public class IfcStructuralActivityImpl extends IfcProductImpl implements IfcStructuralActivity {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY;
	}
	...
	public IfcStructuralLoad getAppliedLoad() {
		return (IfcStructuralLoad) eGet(LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY__APPLIED_LOAD, true);
	}
	...
	public void setAppliedLoad(IfcStructuralLoad newAppliedLoad) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY__APPLIED_LOAD, newAppliedLoad);
	}
	...
	public IfcGlobalOrLocalEnum getGlobalOrLocal() {
		return (IfcGlobalOrLocalEnum) eGet(LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY__GLOBAL_OR_LOCAL, true);
	}
	...
	public void setGlobalOrLocal(IfcGlobalOrLocalEnum newGlobalOrLocal) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY__GLOBAL_OR_LOCAL, newGlobalOrLocal);
	}
	...
	public IfcRelConnectsStructuralActivity getAssignedToStructuralItem() {
		return (IfcRelConnectsStructuralActivity) eGet(LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY__ASSIGNED_TO_STRUCTURAL_ITEM, true);
	}
	...
	public void setAssignedToStructuralItem(IfcRelConnectsStructuralActivity newAssignedToStructuralItem) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY__ASSIGNED_TO_STRUCTURAL_ITEM, newAssignedToStructuralItem);
	}
	...
	public void unsetAssignedToStructuralItem() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY__ASSIGNED_TO_STRUCTURAL_ITEM);
	}
	...
	public boolean isSetAssignedToStructuralItem() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_ACTIVITY__ASSIGNED_TO_STRUCTURAL_ITEM);
	}
