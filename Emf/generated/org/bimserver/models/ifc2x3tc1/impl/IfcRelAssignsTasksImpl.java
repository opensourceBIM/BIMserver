...
public class IfcRelAssignsTasksImpl extends IfcRelAssignsToControlImpl implements IfcRelAssignsTasks {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSIGNS_TASKS;
	}
	...
	public IfcScheduleTimeControl getTimeForTask() {
		return (IfcScheduleTimeControl) eGet(LogPackage.Literals.IFC_REL_ASSIGNS_TASKS__TIME_FOR_TASK, true);
	}
	...
	public void setTimeForTask(IfcScheduleTimeControl newTimeForTask) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS_TASKS__TIME_FOR_TASK, newTimeForTask);
	}
	...
	public void unsetTimeForTask() {
		eUnset(LogPackage.Literals.IFC_REL_ASSIGNS_TASKS__TIME_FOR_TASK);
	}
	...
	public boolean isSetTimeForTask() {
		return eIsSet(LogPackage.Literals.IFC_REL_ASSIGNS_TASKS__TIME_FOR_TASK);
	}
