...
public class IfcVertexPointImpl extends IfcVertexImpl implements IfcVertexPoint {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_VERTEX_POINT;
	}
	...
	public IfcPoint getVertexGeometry() {
		return (IfcPoint) eGet(LogPackage.Literals.IFC_VERTEX_POINT__VERTEX_GEOMETRY, true);
	}
	...
	public void setVertexGeometry(IfcPoint newVertexGeometry) {
		eSet(LogPackage.Literals.IFC_VERTEX_POINT__VERTEX_GEOMETRY, newVertexGeometry);
	}
