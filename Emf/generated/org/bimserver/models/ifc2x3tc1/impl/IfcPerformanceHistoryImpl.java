...
public class IfcPerformanceHistoryImpl extends IfcControlImpl implements IfcPerformanceHistory {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PERFORMANCE_HISTORY;
	}
	...
	public String getLifeCyclePhase() {
		return (String) eGet(LogPackage.Literals.IFC_PERFORMANCE_HISTORY__LIFE_CYCLE_PHASE, true);
	}
	...
	public void setLifeCyclePhase(String newLifeCyclePhase) {
		eSet(LogPackage.Literals.IFC_PERFORMANCE_HISTORY__LIFE_CYCLE_PHASE, newLifeCyclePhase);
	}
