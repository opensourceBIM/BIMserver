...
public class IfcRelAssociatesProfilePropertiesImpl extends IfcRelAssociatesImpl implements IfcRelAssociatesProfileProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES;
	}
	...
	public IfcProfileProperties getRelatingProfileProperties() {
		return (IfcProfileProperties) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__RELATING_PROFILE_PROPERTIES, true);
	}
	...
	public void setRelatingProfileProperties(IfcProfileProperties newRelatingProfileProperties) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__RELATING_PROFILE_PROPERTIES, newRelatingProfileProperties);
	}
	...
	public IfcShapeAspect getProfileSectionLocation() {
		return (IfcShapeAspect) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__PROFILE_SECTION_LOCATION, true);
	}
	...
	public void setProfileSectionLocation(IfcShapeAspect newProfileSectionLocation) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__PROFILE_SECTION_LOCATION, newProfileSectionLocation);
	}
	...
	public void unsetProfileSectionLocation() {
		eUnset(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__PROFILE_SECTION_LOCATION);
	}
	...
	public boolean isSetProfileSectionLocation() {
		return eIsSet(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__PROFILE_SECTION_LOCATION);
	}
	...
	public IfcOrientationSelect getProfileOrientation() {
		return (IfcOrientationSelect) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__PROFILE_ORIENTATION, true);
	}
	...
	public void setProfileOrientation(IfcOrientationSelect newProfileOrientation) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__PROFILE_ORIENTATION, newProfileOrientation);
	}
	...
	public void unsetProfileOrientation() {
		eUnset(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__PROFILE_ORIENTATION);
	}
	...
	public boolean isSetProfileOrientation() {
		return eIsSet(LogPackage.Literals.IFC_REL_ASSOCIATES_PROFILE_PROPERTIES__PROFILE_ORIENTATION);
	}
