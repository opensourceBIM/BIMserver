...
public class IfcCurveBoundedPlaneImpl extends IfcBoundedSurfaceImpl implements IfcCurveBoundedPlane {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE;
	}
	...
	public IfcPlane getBasisSurface() {
		return (IfcPlane) eGet(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__BASIS_SURFACE, true);
	}
	...
	public void setBasisSurface(IfcPlane newBasisSurface) {
		eSet(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__BASIS_SURFACE, newBasisSurface);
	}
	...
	public IfcCurve getOuterBoundary() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__OUTER_BOUNDARY, true);
	}
	...
	public void setOuterBoundary(IfcCurve newOuterBoundary) {
		eSet(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__OUTER_BOUNDARY, newOuterBoundary);
	}
	...
	public EList<IfcCurve> getInnerBoundaries() {
		return (EList<IfcCurve>) eGet(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__INNER_BOUNDARIES, true);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_CURVE_BOUNDED_PLANE__DIM);
	}
