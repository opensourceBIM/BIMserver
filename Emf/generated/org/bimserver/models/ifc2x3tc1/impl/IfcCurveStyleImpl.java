...
public class IfcCurveStyleImpl extends IfcPresentationStyleImpl implements IfcCurveStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CURVE_STYLE;
	}
	...
	public IfcCurveFontOrScaledCurveFontSelect getCurveFont() {
		return (IfcCurveFontOrScaledCurveFontSelect) eGet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_FONT, true);
	}
	...
	public void setCurveFont(IfcCurveFontOrScaledCurveFontSelect newCurveFont) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_FONT, newCurveFont);
	}
	...
	public void unsetCurveFont() {
		eUnset(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_FONT);
	}
	...
	public boolean isSetCurveFont() {
		return eIsSet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_FONT);
	}
	...
	public IfcSizeSelect getCurveWidth() {
		return (IfcSizeSelect) eGet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_WIDTH, true);
	}
	...
	public void setCurveWidth(IfcSizeSelect newCurveWidth) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_WIDTH, newCurveWidth);
	}
	...
	public void unsetCurveWidth() {
		eUnset(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_WIDTH);
	}
	...
	public boolean isSetCurveWidth() {
		return eIsSet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_WIDTH);
	}
	...
	public IfcColour getCurveColour() {
		return (IfcColour) eGet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_COLOUR, true);
	}
	...
	public void setCurveColour(IfcColour newCurveColour) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_COLOUR, newCurveColour);
	}
	...
	public void unsetCurveColour() {
		eUnset(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_COLOUR);
	}
	...
	public boolean isSetCurveColour() {
		return eIsSet(LogPackage.Literals.IFC_CURVE_STYLE__CURVE_COLOUR);
	}
