...
public class IfcAxis1PlacementImpl extends IfcPlacementImpl implements IfcAxis1Placement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_AXIS1_PLACEMENT;
	}
	...
	public IfcDirection getAxis() {
		return (IfcDirection) eGet(LogPackage.Literals.IFC_AXIS1_PLACEMENT__AXIS, true);
	}
	...
	public void setAxis(IfcDirection newAxis) {
		eSet(LogPackage.Literals.IFC_AXIS1_PLACEMENT__AXIS, newAxis);
	}
	...
	public void unsetAxis() {
		eUnset(LogPackage.Literals.IFC_AXIS1_PLACEMENT__AXIS);
	}
	...
	public boolean isSetAxis() {
		return eIsSet(LogPackage.Literals.IFC_AXIS1_PLACEMENT__AXIS);
	}
