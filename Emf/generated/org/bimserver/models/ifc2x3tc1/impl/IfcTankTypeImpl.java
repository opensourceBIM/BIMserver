...
public class IfcTankTypeImpl extends IfcFlowStorageDeviceTypeImpl implements IfcTankType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TANK_TYPE;
	}
	...
	public IfcTankTypeEnum getPredefinedType() {
		return (IfcTankTypeEnum) eGet(LogPackage.Literals.IFC_TANK_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTankTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_TANK_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
