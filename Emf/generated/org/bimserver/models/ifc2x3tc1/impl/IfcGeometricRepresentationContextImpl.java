...
public class IfcGeometricRepresentationContextImpl extends IfcRepresentationContextImpl implements IfcGeometricRepresentationContext {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT;
	}
	...
	public int getCoordinateSpaceDimension() {
		return (Integer) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__COORDINATE_SPACE_DIMENSION, true);
	}
	...
	public void setCoordinateSpaceDimension(int newCoordinateSpaceDimension) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__COORDINATE_SPACE_DIMENSION, newCoordinateSpaceDimension);
	}
	...
	public double getPrecision() {
		return (Double) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION, true);
	}
	...
	public void setPrecision(double newPrecision) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION, newPrecision);
	}
	...
	public void unsetPrecision() {
		eUnset(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION);
	}
	...
	public boolean isSetPrecision() {
		return eIsSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION);
	}
	...
	public String getPrecisionAsString() {
		return (String) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION_AS_STRING, true);
	}
	...
	public void setPrecisionAsString(String newPrecisionAsString) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION_AS_STRING, newPrecisionAsString);
	}
	...
	public void unsetPrecisionAsString() {
		eUnset(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION_AS_STRING);
	}
	...
	public boolean isSetPrecisionAsString() {
		return eIsSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__PRECISION_AS_STRING);
	}
	...
	public IfcAxis2Placement getWorldCoordinateSystem() {
		return (IfcAxis2Placement) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__WORLD_COORDINATE_SYSTEM, true);
	}
	...
	public void setWorldCoordinateSystem(IfcAxis2Placement newWorldCoordinateSystem) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__WORLD_COORDINATE_SYSTEM, newWorldCoordinateSystem);
	}
	...
	public IfcDirection getTrueNorth() {
		return (IfcDirection) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__TRUE_NORTH, true);
	}
	...
	public void setTrueNorth(IfcDirection newTrueNorth) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__TRUE_NORTH, newTrueNorth);
	}
	...
	public void unsetTrueNorth() {
		eUnset(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__TRUE_NORTH);
	}
	...
	public boolean isSetTrueNorth() {
		return eIsSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__TRUE_NORTH);
	}
	...
	public EList<IfcGeometricRepresentationSubContext> getHasSubContexts() {
		return (EList<IfcGeometricRepresentationSubContext>) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__HAS_SUB_CONTEXTS, true);
	}
	...
	public void unsetHasSubContexts() {
		eUnset(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__HAS_SUB_CONTEXTS);
	}
	...
	public boolean isSetHasSubContexts() {
		return eIsSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_CONTEXT__HAS_SUB_CONTEXTS);
	}
