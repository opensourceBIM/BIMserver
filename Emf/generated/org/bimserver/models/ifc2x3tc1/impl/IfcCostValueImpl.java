...
public class IfcCostValueImpl extends IfcAppliedValueImpl implements IfcCostValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_COST_VALUE;
	}
	...
	public String getCostType() {
		return (String) eGet(LogPackage.Literals.IFC_COST_VALUE__COST_TYPE, true);
	}
	...
	public void setCostType(String newCostType) {
		eSet(LogPackage.Literals.IFC_COST_VALUE__COST_TYPE, newCostType);
	}
	...
	public String getCondition() {
		return (String) eGet(LogPackage.Literals.IFC_COST_VALUE__CONDITION, true);
	}
	...
	public void setCondition(String newCondition) {
		eSet(LogPackage.Literals.IFC_COST_VALUE__CONDITION, newCondition);
	}
	...
	public void unsetCondition() {
		eUnset(LogPackage.Literals.IFC_COST_VALUE__CONDITION);
	}
	...
	public boolean isSetCondition() {
		return eIsSet(LogPackage.Literals.IFC_COST_VALUE__CONDITION);
	}
