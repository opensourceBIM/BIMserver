...
public class IfcEdgeImpl extends IfcTopologicalRepresentationItemImpl implements IfcEdge {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_EDGE;
	}
	...
	public IfcVertex getEdgeStart() {
		return (IfcVertex) eGet(LogPackage.Literals.IFC_EDGE__EDGE_START, true);
	}
	...
	public void setEdgeStart(IfcVertex newEdgeStart) {
		eSet(LogPackage.Literals.IFC_EDGE__EDGE_START, newEdgeStart);
	}
	...
	public IfcVertex getEdgeEnd() {
		return (IfcVertex) eGet(LogPackage.Literals.IFC_EDGE__EDGE_END, true);
	}
	...
	public void setEdgeEnd(IfcVertex newEdgeEnd) {
		eSet(LogPackage.Literals.IFC_EDGE__EDGE_END, newEdgeEnd);
	}
