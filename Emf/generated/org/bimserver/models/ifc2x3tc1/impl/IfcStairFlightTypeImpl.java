...
public class IfcStairFlightTypeImpl extends IfcBuildingElementTypeImpl implements IfcStairFlightType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STAIR_FLIGHT_TYPE;
	}
	...
	public IfcStairFlightTypeEnum getPredefinedType() {
		return (IfcStairFlightTypeEnum) eGet(LogPackage.Literals.IFC_STAIR_FLIGHT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcStairFlightTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_STAIR_FLIGHT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
