...
public class IfcTubeBundleTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcTubeBundleType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TUBE_BUNDLE_TYPE;
	}
	...
	public IfcTubeBundleTypeEnum getPredefinedType() {
		return (IfcTubeBundleTypeEnum) eGet(LogPackage.Literals.IFC_TUBE_BUNDLE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTubeBundleTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_TUBE_BUNDLE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
