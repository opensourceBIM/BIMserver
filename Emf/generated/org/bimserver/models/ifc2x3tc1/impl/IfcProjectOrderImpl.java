...
public class IfcProjectOrderImpl extends IfcControlImpl implements IfcProjectOrder {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROJECT_ORDER;
	}
	 ...
	 */
	public String getID() {
		return (String) eGet(LogPackage.Literals.IFC_PROJECT_ORDER__ID, true);
	}
	...
	public void setID(String newID) {
		eSet(LogPackage.Literals.IFC_PROJECT_ORDER__ID, newID);
	}
	...
	public IfcProjectOrderTypeEnum getPredefinedType() {
		return (IfcProjectOrderTypeEnum) eGet(LogPackage.Literals.IFC_PROJECT_ORDER__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcProjectOrderTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_PROJECT_ORDER__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public String getStatus() {
		return (String) eGet(LogPackage.Literals.IFC_PROJECT_ORDER__STATUS, true);
	}
	...
	public void setStatus(String newStatus) {
		eSet(LogPackage.Literals.IFC_PROJECT_ORDER__STATUS, newStatus);
	}
	...
	public void unsetStatus() {
		eUnset(LogPackage.Literals.IFC_PROJECT_ORDER__STATUS);
	}
	...
	public boolean isSetStatus() {
		return eIsSet(LogPackage.Literals.IFC_PROJECT_ORDER__STATUS);
	}
