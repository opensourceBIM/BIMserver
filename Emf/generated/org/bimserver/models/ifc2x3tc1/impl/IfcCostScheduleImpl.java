...
public class IfcCostScheduleImpl extends IfcControlImpl implements IfcCostSchedule {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_COST_SCHEDULE;
	}
	...
	public IfcActorSelect getSubmittedBy() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_COST_SCHEDULE__SUBMITTED_BY, true);
	}
	...
	public void setSubmittedBy(IfcActorSelect newSubmittedBy) {
		eSet(LogPackage.Literals.IFC_COST_SCHEDULE__SUBMITTED_BY, newSubmittedBy);
	}
	...
	public void unsetSubmittedBy() {
		eUnset(LogPackage.Literals.IFC_COST_SCHEDULE__SUBMITTED_BY);
	}
	...
	public boolean isSetSubmittedBy() {
		return eIsSet(LogPackage.Literals.IFC_COST_SCHEDULE__SUBMITTED_BY);
	}
	...
	public IfcActorSelect getPreparedBy() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_COST_SCHEDULE__PREPARED_BY, true);
	}
	...
	public void setPreparedBy(IfcActorSelect newPreparedBy) {
		eSet(LogPackage.Literals.IFC_COST_SCHEDULE__PREPARED_BY, newPreparedBy);
	}
	...
	public void unsetPreparedBy() {
		eUnset(LogPackage.Literals.IFC_COST_SCHEDULE__PREPARED_BY);
	}
	...
	public boolean isSetPreparedBy() {
		return eIsSet(LogPackage.Literals.IFC_COST_SCHEDULE__PREPARED_BY);
	}
	...
	public IfcDateTimeSelect getSubmittedOn() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_COST_SCHEDULE__SUBMITTED_ON, true);
	}
	...
	public void setSubmittedOn(IfcDateTimeSelect newSubmittedOn) {
		eSet(LogPackage.Literals.IFC_COST_SCHEDULE__SUBMITTED_ON, newSubmittedOn);
	}
	...
	public void unsetSubmittedOn() {
		eUnset(LogPackage.Literals.IFC_COST_SCHEDULE__SUBMITTED_ON);
	}
	...
	public boolean isSetSubmittedOn() {
		return eIsSet(LogPackage.Literals.IFC_COST_SCHEDULE__SUBMITTED_ON);
	}
	...
	public String getStatus() {
		return (String) eGet(LogPackage.Literals.IFC_COST_SCHEDULE__STATUS, true);
	}
	...
	public void setStatus(String newStatus) {
		eSet(LogPackage.Literals.IFC_COST_SCHEDULE__STATUS, newStatus);
	}
	...
	public void unsetStatus() {
		eUnset(LogPackage.Literals.IFC_COST_SCHEDULE__STATUS);
	}
	...
	public boolean isSetStatus() {
		return eIsSet(LogPackage.Literals.IFC_COST_SCHEDULE__STATUS);
	}
	...
	public EList<IfcActorSelect> getTargetUsers() {
		return (EList<IfcActorSelect>) eGet(LogPackage.Literals.IFC_COST_SCHEDULE__TARGET_USERS, true);
	}
	...
	public void unsetTargetUsers() {
		eUnset(LogPackage.Literals.IFC_COST_SCHEDULE__TARGET_USERS);
	}
	...
	public boolean isSetTargetUsers() {
		return eIsSet(LogPackage.Literals.IFC_COST_SCHEDULE__TARGET_USERS);
	}
	...
	public IfcDateTimeSelect getUpdateDate() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_COST_SCHEDULE__UPDATE_DATE, true);
	}
	...
	public void setUpdateDate(IfcDateTimeSelect newUpdateDate) {
		eSet(LogPackage.Literals.IFC_COST_SCHEDULE__UPDATE_DATE, newUpdateDate);
	}
	...
	public void unsetUpdateDate() {
		eUnset(LogPackage.Literals.IFC_COST_SCHEDULE__UPDATE_DATE);
	}
	...
	public boolean isSetUpdateDate() {
		return eIsSet(LogPackage.Literals.IFC_COST_SCHEDULE__UPDATE_DATE);
	}
	 ...
	 */
	public String getID() {
		return (String) eGet(LogPackage.Literals.IFC_COST_SCHEDULE__ID, true);
	}
	...
	public void setID(String newID) {
		eSet(LogPackage.Literals.IFC_COST_SCHEDULE__ID, newID);
	}
	...
	public IfcCostScheduleTypeEnum getPredefinedType() {
		return (IfcCostScheduleTypeEnum) eGet(LogPackage.Literals.IFC_COST_SCHEDULE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCostScheduleTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_COST_SCHEDULE__PREDEFINED_TYPE, newPredefinedType);
	}
