...
public class IfcPropertyImpl extends IdEObjectImpl implements IfcProperty {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROPERTY;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_PROPERTY__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_PROPERTY__NAME, newName);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_PROPERTY__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_PROPERTY__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_PROPERTY__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY__DESCRIPTION);
	}
	...
	public EList<IfcPropertyDependencyRelationship> getPropertyForDependance() {
		return (EList<IfcPropertyDependencyRelationship>) eGet(LogPackage.Literals.IFC_PROPERTY__PROPERTY_FOR_DEPENDANCE, true);
	}
	...
	public void unsetPropertyForDependance() {
		eUnset(LogPackage.Literals.IFC_PROPERTY__PROPERTY_FOR_DEPENDANCE);
	}
	...
	public boolean isSetPropertyForDependance() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY__PROPERTY_FOR_DEPENDANCE);
	}
	...
	public EList<IfcPropertyDependencyRelationship> getPropertyDependsOn() {
		return (EList<IfcPropertyDependencyRelationship>) eGet(LogPackage.Literals.IFC_PROPERTY__PROPERTY_DEPENDS_ON, true);
	}
	...
	public void unsetPropertyDependsOn() {
		eUnset(LogPackage.Literals.IFC_PROPERTY__PROPERTY_DEPENDS_ON);
	}
	...
	public boolean isSetPropertyDependsOn() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY__PROPERTY_DEPENDS_ON);
	}
	...
	public EList<IfcComplexProperty> getPartOfComplex() {
		return (EList<IfcComplexProperty>) eGet(LogPackage.Literals.IFC_PROPERTY__PART_OF_COMPLEX, true);
	}
	...
	public void unsetPartOfComplex() {
		eUnset(LogPackage.Literals.IFC_PROPERTY__PART_OF_COMPLEX);
	}
	...
	public boolean isSetPartOfComplex() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY__PART_OF_COMPLEX);
	}
