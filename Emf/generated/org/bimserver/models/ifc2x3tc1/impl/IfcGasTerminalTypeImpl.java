...
public class IfcGasTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcGasTerminalType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_GAS_TERMINAL_TYPE;
	}
	...
	public IfcGasTerminalTypeEnum getPredefinedType() {
		return (IfcGasTerminalTypeEnum) eGet(LogPackage.Literals.IFC_GAS_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcGasTerminalTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_GAS_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
