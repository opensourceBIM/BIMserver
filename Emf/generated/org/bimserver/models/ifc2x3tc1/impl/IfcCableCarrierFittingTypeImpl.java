...
public class IfcCableCarrierFittingTypeImpl extends IfcFlowFittingTypeImpl implements IfcCableCarrierFittingType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CABLE_CARRIER_FITTING_TYPE;
	}
	...
	public IfcCableCarrierFittingTypeEnum getPredefinedType() {
		return (IfcCableCarrierFittingTypeEnum) eGet(LogPackage.Literals.IFC_CABLE_CARRIER_FITTING_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCableCarrierFittingTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_CABLE_CARRIER_FITTING_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
