...
public class IfcRelAssociatesAppliedValueImpl extends IfcRelAssociatesImpl implements IfcRelAssociatesAppliedValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSOCIATES_APPLIED_VALUE;
	}
	...
	public IfcAppliedValue getRelatingAppliedValue() {
		return (IfcAppliedValue) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_APPLIED_VALUE__RELATING_APPLIED_VALUE, true);
	}
	...
	public void setRelatingAppliedValue(IfcAppliedValue newRelatingAppliedValue) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_APPLIED_VALUE__RELATING_APPLIED_VALUE, newRelatingAppliedValue);
	}
