...
public class IfcTextStyleImpl extends IfcPresentationStyleImpl implements IfcTextStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEXT_STYLE;
	}
	...
	public IfcCharacterStyleSelect getTextCharacterAppearance() {
		return (IfcCharacterStyleSelect) eGet(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_CHARACTER_APPEARANCE, true);
	}
	...
	public void setTextCharacterAppearance(IfcCharacterStyleSelect newTextCharacterAppearance) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_CHARACTER_APPEARANCE, newTextCharacterAppearance);
	}
	...
	public void unsetTextCharacterAppearance() {
		eUnset(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_CHARACTER_APPEARANCE);
	}
	...
	public boolean isSetTextCharacterAppearance() {
		return eIsSet(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_CHARACTER_APPEARANCE);
	}
	...
	public IfcTextStyleSelect getTextStyle() {
		return (IfcTextStyleSelect) eGet(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_STYLE, true);
	}
	...
	public void setTextStyle(IfcTextStyleSelect newTextStyle) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_STYLE, newTextStyle);
	}
	...
	public void unsetTextStyle() {
		eUnset(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_STYLE);
	}
	...
	public boolean isSetTextStyle() {
		return eIsSet(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_STYLE);
	}
	...
	public IfcTextFontSelect getTextFontStyle() {
		return (IfcTextFontSelect) eGet(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_FONT_STYLE, true);
	}
	...
	public void setTextFontStyle(IfcTextFontSelect newTextFontStyle) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE__TEXT_FONT_STYLE, newTextFontStyle);
	}
