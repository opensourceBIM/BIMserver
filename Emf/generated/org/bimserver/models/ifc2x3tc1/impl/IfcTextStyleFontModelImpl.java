...
public class IfcTextStyleFontModelImpl extends IfcPreDefinedTextFontImpl implements IfcTextStyleFontModel {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL;
	}
	...
	public EList<String> getFontFamily() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_FAMILY, true);
	}
	...
	public void unsetFontFamily() {
		eUnset(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_FAMILY);
	}
	...
	public boolean isSetFontFamily() {
		return eIsSet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_FAMILY);
	}
	...
	public String getFontStyle() {
		return (String) eGet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_STYLE, true);
	}
	...
	public void setFontStyle(String newFontStyle) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_STYLE, newFontStyle);
	}
	...
	public void unsetFontStyle() {
		eUnset(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_STYLE);
	}
	...
	public boolean isSetFontStyle() {
		return eIsSet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_STYLE);
	}
	...
	public String getFontVariant() {
		return (String) eGet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_VARIANT, true);
	}
	...
	public void setFontVariant(String newFontVariant) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_VARIANT, newFontVariant);
	}
	...
	public void unsetFontVariant() {
		eUnset(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_VARIANT);
	}
	...
	public boolean isSetFontVariant() {
		return eIsSet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_VARIANT);
	}
	...
	public String getFontWeight() {
		return (String) eGet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_WEIGHT, true);
	}
	...
	public void setFontWeight(String newFontWeight) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_WEIGHT, newFontWeight);
	}
	...
	public void unsetFontWeight() {
		eUnset(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_WEIGHT);
	}
	...
	public boolean isSetFontWeight() {
		return eIsSet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_WEIGHT);
	}
	...
	public IfcSizeSelect getFontSize() {
		return (IfcSizeSelect) eGet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_SIZE, true);
	}
	...
	public void setFontSize(IfcSizeSelect newFontSize) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE_FONT_MODEL__FONT_SIZE, newFontSize);
	}
