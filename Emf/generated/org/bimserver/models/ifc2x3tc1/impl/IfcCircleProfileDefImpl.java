...
public class IfcCircleProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcCircleProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CIRCLE_PROFILE_DEF;
	}
	...
	public double getRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_CIRCLE_PROFILE_DEF__RADIUS, true);
	}
	...
	public void setRadius(double newRadius) {
		eSet(LogPackage.Literals.IFC_CIRCLE_PROFILE_DEF__RADIUS, newRadius);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CIRCLE_PROFILE_DEF__RADIUS_AS_STRING, true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(LogPackage.Literals.IFC_CIRCLE_PROFILE_DEF__RADIUS_AS_STRING, newRadiusAsString);
	}
