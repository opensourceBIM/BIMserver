...
public class IfcPropertyDefinitionImpl extends IfcRootImpl implements IfcPropertyDefinition {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROPERTY_DEFINITION;
	}
	...
	public EList<IfcRelAssociates> getHasAssociations() {
		return (EList<IfcRelAssociates>) eGet(LogPackage.Literals.IFC_PROPERTY_DEFINITION__HAS_ASSOCIATIONS, true);
	}
	...
	public void unsetHasAssociations() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_DEFINITION__HAS_ASSOCIATIONS);
	}
	...
	public boolean isSetHasAssociations() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_DEFINITION__HAS_ASSOCIATIONS);
	}
