...
public class IfcPileImpl extends IfcBuildingElementImpl implements IfcPile {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PILE;
	}
	...
	public IfcPileTypeEnum getPredefinedType() {
		return (IfcPileTypeEnum) eGet(LogPackage.Literals.IFC_PILE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcPileTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_PILE__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public IfcPileConstructionEnum getConstructionType() {
		return (IfcPileConstructionEnum) eGet(LogPackage.Literals.IFC_PILE__CONSTRUCTION_TYPE, true);
	}
	...
	public void setConstructionType(IfcPileConstructionEnum newConstructionType) {
		eSet(LogPackage.Literals.IFC_PILE__CONSTRUCTION_TYPE, newConstructionType);
	}
	...
	public void unsetConstructionType() {
		eUnset(LogPackage.Literals.IFC_PILE__CONSTRUCTION_TYPE);
	}
	...
	public boolean isSetConstructionType() {
		return eIsSet(LogPackage.Literals.IFC_PILE__CONSTRUCTION_TYPE);
	}
