...
public class IfcObjectDefinitionImpl extends IfcRootImpl implements IfcObjectDefinition {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_OBJECT_DEFINITION;
	}
	...
	public EList<IfcRelAssigns> getHasAssignments() {
		return (EList<IfcRelAssigns>) eGet(LogPackage.Literals.IFC_OBJECT_DEFINITION__HAS_ASSIGNMENTS, true);
	}
	...
	public void unsetHasAssignments() {
		eUnset(LogPackage.Literals.IFC_OBJECT_DEFINITION__HAS_ASSIGNMENTS);
	}
	...
	public boolean isSetHasAssignments() {
		return eIsSet(LogPackage.Literals.IFC_OBJECT_DEFINITION__HAS_ASSIGNMENTS);
	}
	...
	public EList<IfcRelDecomposes> getIsDecomposedBy() {
		return (EList<IfcRelDecomposes>) eGet(LogPackage.Literals.IFC_OBJECT_DEFINITION__IS_DECOMPOSED_BY, true);
	}
	...
	public void unsetIsDecomposedBy() {
		eUnset(LogPackage.Literals.IFC_OBJECT_DEFINITION__IS_DECOMPOSED_BY);
	}
	...
	public boolean isSetIsDecomposedBy() {
		return eIsSet(LogPackage.Literals.IFC_OBJECT_DEFINITION__IS_DECOMPOSED_BY);
	}
	...
	public EList<IfcRelDecomposes> getDecomposes() {
		return (EList<IfcRelDecomposes>) eGet(LogPackage.Literals.IFC_OBJECT_DEFINITION__DECOMPOSES, true);
	}
	...
	public void unsetDecomposes() {
		eUnset(LogPackage.Literals.IFC_OBJECT_DEFINITION__DECOMPOSES);
	}
	...
	public boolean isSetDecomposes() {
		return eIsSet(LogPackage.Literals.IFC_OBJECT_DEFINITION__DECOMPOSES);
	}
	...
	public EList<IfcRelAssociates> getHasAssociations() {
		return (EList<IfcRelAssociates>) eGet(LogPackage.Literals.IFC_OBJECT_DEFINITION__HAS_ASSOCIATIONS, true);
	}
	...
	public void unsetHasAssociations() {
		eUnset(LogPackage.Literals.IFC_OBJECT_DEFINITION__HAS_ASSOCIATIONS);
	}
	...
	public boolean isSetHasAssociations() {
		return eIsSet(LogPackage.Literals.IFC_OBJECT_DEFINITION__HAS_ASSOCIATIONS);
	}
