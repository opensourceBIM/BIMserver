...
public class IfcQuantityLengthImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityLength {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_QUANTITY_LENGTH;
	}
	...
	public double getLengthValue() {
		return (Double) eGet(LogPackage.Literals.IFC_QUANTITY_LENGTH__LENGTH_VALUE, true);
	}
	...
	public void setLengthValue(double newLengthValue) {
		eSet(LogPackage.Literals.IFC_QUANTITY_LENGTH__LENGTH_VALUE, newLengthValue);
	}
	...
	public String getLengthValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_QUANTITY_LENGTH__LENGTH_VALUE_AS_STRING, true);
	}
	...
	public void setLengthValueAsString(String newLengthValueAsString) {
		eSet(LogPackage.Literals.IFC_QUANTITY_LENGTH__LENGTH_VALUE_AS_STRING, newLengthValueAsString);
	}
