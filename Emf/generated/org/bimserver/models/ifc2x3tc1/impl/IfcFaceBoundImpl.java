...
public class IfcFaceBoundImpl extends IfcTopologicalRepresentationItemImpl implements IfcFaceBound {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FACE_BOUND;
	}
	...
	public IfcLoop getBound() {
		return (IfcLoop) eGet(LogPackage.Literals.IFC_FACE_BOUND__BOUND, true);
	}
	...
	public void setBound(IfcLoop newBound) {
		eSet(LogPackage.Literals.IFC_FACE_BOUND__BOUND, newBound);
	}
	...
	public Tristate getOrientation() {
		return (Tristate) eGet(LogPackage.Literals.IFC_FACE_BOUND__ORIENTATION, true);
	}
	...
	public void setOrientation(Tristate newOrientation) {
		eSet(LogPackage.Literals.IFC_FACE_BOUND__ORIENTATION, newOrientation);
	}
