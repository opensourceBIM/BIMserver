...
public class IfcConstraintClassificationRelationshipImpl extends IdEObjectImpl implements IfcConstraintClassificationRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONSTRAINT_CLASSIFICATION_RELATIONSHIP;
	}
	...
	public IfcConstraint getClassifiedConstraint() {
		return (IfcConstraint) eGet(LogPackage.Literals.IFC_CONSTRAINT_CLASSIFICATION_RELATIONSHIP__CLASSIFIED_CONSTRAINT, true);
	}
	...
	public void setClassifiedConstraint(IfcConstraint newClassifiedConstraint) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT_CLASSIFICATION_RELATIONSHIP__CLASSIFIED_CONSTRAINT, newClassifiedConstraint);
	}
	...
	public EList<IfcClassificationNotationSelect> getRelatedClassifications() {
		return (EList<IfcClassificationNotationSelect>) eGet(LogPackage.Literals.IFC_CONSTRAINT_CLASSIFICATION_RELATIONSHIP__RELATED_CLASSIFICATIONS, true);
	}
