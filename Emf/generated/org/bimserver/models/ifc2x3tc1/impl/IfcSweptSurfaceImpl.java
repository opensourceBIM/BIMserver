...
public class IfcSweptSurfaceImpl extends IfcSurfaceImpl implements IfcSweptSurface {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SWEPT_SURFACE;
	}
	...
	public IfcProfileDef getSweptCurve() {
		return (IfcProfileDef) eGet(LogPackage.Literals.IFC_SWEPT_SURFACE__SWEPT_CURVE, true);
	}
	...
	public void setSweptCurve(IfcProfileDef newSweptCurve) {
		eSet(LogPackage.Literals.IFC_SWEPT_SURFACE__SWEPT_CURVE, newSweptCurve);
	}
	...
	public IfcAxis2Placement3D getPosition() {
		return (IfcAxis2Placement3D) eGet(LogPackage.Literals.IFC_SWEPT_SURFACE__POSITION, true);
	}
	...
	public void setPosition(IfcAxis2Placement3D newPosition) {
		eSet(LogPackage.Literals.IFC_SWEPT_SURFACE__POSITION, newPosition);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_SWEPT_SURFACE__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_SWEPT_SURFACE__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_SWEPT_SURFACE__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_SWEPT_SURFACE__DIM);
	}
