...
public class IfcCraneRailFShapeProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcCraneRailFShapeProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF;
	}
	...
	public double getOverallHeight() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__OVERALL_HEIGHT, true);
	}
	...
	public void setOverallHeight(double newOverallHeight) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__OVERALL_HEIGHT, newOverallHeight);
	}
	...
	public String getOverallHeightAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__OVERALL_HEIGHT_AS_STRING, true);
	}
	...
	public void setOverallHeightAsString(String newOverallHeightAsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__OVERALL_HEIGHT_AS_STRING, newOverallHeightAsString);
	}
	...
	public double getHeadWidth() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_WIDTH, true);
	}
	...
	public void setHeadWidth(double newHeadWidth) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_WIDTH, newHeadWidth);
	}
	...
	public String getHeadWidthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_WIDTH_AS_STRING, true);
	}
	...
	public void setHeadWidthAsString(String newHeadWidthAsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_WIDTH_AS_STRING, newHeadWidthAsString);
	}
	...
	public double getRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__RADIUS, true);
	}
	...
	public void setRadius(double newRadius) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__RADIUS, newRadius);
	}
	...
	public void unsetRadius() {
		eUnset(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__RADIUS);
	}
	...
	public boolean isSetRadius() {
		return eIsSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__RADIUS);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__RADIUS_AS_STRING, true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__RADIUS_AS_STRING, newRadiusAsString);
	}
	...
	public void unsetRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__RADIUS_AS_STRING);
	}
	...
	public boolean isSetRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__RADIUS_AS_STRING);
	}
	...
	public double getHeadDepth2() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_DEPTH2, true);
	}
	...
	public void setHeadDepth2(double newHeadDepth2) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_DEPTH2, newHeadDepth2);
	}
	...
	public String getHeadDepth2AsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_DEPTH2_AS_STRING, true);
	}
	...
	public void setHeadDepth2AsString(String newHeadDepth2AsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_DEPTH2_AS_STRING, newHeadDepth2AsString);
	}
	...
	public double getHeadDepth3() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_DEPTH3, true);
	}
	...
	public void setHeadDepth3(double newHeadDepth3) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_DEPTH3, newHeadDepth3);
	}
	...
	public String getHeadDepth3AsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_DEPTH3_AS_STRING, true);
	}
	...
	public void setHeadDepth3AsString(String newHeadDepth3AsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__HEAD_DEPTH3_AS_STRING, newHeadDepth3AsString);
	}
	...
	public double getWebThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__WEB_THICKNESS, true);
	}
	...
	public void setWebThickness(double newWebThickness) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__WEB_THICKNESS, newWebThickness);
	}
	...
	public String getWebThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, true);
	}
	...
	public void setWebThicknessAsString(String newWebThicknessAsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, newWebThicknessAsString);
	}
	...
	public double getBaseDepth1() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__BASE_DEPTH1, true);
	}
	...
	public void setBaseDepth1(double newBaseDepth1) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__BASE_DEPTH1, newBaseDepth1);
	}
	...
	public String getBaseDepth1AsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__BASE_DEPTH1_AS_STRING, true);
	}
	...
	public void setBaseDepth1AsString(String newBaseDepth1AsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__BASE_DEPTH1_AS_STRING, newBaseDepth1AsString);
	}
	...
	public double getBaseDepth2() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__BASE_DEPTH2, true);
	}
	...
	public void setBaseDepth2(double newBaseDepth2) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__BASE_DEPTH2, newBaseDepth2);
	}
	...
	public String getBaseDepth2AsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__BASE_DEPTH2_AS_STRING, true);
	}
	...
	public void setBaseDepth2AsString(String newBaseDepth2AsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__BASE_DEPTH2_AS_STRING, newBaseDepth2AsString);
	}
	...
	public double getCentreOfGravityInY() {
		return (Double) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_Y, true);
	}
	...
	public void setCentreOfGravityInY(double newCentreOfGravityInY) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_Y, newCentreOfGravityInY);
	}
	...
	public void unsetCentreOfGravityInY() {
		eUnset(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_Y);
	}
	...
	public boolean isSetCentreOfGravityInY() {
		return eIsSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_Y);
	}
	...
	public String getCentreOfGravityInYAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_YAS_STRING, true);
	}
	...
	public void setCentreOfGravityInYAsString(String newCentreOfGravityInYAsString) {
		eSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_YAS_STRING, newCentreOfGravityInYAsString);
	}
	...
	public void unsetCentreOfGravityInYAsString() {
		eUnset(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_YAS_STRING);
	}
	...
	public boolean isSetCentreOfGravityInYAsString() {
		return eIsSet(LogPackage.Literals.IFC_CRANE_RAIL_FSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_YAS_STRING);
	}
