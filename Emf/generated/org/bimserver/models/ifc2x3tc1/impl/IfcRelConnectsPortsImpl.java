...
public class IfcRelConnectsPortsImpl extends IfcRelConnectsImpl implements IfcRelConnectsPorts {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_CONNECTS_PORTS;
	}
	...
	public IfcPort getRelatingPort() {
		return (IfcPort) eGet(LogPackage.Literals.IFC_REL_CONNECTS_PORTS__RELATING_PORT, true);
	}
	...
	public void setRelatingPort(IfcPort newRelatingPort) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_PORTS__RELATING_PORT, newRelatingPort);
	}
	...
	public IfcPort getRelatedPort() {
		return (IfcPort) eGet(LogPackage.Literals.IFC_REL_CONNECTS_PORTS__RELATED_PORT, true);
	}
	...
	public void setRelatedPort(IfcPort newRelatedPort) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_PORTS__RELATED_PORT, newRelatedPort);
	}
	...
	public IfcElement getRealizingElement() {
		return (IfcElement) eGet(LogPackage.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT, true);
	}
	...
	public void setRealizingElement(IfcElement newRealizingElement) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT, newRealizingElement);
	}
	...
	public void unsetRealizingElement() {
		eUnset(LogPackage.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT);
	}
	...
	public boolean isSetRealizingElement() {
		return eIsSet(LogPackage.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT);
	}
