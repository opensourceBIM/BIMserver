...
public class IfcRightCircularConeImpl extends IfcCsgPrimitive3DImpl implements IfcRightCircularCone {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE;
	}
	...
	public double getHeight() {
		return (Double) eGet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE__HEIGHT, true);
	}
	...
	public void setHeight(double newHeight) {
		eSet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE__HEIGHT, newHeight);
	}
	...
	public String getHeightAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE__HEIGHT_AS_STRING, true);
	}
	...
	public void setHeightAsString(String newHeightAsString) {
		eSet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE__HEIGHT_AS_STRING, newHeightAsString);
	}
	...
	public double getBottomRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE__BOTTOM_RADIUS, true);
	}
	...
	public void setBottomRadius(double newBottomRadius) {
		eSet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE__BOTTOM_RADIUS, newBottomRadius);
	}
	...
	public String getBottomRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE__BOTTOM_RADIUS_AS_STRING, true);
	}
	...
	public void setBottomRadiusAsString(String newBottomRadiusAsString) {
		eSet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CONE__BOTTOM_RADIUS_AS_STRING, newBottomRadiusAsString);
	}
