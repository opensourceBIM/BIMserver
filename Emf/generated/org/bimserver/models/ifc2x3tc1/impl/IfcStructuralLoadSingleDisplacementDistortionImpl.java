...
public class IfcStructuralLoadSingleDisplacementDistortionImpl extends IfcStructuralLoadSingleDisplacementImpl implements IfcStructuralLoadSingleDisplacementDistortion {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION;
	}
	...
	public double getDistortion() {
		return (Double) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION__DISTORTION, true);
	}
	...
	public void setDistortion(double newDistortion) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION__DISTORTION, newDistortion);
	}
	...
	public void unsetDistortion() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION__DISTORTION);
	}
	...
	public boolean isSetDistortion() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION__DISTORTION);
	}
	...
	public String getDistortionAsString() {
		return (String) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION__DISTORTION_AS_STRING, true);
	}
	...
	public void setDistortionAsString(String newDistortionAsString) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION__DISTORTION_AS_STRING, newDistortionAsString);
	}
	...
	public void unsetDistortionAsString() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION__DISTORTION_AS_STRING);
	}
	...
	public boolean isSetDistortionAsString() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT_DISTORTION__DISTORTION_AS_STRING);
	}
