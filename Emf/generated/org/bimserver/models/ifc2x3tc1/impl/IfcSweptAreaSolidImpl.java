...
public class IfcSweptAreaSolidImpl extends IfcSolidModelImpl implements IfcSweptAreaSolid {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SWEPT_AREA_SOLID;
	}
	...
	public IfcProfileDef getSweptArea() {
		return (IfcProfileDef) eGet(LogPackage.Literals.IFC_SWEPT_AREA_SOLID__SWEPT_AREA, true);
	}
	...
	public void setSweptArea(IfcProfileDef newSweptArea) {
		eSet(LogPackage.Literals.IFC_SWEPT_AREA_SOLID__SWEPT_AREA, newSweptArea);
	}
	...
	public IfcAxis2Placement3D getPosition() {
		return (IfcAxis2Placement3D) eGet(LogPackage.Literals.IFC_SWEPT_AREA_SOLID__POSITION, true);
	}
	...
	public void setPosition(IfcAxis2Placement3D newPosition) {
		eSet(LogPackage.Literals.IFC_SWEPT_AREA_SOLID__POSITION, newPosition);
	}
