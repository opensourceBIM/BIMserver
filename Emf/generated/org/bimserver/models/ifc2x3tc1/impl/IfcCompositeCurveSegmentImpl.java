...
public class IfcCompositeCurveSegmentImpl extends IfcGeometricRepresentationItemImpl implements IfcCompositeCurveSegment {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT;
	}
	...
	public IfcTransitionCode getTransition() {
		return (IfcTransitionCode) eGet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__TRANSITION, true);
	}
	...
	public void setTransition(IfcTransitionCode newTransition) {
		eSet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__TRANSITION, newTransition);
	}
	...
	public Tristate getSameSense() {
		return (Tristate) eGet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__SAME_SENSE, true);
	}
	...
	public void setSameSense(Tristate newSameSense) {
		eSet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__SAME_SENSE, newSameSense);
	}
	...
	public IfcCurve getParentCurve() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__PARENT_CURVE, true);
	}
	...
	public void setParentCurve(IfcCurve newParentCurve) {
		eSet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__PARENT_CURVE, newParentCurve);
	}
	...
	public EList<IfcCompositeCurve> getUsingCurves() {
		return (EList<IfcCompositeCurve>) eGet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__USING_CURVES, true);
	}
	...
	public void unsetUsingCurves() {
		eUnset(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__USING_CURVES);
	}
	...
	public boolean isSetUsingCurves() {
		return eIsSet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__USING_CURVES);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_COMPOSITE_CURVE_SEGMENT__DIM);
	}
