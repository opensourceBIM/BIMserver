...
public class IfcClassificationImpl extends IdEObjectImpl implements IfcClassification {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CLASSIFICATION;
	}
	...
	public String getSource() {
		return (String) eGet(LogPackage.Literals.IFC_CLASSIFICATION__SOURCE, true);
	}
	...
	public void setSource(String newSource) {
		eSet(LogPackage.Literals.IFC_CLASSIFICATION__SOURCE, newSource);
	}
	...
	public String getEdition() {
		return (String) eGet(LogPackage.Literals.IFC_CLASSIFICATION__EDITION, true);
	}
	...
	public void setEdition(String newEdition) {
		eSet(LogPackage.Literals.IFC_CLASSIFICATION__EDITION, newEdition);
	}
	...
	public IfcCalendarDate getEditionDate() {
		return (IfcCalendarDate) eGet(LogPackage.Literals.IFC_CLASSIFICATION__EDITION_DATE, true);
	}
	...
	public void setEditionDate(IfcCalendarDate newEditionDate) {
		eSet(LogPackage.Literals.IFC_CLASSIFICATION__EDITION_DATE, newEditionDate);
	}
	...
	public void unsetEditionDate() {
		eUnset(LogPackage.Literals.IFC_CLASSIFICATION__EDITION_DATE);
	}
	...
	public boolean isSetEditionDate() {
		return eIsSet(LogPackage.Literals.IFC_CLASSIFICATION__EDITION_DATE);
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_CLASSIFICATION__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_CLASSIFICATION__NAME, newName);
	}
	...
	public EList<IfcClassificationItem> getContains() {
		return (EList<IfcClassificationItem>) eGet(LogPackage.Literals.IFC_CLASSIFICATION__CONTAINS, true);
	}
	...
	public void unsetContains() {
		eUnset(LogPackage.Literals.IFC_CLASSIFICATION__CONTAINS);
	}
	...
	public boolean isSetContains() {
		return eIsSet(LogPackage.Literals.IFC_CLASSIFICATION__CONTAINS);
	}
