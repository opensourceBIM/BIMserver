...
public class IfcTextLiteralWithExtentImpl extends IfcTextLiteralImpl implements IfcTextLiteralWithExtent {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEXT_LITERAL_WITH_EXTENT;
	}
	...
	public IfcPlanarExtent getExtent() {
		return (IfcPlanarExtent) eGet(LogPackage.Literals.IFC_TEXT_LITERAL_WITH_EXTENT__EXTENT, true);
	}
	...
	public void setExtent(IfcPlanarExtent newExtent) {
		eSet(LogPackage.Literals.IFC_TEXT_LITERAL_WITH_EXTENT__EXTENT, newExtent);
	}
	...
	public String getBoxAlignment() {
		return (String) eGet(LogPackage.Literals.IFC_TEXT_LITERAL_WITH_EXTENT__BOX_ALIGNMENT, true);
	}
	...
	public void setBoxAlignment(String newBoxAlignment) {
		eSet(LogPackage.Literals.IFC_TEXT_LITERAL_WITH_EXTENT__BOX_ALIGNMENT, newBoxAlignment);
	}
