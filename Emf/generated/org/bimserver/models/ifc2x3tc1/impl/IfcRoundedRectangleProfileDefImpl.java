...
public class IfcRoundedRectangleProfileDefImpl extends IfcRectangleProfileDefImpl implements IfcRoundedRectangleProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ROUNDED_RECTANGLE_PROFILE_DEF;
	}
	...
	public double getRoundingRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_ROUNDED_RECTANGLE_PROFILE_DEF__ROUNDING_RADIUS, true);
	}
	...
	public void setRoundingRadius(double newRoundingRadius) {
		eSet(LogPackage.Literals.IFC_ROUNDED_RECTANGLE_PROFILE_DEF__ROUNDING_RADIUS, newRoundingRadius);
	}
	...
	public String getRoundingRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ROUNDED_RECTANGLE_PROFILE_DEF__ROUNDING_RADIUS_AS_STRING, true);
	}
	...
	public void setRoundingRadiusAsString(String newRoundingRadiusAsString) {
		eSet(LogPackage.Literals.IFC_ROUNDED_RECTANGLE_PROFILE_DEF__ROUNDING_RADIUS_AS_STRING, newRoundingRadiusAsString);
	}
