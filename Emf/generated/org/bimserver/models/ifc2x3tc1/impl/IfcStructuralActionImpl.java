...
public class IfcStructuralActionImpl extends IfcStructuralActivityImpl implements IfcStructuralAction {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_ACTION;
	}
	...
	public Tristate getDestabilizingLoad() {
		return (Tristate) eGet(LogPackage.Literals.IFC_STRUCTURAL_ACTION__DESTABILIZING_LOAD, true);
	}
	...
	public void setDestabilizingLoad(Tristate newDestabilizingLoad) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_ACTION__DESTABILIZING_LOAD, newDestabilizingLoad);
	}
	...
	public IfcStructuralReaction getCausedBy() {
		return (IfcStructuralReaction) eGet(LogPackage.Literals.IFC_STRUCTURAL_ACTION__CAUSED_BY, true);
	}
	...
	public void setCausedBy(IfcStructuralReaction newCausedBy) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_ACTION__CAUSED_BY, newCausedBy);
	}
	...
	public void unsetCausedBy() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_ACTION__CAUSED_BY);
	}
	...
	public boolean isSetCausedBy() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_ACTION__CAUSED_BY);
	}
