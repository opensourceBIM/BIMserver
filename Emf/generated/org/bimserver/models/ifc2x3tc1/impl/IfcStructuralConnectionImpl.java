...
public class IfcStructuralConnectionImpl extends IfcStructuralItemImpl implements IfcStructuralConnection {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_CONNECTION;
	}
	...
	public IfcBoundaryCondition getAppliedCondition() {
		return (IfcBoundaryCondition) eGet(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION__APPLIED_CONDITION, true);
	}
	...
	public void setAppliedCondition(IfcBoundaryCondition newAppliedCondition) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION__APPLIED_CONDITION, newAppliedCondition);
	}
	...
	public void unsetAppliedCondition() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION__APPLIED_CONDITION);
	}
	...
	public boolean isSetAppliedCondition() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION__APPLIED_CONDITION);
	}
	...
	public EList<IfcRelConnectsStructuralMember> getConnectsStructuralMembers() {
		return (EList<IfcRelConnectsStructuralMember>) eGet(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION__CONNECTS_STRUCTURAL_MEMBERS, true);
	}
	...
	public void unsetConnectsStructuralMembers() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION__CONNECTS_STRUCTURAL_MEMBERS);
	}
	...
	public boolean isSetConnectsStructuralMembers() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION__CONNECTS_STRUCTURAL_MEMBERS);
	}
