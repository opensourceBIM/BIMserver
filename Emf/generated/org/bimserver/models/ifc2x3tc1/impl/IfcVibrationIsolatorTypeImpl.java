...
public class IfcVibrationIsolatorTypeImpl extends IfcDiscreteAccessoryTypeImpl implements IfcVibrationIsolatorType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_VIBRATION_ISOLATOR_TYPE;
	}
	...
	public IfcVibrationIsolatorTypeEnum getPredefinedType() {
		return (IfcVibrationIsolatorTypeEnum) eGet(LogPackage.Literals.IFC_VIBRATION_ISOLATOR_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcVibrationIsolatorTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_VIBRATION_ISOLATOR_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
