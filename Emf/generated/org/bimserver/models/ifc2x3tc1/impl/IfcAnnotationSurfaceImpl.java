...
public class IfcAnnotationSurfaceImpl extends IfcGeometricRepresentationItemImpl implements IfcAnnotationSurface {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ANNOTATION_SURFACE;
	}
	...
	public IfcGeometricRepresentationItem getItem() {
		return (IfcGeometricRepresentationItem) eGet(LogPackage.Literals.IFC_ANNOTATION_SURFACE__ITEM, true);
	}
	...
	public void setItem(IfcGeometricRepresentationItem newItem) {
		eSet(LogPackage.Literals.IFC_ANNOTATION_SURFACE__ITEM, newItem);
	}
	...
	public IfcTextureCoordinate getTextureCoordinates() {
		return (IfcTextureCoordinate) eGet(LogPackage.Literals.IFC_ANNOTATION_SURFACE__TEXTURE_COORDINATES, true);
	}
	...
	public void setTextureCoordinates(IfcTextureCoordinate newTextureCoordinates) {
		eSet(LogPackage.Literals.IFC_ANNOTATION_SURFACE__TEXTURE_COORDINATES, newTextureCoordinates);
	}
	...
	public void unsetTextureCoordinates() {
		eUnset(LogPackage.Literals.IFC_ANNOTATION_SURFACE__TEXTURE_COORDINATES);
	}
	...
	public boolean isSetTextureCoordinates() {
		return eIsSet(LogPackage.Literals.IFC_ANNOTATION_SURFACE__TEXTURE_COORDINATES);
	}
