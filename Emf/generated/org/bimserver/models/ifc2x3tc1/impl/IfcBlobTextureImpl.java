...
public class IfcBlobTextureImpl extends IfcSurfaceTextureImpl implements IfcBlobTexture {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_BLOB_TEXTURE;
	}
	...
	public String getRasterFormat() {
		return (String) eGet(LogPackage.Literals.IFC_BLOB_TEXTURE__RASTER_FORMAT, true);
	}
	...
	public void setRasterFormat(String newRasterFormat) {
		eSet(LogPackage.Literals.IFC_BLOB_TEXTURE__RASTER_FORMAT, newRasterFormat);
	}
	...
	public Tristate getRasterCode() {
		return (Tristate) eGet(LogPackage.Literals.IFC_BLOB_TEXTURE__RASTER_CODE, true);
	}
	...
	public void setRasterCode(Tristate newRasterCode) {
		eSet(LogPackage.Literals.IFC_BLOB_TEXTURE__RASTER_CODE, newRasterCode);
	}
