...
public class IfcMetricImpl extends IfcConstraintImpl implements IfcMetric {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_METRIC;
	}
	...
	public IfcBenchmarkEnum getBenchmark() {
		return (IfcBenchmarkEnum) eGet(LogPackage.Literals.IFC_METRIC__BENCHMARK, true);
	}
	...
	public void setBenchmark(IfcBenchmarkEnum newBenchmark) {
		eSet(LogPackage.Literals.IFC_METRIC__BENCHMARK, newBenchmark);
	}
	...
	public String getValueSource() {
		return (String) eGet(LogPackage.Literals.IFC_METRIC__VALUE_SOURCE, true);
	}
	...
	public void setValueSource(String newValueSource) {
		eSet(LogPackage.Literals.IFC_METRIC__VALUE_SOURCE, newValueSource);
	}
	...
	public void unsetValueSource() {
		eUnset(LogPackage.Literals.IFC_METRIC__VALUE_SOURCE);
	}
	...
	public boolean isSetValueSource() {
		return eIsSet(LogPackage.Literals.IFC_METRIC__VALUE_SOURCE);
	}
	...
	public IfcMetricValueSelect getDataValue() {
		return (IfcMetricValueSelect) eGet(LogPackage.Literals.IFC_METRIC__DATA_VALUE, true);
	}
	...
	public void setDataValue(IfcMetricValueSelect newDataValue) {
		eSet(LogPackage.Literals.IFC_METRIC__DATA_VALUE, newDataValue);
	}
