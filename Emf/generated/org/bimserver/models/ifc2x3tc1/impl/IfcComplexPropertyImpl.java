...
public class IfcComplexPropertyImpl extends IfcPropertyImpl implements IfcComplexProperty {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_COMPLEX_PROPERTY;
	}
	...
	public String getUsageName() {
		return (String) eGet(LogPackage.Literals.IFC_COMPLEX_PROPERTY__USAGE_NAME, true);
	}
	...
	public void setUsageName(String newUsageName) {
		eSet(LogPackage.Literals.IFC_COMPLEX_PROPERTY__USAGE_NAME, newUsageName);
	}
	...
	public EList<IfcProperty> getHasProperties() {
		return (EList<IfcProperty>) eGet(LogPackage.Literals.IFC_COMPLEX_PROPERTY__HAS_PROPERTIES, true);
	}
