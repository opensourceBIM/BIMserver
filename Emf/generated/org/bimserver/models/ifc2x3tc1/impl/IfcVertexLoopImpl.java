...
public class IfcVertexLoopImpl extends IfcLoopImpl implements IfcVertexLoop {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_VERTEX_LOOP;
	}
	...
	public IfcVertex getLoopVertex() {
		return (IfcVertex) eGet(LogPackage.Literals.IFC_VERTEX_LOOP__LOOP_VERTEX, true);
	}
	...
	public void setLoopVertex(IfcVertex newLoopVertex) {
		eSet(LogPackage.Literals.IFC_VERTEX_LOOP__LOOP_VERTEX, newLoopVertex);
	}
