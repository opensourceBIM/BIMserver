...
public class IfcMaterialLayerSetUsageImpl extends IdEObjectImpl implements IfcMaterialLayerSetUsage {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE;
	}
	...
	public IfcMaterialLayerSet getForLayerSet() {
		return (IfcMaterialLayerSet) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__FOR_LAYER_SET, true);
	}
	...
	public void setForLayerSet(IfcMaterialLayerSet newForLayerSet) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__FOR_LAYER_SET, newForLayerSet);
	}
	...
	public IfcLayerSetDirectionEnum getLayerSetDirection() {
		return (IfcLayerSetDirectionEnum) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__LAYER_SET_DIRECTION, true);
	}
	...
	public void setLayerSetDirection(IfcLayerSetDirectionEnum newLayerSetDirection) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__LAYER_SET_DIRECTION, newLayerSetDirection);
	}
	...
	public IfcDirectionSenseEnum getDirectionSense() {
		return (IfcDirectionSenseEnum) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__DIRECTION_SENSE, true);
	}
	...
	public void setDirectionSense(IfcDirectionSenseEnum newDirectionSense) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__DIRECTION_SENSE, newDirectionSense);
	}
	...
	public double getOffsetFromReferenceLine() {
		return (Double) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__OFFSET_FROM_REFERENCE_LINE, true);
	}
	...
	public void setOffsetFromReferenceLine(double newOffsetFromReferenceLine) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__OFFSET_FROM_REFERENCE_LINE, newOffsetFromReferenceLine);
	}
	...
	public String getOffsetFromReferenceLineAsString() {
		return (String) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__OFFSET_FROM_REFERENCE_LINE_AS_STRING, true);
	}
	...
	public void setOffsetFromReferenceLineAsString(String newOffsetFromReferenceLineAsString) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER_SET_USAGE__OFFSET_FROM_REFERENCE_LINE_AS_STRING, newOffsetFromReferenceLineAsString);
	}
