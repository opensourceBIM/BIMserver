...
public class IfcBoxedHalfSpaceImpl extends IfcHalfSpaceSolidImpl implements IfcBoxedHalfSpace {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_BOXED_HALF_SPACE;
	}
	...
	public IfcBoundingBox getEnclosure() {
		return (IfcBoundingBox) eGet(LogPackage.Literals.IFC_BOXED_HALF_SPACE__ENCLOSURE, true);
	}
	...
	public void setEnclosure(IfcBoundingBox newEnclosure) {
		eSet(LogPackage.Literals.IFC_BOXED_HALF_SPACE__ENCLOSURE, newEnclosure);
	}
