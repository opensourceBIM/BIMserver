...
public class IfcStructuralSurfaceMemberImpl extends IfcStructuralMemberImpl implements IfcStructuralSurfaceMember {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER;
	}
	...
	public IfcStructuralSurfaceTypeEnum getPredefinedType() {
		return (IfcStructuralSurfaceTypeEnum) eGet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcStructuralSurfaceTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public double getThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__THICKNESS, true);
	}
	...
	public void setThickness(double newThickness) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__THICKNESS, newThickness);
	}
	...
	public void unsetThickness() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__THICKNESS);
	}
	...
	public boolean isSetThickness() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__THICKNESS);
	}
	...
	public String getThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__THICKNESS_AS_STRING, true);
	}
	...
	public void setThicknessAsString(String newThicknessAsString) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__THICKNESS_AS_STRING, newThicknessAsString);
	}
	...
	public void unsetThicknessAsString() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__THICKNESS_AS_STRING);
	}
	...
	public boolean isSetThicknessAsString() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_SURFACE_MEMBER__THICKNESS_AS_STRING);
	}
