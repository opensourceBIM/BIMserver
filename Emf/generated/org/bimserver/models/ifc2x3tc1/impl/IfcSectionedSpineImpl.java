...
public class IfcSectionedSpineImpl extends IfcGeometricRepresentationItemImpl implements IfcSectionedSpine {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SECTIONED_SPINE;
	}
	...
	public IfcCompositeCurve getSpineCurve() {
		return (IfcCompositeCurve) eGet(LogPackage.Literals.IFC_SECTIONED_SPINE__SPINE_CURVE, true);
	}
	...
	public void setSpineCurve(IfcCompositeCurve newSpineCurve) {
		eSet(LogPackage.Literals.IFC_SECTIONED_SPINE__SPINE_CURVE, newSpineCurve);
	}
	...
	public EList<IfcProfileDef> getCrossSections() {
		return (EList<IfcProfileDef>) eGet(LogPackage.Literals.IFC_SECTIONED_SPINE__CROSS_SECTIONS, true);
	}
	...
	public EList<IfcAxis2Placement3D> getCrossSectionPositions() {
		return (EList<IfcAxis2Placement3D>) eGet(LogPackage.Literals.IFC_SECTIONED_SPINE__CROSS_SECTION_POSITIONS, true);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_SECTIONED_SPINE__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_SECTIONED_SPINE__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_SECTIONED_SPINE__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_SECTIONED_SPINE__DIM);
	}
