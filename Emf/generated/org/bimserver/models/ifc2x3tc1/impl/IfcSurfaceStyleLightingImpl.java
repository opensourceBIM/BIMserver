...
public class IfcSurfaceStyleLightingImpl extends IdEObjectImpl implements IfcSurfaceStyleLighting {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING;
	}
	...
	public IfcColourRgb getDiffuseTransmissionColour() {
		return (IfcColourRgb) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING__DIFFUSE_TRANSMISSION_COLOUR, true);
	}
	...
	public void setDiffuseTransmissionColour(IfcColourRgb newDiffuseTransmissionColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING__DIFFUSE_TRANSMISSION_COLOUR, newDiffuseTransmissionColour);
	}
	...
	public IfcColourRgb getDiffuseReflectionColour() {
		return (IfcColourRgb) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING__DIFFUSE_REFLECTION_COLOUR, true);
	}
	...
	public void setDiffuseReflectionColour(IfcColourRgb newDiffuseReflectionColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING__DIFFUSE_REFLECTION_COLOUR, newDiffuseReflectionColour);
	}
	...
	public IfcColourRgb getTransmissionColour() {
		return (IfcColourRgb) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING__TRANSMISSION_COLOUR, true);
	}
	...
	public void setTransmissionColour(IfcColourRgb newTransmissionColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING__TRANSMISSION_COLOUR, newTransmissionColour);
	}
	...
	public IfcColourRgb getReflectanceColour() {
		return (IfcColourRgb) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING__REFLECTANCE_COLOUR, true);
	}
	...
	public void setReflectanceColour(IfcColourRgb newReflectanceColour) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_LIGHTING__REFLECTANCE_COLOUR, newReflectanceColour);
	}
