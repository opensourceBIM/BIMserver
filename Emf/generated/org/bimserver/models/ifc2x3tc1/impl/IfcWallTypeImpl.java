...
public class IfcWallTypeImpl extends IfcBuildingElementTypeImpl implements IfcWallType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_WALL_TYPE;
	}
	...
	public IfcWallTypeEnum getPredefinedType() {
		return (IfcWallTypeEnum) eGet(LogPackage.Literals.IFC_WALL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcWallTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_WALL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
