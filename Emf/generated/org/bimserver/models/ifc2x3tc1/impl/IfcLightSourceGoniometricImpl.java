...
public class IfcLightSourceGoniometricImpl extends IfcLightSourceImpl implements IfcLightSourceGoniometric {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC;
	}
	...
	public IfcAxis2Placement3D getPosition() {
		return (IfcAxis2Placement3D) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__POSITION, true);
	}
	...
	public void setPosition(IfcAxis2Placement3D newPosition) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__POSITION, newPosition);
	}
	...
	public IfcColourRgb getColourAppearance() {
		return (IfcColourRgb) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE, true);
	}
	...
	public void setColourAppearance(IfcColourRgb newColourAppearance) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE, newColourAppearance);
	}
	...
	public void unsetColourAppearance() {
		eUnset(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE);
	}
	...
	public boolean isSetColourAppearance() {
		return eIsSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE);
	}
	...
	public double getColourTemperature() {
		return (Double) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE, true);
	}
	...
	public void setColourTemperature(double newColourTemperature) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE, newColourTemperature);
	}
	...
	public String getColourTemperatureAsString() {
		return (String) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE_AS_STRING, true);
	}
	...
	public void setColourTemperatureAsString(String newColourTemperatureAsString) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE_AS_STRING, newColourTemperatureAsString);
	}
	...
	public double getLuminousFlux() {
		return (Double) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX, true);
	}
	...
	public void setLuminousFlux(double newLuminousFlux) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX, newLuminousFlux);
	}
	...
	public String getLuminousFluxAsString() {
		return (String) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX_AS_STRING, true);
	}
	...
	public void setLuminousFluxAsString(String newLuminousFluxAsString) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX_AS_STRING, newLuminousFluxAsString);
	}
	...
	public IfcLightEmissionSourceEnum getLightEmissionSource() {
		return (IfcLightEmissionSourceEnum) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_EMISSION_SOURCE, true);
	}
	...
	public void setLightEmissionSource(IfcLightEmissionSourceEnum newLightEmissionSource) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_EMISSION_SOURCE, newLightEmissionSource);
	}
	...
	public IfcLightDistributionDataSourceSelect getLightDistributionDataSource() {
		return (IfcLightDistributionDataSourceSelect) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_DISTRIBUTION_DATA_SOURCE, true);
	}
	...
	public void setLightDistributionDataSource(IfcLightDistributionDataSourceSelect newLightDistributionDataSource) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_DISTRIBUTION_DATA_SOURCE, newLightDistributionDataSource);
	}
