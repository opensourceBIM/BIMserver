...
public class IfcTimeSeriesImpl extends IdEObjectImpl implements IfcTimeSeries {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TIME_SERIES;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_TIME_SERIES__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES__NAME, newName);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_TIME_SERIES__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_TIME_SERIES__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_TIME_SERIES__DESCRIPTION);
	}
	...
	public IfcDateTimeSelect getStartTime() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_TIME_SERIES__START_TIME, true);
	}
	...
	public void setStartTime(IfcDateTimeSelect newStartTime) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES__START_TIME, newStartTime);
	}
	...
	public IfcDateTimeSelect getEndTime() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_TIME_SERIES__END_TIME, true);
	}
	...
	public void setEndTime(IfcDateTimeSelect newEndTime) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES__END_TIME, newEndTime);
	}
	...
	public IfcTimeSeriesDataTypeEnum getTimeSeriesDataType() {
		return (IfcTimeSeriesDataTypeEnum) eGet(LogPackage.Literals.IFC_TIME_SERIES__TIME_SERIES_DATA_TYPE, true);
	}
	...
	public void setTimeSeriesDataType(IfcTimeSeriesDataTypeEnum newTimeSeriesDataType) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES__TIME_SERIES_DATA_TYPE, newTimeSeriesDataType);
	}
	...
	public IfcDataOriginEnum getDataOrigin() {
		return (IfcDataOriginEnum) eGet(LogPackage.Literals.IFC_TIME_SERIES__DATA_ORIGIN, true);
	}
	...
	public void setDataOrigin(IfcDataOriginEnum newDataOrigin) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES__DATA_ORIGIN, newDataOrigin);
	}
	...
	public String getUserDefinedDataOrigin() {
		return (String) eGet(LogPackage.Literals.IFC_TIME_SERIES__USER_DEFINED_DATA_ORIGIN, true);
	}
	...
	public void setUserDefinedDataOrigin(String newUserDefinedDataOrigin) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES__USER_DEFINED_DATA_ORIGIN, newUserDefinedDataOrigin);
	}
	...
	public void unsetUserDefinedDataOrigin() {
		eUnset(LogPackage.Literals.IFC_TIME_SERIES__USER_DEFINED_DATA_ORIGIN);
	}
	...
	public boolean isSetUserDefinedDataOrigin() {
		return eIsSet(LogPackage.Literals.IFC_TIME_SERIES__USER_DEFINED_DATA_ORIGIN);
	}
	...
	public IfcUnit getUnit() {
		return (IfcUnit) eGet(LogPackage.Literals.IFC_TIME_SERIES__UNIT, true);
	}
	...
	public void setUnit(IfcUnit newUnit) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES__UNIT, newUnit);
	}
	...
	public void unsetUnit() {
		eUnset(LogPackage.Literals.IFC_TIME_SERIES__UNIT);
	}
	...
	public boolean isSetUnit() {
		return eIsSet(LogPackage.Literals.IFC_TIME_SERIES__UNIT);
	}
	...
	public EList<IfcTimeSeriesReferenceRelationship> getDocumentedBy() {
		return (EList<IfcTimeSeriesReferenceRelationship>) eGet(LogPackage.Literals.IFC_TIME_SERIES__DOCUMENTED_BY, true);
	}
	...
	public void unsetDocumentedBy() {
		eUnset(LogPackage.Literals.IFC_TIME_SERIES__DOCUMENTED_BY);
	}
	...
	public boolean isSetDocumentedBy() {
		return eIsSet(LogPackage.Literals.IFC_TIME_SERIES__DOCUMENTED_BY);
	}
