...
public class IfcSpaceProgramImpl extends IfcControlImpl implements IfcSpaceProgram {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SPACE_PROGRAM;
	}
	...
	public String getSpaceProgramIdentifier() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__SPACE_PROGRAM_IDENTIFIER, true);
	}
	...
	public void setSpaceProgramIdentifier(String newSpaceProgramIdentifier) {
		eSet(LogPackage.Literals.IFC_SPACE_PROGRAM__SPACE_PROGRAM_IDENTIFIER, newSpaceProgramIdentifier);
	}
	...
	public double getMaxRequiredArea() {
		return (Double) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__MAX_REQUIRED_AREA, true);
	}
	...
	public void setMaxRequiredArea(double newMaxRequiredArea) {
		eSet(LogPackage.Literals.IFC_SPACE_PROGRAM__MAX_REQUIRED_AREA, newMaxRequiredArea);
	}
	...
	public void unsetMaxRequiredArea() {
		eUnset(LogPackage.Literals.IFC_SPACE_PROGRAM__MAX_REQUIRED_AREA);
	}
	...
	public boolean isSetMaxRequiredArea() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_PROGRAM__MAX_REQUIRED_AREA);
	}
	...
	public String getMaxRequiredAreaAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__MAX_REQUIRED_AREA_AS_STRING, true);
	}
	...
	public void setMaxRequiredAreaAsString(String newMaxRequiredAreaAsString) {
		eSet(LogPackage.Literals.IFC_SPACE_PROGRAM__MAX_REQUIRED_AREA_AS_STRING, newMaxRequiredAreaAsString);
	}
	...
	public void unsetMaxRequiredAreaAsString() {
		eUnset(LogPackage.Literals.IFC_SPACE_PROGRAM__MAX_REQUIRED_AREA_AS_STRING);
	}
	...
	public boolean isSetMaxRequiredAreaAsString() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_PROGRAM__MAX_REQUIRED_AREA_AS_STRING);
	}
	...
	public double getMinRequiredArea() {
		return (Double) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__MIN_REQUIRED_AREA, true);
	}
	...
	public void setMinRequiredArea(double newMinRequiredArea) {
		eSet(LogPackage.Literals.IFC_SPACE_PROGRAM__MIN_REQUIRED_AREA, newMinRequiredArea);
	}
	...
	public void unsetMinRequiredArea() {
		eUnset(LogPackage.Literals.IFC_SPACE_PROGRAM__MIN_REQUIRED_AREA);
	}
	...
	public boolean isSetMinRequiredArea() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_PROGRAM__MIN_REQUIRED_AREA);
	}
	...
	public String getMinRequiredAreaAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__MIN_REQUIRED_AREA_AS_STRING, true);
	}
	...
	public void setMinRequiredAreaAsString(String newMinRequiredAreaAsString) {
		eSet(LogPackage.Literals.IFC_SPACE_PROGRAM__MIN_REQUIRED_AREA_AS_STRING, newMinRequiredAreaAsString);
	}
	...
	public void unsetMinRequiredAreaAsString() {
		eUnset(LogPackage.Literals.IFC_SPACE_PROGRAM__MIN_REQUIRED_AREA_AS_STRING);
	}
	...
	public boolean isSetMinRequiredAreaAsString() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_PROGRAM__MIN_REQUIRED_AREA_AS_STRING);
	}
	...
	public IfcSpatialStructureElement getRequestedLocation() {
		return (IfcSpatialStructureElement) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__REQUESTED_LOCATION, true);
	}
	...
	public void setRequestedLocation(IfcSpatialStructureElement newRequestedLocation) {
		eSet(LogPackage.Literals.IFC_SPACE_PROGRAM__REQUESTED_LOCATION, newRequestedLocation);
	}
	...
	public void unsetRequestedLocation() {
		eUnset(LogPackage.Literals.IFC_SPACE_PROGRAM__REQUESTED_LOCATION);
	}
	...
	public boolean isSetRequestedLocation() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_PROGRAM__REQUESTED_LOCATION);
	}
	...
	public double getStandardRequiredArea() {
		return (Double) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__STANDARD_REQUIRED_AREA, true);
	}
	...
	public void setStandardRequiredArea(double newStandardRequiredArea) {
		eSet(LogPackage.Literals.IFC_SPACE_PROGRAM__STANDARD_REQUIRED_AREA, newStandardRequiredArea);
	}
	...
	public String getStandardRequiredAreaAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__STANDARD_REQUIRED_AREA_AS_STRING, true);
	}
	...
	public void setStandardRequiredAreaAsString(String newStandardRequiredAreaAsString) {
		eSet(LogPackage.Literals.IFC_SPACE_PROGRAM__STANDARD_REQUIRED_AREA_AS_STRING, newStandardRequiredAreaAsString);
	}
	...
	public EList<IfcRelInteractionRequirements> getHasInteractionReqsFrom() {
		return (EList<IfcRelInteractionRequirements>) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__HAS_INTERACTION_REQS_FROM, true);
	}
	...
	public void unsetHasInteractionReqsFrom() {
		eUnset(LogPackage.Literals.IFC_SPACE_PROGRAM__HAS_INTERACTION_REQS_FROM);
	}
	...
	public boolean isSetHasInteractionReqsFrom() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_PROGRAM__HAS_INTERACTION_REQS_FROM);
	}
	...
	public EList<IfcRelInteractionRequirements> getHasInteractionReqsTo() {
		return (EList<IfcRelInteractionRequirements>) eGet(LogPackage.Literals.IFC_SPACE_PROGRAM__HAS_INTERACTION_REQS_TO, true);
	}
	...
	public void unsetHasInteractionReqsTo() {
		eUnset(LogPackage.Literals.IFC_SPACE_PROGRAM__HAS_INTERACTION_REQS_TO);
	}
	...
	public boolean isSetHasInteractionReqsTo() {
		return eIsSet(LogPackage.Literals.IFC_SPACE_PROGRAM__HAS_INTERACTION_REQS_TO);
	}
