...
public class IfcTextureCoordinateGeneratorImpl extends IfcTextureCoordinateImpl implements IfcTextureCoordinateGenerator {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEXTURE_COORDINATE_GENERATOR;
	}
	...
	public String getMode() {
		return (String) eGet(LogPackage.Literals.IFC_TEXTURE_COORDINATE_GENERATOR__MODE, true);
	}
	...
	public void setMode(String newMode) {
		eSet(LogPackage.Literals.IFC_TEXTURE_COORDINATE_GENERATOR__MODE, newMode);
	}
	...
	public EList<IfcSimpleValue> getParameter() {
		return (EList<IfcSimpleValue>) eGet(LogPackage.Literals.IFC_TEXTURE_COORDINATE_GENERATOR__PARAMETER, true);
	}
