...
public class IfcDistributionControlElementImpl extends IfcDistributionElementImpl implements IfcDistributionControlElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DISTRIBUTION_CONTROL_ELEMENT;
	}
	...
	public String getControlElementId() {
		return (String) eGet(LogPackage.Literals.IFC_DISTRIBUTION_CONTROL_ELEMENT__CONTROL_ELEMENT_ID, true);
	}
	...
	public void setControlElementId(String newControlElementId) {
		eSet(LogPackage.Literals.IFC_DISTRIBUTION_CONTROL_ELEMENT__CONTROL_ELEMENT_ID, newControlElementId);
	}
	...
	public void unsetControlElementId() {
		eUnset(LogPackage.Literals.IFC_DISTRIBUTION_CONTROL_ELEMENT__CONTROL_ELEMENT_ID);
	}
	...
	public boolean isSetControlElementId() {
		return eIsSet(LogPackage.Literals.IFC_DISTRIBUTION_CONTROL_ELEMENT__CONTROL_ELEMENT_ID);
	}
	...
	public EList<IfcRelFlowControlElements> getAssignedToFlowElement() {
		return (EList<IfcRelFlowControlElements>) eGet(LogPackage.Literals.IFC_DISTRIBUTION_CONTROL_ELEMENT__ASSIGNED_TO_FLOW_ELEMENT, true);
	}
	...
	public void unsetAssignedToFlowElement() {
		eUnset(LogPackage.Literals.IFC_DISTRIBUTION_CONTROL_ELEMENT__ASSIGNED_TO_FLOW_ELEMENT);
	}
	...
	public boolean isSetAssignedToFlowElement() {
		return eIsSet(LogPackage.Literals.IFC_DISTRIBUTION_CONTROL_ELEMENT__ASSIGNED_TO_FLOW_ELEMENT);
	}
