...
public class IfcSystemImpl extends IfcGroupImpl implements IfcSystem {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SYSTEM;
	}
	...
	public EList<IfcRelServicesBuildings> getServicesBuildings() {
		return (EList<IfcRelServicesBuildings>) eGet(LogPackage.Literals.IFC_SYSTEM__SERVICES_BUILDINGS, true);
	}
	...
	public void unsetServicesBuildings() {
		eUnset(LogPackage.Literals.IFC_SYSTEM__SERVICES_BUILDINGS);
	}
	...
	public boolean isSetServicesBuildings() {
		return eIsSet(LogPackage.Literals.IFC_SYSTEM__SERVICES_BUILDINGS);
	}
