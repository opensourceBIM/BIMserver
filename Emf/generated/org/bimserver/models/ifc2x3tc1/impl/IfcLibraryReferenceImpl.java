...
public class IfcLibraryReferenceImpl extends IfcExternalReferenceImpl implements IfcLibraryReference {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LIBRARY_REFERENCE;
	}
	...
	public EList<IfcLibraryInformation> getReferenceIntoLibrary() {
		return (EList<IfcLibraryInformation>) eGet(LogPackage.Literals.IFC_LIBRARY_REFERENCE__REFERENCE_INTO_LIBRARY, true);
	}
	...
	public void unsetReferenceIntoLibrary() {
		eUnset(LogPackage.Literals.IFC_LIBRARY_REFERENCE__REFERENCE_INTO_LIBRARY);
	}
	...
	public boolean isSetReferenceIntoLibrary() {
		return eIsSet(LogPackage.Literals.IFC_LIBRARY_REFERENCE__REFERENCE_INTO_LIBRARY);
	}
