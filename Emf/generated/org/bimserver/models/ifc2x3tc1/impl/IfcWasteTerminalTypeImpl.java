...
public class IfcWasteTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcWasteTerminalType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_WASTE_TERMINAL_TYPE;
	}
	...
	public IfcWasteTerminalTypeEnum getPredefinedType() {
		return (IfcWasteTerminalTypeEnum) eGet(LogPackage.Literals.IFC_WASTE_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcWasteTerminalTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_WASTE_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
