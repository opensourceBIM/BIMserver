...
public class IfcVertexBasedTextureMapImpl extends IdEObjectImpl implements IfcVertexBasedTextureMap {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_VERTEX_BASED_TEXTURE_MAP;
	}
	...
	public EList<IfcTextureVertex> getTextureVertices() {
		return (EList<IfcTextureVertex>) eGet(LogPackage.Literals.IFC_VERTEX_BASED_TEXTURE_MAP__TEXTURE_VERTICES, true);
	}
	...
	public EList<IfcCartesianPoint> getTexturePoints() {
		return (EList<IfcCartesianPoint>) eGet(LogPackage.Literals.IFC_VERTEX_BASED_TEXTURE_MAP__TEXTURE_POINTS, true);
	}
