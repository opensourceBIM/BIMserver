...
public class IfcDerivedUnitImpl extends IdEObjectImpl implements IfcDerivedUnit {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DERIVED_UNIT;
	}
	...
	public EList<IfcDerivedUnitElement> getElements() {
		return (EList<IfcDerivedUnitElement>) eGet(LogPackage.Literals.IFC_DERIVED_UNIT__ELEMENTS, true);
	}
	...
	public IfcDerivedUnitEnum getUnitType() {
		return (IfcDerivedUnitEnum) eGet(LogPackage.Literals.IFC_DERIVED_UNIT__UNIT_TYPE, true);
	}
	...
	public void setUnitType(IfcDerivedUnitEnum newUnitType) {
		eSet(LogPackage.Literals.IFC_DERIVED_UNIT__UNIT_TYPE, newUnitType);
	}
	...
	public String getUserDefinedType() {
		return (String) eGet(LogPackage.Literals.IFC_DERIVED_UNIT__USER_DEFINED_TYPE, true);
	}
	...
	public void setUserDefinedType(String newUserDefinedType) {
		eSet(LogPackage.Literals.IFC_DERIVED_UNIT__USER_DEFINED_TYPE, newUserDefinedType);
	}
	...
	public void unsetUserDefinedType() {
		eUnset(LogPackage.Literals.IFC_DERIVED_UNIT__USER_DEFINED_TYPE);
	}
	...
	public boolean isSetUserDefinedType() {
		return eIsSet(LogPackage.Literals.IFC_DERIVED_UNIT__USER_DEFINED_TYPE);
	}
