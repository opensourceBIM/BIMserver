...
public class IfcRelAssociatesLibraryImpl extends IfcRelAssociatesImpl implements IfcRelAssociatesLibrary {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSOCIATES_LIBRARY;
	}
	...
	public IfcLibrarySelect getRelatingLibrary() {
		return (IfcLibrarySelect) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_LIBRARY__RELATING_LIBRARY, true);
	}
	...
	public void setRelatingLibrary(IfcLibrarySelect newRelatingLibrary) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_LIBRARY__RELATING_LIBRARY, newRelatingLibrary);
	}
