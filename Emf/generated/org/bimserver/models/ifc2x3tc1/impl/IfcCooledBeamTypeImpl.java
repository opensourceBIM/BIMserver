...
public class IfcCooledBeamTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcCooledBeamType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_COOLED_BEAM_TYPE;
	}
	...
	public IfcCooledBeamTypeEnum getPredefinedType() {
		return (IfcCooledBeamTypeEnum) eGet(LogPackage.Literals.IFC_COOLED_BEAM_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcCooledBeamTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_COOLED_BEAM_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
