...
public class IfcElementQuantityImpl extends IfcPropertySetDefinitionImpl implements IfcElementQuantity {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ELEMENT_QUANTITY;
	}
	...
	public String getMethodOfMeasurement() {
		return (String) eGet(LogPackage.Literals.IFC_ELEMENT_QUANTITY__METHOD_OF_MEASUREMENT, true);
	}
	...
	public void setMethodOfMeasurement(String newMethodOfMeasurement) {
		eSet(LogPackage.Literals.IFC_ELEMENT_QUANTITY__METHOD_OF_MEASUREMENT, newMethodOfMeasurement);
	}
	...
	public void unsetMethodOfMeasurement() {
		eUnset(LogPackage.Literals.IFC_ELEMENT_QUANTITY__METHOD_OF_MEASUREMENT);
	}
	...
	public boolean isSetMethodOfMeasurement() {
		return eIsSet(LogPackage.Literals.IFC_ELEMENT_QUANTITY__METHOD_OF_MEASUREMENT);
	}
	...
	public EList<IfcPhysicalQuantity> getQuantities() {
		return (EList<IfcPhysicalQuantity>) eGet(LogPackage.Literals.IFC_ELEMENT_QUANTITY__QUANTITIES, true);
	}
