...
public class IfcAddressImpl extends IdEObjectImpl implements IfcAddress {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ADDRESS;
	}
	...
	public IfcAddressTypeEnum getPurpose() {
		return (IfcAddressTypeEnum) eGet(LogPackage.Literals.IFC_ADDRESS__PURPOSE, true);
	}
	...
	public void setPurpose(IfcAddressTypeEnum newPurpose) {
		eSet(LogPackage.Literals.IFC_ADDRESS__PURPOSE, newPurpose);
	}
	...
	public void unsetPurpose() {
		eUnset(LogPackage.Literals.IFC_ADDRESS__PURPOSE);
	}
	...
	public boolean isSetPurpose() {
		return eIsSet(LogPackage.Literals.IFC_ADDRESS__PURPOSE);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_ADDRESS__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_ADDRESS__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_ADDRESS__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_ADDRESS__DESCRIPTION);
	}
	...
	public String getUserDefinedPurpose() {
		return (String) eGet(LogPackage.Literals.IFC_ADDRESS__USER_DEFINED_PURPOSE, true);
	}
	...
	public void setUserDefinedPurpose(String newUserDefinedPurpose) {
		eSet(LogPackage.Literals.IFC_ADDRESS__USER_DEFINED_PURPOSE, newUserDefinedPurpose);
	}
	...
	public void unsetUserDefinedPurpose() {
		eUnset(LogPackage.Literals.IFC_ADDRESS__USER_DEFINED_PURPOSE);
	}
	...
	public boolean isSetUserDefinedPurpose() {
		return eIsSet(LogPackage.Literals.IFC_ADDRESS__USER_DEFINED_PURPOSE);
	}
	...
	public EList<IfcPerson> getOfPerson() {
		return (EList<IfcPerson>) eGet(LogPackage.Literals.IFC_ADDRESS__OF_PERSON, true);
	}
	...
	public void unsetOfPerson() {
		eUnset(LogPackage.Literals.IFC_ADDRESS__OF_PERSON);
	}
	...
	public boolean isSetOfPerson() {
		return eIsSet(LogPackage.Literals.IFC_ADDRESS__OF_PERSON);
	}
	...
	public EList<IfcOrganization> getOfOrganization() {
		return (EList<IfcOrganization>) eGet(LogPackage.Literals.IFC_ADDRESS__OF_ORGANIZATION, true);
	}
	...
	public void unsetOfOrganization() {
		eUnset(LogPackage.Literals.IFC_ADDRESS__OF_ORGANIZATION);
	}
	...
	public boolean isSetOfOrganization() {
		return eIsSet(LogPackage.Literals.IFC_ADDRESS__OF_ORGANIZATION);
	}
