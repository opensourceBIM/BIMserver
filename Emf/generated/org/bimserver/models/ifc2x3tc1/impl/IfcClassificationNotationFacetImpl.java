...
public class IfcClassificationNotationFacetImpl extends IdEObjectImpl implements IfcClassificationNotationFacet {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CLASSIFICATION_NOTATION_FACET;
	}
	...
	public String getNotationValue() {
		return (String) eGet(LogPackage.Literals.IFC_CLASSIFICATION_NOTATION_FACET__NOTATION_VALUE, true);
	}
	...
	public void setNotationValue(String newNotationValue) {
		eSet(LogPackage.Literals.IFC_CLASSIFICATION_NOTATION_FACET__NOTATION_VALUE, newNotationValue);
	}
