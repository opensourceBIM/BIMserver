...
public class IfcFillAreaStyleTileSymbolWithStyleImpl extends IfcGeometricRepresentationItemImpl implements IfcFillAreaStyleTileSymbolWithStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FILL_AREA_STYLE_TILE_SYMBOL_WITH_STYLE;
	}
	...
	public IfcAnnotationSymbolOccurrence getSymbol() {
		return (IfcAnnotationSymbolOccurrence) eGet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILE_SYMBOL_WITH_STYLE__SYMBOL, true);
	}
	...
	public void setSymbol(IfcAnnotationSymbolOccurrence newSymbol) {
		eSet(LogPackage.Literals.IFC_FILL_AREA_STYLE_TILE_SYMBOL_WITH_STYLE__SYMBOL, newSymbol);
	}
