...
public class IfcSIUnitImpl extends IfcNamedUnitImpl implements IfcSIUnit {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SI_UNIT;
	}
	...
	public IfcSIPrefix getPrefix() {
		return (IfcSIPrefix) eGet(LogPackage.Literals.IFC_SI_UNIT__PREFIX, true);
	}
	...
	public void setPrefix(IfcSIPrefix newPrefix) {
		eSet(LogPackage.Literals.IFC_SI_UNIT__PREFIX, newPrefix);
	}
	...
	public void unsetPrefix() {
		eUnset(LogPackage.Literals.IFC_SI_UNIT__PREFIX);
	}
	...
	public boolean isSetPrefix() {
		return eIsSet(LogPackage.Literals.IFC_SI_UNIT__PREFIX);
	}
	...
	public IfcSIUnitName getName() {
		return (IfcSIUnitName) eGet(LogPackage.Literals.IFC_SI_UNIT__NAME, true);
	}
	...
	public void setName(IfcSIUnitName newName) {
		eSet(LogPackage.Literals.IFC_SI_UNIT__NAME, newName);
	}
