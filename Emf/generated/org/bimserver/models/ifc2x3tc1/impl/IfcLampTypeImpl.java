...
public class IfcLampTypeImpl extends IfcFlowTerminalTypeImpl implements IfcLampType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LAMP_TYPE;
	}
	...
	public IfcLampTypeEnum getPredefinedType() {
		return (IfcLampTypeEnum) eGet(LogPackage.Literals.IFC_LAMP_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcLampTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_LAMP_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
