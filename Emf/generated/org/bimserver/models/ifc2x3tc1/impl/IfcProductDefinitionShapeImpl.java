...
public class IfcProductDefinitionShapeImpl extends IfcProductRepresentationImpl implements IfcProductDefinitionShape {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PRODUCT_DEFINITION_SHAPE;
	}
	...
	public EList<IfcProduct> getShapeOfProduct() {
		return (EList<IfcProduct>) eGet(LogPackage.Literals.IFC_PRODUCT_DEFINITION_SHAPE__SHAPE_OF_PRODUCT, true);
	}
	...
	public void unsetShapeOfProduct() {
		eUnset(LogPackage.Literals.IFC_PRODUCT_DEFINITION_SHAPE__SHAPE_OF_PRODUCT);
	}
	...
	public boolean isSetShapeOfProduct() {
		return eIsSet(LogPackage.Literals.IFC_PRODUCT_DEFINITION_SHAPE__SHAPE_OF_PRODUCT);
	}
	...
	public EList<IfcShapeAspect> getHasShapeAspects() {
		return (EList<IfcShapeAspect>) eGet(LogPackage.Literals.IFC_PRODUCT_DEFINITION_SHAPE__HAS_SHAPE_ASPECTS, true);
	}
	...
	public void unsetHasShapeAspects() {
		eUnset(LogPackage.Literals.IFC_PRODUCT_DEFINITION_SHAPE__HAS_SHAPE_ASPECTS);
	}
	...
	public boolean isSetHasShapeAspects() {
		return eIsSet(LogPackage.Literals.IFC_PRODUCT_DEFINITION_SHAPE__HAS_SHAPE_ASPECTS);
	}
