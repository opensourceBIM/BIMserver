...
public class IfcMeasureWithUnitImpl extends IdEObjectImpl implements IfcMeasureWithUnit {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MEASURE_WITH_UNIT;
	}
	...
	public IfcValue getValueComponent() {
		return (IfcValue) eGet(LogPackage.Literals.IFC_MEASURE_WITH_UNIT__VALUE_COMPONENT, true);
	}
	...
	public void setValueComponent(IfcValue newValueComponent) {
		eSet(LogPackage.Literals.IFC_MEASURE_WITH_UNIT__VALUE_COMPONENT, newValueComponent);
	}
	...
	public IfcUnit getUnitComponent() {
		return (IfcUnit) eGet(LogPackage.Literals.IFC_MEASURE_WITH_UNIT__UNIT_COMPONENT, true);
	}
	...
	public void setUnitComponent(IfcUnit newUnitComponent) {
		eSet(LogPackage.Literals.IFC_MEASURE_WITH_UNIT__UNIT_COMPONENT, newUnitComponent);
	}
