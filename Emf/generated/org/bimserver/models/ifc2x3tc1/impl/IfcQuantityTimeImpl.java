...
public class IfcQuantityTimeImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityTime {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_QUANTITY_TIME;
	}
	...
	public double getTimeValue() {
		return (Double) eGet(LogPackage.Literals.IFC_QUANTITY_TIME__TIME_VALUE, true);
	}
	...
	public void setTimeValue(double newTimeValue) {
		eSet(LogPackage.Literals.IFC_QUANTITY_TIME__TIME_VALUE, newTimeValue);
	}
	...
	public String getTimeValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_QUANTITY_TIME__TIME_VALUE_AS_STRING, true);
	}
	...
	public void setTimeValueAsString(String newTimeValueAsString) {
		eSet(LogPackage.Literals.IFC_QUANTITY_TIME__TIME_VALUE_AS_STRING, newTimeValueAsString);
	}
