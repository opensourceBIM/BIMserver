...
public class IfcCurveStyleFontAndScalingImpl extends IdEObjectImpl implements IfcCurveStyleFontAndScaling {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__NAME);
	}
	...
	public IfcCurveStyleFontSelect getCurveFont() {
		return (IfcCurveStyleFontSelect) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__CURVE_FONT, true);
	}
	...
	public void setCurveFont(IfcCurveStyleFontSelect newCurveFont) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__CURVE_FONT, newCurveFont);
	}
	...
	public double getCurveFontScaling() {
		return (Double) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__CURVE_FONT_SCALING, true);
	}
	...
	public void setCurveFontScaling(double newCurveFontScaling) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__CURVE_FONT_SCALING, newCurveFontScaling);
	}
	...
	public String getCurveFontScalingAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__CURVE_FONT_SCALING_AS_STRING, true);
	}
	...
	public void setCurveFontScalingAsString(String newCurveFontScalingAsString) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_AND_SCALING__CURVE_FONT_SCALING_AS_STRING, newCurveFontScalingAsString);
	}
