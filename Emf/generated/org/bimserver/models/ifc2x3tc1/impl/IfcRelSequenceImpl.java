...
public class IfcRelSequenceImpl extends IfcRelConnectsImpl implements IfcRelSequence {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_SEQUENCE;
	}
	...
	public IfcProcess getRelatingProcess() {
		return (IfcProcess) eGet(LogPackage.Literals.IFC_REL_SEQUENCE__RELATING_PROCESS, true);
	}
	...
	public void setRelatingProcess(IfcProcess newRelatingProcess) {
		eSet(LogPackage.Literals.IFC_REL_SEQUENCE__RELATING_PROCESS, newRelatingProcess);
	}
	...
	public IfcProcess getRelatedProcess() {
		return (IfcProcess) eGet(LogPackage.Literals.IFC_REL_SEQUENCE__RELATED_PROCESS, true);
	}
	...
	public void setRelatedProcess(IfcProcess newRelatedProcess) {
		eSet(LogPackage.Literals.IFC_REL_SEQUENCE__RELATED_PROCESS, newRelatedProcess);
	}
	...
	public double getTimeLag() {
		return (Double) eGet(LogPackage.Literals.IFC_REL_SEQUENCE__TIME_LAG, true);
	}
	...
	public void setTimeLag(double newTimeLag) {
		eSet(LogPackage.Literals.IFC_REL_SEQUENCE__TIME_LAG, newTimeLag);
	}
	...
	public String getTimeLagAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REL_SEQUENCE__TIME_LAG_AS_STRING, true);
	}
	...
	public void setTimeLagAsString(String newTimeLagAsString) {
		eSet(LogPackage.Literals.IFC_REL_SEQUENCE__TIME_LAG_AS_STRING, newTimeLagAsString);
	}
	...
	public IfcSequenceEnum getSequenceType() {
		return (IfcSequenceEnum) eGet(LogPackage.Literals.IFC_REL_SEQUENCE__SEQUENCE_TYPE, true);
	}
	...
	public void setSequenceType(IfcSequenceEnum newSequenceType) {
		eSet(LogPackage.Literals.IFC_REL_SEQUENCE__SEQUENCE_TYPE, newSequenceType);
	}
