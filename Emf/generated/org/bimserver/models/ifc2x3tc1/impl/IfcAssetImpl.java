...
public class IfcAssetImpl extends IfcGroupImpl implements IfcAsset {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ASSET;
	}
	...
	public String getAssetID() {
		return (String) eGet(LogPackage.Literals.IFC_ASSET__ASSET_ID, true);
	}
	...
	public void setAssetID(String newAssetID) {
		eSet(LogPackage.Literals.IFC_ASSET__ASSET_ID, newAssetID);
	}
	...
	public IfcCostValue getOriginalValue() {
		return (IfcCostValue) eGet(LogPackage.Literals.IFC_ASSET__ORIGINAL_VALUE, true);
	}
	...
	public void setOriginalValue(IfcCostValue newOriginalValue) {
		eSet(LogPackage.Literals.IFC_ASSET__ORIGINAL_VALUE, newOriginalValue);
	}
	...
	public IfcCostValue getCurrentValue() {
		return (IfcCostValue) eGet(LogPackage.Literals.IFC_ASSET__CURRENT_VALUE, true);
	}
	...
	public void setCurrentValue(IfcCostValue newCurrentValue) {
		eSet(LogPackage.Literals.IFC_ASSET__CURRENT_VALUE, newCurrentValue);
	}
	...
	public IfcCostValue getTotalReplacementCost() {
		return (IfcCostValue) eGet(LogPackage.Literals.IFC_ASSET__TOTAL_REPLACEMENT_COST, true);
	}
	...
	public void setTotalReplacementCost(IfcCostValue newTotalReplacementCost) {
		eSet(LogPackage.Literals.IFC_ASSET__TOTAL_REPLACEMENT_COST, newTotalReplacementCost);
	}
	...
	public IfcActorSelect getOwner() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_ASSET__OWNER, true);
	}
	...
	public void setOwner(IfcActorSelect newOwner) {
		eSet(LogPackage.Literals.IFC_ASSET__OWNER, newOwner);
	}
	...
	public IfcActorSelect getUser() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_ASSET__USER, true);
	}
	...
	public void setUser(IfcActorSelect newUser) {
		eSet(LogPackage.Literals.IFC_ASSET__USER, newUser);
	}
	...
	public IfcPerson getResponsiblePerson() {
		return (IfcPerson) eGet(LogPackage.Literals.IFC_ASSET__RESPONSIBLE_PERSON, true);
	}
	...
	public void setResponsiblePerson(IfcPerson newResponsiblePerson) {
		eSet(LogPackage.Literals.IFC_ASSET__RESPONSIBLE_PERSON, newResponsiblePerson);
	}
	...
	public IfcCalendarDate getIncorporationDate() {
		return (IfcCalendarDate) eGet(LogPackage.Literals.IFC_ASSET__INCORPORATION_DATE, true);
	}
	...
	public void setIncorporationDate(IfcCalendarDate newIncorporationDate) {
		eSet(LogPackage.Literals.IFC_ASSET__INCORPORATION_DATE, newIncorporationDate);
	}
	...
	public IfcCostValue getDepreciatedValue() {
		return (IfcCostValue) eGet(LogPackage.Literals.IFC_ASSET__DEPRECIATED_VALUE, true);
	}
	...
	public void setDepreciatedValue(IfcCostValue newDepreciatedValue) {
		eSet(LogPackage.Literals.IFC_ASSET__DEPRECIATED_VALUE, newDepreciatedValue);
	}
