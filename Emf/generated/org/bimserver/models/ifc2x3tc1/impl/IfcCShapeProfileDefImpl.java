...
public class IfcCShapeProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcCShapeProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF;
	}
	...
	public double getDepth() {
		return (Double) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__DEPTH, true);
	}
	...
	public void setDepth(double newDepth) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__DEPTH, newDepth);
	}
	...
	public String getDepthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__DEPTH_AS_STRING, true);
	}
	...
	public void setDepthAsString(String newDepthAsString) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__DEPTH_AS_STRING, newDepthAsString);
	}
	...
	public double getWidth() {
		return (Double) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__WIDTH, true);
	}
	...
	public void setWidth(double newWidth) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__WIDTH, newWidth);
	}
	...
	public String getWidthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__WIDTH_AS_STRING, true);
	}
	...
	public void setWidthAsString(String newWidthAsString) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__WIDTH_AS_STRING, newWidthAsString);
	}
	...
	public double getWallThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__WALL_THICKNESS, true);
	}
	...
	public void setWallThickness(double newWallThickness) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__WALL_THICKNESS, newWallThickness);
	}
	...
	public String getWallThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__WALL_THICKNESS_AS_STRING, true);
	}
	...
	public void setWallThicknessAsString(String newWallThicknessAsString) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__WALL_THICKNESS_AS_STRING, newWallThicknessAsString);
	}
	...
	public double getGirth() {
		return (Double) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__GIRTH, true);
	}
	...
	public void setGirth(double newGirth) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__GIRTH, newGirth);
	}
	...
	public String getGirthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__GIRTH_AS_STRING, true);
	}
	...
	public void setGirthAsString(String newGirthAsString) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__GIRTH_AS_STRING, newGirthAsString);
	}
	...
	public double getInternalFilletRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS, true);
	}
	...
	public void setInternalFilletRadius(double newInternalFilletRadius) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS, newInternalFilletRadius);
	}
	...
	public void unsetInternalFilletRadius() {
		eUnset(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS);
	}
	...
	public boolean isSetInternalFilletRadius() {
		return eIsSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS);
	}
	...
	public String getInternalFilletRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS_AS_STRING, true);
	}
	...
	public void setInternalFilletRadiusAsString(String newInternalFilletRadiusAsString) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS_AS_STRING, newInternalFilletRadiusAsString);
	}
	...
	public void unsetInternalFilletRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS_AS_STRING);
	}
	...
	public boolean isSetInternalFilletRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS_AS_STRING);
	}
	...
	public double getCentreOfGravityInX() {
		return (Double) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_X, true);
	}
	...
	public void setCentreOfGravityInX(double newCentreOfGravityInX) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_X, newCentreOfGravityInX);
	}
	...
	public void unsetCentreOfGravityInX() {
		eUnset(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_X);
	}
	...
	public boolean isSetCentreOfGravityInX() {
		return eIsSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_X);
	}
	...
	public String getCentreOfGravityInXAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_XAS_STRING, true);
	}
	...
	public void setCentreOfGravityInXAsString(String newCentreOfGravityInXAsString) {
		eSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_XAS_STRING, newCentreOfGravityInXAsString);
	}
	...
	public void unsetCentreOfGravityInXAsString() {
		eUnset(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_XAS_STRING);
	}
	...
	public boolean isSetCentreOfGravityInXAsString() {
		return eIsSet(LogPackage.Literals.IFC_CSHAPE_PROFILE_DEF__CENTRE_OF_GRAVITY_IN_XAS_STRING);
	}
