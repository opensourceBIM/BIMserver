...
public class LogFactoryImpl extends EFactoryImpl implements LogFactory {
	...
	public static LogFactory init() {
		try {
			LogFactory theLogFactory = (LogFactory) EPackage.Registry.INSTANCE.getEFactory("http:///buildingsmart.ifc.ecore");
