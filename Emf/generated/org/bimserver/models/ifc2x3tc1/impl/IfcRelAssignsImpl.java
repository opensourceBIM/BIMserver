...
public class IfcRelAssignsImpl extends IfcRelationshipImpl implements IfcRelAssigns {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSIGNS;
	}
	...
	public EList<IfcObjectDefinition> getRelatedObjects() {
		return (EList<IfcObjectDefinition>) eGet(LogPackage.Literals.IFC_REL_ASSIGNS__RELATED_OBJECTS, true);
	}
	...
	public IfcObjectTypeEnum getRelatedObjectsType() {
		return (IfcObjectTypeEnum) eGet(LogPackage.Literals.IFC_REL_ASSIGNS__RELATED_OBJECTS_TYPE, true);
	}
	...
	public void setRelatedObjectsType(IfcObjectTypeEnum newRelatedObjectsType) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS__RELATED_OBJECTS_TYPE, newRelatedObjectsType);
	}
	...
	public void unsetRelatedObjectsType() {
		eUnset(LogPackage.Literals.IFC_REL_ASSIGNS__RELATED_OBJECTS_TYPE);
	}
	...
	public boolean isSetRelatedObjectsType() {
		return eIsSet(LogPackage.Literals.IFC_REL_ASSIGNS__RELATED_OBJECTS_TYPE);
	}
