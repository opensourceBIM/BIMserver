...
public class IfcRelDefinesByPropertiesImpl extends IfcRelDefinesImpl implements IfcRelDefinesByProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_DEFINES_BY_PROPERTIES;
	}
	...
	public IfcPropertySetDefinition getRelatingPropertyDefinition() {
		return (IfcPropertySetDefinition) eGet(LogPackage.Literals.IFC_REL_DEFINES_BY_PROPERTIES__RELATING_PROPERTY_DEFINITION, true);
	}
	...
	public void setRelatingPropertyDefinition(IfcPropertySetDefinition newRelatingPropertyDefinition) {
		eSet(LogPackage.Literals.IFC_REL_DEFINES_BY_PROPERTIES__RELATING_PROPERTY_DEFINITION, newRelatingPropertyDefinition);
	}
