...
public class IfcShapeAspectImpl extends IdEObjectImpl implements IfcShapeAspect {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SHAPE_ASPECT;
	}
	...
	public EList<IfcShapeModel> getShapeRepresentations() {
		return (EList<IfcShapeModel>) eGet(LogPackage.Literals.IFC_SHAPE_ASPECT__SHAPE_REPRESENTATIONS, true);
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_SHAPE_ASPECT__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_SHAPE_ASPECT__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_SHAPE_ASPECT__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_SHAPE_ASPECT__NAME);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_SHAPE_ASPECT__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_SHAPE_ASPECT__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_SHAPE_ASPECT__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_SHAPE_ASPECT__DESCRIPTION);
	}
	...
	public boolean isProductDefinitional() {
		return (Boolean) eGet(LogPackage.Literals.IFC_SHAPE_ASPECT__PRODUCT_DEFINITIONAL, true);
	}
	...
	public void setProductDefinitional(boolean newProductDefinitional) {
		eSet(LogPackage.Literals.IFC_SHAPE_ASPECT__PRODUCT_DEFINITIONAL, newProductDefinitional);
	}
	...
	public IfcProductDefinitionShape getPartOfProductDefinitionShape() {
		return (IfcProductDefinitionShape) eGet(LogPackage.Literals.IFC_SHAPE_ASPECT__PART_OF_PRODUCT_DEFINITION_SHAPE, true);
	}
	...
	public void setPartOfProductDefinitionShape(IfcProductDefinitionShape newPartOfProductDefinitionShape) {
		eSet(LogPackage.Literals.IFC_SHAPE_ASPECT__PART_OF_PRODUCT_DEFINITION_SHAPE, newPartOfProductDefinitionShape);
	}
