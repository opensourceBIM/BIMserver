...
public class IfcPlateTypeImpl extends IfcBuildingElementTypeImpl implements IfcPlateType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PLATE_TYPE;
	}
	...
	public IfcPlateTypeEnum getPredefinedType() {
		return (IfcPlateTypeEnum) eGet(LogPackage.Literals.IFC_PLATE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcPlateTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_PLATE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
