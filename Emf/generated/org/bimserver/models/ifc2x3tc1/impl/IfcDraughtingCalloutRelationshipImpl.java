...
public class IfcDraughtingCalloutRelationshipImpl extends IdEObjectImpl implements IfcDraughtingCalloutRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__NAME);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__DESCRIPTION);
	}
	...
	public IfcDraughtingCallout getRelatingDraughtingCallout() {
		return (IfcDraughtingCallout) eGet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__RELATING_DRAUGHTING_CALLOUT, true);
	}
	...
	public void setRelatingDraughtingCallout(IfcDraughtingCallout newRelatingDraughtingCallout) {
		eSet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__RELATING_DRAUGHTING_CALLOUT, newRelatingDraughtingCallout);
	}
	...
	public IfcDraughtingCallout getRelatedDraughtingCallout() {
		return (IfcDraughtingCallout) eGet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__RELATED_DRAUGHTING_CALLOUT, true);
	}
	...
	public void setRelatedDraughtingCallout(IfcDraughtingCallout newRelatedDraughtingCallout) {
		eSet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT_RELATIONSHIP__RELATED_DRAUGHTING_CALLOUT, newRelatedDraughtingCallout);
	}
