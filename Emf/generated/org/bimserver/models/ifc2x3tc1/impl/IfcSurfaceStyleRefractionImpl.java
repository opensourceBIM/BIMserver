...
public class IfcSurfaceStyleRefractionImpl extends IdEObjectImpl implements IfcSurfaceStyleRefraction {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION;
	}
	...
	public double getRefractionIndex() {
		return (Double) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__REFRACTION_INDEX, true);
	}
	...
	public void setRefractionIndex(double newRefractionIndex) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__REFRACTION_INDEX, newRefractionIndex);
	}
	...
	public void unsetRefractionIndex() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__REFRACTION_INDEX);
	}
	...
	public boolean isSetRefractionIndex() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__REFRACTION_INDEX);
	}
	...
	public String getRefractionIndexAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__REFRACTION_INDEX_AS_STRING, true);
	}
	...
	public void setRefractionIndexAsString(String newRefractionIndexAsString) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__REFRACTION_INDEX_AS_STRING, newRefractionIndexAsString);
	}
	...
	public void unsetRefractionIndexAsString() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__REFRACTION_INDEX_AS_STRING);
	}
	...
	public boolean isSetRefractionIndexAsString() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__REFRACTION_INDEX_AS_STRING);
	}
	...
	public double getDispersionFactor() {
		return (Double) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__DISPERSION_FACTOR, true);
	}
	...
	public void setDispersionFactor(double newDispersionFactor) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__DISPERSION_FACTOR, newDispersionFactor);
	}
	...
	public void unsetDispersionFactor() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__DISPERSION_FACTOR);
	}
	...
	public boolean isSetDispersionFactor() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__DISPERSION_FACTOR);
	}
	...
	public String getDispersionFactorAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__DISPERSION_FACTOR_AS_STRING, true);
	}
	...
	public void setDispersionFactorAsString(String newDispersionFactorAsString) {
		eSet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__DISPERSION_FACTOR_AS_STRING, newDispersionFactorAsString);
	}
	...
	public void unsetDispersionFactorAsString() {
		eUnset(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__DISPERSION_FACTOR_AS_STRING);
	}
	...
	public boolean isSetDispersionFactorAsString() {
		return eIsSet(LogPackage.Literals.IFC_SURFACE_STYLE_REFRACTION__DISPERSION_FACTOR_AS_STRING);
	}
