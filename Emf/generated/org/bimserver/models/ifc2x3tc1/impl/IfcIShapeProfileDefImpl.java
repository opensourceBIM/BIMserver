...
public class IfcIShapeProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcIShapeProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF;
	}
	...
	public double getOverallWidth() {
		return (Double) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_WIDTH, true);
	}
	...
	public void setOverallWidth(double newOverallWidth) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_WIDTH, newOverallWidth);
	}
	...
	public String getOverallWidthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_WIDTH_AS_STRING, true);
	}
	...
	public void setOverallWidthAsString(String newOverallWidthAsString) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_WIDTH_AS_STRING, newOverallWidthAsString);
	}
	...
	public double getOverallDepth() {
		return (Double) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_DEPTH, true);
	}
	...
	public void setOverallDepth(double newOverallDepth) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_DEPTH, newOverallDepth);
	}
	...
	public String getOverallDepthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_DEPTH_AS_STRING, true);
	}
	...
	public void setOverallDepthAsString(String newOverallDepthAsString) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_DEPTH_AS_STRING, newOverallDepthAsString);
	}
	...
	public double getWebThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__WEB_THICKNESS, true);
	}
	...
	public void setWebThickness(double newWebThickness) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__WEB_THICKNESS, newWebThickness);
	}
	...
	public String getWebThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, true);
	}
	...
	public void setWebThicknessAsString(String newWebThicknessAsString) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, newWebThicknessAsString);
	}
	...
	public double getFlangeThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_THICKNESS, true);
	}
	...
	public void setFlangeThickness(double newFlangeThickness) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_THICKNESS, newFlangeThickness);
	}
	...
	public String getFlangeThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING, true);
	}
	...
	public void setFlangeThicknessAsString(String newFlangeThicknessAsString) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING, newFlangeThicknessAsString);
	}
	...
	public double getFilletRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS, true);
	}
	...
	public void setFilletRadius(double newFilletRadius) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS, newFilletRadius);
	}
	...
	public void unsetFilletRadius() {
		eUnset(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS);
	}
	...
	public boolean isSetFilletRadius() {
		return eIsSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS);
	}
	...
	public String getFilletRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING, true);
	}
	...
	public void setFilletRadiusAsString(String newFilletRadiusAsString) {
		eSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING, newFilletRadiusAsString);
	}
	...
	public void unsetFilletRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING);
	}
	...
	public boolean isSetFilletRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING);
	}
