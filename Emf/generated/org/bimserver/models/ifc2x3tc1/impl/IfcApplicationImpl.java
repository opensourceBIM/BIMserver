...
public class IfcApplicationImpl extends IdEObjectImpl implements IfcApplication {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_APPLICATION;
	}
	...
	public IfcOrganization getApplicationDeveloper() {
		return (IfcOrganization) eGet(LogPackage.Literals.IFC_APPLICATION__APPLICATION_DEVELOPER, true);
	}
	...
	public void setApplicationDeveloper(IfcOrganization newApplicationDeveloper) {
		eSet(LogPackage.Literals.IFC_APPLICATION__APPLICATION_DEVELOPER, newApplicationDeveloper);
	}
	...
	public String getVersion() {
		return (String) eGet(LogPackage.Literals.IFC_APPLICATION__VERSION, true);
	}
	...
	public void setVersion(String newVersion) {
		eSet(LogPackage.Literals.IFC_APPLICATION__VERSION, newVersion);
	}
	...
	public String getApplicationFullName() {
		return (String) eGet(LogPackage.Literals.IFC_APPLICATION__APPLICATION_FULL_NAME, true);
	}
	...
	public void setApplicationFullName(String newApplicationFullName) {
		eSet(LogPackage.Literals.IFC_APPLICATION__APPLICATION_FULL_NAME, newApplicationFullName);
	}
	...
	public String getApplicationIdentifier() {
		return (String) eGet(LogPackage.Literals.IFC_APPLICATION__APPLICATION_IDENTIFIER, true);
	}
	...
	public void setApplicationIdentifier(String newApplicationIdentifier) {
		eSet(LogPackage.Literals.IFC_APPLICATION__APPLICATION_IDENTIFIER, newApplicationIdentifier);
	}
