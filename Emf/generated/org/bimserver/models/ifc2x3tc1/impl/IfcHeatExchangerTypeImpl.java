...
public class IfcHeatExchangerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcHeatExchangerType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_HEAT_EXCHANGER_TYPE;
	}
	...
	public IfcHeatExchangerTypeEnum getPredefinedType() {
		return (IfcHeatExchangerTypeEnum) eGet(LogPackage.Literals.IFC_HEAT_EXCHANGER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcHeatExchangerTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_HEAT_EXCHANGER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
