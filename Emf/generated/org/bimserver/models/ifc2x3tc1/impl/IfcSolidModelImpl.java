...
public class IfcSolidModelImpl extends IfcGeometricRepresentationItemImpl implements IfcSolidModel {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SOLID_MODEL;
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_SOLID_MODEL__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_SOLID_MODEL__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_SOLID_MODEL__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_SOLID_MODEL__DIM);
	}
