...
public class IfcProxyImpl extends IfcProductImpl implements IfcProxy {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROXY;
	}
	...
	public IfcObjectTypeEnum getProxyType() {
		return (IfcObjectTypeEnum) eGet(LogPackage.Literals.IFC_PROXY__PROXY_TYPE, true);
	}
	...
	public void setProxyType(IfcObjectTypeEnum newProxyType) {
		eSet(LogPackage.Literals.IFC_PROXY__PROXY_TYPE, newProxyType);
	}
	...
	public String getTag() {
		return (String) eGet(LogPackage.Literals.IFC_PROXY__TAG, true);
	}
	...
	public void setTag(String newTag) {
		eSet(LogPackage.Literals.IFC_PROXY__TAG, newTag);
	}
	...
	public void unsetTag() {
		eUnset(LogPackage.Literals.IFC_PROXY__TAG);
	}
	...
	public boolean isSetTag() {
		return eIsSet(LogPackage.Literals.IFC_PROXY__TAG);
	}
