...
public class IfcRelAssociatesConstraintImpl extends IfcRelAssociatesImpl implements IfcRelAssociatesConstraint {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSOCIATES_CONSTRAINT;
	}
	...
	public String getIntent() {
		return (String) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_CONSTRAINT__INTENT, true);
	}
	...
	public void setIntent(String newIntent) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_CONSTRAINT__INTENT, newIntent);
	}
	...
	public IfcConstraint getRelatingConstraint() {
		return (IfcConstraint) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_CONSTRAINT__RELATING_CONSTRAINT, true);
	}
	...
	public void setRelatingConstraint(IfcConstraint newRelatingConstraint) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_CONSTRAINT__RELATING_CONSTRAINT, newRelatingConstraint);
	}
