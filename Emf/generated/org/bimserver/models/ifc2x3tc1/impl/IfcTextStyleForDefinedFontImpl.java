...
public class IfcTextStyleForDefinedFontImpl extends IdEObjectImpl implements IfcTextStyleForDefinedFont {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEXT_STYLE_FOR_DEFINED_FONT;
	}
	...
	public IfcColour getColour() {
		return (IfcColour) eGet(LogPackage.Literals.IFC_TEXT_STYLE_FOR_DEFINED_FONT__COLOUR, true);
	}
	...
	public void setColour(IfcColour newColour) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE_FOR_DEFINED_FONT__COLOUR, newColour);
	}
	...
	public IfcColour getBackgroundColour() {
		return (IfcColour) eGet(LogPackage.Literals.IFC_TEXT_STYLE_FOR_DEFINED_FONT__BACKGROUND_COLOUR, true);
	}
	...
	public void setBackgroundColour(IfcColour newBackgroundColour) {
		eSet(LogPackage.Literals.IFC_TEXT_STYLE_FOR_DEFINED_FONT__BACKGROUND_COLOUR, newBackgroundColour);
	}
	...
	public void unsetBackgroundColour() {
		eUnset(LogPackage.Literals.IFC_TEXT_STYLE_FOR_DEFINED_FONT__BACKGROUND_COLOUR);
	}
	...
	public boolean isSetBackgroundColour() {
		return eIsSet(LogPackage.Literals.IFC_TEXT_STYLE_FOR_DEFINED_FONT__BACKGROUND_COLOUR);
	}
