...
public class IfcRelCoversBldgElementsImpl extends IfcRelConnectsImpl implements IfcRelCoversBldgElements {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_COVERS_BLDG_ELEMENTS;
	}
	...
	public IfcElement getRelatingBuildingElement() {
		return (IfcElement) eGet(LogPackage.Literals.IFC_REL_COVERS_BLDG_ELEMENTS__RELATING_BUILDING_ELEMENT, true);
	}
	...
	public void setRelatingBuildingElement(IfcElement newRelatingBuildingElement) {
		eSet(LogPackage.Literals.IFC_REL_COVERS_BLDG_ELEMENTS__RELATING_BUILDING_ELEMENT, newRelatingBuildingElement);
	}
	...
	public EList<IfcCovering> getRelatedCoverings() {
		return (EList<IfcCovering>) eGet(LogPackage.Literals.IFC_REL_COVERS_BLDG_ELEMENTS__RELATED_COVERINGS, true);
	}
