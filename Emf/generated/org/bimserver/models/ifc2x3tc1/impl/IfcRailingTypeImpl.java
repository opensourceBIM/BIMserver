...
public class IfcRailingTypeImpl extends IfcBuildingElementTypeImpl implements IfcRailingType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RAILING_TYPE;
	}
	...
	public IfcRailingTypeEnum getPredefinedType() {
		return (IfcRailingTypeEnum) eGet(LogPackage.Literals.IFC_RAILING_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcRailingTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_RAILING_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
