...
public class IfcPropertyTableValueImpl extends IfcSimplePropertyImpl implements IfcPropertyTableValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE;
	}
	...
	public EList<IfcValue> getDefiningValues() {
		return (EList<IfcValue>) eGet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINING_VALUES, true);
	}
	...
	public EList<IfcValue> getDefinedValues() {
		return (EList<IfcValue>) eGet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINED_VALUES, true);
	}
	...
	public String getExpression() {
		return (String) eGet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__EXPRESSION, true);
	}
	...
	public void setExpression(String newExpression) {
		eSet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__EXPRESSION, newExpression);
	}
	...
	public void unsetExpression() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__EXPRESSION);
	}
	...
	public boolean isSetExpression() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__EXPRESSION);
	}
	...
	public IfcUnit getDefiningUnit() {
		return (IfcUnit) eGet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINING_UNIT, true);
	}
	...
	public void setDefiningUnit(IfcUnit newDefiningUnit) {
		eSet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINING_UNIT, newDefiningUnit);
	}
	...
	public void unsetDefiningUnit() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINING_UNIT);
	}
	...
	public boolean isSetDefiningUnit() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINING_UNIT);
	}
	...
	public IfcUnit getDefinedUnit() {
		return (IfcUnit) eGet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINED_UNIT, true);
	}
	...
	public void setDefinedUnit(IfcUnit newDefinedUnit) {
		eSet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINED_UNIT, newDefinedUnit);
	}
	...
	public void unsetDefinedUnit() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINED_UNIT);
	}
	...
	public boolean isSetDefinedUnit() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_TABLE_VALUE__DEFINED_UNIT);
	}
