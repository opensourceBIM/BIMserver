...
public class IfcMonetaryUnitImpl extends IdEObjectImpl implements IfcMonetaryUnit {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MONETARY_UNIT;
	}
	...
	public IfcCurrencyEnum getCurrency() {
		return (IfcCurrencyEnum) eGet(LogPackage.Literals.IFC_MONETARY_UNIT__CURRENCY, true);
	}
	...
	public void setCurrency(IfcCurrencyEnum newCurrency) {
		eSet(LogPackage.Literals.IFC_MONETARY_UNIT__CURRENCY, newCurrency);
	}
