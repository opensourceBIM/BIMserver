...
public class IfcRelProjectsElementImpl extends IfcRelConnectsImpl implements IfcRelProjectsElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_PROJECTS_ELEMENT;
	}
	...
	public IfcElement getRelatingElement() {
		return (IfcElement) eGet(LogPackage.Literals.IFC_REL_PROJECTS_ELEMENT__RELATING_ELEMENT, true);
	}
	...
	public void setRelatingElement(IfcElement newRelatingElement) {
		eSet(LogPackage.Literals.IFC_REL_PROJECTS_ELEMENT__RELATING_ELEMENT, newRelatingElement);
	}
	...
	public IfcFeatureElementAddition getRelatedFeatureElement() {
		return (IfcFeatureElementAddition) eGet(LogPackage.Literals.IFC_REL_PROJECTS_ELEMENT__RELATED_FEATURE_ELEMENT, true);
	}
	...
	public void setRelatedFeatureElement(IfcFeatureElementAddition newRelatedFeatureElement) {
		eSet(LogPackage.Literals.IFC_REL_PROJECTS_ELEMENT__RELATED_FEATURE_ELEMENT, newRelatedFeatureElement);
	}
