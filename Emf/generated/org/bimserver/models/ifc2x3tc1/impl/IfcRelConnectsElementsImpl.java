...
public class IfcRelConnectsElementsImpl extends IfcRelConnectsImpl implements IfcRelConnectsElements {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS;
	}
	...
	public IfcConnectionGeometry getConnectionGeometry() {
		return (IfcConnectionGeometry) eGet(LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS__CONNECTION_GEOMETRY, true);
	}
	...
	public void setConnectionGeometry(IfcConnectionGeometry newConnectionGeometry) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS__CONNECTION_GEOMETRY, newConnectionGeometry);
	}
	...
	public void unsetConnectionGeometry() {
		eUnset(LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS__CONNECTION_GEOMETRY);
	}
	...
	public boolean isSetConnectionGeometry() {
		return eIsSet(LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS__CONNECTION_GEOMETRY);
	}
	...
	public IfcElement getRelatingElement() {
		return (IfcElement) eGet(LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS__RELATING_ELEMENT, true);
	}
	...
	public void setRelatingElement(IfcElement newRelatingElement) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS__RELATING_ELEMENT, newRelatingElement);
	}
	...
	public IfcElement getRelatedElement() {
		return (IfcElement) eGet(LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS__RELATED_ELEMENT, true);
	}
	...
	public void setRelatedElement(IfcElement newRelatedElement) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_ELEMENTS__RELATED_ELEMENT, newRelatedElement);
	}
