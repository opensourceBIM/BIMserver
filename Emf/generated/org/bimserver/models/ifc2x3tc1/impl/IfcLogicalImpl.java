...
public class IfcLogicalImpl extends WrappedValueImpl implements IfcLogical {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LOGICAL;
	}
	...
	public Tristate getWrappedValue() {
		return (Tristate) eGet(LogPackage.Literals.IFC_LOGICAL__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(Tristate newWrappedValue) {
		eSet(LogPackage.Literals.IFC_LOGICAL__WRAPPED_VALUE, newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(LogPackage.Literals.IFC_LOGICAL__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(LogPackage.Literals.IFC_LOGICAL__WRAPPED_VALUE);
	}
