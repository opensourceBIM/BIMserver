...
public class IfcConversionBasedUnitImpl extends IfcNamedUnitImpl implements IfcConversionBasedUnit {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONVERSION_BASED_UNIT;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_CONVERSION_BASED_UNIT__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_CONVERSION_BASED_UNIT__NAME, newName);
	}
	...
	public IfcMeasureWithUnit getConversionFactor() {
		return (IfcMeasureWithUnit) eGet(LogPackage.Literals.IFC_CONVERSION_BASED_UNIT__CONVERSION_FACTOR, true);
	}
	...
	public void setConversionFactor(IfcMeasureWithUnit newConversionFactor) {
		eSet(LogPackage.Literals.IFC_CONVERSION_BASED_UNIT__CONVERSION_FACTOR, newConversionFactor);
	}
