...
public class IfcRelAssignsToProductImpl extends IfcRelAssignsImpl implements IfcRelAssignsToProduct {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSIGNS_TO_PRODUCT;
	}
	...
	public IfcProduct getRelatingProduct() {
		return (IfcProduct) eGet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_PRODUCT__RELATING_PRODUCT, true);
	}
	...
	public void setRelatingProduct(IfcProduct newRelatingProduct) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_PRODUCT__RELATING_PRODUCT, newRelatingProduct);
	}
