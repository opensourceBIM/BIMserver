...
public class IfcSubContractResourceImpl extends IfcConstructionResourceImpl implements IfcSubContractResource {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE;
	}
	...
	public IfcActorSelect getSubContractor() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE__SUB_CONTRACTOR, true);
	}
	...
	public void setSubContractor(IfcActorSelect newSubContractor) {
		eSet(LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE__SUB_CONTRACTOR, newSubContractor);
	}
	...
	public void unsetSubContractor() {
		eUnset(LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE__SUB_CONTRACTOR);
	}
	...
	public boolean isSetSubContractor() {
		return eIsSet(LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE__SUB_CONTRACTOR);
	}
	...
	public String getJobDescription() {
		return (String) eGet(LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE__JOB_DESCRIPTION, true);
	}
	...
	public void setJobDescription(String newJobDescription) {
		eSet(LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE__JOB_DESCRIPTION, newJobDescription);
	}
	...
	public void unsetJobDescription() {
		eUnset(LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE__JOB_DESCRIPTION);
	}
	...
	public boolean isSetJobDescription() {
		return eIsSet(LogPackage.Literals.IFC_SUB_CONTRACT_RESOURCE__JOB_DESCRIPTION);
	}
