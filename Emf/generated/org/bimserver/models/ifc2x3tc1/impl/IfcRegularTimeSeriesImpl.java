...
public class IfcRegularTimeSeriesImpl extends IfcTimeSeriesImpl implements IfcRegularTimeSeries {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REGULAR_TIME_SERIES;
	}
	...
	public double getTimeStep() {
		return (Double) eGet(LogPackage.Literals.IFC_REGULAR_TIME_SERIES__TIME_STEP, true);
	}
	...
	public void setTimeStep(double newTimeStep) {
		eSet(LogPackage.Literals.IFC_REGULAR_TIME_SERIES__TIME_STEP, newTimeStep);
	}
	...
	public String getTimeStepAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REGULAR_TIME_SERIES__TIME_STEP_AS_STRING, true);
	}
	...
	public void setTimeStepAsString(String newTimeStepAsString) {
		eSet(LogPackage.Literals.IFC_REGULAR_TIME_SERIES__TIME_STEP_AS_STRING, newTimeStepAsString);
	}
	...
	public EList<IfcTimeSeriesValue> getValues() {
		return (EList<IfcTimeSeriesValue>) eGet(LogPackage.Literals.IFC_REGULAR_TIME_SERIES__VALUES, true);
	}
