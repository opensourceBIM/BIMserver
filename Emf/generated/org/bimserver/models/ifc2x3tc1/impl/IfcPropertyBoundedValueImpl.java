...
public class IfcPropertyBoundedValueImpl extends IfcSimplePropertyImpl implements IfcPropertyBoundedValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE;
	}
	...
	public IfcValue getUpperBoundValue() {
		return (IfcValue) eGet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__UPPER_BOUND_VALUE, true);
	}
	...
	public void setUpperBoundValue(IfcValue newUpperBoundValue) {
		eSet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__UPPER_BOUND_VALUE, newUpperBoundValue);
	}
	...
	public void unsetUpperBoundValue() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__UPPER_BOUND_VALUE);
	}
	...
	public boolean isSetUpperBoundValue() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__UPPER_BOUND_VALUE);
	}
	...
	public IfcValue getLowerBoundValue() {
		return (IfcValue) eGet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__LOWER_BOUND_VALUE, true);
	}
	...
	public void setLowerBoundValue(IfcValue newLowerBoundValue) {
		eSet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__LOWER_BOUND_VALUE, newLowerBoundValue);
	}
	...
	public void unsetLowerBoundValue() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__LOWER_BOUND_VALUE);
	}
	...
	public boolean isSetLowerBoundValue() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__LOWER_BOUND_VALUE);
	}
	...
	public IfcUnit getUnit() {
		return (IfcUnit) eGet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__UNIT, true);
	}
	...
	public void setUnit(IfcUnit newUnit) {
		eSet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__UNIT, newUnit);
	}
	...
	public void unsetUnit() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__UNIT);
	}
	...
	public boolean isSetUnit() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_BOUNDED_VALUE__UNIT);
	}
