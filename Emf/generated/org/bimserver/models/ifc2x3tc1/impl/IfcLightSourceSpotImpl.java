...
public class IfcLightSourceSpotImpl extends IfcLightSourcePositionalImpl implements IfcLightSourceSpot {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT;
	}
	...
	public IfcDirection getOrientation() {
		return (IfcDirection) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__ORIENTATION, true);
	}
	...
	public void setOrientation(IfcDirection newOrientation) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__ORIENTATION, newOrientation);
	}
	...
	public double getConcentrationExponent() {
		return (Double) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT, true);
	}
	...
	public void setConcentrationExponent(double newConcentrationExponent) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT, newConcentrationExponent);
	}
	...
	public void unsetConcentrationExponent() {
		eUnset(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT);
	}
	...
	public boolean isSetConcentrationExponent() {
		return eIsSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT);
	}
	...
	public String getConcentrationExponentAsString() {
		return (String) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT_AS_STRING, true);
	}
	...
	public void setConcentrationExponentAsString(String newConcentrationExponentAsString) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT_AS_STRING, newConcentrationExponentAsString);
	}
	...
	public void unsetConcentrationExponentAsString() {
		eUnset(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT_AS_STRING);
	}
	...
	public boolean isSetConcentrationExponentAsString() {
		return eIsSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT_AS_STRING);
	}
	...
	public double getSpreadAngle() {
		return (Double) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__SPREAD_ANGLE, true);
	}
	...
	public void setSpreadAngle(double newSpreadAngle) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__SPREAD_ANGLE, newSpreadAngle);
	}
	...
	public String getSpreadAngleAsString() {
		return (String) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__SPREAD_ANGLE_AS_STRING, true);
	}
	...
	public void setSpreadAngleAsString(String newSpreadAngleAsString) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__SPREAD_ANGLE_AS_STRING, newSpreadAngleAsString);
	}
	...
	public double getBeamWidthAngle() {
		return (Double) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__BEAM_WIDTH_ANGLE, true);
	}
	...
	public void setBeamWidthAngle(double newBeamWidthAngle) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__BEAM_WIDTH_ANGLE, newBeamWidthAngle);
	}
	...
	public String getBeamWidthAngleAsString() {
		return (String) eGet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__BEAM_WIDTH_ANGLE_AS_STRING, true);
	}
	...
	public void setBeamWidthAngleAsString(String newBeamWidthAngleAsString) {
		eSet(LogPackage.Literals.IFC_LIGHT_SOURCE_SPOT__BEAM_WIDTH_ANGLE_AS_STRING, newBeamWidthAngleAsString);
	}
