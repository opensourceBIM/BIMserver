...
public class IfcTendonImpl extends IfcReinforcingElementImpl implements IfcTendon {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TENDON;
	}
	...
	public IfcTendonTypeEnum getPredefinedType() {
		return (IfcTendonTypeEnum) eGet(LogPackage.Literals.IFC_TENDON__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTendonTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_TENDON__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public double getNominalDiameter() {
		return (Double) eGet(LogPackage.Literals.IFC_TENDON__NOMINAL_DIAMETER, true);
	}
	...
	public void setNominalDiameter(double newNominalDiameter) {
		eSet(LogPackage.Literals.IFC_TENDON__NOMINAL_DIAMETER, newNominalDiameter);
	}
	...
	public String getNominalDiameterAsString() {
		return (String) eGet(LogPackage.Literals.IFC_TENDON__NOMINAL_DIAMETER_AS_STRING, true);
	}
	...
	public void setNominalDiameterAsString(String newNominalDiameterAsString) {
		eSet(LogPackage.Literals.IFC_TENDON__NOMINAL_DIAMETER_AS_STRING, newNominalDiameterAsString);
	}
	...
	public double getCrossSectionArea() {
		return (Double) eGet(LogPackage.Literals.IFC_TENDON__CROSS_SECTION_AREA, true);
	}
	...
	public void setCrossSectionArea(double newCrossSectionArea) {
		eSet(LogPackage.Literals.IFC_TENDON__CROSS_SECTION_AREA, newCrossSectionArea);
	}
	...
	public String getCrossSectionAreaAsString() {
		return (String) eGet(LogPackage.Literals.IFC_TENDON__CROSS_SECTION_AREA_AS_STRING, true);
	}
	...
	public void setCrossSectionAreaAsString(String newCrossSectionAreaAsString) {
		eSet(LogPackage.Literals.IFC_TENDON__CROSS_SECTION_AREA_AS_STRING, newCrossSectionAreaAsString);
	}
	...
	public double getTensionForce() {
		return (Double) eGet(LogPackage.Literals.IFC_TENDON__TENSION_FORCE, true);
	}
	...
	public void setTensionForce(double newTensionForce) {
		eSet(LogPackage.Literals.IFC_TENDON__TENSION_FORCE, newTensionForce);
	}
	...
	public void unsetTensionForce() {
		eUnset(LogPackage.Literals.IFC_TENDON__TENSION_FORCE);
	}
	...
	public boolean isSetTensionForce() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__TENSION_FORCE);
	}
	...
	public String getTensionForceAsString() {
		return (String) eGet(LogPackage.Literals.IFC_TENDON__TENSION_FORCE_AS_STRING, true);
	}
	...
	public void setTensionForceAsString(String newTensionForceAsString) {
		eSet(LogPackage.Literals.IFC_TENDON__TENSION_FORCE_AS_STRING, newTensionForceAsString);
	}
	...
	public void unsetTensionForceAsString() {
		eUnset(LogPackage.Literals.IFC_TENDON__TENSION_FORCE_AS_STRING);
	}
	...
	public boolean isSetTensionForceAsString() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__TENSION_FORCE_AS_STRING);
	}
	...
	public double getPreStress() {
		return (Double) eGet(LogPackage.Literals.IFC_TENDON__PRE_STRESS, true);
	}
	...
	public void setPreStress(double newPreStress) {
		eSet(LogPackage.Literals.IFC_TENDON__PRE_STRESS, newPreStress);
	}
	...
	public void unsetPreStress() {
		eUnset(LogPackage.Literals.IFC_TENDON__PRE_STRESS);
	}
	...
	public boolean isSetPreStress() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__PRE_STRESS);
	}
	...
	public String getPreStressAsString() {
		return (String) eGet(LogPackage.Literals.IFC_TENDON__PRE_STRESS_AS_STRING, true);
	}
	...
	public void setPreStressAsString(String newPreStressAsString) {
		eSet(LogPackage.Literals.IFC_TENDON__PRE_STRESS_AS_STRING, newPreStressAsString);
	}
	...
	public void unsetPreStressAsString() {
		eUnset(LogPackage.Literals.IFC_TENDON__PRE_STRESS_AS_STRING);
	}
	...
	public boolean isSetPreStressAsString() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__PRE_STRESS_AS_STRING);
	}
	...
	public double getFrictionCoefficient() {
		return (Double) eGet(LogPackage.Literals.IFC_TENDON__FRICTION_COEFFICIENT, true);
	}
	...
	public void setFrictionCoefficient(double newFrictionCoefficient) {
		eSet(LogPackage.Literals.IFC_TENDON__FRICTION_COEFFICIENT, newFrictionCoefficient);
	}
	...
	public void unsetFrictionCoefficient() {
		eUnset(LogPackage.Literals.IFC_TENDON__FRICTION_COEFFICIENT);
	}
	...
	public boolean isSetFrictionCoefficient() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__FRICTION_COEFFICIENT);
	}
	...
	public String getFrictionCoefficientAsString() {
		return (String) eGet(LogPackage.Literals.IFC_TENDON__FRICTION_COEFFICIENT_AS_STRING, true);
	}
	...
	public void setFrictionCoefficientAsString(String newFrictionCoefficientAsString) {
		eSet(LogPackage.Literals.IFC_TENDON__FRICTION_COEFFICIENT_AS_STRING, newFrictionCoefficientAsString);
	}
	...
	public void unsetFrictionCoefficientAsString() {
		eUnset(LogPackage.Literals.IFC_TENDON__FRICTION_COEFFICIENT_AS_STRING);
	}
	...
	public boolean isSetFrictionCoefficientAsString() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__FRICTION_COEFFICIENT_AS_STRING);
	}
	...
	public double getAnchorageSlip() {
		return (Double) eGet(LogPackage.Literals.IFC_TENDON__ANCHORAGE_SLIP, true);
	}
	...
	public void setAnchorageSlip(double newAnchorageSlip) {
		eSet(LogPackage.Literals.IFC_TENDON__ANCHORAGE_SLIP, newAnchorageSlip);
	}
	...
	public void unsetAnchorageSlip() {
		eUnset(LogPackage.Literals.IFC_TENDON__ANCHORAGE_SLIP);
	}
	...
	public boolean isSetAnchorageSlip() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__ANCHORAGE_SLIP);
	}
	...
	public String getAnchorageSlipAsString() {
		return (String) eGet(LogPackage.Literals.IFC_TENDON__ANCHORAGE_SLIP_AS_STRING, true);
	}
	...
	public void setAnchorageSlipAsString(String newAnchorageSlipAsString) {
		eSet(LogPackage.Literals.IFC_TENDON__ANCHORAGE_SLIP_AS_STRING, newAnchorageSlipAsString);
	}
	...
	public void unsetAnchorageSlipAsString() {
		eUnset(LogPackage.Literals.IFC_TENDON__ANCHORAGE_SLIP_AS_STRING);
	}
	...
	public boolean isSetAnchorageSlipAsString() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__ANCHORAGE_SLIP_AS_STRING);
	}
	...
	public double getMinCurvatureRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_TENDON__MIN_CURVATURE_RADIUS, true);
	}
	...
	public void setMinCurvatureRadius(double newMinCurvatureRadius) {
		eSet(LogPackage.Literals.IFC_TENDON__MIN_CURVATURE_RADIUS, newMinCurvatureRadius);
	}
	...
	public void unsetMinCurvatureRadius() {
		eUnset(LogPackage.Literals.IFC_TENDON__MIN_CURVATURE_RADIUS);
	}
	...
	public boolean isSetMinCurvatureRadius() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__MIN_CURVATURE_RADIUS);
	}
	...
	public String getMinCurvatureRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_TENDON__MIN_CURVATURE_RADIUS_AS_STRING, true);
	}
	...
	public void setMinCurvatureRadiusAsString(String newMinCurvatureRadiusAsString) {
		eSet(LogPackage.Literals.IFC_TENDON__MIN_CURVATURE_RADIUS_AS_STRING, newMinCurvatureRadiusAsString);
	}
	...
	public void unsetMinCurvatureRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_TENDON__MIN_CURVATURE_RADIUS_AS_STRING);
	}
	...
	public boolean isSetMinCurvatureRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_TENDON__MIN_CURVATURE_RADIUS_AS_STRING);
	}
