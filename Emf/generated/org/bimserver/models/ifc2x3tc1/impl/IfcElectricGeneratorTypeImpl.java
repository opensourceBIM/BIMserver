...
public class IfcElectricGeneratorTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcElectricGeneratorType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ELECTRIC_GENERATOR_TYPE;
	}
	...
	public IfcElectricGeneratorTypeEnum getPredefinedType() {
		return (IfcElectricGeneratorTypeEnum) eGet(LogPackage.Literals.IFC_ELECTRIC_GENERATOR_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcElectricGeneratorTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_ELECTRIC_GENERATOR_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
