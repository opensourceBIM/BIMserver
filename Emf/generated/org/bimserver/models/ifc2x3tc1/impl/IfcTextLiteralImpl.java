...
public class IfcTextLiteralImpl extends IfcGeometricRepresentationItemImpl implements IfcTextLiteral {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEXT_LITERAL;
	}
	...
	public String getLiteral() {
		return (String) eGet(LogPackage.Literals.IFC_TEXT_LITERAL__LITERAL, true);
	}
	...
	public void setLiteral(String newLiteral) {
		eSet(LogPackage.Literals.IFC_TEXT_LITERAL__LITERAL, newLiteral);
	}
	...
	public IfcAxis2Placement getPlacement() {
		return (IfcAxis2Placement) eGet(LogPackage.Literals.IFC_TEXT_LITERAL__PLACEMENT, true);
	}
	...
	public void setPlacement(IfcAxis2Placement newPlacement) {
		eSet(LogPackage.Literals.IFC_TEXT_LITERAL__PLACEMENT, newPlacement);
	}
	...
	public IfcTextPath getPath() {
		return (IfcTextPath) eGet(LogPackage.Literals.IFC_TEXT_LITERAL__PATH, true);
	}
	...
	public void setPath(IfcTextPath newPath) {
		eSet(LogPackage.Literals.IFC_TEXT_LITERAL__PATH, newPath);
	}
