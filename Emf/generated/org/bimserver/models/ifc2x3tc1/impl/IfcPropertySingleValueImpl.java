...
public class IfcPropertySingleValueImpl extends IfcSimplePropertyImpl implements IfcPropertySingleValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE;
	}
	...
	public IfcValue getNominalValue() {
		return (IfcValue) eGet(LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE__NOMINAL_VALUE, true);
	}
	...
	public void setNominalValue(IfcValue newNominalValue) {
		eSet(LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE__NOMINAL_VALUE, newNominalValue);
	}
	...
	public void unsetNominalValue() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE__NOMINAL_VALUE);
	}
	...
	public boolean isSetNominalValue() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE__NOMINAL_VALUE);
	}
	...
	public IfcUnit getUnit() {
		return (IfcUnit) eGet(LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE__UNIT, true);
	}
	...
	public void setUnit(IfcUnit newUnit) {
		eSet(LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE__UNIT, newUnit);
	}
	...
	public void unsetUnit() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE__UNIT);
	}
	...
	public boolean isSetUnit() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_SINGLE_VALUE__UNIT);
	}
