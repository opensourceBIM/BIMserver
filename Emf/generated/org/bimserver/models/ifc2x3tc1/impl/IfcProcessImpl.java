...
public class IfcProcessImpl extends IfcObjectImpl implements IfcProcess {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROCESS;
	}
	...
	public EList<IfcRelAssignsToProcess> getOperatesOn() {
		return (EList<IfcRelAssignsToProcess>) eGet(LogPackage.Literals.IFC_PROCESS__OPERATES_ON, true);
	}
	...
	public void unsetOperatesOn() {
		eUnset(LogPackage.Literals.IFC_PROCESS__OPERATES_ON);
	}
	...
	public boolean isSetOperatesOn() {
		return eIsSet(LogPackage.Literals.IFC_PROCESS__OPERATES_ON);
	}
	...
	public EList<IfcRelSequence> getIsSuccessorFrom() {
		return (EList<IfcRelSequence>) eGet(LogPackage.Literals.IFC_PROCESS__IS_SUCCESSOR_FROM, true);
	}
	...
	public void unsetIsSuccessorFrom() {
		eUnset(LogPackage.Literals.IFC_PROCESS__IS_SUCCESSOR_FROM);
	}
	...
	public boolean isSetIsSuccessorFrom() {
		return eIsSet(LogPackage.Literals.IFC_PROCESS__IS_SUCCESSOR_FROM);
	}
	...
	public EList<IfcRelSequence> getIsPredecessorTo() {
		return (EList<IfcRelSequence>) eGet(LogPackage.Literals.IFC_PROCESS__IS_PREDECESSOR_TO, true);
	}
	...
	public void unsetIsPredecessorTo() {
		eUnset(LogPackage.Literals.IFC_PROCESS__IS_PREDECESSOR_TO);
	}
	...
	public boolean isSetIsPredecessorTo() {
		return eIsSet(LogPackage.Literals.IFC_PROCESS__IS_PREDECESSOR_TO);
	}
