...
public class IfcTrimmedCurveImpl extends IfcBoundedCurveImpl implements IfcTrimmedCurve {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TRIMMED_CURVE;
	}
	...
	public IfcCurve getBasisCurve() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_TRIMMED_CURVE__BASIS_CURVE, true);
	}
	...
	public void setBasisCurve(IfcCurve newBasisCurve) {
		eSet(LogPackage.Literals.IFC_TRIMMED_CURVE__BASIS_CURVE, newBasisCurve);
	}
	...
	public EList<IfcTrimmingSelect> getTrim1() {
		return (EList<IfcTrimmingSelect>) eGet(LogPackage.Literals.IFC_TRIMMED_CURVE__TRIM1, true);
	}
	...
	public EList<IfcTrimmingSelect> getTrim2() {
		return (EList<IfcTrimmingSelect>) eGet(LogPackage.Literals.IFC_TRIMMED_CURVE__TRIM2, true);
	}
	...
	public Tristate getSenseAgreement() {
		return (Tristate) eGet(LogPackage.Literals.IFC_TRIMMED_CURVE__SENSE_AGREEMENT, true);
	}
	...
	public void setSenseAgreement(Tristate newSenseAgreement) {
		eSet(LogPackage.Literals.IFC_TRIMMED_CURVE__SENSE_AGREEMENT, newSenseAgreement);
	}
	...
	public IfcTrimmingPreference getMasterRepresentation() {
		return (IfcTrimmingPreference) eGet(LogPackage.Literals.IFC_TRIMMED_CURVE__MASTER_REPRESENTATION, true);
	}
	...
	public void setMasterRepresentation(IfcTrimmingPreference newMasterRepresentation) {
		eSet(LogPackage.Literals.IFC_TRIMMED_CURVE__MASTER_REPRESENTATION, newMasterRepresentation);
	}
