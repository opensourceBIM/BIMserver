...
public class IfcRelDecomposesImpl extends IfcRelationshipImpl implements IfcRelDecomposes {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_DECOMPOSES;
	}
	...
	public IfcObjectDefinition getRelatingObject() {
		return (IfcObjectDefinition) eGet(LogPackage.Literals.IFC_REL_DECOMPOSES__RELATING_OBJECT, true);
	}
	...
	public void setRelatingObject(IfcObjectDefinition newRelatingObject) {
		eSet(LogPackage.Literals.IFC_REL_DECOMPOSES__RELATING_OBJECT, newRelatingObject);
	}
	...
	public EList<IfcObjectDefinition> getRelatedObjects() {
		return (EList<IfcObjectDefinition>) eGet(LogPackage.Literals.IFC_REL_DECOMPOSES__RELATED_OBJECTS, true);
	}
