...
public class IfcRoundedEdgeFeatureImpl extends IfcEdgeFeatureImpl implements IfcRoundedEdgeFeature {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE;
	}
	...
	public double getRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE__RADIUS, true);
	}
	...
	public void setRadius(double newRadius) {
		eSet(LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE__RADIUS, newRadius);
	}
	...
	public void unsetRadius() {
		eUnset(LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE__RADIUS);
	}
	...
	public boolean isSetRadius() {
		return eIsSet(LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE__RADIUS);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE__RADIUS_AS_STRING, true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE__RADIUS_AS_STRING, newRadiusAsString);
	}
	...
	public void unsetRadiusAsString() {
		eUnset(LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE__RADIUS_AS_STRING);
	}
	...
	public boolean isSetRadiusAsString() {
		return eIsSet(LogPackage.Literals.IFC_ROUNDED_EDGE_FEATURE__RADIUS_AS_STRING);
	}
