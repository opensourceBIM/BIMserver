...
public class IfcReinforcementDefinitionPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcReinforcementDefinitionProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES;
	}
	...
	public String getDefinitionType() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES__DEFINITION_TYPE, true);
	}
	...
	public void setDefinitionType(String newDefinitionType) {
		eSet(LogPackage.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES__DEFINITION_TYPE, newDefinitionType);
	}
	...
	public void unsetDefinitionType() {
		eUnset(LogPackage.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES__DEFINITION_TYPE);
	}
	...
	public boolean isSetDefinitionType() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES__DEFINITION_TYPE);
	}
	...
	public EList<IfcSectionReinforcementProperties> getReinforcementSectionDefinitions() {
		return (EList<IfcSectionReinforcementProperties>) eGet(LogPackage.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES__REINFORCEMENT_SECTION_DEFINITIONS, true);
	}
