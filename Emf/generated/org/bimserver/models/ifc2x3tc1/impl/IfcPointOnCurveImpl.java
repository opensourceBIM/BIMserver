...
public class IfcPointOnCurveImpl extends IfcPointImpl implements IfcPointOnCurve {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_POINT_ON_CURVE;
	}
	...
	public IfcCurve getBasisCurve() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_POINT_ON_CURVE__BASIS_CURVE, true);
	}
	...
	public void setBasisCurve(IfcCurve newBasisCurve) {
		eSet(LogPackage.Literals.IFC_POINT_ON_CURVE__BASIS_CURVE, newBasisCurve);
	}
	...
	public double getPointParameter() {
		return (Double) eGet(LogPackage.Literals.IFC_POINT_ON_CURVE__POINT_PARAMETER, true);
	}
	...
	public void setPointParameter(double newPointParameter) {
		eSet(LogPackage.Literals.IFC_POINT_ON_CURVE__POINT_PARAMETER, newPointParameter);
	}
	...
	public String getPointParameterAsString() {
		return (String) eGet(LogPackage.Literals.IFC_POINT_ON_CURVE__POINT_PARAMETER_AS_STRING, true);
	}
	...
	public void setPointParameterAsString(String newPointParameterAsString) {
		eSet(LogPackage.Literals.IFC_POINT_ON_CURVE__POINT_PARAMETER_AS_STRING, newPointParameterAsString);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_POINT_ON_CURVE__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_POINT_ON_CURVE__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_POINT_ON_CURVE__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_POINT_ON_CURVE__DIM);
	}
