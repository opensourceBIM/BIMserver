...
public class IfcConnectionPortGeometryImpl extends IfcConnectionGeometryImpl implements IfcConnectionPortGeometry {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY;
	}
	...
	public IfcAxis2Placement getLocationAtRelatingElement() {
		return (IfcAxis2Placement) eGet(LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY__LOCATION_AT_RELATING_ELEMENT, true);
	}
	...
	public void setLocationAtRelatingElement(IfcAxis2Placement newLocationAtRelatingElement) {
		eSet(LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY__LOCATION_AT_RELATING_ELEMENT, newLocationAtRelatingElement);
	}
	...
	public IfcAxis2Placement getLocationAtRelatedElement() {
		return (IfcAxis2Placement) eGet(LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY__LOCATION_AT_RELATED_ELEMENT, true);
	}
	...
	public void setLocationAtRelatedElement(IfcAxis2Placement newLocationAtRelatedElement) {
		eSet(LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY__LOCATION_AT_RELATED_ELEMENT, newLocationAtRelatedElement);
	}
	...
	public void unsetLocationAtRelatedElement() {
		eUnset(LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY__LOCATION_AT_RELATED_ELEMENT);
	}
	...
	public boolean isSetLocationAtRelatedElement() {
		return eIsSet(LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY__LOCATION_AT_RELATED_ELEMENT);
	}
	...
	public IfcProfileDef getProfileOfPort() {
		return (IfcProfileDef) eGet(LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY__PROFILE_OF_PORT, true);
	}
	...
	public void setProfileOfPort(IfcProfileDef newProfileOfPort) {
		eSet(LogPackage.Literals.IFC_CONNECTION_PORT_GEOMETRY__PROFILE_OF_PORT, newProfileOfPort);
	}
