...
public class IfcServiceLifeImpl extends IfcControlImpl implements IfcServiceLife {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SERVICE_LIFE;
	}
	...
	public IfcServiceLifeTypeEnum getServiceLifeType() {
		return (IfcServiceLifeTypeEnum) eGet(LogPackage.Literals.IFC_SERVICE_LIFE__SERVICE_LIFE_TYPE, true);
	}
	...
	public void setServiceLifeType(IfcServiceLifeTypeEnum newServiceLifeType) {
		eSet(LogPackage.Literals.IFC_SERVICE_LIFE__SERVICE_LIFE_TYPE, newServiceLifeType);
	}
	...
	public double getServiceLifeDuration() {
		return (Double) eGet(LogPackage.Literals.IFC_SERVICE_LIFE__SERVICE_LIFE_DURATION, true);
	}
	...
	public void setServiceLifeDuration(double newServiceLifeDuration) {
		eSet(LogPackage.Literals.IFC_SERVICE_LIFE__SERVICE_LIFE_DURATION, newServiceLifeDuration);
	}
	...
	public String getServiceLifeDurationAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SERVICE_LIFE__SERVICE_LIFE_DURATION_AS_STRING, true);
	}
	...
	public void setServiceLifeDurationAsString(String newServiceLifeDurationAsString) {
		eSet(LogPackage.Literals.IFC_SERVICE_LIFE__SERVICE_LIFE_DURATION_AS_STRING, newServiceLifeDurationAsString);
	}
