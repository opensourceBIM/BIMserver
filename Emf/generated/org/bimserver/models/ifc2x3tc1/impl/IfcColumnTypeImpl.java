...
public class IfcColumnTypeImpl extends IfcBuildingElementTypeImpl implements IfcColumnType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_COLUMN_TYPE;
	}
	...
	public IfcColumnTypeEnum getPredefinedType() {
		return (IfcColumnTypeEnum) eGet(LogPackage.Literals.IFC_COLUMN_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcColumnTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_COLUMN_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
