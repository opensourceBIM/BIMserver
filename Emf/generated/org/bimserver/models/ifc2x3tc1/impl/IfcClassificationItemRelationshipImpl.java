...
public class IfcClassificationItemRelationshipImpl extends IdEObjectImpl implements IfcClassificationItemRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CLASSIFICATION_ITEM_RELATIONSHIP;
	}
	...
	public IfcClassificationItem getRelatingItem() {
		return (IfcClassificationItem) eGet(LogPackage.Literals.IFC_CLASSIFICATION_ITEM_RELATIONSHIP__RELATING_ITEM, true);
	}
	...
	public void setRelatingItem(IfcClassificationItem newRelatingItem) {
		eSet(LogPackage.Literals.IFC_CLASSIFICATION_ITEM_RELATIONSHIP__RELATING_ITEM, newRelatingItem);
	}
	...
	public EList<IfcClassificationItem> getRelatedItems() {
		return (EList<IfcClassificationItem>) eGet(LogPackage.Literals.IFC_CLASSIFICATION_ITEM_RELATIONSHIP__RELATED_ITEMS, true);
	}
