...
public class IfcActorImpl extends IfcObjectImpl implements IfcActor {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ACTOR;
	}
	...
	public IfcActorSelect getTheActor() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_ACTOR__THE_ACTOR, true);
	}
	...
	public void setTheActor(IfcActorSelect newTheActor) {
		eSet(LogPackage.Literals.IFC_ACTOR__THE_ACTOR, newTheActor);
	}
	...
	public EList<IfcRelAssignsToActor> getIsActingUpon() {
		return (EList<IfcRelAssignsToActor>) eGet(LogPackage.Literals.IFC_ACTOR__IS_ACTING_UPON, true);
	}
	...
	public void unsetIsActingUpon() {
		eUnset(LogPackage.Literals.IFC_ACTOR__IS_ACTING_UPON);
	}
	...
	public boolean isSetIsActingUpon() {
		return eIsSet(LogPackage.Literals.IFC_ACTOR__IS_ACTING_UPON);
	}
