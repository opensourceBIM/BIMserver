...
public class IfcCurveStyleFontImpl extends IdEObjectImpl implements IfcCurveStyleFont {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CURVE_STYLE_FONT;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_CURVE_STYLE_FONT__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT__NAME);
	}
	...
	public EList<IfcCurveStyleFontPattern> getPatternList() {
		return (EList<IfcCurveStyleFontPattern>) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT__PATTERN_LIST, true);
	}
