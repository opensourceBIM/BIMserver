...
public class IfcElectricDistributionPointImpl extends IfcFlowControllerImpl implements IfcElectricDistributionPoint {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ELECTRIC_DISTRIBUTION_POINT;
	}
	...
	public IfcElectricDistributionPointFunctionEnum getDistributionPointFunction() {
		return (IfcElectricDistributionPointFunctionEnum) eGet(LogPackage.Literals.IFC_ELECTRIC_DISTRIBUTION_POINT__DISTRIBUTION_POINT_FUNCTION, true);
	}
	...
	public void setDistributionPointFunction(IfcElectricDistributionPointFunctionEnum newDistributionPointFunction) {
		eSet(LogPackage.Literals.IFC_ELECTRIC_DISTRIBUTION_POINT__DISTRIBUTION_POINT_FUNCTION, newDistributionPointFunction);
	}
	...
	public String getUserDefinedFunction() {
		return (String) eGet(LogPackage.Literals.IFC_ELECTRIC_DISTRIBUTION_POINT__USER_DEFINED_FUNCTION, true);
	}
	...
	public void setUserDefinedFunction(String newUserDefinedFunction) {
		eSet(LogPackage.Literals.IFC_ELECTRIC_DISTRIBUTION_POINT__USER_DEFINED_FUNCTION, newUserDefinedFunction);
	}
	...
	public void unsetUserDefinedFunction() {
		eUnset(LogPackage.Literals.IFC_ELECTRIC_DISTRIBUTION_POINT__USER_DEFINED_FUNCTION);
	}
	...
	public boolean isSetUserDefinedFunction() {
		return eIsSet(LogPackage.Literals.IFC_ELECTRIC_DISTRIBUTION_POINT__USER_DEFINED_FUNCTION);
	}
