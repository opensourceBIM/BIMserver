...
public class IfcQuantityAreaImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityArea {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_QUANTITY_AREA;
	}
	...
	public double getAreaValue() {
		return (Double) eGet(LogPackage.Literals.IFC_QUANTITY_AREA__AREA_VALUE, true);
	}
	...
	public void setAreaValue(double newAreaValue) {
		eSet(LogPackage.Literals.IFC_QUANTITY_AREA__AREA_VALUE, newAreaValue);
	}
	...
	public String getAreaValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_QUANTITY_AREA__AREA_VALUE_AS_STRING, true);
	}
	...
	public void setAreaValueAsString(String newAreaValueAsString) {
		eSet(LogPackage.Literals.IFC_QUANTITY_AREA__AREA_VALUE_AS_STRING, newAreaValueAsString);
	}
