...
public class IfcMaterialLayerImpl extends IdEObjectImpl implements IfcMaterialLayer {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MATERIAL_LAYER;
	}
	...
	public IfcMaterial getMaterial() {
		return (IfcMaterial) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER__MATERIAL, true);
	}
	...
	public void setMaterial(IfcMaterial newMaterial) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER__MATERIAL, newMaterial);
	}
	...
	public void unsetMaterial() {
		eUnset(LogPackage.Literals.IFC_MATERIAL_LAYER__MATERIAL);
	}
	...
	public boolean isSetMaterial() {
		return eIsSet(LogPackage.Literals.IFC_MATERIAL_LAYER__MATERIAL);
	}
	...
	public double getLayerThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER__LAYER_THICKNESS, true);
	}
	...
	public void setLayerThickness(double newLayerThickness) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER__LAYER_THICKNESS, newLayerThickness);
	}
	...
	public String getLayerThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER__LAYER_THICKNESS_AS_STRING, true);
	}
	...
	public void setLayerThicknessAsString(String newLayerThicknessAsString) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER__LAYER_THICKNESS_AS_STRING, newLayerThicknessAsString);
	}
	...
	public Tristate getIsVentilated() {
		return (Tristate) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER__IS_VENTILATED, true);
	}
	...
	public void setIsVentilated(Tristate newIsVentilated) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER__IS_VENTILATED, newIsVentilated);
	}
	...
	public void unsetIsVentilated() {
		eUnset(LogPackage.Literals.IFC_MATERIAL_LAYER__IS_VENTILATED);
	}
	...
	public boolean isSetIsVentilated() {
		return eIsSet(LogPackage.Literals.IFC_MATERIAL_LAYER__IS_VENTILATED);
	}
	...
	public IfcMaterialLayerSet getToMaterialLayerSet() {
		return (IfcMaterialLayerSet) eGet(LogPackage.Literals.IFC_MATERIAL_LAYER__TO_MATERIAL_LAYER_SET, true);
	}
	...
	public void setToMaterialLayerSet(IfcMaterialLayerSet newToMaterialLayerSet) {
		eSet(LogPackage.Literals.IFC_MATERIAL_LAYER__TO_MATERIAL_LAYER_SET, newToMaterialLayerSet);
	}
	...
	public void unsetToMaterialLayerSet() {
		eUnset(LogPackage.Literals.IFC_MATERIAL_LAYER__TO_MATERIAL_LAYER_SET);
	}
	...
	public boolean isSetToMaterialLayerSet() {
		return eIsSet(LogPackage.Literals.IFC_MATERIAL_LAYER__TO_MATERIAL_LAYER_SET);
	}
