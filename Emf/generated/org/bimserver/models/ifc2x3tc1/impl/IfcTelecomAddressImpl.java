...
public class IfcTelecomAddressImpl extends IfcAddressImpl implements IfcTelecomAddress {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TELECOM_ADDRESS;
	}
	...
	public EList<String> getTelephoneNumbers() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_TELECOM_ADDRESS__TELEPHONE_NUMBERS, true);
	}
	...
	public void unsetTelephoneNumbers() {
		eUnset(LogPackage.Literals.IFC_TELECOM_ADDRESS__TELEPHONE_NUMBERS);
	}
	...
	public boolean isSetTelephoneNumbers() {
		return eIsSet(LogPackage.Literals.IFC_TELECOM_ADDRESS__TELEPHONE_NUMBERS);
	}
	...
	public EList<String> getFacsimileNumbers() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_TELECOM_ADDRESS__FACSIMILE_NUMBERS, true);
	}
	...
	public void unsetFacsimileNumbers() {
		eUnset(LogPackage.Literals.IFC_TELECOM_ADDRESS__FACSIMILE_NUMBERS);
	}
	...
	public boolean isSetFacsimileNumbers() {
		return eIsSet(LogPackage.Literals.IFC_TELECOM_ADDRESS__FACSIMILE_NUMBERS);
	}
	...
	public String getPagerNumber() {
		return (String) eGet(LogPackage.Literals.IFC_TELECOM_ADDRESS__PAGER_NUMBER, true);
	}
	...
	public void setPagerNumber(String newPagerNumber) {
		eSet(LogPackage.Literals.IFC_TELECOM_ADDRESS__PAGER_NUMBER, newPagerNumber);
	}
	...
	public void unsetPagerNumber() {
		eUnset(LogPackage.Literals.IFC_TELECOM_ADDRESS__PAGER_NUMBER);
	}
	...
	public boolean isSetPagerNumber() {
		return eIsSet(LogPackage.Literals.IFC_TELECOM_ADDRESS__PAGER_NUMBER);
	}
	...
	public EList<String> getElectronicMailAddresses() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_TELECOM_ADDRESS__ELECTRONIC_MAIL_ADDRESSES, true);
	}
	...
	public void unsetElectronicMailAddresses() {
		eUnset(LogPackage.Literals.IFC_TELECOM_ADDRESS__ELECTRONIC_MAIL_ADDRESSES);
	}
	...
	public boolean isSetElectronicMailAddresses() {
		return eIsSet(LogPackage.Literals.IFC_TELECOM_ADDRESS__ELECTRONIC_MAIL_ADDRESSES);
	}
	...
	public String getWWWHomePageURL() {
		return (String) eGet(LogPackage.Literals.IFC_TELECOM_ADDRESS__WWW_HOME_PAGE_URL, true);
	}
	...
	public void setWWWHomePageURL(String newWWWHomePageURL) {
		eSet(LogPackage.Literals.IFC_TELECOM_ADDRESS__WWW_HOME_PAGE_URL, newWWWHomePageURL);
	}
	...
	public void unsetWWWHomePageURL() {
		eUnset(LogPackage.Literals.IFC_TELECOM_ADDRESS__WWW_HOME_PAGE_URL);
	}
	...
	public boolean isSetWWWHomePageURL() {
		return eIsSet(LogPackage.Literals.IFC_TELECOM_ADDRESS__WWW_HOME_PAGE_URL);
	}
