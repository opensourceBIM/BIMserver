...
public class IfcTimeSeriesReferenceRelationshipImpl extends IdEObjectImpl implements IfcTimeSeriesReferenceRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TIME_SERIES_REFERENCE_RELATIONSHIP;
	}
	...
	public IfcTimeSeries getReferencedTimeSeries() {
		return (IfcTimeSeries) eGet(LogPackage.Literals.IFC_TIME_SERIES_REFERENCE_RELATIONSHIP__REFERENCED_TIME_SERIES, true);
	}
	...
	public void setReferencedTimeSeries(IfcTimeSeries newReferencedTimeSeries) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES_REFERENCE_RELATIONSHIP__REFERENCED_TIME_SERIES, newReferencedTimeSeries);
	}
	...
	public EList<IfcDocumentSelect> getTimeSeriesReferences() {
		return (EList<IfcDocumentSelect>) eGet(LogPackage.Literals.IFC_TIME_SERIES_REFERENCE_RELATIONSHIP__TIME_SERIES_REFERENCES, true);
	}
