...
public class IfcMappedItemImpl extends IfcRepresentationItemImpl implements IfcMappedItem {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MAPPED_ITEM;
	}
	...
	public IfcRepresentationMap getMappingSource() {
		return (IfcRepresentationMap) eGet(LogPackage.Literals.IFC_MAPPED_ITEM__MAPPING_SOURCE, true);
	}
	...
	public void setMappingSource(IfcRepresentationMap newMappingSource) {
		eSet(LogPackage.Literals.IFC_MAPPED_ITEM__MAPPING_SOURCE, newMappingSource);
	}
	...
	public IfcCartesianTransformationOperator getMappingTarget() {
		return (IfcCartesianTransformationOperator) eGet(LogPackage.Literals.IFC_MAPPED_ITEM__MAPPING_TARGET, true);
	}
	...
	public void setMappingTarget(IfcCartesianTransformationOperator newMappingTarget) {
		eSet(LogPackage.Literals.IFC_MAPPED_ITEM__MAPPING_TARGET, newMappingTarget);
	}
