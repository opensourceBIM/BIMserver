...
public class IfcRelDefinesByTypeImpl extends IfcRelDefinesImpl implements IfcRelDefinesByType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_DEFINES_BY_TYPE;
	}
	...
	public IfcTypeObject getRelatingType() {
		return (IfcTypeObject) eGet(LogPackage.Literals.IFC_REL_DEFINES_BY_TYPE__RELATING_TYPE, true);
	}
	...
	public void setRelatingType(IfcTypeObject newRelatingType) {
		eSet(LogPackage.Literals.IFC_REL_DEFINES_BY_TYPE__RELATING_TYPE, newRelatingType);
	}
