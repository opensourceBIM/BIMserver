...
public class IfcPropertySetDefinitionImpl extends IfcPropertyDefinitionImpl implements IfcPropertySetDefinition {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROPERTY_SET_DEFINITION;
	}
	...
	public EList<IfcRelDefinesByProperties> getPropertyDefinitionOf() {
		return (EList<IfcRelDefinesByProperties>) eGet(LogPackage.Literals.IFC_PROPERTY_SET_DEFINITION__PROPERTY_DEFINITION_OF, true);
	}
	...
	public void unsetPropertyDefinitionOf() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_SET_DEFINITION__PROPERTY_DEFINITION_OF);
	}
	...
	public boolean isSetPropertyDefinitionOf() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_SET_DEFINITION__PROPERTY_DEFINITION_OF);
	}
	...
	public EList<IfcTypeObject> getDefinesType() {
		return (EList<IfcTypeObject>) eGet(LogPackage.Literals.IFC_PROPERTY_SET_DEFINITION__DEFINES_TYPE, true);
	}
	...
	public void unsetDefinesType() {
		eUnset(LogPackage.Literals.IFC_PROPERTY_SET_DEFINITION__DEFINES_TYPE);
	}
	...
	public boolean isSetDefinesType() {
		return eIsSet(LogPackage.Literals.IFC_PROPERTY_SET_DEFINITION__DEFINES_TYPE);
	}
