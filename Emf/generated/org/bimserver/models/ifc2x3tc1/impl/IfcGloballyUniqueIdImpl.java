...
public class IfcGloballyUniqueIdImpl extends WrappedValueImpl implements IfcGloballyUniqueId {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_GLOBALLY_UNIQUE_ID;
	}
	...
	public String getWrappedValue() {
		return (String) eGet(LogPackage.Literals.IFC_GLOBALLY_UNIQUE_ID__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(String newWrappedValue) {
		eSet(LogPackage.Literals.IFC_GLOBALLY_UNIQUE_ID__WRAPPED_VALUE, newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(LogPackage.Literals.IFC_GLOBALLY_UNIQUE_ID__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(LogPackage.Literals.IFC_GLOBALLY_UNIQUE_ID__WRAPPED_VALUE);
	}
	...
	public IfcRoot getIfcRoot() {
		return (IfcRoot) eGet(LogPackage.Literals.IFC_GLOBALLY_UNIQUE_ID__IFC_ROOT, true);
	}
	...
	public void setIfcRoot(IfcRoot newIfcRoot) {
		eSet(LogPackage.Literals.IFC_GLOBALLY_UNIQUE_ID__IFC_ROOT, newIfcRoot);
	}
