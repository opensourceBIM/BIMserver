...
public class IfcCurrencyRelationshipImpl extends IdEObjectImpl implements IfcCurrencyRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP;
	}
	...
	public IfcMonetaryUnit getRelatingMonetaryUnit() {
		return (IfcMonetaryUnit) eGet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RELATING_MONETARY_UNIT, true);
	}
	...
	public void setRelatingMonetaryUnit(IfcMonetaryUnit newRelatingMonetaryUnit) {
		eSet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RELATING_MONETARY_UNIT, newRelatingMonetaryUnit);
	}
	...
	public IfcMonetaryUnit getRelatedMonetaryUnit() {
		return (IfcMonetaryUnit) eGet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RELATED_MONETARY_UNIT, true);
	}
	...
	public void setRelatedMonetaryUnit(IfcMonetaryUnit newRelatedMonetaryUnit) {
		eSet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RELATED_MONETARY_UNIT, newRelatedMonetaryUnit);
	}
	...
	public double getExchangeRate() {
		return (Double) eGet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__EXCHANGE_RATE, true);
	}
	...
	public void setExchangeRate(double newExchangeRate) {
		eSet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__EXCHANGE_RATE, newExchangeRate);
	}
	...
	public String getExchangeRateAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__EXCHANGE_RATE_AS_STRING, true);
	}
	...
	public void setExchangeRateAsString(String newExchangeRateAsString) {
		eSet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__EXCHANGE_RATE_AS_STRING, newExchangeRateAsString);
	}
	...
	public IfcDateAndTime getRateDateTime() {
		return (IfcDateAndTime) eGet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_DATE_TIME, true);
	}
	...
	public void setRateDateTime(IfcDateAndTime newRateDateTime) {
		eSet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_DATE_TIME, newRateDateTime);
	}
	...
	public IfcLibraryInformation getRateSource() {
		return (IfcLibraryInformation) eGet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_SOURCE, true);
	}
	...
	public void setRateSource(IfcLibraryInformation newRateSource) {
		eSet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_SOURCE, newRateSource);
	}
	...
	public void unsetRateSource() {
		eUnset(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_SOURCE);
	}
	...
	public boolean isSetRateSource() {
		return eIsSet(LogPackage.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_SOURCE);
	}
