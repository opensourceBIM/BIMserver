...
public class IfcCenterLineProfileDefImpl extends IfcArbitraryOpenProfileDefImpl implements IfcCenterLineProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CENTER_LINE_PROFILE_DEF;
	}
	...
	public double getThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_CENTER_LINE_PROFILE_DEF__THICKNESS, true);
	}
	...
	public void setThickness(double newThickness) {
		eSet(LogPackage.Literals.IFC_CENTER_LINE_PROFILE_DEF__THICKNESS, newThickness);
	}
	...
	public String getThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CENTER_LINE_PROFILE_DEF__THICKNESS_AS_STRING, true);
	}
	...
	public void setThicknessAsString(String newThicknessAsString) {
		eSet(LogPackage.Literals.IFC_CENTER_LINE_PROFILE_DEF__THICKNESS_AS_STRING, newThicknessAsString);
	}
