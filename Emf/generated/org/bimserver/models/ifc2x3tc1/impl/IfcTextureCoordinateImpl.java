...
public class IfcTextureCoordinateImpl extends IdEObjectImpl implements IfcTextureCoordinate {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEXTURE_COORDINATE;
	}
	...
	public EList<IfcAnnotationSurface> getAnnotatedSurface() {
		return (EList<IfcAnnotationSurface>) eGet(LogPackage.Literals.IFC_TEXTURE_COORDINATE__ANNOTATED_SURFACE, true);
	}
	...
	public void unsetAnnotatedSurface() {
		eUnset(LogPackage.Literals.IFC_TEXTURE_COORDINATE__ANNOTATED_SURFACE);
	}
	...
	public boolean isSetAnnotatedSurface() {
		return eIsSet(LogPackage.Literals.IFC_TEXTURE_COORDINATE__ANNOTATED_SURFACE);
	}
