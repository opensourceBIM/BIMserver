...
public class IfcStructuralResultGroupImpl extends IfcGroupImpl implements IfcStructuralResultGroup {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP;
	}
	...
	public IfcAnalysisTheoryTypeEnum getTheoryType() {
		return (IfcAnalysisTheoryTypeEnum) eGet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__THEORY_TYPE, true);
	}
	...
	public void setTheoryType(IfcAnalysisTheoryTypeEnum newTheoryType) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__THEORY_TYPE, newTheoryType);
	}
	...
	public IfcStructuralLoadGroup getResultForLoadGroup() {
		return (IfcStructuralLoadGroup) eGet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__RESULT_FOR_LOAD_GROUP, true);
	}
	...
	public void setResultForLoadGroup(IfcStructuralLoadGroup newResultForLoadGroup) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__RESULT_FOR_LOAD_GROUP, newResultForLoadGroup);
	}
	...
	public void unsetResultForLoadGroup() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__RESULT_FOR_LOAD_GROUP);
	}
	...
	public boolean isSetResultForLoadGroup() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__RESULT_FOR_LOAD_GROUP);
	}
	...
	public Tristate getIsLinear() {
		return (Tristate) eGet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__IS_LINEAR, true);
	}
	...
	public void setIsLinear(Tristate newIsLinear) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__IS_LINEAR, newIsLinear);
	}
	...
	public EList<IfcStructuralAnalysisModel> getResultGroupFor() {
		return (EList<IfcStructuralAnalysisModel>) eGet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__RESULT_GROUP_FOR, true);
	}
	...
	public void unsetResultGroupFor() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__RESULT_GROUP_FOR);
	}
	...
	public boolean isSetResultGroupFor() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_RESULT_GROUP__RESULT_GROUP_FOR);
	}
