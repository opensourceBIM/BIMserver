...
public class IfcFaceSurfaceImpl extends IfcFaceImpl implements IfcFaceSurface {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FACE_SURFACE;
	}
	...
	public IfcSurface getFaceSurface() {
		return (IfcSurface) eGet(LogPackage.Literals.IFC_FACE_SURFACE__FACE_SURFACE, true);
	}
	...
	public void setFaceSurface(IfcSurface newFaceSurface) {
		eSet(LogPackage.Literals.IFC_FACE_SURFACE__FACE_SURFACE, newFaceSurface);
	}
	...
	public Tristate getSameSense() {
		return (Tristate) eGet(LogPackage.Literals.IFC_FACE_SURFACE__SAME_SENSE, true);
	}
	...
	public void setSameSense(Tristate newSameSense) {
		eSet(LogPackage.Literals.IFC_FACE_SURFACE__SAME_SENSE, newSameSense);
	}
