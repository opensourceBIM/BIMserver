...
public class IfcRelAssignsToProcessImpl extends IfcRelAssignsImpl implements IfcRelAssignsToProcess {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSIGNS_TO_PROCESS;
	}
	...
	public IfcProcess getRelatingProcess() {
		return (IfcProcess) eGet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_PROCESS__RELATING_PROCESS, true);
	}
	...
	public void setRelatingProcess(IfcProcess newRelatingProcess) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_PROCESS__RELATING_PROCESS, newRelatingProcess);
	}
	...
	public IfcMeasureWithUnit getQuantityInProcess() {
		return (IfcMeasureWithUnit) eGet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_PROCESS__QUANTITY_IN_PROCESS, true);
	}
	...
	public void setQuantityInProcess(IfcMeasureWithUnit newQuantityInProcess) {
		eSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_PROCESS__QUANTITY_IN_PROCESS, newQuantityInProcess);
	}
	...
	public void unsetQuantityInProcess() {
		eUnset(LogPackage.Literals.IFC_REL_ASSIGNS_TO_PROCESS__QUANTITY_IN_PROCESS);
	}
	...
	public boolean isSetQuantityInProcess() {
		return eIsSet(LogPackage.Literals.IFC_REL_ASSIGNS_TO_PROCESS__QUANTITY_IN_PROCESS);
	}
