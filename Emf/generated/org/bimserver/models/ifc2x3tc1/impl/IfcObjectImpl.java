...
public class IfcObjectImpl extends IfcObjectDefinitionImpl implements IfcObject {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_OBJECT;
	}
	...
	public String getObjectType() {
		return (String) eGet(LogPackage.Literals.IFC_OBJECT__OBJECT_TYPE, true);
	}
	...
	public void setObjectType(String newObjectType) {
		eSet(LogPackage.Literals.IFC_OBJECT__OBJECT_TYPE, newObjectType);
	}
	...
	public void unsetObjectType() {
		eUnset(LogPackage.Literals.IFC_OBJECT__OBJECT_TYPE);
	}
	...
	public boolean isSetObjectType() {
		return eIsSet(LogPackage.Literals.IFC_OBJECT__OBJECT_TYPE);
	}
	...
	public EList<IfcRelDefines> getIsDefinedBy() {
		return (EList<IfcRelDefines>) eGet(LogPackage.Literals.IFC_OBJECT__IS_DEFINED_BY, true);
	}
	...
	public void unsetIsDefinedBy() {
		eUnset(LogPackage.Literals.IFC_OBJECT__IS_DEFINED_BY);
	}
	...
	public boolean isSetIsDefinedBy() {
		return eIsSet(LogPackage.Literals.IFC_OBJECT__IS_DEFINED_BY);
	}
