...
public class IfcConicImpl extends IfcCurveImpl implements IfcConic {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONIC;
	}
	...
	public IfcAxis2Placement getPosition() {
		return (IfcAxis2Placement) eGet(LogPackage.Literals.IFC_CONIC__POSITION, true);
	}
	...
	public void setPosition(IfcAxis2Placement newPosition) {
		eSet(LogPackage.Literals.IFC_CONIC__POSITION, newPosition);
	}
