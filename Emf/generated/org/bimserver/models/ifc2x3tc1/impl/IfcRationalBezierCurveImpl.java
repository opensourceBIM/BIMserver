...
public class IfcRationalBezierCurveImpl extends IfcBezierCurveImpl implements IfcRationalBezierCurve {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RATIONAL_BEZIER_CURVE;
	}
	...
	public EList<Double> getWeightsData() {
		return (EList<Double>) eGet(LogPackage.Literals.IFC_RATIONAL_BEZIER_CURVE__WEIGHTS_DATA, true);
	}
	...
	public EList<String> getWeightsDataAsString() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_RATIONAL_BEZIER_CURVE__WEIGHTS_DATA_AS_STRING, true);
	}
