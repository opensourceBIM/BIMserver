...
public class IfcBoundingBoxImpl extends IfcGeometricRepresentationItemImpl implements IfcBoundingBox {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_BOUNDING_BOX;
	}
	...
	public IfcCartesianPoint getCorner() {
		return (IfcCartesianPoint) eGet(LogPackage.Literals.IFC_BOUNDING_BOX__CORNER, true);
	}
	...
	public void setCorner(IfcCartesianPoint newCorner) {
		eSet(LogPackage.Literals.IFC_BOUNDING_BOX__CORNER, newCorner);
	}
	...
	public double getXDim() {
		return (Double) eGet(LogPackage.Literals.IFC_BOUNDING_BOX__XDIM, true);
	}
	...
	public void setXDim(double newXDim) {
		eSet(LogPackage.Literals.IFC_BOUNDING_BOX__XDIM, newXDim);
	}
	...
	public String getXDimAsString() {
		return (String) eGet(LogPackage.Literals.IFC_BOUNDING_BOX__XDIM_AS_STRING, true);
	}
	...
	public void setXDimAsString(String newXDimAsString) {
		eSet(LogPackage.Literals.IFC_BOUNDING_BOX__XDIM_AS_STRING, newXDimAsString);
	}
	...
	public double getYDim() {
		return (Double) eGet(LogPackage.Literals.IFC_BOUNDING_BOX__YDIM, true);
	}
	...
	public void setYDim(double newYDim) {
		eSet(LogPackage.Literals.IFC_BOUNDING_BOX__YDIM, newYDim);
	}
	...
	public String getYDimAsString() {
		return (String) eGet(LogPackage.Literals.IFC_BOUNDING_BOX__YDIM_AS_STRING, true);
	}
	...
	public void setYDimAsString(String newYDimAsString) {
		eSet(LogPackage.Literals.IFC_BOUNDING_BOX__YDIM_AS_STRING, newYDimAsString);
	}
	...
	public double getZDim() {
		return (Double) eGet(LogPackage.Literals.IFC_BOUNDING_BOX__ZDIM, true);
	}
	...
	public void setZDim(double newZDim) {
		eSet(LogPackage.Literals.IFC_BOUNDING_BOX__ZDIM, newZDim);
	}
	...
	public String getZDimAsString() {
		return (String) eGet(LogPackage.Literals.IFC_BOUNDING_BOX__ZDIM_AS_STRING, true);
	}
	...
	public void setZDimAsString(String newZDimAsString) {
		eSet(LogPackage.Literals.IFC_BOUNDING_BOX__ZDIM_AS_STRING, newZDimAsString);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_BOUNDING_BOX__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_BOUNDING_BOX__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_BOUNDING_BOX__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_BOUNDING_BOX__DIM);
	}
