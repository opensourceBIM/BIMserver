...
public class IfcDoorImpl extends IfcBuildingElementImpl implements IfcDoor {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DOOR;
	}
	...
	public double getOverallHeight() {
		return (Double) eGet(LogPackage.Literals.IFC_DOOR__OVERALL_HEIGHT, true);
	}
	...
	public void setOverallHeight(double newOverallHeight) {
		eSet(LogPackage.Literals.IFC_DOOR__OVERALL_HEIGHT, newOverallHeight);
	}
	...
	public void unsetOverallHeight() {
		eUnset(LogPackage.Literals.IFC_DOOR__OVERALL_HEIGHT);
	}
	...
	public boolean isSetOverallHeight() {
		return eIsSet(LogPackage.Literals.IFC_DOOR__OVERALL_HEIGHT);
	}
	...
	public String getOverallHeightAsString() {
		return (String) eGet(LogPackage.Literals.IFC_DOOR__OVERALL_HEIGHT_AS_STRING, true);
	}
	...
	public void setOverallHeightAsString(String newOverallHeightAsString) {
		eSet(LogPackage.Literals.IFC_DOOR__OVERALL_HEIGHT_AS_STRING, newOverallHeightAsString);
	}
	...
	public void unsetOverallHeightAsString() {
		eUnset(LogPackage.Literals.IFC_DOOR__OVERALL_HEIGHT_AS_STRING);
	}
	...
	public boolean isSetOverallHeightAsString() {
		return eIsSet(LogPackage.Literals.IFC_DOOR__OVERALL_HEIGHT_AS_STRING);
	}
	...
	public double getOverallWidth() {
		return (Double) eGet(LogPackage.Literals.IFC_DOOR__OVERALL_WIDTH, true);
	}
	...
	public void setOverallWidth(double newOverallWidth) {
		eSet(LogPackage.Literals.IFC_DOOR__OVERALL_WIDTH, newOverallWidth);
	}
	...
	public void unsetOverallWidth() {
		eUnset(LogPackage.Literals.IFC_DOOR__OVERALL_WIDTH);
	}
	...
	public boolean isSetOverallWidth() {
		return eIsSet(LogPackage.Literals.IFC_DOOR__OVERALL_WIDTH);
	}
	...
	public String getOverallWidthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_DOOR__OVERALL_WIDTH_AS_STRING, true);
	}
	...
	public void setOverallWidthAsString(String newOverallWidthAsString) {
		eSet(LogPackage.Literals.IFC_DOOR__OVERALL_WIDTH_AS_STRING, newOverallWidthAsString);
	}
	...
	public void unsetOverallWidthAsString() {
		eUnset(LogPackage.Literals.IFC_DOOR__OVERALL_WIDTH_AS_STRING);
	}
	...
	public boolean isSetOverallWidthAsString() {
		return eIsSet(LogPackage.Literals.IFC_DOOR__OVERALL_WIDTH_AS_STRING);
	}
