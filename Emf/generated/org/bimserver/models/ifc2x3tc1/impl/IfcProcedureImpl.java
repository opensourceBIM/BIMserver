...
public class IfcProcedureImpl extends IfcProcessImpl implements IfcProcedure {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROCEDURE;
	}
	...
	public String getProcedureID() {
		return (String) eGet(LogPackage.Literals.IFC_PROCEDURE__PROCEDURE_ID, true);
	}
	...
	public void setProcedureID(String newProcedureID) {
		eSet(LogPackage.Literals.IFC_PROCEDURE__PROCEDURE_ID, newProcedureID);
	}
	...
	public IfcProcedureTypeEnum getProcedureType() {
		return (IfcProcedureTypeEnum) eGet(LogPackage.Literals.IFC_PROCEDURE__PROCEDURE_TYPE, true);
	}
	...
	public void setProcedureType(IfcProcedureTypeEnum newProcedureType) {
		eSet(LogPackage.Literals.IFC_PROCEDURE__PROCEDURE_TYPE, newProcedureType);
	}
	...
	public String getUserDefinedProcedureType() {
		return (String) eGet(LogPackage.Literals.IFC_PROCEDURE__USER_DEFINED_PROCEDURE_TYPE, true);
	}
	...
	public void setUserDefinedProcedureType(String newUserDefinedProcedureType) {
		eSet(LogPackage.Literals.IFC_PROCEDURE__USER_DEFINED_PROCEDURE_TYPE, newUserDefinedProcedureType);
	}
	...
	public void unsetUserDefinedProcedureType() {
		eUnset(LogPackage.Literals.IFC_PROCEDURE__USER_DEFINED_PROCEDURE_TYPE);
	}
	...
	public boolean isSetUserDefinedProcedureType() {
		return eIsSet(LogPackage.Literals.IFC_PROCEDURE__USER_DEFINED_PROCEDURE_TYPE);
	}
