...
public class IfcTableRowImpl extends IdEObjectImpl implements IfcTableRow {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TABLE_ROW;
	}
	...
	public EList<IfcValue> getRowCells() {
		return (EList<IfcValue>) eGet(LogPackage.Literals.IFC_TABLE_ROW__ROW_CELLS, true);
	}
	...
	public Tristate getIsHeading() {
		return (Tristate) eGet(LogPackage.Literals.IFC_TABLE_ROW__IS_HEADING, true);
	}
	...
	public void setIsHeading(Tristate newIsHeading) {
		eSet(LogPackage.Literals.IFC_TABLE_ROW__IS_HEADING, newIsHeading);
	}
	...
	public IfcTable getOfTable() {
		return (IfcTable) eGet(LogPackage.Literals.IFC_TABLE_ROW__OF_TABLE, true);
	}
	...
	public void setOfTable(IfcTable newOfTable) {
		eSet(LogPackage.Literals.IFC_TABLE_ROW__OF_TABLE, newOfTable);
	}
	...
	public void unsetOfTable() {
		eUnset(LogPackage.Literals.IFC_TABLE_ROW__OF_TABLE);
	}
	...
	public boolean isSetOfTable() {
		return eIsSet(LogPackage.Literals.IFC_TABLE_ROW__OF_TABLE);
	}
