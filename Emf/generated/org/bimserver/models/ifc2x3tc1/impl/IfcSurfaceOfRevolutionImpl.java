...
public class IfcSurfaceOfRevolutionImpl extends IfcSweptSurfaceImpl implements IfcSurfaceOfRevolution {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_OF_REVOLUTION;
	}
	...
	public IfcAxis1Placement getAxisPosition() {
		return (IfcAxis1Placement) eGet(LogPackage.Literals.IFC_SURFACE_OF_REVOLUTION__AXIS_POSITION, true);
	}
	...
	public void setAxisPosition(IfcAxis1Placement newAxisPosition) {
		eSet(LogPackage.Literals.IFC_SURFACE_OF_REVOLUTION__AXIS_POSITION, newAxisPosition);
	}
