...
public class IfcResourceImpl extends IfcObjectImpl implements IfcResource {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RESOURCE;
	}
	...
	public EList<IfcRelAssignsToResource> getResourceOf() {
		return (EList<IfcRelAssignsToResource>) eGet(LogPackage.Literals.IFC_RESOURCE__RESOURCE_OF, true);
	}
	...
	public void unsetResourceOf() {
		eUnset(LogPackage.Literals.IFC_RESOURCE__RESOURCE_OF);
	}
	...
	public boolean isSetResourceOf() {
		return eIsSet(LogPackage.Literals.IFC_RESOURCE__RESOURCE_OF);
	}
