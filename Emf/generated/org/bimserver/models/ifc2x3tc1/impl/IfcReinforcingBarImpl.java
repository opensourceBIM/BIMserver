...
public class IfcReinforcingBarImpl extends IfcReinforcingElementImpl implements IfcReinforcingBar {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REINFORCING_BAR;
	}
	...
	public double getNominalDiameter() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER, true);
	}
	...
	public void setNominalDiameter(double newNominalDiameter) {
		eSet(LogPackage.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER, newNominalDiameter);
	}
	...
	public String getNominalDiameterAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER_AS_STRING, true);
	}
	...
	public void setNominalDiameterAsString(String newNominalDiameterAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER_AS_STRING, newNominalDiameterAsString);
	}
	...
	public double getCrossSectionArea() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA, true);
	}
	...
	public void setCrossSectionArea(double newCrossSectionArea) {
		eSet(LogPackage.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA, newCrossSectionArea);
	}
	...
	public String getCrossSectionAreaAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA_AS_STRING, true);
	}
	...
	public void setCrossSectionAreaAsString(String newCrossSectionAreaAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA_AS_STRING, newCrossSectionAreaAsString);
	}
	...
	public double getBarLength() {
		return (Double) eGet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_LENGTH, true);
	}
	...
	public void setBarLength(double newBarLength) {
		eSet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_LENGTH, newBarLength);
	}
	...
	public void unsetBarLength() {
		eUnset(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_LENGTH);
	}
	...
	public boolean isSetBarLength() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_LENGTH);
	}
	...
	public String getBarLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING, true);
	}
	...
	public void setBarLengthAsString(String newBarLengthAsString) {
		eSet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING, newBarLengthAsString);
	}
	...
	public void unsetBarLengthAsString() {
		eUnset(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING);
	}
	...
	public boolean isSetBarLengthAsString() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING);
	}
	...
	public IfcReinforcingBarRoleEnum getBarRole() {
		return (IfcReinforcingBarRoleEnum) eGet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_ROLE, true);
	}
	...
	public void setBarRole(IfcReinforcingBarRoleEnum newBarRole) {
		eSet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_ROLE, newBarRole);
	}
	...
	public IfcReinforcingBarSurfaceEnum getBarSurface() {
		return (IfcReinforcingBarSurfaceEnum) eGet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_SURFACE, true);
	}
	...
	public void setBarSurface(IfcReinforcingBarSurfaceEnum newBarSurface) {
		eSet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_SURFACE, newBarSurface);
	}
	...
	public void unsetBarSurface() {
		eUnset(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_SURFACE);
	}
	...
	public boolean isSetBarSurface() {
		return eIsSet(LogPackage.Literals.IFC_REINFORCING_BAR__BAR_SURFACE);
	}
