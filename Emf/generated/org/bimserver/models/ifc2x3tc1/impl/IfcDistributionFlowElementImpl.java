...
public class IfcDistributionFlowElementImpl extends IfcDistributionElementImpl implements IfcDistributionFlowElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DISTRIBUTION_FLOW_ELEMENT;
	}
	...
	public EList<IfcRelFlowControlElements> getHasControlElements() {
		return (EList<IfcRelFlowControlElements>) eGet(LogPackage.Literals.IFC_DISTRIBUTION_FLOW_ELEMENT__HAS_CONTROL_ELEMENTS, true);
	}
	...
	public void unsetHasControlElements() {
		eUnset(LogPackage.Literals.IFC_DISTRIBUTION_FLOW_ELEMENT__HAS_CONTROL_ELEMENTS);
	}
	...
	public boolean isSetHasControlElements() {
		return eIsSet(LogPackage.Literals.IFC_DISTRIBUTION_FLOW_ELEMENT__HAS_CONTROL_ELEMENTS);
	}
