...
public class IfcSurfaceOfLinearExtrusionImpl extends IfcSweptSurfaceImpl implements IfcSurfaceOfLinearExtrusion {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SURFACE_OF_LINEAR_EXTRUSION;
	}
	...
	public IfcDirection getExtrudedDirection() {
		return (IfcDirection) eGet(LogPackage.Literals.IFC_SURFACE_OF_LINEAR_EXTRUSION__EXTRUDED_DIRECTION, true);
	}
	...
	public void setExtrudedDirection(IfcDirection newExtrudedDirection) {
		eSet(LogPackage.Literals.IFC_SURFACE_OF_LINEAR_EXTRUSION__EXTRUDED_DIRECTION, newExtrudedDirection);
	}
	...
	public double getDepth() {
		return (Double) eGet(LogPackage.Literals.IFC_SURFACE_OF_LINEAR_EXTRUSION__DEPTH, true);
	}
	...
	public void setDepth(double newDepth) {
		eSet(LogPackage.Literals.IFC_SURFACE_OF_LINEAR_EXTRUSION__DEPTH, newDepth);
	}
	...
	public String getDepthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SURFACE_OF_LINEAR_EXTRUSION__DEPTH_AS_STRING, true);
	}
	...
	public void setDepthAsString(String newDepthAsString) {
		eSet(LogPackage.Literals.IFC_SURFACE_OF_LINEAR_EXTRUSION__DEPTH_AS_STRING, newDepthAsString);
	}
