...
public class IfcSubedgeImpl extends IfcEdgeImpl implements IfcSubedge {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SUBEDGE;
	}
	...
	public IfcEdge getParentEdge() {
		return (IfcEdge) eGet(LogPackage.Literals.IFC_SUBEDGE__PARENT_EDGE, true);
	}
	...
	public void setParentEdge(IfcEdge newParentEdge) {
		eSet(LogPackage.Literals.IFC_SUBEDGE__PARENT_EDGE, newParentEdge);
	}
