...
public class IfcDistributionChamberElementTypeImpl extends IfcDistributionFlowElementTypeImpl implements IfcDistributionChamberElementType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DISTRIBUTION_CHAMBER_ELEMENT_TYPE;
	}
	...
	public IfcDistributionChamberElementTypeEnum getPredefinedType() {
		return (IfcDistributionChamberElementTypeEnum) eGet(LogPackage.Literals.IFC_DISTRIBUTION_CHAMBER_ELEMENT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcDistributionChamberElementTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_DISTRIBUTION_CHAMBER_ELEMENT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
