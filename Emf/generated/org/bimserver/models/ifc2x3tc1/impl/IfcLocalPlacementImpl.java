...
public class IfcLocalPlacementImpl extends IfcObjectPlacementImpl implements IfcLocalPlacement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LOCAL_PLACEMENT;
	}
	...
	public IfcObjectPlacement getPlacementRelTo() {
		return (IfcObjectPlacement) eGet(LogPackage.Literals.IFC_LOCAL_PLACEMENT__PLACEMENT_REL_TO, true);
	}
	...
	public void setPlacementRelTo(IfcObjectPlacement newPlacementRelTo) {
		eSet(LogPackage.Literals.IFC_LOCAL_PLACEMENT__PLACEMENT_REL_TO, newPlacementRelTo);
	}
	...
	public void unsetPlacementRelTo() {
		eUnset(LogPackage.Literals.IFC_LOCAL_PLACEMENT__PLACEMENT_REL_TO);
	}
	...
	public boolean isSetPlacementRelTo() {
		return eIsSet(LogPackage.Literals.IFC_LOCAL_PLACEMENT__PLACEMENT_REL_TO);
	}
	...
	public IfcAxis2Placement getRelativePlacement() {
		return (IfcAxis2Placement) eGet(LogPackage.Literals.IFC_LOCAL_PLACEMENT__RELATIVE_PLACEMENT, true);
	}
	...
	public void setRelativePlacement(IfcAxis2Placement newRelativePlacement) {
		eSet(LogPackage.Literals.IFC_LOCAL_PLACEMENT__RELATIVE_PLACEMENT, newRelativePlacement);
	}
