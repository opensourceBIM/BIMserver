...
public class IfcTransportElementTypeImpl extends IfcElementTypeImpl implements IfcTransportElementType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TRANSPORT_ELEMENT_TYPE;
	}
	...
	public IfcTransportElementTypeEnum getPredefinedType() {
		return (IfcTransportElementTypeEnum) eGet(LogPackage.Literals.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTransportElementTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_TRANSPORT_ELEMENT_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
