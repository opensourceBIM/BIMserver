...
public class IfcDimensionCurveImpl extends IfcAnnotationCurveOccurrenceImpl implements IfcDimensionCurve {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DIMENSION_CURVE;
	}
	...
	public EList<IfcTerminatorSymbol> getAnnotatedBySymbols() {
		return (EList<IfcTerminatorSymbol>) eGet(LogPackage.Literals.IFC_DIMENSION_CURVE__ANNOTATED_BY_SYMBOLS, true);
	}
	...
	public void unsetAnnotatedBySymbols() {
		eUnset(LogPackage.Literals.IFC_DIMENSION_CURVE__ANNOTATED_BY_SYMBOLS);
	}
	...
	public boolean isSetAnnotatedBySymbols() {
		return eIsSet(LogPackage.Literals.IFC_DIMENSION_CURVE__ANNOTATED_BY_SYMBOLS);
	}
