...
public class IfcExtendedMaterialPropertiesImpl extends IfcMaterialPropertiesImpl implements IfcExtendedMaterialProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_EXTENDED_MATERIAL_PROPERTIES;
	}
	...
	public EList<IfcProperty> getExtendedProperties() {
		return (EList<IfcProperty>) eGet(LogPackage.Literals.IFC_EXTENDED_MATERIAL_PROPERTIES__EXTENDED_PROPERTIES, true);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_EXTENDED_MATERIAL_PROPERTIES__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_EXTENDED_MATERIAL_PROPERTIES__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_EXTENDED_MATERIAL_PROPERTIES__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_EXTENDED_MATERIAL_PROPERTIES__DESCRIPTION);
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_EXTENDED_MATERIAL_PROPERTIES__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_EXTENDED_MATERIAL_PROPERTIES__NAME, newName);
	}
