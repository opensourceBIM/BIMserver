...
public class IfcAppliedValueImpl extends IdEObjectImpl implements IfcAppliedValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_APPLIED_VALUE;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_APPLIED_VALUE__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__NAME);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_APPLIED_VALUE__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__DESCRIPTION);
	}
	...
	public IfcAppliedValueSelect getAppliedValue() {
		return (IfcAppliedValueSelect) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__APPLIED_VALUE, true);
	}
	...
	public void setAppliedValue(IfcAppliedValueSelect newAppliedValue) {
		eSet(LogPackage.Literals.IFC_APPLIED_VALUE__APPLIED_VALUE, newAppliedValue);
	}
	...
	public void unsetAppliedValue() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__APPLIED_VALUE);
	}
	...
	public boolean isSetAppliedValue() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__APPLIED_VALUE);
	}
	...
	public IfcMeasureWithUnit getUnitBasis() {
		return (IfcMeasureWithUnit) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__UNIT_BASIS, true);
	}
	...
	public void setUnitBasis(IfcMeasureWithUnit newUnitBasis) {
		eSet(LogPackage.Literals.IFC_APPLIED_VALUE__UNIT_BASIS, newUnitBasis);
	}
	...
	public void unsetUnitBasis() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__UNIT_BASIS);
	}
	...
	public boolean isSetUnitBasis() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__UNIT_BASIS);
	}
	...
	public IfcDateTimeSelect getApplicableDate() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__APPLICABLE_DATE, true);
	}
	...
	public void setApplicableDate(IfcDateTimeSelect newApplicableDate) {
		eSet(LogPackage.Literals.IFC_APPLIED_VALUE__APPLICABLE_DATE, newApplicableDate);
	}
	...
	public void unsetApplicableDate() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__APPLICABLE_DATE);
	}
	...
	public boolean isSetApplicableDate() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__APPLICABLE_DATE);
	}
	...
	public IfcDateTimeSelect getFixedUntilDate() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__FIXED_UNTIL_DATE, true);
	}
	...
	public void setFixedUntilDate(IfcDateTimeSelect newFixedUntilDate) {
		eSet(LogPackage.Literals.IFC_APPLIED_VALUE__FIXED_UNTIL_DATE, newFixedUntilDate);
	}
	...
	public void unsetFixedUntilDate() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__FIXED_UNTIL_DATE);
	}
	...
	public boolean isSetFixedUntilDate() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__FIXED_UNTIL_DATE);
	}
	...
	public EList<IfcReferencesValueDocument> getValuesReferenced() {
		return (EList<IfcReferencesValueDocument>) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__VALUES_REFERENCED, true);
	}
	...
	public void unsetValuesReferenced() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__VALUES_REFERENCED);
	}
	...
	public boolean isSetValuesReferenced() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__VALUES_REFERENCED);
	}
	...
	public EList<IfcAppliedValueRelationship> getValueOfComponents() {
		return (EList<IfcAppliedValueRelationship>) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__VALUE_OF_COMPONENTS, true);
	}
	...
	public void unsetValueOfComponents() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__VALUE_OF_COMPONENTS);
	}
	...
	public boolean isSetValueOfComponents() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__VALUE_OF_COMPONENTS);
	}
	...
	public EList<IfcAppliedValueRelationship> getIsComponentIn() {
		return (EList<IfcAppliedValueRelationship>) eGet(LogPackage.Literals.IFC_APPLIED_VALUE__IS_COMPONENT_IN, true);
	}
	...
	public void unsetIsComponentIn() {
		eUnset(LogPackage.Literals.IFC_APPLIED_VALUE__IS_COMPONENT_IN);
	}
	...
	public boolean isSetIsComponentIn() {
		return eIsSet(LogPackage.Literals.IFC_APPLIED_VALUE__IS_COMPONENT_IN);
	}
