...
public class IfcLibraryInformationImpl extends IdEObjectImpl implements IfcLibraryInformation {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LIBRARY_INFORMATION;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__NAME, newName);
	}
	...
	public String getVersion() {
		return (String) eGet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__VERSION, true);
	}
	...
	public void setVersion(String newVersion) {
		eSet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__VERSION, newVersion);
	}
	...
	public void unsetVersion() {
		eUnset(LogPackage.Literals.IFC_LIBRARY_INFORMATION__VERSION);
	}
	...
	public boolean isSetVersion() {
		return eIsSet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__VERSION);
	}
	...
	public IfcOrganization getPublisher() {
		return (IfcOrganization) eGet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__PUBLISHER, true);
	}
	...
	public void setPublisher(IfcOrganization newPublisher) {
		eSet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__PUBLISHER, newPublisher);
	}
	...
	public void unsetPublisher() {
		eUnset(LogPackage.Literals.IFC_LIBRARY_INFORMATION__PUBLISHER);
	}
	...
	public boolean isSetPublisher() {
		return eIsSet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__PUBLISHER);
	}
	...
	public IfcCalendarDate getVersionDate() {
		return (IfcCalendarDate) eGet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__VERSION_DATE, true);
	}
	...
	public void setVersionDate(IfcCalendarDate newVersionDate) {
		eSet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__VERSION_DATE, newVersionDate);
	}
	...
	public void unsetVersionDate() {
		eUnset(LogPackage.Literals.IFC_LIBRARY_INFORMATION__VERSION_DATE);
	}
	...
	public boolean isSetVersionDate() {
		return eIsSet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__VERSION_DATE);
	}
	...
	public EList<IfcLibraryReference> getLibraryReference() {
		return (EList<IfcLibraryReference>) eGet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__LIBRARY_REFERENCE, true);
	}
	...
	public void unsetLibraryReference() {
		eUnset(LogPackage.Literals.IFC_LIBRARY_INFORMATION__LIBRARY_REFERENCE);
	}
	...
	public boolean isSetLibraryReference() {
		return eIsSet(LogPackage.Literals.IFC_LIBRARY_INFORMATION__LIBRARY_REFERENCE);
	}
