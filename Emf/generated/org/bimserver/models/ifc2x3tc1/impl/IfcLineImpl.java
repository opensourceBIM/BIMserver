...
public class IfcLineImpl extends IfcCurveImpl implements IfcLine {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LINE;
	}
	...
	public IfcCartesianPoint getPnt() {
		return (IfcCartesianPoint) eGet(LogPackage.Literals.IFC_LINE__PNT, true);
	}
	...
	public void setPnt(IfcCartesianPoint newPnt) {
		eSet(LogPackage.Literals.IFC_LINE__PNT, newPnt);
	}
	...
	public IfcVector getDir() {
		return (IfcVector) eGet(LogPackage.Literals.IFC_LINE__DIR, true);
	}
	...
	public void setDir(IfcVector newDir) {
		eSet(LogPackage.Literals.IFC_LINE__DIR, newDir);
	}
