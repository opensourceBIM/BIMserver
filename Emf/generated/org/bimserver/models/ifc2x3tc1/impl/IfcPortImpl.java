...
public class IfcPortImpl extends IfcProductImpl implements IfcPort {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PORT;
	}
	...
	public IfcRelConnectsPortToElement getContainedIn() {
		return (IfcRelConnectsPortToElement) eGet(LogPackage.Literals.IFC_PORT__CONTAINED_IN, true);
	}
	...
	public void setContainedIn(IfcRelConnectsPortToElement newContainedIn) {
		eSet(LogPackage.Literals.IFC_PORT__CONTAINED_IN, newContainedIn);
	}
	...
	public void unsetContainedIn() {
		eUnset(LogPackage.Literals.IFC_PORT__CONTAINED_IN);
	}
	...
	public boolean isSetContainedIn() {
		return eIsSet(LogPackage.Literals.IFC_PORT__CONTAINED_IN);
	}
	...
	public EList<IfcRelConnectsPorts> getConnectedFrom() {
		return (EList<IfcRelConnectsPorts>) eGet(LogPackage.Literals.IFC_PORT__CONNECTED_FROM, true);
	}
	...
	public void unsetConnectedFrom() {
		eUnset(LogPackage.Literals.IFC_PORT__CONNECTED_FROM);
	}
	...
	public boolean isSetConnectedFrom() {
		return eIsSet(LogPackage.Literals.IFC_PORT__CONNECTED_FROM);
	}
	...
	public EList<IfcRelConnectsPorts> getConnectedTo() {
		return (EList<IfcRelConnectsPorts>) eGet(LogPackage.Literals.IFC_PORT__CONNECTED_TO, true);
	}
	...
	public void unsetConnectedTo() {
		eUnset(LogPackage.Literals.IFC_PORT__CONNECTED_TO);
	}
	...
	public boolean isSetConnectedTo() {
		return eIsSet(LogPackage.Literals.IFC_PORT__CONNECTED_TO);
	}
