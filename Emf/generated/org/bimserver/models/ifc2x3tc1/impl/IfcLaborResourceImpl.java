...
public class IfcLaborResourceImpl extends IfcConstructionResourceImpl implements IfcLaborResource {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_LABOR_RESOURCE;
	}
	...
	public String getSkillSet() {
		return (String) eGet(LogPackage.Literals.IFC_LABOR_RESOURCE__SKILL_SET, true);
	}
	...
	public void setSkillSet(String newSkillSet) {
		eSet(LogPackage.Literals.IFC_LABOR_RESOURCE__SKILL_SET, newSkillSet);
	}
	...
	public void unsetSkillSet() {
		eUnset(LogPackage.Literals.IFC_LABOR_RESOURCE__SKILL_SET);
	}
	...
	public boolean isSetSkillSet() {
		return eIsSet(LogPackage.Literals.IFC_LABOR_RESOURCE__SKILL_SET);
	}
