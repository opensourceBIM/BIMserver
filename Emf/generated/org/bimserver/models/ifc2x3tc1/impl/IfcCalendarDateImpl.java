...
public class IfcCalendarDateImpl extends IdEObjectImpl implements IfcCalendarDate {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CALENDAR_DATE;
	}
	...
	public int getDayComponent() {
		return (Integer) eGet(LogPackage.Literals.IFC_CALENDAR_DATE__DAY_COMPONENT, true);
	}
	...
	public void setDayComponent(int newDayComponent) {
		eSet(LogPackage.Literals.IFC_CALENDAR_DATE__DAY_COMPONENT, newDayComponent);
	}
	...
	public int getMonthComponent() {
		return (Integer) eGet(LogPackage.Literals.IFC_CALENDAR_DATE__MONTH_COMPONENT, true);
	}
	...
	public void setMonthComponent(int newMonthComponent) {
		eSet(LogPackage.Literals.IFC_CALENDAR_DATE__MONTH_COMPONENT, newMonthComponent);
	}
	...
	public int getYearComponent() {
		return (Integer) eGet(LogPackage.Literals.IFC_CALENDAR_DATE__YEAR_COMPONENT, true);
	}
	...
	public void setYearComponent(int newYearComponent) {
		eSet(LogPackage.Literals.IFC_CALENDAR_DATE__YEAR_COMPONENT, newYearComponent);
	}
