...
public class IfcDoorPanelPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcDoorPanelProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES;
	}
	...
	public double getPanelDepth() {
		return (Double) eGet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH, true);
	}
	...
	public void setPanelDepth(double newPanelDepth) {
		eSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH, newPanelDepth);
	}
	...
	public void unsetPanelDepth() {
		eUnset(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH);
	}
	...
	public boolean isSetPanelDepth() {
		return eIsSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH);
	}
	...
	public String getPanelDepthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH_AS_STRING, true);
	}
	...
	public void setPanelDepthAsString(String newPanelDepthAsString) {
		eSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH_AS_STRING, newPanelDepthAsString);
	}
	...
	public void unsetPanelDepthAsString() {
		eUnset(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH_AS_STRING);
	}
	...
	public boolean isSetPanelDepthAsString() {
		return eIsSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH_AS_STRING);
	}
	...
	public IfcDoorPanelOperationEnum getPanelOperation() {
		return (IfcDoorPanelOperationEnum) eGet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_OPERATION, true);
	}
	...
	public void setPanelOperation(IfcDoorPanelOperationEnum newPanelOperation) {
		eSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_OPERATION, newPanelOperation);
	}
	...
	public double getPanelWidth() {
		return (Double) eGet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH, true);
	}
	...
	public void setPanelWidth(double newPanelWidth) {
		eSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH, newPanelWidth);
	}
	...
	public void unsetPanelWidth() {
		eUnset(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH);
	}
	...
	public boolean isSetPanelWidth() {
		return eIsSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH);
	}
	...
	public String getPanelWidthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH_AS_STRING, true);
	}
	...
	public void setPanelWidthAsString(String newPanelWidthAsString) {
		eSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH_AS_STRING, newPanelWidthAsString);
	}
	...
	public void unsetPanelWidthAsString() {
		eUnset(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH_AS_STRING);
	}
	...
	public boolean isSetPanelWidthAsString() {
		return eIsSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH_AS_STRING);
	}
	...
	public IfcDoorPanelPositionEnum getPanelPosition() {
		return (IfcDoorPanelPositionEnum) eGet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_POSITION, true);
	}
	...
	public void setPanelPosition(IfcDoorPanelPositionEnum newPanelPosition) {
		eSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_POSITION, newPanelPosition);
	}
	...
	public IfcShapeAspect getShapeAspectStyle() {
		return (IfcShapeAspect) eGet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE, true);
	}
	...
	public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
		eSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE, newShapeAspectStyle);
	}
	...
	public void unsetShapeAspectStyle() {
		eUnset(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
	...
	public boolean isSetShapeAspectStyle() {
		return eIsSet(LogPackage.Literals.IFC_DOOR_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
