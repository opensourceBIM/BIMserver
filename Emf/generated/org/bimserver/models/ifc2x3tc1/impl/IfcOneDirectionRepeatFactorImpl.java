...
public class IfcOneDirectionRepeatFactorImpl extends IfcGeometricRepresentationItemImpl implements IfcOneDirectionRepeatFactor {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ONE_DIRECTION_REPEAT_FACTOR;
	}
	...
	public IfcVector getRepeatFactor() {
		return (IfcVector) eGet(LogPackage.Literals.IFC_ONE_DIRECTION_REPEAT_FACTOR__REPEAT_FACTOR, true);
	}
	...
	public void setRepeatFactor(IfcVector newRepeatFactor) {
		eSet(LogPackage.Literals.IFC_ONE_DIRECTION_REPEAT_FACTOR__REPEAT_FACTOR, newRepeatFactor);
	}
