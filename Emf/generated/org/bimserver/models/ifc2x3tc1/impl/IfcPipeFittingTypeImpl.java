...
public class IfcPipeFittingTypeImpl extends IfcFlowFittingTypeImpl implements IfcPipeFittingType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PIPE_FITTING_TYPE;
	}
	...
	public IfcPipeFittingTypeEnum getPredefinedType() {
		return (IfcPipeFittingTypeEnum) eGet(LogPackage.Literals.IFC_PIPE_FITTING_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcPipeFittingTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_PIPE_FITTING_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
