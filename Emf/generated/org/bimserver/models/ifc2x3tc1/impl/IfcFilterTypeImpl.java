...
public class IfcFilterTypeImpl extends IfcFlowTreatmentDeviceTypeImpl implements IfcFilterType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FILTER_TYPE;
	}
	...
	public IfcFilterTypeEnum getPredefinedType() {
		return (IfcFilterTypeEnum) eGet(LogPackage.Literals.IFC_FILTER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcFilterTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_FILTER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
