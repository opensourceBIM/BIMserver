...
public class IfcConstructionMaterialResourceImpl extends IfcConstructionResourceImpl implements IfcConstructionMaterialResource {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE;
	}
	...
	public EList<IfcActorSelect> getSuppliers() {
		return (EList<IfcActorSelect>) eGet(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__SUPPLIERS, true);
	}
	...
	public void unsetSuppliers() {
		eUnset(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__SUPPLIERS);
	}
	...
	public boolean isSetSuppliers() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__SUPPLIERS);
	}
	...
	public double getUsageRatio() {
		return (Double) eGet(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__USAGE_RATIO, true);
	}
	...
	public void setUsageRatio(double newUsageRatio) {
		eSet(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__USAGE_RATIO, newUsageRatio);
	}
	...
	public void unsetUsageRatio() {
		eUnset(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__USAGE_RATIO);
	}
	...
	public boolean isSetUsageRatio() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__USAGE_RATIO);
	}
	...
	public String getUsageRatioAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__USAGE_RATIO_AS_STRING, true);
	}
	...
	public void setUsageRatioAsString(String newUsageRatioAsString) {
		eSet(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__USAGE_RATIO_AS_STRING, newUsageRatioAsString);
	}
	...
	public void unsetUsageRatioAsString() {
		eUnset(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__USAGE_RATIO_AS_STRING);
	}
	...
	public boolean isSetUsageRatioAsString() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRUCTION_MATERIAL_RESOURCE__USAGE_RATIO_AS_STRING);
	}
