...
public class IfcPermeableCoveringPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcPermeableCoveringProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES;
	}
	...
	public IfcPermeableCoveringOperationEnum getOperationType() {
		return (IfcPermeableCoveringOperationEnum) eGet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE, true);
	}
	...
	public void setOperationType(IfcPermeableCoveringOperationEnum newOperationType) {
		eSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE, newOperationType);
	}
	...
	public IfcWindowPanelPositionEnum getPanelPosition() {
		return (IfcWindowPanelPositionEnum) eGet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__PANEL_POSITION, true);
	}
	...
	public void setPanelPosition(IfcWindowPanelPositionEnum newPanelPosition) {
		eSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__PANEL_POSITION, newPanelPosition);
	}
	...
	public double getFrameDepth() {
		return (Double) eGet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH, true);
	}
	...
	public void setFrameDepth(double newFrameDepth) {
		eSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH, newFrameDepth);
	}
	...
	public void unsetFrameDepth() {
		eUnset(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH);
	}
	...
	public boolean isSetFrameDepth() {
		return eIsSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH);
	}
	...
	public String getFrameDepthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING, true);
	}
	...
	public void setFrameDepthAsString(String newFrameDepthAsString) {
		eSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING, newFrameDepthAsString);
	}
	...
	public void unsetFrameDepthAsString() {
		eUnset(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING);
	}
	...
	public boolean isSetFrameDepthAsString() {
		return eIsSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING);
	}
	...
	public double getFrameThickness() {
		return (Double) eGet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS, true);
	}
	...
	public void setFrameThickness(double newFrameThickness) {
		eSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS, newFrameThickness);
	}
	...
	public void unsetFrameThickness() {
		eUnset(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS);
	}
	...
	public boolean isSetFrameThickness() {
		return eIsSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS);
	}
	...
	public String getFrameThicknessAsString() {
		return (String) eGet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING, true);
	}
	...
	public void setFrameThicknessAsString(String newFrameThicknessAsString) {
		eSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING, newFrameThicknessAsString);
	}
	...
	public void unsetFrameThicknessAsString() {
		eUnset(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING);
	}
	...
	public boolean isSetFrameThicknessAsString() {
		return eIsSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING);
	}
	...
	public IfcShapeAspect getShapeAspectStyle() {
		return (IfcShapeAspect) eGet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE, true);
	}
	...
	public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
		eSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE, newShapeAspectStyle);
	}
	...
	public void unsetShapeAspectStyle() {
		eUnset(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
	...
	public boolean isSetShapeAspectStyle() {
		return eIsSet(LogPackage.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
