...
public class IfcTemperatureGradientMeasureImpl extends WrappedValueImpl implements IfcTemperatureGradientMeasure {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE;
	}
	...
	public double getWrappedValue() {
		return (Double) eGet(LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE__WRAPPED_VALUE, newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE__WRAPPED_VALUE);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE__WRAPPED_VALUE_AS_STRING, true);
	}
	...
	public void setWrappedValueAsString(String newWrappedValueAsString) {
		eSet(LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE__WRAPPED_VALUE_AS_STRING, newWrappedValueAsString);
	}
	...
	public void unsetWrappedValueAsString() {
		eUnset(LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE__WRAPPED_VALUE_AS_STRING);
	}
	...
	public boolean isSetWrappedValueAsString() {
		return eIsSet(LogPackage.Literals.IFC_TEMPERATURE_GRADIENT_MEASURE__WRAPPED_VALUE_AS_STRING);
	}
