...
public class IfcSanitaryTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcSanitaryTerminalType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SANITARY_TERMINAL_TYPE;
	}
	...
	public IfcSanitaryTerminalTypeEnum getPredefinedType() {
		return (IfcSanitaryTerminalTypeEnum) eGet(LogPackage.Literals.IFC_SANITARY_TERMINAL_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSanitaryTerminalTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_SANITARY_TERMINAL_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
