...
public class IfcShellBasedSurfaceModelImpl extends IfcGeometricRepresentationItemImpl implements IfcShellBasedSurfaceModel {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SHELL_BASED_SURFACE_MODEL;
	}
	...
	public EList<IfcShell> getSbsmBoundary() {
		return (EList<IfcShell>) eGet(LogPackage.Literals.IFC_SHELL_BASED_SURFACE_MODEL__SBSM_BOUNDARY, true);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_SHELL_BASED_SURFACE_MODEL__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_SHELL_BASED_SURFACE_MODEL__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_SHELL_BASED_SURFACE_MODEL__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_SHELL_BASED_SURFACE_MODEL__DIM);
	}
