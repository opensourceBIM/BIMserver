...
public class IfcServiceLifeFactorImpl extends IfcPropertySetDefinitionImpl implements IfcServiceLifeFactor {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR;
	}
	...
	public IfcServiceLifeFactorTypeEnum getPredefinedType() {
		return (IfcServiceLifeFactorTypeEnum) eGet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcServiceLifeFactorTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public IfcMeasureValue getUpperValue() {
		return (IfcMeasureValue) eGet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__UPPER_VALUE, true);
	}
	...
	public void setUpperValue(IfcMeasureValue newUpperValue) {
		eSet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__UPPER_VALUE, newUpperValue);
	}
	...
	public void unsetUpperValue() {
		eUnset(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__UPPER_VALUE);
	}
	...
	public boolean isSetUpperValue() {
		return eIsSet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__UPPER_VALUE);
	}
	...
	public IfcMeasureValue getMostUsedValue() {
		return (IfcMeasureValue) eGet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__MOST_USED_VALUE, true);
	}
	...
	public void setMostUsedValue(IfcMeasureValue newMostUsedValue) {
		eSet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__MOST_USED_VALUE, newMostUsedValue);
	}
	...
	public IfcMeasureValue getLowerValue() {
		return (IfcMeasureValue) eGet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__LOWER_VALUE, true);
	}
	...
	public void setLowerValue(IfcMeasureValue newLowerValue) {
		eSet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__LOWER_VALUE, newLowerValue);
	}
	...
	public void unsetLowerValue() {
		eUnset(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__LOWER_VALUE);
	}
	...
	public boolean isSetLowerValue() {
		return eIsSet(LogPackage.Literals.IFC_SERVICE_LIFE_FACTOR__LOWER_VALUE);
	}
