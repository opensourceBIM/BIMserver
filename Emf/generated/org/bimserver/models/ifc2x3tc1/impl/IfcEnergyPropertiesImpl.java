...
public class IfcEnergyPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcEnergyProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ENERGY_PROPERTIES;
	}
	...
	public IfcEnergySequenceEnum getEnergySequence() {
		return (IfcEnergySequenceEnum) eGet(LogPackage.Literals.IFC_ENERGY_PROPERTIES__ENERGY_SEQUENCE, true);
	}
	...
	public void setEnergySequence(IfcEnergySequenceEnum newEnergySequence) {
		eSet(LogPackage.Literals.IFC_ENERGY_PROPERTIES__ENERGY_SEQUENCE, newEnergySequence);
	}
	...
	public void unsetEnergySequence() {
		eUnset(LogPackage.Literals.IFC_ENERGY_PROPERTIES__ENERGY_SEQUENCE);
	}
	...
	public boolean isSetEnergySequence() {
		return eIsSet(LogPackage.Literals.IFC_ENERGY_PROPERTIES__ENERGY_SEQUENCE);
	}
	...
	public String getUserDefinedEnergySequence() {
		return (String) eGet(LogPackage.Literals.IFC_ENERGY_PROPERTIES__USER_DEFINED_ENERGY_SEQUENCE, true);
	}
	...
	public void setUserDefinedEnergySequence(String newUserDefinedEnergySequence) {
		eSet(LogPackage.Literals.IFC_ENERGY_PROPERTIES__USER_DEFINED_ENERGY_SEQUENCE, newUserDefinedEnergySequence);
	}
	...
	public void unsetUserDefinedEnergySequence() {
		eUnset(LogPackage.Literals.IFC_ENERGY_PROPERTIES__USER_DEFINED_ENERGY_SEQUENCE);
	}
	...
	public boolean isSetUserDefinedEnergySequence() {
		return eIsSet(LogPackage.Literals.IFC_ENERGY_PROPERTIES__USER_DEFINED_ENERGY_SEQUENCE);
	}
