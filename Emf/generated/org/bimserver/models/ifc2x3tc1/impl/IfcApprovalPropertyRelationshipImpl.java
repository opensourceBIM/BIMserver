...
public class IfcApprovalPropertyRelationshipImpl extends IdEObjectImpl implements IfcApprovalPropertyRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_APPROVAL_PROPERTY_RELATIONSHIP;
	}
	...
	public EList<IfcProperty> getApprovedProperties() {
		return (EList<IfcProperty>) eGet(LogPackage.Literals.IFC_APPROVAL_PROPERTY_RELATIONSHIP__APPROVED_PROPERTIES, true);
	}
	...
	public IfcApproval getApproval() {
		return (IfcApproval) eGet(LogPackage.Literals.IFC_APPROVAL_PROPERTY_RELATIONSHIP__APPROVAL, true);
	}
	...
	public void setApproval(IfcApproval newApproval) {
		eSet(LogPackage.Literals.IFC_APPROVAL_PROPERTY_RELATIONSHIP__APPROVAL, newApproval);
	}
