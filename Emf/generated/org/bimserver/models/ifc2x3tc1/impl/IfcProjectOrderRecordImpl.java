...
public class IfcProjectOrderRecordImpl extends IfcControlImpl implements IfcProjectOrderRecord {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROJECT_ORDER_RECORD;
	}
	...
	public EList<IfcRelAssignsToProjectOrder> getRecords() {
		return (EList<IfcRelAssignsToProjectOrder>) eGet(LogPackage.Literals.IFC_PROJECT_ORDER_RECORD__RECORDS, true);
	}
	...
	public IfcProjectOrderRecordTypeEnum getPredefinedType() {
		return (IfcProjectOrderRecordTypeEnum) eGet(LogPackage.Literals.IFC_PROJECT_ORDER_RECORD__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcProjectOrderRecordTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_PROJECT_ORDER_RECORD__PREDEFINED_TYPE, newPredefinedType);
	}
