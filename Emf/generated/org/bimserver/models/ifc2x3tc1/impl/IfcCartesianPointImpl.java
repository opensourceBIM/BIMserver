...
public class IfcCartesianPointImpl extends IfcPointImpl implements IfcCartesianPoint {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CARTESIAN_POINT;
	}
	...
	public EList<Double> getCoordinates() {
		return (EList<Double>) eGet(LogPackage.Literals.IFC_CARTESIAN_POINT__COORDINATES, true);
	}
	...
	public EList<String> getCoordinatesAsString() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_CARTESIAN_POINT__COORDINATES_AS_STRING, true);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_CARTESIAN_POINT__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_CARTESIAN_POINT__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_CARTESIAN_POINT__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_CARTESIAN_POINT__DIM);
	}
