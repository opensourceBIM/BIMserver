...
public class IfcGridAxisImpl extends IdEObjectImpl implements IfcGridAxis {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_GRID_AXIS;
	}
	...
	public String getAxisTag() {
		return (String) eGet(LogPackage.Literals.IFC_GRID_AXIS__AXIS_TAG, true);
	}
	...
	public void setAxisTag(String newAxisTag) {
		eSet(LogPackage.Literals.IFC_GRID_AXIS__AXIS_TAG, newAxisTag);
	}
	...
	public void unsetAxisTag() {
		eUnset(LogPackage.Literals.IFC_GRID_AXIS__AXIS_TAG);
	}
	...
	public boolean isSetAxisTag() {
		return eIsSet(LogPackage.Literals.IFC_GRID_AXIS__AXIS_TAG);
	}
	...
	public IfcCurve getAxisCurve() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_GRID_AXIS__AXIS_CURVE, true);
	}
	...
	public void setAxisCurve(IfcCurve newAxisCurve) {
		eSet(LogPackage.Literals.IFC_GRID_AXIS__AXIS_CURVE, newAxisCurve);
	}
	...
	public Tristate getSameSense() {
		return (Tristate) eGet(LogPackage.Literals.IFC_GRID_AXIS__SAME_SENSE, true);
	}
	...
	public void setSameSense(Tristate newSameSense) {
		eSet(LogPackage.Literals.IFC_GRID_AXIS__SAME_SENSE, newSameSense);
	}
	...
	public EList<IfcGrid> getPartOfW() {
		return (EList<IfcGrid>) eGet(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_W, true);
	}
	...
	public void unsetPartOfW() {
		eUnset(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_W);
	}
	...
	public boolean isSetPartOfW() {
		return eIsSet(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_W);
	}
	...
	public EList<IfcGrid> getPartOfV() {
		return (EList<IfcGrid>) eGet(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_V, true);
	}
	...
	public void unsetPartOfV() {
		eUnset(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_V);
	}
	...
	public boolean isSetPartOfV() {
		return eIsSet(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_V);
	}
	...
	public EList<IfcGrid> getPartOfU() {
		return (EList<IfcGrid>) eGet(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_U, true);
	}
	...
	public void unsetPartOfU() {
		eUnset(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_U);
	}
	...
	public boolean isSetPartOfU() {
		return eIsSet(LogPackage.Literals.IFC_GRID_AXIS__PART_OF_U);
	}
	...
	public EList<IfcVirtualGridIntersection> getHasIntersections() {
		return (EList<IfcVirtualGridIntersection>) eGet(LogPackage.Literals.IFC_GRID_AXIS__HAS_INTERSECTIONS, true);
	}
	...
	public void unsetHasIntersections() {
		eUnset(LogPackage.Literals.IFC_GRID_AXIS__HAS_INTERSECTIONS);
	}
	...
	public boolean isSetHasIntersections() {
		return eIsSet(LogPackage.Literals.IFC_GRID_AXIS__HAS_INTERSECTIONS);
	}
