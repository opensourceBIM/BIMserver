...
public class IfcDirectionImpl extends IfcGeometricRepresentationItemImpl implements IfcDirection {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DIRECTION;
	}
	...
	public EList<Double> getDirectionRatios() {
		return (EList<Double>) eGet(LogPackage.Literals.IFC_DIRECTION__DIRECTION_RATIOS, true);
	}
	...
	public EList<String> getDirectionRatiosAsString() {
		return (EList<String>) eGet(LogPackage.Literals.IFC_DIRECTION__DIRECTION_RATIOS_AS_STRING, true);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(LogPackage.Literals.IFC_DIRECTION__DIM, true);
	}
	...
	public void setDim(int newDim) {
		eSet(LogPackage.Literals.IFC_DIRECTION__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(LogPackage.Literals.IFC_DIRECTION__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(LogPackage.Literals.IFC_DIRECTION__DIM);
	}
