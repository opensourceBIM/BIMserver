...
public class IfcDuctSilencerTypeImpl extends IfcFlowTreatmentDeviceTypeImpl implements IfcDuctSilencerType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DUCT_SILENCER_TYPE;
	}
	...
	public IfcDuctSilencerTypeEnum getPredefinedType() {
		return (IfcDuctSilencerTypeEnum) eGet(LogPackage.Literals.IFC_DUCT_SILENCER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcDuctSilencerTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_DUCT_SILENCER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
