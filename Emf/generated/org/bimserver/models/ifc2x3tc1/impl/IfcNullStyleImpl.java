...
public class IfcNullStyleImpl extends WrappedValueImpl implements IfcNullStyle {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_NULL_STYLE;
	}
	...
	public IfcNullStyleEnum getWrappedValue() {
		return (IfcNullStyleEnum) eGet(LogPackage.Literals.IFC_NULL_STYLE__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(IfcNullStyleEnum newWrappedValue) {
		eSet(LogPackage.Literals.IFC_NULL_STYLE__WRAPPED_VALUE, newWrappedValue);
	}
