...
public class IfcAnnotationFillAreaImpl extends IfcGeometricRepresentationItemImpl implements IfcAnnotationFillArea {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ANNOTATION_FILL_AREA;
	}
	...
	public IfcCurve getOuterBoundary() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA__OUTER_BOUNDARY, true);
	}
	...
	public void setOuterBoundary(IfcCurve newOuterBoundary) {
		eSet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA__OUTER_BOUNDARY, newOuterBoundary);
	}
	...
	public EList<IfcCurve> getInnerBoundaries() {
		return (EList<IfcCurve>) eGet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA__INNER_BOUNDARIES, true);
	}
	...
	public void unsetInnerBoundaries() {
		eUnset(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA__INNER_BOUNDARIES);
	}
	...
	public boolean isSetInnerBoundaries() {
		return eIsSet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA__INNER_BOUNDARIES);
	}
