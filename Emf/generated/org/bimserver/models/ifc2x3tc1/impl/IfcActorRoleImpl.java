...
public class IfcActorRoleImpl extends IdEObjectImpl implements IfcActorRole {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ACTOR_ROLE;
	}
	...
	public IfcRoleEnum getRole() {
		return (IfcRoleEnum) eGet(LogPackage.Literals.IFC_ACTOR_ROLE__ROLE, true);
	}
	...
	public void setRole(IfcRoleEnum newRole) {
		eSet(LogPackage.Literals.IFC_ACTOR_ROLE__ROLE, newRole);
	}
	...
	public String getUserDefinedRole() {
		return (String) eGet(LogPackage.Literals.IFC_ACTOR_ROLE__USER_DEFINED_ROLE, true);
	}
	...
	public void setUserDefinedRole(String newUserDefinedRole) {
		eSet(LogPackage.Literals.IFC_ACTOR_ROLE__USER_DEFINED_ROLE, newUserDefinedRole);
	}
	...
	public void unsetUserDefinedRole() {
		eUnset(LogPackage.Literals.IFC_ACTOR_ROLE__USER_DEFINED_ROLE);
	}
	...
	public boolean isSetUserDefinedRole() {
		return eIsSet(LogPackage.Literals.IFC_ACTOR_ROLE__USER_DEFINED_ROLE);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_ACTOR_ROLE__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_ACTOR_ROLE__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_ACTOR_ROLE__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_ACTOR_ROLE__DESCRIPTION);
	}
