...
public class IfcBSplineCurveImpl extends IfcBoundedCurveImpl implements IfcBSplineCurve {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_BSPLINE_CURVE;
	}
	...
	public int getDegree() {
		return (Integer) eGet(LogPackage.Literals.IFC_BSPLINE_CURVE__DEGREE, true);
	}
	...
	public void setDegree(int newDegree) {
		eSet(LogPackage.Literals.IFC_BSPLINE_CURVE__DEGREE, newDegree);
	}
	...
	public EList<IfcCartesianPoint> getControlPointsList() {
		return (EList<IfcCartesianPoint>) eGet(LogPackage.Literals.IFC_BSPLINE_CURVE__CONTROL_POINTS_LIST, true);
	}
	...
	public IfcBSplineCurveForm getCurveForm() {
		return (IfcBSplineCurveForm) eGet(LogPackage.Literals.IFC_BSPLINE_CURVE__CURVE_FORM, true);
	}
	...
	public void setCurveForm(IfcBSplineCurveForm newCurveForm) {
		eSet(LogPackage.Literals.IFC_BSPLINE_CURVE__CURVE_FORM, newCurveForm);
	}
	...
	public boolean isClosedCurve() {
		return (Boolean) eGet(LogPackage.Literals.IFC_BSPLINE_CURVE__CLOSED_CURVE, true);
	}
	...
	public void setClosedCurve(boolean newClosedCurve) {
		eSet(LogPackage.Literals.IFC_BSPLINE_CURVE__CLOSED_CURVE, newClosedCurve);
	}
	...
	public boolean isSelfIntersect() {
		return (Boolean) eGet(LogPackage.Literals.IFC_BSPLINE_CURVE__SELF_INTERSECT, true);
	}
	...
	public void setSelfIntersect(boolean newSelfIntersect) {
		eSet(LogPackage.Literals.IFC_BSPLINE_CURVE__SELF_INTERSECT, newSelfIntersect);
	}
