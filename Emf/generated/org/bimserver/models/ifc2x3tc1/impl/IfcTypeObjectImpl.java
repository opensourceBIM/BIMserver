...
public class IfcTypeObjectImpl extends IfcObjectDefinitionImpl implements IfcTypeObject {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TYPE_OBJECT;
	}
	...
	public String getApplicableOccurrence() {
		return (String) eGet(LogPackage.Literals.IFC_TYPE_OBJECT__APPLICABLE_OCCURRENCE, true);
	}
	...
	public void setApplicableOccurrence(String newApplicableOccurrence) {
		eSet(LogPackage.Literals.IFC_TYPE_OBJECT__APPLICABLE_OCCURRENCE, newApplicableOccurrence);
	}
	...
	public void unsetApplicableOccurrence() {
		eUnset(LogPackage.Literals.IFC_TYPE_OBJECT__APPLICABLE_OCCURRENCE);
	}
	...
	public boolean isSetApplicableOccurrence() {
		return eIsSet(LogPackage.Literals.IFC_TYPE_OBJECT__APPLICABLE_OCCURRENCE);
	}
	...
	public EList<IfcPropertySetDefinition> getHasPropertySets() {
		return (EList<IfcPropertySetDefinition>) eGet(LogPackage.Literals.IFC_TYPE_OBJECT__HAS_PROPERTY_SETS, true);
	}
	...
	public void unsetHasPropertySets() {
		eUnset(LogPackage.Literals.IFC_TYPE_OBJECT__HAS_PROPERTY_SETS);
	}
	...
	public boolean isSetHasPropertySets() {
		return eIsSet(LogPackage.Literals.IFC_TYPE_OBJECT__HAS_PROPERTY_SETS);
	}
	...
	public EList<IfcRelDefinesByType> getObjectTypeOf() {
		return (EList<IfcRelDefinesByType>) eGet(LogPackage.Literals.IFC_TYPE_OBJECT__OBJECT_TYPE_OF, true);
	}
	...
	public void unsetObjectTypeOf() {
		eUnset(LogPackage.Literals.IFC_TYPE_OBJECT__OBJECT_TYPE_OF);
	}
	...
	public boolean isSetObjectTypeOf() {
		return eIsSet(LogPackage.Literals.IFC_TYPE_OBJECT__OBJECT_TYPE_OF);
	}
