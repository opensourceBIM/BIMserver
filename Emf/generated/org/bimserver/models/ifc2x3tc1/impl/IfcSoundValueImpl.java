...
public class IfcSoundValueImpl extends IfcPropertySetDefinitionImpl implements IfcSoundValue {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SOUND_VALUE;
	}
	...
	public IfcTimeSeries getSoundLevelTimeSeries() {
		return (IfcTimeSeries) eGet(LogPackage.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_TIME_SERIES, true);
	}
	...
	public void setSoundLevelTimeSeries(IfcTimeSeries newSoundLevelTimeSeries) {
		eSet(LogPackage.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_TIME_SERIES, newSoundLevelTimeSeries);
	}
	...
	public void unsetSoundLevelTimeSeries() {
		eUnset(LogPackage.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_TIME_SERIES);
	}
	...
	public boolean isSetSoundLevelTimeSeries() {
		return eIsSet(LogPackage.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_TIME_SERIES);
	}
	...
	public double getFrequency() {
		return (Double) eGet(LogPackage.Literals.IFC_SOUND_VALUE__FREQUENCY, true);
	}
	...
	public void setFrequency(double newFrequency) {
		eSet(LogPackage.Literals.IFC_SOUND_VALUE__FREQUENCY, newFrequency);
	}
	...
	public String getFrequencyAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SOUND_VALUE__FREQUENCY_AS_STRING, true);
	}
	...
	public void setFrequencyAsString(String newFrequencyAsString) {
		eSet(LogPackage.Literals.IFC_SOUND_VALUE__FREQUENCY_AS_STRING, newFrequencyAsString);
	}
	...
	public IfcDerivedMeasureValue getSoundLevelSingleValue() {
		return (IfcDerivedMeasureValue) eGet(LogPackage.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_SINGLE_VALUE, true);
	}
	...
	public void setSoundLevelSingleValue(IfcDerivedMeasureValue newSoundLevelSingleValue) {
		eSet(LogPackage.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_SINGLE_VALUE, newSoundLevelSingleValue);
	}
	...
	public void unsetSoundLevelSingleValue() {
		eUnset(LogPackage.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_SINGLE_VALUE);
	}
	...
	public boolean isSetSoundLevelSingleValue() {
		return eIsSet(LogPackage.Literals.IFC_SOUND_VALUE__SOUND_LEVEL_SINGLE_VALUE);
	}
