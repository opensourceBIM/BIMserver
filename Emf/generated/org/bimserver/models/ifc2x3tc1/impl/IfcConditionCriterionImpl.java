...
public class IfcConditionCriterionImpl extends IfcControlImpl implements IfcConditionCriterion {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONDITION_CRITERION;
	}
	...
	public IfcConditionCriterionSelect getCriterion() {
		return (IfcConditionCriterionSelect) eGet(LogPackage.Literals.IFC_CONDITION_CRITERION__CRITERION, true);
	}
	...
	public void setCriterion(IfcConditionCriterionSelect newCriterion) {
		eSet(LogPackage.Literals.IFC_CONDITION_CRITERION__CRITERION, newCriterion);
	}
	...
	public IfcDateTimeSelect getCriterionDateTime() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_CONDITION_CRITERION__CRITERION_DATE_TIME, true);
	}
	...
	public void setCriterionDateTime(IfcDateTimeSelect newCriterionDateTime) {
		eSet(LogPackage.Literals.IFC_CONDITION_CRITERION__CRITERION_DATE_TIME, newCriterionDateTime);
	}
