...
public class IfcSwitchingDeviceTypeImpl extends IfcFlowControllerTypeImpl implements IfcSwitchingDeviceType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SWITCHING_DEVICE_TYPE;
	}
	...
	public IfcSwitchingDeviceTypeEnum getPredefinedType() {
		return (IfcSwitchingDeviceTypeEnum) eGet(LogPackage.Literals.IFC_SWITCHING_DEVICE_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSwitchingDeviceTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_SWITCHING_DEVICE_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
