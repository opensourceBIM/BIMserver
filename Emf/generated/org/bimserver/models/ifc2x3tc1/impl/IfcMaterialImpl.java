...
public class IfcMaterialImpl extends IdEObjectImpl implements IfcMaterial {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MATERIAL;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_MATERIAL__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_MATERIAL__NAME, newName);
	}
	...
	public EList<IfcMaterialDefinitionRepresentation> getHasRepresentation() {
		return (EList<IfcMaterialDefinitionRepresentation>) eGet(LogPackage.Literals.IFC_MATERIAL__HAS_REPRESENTATION, true);
	}
	...
	public void unsetHasRepresentation() {
		eUnset(LogPackage.Literals.IFC_MATERIAL__HAS_REPRESENTATION);
	}
	...
	public boolean isSetHasRepresentation() {
		return eIsSet(LogPackage.Literals.IFC_MATERIAL__HAS_REPRESENTATION);
	}
	...
	public EList<IfcMaterialClassificationRelationship> getClassifiedAs() {
		return (EList<IfcMaterialClassificationRelationship>) eGet(LogPackage.Literals.IFC_MATERIAL__CLASSIFIED_AS, true);
	}
	...
	public void unsetClassifiedAs() {
		eUnset(LogPackage.Literals.IFC_MATERIAL__CLASSIFIED_AS);
	}
	...
	public boolean isSetClassifiedAs() {
		return eIsSet(LogPackage.Literals.IFC_MATERIAL__CLASSIFIED_AS);
	}
