...
public class IfcFlowMeterTypeImpl extends IfcFlowControllerTypeImpl implements IfcFlowMeterType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_FLOW_METER_TYPE;
	}
	...
	public IfcFlowMeterTypeEnum getPredefinedType() {
		return (IfcFlowMeterTypeEnum) eGet(LogPackage.Literals.IFC_FLOW_METER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcFlowMeterTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_FLOW_METER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
