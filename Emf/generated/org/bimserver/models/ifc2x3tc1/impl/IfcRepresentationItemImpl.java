...
public class IfcRepresentationItemImpl extends IdEObjectImpl implements IfcRepresentationItem {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REPRESENTATION_ITEM;
	}
	...
	public EList<IfcPresentationLayerAssignment> getLayerAssignments() {
		return (EList<IfcPresentationLayerAssignment>) eGet(LogPackage.Literals.IFC_REPRESENTATION_ITEM__LAYER_ASSIGNMENTS, true);
	}
	...
	public void unsetLayerAssignments() {
		eUnset(LogPackage.Literals.IFC_REPRESENTATION_ITEM__LAYER_ASSIGNMENTS);
	}
	...
	public boolean isSetLayerAssignments() {
		return eIsSet(LogPackage.Literals.IFC_REPRESENTATION_ITEM__LAYER_ASSIGNMENTS);
	}
	...
	public EList<IfcStyledItem> getStyledByItem() {
		return (EList<IfcStyledItem>) eGet(LogPackage.Literals.IFC_REPRESENTATION_ITEM__STYLED_BY_ITEM, true);
	}
	...
	public void unsetStyledByItem() {
		eUnset(LogPackage.Literals.IFC_REPRESENTATION_ITEM__STYLED_BY_ITEM);
	}
	...
	public boolean isSetStyledByItem() {
		return eIsSet(LogPackage.Literals.IFC_REPRESENTATION_ITEM__STYLED_BY_ITEM);
	}
