...
public class IfcNamedUnitImpl extends IdEObjectImpl implements IfcNamedUnit {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_NAMED_UNIT;
	}
	...
	public IfcDimensionalExponents getDimensions() {
		return (IfcDimensionalExponents) eGet(LogPackage.Literals.IFC_NAMED_UNIT__DIMENSIONS, true);
	}
	...
	public void setDimensions(IfcDimensionalExponents newDimensions) {
		eSet(LogPackage.Literals.IFC_NAMED_UNIT__DIMENSIONS, newDimensions);
	}
	...
	public IfcUnitEnum getUnitType() {
		return (IfcUnitEnum) eGet(LogPackage.Literals.IFC_NAMED_UNIT__UNIT_TYPE, true);
	}
	...
	public void setUnitType(IfcUnitEnum newUnitType) {
		eSet(LogPackage.Literals.IFC_NAMED_UNIT__UNIT_TYPE, newUnitType);
	}
