...
public class IfcElementAssemblyImpl extends IfcElementImpl implements IfcElementAssembly {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ELEMENT_ASSEMBLY;
	}
	...
	public IfcAssemblyPlaceEnum getAssemblyPlace() {
		return (IfcAssemblyPlaceEnum) eGet(LogPackage.Literals.IFC_ELEMENT_ASSEMBLY__ASSEMBLY_PLACE, true);
	}
	...
	public void setAssemblyPlace(IfcAssemblyPlaceEnum newAssemblyPlace) {
		eSet(LogPackage.Literals.IFC_ELEMENT_ASSEMBLY__ASSEMBLY_PLACE, newAssemblyPlace);
	}
	...
	public void unsetAssemblyPlace() {
		eUnset(LogPackage.Literals.IFC_ELEMENT_ASSEMBLY__ASSEMBLY_PLACE);
	}
	...
	public boolean isSetAssemblyPlace() {
		return eIsSet(LogPackage.Literals.IFC_ELEMENT_ASSEMBLY__ASSEMBLY_PLACE);
	}
	...
	public IfcElementAssemblyTypeEnum getPredefinedType() {
		return (IfcElementAssemblyTypeEnum) eGet(LogPackage.Literals.IFC_ELEMENT_ASSEMBLY__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcElementAssemblyTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_ELEMENT_ASSEMBLY__PREDEFINED_TYPE, newPredefinedType);
	}
