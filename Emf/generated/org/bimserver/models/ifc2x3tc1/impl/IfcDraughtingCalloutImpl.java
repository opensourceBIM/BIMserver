...
public class IfcDraughtingCalloutImpl extends IfcGeometricRepresentationItemImpl implements IfcDraughtingCallout {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DRAUGHTING_CALLOUT;
	}
	...
	public EList<IfcDraughtingCalloutElement> getContents() {
		return (EList<IfcDraughtingCalloutElement>) eGet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT__CONTENTS, true);
	}
	...
	public EList<IfcDraughtingCalloutRelationship> getIsRelatedFromCallout() {
		return (EList<IfcDraughtingCalloutRelationship>) eGet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT__IS_RELATED_FROM_CALLOUT, true);
	}
	...
	public void unsetIsRelatedFromCallout() {
		eUnset(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT__IS_RELATED_FROM_CALLOUT);
	}
	...
	public boolean isSetIsRelatedFromCallout() {
		return eIsSet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT__IS_RELATED_FROM_CALLOUT);
	}
	...
	public EList<IfcDraughtingCalloutRelationship> getIsRelatedToCallout() {
		return (EList<IfcDraughtingCalloutRelationship>) eGet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT__IS_RELATED_TO_CALLOUT, true);
	}
	...
	public void unsetIsRelatedToCallout() {
		eUnset(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT__IS_RELATED_TO_CALLOUT);
	}
	...
	public boolean isSetIsRelatedToCallout() {
		return eIsSet(LogPackage.Literals.IFC_DRAUGHTING_CALLOUT__IS_RELATED_TO_CALLOUT);
	}
