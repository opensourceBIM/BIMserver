...
public class IfcGeometricRepresentationSubContextImpl extends IfcGeometricRepresentationContextImpl implements IfcGeometricRepresentationSubContext {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT;
	}
	...
	public IfcGeometricRepresentationContext getParentContext() {
		return (IfcGeometricRepresentationContext) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__PARENT_CONTEXT, true);
	}
	...
	public void setParentContext(IfcGeometricRepresentationContext newParentContext) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__PARENT_CONTEXT, newParentContext);
	}
	...
	public double getTargetScale() {
		return (Double) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_SCALE, true);
	}
	...
	public void setTargetScale(double newTargetScale) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_SCALE, newTargetScale);
	}
	...
	public void unsetTargetScale() {
		eUnset(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_SCALE);
	}
	...
	public boolean isSetTargetScale() {
		return eIsSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_SCALE);
	}
	...
	public String getTargetScaleAsString() {
		return (String) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_SCALE_AS_STRING, true);
	}
	...
	public void setTargetScaleAsString(String newTargetScaleAsString) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_SCALE_AS_STRING, newTargetScaleAsString);
	}
	...
	public void unsetTargetScaleAsString() {
		eUnset(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_SCALE_AS_STRING);
	}
	...
	public boolean isSetTargetScaleAsString() {
		return eIsSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_SCALE_AS_STRING);
	}
	...
	public IfcGeometricProjectionEnum getTargetView() {
		return (IfcGeometricProjectionEnum) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_VIEW, true);
	}
	...
	public void setTargetView(IfcGeometricProjectionEnum newTargetView) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__TARGET_VIEW, newTargetView);
	}
	...
	public String getUserDefinedTargetView() {
		return (String) eGet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__USER_DEFINED_TARGET_VIEW, true);
	}
	...
	public void setUserDefinedTargetView(String newUserDefinedTargetView) {
		eSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__USER_DEFINED_TARGET_VIEW, newUserDefinedTargetView);
	}
	...
	public void unsetUserDefinedTargetView() {
		eUnset(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__USER_DEFINED_TARGET_VIEW);
	}
	...
	public boolean isSetUserDefinedTargetView() {
		return eIsSet(LogPackage.Literals.IFC_GEOMETRIC_REPRESENTATION_SUB_CONTEXT__USER_DEFINED_TARGET_VIEW);
	}
