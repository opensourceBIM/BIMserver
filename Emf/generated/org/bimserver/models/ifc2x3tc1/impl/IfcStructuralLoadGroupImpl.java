...
public class IfcStructuralLoadGroupImpl extends IfcGroupImpl implements IfcStructuralLoadGroup {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP;
	}
	...
	public IfcLoadGroupTypeEnum getPredefinedType() {
		return (IfcLoadGroupTypeEnum) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcLoadGroupTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public IfcActionTypeEnum getActionType() {
		return (IfcActionTypeEnum) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__ACTION_TYPE, true);
	}
	...
	public void setActionType(IfcActionTypeEnum newActionType) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__ACTION_TYPE, newActionType);
	}
	...
	public IfcActionSourceTypeEnum getActionSource() {
		return (IfcActionSourceTypeEnum) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__ACTION_SOURCE, true);
	}
	...
	public void setActionSource(IfcActionSourceTypeEnum newActionSource) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__ACTION_SOURCE, newActionSource);
	}
	...
	public double getCoefficient() {
		return (Double) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__COEFFICIENT, true);
	}
	...
	public void setCoefficient(double newCoefficient) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__COEFFICIENT, newCoefficient);
	}
	...
	public void unsetCoefficient() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__COEFFICIENT);
	}
	...
	public boolean isSetCoefficient() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__COEFFICIENT);
	}
	...
	public String getCoefficientAsString() {
		return (String) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__COEFFICIENT_AS_STRING, true);
	}
	...
	public void setCoefficientAsString(String newCoefficientAsString) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__COEFFICIENT_AS_STRING, newCoefficientAsString);
	}
	...
	public void unsetCoefficientAsString() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__COEFFICIENT_AS_STRING);
	}
	...
	public boolean isSetCoefficientAsString() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__COEFFICIENT_AS_STRING);
	}
	...
	public String getPurpose() {
		return (String) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__PURPOSE, true);
	}
	...
	public void setPurpose(String newPurpose) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__PURPOSE, newPurpose);
	}
	...
	public void unsetPurpose() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__PURPOSE);
	}
	...
	public boolean isSetPurpose() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__PURPOSE);
	}
	...
	public EList<IfcStructuralResultGroup> getSourceOfResultGroup() {
		return (EList<IfcStructuralResultGroup>) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__SOURCE_OF_RESULT_GROUP, true);
	}
	...
	public void unsetSourceOfResultGroup() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__SOURCE_OF_RESULT_GROUP);
	}
	...
	public boolean isSetSourceOfResultGroup() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__SOURCE_OF_RESULT_GROUP);
	}
	...
	public EList<IfcStructuralAnalysisModel> getLoadGroupFor() {
		return (EList<IfcStructuralAnalysisModel>) eGet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__LOAD_GROUP_FOR, true);
	}
	...
	public void unsetLoadGroupFor() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__LOAD_GROUP_FOR);
	}
	...
	public boolean isSetLoadGroupFor() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_LOAD_GROUP__LOAD_GROUP_FOR);
	}
