...
public class IfcOffsetCurve3DImpl extends IfcCurveImpl implements IfcOffsetCurve3D {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_OFFSET_CURVE3_D;
	}
	...
	public IfcCurve getBasisCurve() {
		return (IfcCurve) eGet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__BASIS_CURVE, true);
	}
	...
	public void setBasisCurve(IfcCurve newBasisCurve) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__BASIS_CURVE, newBasisCurve);
	}
	...
	public double getDistance() {
		return (Double) eGet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__DISTANCE, true);
	}
	...
	public void setDistance(double newDistance) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__DISTANCE, newDistance);
	}
	...
	public String getDistanceAsString() {
		return (String) eGet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__DISTANCE_AS_STRING, true);
	}
	...
	public void setDistanceAsString(String newDistanceAsString) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__DISTANCE_AS_STRING, newDistanceAsString);
	}
	...
	public boolean isSelfIntersect() {
		return (Boolean) eGet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__SELF_INTERSECT, true);
	}
	...
	public void setSelfIntersect(boolean newSelfIntersect) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__SELF_INTERSECT, newSelfIntersect);
	}
	...
	public IfcDirection getRefDirection() {
		return (IfcDirection) eGet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__REF_DIRECTION, true);
	}
	...
	public void setRefDirection(IfcDirection newRefDirection) {
		eSet(LogPackage.Literals.IFC_OFFSET_CURVE3_D__REF_DIRECTION, newRefDirection);
	}
