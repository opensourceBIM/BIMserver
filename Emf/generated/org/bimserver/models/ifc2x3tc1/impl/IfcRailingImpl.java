...
public class IfcRailingImpl extends IfcBuildingElementImpl implements IfcRailing {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RAILING;
	}
	...
	public IfcRailingTypeEnum getPredefinedType() {
		return (IfcRailingTypeEnum) eGet(LogPackage.Literals.IFC_RAILING__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcRailingTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_RAILING__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(LogPackage.Literals.IFC_RAILING__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(LogPackage.Literals.IFC_RAILING__PREDEFINED_TYPE);
	}
