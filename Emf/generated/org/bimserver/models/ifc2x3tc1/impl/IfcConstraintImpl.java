...
public class IfcConstraintImpl extends IdEObjectImpl implements IfcConstraint {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONSTRAINT;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_CONSTRAINT__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT__NAME, newName);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_CONSTRAINT__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__DESCRIPTION);
	}
	...
	public IfcConstraintEnum getConstraintGrade() {
		return (IfcConstraintEnum) eGet(LogPackage.Literals.IFC_CONSTRAINT__CONSTRAINT_GRADE, true);
	}
	...
	public void setConstraintGrade(IfcConstraintEnum newConstraintGrade) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT__CONSTRAINT_GRADE, newConstraintGrade);
	}
	...
	public String getConstraintSource() {
		return (String) eGet(LogPackage.Literals.IFC_CONSTRAINT__CONSTRAINT_SOURCE, true);
	}
	...
	public void setConstraintSource(String newConstraintSource) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT__CONSTRAINT_SOURCE, newConstraintSource);
	}
	...
	public void unsetConstraintSource() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__CONSTRAINT_SOURCE);
	}
	...
	public boolean isSetConstraintSource() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__CONSTRAINT_SOURCE);
	}
	...
	public IfcActorSelect getCreatingActor() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_CONSTRAINT__CREATING_ACTOR, true);
	}
	...
	public void setCreatingActor(IfcActorSelect newCreatingActor) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT__CREATING_ACTOR, newCreatingActor);
	}
	...
	public void unsetCreatingActor() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__CREATING_ACTOR);
	}
	...
	public boolean isSetCreatingActor() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__CREATING_ACTOR);
	}
	...
	public IfcDateTimeSelect getCreationTime() {
		return (IfcDateTimeSelect) eGet(LogPackage.Literals.IFC_CONSTRAINT__CREATION_TIME, true);
	}
	...
	public void setCreationTime(IfcDateTimeSelect newCreationTime) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT__CREATION_TIME, newCreationTime);
	}
	...
	public void unsetCreationTime() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__CREATION_TIME);
	}
	...
	public boolean isSetCreationTime() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__CREATION_TIME);
	}
	...
	public String getUserDefinedGrade() {
		return (String) eGet(LogPackage.Literals.IFC_CONSTRAINT__USER_DEFINED_GRADE, true);
	}
	...
	public void setUserDefinedGrade(String newUserDefinedGrade) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT__USER_DEFINED_GRADE, newUserDefinedGrade);
	}
	...
	public void unsetUserDefinedGrade() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__USER_DEFINED_GRADE);
	}
	...
	public boolean isSetUserDefinedGrade() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__USER_DEFINED_GRADE);
	}
	...
	public EList<IfcConstraintClassificationRelationship> getClassifiedAs() {
		return (EList<IfcConstraintClassificationRelationship>) eGet(LogPackage.Literals.IFC_CONSTRAINT__CLASSIFIED_AS, true);
	}
	...
	public void unsetClassifiedAs() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__CLASSIFIED_AS);
	}
	...
	public boolean isSetClassifiedAs() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__CLASSIFIED_AS);
	}
	...
	public EList<IfcConstraintRelationship> getRelatesConstraints() {
		return (EList<IfcConstraintRelationship>) eGet(LogPackage.Literals.IFC_CONSTRAINT__RELATES_CONSTRAINTS, true);
	}
	...
	public void unsetRelatesConstraints() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__RELATES_CONSTRAINTS);
	}
	...
	public boolean isSetRelatesConstraints() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__RELATES_CONSTRAINTS);
	}
	...
	public EList<IfcConstraintRelationship> getIsRelatedWith() {
		return (EList<IfcConstraintRelationship>) eGet(LogPackage.Literals.IFC_CONSTRAINT__IS_RELATED_WITH, true);
	}
	...
	public void unsetIsRelatedWith() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__IS_RELATED_WITH);
	}
	...
	public boolean isSetIsRelatedWith() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__IS_RELATED_WITH);
	}
	...
	public EList<IfcPropertyConstraintRelationship> getPropertiesForConstraint() {
		return (EList<IfcPropertyConstraintRelationship>) eGet(LogPackage.Literals.IFC_CONSTRAINT__PROPERTIES_FOR_CONSTRAINT, true);
	}
	...
	public void unsetPropertiesForConstraint() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__PROPERTIES_FOR_CONSTRAINT);
	}
	...
	public boolean isSetPropertiesForConstraint() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__PROPERTIES_FOR_CONSTRAINT);
	}
	...
	public EList<IfcConstraintAggregationRelationship> getAggregates() {
		return (EList<IfcConstraintAggregationRelationship>) eGet(LogPackage.Literals.IFC_CONSTRAINT__AGGREGATES, true);
	}
	...
	public void unsetAggregates() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__AGGREGATES);
	}
	...
	public boolean isSetAggregates() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__AGGREGATES);
	}
	...
	public EList<IfcConstraintAggregationRelationship> getIsAggregatedIn() {
		return (EList<IfcConstraintAggregationRelationship>) eGet(LogPackage.Literals.IFC_CONSTRAINT__IS_AGGREGATED_IN, true);
	}
	...
	public void unsetIsAggregatedIn() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT__IS_AGGREGATED_IN);
	}
	...
	public boolean isSetIsAggregatedIn() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT__IS_AGGREGATED_IN);
	}
