...
public class IfcApprovalActorRelationshipImpl extends IdEObjectImpl implements IfcApprovalActorRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_APPROVAL_ACTOR_RELATIONSHIP;
	}
	...
	public IfcActorSelect getActor() {
		return (IfcActorSelect) eGet(LogPackage.Literals.IFC_APPROVAL_ACTOR_RELATIONSHIP__ACTOR, true);
	}
	...
	public void setActor(IfcActorSelect newActor) {
		eSet(LogPackage.Literals.IFC_APPROVAL_ACTOR_RELATIONSHIP__ACTOR, newActor);
	}
	...
	public IfcApproval getApproval() {
		return (IfcApproval) eGet(LogPackage.Literals.IFC_APPROVAL_ACTOR_RELATIONSHIP__APPROVAL, true);
	}
	...
	public void setApproval(IfcApproval newApproval) {
		eSet(LogPackage.Literals.IFC_APPROVAL_ACTOR_RELATIONSHIP__APPROVAL, newApproval);
	}
	...
	public IfcActorRole getRole() {
		return (IfcActorRole) eGet(LogPackage.Literals.IFC_APPROVAL_ACTOR_RELATIONSHIP__ROLE, true);
	}
	...
	public void setRole(IfcActorRole newRole) {
		eSet(LogPackage.Literals.IFC_APPROVAL_ACTOR_RELATIONSHIP__ROLE, newRole);
	}
