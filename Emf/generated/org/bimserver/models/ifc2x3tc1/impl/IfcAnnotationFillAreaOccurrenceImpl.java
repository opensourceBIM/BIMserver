...
public class IfcAnnotationFillAreaOccurrenceImpl extends IfcAnnotationOccurrenceImpl implements IfcAnnotationFillAreaOccurrence {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE;
	}
	...
	public IfcPoint getFillStyleTarget() {
		return (IfcPoint) eGet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE__FILL_STYLE_TARGET, true);
	}
	...
	public void setFillStyleTarget(IfcPoint newFillStyleTarget) {
		eSet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE__FILL_STYLE_TARGET, newFillStyleTarget);
	}
	...
	public void unsetFillStyleTarget() {
		eUnset(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE__FILL_STYLE_TARGET);
	}
	...
	public boolean isSetFillStyleTarget() {
		return eIsSet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE__FILL_STYLE_TARGET);
	}
	...
	public IfcGlobalOrLocalEnum getGlobalOrLocal() {
		return (IfcGlobalOrLocalEnum) eGet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE__GLOBAL_OR_LOCAL, true);
	}
	...
	public void setGlobalOrLocal(IfcGlobalOrLocalEnum newGlobalOrLocal) {
		eSet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE__GLOBAL_OR_LOCAL, newGlobalOrLocal);
	}
	...
	public void unsetGlobalOrLocal() {
		eUnset(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE__GLOBAL_OR_LOCAL);
	}
	...
	public boolean isSetGlobalOrLocal() {
		return eIsSet(LogPackage.Literals.IFC_ANNOTATION_FILL_AREA_OCCURRENCE__GLOBAL_OR_LOCAL);
	}
