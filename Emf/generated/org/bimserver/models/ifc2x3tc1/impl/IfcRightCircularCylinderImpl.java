...
public class IfcRightCircularCylinderImpl extends IfcCsgPrimitive3DImpl implements IfcRightCircularCylinder {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER;
	}
	...
	public double getHeight() {
		return (Double) eGet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER__HEIGHT, true);
	}
	...
	public void setHeight(double newHeight) {
		eSet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER__HEIGHT, newHeight);
	}
	...
	public String getHeightAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER__HEIGHT_AS_STRING, true);
	}
	...
	public void setHeightAsString(String newHeightAsString) {
		eSet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER__HEIGHT_AS_STRING, newHeightAsString);
	}
	...
	public double getRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER__RADIUS, true);
	}
	...
	public void setRadius(double newRadius) {
		eSet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER__RADIUS, newRadius);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER__RADIUS_AS_STRING, true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(LogPackage.Literals.IFC_RIGHT_CIRCULAR_CYLINDER__RADIUS_AS_STRING, newRadiusAsString);
	}
