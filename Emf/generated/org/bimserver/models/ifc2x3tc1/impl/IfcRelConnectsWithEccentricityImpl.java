...
public class IfcRelConnectsWithEccentricityImpl extends IfcRelConnectsStructuralMemberImpl implements IfcRelConnectsWithEccentricity {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_CONNECTS_WITH_ECCENTRICITY;
	}
	...
	public IfcConnectionGeometry getConnectionConstraint() {
		return (IfcConnectionGeometry) eGet(LogPackage.Literals.IFC_REL_CONNECTS_WITH_ECCENTRICITY__CONNECTION_CONSTRAINT, true);
	}
	...
	public void setConnectionConstraint(IfcConnectionGeometry newConnectionConstraint) {
		eSet(LogPackage.Literals.IFC_REL_CONNECTS_WITH_ECCENTRICITY__CONNECTION_CONSTRAINT, newConnectionConstraint);
	}
