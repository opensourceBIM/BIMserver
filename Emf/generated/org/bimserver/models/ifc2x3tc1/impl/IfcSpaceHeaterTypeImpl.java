...
public class IfcSpaceHeaterTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcSpaceHeaterType {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SPACE_HEATER_TYPE;
	}
	...
	public IfcSpaceHeaterTypeEnum getPredefinedType() {
		return (IfcSpaceHeaterTypeEnum) eGet(LogPackage.Literals.IFC_SPACE_HEATER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcSpaceHeaterTypeEnum newPredefinedType) {
		eSet(LogPackage.Literals.IFC_SPACE_HEATER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
