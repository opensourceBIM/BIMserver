...
public class IfcStructuralConnectionConditionImpl extends IdEObjectImpl implements IfcStructuralConnectionCondition {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_STRUCTURAL_CONNECTION_CONDITION;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION_CONDITION__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION_CONDITION__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION_CONDITION__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_STRUCTURAL_CONNECTION_CONDITION__NAME);
	}
