...
public class IfcSphereImpl extends IfcCsgPrimitive3DImpl implements IfcSphere {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SPHERE;
	}
	...
	public double getRadius() {
		return (Double) eGet(LogPackage.Literals.IFC_SPHERE__RADIUS, true);
	}
	...
	public void setRadius(double newRadius) {
		eSet(LogPackage.Literals.IFC_SPHERE__RADIUS, newRadius);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(LogPackage.Literals.IFC_SPHERE__RADIUS_AS_STRING, true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(LogPackage.Literals.IFC_SPHERE__RADIUS_AS_STRING, newRadiusAsString);
	}
