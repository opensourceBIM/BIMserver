...
public class IfcRelAssociatesDocumentImpl extends IfcRelAssociatesImpl implements IfcRelAssociatesDocument {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REL_ASSOCIATES_DOCUMENT;
	}
	...
	public IfcDocumentSelect getRelatingDocument() {
		return (IfcDocumentSelect) eGet(LogPackage.Literals.IFC_REL_ASSOCIATES_DOCUMENT__RELATING_DOCUMENT, true);
	}
	...
	public void setRelatingDocument(IfcDocumentSelect newRelatingDocument) {
		eSet(LogPackage.Literals.IFC_REL_ASSOCIATES_DOCUMENT__RELATING_DOCUMENT, newRelatingDocument);
	}
