...
public class IfcConstraintRelationshipImpl extends IdEObjectImpl implements IfcConstraintRelationship {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP;
	}
	...
	public String getName() {
		return (String) eGet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__NAME, newName);
	}
	...
	public void unsetName() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__NAME);
	}
	...
	public boolean isSetName() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__NAME);
	}
	...
	public String getDescription() {
		return (String) eGet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__DESCRIPTION);
	}
	...
	public IfcConstraint getRelatingConstraint() {
		return (IfcConstraint) eGet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__RELATING_CONSTRAINT, true);
	}
	...
	public void setRelatingConstraint(IfcConstraint newRelatingConstraint) {
		eSet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__RELATING_CONSTRAINT, newRelatingConstraint);
	}
	...
	public EList<IfcConstraint> getRelatedConstraints() {
		return (EList<IfcConstraint>) eGet(LogPackage.Literals.IFC_CONSTRAINT_RELATIONSHIP__RELATED_CONSTRAINTS, true);
	}
