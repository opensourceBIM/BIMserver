...
public class IfcManifoldSolidBrepImpl extends IfcSolidModelImpl implements IfcManifoldSolidBrep {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_MANIFOLD_SOLID_BREP;
	}
	...
	public IfcClosedShell getOuter() {
		return (IfcClosedShell) eGet(LogPackage.Literals.IFC_MANIFOLD_SOLID_BREP__OUTER, true);
	}
	...
	public void setOuter(IfcClosedShell newOuter) {
		eSet(LogPackage.Literals.IFC_MANIFOLD_SOLID_BREP__OUTER, newOuter);
	}
