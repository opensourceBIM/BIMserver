...
public class IfcSectionPropertiesImpl extends IdEObjectImpl implements IfcSectionProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_SECTION_PROPERTIES;
	}
	...
	public IfcSectionTypeEnum getSectionType() {
		return (IfcSectionTypeEnum) eGet(LogPackage.Literals.IFC_SECTION_PROPERTIES__SECTION_TYPE, true);
	}
	...
	public void setSectionType(IfcSectionTypeEnum newSectionType) {
		eSet(LogPackage.Literals.IFC_SECTION_PROPERTIES__SECTION_TYPE, newSectionType);
	}
	...
	public IfcProfileDef getStartProfile() {
		return (IfcProfileDef) eGet(LogPackage.Literals.IFC_SECTION_PROPERTIES__START_PROFILE, true);
	}
	...
	public void setStartProfile(IfcProfileDef newStartProfile) {
		eSet(LogPackage.Literals.IFC_SECTION_PROPERTIES__START_PROFILE, newStartProfile);
	}
	...
	public IfcProfileDef getEndProfile() {
		return (IfcProfileDef) eGet(LogPackage.Literals.IFC_SECTION_PROPERTIES__END_PROFILE, true);
	}
	...
	public void setEndProfile(IfcProfileDef newEndProfile) {
		eSet(LogPackage.Literals.IFC_SECTION_PROPERTIES__END_PROFILE, newEndProfile);
	}
	...
	public void unsetEndProfile() {
		eUnset(LogPackage.Literals.IFC_SECTION_PROPERTIES__END_PROFILE);
	}
	...
	public boolean isSetEndProfile() {
		return eIsSet(LogPackage.Literals.IFC_SECTION_PROPERTIES__END_PROFILE);
	}
