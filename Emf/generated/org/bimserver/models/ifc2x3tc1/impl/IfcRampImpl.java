...
public class IfcRampImpl extends IfcBuildingElementImpl implements IfcRamp {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_RAMP;
	}
	...
	public IfcRampTypeEnum getShapeType() {
		return (IfcRampTypeEnum) eGet(LogPackage.Literals.IFC_RAMP__SHAPE_TYPE, true);
	}
	...
	public void setShapeType(IfcRampTypeEnum newShapeType) {
		eSet(LogPackage.Literals.IFC_RAMP__SHAPE_TYPE, newShapeType);
	}
