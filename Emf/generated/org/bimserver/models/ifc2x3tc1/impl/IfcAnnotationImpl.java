...
public class IfcAnnotationImpl extends IfcProductImpl implements IfcAnnotation {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_ANNOTATION;
	}
	...
	public EList<IfcRelContainedInSpatialStructure> getContainedInStructure() {
		return (EList<IfcRelContainedInSpatialStructure>) eGet(LogPackage.Literals.IFC_ANNOTATION__CONTAINED_IN_STRUCTURE, true);
	}
	...
	public void unsetContainedInStructure() {
		eUnset(LogPackage.Literals.IFC_ANNOTATION__CONTAINED_IN_STRUCTURE);
	}
	...
	public boolean isSetContainedInStructure() {
		return eIsSet(LogPackage.Literals.IFC_ANNOTATION__CONTAINED_IN_STRUCTURE);
	}
