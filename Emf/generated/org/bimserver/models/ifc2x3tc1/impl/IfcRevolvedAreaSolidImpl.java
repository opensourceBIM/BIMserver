...
public class IfcRevolvedAreaSolidImpl extends IfcSweptAreaSolidImpl implements IfcRevolvedAreaSolid {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_REVOLVED_AREA_SOLID;
	}
	...
	public IfcAxis1Placement getAxis() {
		return (IfcAxis1Placement) eGet(LogPackage.Literals.IFC_REVOLVED_AREA_SOLID__AXIS, true);
	}
	...
	public void setAxis(IfcAxis1Placement newAxis) {
		eSet(LogPackage.Literals.IFC_REVOLVED_AREA_SOLID__AXIS, newAxis);
	}
	...
	public double getAngle() {
		return (Double) eGet(LogPackage.Literals.IFC_REVOLVED_AREA_SOLID__ANGLE, true);
	}
	...
	public void setAngle(double newAngle) {
		eSet(LogPackage.Literals.IFC_REVOLVED_AREA_SOLID__ANGLE, newAngle);
	}
	...
	public String getAngleAsString() {
		return (String) eGet(LogPackage.Literals.IFC_REVOLVED_AREA_SOLID__ANGLE_AS_STRING, true);
	}
	...
	public void setAngleAsString(String newAngleAsString) {
		eSet(LogPackage.Literals.IFC_REVOLVED_AREA_SOLID__ANGLE_AS_STRING, newAngleAsString);
	}
