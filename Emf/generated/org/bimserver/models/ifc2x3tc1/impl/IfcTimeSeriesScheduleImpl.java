...
public class IfcTimeSeriesScheduleImpl extends IfcControlImpl implements IfcTimeSeriesSchedule {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_TIME_SERIES_SCHEDULE;
	}
	...
	public EList<IfcDateTimeSelect> getApplicableDates() {
		return (EList<IfcDateTimeSelect>) eGet(LogPackage.Literals.IFC_TIME_SERIES_SCHEDULE__APPLICABLE_DATES, true);
	}
	...
	public void unsetApplicableDates() {
		eUnset(LogPackage.Literals.IFC_TIME_SERIES_SCHEDULE__APPLICABLE_DATES);
	}
	...
	public boolean isSetApplicableDates() {
		return eIsSet(LogPackage.Literals.IFC_TIME_SERIES_SCHEDULE__APPLICABLE_DATES);
	}
	...
	public IfcTimeSeriesScheduleTypeEnum getTimeSeriesScheduleType() {
		return (IfcTimeSeriesScheduleTypeEnum) eGet(LogPackage.Literals.IFC_TIME_SERIES_SCHEDULE__TIME_SERIES_SCHEDULE_TYPE, true);
	}
	...
	public void setTimeSeriesScheduleType(IfcTimeSeriesScheduleTypeEnum newTimeSeriesScheduleType) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES_SCHEDULE__TIME_SERIES_SCHEDULE_TYPE, newTimeSeriesScheduleType);
	}
	...
	public IfcTimeSeries getTimeSeries() {
		return (IfcTimeSeries) eGet(LogPackage.Literals.IFC_TIME_SERIES_SCHEDULE__TIME_SERIES, true);
	}
	...
	public void setTimeSeries(IfcTimeSeries newTimeSeries) {
		eSet(LogPackage.Literals.IFC_TIME_SERIES_SCHEDULE__TIME_SERIES, newTimeSeries);
	}
