...
public class IfcDerivedUnitElementImpl extends IdEObjectImpl implements IfcDerivedUnitElement {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_DERIVED_UNIT_ELEMENT;
	}
	...
	public IfcNamedUnit getUnit() {
		return (IfcNamedUnit) eGet(LogPackage.Literals.IFC_DERIVED_UNIT_ELEMENT__UNIT, true);
	}
	...
	public void setUnit(IfcNamedUnit newUnit) {
		eSet(LogPackage.Literals.IFC_DERIVED_UNIT_ELEMENT__UNIT, newUnit);
	}
	...
	public int getExponent() {
		return (Integer) eGet(LogPackage.Literals.IFC_DERIVED_UNIT_ELEMENT__EXPONENT, true);
	}
	...
	public void setExponent(int newExponent) {
		eSet(LogPackage.Literals.IFC_DERIVED_UNIT_ELEMENT__EXPONENT, newExponent);
	}
