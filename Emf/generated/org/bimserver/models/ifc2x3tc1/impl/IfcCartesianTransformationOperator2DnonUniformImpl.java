...
public class IfcCartesianTransformationOperator2DnonUniformImpl extends IfcCartesianTransformationOperator2DImpl implements IfcCartesianTransformationOperator2DnonUniform {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM;
	}
	...
	public double getScale2() {
		return (Double) eGet(LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2, true);
	}
	...
	public void setScale2(double newScale2) {
		eSet(LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2, newScale2);
	}
	...
	public void unsetScale2() {
		eUnset(LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2);
	}
	...
	public boolean isSetScale2() {
		return eIsSet(LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2);
	}
	...
	public String getScale2AsString() {
		return (String) eGet(LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2_AS_STRING, true);
	}
	...
	public void setScale2AsString(String newScale2AsString) {
		eSet(LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2_AS_STRING, newScale2AsString);
	}
	...
	public void unsetScale2AsString() {
		eUnset(LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2_AS_STRING);
	}
	...
	public boolean isSetScale2AsString() {
		return eIsSet(LogPackage.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2_AS_STRING);
	}
