...
public class IfcCurveStyleFontPatternImpl extends IdEObjectImpl implements IfcCurveStyleFontPattern {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN;
	}
	...
	public double getVisibleSegmentLength() {
		return (Double) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN__VISIBLE_SEGMENT_LENGTH, true);
	}
	...
	public void setVisibleSegmentLength(double newVisibleSegmentLength) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN__VISIBLE_SEGMENT_LENGTH, newVisibleSegmentLength);
	}
	...
	public String getVisibleSegmentLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN__VISIBLE_SEGMENT_LENGTH_AS_STRING, true);
	}
	...
	public void setVisibleSegmentLengthAsString(String newVisibleSegmentLengthAsString) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN__VISIBLE_SEGMENT_LENGTH_AS_STRING, newVisibleSegmentLengthAsString);
	}
	...
	public double getInvisibleSegmentLength() {
		return (Double) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN__INVISIBLE_SEGMENT_LENGTH, true);
	}
	...
	public void setInvisibleSegmentLength(double newInvisibleSegmentLength) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN__INVISIBLE_SEGMENT_LENGTH, newInvisibleSegmentLength);
	}
	...
	public String getInvisibleSegmentLengthAsString() {
		return (String) eGet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN__INVISIBLE_SEGMENT_LENGTH_AS_STRING, true);
	}
	...
	public void setInvisibleSegmentLengthAsString(String newInvisibleSegmentLengthAsString) {
		eSet(LogPackage.Literals.IFC_CURVE_STYLE_FONT_PATTERN__INVISIBLE_SEGMENT_LENGTH_AS_STRING, newInvisibleSegmentLengthAsString);
	}
