...
public class IfcCompositeProfileDefImpl extends IfcProfileDefImpl implements IfcCompositeProfileDef {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_COMPOSITE_PROFILE_DEF;
	}
	...
	public EList<IfcProfileDef> getProfiles() {
		return (EList<IfcProfileDef>) eGet(LogPackage.Literals.IFC_COMPOSITE_PROFILE_DEF__PROFILES, true);
	}
	...
	public String getLabel() {
		return (String) eGet(LogPackage.Literals.IFC_COMPOSITE_PROFILE_DEF__LABEL, true);
	}
	...
	public void setLabel(String newLabel) {
		eSet(LogPackage.Literals.IFC_COMPOSITE_PROFILE_DEF__LABEL, newLabel);
	}
	...
	public void unsetLabel() {
		eUnset(LogPackage.Literals.IFC_COMPOSITE_PROFILE_DEF__LABEL);
	}
	...
	public boolean isSetLabel() {
		return eIsSet(LogPackage.Literals.IFC_COMPOSITE_PROFILE_DEF__LABEL);
	}
