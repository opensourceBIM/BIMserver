...
public class IfcProfilePropertiesImpl extends IdEObjectImpl implements IfcProfileProperties {
	...
	protected EClass eStaticClass() {
		return LogPackage.Literals.IFC_PROFILE_PROPERTIES;
	}
	...
	public String getProfileName() {
		return (String) eGet(LogPackage.Literals.IFC_PROFILE_PROPERTIES__PROFILE_NAME, true);
	}
	...
	public void setProfileName(String newProfileName) {
		eSet(LogPackage.Literals.IFC_PROFILE_PROPERTIES__PROFILE_NAME, newProfileName);
	}
	...
	public void unsetProfileName() {
		eUnset(LogPackage.Literals.IFC_PROFILE_PROPERTIES__PROFILE_NAME);
	}
	...
	public boolean isSetProfileName() {
		return eIsSet(LogPackage.Literals.IFC_PROFILE_PROPERTIES__PROFILE_NAME);
	}
	...
	public IfcProfileDef getProfileDefinition() {
		return (IfcProfileDef) eGet(LogPackage.Literals.IFC_PROFILE_PROPERTIES__PROFILE_DEFINITION, true);
	}
	...
	public void setProfileDefinition(IfcProfileDef newProfileDefinition) {
		eSet(LogPackage.Literals.IFC_PROFILE_PROPERTIES__PROFILE_DEFINITION, newProfileDefinition);
	}
	...
	public void unsetProfileDefinition() {
		eUnset(LogPackage.Literals.IFC_PROFILE_PROPERTIES__PROFILE_DEFINITION);
	}
	...
	public boolean isSetProfileDefinition() {
		return eIsSet(LogPackage.Literals.IFC_PROFILE_PROPERTIES__PROFILE_DEFINITION);
	}
