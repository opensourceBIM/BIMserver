 ...
 * @generated
 */
public class GeometryImpl extends IdEObjectImpl implements Geometry {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public EList<Integer> getIndices() {
		return (EList<Integer>) eGet(StorePackage.Literals.GEOMETRY__INDICES, true);
	}
	...
	public EList<Float> getVertices() {
		return (EList<Float>) eGet(StorePackage.Literals.GEOMETRY__VERTICES, true);
	}
	...
	public EList<Float> getNormals() {
		return (EList<Float>) eGet(StorePackage.Literals.GEOMETRY__NORMALS, true);
	}
