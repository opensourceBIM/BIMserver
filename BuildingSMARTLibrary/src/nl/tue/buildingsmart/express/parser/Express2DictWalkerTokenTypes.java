...
public enum Express2DictWalkerTokenTypes {
	EOF(1),
	...
	private Express2DictWalkerTokenTypes(int index) {
		this.index = index;
	}
	...
	public static Express2DictWalkerTokenTypes getToken(int tokenIndex) {
		for (Express2DictWalkerTokenTypes t : Express2DictWalkerTokenTypes.values()) {
			if (t.getIndex() == tokenIndex)
				return t;
		}
		throw new IllegalArgumentException(String.format("Express2DictWalkerTokenTypes does not have a Token with an index of %s", tokenIndex));
	}
}
