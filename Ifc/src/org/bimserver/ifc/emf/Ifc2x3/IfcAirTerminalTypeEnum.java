 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.ifc.emf.Ifc2x3.Ifc2x3Package#getIfcAirTerminalTypeEnum()
 * @model
 * @generated
 */
public enum IfcAirTerminalTypeEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcAirTerminalTypeEnum[] VALUES_ARRAY = new IfcAirTerminalTypeEnum[] { NULL, NOTDEFINED, GRILLE, LINEARGRILLE, IRIS, DIFFUSER, LINEARDIFFUSER, REGISTER,
			USERDEFINED, EYEBALL, };
