 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.ifc.emf.Ifc2x3.Ifc2x3Package#getIfcEvaporativeCoolerTypeEnum()
 * @model
 * @generated
 */
public enum IfcEvaporativeCoolerTypeEnum implements Enumerator {
	...
	private static final IfcEvaporativeCoolerTypeEnum[] VALUES_ARRAY = new IfcEvaporativeCoolerTypeEnum[] { NULL, DIRECTEVAPORATIVERANDOMMEDIAAIRCOOLER, NOTDEFINED,
			INDIRECTDIRECTCOMBINATION, DIRECTEVAPORATIVERIGIDMEDIAAIRCOOLER, DIRECTEVAPORATIVESLINGERSPACKAGEDAIRCOOLER, USERDEFINED, INDIRECTEVAPORATIVEPACKAGEAIRCOOLER,
			INDIRECTEVAPORATIVECOOLINGTOWERORCOILCOOLER, INDIRECTEVAPORATIVEWETCOIL, DIRECTEVAPORATIVEAIRWASHER, DIRECTEVAPORATIVEPACKAGEDROTARYAIRCOOLER, };
