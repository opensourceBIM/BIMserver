...
public class TestCompare extends TestWithEmbeddedServer {
	...
	@Test
	public void testIfc2x3tc1Name() throws ServiceException, ChannelConnectionException, IOException {
		// Create a new BimServerClient with authentication
		BimServerClientInterface bimServerClient = getFactory().create(new UsernamePasswordAuthenticationInfo("admin@bimserver.org", "admin"));
	...
	@Test
	public void testIfc4Guid() throws IOException, ServiceException, ChannelConnectionException {
		// Create a new BimServerClient with authentication
		BimServerClientInterface bimServerClient = getFactory().create(new UsernamePasswordAuthenticationInfo("admin@bimserver.org", "admin"));
	...
	@Test
	public void testIfc4Name() throws ServiceException, ChannelConnectionException, IOException {
		// Create a new BimServerClient with authentication
		BimServerClientInterface bimServerClient = getFactory().create(new UsernamePasswordAuthenticationInfo("admin@bimserver.org", "admin"));
