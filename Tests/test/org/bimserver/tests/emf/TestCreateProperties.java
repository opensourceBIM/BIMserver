...
public class TestCreateProperties extends TestWithEmbeddedServer  {
	...
	@Test
	public void test() throws ServiceException, ChannelConnectionException, MalformedURLException, BimServerClientException, IfcModelInterfaceException {
		// New client
		...
		assertEquals(foundOke, nrWindowsFirst);
	}
