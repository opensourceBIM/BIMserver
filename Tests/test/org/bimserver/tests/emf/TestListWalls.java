...
public class TestListWalls extends TestWithEmbeddedServer {
	...
	@Test
	public void test() throws ServiceException, ChannelConnectionException, BimServerClientException, MalformedURLException {
		...
		// Checkin the file
		bimServerClient.checkinSync(newProject.getOid(), "test", deserializer.getOid(), false, new URL("https://github.com/opensourceBIM/TestFiles/raw/master/TestData/data/Jesse.1.ifc"));
