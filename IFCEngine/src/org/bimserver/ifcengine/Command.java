...
public enum Command {
	CHECK_CONNECTION, OPEN_MODEL, SET_POSTPROCESSING, FINALIZE_MODELLING, INITIALIZE_MODELLING, GET_INSTANCES, GET_VISUALISATION_PROPERTIES, CLOSE_MODEL, FIND_CLASHES_BY_GUID, FIND_CLASHES_BY_EID, CLOSE;
