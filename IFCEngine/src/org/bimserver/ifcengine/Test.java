...
public class Test {
	public static void main(String[] args) {
		...
		FailSafeIfcEngine failSafeIfcEngine;
		try {
			failSafeIfcEngine = new FailSafeIfcEngine(resourceFetcher.getFile("IFC2X3_FINAL.exp").getAbsoluteFile(), resourceFetcher.getFile("lib/"), resourceFetcher);
			try {
