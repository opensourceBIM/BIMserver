...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Surface Side</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc2x3.Ifc2x3Package#getIfcSurfaceSide()
 * @model
 * @generated
 */
public enum IfcSurfaceSide implements Enumerator
{
	/**
	 ...
	 * @ordered
	 */
	POSITIVE_LITERAL(2, "POSITIVE", "POSITIVE"),
	 ...
	 * @ordered
	 */
	NEGATIVE_LITERAL(3, "NEGATIVE", "NEGATIVE");
	 ...
	 * @generated
	 */
	private static final IfcSurfaceSide[] VALUES_ARRAY =
		new IfcSurfaceSide[]
		{
			NULL_LITERAL,
			BOTH_LITERAL,
	 ...
	 * @generated
	 */
	public static IfcSurfaceSide get(String literal)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			IfcSurfaceSide result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Ifc Surface Side</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static IfcSurfaceSide getByName(String name)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			IfcSurfaceSide result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Ifc Surface Side</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static IfcSurfaceSide get(int value)
	{
		switch (value)
		{
			case NULL: return NULL_LITERAL;
			case BOTH: return BOTH_LITERAL;
			case POSITIVE: return POSITIVE_LITERAL;
			case NEGATIVE: return NEGATIVE_LITERAL;
		}
		return null;
	}
	 ...
	 * @generated
	 */
	private IfcSurfaceSide(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
