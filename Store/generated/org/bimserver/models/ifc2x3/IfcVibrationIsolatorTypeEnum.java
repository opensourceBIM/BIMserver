 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc2x3.Ifc2x3Package#getIfcVibrationIsolatorTypeEnum()
 * @model
 * @generated
 */
public enum IfcVibrationIsolatorTypeEnum implements Enumerator
{
	 ...
	 * @ordered
	 */
	SPRING_LITERAL(2, "SPRING", "SPRING"),
	 ...
	 * @ordered
	 */
	COMPRESSION_LITERAL(4, "COMPRESSION", "COMPRESSION");
	...
	public static IfcVibrationIsolatorTypeEnum get(int value)
	{
		switch (value)
		{
			...
			case COMPRESSION: return COMPRESSION_LITERAL;
		}
		return null;
	}
