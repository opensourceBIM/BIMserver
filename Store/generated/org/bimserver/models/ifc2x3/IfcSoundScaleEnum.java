...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Sound Scale Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc2x3.Ifc2x3Package#getIfcSoundScaleEnum()
 * @model
 * @generated
 */
public enum IfcSoundScaleEnum implements Enumerator
{
	/**
	 ...
	 * @generated
	 */
	private static final IfcSoundScaleEnum[] VALUES_ARRAY =
		new IfcSoundScaleEnum[]
		{
			NULL_LITERAL,
			DBB_LITERAL,
			DBC_LITERAL,
	...
	public static IfcSoundScaleEnum get(String literal)
	{
		...
		{
			IfcSoundScaleEnum result = VALUES_ARRAY[i];
	...
	public static IfcSoundScaleEnum get(int value)
	{
		switch (value)
		{
			...
			case DBB: return DBB_LITERAL;
			case DBC: return DBC_LITERAL;
			case NOTDEFINED: return NOTDEFINED_LITERAL;
			case DBA: return DBA_LITERAL;
			case USERDEFINED: return USERDEFINED_LITERAL;
			case NR: return NR_LITERAL;
	 ...
	 * @generated
	 */
	private IfcSoundScaleEnum(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
