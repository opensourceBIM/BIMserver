...
public class IfcPermeableCoveringPropertiesImpl extends IfcPropertySetDefinitionImpl implements IfcPermeableCoveringProperties
{
	...
	{
		return Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES;
	}
	...
	{
		return (IfcPermeableCoveringOperationEnum)eGet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE, newOperationType);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH);
	}
	...
	{
		return (String)eGet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING, newFrameDepthAsString);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS);
	}
	...
	{
		return (String)eGet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING, newFrameThicknessAsString);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING);
	}
	...
	{
		return (IfcShapeAspect)eGet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE, newShapeAspectStyle);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
