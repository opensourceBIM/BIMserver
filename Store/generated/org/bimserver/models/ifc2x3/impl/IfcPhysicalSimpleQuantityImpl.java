...
public class IfcPhysicalSimpleQuantityImpl extends IfcPhysicalQuantityImpl implements IfcPhysicalSimpleQuantity
{
	...
	{
		return Ifc2x3Package.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY;
	}
	...
	{
		return (IfcNamedUnit)eGet(Ifc2x3Package.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY__UNIT, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY__UNIT, newUnit);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY__UNIT);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_PHYSICAL_SIMPLE_QUANTITY__UNIT);
	}
