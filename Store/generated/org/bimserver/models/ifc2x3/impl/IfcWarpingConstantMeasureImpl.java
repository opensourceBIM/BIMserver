...
public class IfcWarpingConstantMeasureImpl extends WrappedValueImpl implements IfcWarpingConstantMeasure
{
	...
	{
		return (String)eGet(Ifc2x3Package.eINSTANCE.getIfcWarpingConstantMeasure_WrappedValueAsString(), true);
	}
	...
	{
		eSet(Ifc2x3Package.eINSTANCE.getIfcWarpingConstantMeasure_WrappedValueAsString(), newWrappedValueAsString);
	}
