...
public class IfcTerminatorSymbolImpl extends IfcAnnotationSymbolOccurrenceImpl implements IfcTerminatorSymbol
{
	...
	{
		return Ifc2x3Package.Literals.IFC_TERMINATOR_SYMBOL;
	}
	...
	{
		return (IfcAnnotationCurveOccurrence)eGet(Ifc2x3Package.Literals.IFC_TERMINATOR_SYMBOL__ANNOTATED_CURVE, true);
	}
