...
public class IfcConditionCriterionImpl extends IfcControlImpl implements IfcConditionCriterion
{
	...
	{
		return Ifc2x3Package.Literals.IFC_CONDITION_CRITERION;
	}
	...
	{
		return (IfcConditionCriterionSelect)eGet(Ifc2x3Package.Literals.IFC_CONDITION_CRITERION__CRITERION, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_CONDITION_CRITERION__CRITERION, newCriterion);
	}
