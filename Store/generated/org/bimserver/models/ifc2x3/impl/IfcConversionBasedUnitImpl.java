...
public class IfcConversionBasedUnitImpl extends IfcNamedUnitImpl implements IfcConversionBasedUnit
{
	...
	{
		return Ifc2x3Package.Literals.IFC_CONVERSION_BASED_UNIT;
	}
	...
	{
		return (String)eGet(Ifc2x3Package.Literals.IFC_CONVERSION_BASED_UNIT__NAME, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_CONVERSION_BASED_UNIT__NAME, newName);
	}
