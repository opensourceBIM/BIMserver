...
public class IfcRelConnectsPortsImpl extends IfcRelConnectsImpl implements IfcRelConnectsPorts
{
	...
	{
		return Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORTS;
	}
	...
	{
		return (IfcPort)eGet(Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORTS__RELATING_PORT, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORTS__RELATING_PORT, newRelatingPort);
	}
	...
	{
		return (IfcElement)eGet(Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT, newRealizingElement);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT);
	}
