...
public class IfcMetricImpl extends IfcConstraintImpl implements IfcMetric
{
	...
	{
		return Ifc2x3Package.Literals.IFC_METRIC;
	}
	...
	{
		return (IfcBenchmarkEnum)eGet(Ifc2x3Package.Literals.IFC_METRIC__BENCHMARK, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_METRIC__BENCHMARK, newBenchmark);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_METRIC__VALUE_SOURCE, newValueSource);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_METRIC__VALUE_SOURCE);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_METRIC__VALUE_SOURCE);
	}
	...
	{
		return (IfcMetricValueSelect)eGet(Ifc2x3Package.Literals.IFC_METRIC__DATA_VALUE, true);
	}
