...
public class IfcSweptAreaSolidImpl extends IfcSolidModelImpl implements IfcSweptAreaSolid
{
	...
	{
		return Ifc2x3Package.Literals.IFC_SWEPT_AREA_SOLID;
	}
	...
	{
		return (IfcProfileDef)eGet(Ifc2x3Package.Literals.IFC_SWEPT_AREA_SOLID__SWEPT_AREA, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_SWEPT_AREA_SOLID__SWEPT_AREA, newSweptArea);
	}
