...
public class IfcLightFixtureTypeImpl extends IfcFlowTerminalTypeImpl implements IfcLightFixtureType
{
	...
	{
		return Ifc2x3Package.Literals.IFC_LIGHT_FIXTURE_TYPE;
	}
	...
	{
		return (IfcLightFixtureTypeEnum)eGet(Ifc2x3Package.Literals.IFC_LIGHT_FIXTURE_TYPE__PREDEFINED_TYPE, true);
	}
