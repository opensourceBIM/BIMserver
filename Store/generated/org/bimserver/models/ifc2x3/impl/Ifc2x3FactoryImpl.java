...
public class Ifc2x3FactoryImpl extends EFactoryImpl implements Ifc2x3Factory
{
	...
	public EObject create(EClass eClass)
	{
		switch (eClass.getClassifierID()) {
			...
			case Ifc2x3Package.IFC_ANGULAR_VELOCITY_MEASURE: return (EObject)createIfcAngularVelocityMeasure();
			case Ifc2x3Package.IFC_AREA_MEASURE: return (EObject)createIfcAreaMeasure();
			case Ifc2x3Package.IFC_BOOLEAN: return (EObject)createIfcBoolean();
			case Ifc2x3Package.IFC_CONTEXT_DEPENDENT_MEASURE: return (EObject)createIfcContextDependentMeasure();
			case Ifc2x3Package.IFC_COUNT_MEASURE: return (EObject)createIfcCountMeasure();
			case Ifc2x3Package.IFC_CURVATURE_MEASURE: return (EObject)createIfcCurvatureMeasure();
			case Ifc2x3Package.IFC_DESCRIPTIVE_MEASURE: return (EObject)createIfcDescriptiveMeasure();
			case Ifc2x3Package.IFC_DOSE_EQUIVALENT_MEASURE: return (EObject)createIfcDoseEquivalentMeasure();
			case Ifc2x3Package.IFC_DYNAMIC_VISCOSITY_MEASURE: return (EObject)createIfcDynamicViscosityMeasure();
			case Ifc2x3Package.IFC_ELECTRIC_CAPACITANCE_MEASURE: return (EObject)createIfcElectricCapacitanceMeasure();
			case Ifc2x3Package.IFC_ELECTRIC_CHARGE_MEASURE: return (EObject)createIfcElectricChargeMeasure();
			case Ifc2x3Package.IFC_ELECTRIC_CONDUCTANCE_MEASURE: return (EObject)createIfcElectricConductanceMeasure();
			case Ifc2x3Package.IFC_ELECTRIC_CURRENT_MEASURE: return (EObject)createIfcElectricCurrentMeasure();
			case Ifc2x3Package.IFC_ELECTRIC_RESISTANCE_MEASURE: return (EObject)createIfcElectricResistanceMeasure();
			case Ifc2x3Package.IFC_ELECTRIC_VOLTAGE_MEASURE: return (EObject)createIfcElectricVoltageMeasure();
			case Ifc2x3Package.IFC_ENERGY_MEASURE: return (EObject)createIfcEnergyMeasure();
			case Ifc2x3Package.IFC_FORCE_MEASURE: return (EObject)createIfcForceMeasure();
			case Ifc2x3Package.IFC_FREQUENCY_MEASURE: return (EObject)createIfcFrequencyMeasure();
			case Ifc2x3Package.IFC_GLOBALLY_UNIQUE_ID: return (EObject)createIfcGloballyUniqueId();
			case Ifc2x3Package.IFC_HEAT_FLUX_DENSITY_MEASURE: return (EObject)createIfcHeatFluxDensityMeasure();
			case Ifc2x3Package.IFC_HEATING_VALUE_MEASURE: return (EObject)createIfcHeatingValueMeasure();
			case Ifc2x3Package.IFC_IDENTIFIER: return (EObject)createIfcIdentifier();
			case Ifc2x3Package.IFC_ILLUMINANCE_MEASURE: return (EObject)createIfcIlluminanceMeasure();
			case Ifc2x3Package.IFC_INDUCTANCE_MEASURE: return (EObject)createIfcInductanceMeasure();
			case Ifc2x3Package.IFC_INTEGER: return (EObject)createIfcInteger();
			case Ifc2x3Package.IFC_INTEGER_COUNT_RATE_MEASURE: return (EObject)createIfcIntegerCountRateMeasure();
			case Ifc2x3Package.IFC_ION_CONCENTRATION_MEASURE: return (EObject)createIfcIonConcentrationMeasure();
			case Ifc2x3Package.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE: return (EObject)createIfcIsothermalMoistureCapacityMeasure();
			case Ifc2x3Package.IFC_KINEMATIC_VISCOSITY_MEASURE: return (EObject)createIfcKinematicViscosityMeasure();
			case Ifc2x3Package.IFC_LABEL: return (EObject)createIfcLabel();
			case Ifc2x3Package.IFC_LENGTH_MEASURE: return (EObject)createIfcLengthMeasure();
			case Ifc2x3Package.IFC_LINEAR_FORCE_MEASURE: return (EObject)createIfcLinearForceMeasure();
			case Ifc2x3Package.IFC_LINEAR_MOMENT_MEASURE: return (EObject)createIfcLinearMomentMeasure();
			case Ifc2x3Package.IFC_LINEAR_STIFFNESS_MEASURE: return (EObject)createIfcLinearStiffnessMeasure();
			case Ifc2x3Package.IFC_LINEAR_VELOCITY_MEASURE: return (EObject)createIfcLinearVelocityMeasure();
			case Ifc2x3Package.IFC_LOGICAL: return (EObject)createIfcLogical();
			case Ifc2x3Package.IFC_LUMINOUS_FLUX_MEASURE: return (EObject)createIfcLuminousFluxMeasure();
			case Ifc2x3Package.IFC_LUMINOUS_INTENSITY_DISTRIBUTION_MEASURE: return (EObject)createIfcLuminousIntensityDistributionMeasure();
			case Ifc2x3Package.IFC_LUMINOUS_INTENSITY_MEASURE: return (EObject)createIfcLuminousIntensityMeasure();
			case Ifc2x3Package.IFC_MAGNETIC_FLUX_DENSITY_MEASURE: return (EObject)createIfcMagneticFluxDensityMeasure();
			case Ifc2x3Package.IFC_MAGNETIC_FLUX_MEASURE: return (EObject)createIfcMagneticFluxMeasure();
			case Ifc2x3Package.IFC_MASS_DENSITY_MEASURE: return (EObject)createIfcMassDensityMeasure();
			case Ifc2x3Package.IFC_MASS_FLOW_RATE_MEASURE: return (EObject)createIfcMassFlowRateMeasure();
			case Ifc2x3Package.IFC_MASS_MEASURE: return (EObject)createIfcMassMeasure();
			case Ifc2x3Package.IFC_MASS_PER_LENGTH_MEASURE: return (EObject)createIfcMassPerLengthMeasure();
			case Ifc2x3Package.IFC_MODULUS_OF_ELASTICITY_MEASURE: return (EObject)createIfcModulusOfElasticityMeasure();
			case Ifc2x3Package.IFC_MODULUS_OF_LINEAR_SUBGRADE_REACTION_MEASURE: return (EObject)createIfcModulusOfLinearSubgradeReactionMeasure();
			case Ifc2x3Package.IFC_MODULUS_OF_ROTATIONAL_SUBGRADE_REACTION_MEASURE: return (EObject)createIfcModulusOfRotationalSubgradeReactionMeasure();
			case Ifc2x3Package.IFC_MODULUS_OF_SUBGRADE_REACTION_MEASURE: return (EObject)createIfcModulusOfSubgradeReactionMeasure();
			case Ifc2x3Package.IFC_MOISTURE_DIFFUSIVITY_MEASURE: return (EObject)createIfcMoistureDiffusivityMeasure();
			case Ifc2x3Package.IFC_MOLECULAR_WEIGHT_MEASURE: return (EObject)createIfcMolecularWeightMeasure();
			case Ifc2x3Package.IFC_MOMENT_OF_INERTIA_MEASURE: return (EObject)createIfcMomentOfInertiaMeasure();
			case Ifc2x3Package.IFC_MONETARY_MEASURE: return (EObject)createIfcMonetaryMeasure();
			case Ifc2x3Package.IFC_NUMERIC_MEASURE: return (EObject)createIfcNumericMeasure();
			case Ifc2x3Package.IFC_PH_MEASURE: return (EObject)createIfcPHMeasure();
			case Ifc2x3Package.IFC_PARAMETER_VALUE: return (EObject)createIfcParameterValue();
			case Ifc2x3Package.IFC_PLANAR_FORCE_MEASURE: return (EObject)createIfcPlanarForceMeasure();
			case Ifc2x3Package.IFC_PLANE_ANGLE_MEASURE: return (EObject)createIfcPlaneAngleMeasure();
			case Ifc2x3Package.IFC_POWER_MEASURE: return (EObject)createIfcPowerMeasure();
			case Ifc2x3Package.IFC_PRESSURE_MEASURE: return (EObject)createIfcPressureMeasure();
			case Ifc2x3Package.IFC_RADIO_ACTIVITY_MEASURE: return (EObject)createIfcRadioActivityMeasure();
			case Ifc2x3Package.IFC_RATIO_MEASURE: return (EObject)createIfcRatioMeasure();
			case Ifc2x3Package.IFC_REAL: return (EObject)createIfcReal();
			case Ifc2x3Package.IFC_ROTATIONAL_FREQUENCY_MEASURE: return (EObject)createIfcRotationalFrequencyMeasure();
			case Ifc2x3Package.IFC_ROTATIONAL_MASS_MEASURE: return (EObject)createIfcRotationalMassMeasure();
			case Ifc2x3Package.IFC_ROTATIONAL_STIFFNESS_MEASURE: return (EObject)createIfcRotationalStiffnessMeasure();
			case Ifc2x3Package.IFC_SECTION_MODULUS_MEASURE: return (EObject)createIfcSectionModulusMeasure();
			case Ifc2x3Package.IFC_SECTIONAL_AREA_INTEGRAL_MEASURE: return (EObject)createIfcSectionalAreaIntegralMeasure();
			case Ifc2x3Package.IFC_SHEAR_MODULUS_MEASURE: return (EObject)createIfcShearModulusMeasure();
			case Ifc2x3Package.IFC_SOLID_ANGLE_MEASURE: return (EObject)createIfcSolidAngleMeasure();
			case Ifc2x3Package.IFC_SOUND_POWER_MEASURE: return (EObject)createIfcSoundPowerMeasure();
			case Ifc2x3Package.IFC_SOUND_PRESSURE_MEASURE: return (EObject)createIfcSoundPressureMeasure();
			case Ifc2x3Package.IFC_SPECIFIC_HEAT_CAPACITY_MEASURE: return (EObject)createIfcSpecificHeatCapacityMeasure();
			case Ifc2x3Package.IFC_SPECULAR_EXPONENT: return (EObject)createIfcSpecularExponent();
			case Ifc2x3Package.IFC_SPECULAR_ROUGHNESS: return (EObject)createIfcSpecularRoughness();
			case Ifc2x3Package.IFC_TEMPERATURE_GRADIENT_MEASURE: return (EObject)createIfcTemperatureGradientMeasure();
			case Ifc2x3Package.IFC_TEXT: return (EObject)createIfcText();
			case Ifc2x3Package.IFC_THERMAL_ADMITTANCE_MEASURE: return (EObject)createIfcThermalAdmittanceMeasure();
			case Ifc2x3Package.IFC_THERMAL_CONDUCTIVITY_MEASURE: return (EObject)createIfcThermalConductivityMeasure();
			case Ifc2x3Package.IFC_THERMAL_EXPANSION_COEFFICIENT_MEASURE: return (EObject)createIfcThermalExpansionCoefficientMeasure();
			case Ifc2x3Package.IFC_THERMAL_RESISTANCE_MEASURE: return (EObject)createIfcThermalResistanceMeasure();
			case Ifc2x3Package.IFC_THERMAL_TRANSMITTANCE_MEASURE: return (EObject)createIfcThermalTransmittanceMeasure();
			case Ifc2x3Package.IFC_THERMODYNAMIC_TEMPERATURE_MEASURE: return (EObject)createIfcThermodynamicTemperatureMeasure();
			case Ifc2x3Package.IFC_TIME_MEASURE: return (EObject)createIfcTimeMeasure();
			case Ifc2x3Package.IFC_TIME_STAMP: return (EObject)createIfcTimeStamp();
			case Ifc2x3Package.IFC_TORQUE_MEASURE: return (EObject)createIfcTorqueMeasure();
			case Ifc2x3Package.IFC_VAPOR_PERMEABILITY_MEASURE: return (EObject)createIfcVaporPermeabilityMeasure();
			case Ifc2x3Package.IFC_VOLUME_MEASURE: return (EObject)createIfcVolumeMeasure();
			case Ifc2x3Package.IFC_VOLUMETRIC_FLOW_RATE_MEASURE: return (EObject)createIfcVolumetricFlowRateMeasure();
			case Ifc2x3Package.IFC_WARPING_CONSTANT_MEASURE: return (EObject)createIfcWarpingConstantMeasure();
			case Ifc2x3Package.IFC_WARPING_MOMENT_MEASURE: return (EObject)createIfcWarpingMomentMeasure();
			case Ifc2x3Package.IFC_NORMALISED_RATIO_MEASURE: return (EObject)createIfcNormalisedRatioMeasure();
			case Ifc2x3Package.IFC_POSITIVE_LENGTH_MEASURE: return (EObject)createIfcPositiveLengthMeasure();
			case Ifc2x3Package.IFC_POSITIVE_PLANE_ANGLE_MEASURE: return (EObject)createIfcPositivePlaneAngleMeasure();
			case Ifc2x3Package.IFC_POSITIVE_RATIO_MEASURE: return (EObject)createIfcPositiveRatioMeasure();
