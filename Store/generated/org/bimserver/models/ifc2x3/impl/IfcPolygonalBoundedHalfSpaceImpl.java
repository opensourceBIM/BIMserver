...
public class IfcPolygonalBoundedHalfSpaceImpl extends IfcHalfSpaceSolidImpl implements IfcPolygonalBoundedHalfSpace
{
	...
	{
		return Ifc2x3Package.Literals.IFC_POLYGONAL_BOUNDED_HALF_SPACE;
	}
	...
	{
		return (IfcAxis2Placement3D)eGet(Ifc2x3Package.Literals.IFC_POLYGONAL_BOUNDED_HALF_SPACE__POSITION, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_POLYGONAL_BOUNDED_HALF_SPACE__POSITION, newPosition);
	}
