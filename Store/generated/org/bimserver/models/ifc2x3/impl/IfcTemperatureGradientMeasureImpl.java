...
public class IfcTemperatureGradientMeasureImpl extends WrappedValueImpl implements IfcTemperatureGradientMeasure
{
	...
	{
		return (String)eGet(Ifc2x3Package.eINSTANCE.getIfcTemperatureGradientMeasure_WrappedValueAsString(), true);
	}
	...
	{
		eSet(Ifc2x3Package.eINSTANCE.getIfcTemperatureGradientMeasure_WrappedValueAsString(), newWrappedValueAsString);
	}
