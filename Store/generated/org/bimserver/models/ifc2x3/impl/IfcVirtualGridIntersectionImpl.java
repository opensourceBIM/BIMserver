...
public class IfcVirtualGridIntersectionImpl extends IdEObjectImpl implements IfcVirtualGridIntersection
{
	...
	{
		return Ifc2x3Package.Literals.IFC_VIRTUAL_GRID_INTERSECTION;
	}
	...
	{
		return (EList<IfcGridAxis>)eGet(Ifc2x3Package.Literals.IFC_VIRTUAL_GRID_INTERSECTION__INTERSECTING_AXES, true);
	}
	...
	{
		return (EList<Float>)eGet(Ifc2x3Package.Literals.IFC_VIRTUAL_GRID_INTERSECTION__OFFSET_DISTANCES, true);
	}
