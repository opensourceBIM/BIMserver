...
public class IfcProcedureImpl extends IfcProcessImpl implements IfcProcedure
{
	...
	{
		return Ifc2x3Package.Literals.IFC_PROCEDURE;
	}
	...
	{
		return (String)eGet(Ifc2x3Package.Literals.IFC_PROCEDURE__PROCEDURE_ID, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_PROCEDURE__PROCEDURE_ID, newProcedureID);
	}
	...
	{
		return (String)eGet(Ifc2x3Package.Literals.IFC_PROCEDURE__USER_DEFINED_PROCEDURE_TYPE, true);
	}
	...
	{
		eSet(Ifc2x3Package.Literals.IFC_PROCEDURE__USER_DEFINED_PROCEDURE_TYPE, newUserDefinedProcedureType);
	}
	...
	{
		eUnset(Ifc2x3Package.Literals.IFC_PROCEDURE__USER_DEFINED_PROCEDURE_TYPE);
	}
	...
	{
		return eIsSet(Ifc2x3Package.Literals.IFC_PROCEDURE__USER_DEFINED_PROCEDURE_TYPE);
	}
