...
public class IfcRelAssignsToControlImpl extends IfcRelAssignsImpl implements IfcRelAssignsToControl
{
	...
	{
		return Ifc2x3Package.Literals.IFC_REL_ASSIGNS_TO_CONTROL;
	}
	...
	{
		return (IfcControl)eGet(Ifc2x3Package.Literals.IFC_REL_ASSIGNS_TO_CONTROL__RELATING_CONTROL, true);
	}
