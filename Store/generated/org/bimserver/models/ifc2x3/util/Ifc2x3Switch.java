 ...
 * @generated
 */
public class Ifc2x3Switch<T> extends Switch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID) {
			...
			case Ifc2x3Package.IFC_ABSORBED_DOSE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcAbsorbedDoseMeasure);
				if (result == null) result = caseIfcValue(ifcAbsorbedDoseMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ACCELERATION_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcAccelerationMeasure);
				if (result == null) result = caseIfcValue(ifcAccelerationMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_AMOUNT_OF_SUBSTANCE_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcAmountOfSubstanceMeasure);
				if (result == null) result = caseIfcValue(ifcAmountOfSubstanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ANGULAR_VELOCITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcAngularVelocityMeasure);
				if (result == null) result = caseIfcValue(ifcAngularVelocityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_AREA_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcAreaMeasure);
				if (result == null) result = caseIfcValue(ifcAreaMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_BOOLEAN: {
				...
				if (result == null) result = caseIfcValue(ifcBoolean);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CONTEXT_DEPENDENT_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcContextDependentMeasure);
				if (result == null) result = caseIfcValue(ifcContextDependentMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_COUNT_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcCountMeasure);
				if (result == null) result = caseIfcValue(ifcCountMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CURVATURE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcCurvatureMeasure);
			...
			case Ifc2x3Package.IFC_DESCRIPTIVE_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcDescriptiveMeasure);
				if (result == null) result = caseIfcSizeSelect(ifcDescriptiveMeasure);
				if (result == null) result = caseIfcValue(ifcDescriptiveMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_DOSE_EQUIVALENT_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcDoseEquivalentMeasure);
				if (result == null) result = caseIfcValue(ifcDoseEquivalentMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_DYNAMIC_VISCOSITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcDynamicViscosityMeasure);
				if (result == null) result = caseIfcValue(ifcDynamicViscosityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ELECTRIC_CAPACITANCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcElectricCapacitanceMeasure);
				if (result == null) result = caseIfcValue(ifcElectricCapacitanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ELECTRIC_CHARGE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcElectricChargeMeasure);
				if (result == null) result = caseIfcValue(ifcElectricChargeMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ELECTRIC_CONDUCTANCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcElectricConductanceMeasure);
				if (result == null) result = caseIfcValue(ifcElectricConductanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ELECTRIC_CURRENT_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcElectricCurrentMeasure);
				if (result == null) result = caseIfcValue(ifcElectricCurrentMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ELECTRIC_RESISTANCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcElectricResistanceMeasure);
				if (result == null) result = caseIfcValue(ifcElectricResistanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ELECTRIC_VOLTAGE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcElectricVoltageMeasure);
				if (result == null) result = caseIfcValue(ifcElectricVoltageMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ENERGY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcEnergyMeasure);
				if (result == null) result = caseIfcValue(ifcEnergyMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FORCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcForceMeasure);
				if (result == null) result = caseIfcValue(ifcForceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FREQUENCY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcFrequencyMeasure);
				if (result == null) result = caseIfcValue(ifcFrequencyMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_HEAT_FLUX_DENSITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcHeatFluxDensityMeasure);
				if (result == null) result = caseIfcValue(ifcHeatFluxDensityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_HEATING_VALUE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcHeatingValueMeasure);
				if (result == null) result = caseIfcValue(ifcHeatingValueMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_IDENTIFIER: {
				...
				if (result == null) result = caseIfcSimpleValue(ifcIdentifier);
				if (result == null) result = caseIfcValue(ifcIdentifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ILLUMINANCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcIlluminanceMeasure);
				if (result == null) result = caseIfcValue(ifcIlluminanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_INDUCTANCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcInductanceMeasure);
				if (result == null) result = caseIfcValue(ifcInductanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_INTEGER: {
				...
				if (result == null) result = caseIfcSimpleValue(ifcInteger);
				if (result == null) result = caseIfcValue(ifcInteger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_INTEGER_COUNT_RATE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcIntegerCountRateMeasure);
				if (result == null) result = caseIfcValue(ifcIntegerCountRateMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ION_CONCENTRATION_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcIonConcentrationMeasure);
				if (result == null) result = caseIfcValue(ifcIonConcentrationMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcIsothermalMoistureCapacityMeasure);
			...
			case Ifc2x3Package.IFC_KINEMATIC_VISCOSITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcKinematicViscosityMeasure);
				if (result == null) result = caseIfcValue(ifcKinematicViscosityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LABEL: {
				...
				if (result == null) result = caseIfcConditionCriterionSelect(ifcLabel);
				if (result == null) result = caseIfcSimpleValue(ifcLabel);
				if (result == null) result = caseIfcValue(ifcLabel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LENGTH_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcLengthMeasure);
				if (result == null) result = caseIfcSizeSelect(ifcLengthMeasure);
				if (result == null) result = caseIfcValue(ifcLengthMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LINEAR_FORCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcLinearForceMeasure);
				if (result == null) result = caseIfcValue(ifcLinearForceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LINEAR_MOMENT_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcLinearMomentMeasure);
				if (result == null) result = caseIfcValue(ifcLinearMomentMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LINEAR_STIFFNESS_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcLinearStiffnessMeasure);
				if (result == null) result = caseIfcValue(ifcLinearStiffnessMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LINEAR_VELOCITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcLinearVelocityMeasure);
				if (result == null) result = caseIfcValue(ifcLinearVelocityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LOGICAL: {
				...
				if (result == null) result = caseIfcSimpleValue(ifcLogical);
				if (result == null) result = caseIfcValue(ifcLogical);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LUMINOUS_FLUX_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcLuminousFluxMeasure);
				if (result == null) result = caseIfcValue(ifcLuminousFluxMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LUMINOUS_INTENSITY_DISTRIBUTION_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcLuminousIntensityDistributionMeasure);
				if (result == null) result = caseIfcValue(ifcLuminousIntensityDistributionMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LUMINOUS_INTENSITY_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcLuminousIntensityMeasure);
				if (result == null) result = caseIfcValue(ifcLuminousIntensityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MAGNETIC_FLUX_DENSITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMagneticFluxDensityMeasure);
				if (result == null) result = caseIfcValue(ifcMagneticFluxDensityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MAGNETIC_FLUX_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMagneticFluxMeasure);
				if (result == null) result = caseIfcValue(ifcMagneticFluxMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MASS_DENSITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMassDensityMeasure);
				if (result == null) result = caseIfcValue(ifcMassDensityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MASS_FLOW_RATE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMassFlowRateMeasure);
				if (result == null) result = caseIfcValue(ifcMassFlowRateMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MASS_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcMassMeasure);
				if (result == null) result = caseIfcValue(ifcMassMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MASS_PER_LENGTH_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMassPerLengthMeasure);
				if (result == null) result = caseIfcValue(ifcMassPerLengthMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MODULUS_OF_ELASTICITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcModulusOfElasticityMeasure);
				if (result == null) result = caseIfcValue(ifcModulusOfElasticityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MODULUS_OF_LINEAR_SUBGRADE_REACTION_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcModulusOfLinearSubgradeReactionMeasure);
				if (result == null) result = caseIfcValue(ifcModulusOfLinearSubgradeReactionMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MODULUS_OF_ROTATIONAL_SUBGRADE_REACTION_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcModulusOfRotationalSubgradeReactionMeasure);
				if (result == null) result = caseIfcValue(ifcModulusOfRotationalSubgradeReactionMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MODULUS_OF_SUBGRADE_REACTION_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcModulusOfSubgradeReactionMeasure);
				if (result == null) result = caseIfcValue(ifcModulusOfSubgradeReactionMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MOISTURE_DIFFUSIVITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMoistureDiffusivityMeasure);
				if (result == null) result = caseIfcValue(ifcMoistureDiffusivityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MOLECULAR_WEIGHT_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMolecularWeightMeasure);
			...
			case Ifc2x3Package.IFC_MOMENT_OF_INERTIA_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMomentOfInertiaMeasure);
				if (result == null) result = caseIfcValue(ifcMomentOfInertiaMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MONETARY_MEASURE: {
				...
				if (result == null) result = caseIfcAppliedValueSelect(ifcMonetaryMeasure);
				if (result == null) result = caseIfcDerivedMeasureValue(ifcMonetaryMeasure);
				if (result == null) result = caseIfcValue(ifcMonetaryMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_NUMERIC_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcNumericMeasure);
				if (result == null) result = caseIfcValue(ifcNumericMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PH_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcPHMeasure);
				if (result == null) result = caseIfcValue(ifcPHMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PARAMETER_VALUE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcParameterValue);
				if (result == null) result = caseIfcTrimmingSelect(ifcParameterValue);
				if (result == null) result = caseIfcValue(ifcParameterValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PLANAR_FORCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcPlanarForceMeasure);
				if (result == null) result = caseIfcValue(ifcPlanarForceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PLANE_ANGLE_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcPlaneAngleMeasure);
				if (result == null) result = caseIfcOrientationSelect(ifcPlaneAngleMeasure);
				if (result == null) result = caseIfcValue(ifcPlaneAngleMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POWER_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcPowerMeasure);
				if (result == null) result = caseIfcValue(ifcPowerMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PRESSURE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcPressureMeasure);
				if (result == null) result = caseIfcValue(ifcPressureMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_RADIO_ACTIVITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcRadioActivityMeasure);
				if (result == null) result = caseIfcValue(ifcRadioActivityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_RATIO_MEASURE: {
				...
				if (result == null) result = caseIfcAppliedValueSelect(ifcRatioMeasure);
				if (result == null) result = caseIfcMeasureValue(ifcRatioMeasure);
				if (result == null) result = caseIfcSizeSelect(ifcRatioMeasure);
				if (result == null) result = caseIfcValue(ifcRatioMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_REAL: {
				...
				if (result == null) result = caseIfcSimpleValue(ifcReal);
				if (result == null) result = caseIfcValue(ifcReal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ROTATIONAL_FREQUENCY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcRotationalFrequencyMeasure);
				if (result == null) result = caseIfcValue(ifcRotationalFrequencyMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ROTATIONAL_MASS_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcRotationalMassMeasure);
				if (result == null) result = caseIfcValue(ifcRotationalMassMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ROTATIONAL_STIFFNESS_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcRotationalStiffnessMeasure);
				if (result == null) result = caseIfcValue(ifcRotationalStiffnessMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SECTION_MODULUS_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcSectionModulusMeasure);
				if (result == null) result = caseIfcValue(ifcSectionModulusMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SECTIONAL_AREA_INTEGRAL_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcSectionalAreaIntegralMeasure);
				if (result == null) result = caseIfcValue(ifcSectionalAreaIntegralMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SHEAR_MODULUS_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcShearModulusMeasure);
				if (result == null) result = caseIfcValue(ifcShearModulusMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SOLID_ANGLE_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcSolidAngleMeasure);
				if (result == null) result = caseIfcValue(ifcSolidAngleMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SOUND_POWER_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcSoundPowerMeasure);
				if (result == null) result = caseIfcValue(ifcSoundPowerMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SOUND_PRESSURE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcSoundPressureMeasure);
				if (result == null) result = caseIfcValue(ifcSoundPressureMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SPECIFIC_HEAT_CAPACITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcSpecificHeatCapacityMeasure);
				if (result == null) result = caseIfcValue(ifcSpecificHeatCapacityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SPECULAR_EXPONENT: {
				...
				if (result == null) result = caseIfcSpecularHighlightSelect(ifcSpecularExponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SPECULAR_ROUGHNESS: {
				...
				if (result == null) result = caseIfcSpecularHighlightSelect(ifcSpecularRoughness);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_TEMPERATURE_GRADIENT_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcTemperatureGradientMeasure);
				if (result == null) result = caseIfcValue(ifcTemperatureGradientMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_TEXT: {
				...
				if (result == null) result = caseIfcMetricValueSelect(ifcText);
				if (result == null) result = caseIfcSimpleValue(ifcText);
				if (result == null) result = caseIfcValue(ifcText);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_THERMAL_ADMITTANCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcThermalAdmittanceMeasure);
				if (result == null) result = caseIfcValue(ifcThermalAdmittanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_THERMAL_CONDUCTIVITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcThermalConductivityMeasure);
				if (result == null) result = caseIfcValue(ifcThermalConductivityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_THERMAL_EXPANSION_COEFFICIENT_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcThermalExpansionCoefficientMeasure);
				if (result == null) result = caseIfcValue(ifcThermalExpansionCoefficientMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_THERMAL_RESISTANCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcThermalResistanceMeasure);
				if (result == null) result = caseIfcValue(ifcThermalResistanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_THERMAL_TRANSMITTANCE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcThermalTransmittanceMeasure);
				if (result == null) result = caseIfcValue(ifcThermalTransmittanceMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_THERMODYNAMIC_TEMPERATURE_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcThermodynamicTemperatureMeasure);
				if (result == null) result = caseIfcValue(ifcThermodynamicTemperatureMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_TIME_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcTimeMeasure);
				if (result == null) result = caseIfcValue(ifcTimeMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_TIME_STAMP: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcTimeStamp);
				if (result == null) result = caseIfcValue(ifcTimeStamp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_TORQUE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcTorqueMeasure);
				if (result == null) result = caseIfcValue(ifcTorqueMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_VAPOR_PERMEABILITY_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcVaporPermeabilityMeasure);
				if (result == null) result = caseIfcValue(ifcVaporPermeabilityMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_VOLUME_MEASURE: {
				...
				if (result == null) result = caseIfcMeasureValue(ifcVolumeMeasure);
				if (result == null) result = caseIfcValue(ifcVolumeMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_VOLUMETRIC_FLOW_RATE_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcVolumetricFlowRateMeasure);
				if (result == null) result = caseIfcValue(ifcVolumetricFlowRateMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_WARPING_CONSTANT_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcWarpingConstantMeasure);
			...
			case Ifc2x3Package.IFC_WARPING_MOMENT_MEASURE: {
				...
				if (result == null) result = caseIfcDerivedMeasureValue(ifcWarpingMomentMeasure);
				if (result == null) result = caseIfcValue(ifcWarpingMomentMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_NORMALISED_RATIO_MEASURE: {
				...
				if (result == null) result = caseIfcColourOrFactor(ifcNormalisedRatioMeasure);
				if (result == null) result = caseWrappedValue(ifcNormalisedRatioMeasure);
				if (result == null) result = caseIfcAppliedValueSelect(ifcNormalisedRatioMeasure);
				if (result == null) result = caseIfcMeasureValue(ifcNormalisedRatioMeasure);
				if (result == null) result = caseIfcSizeSelect(ifcNormalisedRatioMeasure);
				if (result == null) result = caseIfcValue(ifcNormalisedRatioMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POSITIVE_LENGTH_MEASURE: {
				...
				if (result == null) result = caseIfcHatchLineDistanceSelect(ifcPositiveLengthMeasure);
				if (result == null) result = caseWrappedValue(ifcPositiveLengthMeasure);
				if (result == null) result = caseIfcMeasureValue(ifcPositiveLengthMeasure);
				if (result == null) result = caseIfcSizeSelect(ifcPositiveLengthMeasure);
				if (result == null) result = caseIfcValue(ifcPositiveLengthMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POSITIVE_PLANE_ANGLE_MEASURE: {
				...
				if (result == null) result = caseWrappedValue(ifcPositivePlaneAngleMeasure);
				if (result == null) result = caseIfcMeasureValue(ifcPositivePlaneAngleMeasure);
				if (result == null) result = caseIfcOrientationSelect(ifcPositivePlaneAngleMeasure);
				if (result == null) result = caseIfcValue(ifcPositivePlaneAngleMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POSITIVE_RATIO_MEASURE: {
				...
				if (result == null) result = caseWrappedValue(ifcPositiveRatioMeasure);
				if (result == null) result = caseIfcAppliedValueSelect(ifcPositiveRatioMeasure);
				if (result == null) result = caseIfcMeasureValue(ifcPositiveRatioMeasure);
				if (result == null) result = caseIfcSizeSelect(ifcPositiveRatioMeasure);
				if (result == null) result = caseIfcValue(ifcPositiveRatioMeasure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_ANGULAR_DIMENSION: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcAngularDimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_ANNOTATION_CURVE_OCCURRENCE: {
				...
				if (result == null) result = caseIfcDraughtingCalloutElement(ifcAnnotationCurveOccurrence);
				...
				if (result == null) result = caseIfcLayeredItem(ifcAnnotationCurveOccurrence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ANNOTATION_FILL_AREA: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcAnnotationFillArea);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ANNOTATION_FILL_AREA_OCCURRENCE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcAnnotationFillAreaOccurrence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ANNOTATION_OCCURRENCE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcAnnotationOccurrence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ANNOTATION_SURFACE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcAnnotationSurface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ANNOTATION_SURFACE_OCCURRENCE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcAnnotationSurfaceOccurrence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ANNOTATION_SYMBOL_OCCURRENCE: {
				...
				if (result == null) result = caseIfcDraughtingCalloutElement(ifcAnnotationSymbolOccurrence);
				...
				if (result == null) result = caseIfcLayeredItem(ifcAnnotationSymbolOccurrence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ANNOTATION_TEXT_OCCURRENCE: {
				...
				if (result == null) result = caseIfcDraughtingCalloutElement(ifcAnnotationTextOccurrence);
				...
				if (result == null) result = caseIfcLayeredItem(ifcAnnotationTextOccurrence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_AXIS1_PLACEMENT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcAxis1Placement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_AXIS2_PLACEMENT2_D: {
				...
				if (result == null) result = caseIfcAxis2Placement(ifcAxis2Placement2D);
				...
				if (result == null) result = caseIfcLayeredItem(ifcAxis2Placement2D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_AXIS2_PLACEMENT3_D: {
				...
				if (result == null) result = caseIfcAxis2Placement(ifcAxis2Placement3D);
				...
				if (result == null) result = caseIfcLayeredItem(ifcAxis2Placement3D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_BSPLINE_CURVE: {
				...
				if (result == null) result = caseIfcCurveOrEdgeCurve(ifcBSplineCurve);
				if (result == null) result = caseIfcGeometricRepresentationItem(ifcBSplineCurve);
				if (result == null) result = caseIfcGeometricSetSelect(ifcBSplineCurve);
				if (result == null) result = caseIfcRepresentationItem(ifcBSplineCurve);
				if (result == null) result = caseIfcLayeredItem(ifcBSplineCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_BEAM: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcBeam);
			...
			case Ifc2x3Package.IFC_BEZIER_CURVE: {
				...
				if (result == null) result = caseIfcCurveOrEdgeCurve(ifcBezierCurve);
				if (result == null) result = caseIfcGeometricRepresentationItem(ifcBezierCurve);
				if (result == null) result = caseIfcGeometricSetSelect(ifcBezierCurve);
				if (result == null) result = caseIfcRepresentationItem(ifcBezierCurve);
				if (result == null) result = caseIfcLayeredItem(ifcBezierCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_BLOCK: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcBlock);
				if (result == null) result = caseIfcCsgSelect(ifcBlock);
				if (result == null) result = caseIfcRepresentationItem(ifcBlock);
				if (result == null) result = caseIfcLayeredItem(ifcBlock);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_BOOLEAN_CLIPPING_RESULT: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcBooleanClippingResult);
				if (result == null) result = caseIfcCsgSelect(ifcBooleanClippingResult);
				if (result == null) result = caseIfcRepresentationItem(ifcBooleanClippingResult);
				if (result == null) result = caseIfcLayeredItem(ifcBooleanClippingResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_BOOLEAN_RESULT: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcBooleanResult);
				if (result == null) result = caseIfcCsgSelect(ifcBooleanResult);
				if (result == null) result = caseIfcRepresentationItem(ifcBooleanResult);
				if (result == null) result = caseIfcLayeredItem(ifcBooleanResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_BOUNDED_CURVE: {
				...
				if (result == null) result = caseIfcCurveOrEdgeCurve(ifcBoundedCurve);
				if (result == null) result = caseIfcGeometricRepresentationItem(ifcBoundedCurve);
				if (result == null) result = caseIfcGeometricSetSelect(ifcBoundedCurve);
				if (result == null) result = caseIfcRepresentationItem(ifcBoundedCurve);
				if (result == null) result = caseIfcLayeredItem(ifcBoundedCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_BOUNDED_SURFACE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcBoundedSurface);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcBoundedSurface);
				if (result == null) result = caseIfcRepresentationItem(ifcBoundedSurface);
				if (result == null) result = caseIfcLayeredItem(ifcBoundedSurface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_BOUNDING_BOX: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcBoundingBox);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_BOXED_HALF_SPACE: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcBoxedHalfSpace);
				if (result == null) result = caseIfcRepresentationItem(ifcBoxedHalfSpace);
				if (result == null) result = caseIfcLayeredItem(ifcBoxedHalfSpace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_BUILDING_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcBuildingElement);
			...
			case Ifc2x3Package.IFC_BUILDING_ELEMENT_COMPONENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcBuildingElementComponent);
			...
			case Ifc2x3Package.IFC_BUILDING_ELEMENT_PART: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcBuildingElementPart);
			...
			case Ifc2x3Package.IFC_BUILDING_ELEMENT_PROXY: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcBuildingElementProxy);
			...
			case Ifc2x3Package.IFC_CALENDAR_DATE: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcCalendarDate);
				if (result == null) result = caseIfcMetricValueSelect(ifcCalendarDate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CARTESIAN_POINT: {
				...
				if (result == null) result = caseIfcTrimmingSelect(ifcCartesianPoint);
				if (result == null) result = caseIfcGeometricRepresentationItem(ifcCartesianPoint);
				if (result == null) result = caseIfcGeometricSetSelect(ifcCartesianPoint);
				if (result == null) result = caseIfcPointOrVertexPoint(ifcCartesianPoint);
				if (result == null) result = caseIfcRepresentationItem(ifcCartesianPoint);
				if (result == null) result = caseIfcLayeredItem(ifcCartesianPoint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_D: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcCartesianTransformationOperator2D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcCartesianTransformationOperator2DnonUniform);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CARTESIAN_TRANSFORMATION_OPERATOR3_D: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcCartesianTransformationOperator3D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CARTESIAN_TRANSFORMATION_OPERATOR3_DNON_UNIFORM: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcCartesianTransformationOperator3DnonUniform);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_CHAMFER_EDGE_FEATURE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcChamferEdgeFeature);
			...
			case Ifc2x3Package.IFC_CIRCLE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcCircle);
				if (result == null) result = caseIfcRepresentationItem(ifcCircle);
				if (result == null) result = caseIfcLayeredItem(ifcCircle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_CLASSIFICATION_REFERENCE: {
				...
				if (result == null) result = caseIfcClassificationNotationSelect(ifcClassificationReference);
				if (result == null) result = caseIfcLightDistributionDataSourceSelect(ifcClassificationReference);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcClassificationReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CLOSED_SHELL: {
				...
				if (result == null) result = caseIfcShell(ifcClosedShell);
				...
				if (result == null) result = caseIfcLayeredItem(ifcClosedShell);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_COLOUR_RGB: {
				...
				if (result == null) result = caseIfcColourOrFactor(ifcColourRgb);
				if (result == null) result = caseIfcColour(ifcColourRgb);
				if (result == null) result = caseIfcFillStyleSelect(ifcColourRgb);
				if (result == null) result = caseIfcSymbolStyleSelect(ifcColourRgb);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_COLOUR_SPECIFICATION: {
				...
				if (result == null) result = caseIfcFillStyleSelect(ifcColourSpecification);
				if (result == null) result = caseIfcSymbolStyleSelect(ifcColourSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_COLUMN: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcColumn);
			...
			case Ifc2x3Package.IFC_COMPOSITE_CURVE: {
				...
				if (result == null) result = caseIfcCurveOrEdgeCurve(ifcCompositeCurve);
				if (result == null) result = caseIfcGeometricRepresentationItem(ifcCompositeCurve);
				if (result == null) result = caseIfcGeometricSetSelect(ifcCompositeCurve);
				if (result == null) result = caseIfcRepresentationItem(ifcCompositeCurve);
				if (result == null) result = caseIfcLayeredItem(ifcCompositeCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_COMPOSITE_CURVE_SEGMENT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcCompositeCurveSegment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_CONIC: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcConic);
				if (result == null) result = caseIfcRepresentationItem(ifcConic);
				if (result == null) result = caseIfcLayeredItem(ifcConic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CONNECTED_FACE_SET: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcConnectedFaceSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_CONTEXT_DEPENDENT_UNIT: {
				...
				if (result == null) result = caseIfcUnit(ifcContextDependentUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_CONVERSION_BASED_UNIT: {
				...
				if (result == null) result = caseIfcUnit(ifcConversionBasedUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_COST_VALUE: {
				...
				if (result == null) result = caseIfcMetricValueSelect(ifcCostValue);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcCostValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_COVERING: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcCovering);
			...
			case Ifc2x3Package.IFC_CSG_PRIMITIVE3_D: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcCsgPrimitive3D);
				...
				if (result == null) result = caseIfcLayeredItem(ifcCsgPrimitive3D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CSG_SOLID: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcCsgSolid);
				if (result == null) result = caseIfcRepresentationItem(ifcCsgSolid);
				if (result == null) result = caseIfcLayeredItem(ifcCsgSolid);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_CURTAIN_WALL: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcCurtainWall);
			...
			case Ifc2x3Package.IFC_CURVE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcCurve);
				if (result == null) result = caseIfcRepresentationItem(ifcCurve);
				if (result == null) result = caseIfcLayeredItem(ifcCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CURVE_BOUNDED_PLANE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcCurveBoundedPlane);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcCurveBoundedPlane);
				if (result == null) result = caseIfcRepresentationItem(ifcCurveBoundedPlane);
				if (result == null) result = caseIfcLayeredItem(ifcCurveBoundedPlane);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CURVE_STYLE: {
				...
				if (result == null) result = caseIfcPresentationStyleSelect(ifcCurveStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_CURVE_STYLE_FONT: {
				...
				if (result == null) result = caseIfcCurveFontOrScaledCurveFontSelect(ifcCurveStyleFont);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_DATE_AND_TIME: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcDateAndTime);
				if (result == null) result = caseIfcMetricValueSelect(ifcDateAndTime);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_DEFINED_SYMBOL: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcDefinedSymbol);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_DIAMETER_DIMENSION: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcDiameterDimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_DIMENSION_CURVE: {
				...
				if (result == null) result = caseIfcDraughtingCalloutElement(ifcDimensionCurve);
				...
				if (result == null) result = caseIfcLayeredItem(ifcDimensionCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_DIMENSION_CURVE_DIRECTED_CALLOUT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcDimensionCurveDirectedCallout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_DIMENSION_CURVE_TERMINATOR: {
				...
				if (result == null) result = caseIfcDraughtingCalloutElement(ifcDimensionCurveTerminator);
				...
				if (result == null) result = caseIfcLayeredItem(ifcDimensionCurveTerminator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_DIRECTION: {
				...
				if (result == null) result = caseIfcOrientationSelect(ifcDirection);
				if (result == null) result = caseIfcVectorOrDirection(ifcDirection);
				if (result == null) result = caseIfcRepresentationItem(ifcDirection);
				if (result == null) result = caseIfcLayeredItem(ifcDirection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_DISCRETE_ACCESSORY: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcDiscreteAccessory);
			...
			case Ifc2x3Package.IFC_DISTRIBUTION_CHAMBER_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcDistributionChamberElement);
			...
			case Ifc2x3Package.IFC_DISTRIBUTION_CONTROL_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcDistributionControlElement);
			...
			case Ifc2x3Package.IFC_DISTRIBUTION_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcDistributionElement);
			...
			case Ifc2x3Package.IFC_DISTRIBUTION_FLOW_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcDistributionFlowElement);
			...
			case Ifc2x3Package.IFC_DOCUMENT_REFERENCE: {
				...
				if (result == null) result = caseIfcDocumentSelect(ifcDocumentReference);
				if (result == null) result = caseIfcLightDistributionDataSourceSelect(ifcDocumentReference);
			...
			case Ifc2x3Package.IFC_DOOR: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcDoor);
			...
			case Ifc2x3Package.IFC_DRAUGHTING_CALLOUT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcDraughtingCallout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_DRAUGHTING_PRE_DEFINED_COLOUR: {
				...
				if (result == null) result = caseIfcColour(ifcDraughtingPreDefinedColour);
				if (result == null) result = caseIfcFillStyleSelect(ifcDraughtingPreDefinedColour);
				if (result == null) result = caseIfcSymbolStyleSelect(ifcDraughtingPreDefinedColour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_DRAUGHTING_PRE_DEFINED_CURVE_FONT: {
				...
				if (result == null) result = caseIfcCurveStyleFontSelect(ifcDraughtingPreDefinedCurveFont);
				if (result == null) result = caseIfcCurveFontOrScaledCurveFontSelect(ifcDraughtingPreDefinedCurveFont);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_DRAUGHTING_PRE_DEFINED_TEXT_FONT: {
				...
				if (result == null) result = caseIfcTextFontSelect(ifcDraughtingPreDefinedTextFont);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_EDGE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_EDGE_CURVE: {
				...
				if (result == null) result = caseIfcCurveOrEdgeCurve(ifcEdgeCurve);
				...
				if (result == null) result = caseIfcLayeredItem(ifcEdgeCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_EDGE_FEATURE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcEdgeFeature);
			...
			case Ifc2x3Package.IFC_EDGE_LOOP: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcEdgeLoop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_ELECTRIC_DISTRIBUTION_POINT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcElectricDistributionPoint);
			...
			case Ifc2x3Package.IFC_ELECTRICAL_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcElectricalElement);
			...
			case Ifc2x3Package.IFC_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcElement);
			...
			case Ifc2x3Package.IFC_ELEMENT_ASSEMBLY: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcElementAssembly);
			...
			case Ifc2x3Package.IFC_ELEMENT_COMPONENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcElementComponent);
			...
			case Ifc2x3Package.IFC_ELEMENTARY_SURFACE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcElementarySurface);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcElementarySurface);
				if (result == null) result = caseIfcRepresentationItem(ifcElementarySurface);
				if (result == null) result = caseIfcLayeredItem(ifcElementarySurface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ELLIPSE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcEllipse);
				if (result == null) result = caseIfcRepresentationItem(ifcEllipse);
				if (result == null) result = caseIfcLayeredItem(ifcEllipse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_ENERGY_CONVERSION_DEVICE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcEnergyConversionDevice);
			...
			case Ifc2x3Package.IFC_ENVIRONMENTAL_IMPACT_VALUE: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcEnvironmentalImpactValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_EQUIPMENT_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcEquipmentElement);
			...
			case Ifc2x3Package.IFC_EXTERNAL_REFERENCE: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcExternalReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_EXTERNALLY_DEFINED_HATCH_STYLE: {
				...
				if (result == null) result = caseIfcFillStyleSelect(ifcExternallyDefinedHatchStyle);
				if (result == null) result = caseIfcLightDistributionDataSourceSelect(ifcExternallyDefinedHatchStyle);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcExternallyDefinedHatchStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_EXTERNALLY_DEFINED_SURFACE_STYLE: {
				...
				if (result == null) result = caseIfcSurfaceStyleElementSelect(ifcExternallyDefinedSurfaceStyle);
				if (result == null) result = caseIfcLightDistributionDataSourceSelect(ifcExternallyDefinedSurfaceStyle);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcExternallyDefinedSurfaceStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_EXTERNALLY_DEFINED_SYMBOL: {
				...
				if (result == null) result = caseIfcDefinedSymbolSelect(ifcExternallyDefinedSymbol);
				if (result == null) result = caseIfcLightDistributionDataSourceSelect(ifcExternallyDefinedSymbol);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcExternallyDefinedSymbol);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_EXTERNALLY_DEFINED_TEXT_FONT: {
				...
				if (result == null) result = caseIfcTextFontSelect(ifcExternallyDefinedTextFont);
				if (result == null) result = caseIfcLightDistributionDataSourceSelect(ifcExternallyDefinedTextFont);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcExternallyDefinedTextFont);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_EXTRUDED_AREA_SOLID: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcExtrudedAreaSolid);
				if (result == null) result = caseIfcRepresentationItem(ifcExtrudedAreaSolid);
				if (result == null) result = caseIfcLayeredItem(ifcExtrudedAreaSolid);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FACE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcFace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FACE_BASED_SURFACE_MODEL: {
				...
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcFaceBasedSurfaceModel);
				if (result == null) result = caseIfcRepresentationItem(ifcFaceBasedSurfaceModel);
				if (result == null) result = caseIfcLayeredItem(ifcFaceBasedSurfaceModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FACE_BOUND: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcFaceBound);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FACE_OUTER_BOUND: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcFaceOuterBound);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FACE_SURFACE: {
				...
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcFaceSurface);
				...
				if (result == null) result = caseIfcLayeredItem(ifcFaceSurface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FACETED_BREP: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcFacetedBrep);
				if (result == null) result = caseIfcRepresentationItem(ifcFacetedBrep);
				if (result == null) result = caseIfcLayeredItem(ifcFacetedBrep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FACETED_BREP_WITH_VOIDS: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcFacetedBrepWithVoids);
				if (result == null) result = caseIfcRepresentationItem(ifcFacetedBrepWithVoids);
				if (result == null) result = caseIfcLayeredItem(ifcFacetedBrepWithVoids);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_FASTENER: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFastener);
			...
			case Ifc2x3Package.IFC_FEATURE_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFeatureElement);
			...
			case Ifc2x3Package.IFC_FEATURE_ELEMENT_ADDITION: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFeatureElementAddition);
			...
			case Ifc2x3Package.IFC_FEATURE_ELEMENT_SUBTRACTION: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFeatureElementSubtraction);
			...
			case Ifc2x3Package.IFC_FILL_AREA_STYLE: {
				...
				if (result == null) result = caseIfcPresentationStyleSelect(ifcFillAreaStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FILL_AREA_STYLE_HATCHING: {
				...
				if (result == null) result = caseIfcFillStyleSelect(ifcFillAreaStyleHatching);
				if (result == null) result = caseIfcRepresentationItem(ifcFillAreaStyleHatching);
				if (result == null) result = caseIfcLayeredItem(ifcFillAreaStyleHatching);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FILL_AREA_STYLE_TILE_SYMBOL_WITH_STYLE: {
				...
				if (result == null) result = caseIfcFillAreaStyleTileShapeSelect(ifcFillAreaStyleTileSymbolWithStyle);
				if (result == null) result = caseIfcRepresentationItem(ifcFillAreaStyleTileSymbolWithStyle);
				if (result == null) result = caseIfcLayeredItem(ifcFillAreaStyleTileSymbolWithStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_FILL_AREA_STYLE_TILES: {
				...
				if (result == null) result = caseIfcFillStyleSelect(ifcFillAreaStyleTiles);
				if (result == null) result = caseIfcRepresentationItem(ifcFillAreaStyleTiles);
				if (result == null) result = caseIfcLayeredItem(ifcFillAreaStyleTiles);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_FLOW_CONTROLLER: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFlowController);
			...
			case Ifc2x3Package.IFC_FLOW_FITTING: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFlowFitting);
			...
			case Ifc2x3Package.IFC_FLOW_MOVING_DEVICE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFlowMovingDevice);
			...
			case Ifc2x3Package.IFC_FLOW_SEGMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFlowSegment);
			...
			case Ifc2x3Package.IFC_FLOW_STORAGE_DEVICE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFlowStorageDevice);
			...
			case Ifc2x3Package.IFC_FLOW_TERMINAL: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFlowTerminal);
			...
			case Ifc2x3Package.IFC_FLOW_TREATMENT_DEVICE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFlowTreatmentDevice);
			...
			case Ifc2x3Package.IFC_FOOTING: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcFooting);
			...
			case Ifc2x3Package.IFC_GEOMETRIC_CURVE_SET: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcGeometricCurveSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_GEOMETRIC_REPRESENTATION_ITEM: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcGeometricRepresentationItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_GEOMETRIC_SET: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcGeometricSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_HALF_SPACE_SOLID: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcHalfSpaceSolid);
				if (result == null) result = caseIfcRepresentationItem(ifcHalfSpaceSolid);
				if (result == null) result = caseIfcLayeredItem(ifcHalfSpaceSolid);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_IRREGULAR_TIME_SERIES: {
				...
				if (result == null) result = caseIfcMetricValueSelect(ifcIrregularTimeSeries);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcIrregularTimeSeries);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_LIBRARY_REFERENCE: {
				...
				if (result == null) result = caseIfcLibrarySelect(ifcLibraryReference);
				if (result == null) result = caseIfcLightDistributionDataSourceSelect(ifcLibraryReference);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcLibraryReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_LIGHT_SOURCE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcLightSource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LIGHT_SOURCE_AMBIENT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcLightSourceAmbient);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LIGHT_SOURCE_DIRECTIONAL: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcLightSourceDirectional);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LIGHT_SOURCE_GONIOMETRIC: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcLightSourceGoniometric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LIGHT_SOURCE_POSITIONAL: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcLightSourcePositional);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LIGHT_SOURCE_SPOT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcLightSourceSpot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LINE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcLine);
				if (result == null) result = caseIfcRepresentationItem(ifcLine);
				if (result == null) result = caseIfcLayeredItem(ifcLine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LINEAR_DIMENSION: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcLinearDimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_LOCAL_TIME: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcLocalTime);
				if (result == null) result = caseIfcMetricValueSelect(ifcLocalTime);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_LOOP: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcLoop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MANIFOLD_SOLID_BREP: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcManifoldSolidBrep);
				if (result == null) result = caseIfcRepresentationItem(ifcManifoldSolidBrep);
				if (result == null) result = caseIfcLayeredItem(ifcManifoldSolidBrep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MAPPED_ITEM: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcMappedItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_MATERIAL: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcMaterial);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_MATERIAL_LAYER: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcMaterialLayer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_MATERIAL_LIST: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcMaterialList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_MEASURE_WITH_UNIT: {
				...
				if (result == null) result = caseIfcConditionCriterionSelect(ifcMeasureWithUnit);
				if (result == null) result = caseIfcMetricValueSelect(ifcMeasureWithUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_MECHANICAL_FASTENER: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcMechanicalFastener);
			...
			case Ifc2x3Package.IFC_MEMBER: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcMember);
			...
			case Ifc2x3Package.IFC_OFFSET_CURVE2_D: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcOffsetCurve2D);
				if (result == null) result = caseIfcRepresentationItem(ifcOffsetCurve2D);
				if (result == null) result = caseIfcLayeredItem(ifcOffsetCurve2D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_OFFSET_CURVE3_D: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcOffsetCurve3D);
				if (result == null) result = caseIfcRepresentationItem(ifcOffsetCurve3D);
				if (result == null) result = caseIfcLayeredItem(ifcOffsetCurve3D);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ONE_DIRECTION_REPEAT_FACTOR: {
				...
				if (result == null) result = caseIfcHatchLineDistanceSelect(ifcOneDirectionRepeatFactor);
				if (result == null) result = caseIfcRepresentationItem(ifcOneDirectionRepeatFactor);
				if (result == null) result = caseIfcLayeredItem(ifcOneDirectionRepeatFactor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_OPEN_SHELL: {
				...
				if (result == null) result = caseIfcShell(ifcOpenShell);
				...
				if (result == null) result = caseIfcLayeredItem(ifcOpenShell);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_ORGANIZATION: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcOrganization);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_ORIENTED_EDGE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcOrientedEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_PATH: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcPath);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_PERSON: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcPerson);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PERSON_AND_ORGANIZATION: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcPersonAndOrganization);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_PILE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcPile);
			...
			case Ifc2x3Package.IFC_PLACEMENT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcPlacement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PLANAR_BOX: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcPlanarBox);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PLANAR_EXTENT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcPlanarExtent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PLANE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcPlane);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcPlane);
				if (result == null) result = caseIfcRepresentationItem(ifcPlane);
				if (result == null) result = caseIfcLayeredItem(ifcPlane);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PLATE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcPlate);
			...
			case Ifc2x3Package.IFC_POINT: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcPoint);
				if (result == null) result = caseIfcPointOrVertexPoint(ifcPoint);
				if (result == null) result = caseIfcRepresentationItem(ifcPoint);
				if (result == null) result = caseIfcLayeredItem(ifcPoint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POINT_ON_CURVE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcPointOnCurve);
				if (result == null) result = caseIfcPointOrVertexPoint(ifcPointOnCurve);
				if (result == null) result = caseIfcRepresentationItem(ifcPointOnCurve);
				if (result == null) result = caseIfcLayeredItem(ifcPointOnCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POINT_ON_SURFACE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcPointOnSurface);
				if (result == null) result = caseIfcPointOrVertexPoint(ifcPointOnSurface);
				if (result == null) result = caseIfcRepresentationItem(ifcPointOnSurface);
				if (result == null) result = caseIfcLayeredItem(ifcPointOnSurface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POLY_LOOP: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcPolyLoop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POLYGONAL_BOUNDED_HALF_SPACE: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcPolygonalBoundedHalfSpace);
				if (result == null) result = caseIfcRepresentationItem(ifcPolygonalBoundedHalfSpace);
				if (result == null) result = caseIfcLayeredItem(ifcPolygonalBoundedHalfSpace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_POLYLINE: {
				...
				if (result == null) result = caseIfcCurveOrEdgeCurve(ifcPolyline);
				if (result == null) result = caseIfcGeometricRepresentationItem(ifcPolyline);
				if (result == null) result = caseIfcGeometricSetSelect(ifcPolyline);
				if (result == null) result = caseIfcRepresentationItem(ifcPolyline);
				if (result == null) result = caseIfcLayeredItem(ifcPolyline);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_POSTAL_ADDRESS: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcPostalAddress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PRE_DEFINED_COLOUR: {
				...
				if (result == null) result = caseIfcColour(ifcPreDefinedColour);
				if (result == null) result = caseIfcFillStyleSelect(ifcPreDefinedColour);
				if (result == null) result = caseIfcSymbolStyleSelect(ifcPreDefinedColour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PRE_DEFINED_CURVE_FONT: {
				...
				if (result == null) result = caseIfcCurveStyleFontSelect(ifcPreDefinedCurveFont);
				if (result == null) result = caseIfcCurveFontOrScaledCurveFontSelect(ifcPreDefinedCurveFont);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PRE_DEFINED_DIMENSION_SYMBOL: {
				...
				if (result == null) result = caseIfcDefinedSymbolSelect(ifcPreDefinedDimensionSymbol);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_PRE_DEFINED_POINT_MARKER_SYMBOL: {
				...
				if (result == null) result = caseIfcDefinedSymbolSelect(ifcPreDefinedPointMarkerSymbol);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PRE_DEFINED_SYMBOL: {
				...
				if (result == null) result = caseIfcDefinedSymbolSelect(ifcPreDefinedSymbol);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PRE_DEFINED_TERMINATOR_SYMBOL: {
				...
				if (result == null) result = caseIfcDefinedSymbolSelect(ifcPreDefinedTerminatorSymbol);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PRE_DEFINED_TEXT_FONT: {
				...
				if (result == null) result = caseIfcTextFontSelect(ifcPreDefinedTextFont);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_PROJECTION_CURVE: {
				...
				if (result == null) result = caseIfcDraughtingCalloutElement(ifcProjectionCurve);
				...
				if (result == null) result = caseIfcLayeredItem(ifcProjectionCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_PROJECTION_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcProjectionElement);
			...
			case Ifc2x3Package.IFC_RADIUS_DIMENSION: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcRadiusDimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_RAILING: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcRailing);
			...
			case Ifc2x3Package.IFC_RAMP: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcRamp);
			...
			case Ifc2x3Package.IFC_RAMP_FLIGHT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcRampFlight);
			...
			case Ifc2x3Package.IFC_RATIONAL_BEZIER_CURVE: {
				...
				if (result == null) result = caseIfcCurveOrEdgeCurve(ifcRationalBezierCurve);
				if (result == null) result = caseIfcGeometricRepresentationItem(ifcRationalBezierCurve);
				if (result == null) result = caseIfcGeometricSetSelect(ifcRationalBezierCurve);
				if (result == null) result = caseIfcRepresentationItem(ifcRationalBezierCurve);
				if (result == null) result = caseIfcLayeredItem(ifcRationalBezierCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_RECTANGULAR_PYRAMID: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcRectangularPyramid);
				if (result == null) result = caseIfcCsgSelect(ifcRectangularPyramid);
				if (result == null) result = caseIfcRepresentationItem(ifcRectangularPyramid);
				if (result == null) result = caseIfcLayeredItem(ifcRectangularPyramid);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_RECTANGULAR_TRIMMED_SURFACE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcRectangularTrimmedSurface);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcRectangularTrimmedSurface);
				if (result == null) result = caseIfcRepresentationItem(ifcRectangularTrimmedSurface);
				if (result == null) result = caseIfcLayeredItem(ifcRectangularTrimmedSurface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_REGULAR_TIME_SERIES: {
				...
				if (result == null) result = caseIfcMetricValueSelect(ifcRegularTimeSeries);
				if (result == null) result = caseIfcObjectReferenceSelect(ifcRegularTimeSeries);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_REINFORCING_BAR: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcReinforcingBar);
			...
			case Ifc2x3Package.IFC_REINFORCING_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcReinforcingElement);
			...
			case Ifc2x3Package.IFC_REINFORCING_MESH: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcReinforcingMesh);
			...
			case Ifc2x3Package.IFC_REVOLVED_AREA_SOLID: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcRevolvedAreaSolid);
				if (result == null) result = caseIfcRepresentationItem(ifcRevolvedAreaSolid);
				if (result == null) result = caseIfcLayeredItem(ifcRevolvedAreaSolid);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_RIGHT_CIRCULAR_CONE: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcRightCircularCone);
				...
				if (result == null) result = caseIfcLayeredItem(ifcRightCircularCone);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_RIGHT_CIRCULAR_CYLINDER: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcRightCircularCylinder);
				if (result == null) result = caseIfcCsgSelect(ifcRightCircularCylinder);
				if (result == null) result = caseIfcRepresentationItem(ifcRightCircularCylinder);
				if (result == null) result = caseIfcLayeredItem(ifcRightCircularCylinder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_ROOF: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcRoof);
			...
			case Ifc2x3Package.IFC_ROUNDED_EDGE_FEATURE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcRoundedEdgeFeature);
			...
			case Ifc2x3Package.IFC_SI_UNIT: {
				...
				if (result == null) result = caseIfcUnit(ifcSIUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_SHAPE_MODEL: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcShapeModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SHAPE_REPRESENTATION: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcShapeRepresentation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SHELL_BASED_SURFACE_MODEL: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcShellBasedSurfaceModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_SLAB: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcSlab);
			...
			case Ifc2x3Package.IFC_SOLID_MODEL: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcSolidModel);
				if (result == null) result = caseIfcRepresentationItem(ifcSolidModel);
				if (result == null) result = caseIfcLayeredItem(ifcSolidModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_SPHERE: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcSphere);
				if (result == null) result = caseIfcCsgSelect(ifcSphere);
				if (result == null) result = caseIfcRepresentationItem(ifcSphere);
				if (result == null) result = caseIfcLayeredItem(ifcSphere);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_STAIR: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStair);
			...
			case Ifc2x3Package.IFC_STAIR_FLIGHT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStairFlight);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_CURVE_CONNECTION: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralCurveConnection);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_CURVE_MEMBER: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralCurveMember);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_CURVE_MEMBER_VARYING: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralCurveMemberVarying);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_ITEM: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralItem);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_MEMBER: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralMember);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_POINT_CONNECTION: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralPointConnection);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_SURFACE_CONNECTION: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralSurfaceConnection);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_SURFACE_MEMBER: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralSurfaceMember);
			...
			case Ifc2x3Package.IFC_STRUCTURAL_SURFACE_MEMBER_VARYING: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcStructuralSurfaceMemberVarying);
			...
			case Ifc2x3Package.IFC_STRUCTURED_DIMENSION_CALLOUT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcStructuredDimensionCallout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_STYLE_MODEL: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcStyleModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_STYLED_ITEM: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcStyledItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_STYLED_REPRESENTATION: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcStyledRepresentation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_SUBEDGE: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcSubedge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SURFACE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcSurface);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcSurface);
				if (result == null) result = caseIfcRepresentationItem(ifcSurface);
				if (result == null) result = caseIfcLayeredItem(ifcSurface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SURFACE_CURVE_SWEPT_AREA_SOLID: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcSurfaceCurveSweptAreaSolid);
				if (result == null) result = caseIfcRepresentationItem(ifcSurfaceCurveSweptAreaSolid);
				if (result == null) result = caseIfcLayeredItem(ifcSurfaceCurveSweptAreaSolid);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SURFACE_OF_LINEAR_EXTRUSION: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcSurfaceOfLinearExtrusion);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcSurfaceOfLinearExtrusion);
				if (result == null) result = caseIfcRepresentationItem(ifcSurfaceOfLinearExtrusion);
				if (result == null) result = caseIfcLayeredItem(ifcSurfaceOfLinearExtrusion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SURFACE_OF_REVOLUTION: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcSurfaceOfRevolution);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcSurfaceOfRevolution);
				if (result == null) result = caseIfcRepresentationItem(ifcSurfaceOfRevolution);
				if (result == null) result = caseIfcLayeredItem(ifcSurfaceOfRevolution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SURFACE_STYLE: {
				...
				if (result == null) result = caseIfcPresentationStyleSelect(ifcSurfaceStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_SURFACE_STYLE_RENDERING: {
				...
				if (result == null) result = caseIfcSurfaceStyleElementSelect(ifcSurfaceStyleRendering);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_SWEPT_AREA_SOLID: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcSweptAreaSolid);
				if (result == null) result = caseIfcRepresentationItem(ifcSweptAreaSolid);
				if (result == null) result = caseIfcLayeredItem(ifcSweptAreaSolid);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SWEPT_DISK_SOLID: {
				...
				if (result == null) result = caseIfcBooleanOperand(ifcSweptDiskSolid);
				if (result == null) result = caseIfcRepresentationItem(ifcSweptDiskSolid);
				if (result == null) result = caseIfcLayeredItem(ifcSweptDiskSolid);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_SWEPT_SURFACE: {
				...
				if (result == null) result = caseIfcGeometricSetSelect(ifcSweptSurface);
				if (result == null) result = caseIfcSurfaceOrFaceSurface(ifcSweptSurface);
				if (result == null) result = caseIfcRepresentationItem(ifcSweptSurface);
				if (result == null) result = caseIfcLayeredItem(ifcSweptSurface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_SYMBOL_STYLE: {
				...
				if (result == null) result = caseIfcPresentationStyleSelect(ifcSymbolStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_TENDON: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcTendon);
			...
			case Ifc2x3Package.IFC_TENDON_ANCHOR: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcTendonAnchor);
			...
			case Ifc2x3Package.IFC_TERMINATOR_SYMBOL: {
				...
				if (result == null) result = caseIfcDraughtingCalloutElement(ifcTerminatorSymbol);
				...
				if (result == null) result = caseIfcLayeredItem(ifcTerminatorSymbol);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_TEXT_LITERAL: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcTextLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_TEXT_LITERAL_WITH_EXTENT: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcTextLiteralWithExtent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_TEXT_STYLE_FONT_MODEL: {
				...
				if (result == null) result = caseIfcTextFontSelect(ifcTextStyleFontModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_TIME_SERIES: {
				...
				if (result == null) result = caseIfcObjectReferenceSelect(ifcTimeSeries);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_TOPOLOGICAL_REPRESENTATION_ITEM: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcTopologicalRepresentationItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_TOPOLOGY_REPRESENTATION: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcTopologyRepresentation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_TRANSPORT_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcTransportElement);
			...
			case Ifc2x3Package.IFC_TRIMMED_CURVE: {
				...
				if (result == null) result = caseIfcCurveOrEdgeCurve(ifcTrimmedCurve);
				if (result == null) result = caseIfcGeometricRepresentationItem(ifcTrimmedCurve);
				if (result == null) result = caseIfcGeometricSetSelect(ifcTrimmedCurve);
				if (result == null) result = caseIfcRepresentationItem(ifcTrimmedCurve);
				if (result == null) result = caseIfcLayeredItem(ifcTrimmedCurve);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_TWO_DIRECTION_REPEAT_FACTOR: {
				...
				if (result == null) result = caseIfcHatchLineDistanceSelect(ifcTwoDirectionRepeatFactor);
				if (result == null) result = caseIfcRepresentationItem(ifcTwoDirectionRepeatFactor);
				if (result == null) result = caseIfcLayeredItem(ifcTwoDirectionRepeatFactor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_VECTOR: {
				...
				if (result == null) result = caseIfcVectorOrDirection(ifcVector);
				if (result == null) result = caseIfcRepresentationItem(ifcVector);
				if (result == null) result = caseIfcLayeredItem(ifcVector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_VERTEX: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcVertex);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_VERTEX_LOOP: {
				...
				if (result == null) result = caseIfcLayeredItem(ifcVertexLoop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ifc2x3Package.IFC_VERTEX_POINT: {
				...
				if (result == null) result = caseIfcPointOrVertexPoint(ifcVertexPoint);
				...
				if (result == null) result = caseIfcLayeredItem(ifcVertexPoint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Ifc2x3Package.IFC_VIRTUAL_ELEMENT: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcVirtualElement);
			...
			case Ifc2x3Package.IFC_WALL: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcWall);
			...
			case Ifc2x3Package.IFC_WALL_STANDARD_CASE: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcWallStandardCase);
			...
			case Ifc2x3Package.IFC_WINDOW: {
				...
				if (result == null) result = caseIfcStructuralActivityAssignmentSelect(ifcWindow);
			...
			case Ifc2x3Package.IFC_COLOUR: {
				...
				if (result == null) result = caseIfcSymbolStyleSelect(ifcColour);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
