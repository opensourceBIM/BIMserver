 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc2x3.Ifc2x3Package#getIfcPlateTypeEnum()
 * @model
 * @generated
 */
public enum IfcPlateTypeEnum implements Enumerator
{
	 ...
	 * @ordered
	 */
	CURTAIN_PANEL_LITERAL(2, "CURTAIN_PANEL", "CURTAIN_PANEL"),
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>CURTAIN PANEL</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #CURTAIN_PANEL_LITERAL
	 * @model
	 * @generated
	 * @ordered
	 */
	public static final int CURTAIN_PANEL = 2;
	 ...
	 * @generated
	 */
	private static final IfcPlateTypeEnum[] VALUES_ARRAY =
		new IfcPlateTypeEnum[]
		{
			NULL_LITERAL,
			NOTDEFINED_LITERAL,
			CURTAIN_PANEL_LITERAL,
			SHEET_LITERAL,
			USERDEFINED_LITERAL,
		};
	...
	public static IfcPlateTypeEnum get(int value)
	{
		switch (value)
		{
			...
			case CURTAIN_PANEL: return CURTAIN_PANEL_LITERAL;
			case SHEET: return SHEET_LITERAL;
