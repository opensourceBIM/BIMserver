 ...
 * <ul>
 *   <li>{@link org.bimserver.database.store.log.GeoTagUpdated#getGeoTag <em>Geo Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.bimserver.database.store.log.LogPackage#getGeoTagUpdated()
 * @model
 * @generated
 */
public interface GeoTagUpdated extends LogAction {
	 ...
	 * @see org.bimserver.database.store.log.LogPackage#getGeoTagUpdated_GeoTag()
	 * @model
	 * @generated
	 */
	GeoTag getGeoTag();
	...
	/**
	 * Sets the value of the '{@link org.bimserver.database.store.log.GeoTagUpdated#getGeoTag <em>Geo Tag</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
