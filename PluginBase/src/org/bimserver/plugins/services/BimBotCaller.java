...
public class BimBotCaller implements AutoCloseable {
	private String baseAddress;
	private CloseableHttpClient httpClient;
	private String token;

	public static void main(String[] args) {
		try (BimBotCaller bimBotCaller = new BimBotCaller("http://localhost:8080/services", "a70abb752c5a04f5ccce7ea1b79b85c045c594c3d7fb23d6f28e8e8ad04f2750477ec5706013f2bc07be2b9555fd44df")) {
	...
	public BimBotCaller(String baseAddress, String token) {
