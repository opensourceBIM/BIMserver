...
public enum IfcRoleEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcRoleEnum[] VALUES_ARRAY = new IfcRoleEnum[] { NULL, CONSTRUCTIONMANAGER, COSTENGINEER, CONSULTANT, BUILDINGOWNER, COMMISSIONINGENGINEER, ENGINEER, CONTRACTOR,
			ELECTRICALENGINEER, USERDEFINED, MANUFACTURER, SUPPLIER, STRUCTURALENGINEER, CLIENT, OWNER, RESELLER, CIVILENGINEER, BUILDINGOPERATOR, PROJECTMANAGER, MECHANICALENGINEER,
			FACILITIESMANAGER, SUBCONTRACTOR, FIELDCONSTRUCTIONMANAGER, ARCHITECT, };
