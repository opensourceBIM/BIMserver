...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Window Type Partitioning Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcWindowTypePartitioningEnum()
 * @model
 * @generated
 */
public enum IfcWindowTypePartitioningEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Ifc Window Type Partitioning Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final IfcWindowTypePartitioningEnum[] VALUES_ARRAY = new IfcWindowTypePartitioningEnum[] { NULL, NOTDEFINED, DOUBLE_PANEL_HORIZONTAL, TRIPLE_PANEL_BOTTOM, TRIPLE_PANEL_LEFT, DOUBLE_PANEL_VERTICAL, TRIPLE_PANEL_HORIZONTAL,
	...
	public static IfcWindowTypePartitioningEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcWindowTypePartitioningEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private IfcWindowTypePartitioningEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
