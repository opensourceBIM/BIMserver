...
public enum IfcSensorTypeEnum implements Enumerator {
	...
	* <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	private static final IfcSensorTypeEnum[] VALUES_ARRAY = new IfcSensorTypeEnum[] { NULL, PHSENSOR, USERDEFINED,
			WINDSENSOR, HEATSENSOR, MOVEMENTSENSOR, NOTDEFINED, FROSTSENSOR, IDENTIFIERSENSOR, LEVELSENSOR, FLOWSENSOR,
			HUMIDITYSENSOR, PRESSURESENSOR, COSENSOR, RADIATIONSENSOR, FIRESENSOR, CONTACTSENSOR, GASSENSOR,
			IONCONCENTRATIONSENSOR, CO2SENSOR, RADIOACTIVITYSENSOR, LIGHTSENSOR, SOUNDSENSOR, TEMPERATURESENSOR,
			CONDUCTANCESENSOR, MOISTURESENSOR, SMOKESENSOR, };
