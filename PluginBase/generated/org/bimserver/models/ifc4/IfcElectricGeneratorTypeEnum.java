...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Electric Generator Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcElectricGeneratorTypeEnum()
 * @model
 * @generated
 */
public enum IfcElectricGeneratorTypeEnum implements Enumerator {
	/**
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>CHP</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #CHP
	 ...
	 * @generated
	 */
	private static final IfcElectricGeneratorTypeEnum[] VALUES_ARRAY = new IfcElectricGeneratorTypeEnum[] { NULL, STANDALONE, NOTDEFINED, ENGINEGENERATOR, CHP, USERDEFINED, };
	...
	public static IfcElectricGeneratorTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcElectricGeneratorTypeEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private IfcElectricGeneratorTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
