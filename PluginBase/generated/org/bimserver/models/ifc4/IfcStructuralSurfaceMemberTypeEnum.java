...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Structural Surface Member Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcStructuralSurfaceMemberTypeEnum()
 * @model
 * @generated
 */
public enum IfcStructuralSurfaceMemberTypeEnum implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final IfcStructuralSurfaceMemberTypeEnum[] VALUES_ARRAY = new IfcStructuralSurfaceMemberTypeEnum[] { NULL, NOTDEFINED, BENDING_ELEMENT, SHELL, MEMBRANE_ELEMENT, USERDEFINED, };
	 ...
	 * @generated
	 */
	public static IfcStructuralSurfaceMemberTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcStructuralSurfaceMemberTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Ifc Structural Surface Member Type Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static IfcStructuralSurfaceMemberTypeEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcStructuralSurfaceMemberTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Ifc Structural Surface Member Type Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static IfcStructuralSurfaceMemberTypeEnum get(int value) {
		switch (value) {
		case NULL_VALUE:
			return NULL;
