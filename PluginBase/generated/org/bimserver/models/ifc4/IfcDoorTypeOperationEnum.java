...
public enum IfcDoorTypeOperationEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcDoorTypeOperationEnum[] VALUES_ARRAY = new IfcDoorTypeOperationEnum[] { NULL, DOUBLE_DOOR_DOUBLE_SWING, USERDEFINED, SWING_FIXED_LEFT, FOLDING_TO_LEFT, SLIDING_TO_RIGHT,
			SINGLE_SWING_RIGHT, DOUBLE_SWING_LEFT, NOTDEFINED, DOUBLE_DOOR_FOLDING, REVOLVING, DOUBLE_DOOR_SINGLE_SWING_OPPOSITE_RIGHT, SLIDING_TO_LEFT, SWING_FIXED_RIGHT, DOUBLE_SWING_RIGHT,
			ROLLINGUP, SINGLE_SWING_LEFT, DOUBLE_DOOR_SINGLE_SWING_OPPOSITE_LEFT, DOUBLE_DOOR_SINGLE_SWING, DOUBLE_DOOR_SLIDING, FOLDING_TO_RIGHT, };
