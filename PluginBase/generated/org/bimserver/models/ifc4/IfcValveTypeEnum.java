 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcValveTypeEnum()
 * @model
 * @generated
 */
public enum IfcValveTypeEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcValveTypeEnum[] VALUES_ARRAY = new IfcValveTypeEnum[] { NULL, COMMISSIONING, CHANGEOVER, DIVERTING, GASTAP, ANTIVACUUM, USERDEFINED, AIRRELEASE, REGULATING, PRESSUREREDUCING, STEAMTRAP, DOUBLECHECK, NOTDEFINED,
			MIXING, PRESSURERELIEF, STOPCOCK, FLUSHING, ISOLATING, FAUCET, SAFETYCUTOFF, CHECK, DRAWOFFCOCK, GASCOCK, DOUBLEREGULATING, };
