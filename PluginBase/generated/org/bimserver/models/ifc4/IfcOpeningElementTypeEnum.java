...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Opening Element Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcOpeningElementTypeEnum()
 * @model
 * @generated
 */
public enum IfcOpeningElementTypeEnum implements Enumerator {
	/**
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>RECESS</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #RECESS
	 ...
	 * @ordered
	 */
	public static final int RECESS_VALUE = 4;

	/**
	 * An array of all the '<em><b>Ifc Opening Element Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final IfcOpeningElementTypeEnum[] VALUES_ARRAY = new IfcOpeningElementTypeEnum[] { NULL, NOTDEFINED, OPENING, USERDEFINED, RECESS, };
	...
	public static IfcOpeningElementTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcOpeningElementTypeEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private IfcOpeningElementTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
