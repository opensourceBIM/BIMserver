 ...
 * </p>
 * <ul>
 *   <li>{@link org.bimserver.models.ifc4.impl.IfcVaporPermeabilityMeasureImpl#getWrappedValue <em>Wrapped Value</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.impl.IfcVaporPermeabilityMeasureImpl#getWrappedValueAsString <em>Wrapped Value As String</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfcVaporPermeabilityMeasureImpl extends IdEObjectImpl implements IfcVaporPermeabilityMeasure {
	...
	protected EClass eStaticClass() {
		return Ifc4Package.Literals.IFC_VAPOR_PERMEABILITY_MEASURE;
	}
	...
	public void unsetWrappedValue() {
		eUnset(Ifc4Package.Literals.IFC_VAPOR_PERMEABILITY_MEASURE__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(Ifc4Package.Literals.IFC_VAPOR_PERMEABILITY_MEASURE__WRAPPED_VALUE);
	}
	...
	public void unsetWrappedValueAsString() {
		eUnset(Ifc4Package.Literals.IFC_VAPOR_PERMEABILITY_MEASURE__WRAPPED_VALUE_AS_STRING);
	}
	...
	public boolean isSetWrappedValueAsString() {
		return eIsSet(Ifc4Package.Literals.IFC_VAPOR_PERMEABILITY_MEASURE__WRAPPED_VALUE_AS_STRING);
	}
