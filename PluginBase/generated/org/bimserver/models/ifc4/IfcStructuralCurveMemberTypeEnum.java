...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Structural Curve Member Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcStructuralCurveMemberTypeEnum()
 * @model
 * @generated
 */
public enum IfcStructuralCurveMemberTypeEnum implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>Ifc Structural Curve Member Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final IfcStructuralCurveMemberTypeEnum[] VALUES_ARRAY = new IfcStructuralCurveMemberTypeEnum[] { NULL, PIN_JOINED_MEMBER, NOTDEFINED, CABLE, RIGID_JOINED_MEMBER, COMPRESSION_MEMBER, TENSION_MEMBER, USERDEFINED, };
	...
	public static IfcStructuralCurveMemberTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcStructuralCurveMemberTypeEnum result = VALUES_ARRAY[i];
