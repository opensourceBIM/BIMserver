...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Engine Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcEngineTypeEnum()
 * @model
 * @generated
 */
public enum IfcEngineTypeEnum implements Enumerator {
	/**
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>INTERNALCOMBUSTION</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #INTERNALCOMBUSTION
	 * @model
	 * @generated
	 * @ordered
	 */
	...
	public static IfcEngineTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcEngineTypeEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private IfcEngineTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
