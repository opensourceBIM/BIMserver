 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3.Ifc4x3Package#getIfcDerivedUnitEnum()
 * @model
 * @generated
 */
public enum IfcDerivedUnitEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	IONCONCENTRATIONUNIT(29, "IONCONCENTRATIONUNIT", "IONCONCENTRATIONUNIT"),
	 ...
	 * @ordered
	 */
	LINEARSTIFFNESSUNIT(30, "LINEARSTIFFNESSUNIT", "LINEARSTIFFNESSUNIT"),
	 ...
	 * @ordered
	 */
	THERMALRESISTANCEUNIT(39, "THERMALRESISTANCEUNIT", "THERMALRESISTANCEUNIT"),
	 ...
	 * @ordered
	 */
	MODULUSOFROTATIONALSUBGRADEREACTIONUNIT(42, "MODULUSOFROTATIONALSUBGRADEREACTIONUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFLINEARSUBGRADEREACTIONUNIT(45, "MODULUSOFLINEARSUBGRADEREACTIONUNIT",
	 ...
	 * @ordered
	 */
	public static final int IONCONCENTRATIONUNIT_VALUE = 29;
	 ...
	 * @ordered
	 */
	public static final int LINEARSTIFFNESSUNIT_VALUE = 30;
	 ...
	 * @ordered
	 */
	public static final int PHUNIT_VALUE = 38;
	 ...
	 * @ordered
	 */
	public static final int THERMALRESISTANCEUNIT_VALUE = 39;
	 ...
	 * @generated
	 */
	private static final IfcDerivedUnitEnum[] VALUES_ARRAY = new IfcDerivedUnitEnum[] { NULL, AREADENSITYUNIT,
			MODULUSOFELASTICITYUNIT, CURVATUREUNIT, USERDEFINED, DYNAMICVISCOSITYUNIT, MASSDENSITYUNIT,
			SHEARMODULUSUNIT, LINEARMOMENTUNIT, WARPINGMOMENTUNIT, VOLUMETRICFLOWRATEUNIT, WARPINGCONSTANTUNIT,
			MODULUSOFSUBGRADEREACTIONUNIT, THERMALTRANSMITTANCEUNIT, THERMALEXPANSIONCOEFFICIENTUNIT,
			ROTATIONALSTIFFNESSUNIT, MOMENTOFINERTIAUNIT, TEMPERATUREGRADIENTUNIT, THERMALCONDUCTANCEUNIT,
			MASSFLOWRATEUNIT, MOISTUREDIFFUSIVITYUNIT, KINEMATICVISCOSITYUNIT, TORQUEUNIT, HEATFLUXDENSITYUNIT,
			THERMALADMITTANCEUNIT, ANGULARVELOCITYUNIT, LINEARFORCEUNIT, SOUNDPOWERLEVELUNIT,
			TEMPERATURERATEOFCHANGEUNIT, IONCONCENTRATIONUNIT, LINEARSTIFFNESSUNIT, SECTIONAREAINTEGRALUNIT,
			SOUNDPOWERUNIT, LINEARVELOCITYUNIT, PLANARFORCEUNIT, SPECIFICHEATCAPACITYUNIT, VAPORPERMEABILITYUNIT,
			ROTATIONALFREQUENCYUNIT, PHUNIT, THERMALRESISTANCEUNIT, MASSPERLENGTHUNIT, SOUNDPRESSUREUNIT,
			...
			COMPOUNDPLANEANGLEUNIT, HEATINGVALUEUNIT, SOUNDPRESSURELEVELUNIT, ISOTHERMALMOISTURECAPACITYUNIT,
