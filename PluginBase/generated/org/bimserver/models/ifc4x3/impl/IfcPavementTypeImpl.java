...
public class IfcPavementTypeImpl extends IfcBuiltElementTypeImpl implements IfcPavementType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPavementType();
	}
	...
	public IfcPavementTypeEnum getPredefinedType() {
		return (IfcPavementTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcPavementType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcPavementTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPavementType_PredefinedType(), newPredefinedType);
	}
