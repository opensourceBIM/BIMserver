...
public class IfcRoadPartImpl extends IfcFacilityPartImpl implements IfcRoadPart {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRoadPart();
	}
	...
	public IfcRoadPartTypeEnum getPredefinedType() {
		return (IfcRoadPartTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcRoadPart_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcRoadPartTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRoadPart_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRoadPart_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRoadPart_PredefinedType());
	}
