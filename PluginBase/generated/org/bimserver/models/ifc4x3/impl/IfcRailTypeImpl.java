...
public class IfcRailTypeImpl extends IfcBuiltElementTypeImpl implements IfcRailType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRailType();
	}
	...
	public IfcRailTypeEnum getPredefinedType() {
		return (IfcRailTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcRailType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcRailTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRailType_PredefinedType(), newPredefinedType);
	}
