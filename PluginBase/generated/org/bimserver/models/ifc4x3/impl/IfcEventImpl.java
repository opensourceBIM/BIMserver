...
public class IfcEventImpl extends IfcProcessImpl implements IfcEvent {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcEvent();
	}
	...
	public IfcEventTypeEnum getPredefinedType() {
		return (IfcEventTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcEvent_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcEventTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcEvent_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcEvent_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcEvent_PredefinedType());
	}
	...
	public IfcEventTriggerTypeEnum getEventTriggerType() {
		return (IfcEventTriggerTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcEvent_EventTriggerType(), true);
	}
	...
	public void setEventTriggerType(IfcEventTriggerTypeEnum newEventTriggerType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcEvent_EventTriggerType(), newEventTriggerType);
	}
	...
	public void unsetEventTriggerType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcEvent_EventTriggerType());
	}
	...
	public boolean isSetEventTriggerType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcEvent_EventTriggerType());
	}
	...
	public String getUserDefinedEventTriggerType() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcEvent_UserDefinedEventTriggerType(), true);
	}
	...
	public void setUserDefinedEventTriggerType(String newUserDefinedEventTriggerType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcEvent_UserDefinedEventTriggerType(), newUserDefinedEventTriggerType);
	}
	...
	public void unsetUserDefinedEventTriggerType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcEvent_UserDefinedEventTriggerType());
	}
	...
	public boolean isSetUserDefinedEventTriggerType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcEvent_UserDefinedEventTriggerType());
	}
	...
	public IfcEventTime getEventOccurenceTime() {
		return (IfcEventTime) eGet(Ifc4x3Package.eINSTANCE.getIfcEvent_EventOccurenceTime(), true);
	}
	...
	public void setEventOccurenceTime(IfcEventTime newEventOccurenceTime) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcEvent_EventOccurenceTime(), newEventOccurenceTime);
	}
	...
	public void unsetEventOccurenceTime() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcEvent_EventOccurenceTime());
	}
	...
	public boolean isSetEventOccurenceTime() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcEvent_EventOccurenceTime());
	}
