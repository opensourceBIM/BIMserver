...
public class IfcDoorPanelPropertiesImpl extends IfcPreDefinedPropertySetImpl implements IfcDoorPanelProperties {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES;
	}
	...
	public double getPanelDepth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH, true);
	}
	...
	public void setPanelDepth(double newPanelDepth) {
		eSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH, newPanelDepth);
	}
	...
	public void unsetPanelDepth() {
		eUnset(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH);
	}
	...
	public boolean isSetPanelDepth() {
		return eIsSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH);
	}
	...
	public String getPanelDepthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH_AS_STRING, true);
	}
	...
	public void setPanelDepthAsString(String newPanelDepthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH_AS_STRING, newPanelDepthAsString);
	}
	...
	public void unsetPanelDepthAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH_AS_STRING);
	}
	...
	public boolean isSetPanelDepthAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_DEPTH_AS_STRING);
	}
	...
	public IfcDoorPanelOperationEnum getPanelOperation() {
		return (IfcDoorPanelOperationEnum) eGet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_OPERATION,
				true);
	}
	...
	public void setPanelOperation(IfcDoorPanelOperationEnum newPanelOperation) {
		eSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_OPERATION, newPanelOperation);
	}
	...
	public double getPanelWidth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH, true);
	}
	...
	public void setPanelWidth(double newPanelWidth) {
		eSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH, newPanelWidth);
	}
	...
	public void unsetPanelWidth() {
		eUnset(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH);
	}
	...
	public boolean isSetPanelWidth() {
		return eIsSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH);
	}
	...
	public String getPanelWidthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH_AS_STRING, true);
	}
	...
	public void setPanelWidthAsString(String newPanelWidthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH_AS_STRING, newPanelWidthAsString);
	}
	...
	public boolean isSetPanelWidthAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_WIDTH_AS_STRING);
	}
	...
	public IfcDoorPanelPositionEnum getPanelPosition() {
		return (IfcDoorPanelPositionEnum) eGet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_POSITION, true);
	}
	...
	public void setPanelPosition(IfcDoorPanelPositionEnum newPanelPosition) {
		eSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__PANEL_POSITION, newPanelPosition);
	}
	...
	public IfcShapeAspect getShapeAspectStyle() {
		return (IfcShapeAspect) eGet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE, true);
	}
	...
	public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
		eSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE, newShapeAspectStyle);
	}
	...
	public void unsetShapeAspectStyle() {
		eUnset(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
	...
	public boolean isSetShapeAspectStyle() {
		return eIsSet(Ifc4x3Package.Literals.IFC_DOOR_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
