...
public class IfcFixedReferenceSweptAreaSolidImpl extends IfcDirectrixCurveSweptAreaSolidImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcFixedReferenceSweptAreaSolid();
	}
	...
	public IfcDirection getFixedReference() {
		return (IfcDirection) eGet(Ifc4x3Package.eINSTANCE.getIfcFixedReferenceSweptAreaSolid_FixedReference(), true);
	}
	...
	public void setFixedReference(IfcDirection newFixedReference) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcFixedReferenceSweptAreaSolid_FixedReference(), newFixedReference);
	}
