...
public class IfcIntegerImpl extends IdEObjectImpl implements IfcInteger {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcInteger();
	}
	...
	public long getWrappedValue() {
		return (Long) eGet(Ifc4x3Package.eINSTANCE.getIfcInteger_WrappedValue(), true);
	}
	...
	public void setWrappedValue(long newWrappedValue) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcInteger_WrappedValue(), newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcInteger_WrappedValue());
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcInteger_WrappedValue());
	}
