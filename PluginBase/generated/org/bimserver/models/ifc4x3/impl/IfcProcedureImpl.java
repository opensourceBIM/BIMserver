...
public class IfcProcedureImpl extends IfcProcessImpl implements IfcProcedure {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcProcedure();
	}
	...
	public IfcProcedureTypeEnum getPredefinedType() {
		return (IfcProcedureTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcProcedure_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcProcedureTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcProcedure_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcProcedure_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcProcedure_PredefinedType());
	}
