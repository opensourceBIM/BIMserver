...
public class IfcBlobTextureImpl extends IfcSurfaceTextureImpl implements IfcBlobTexture {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcBlobTexture();
	}
	...
	public String getRasterFormat() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcBlobTexture_RasterFormat(), true);
	}
	...
	public void setRasterFormat(String newRasterFormat) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBlobTexture_RasterFormat(), newRasterFormat);
	}
	...
	public byte[] getRasterCode() {
		return (byte[]) eGet(Ifc4x3Package.eINSTANCE.getIfcBlobTexture_RasterCode(), true);
	}
	...
	public void setRasterCode(byte[] newRasterCode) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBlobTexture_RasterCode(), newRasterCode);
	}
