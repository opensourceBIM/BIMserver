...
public class IfcStructuralConnectionImpl extends IfcStructuralItemImpl implements IfcStructuralConnection {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_STRUCTURAL_CONNECTION;
	}
	...
	public IfcBoundaryCondition getAppliedCondition() {
		return (IfcBoundaryCondition) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_CONNECTION__APPLIED_CONDITION, true);
	}
	...
	public void setAppliedCondition(IfcBoundaryCondition newAppliedCondition) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_CONNECTION__APPLIED_CONDITION, newAppliedCondition);
	}
	...
	public void unsetAppliedCondition() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_CONNECTION__APPLIED_CONDITION);
	}
	...
	public EList<IfcRelConnectsStructuralMember> getConnectsStructuralMembers() {
		return (EList<IfcRelConnectsStructuralMember>) eGet(
				Ifc4x3Package.Literals.IFC_STRUCTURAL_CONNECTION__CONNECTS_STRUCTURAL_MEMBERS, true);
	}
	...
	public void unsetConnectsStructuralMembers() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_CONNECTION__CONNECTS_STRUCTURAL_MEMBERS);
	}
	...
	public boolean isSetConnectsStructuralMembers() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_CONNECTION__CONNECTS_STRUCTURAL_MEMBERS);
	}
