...
public class IfcCompositeCurveSegmentImpl extends IfcSegmentImpl implements IfcCompositeCurveSegment {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCompositeCurveSegment();
	}
	...
	public Tristate getSameSense() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurveSegment_SameSense(), true);
	}
	...
	public void setSameSense(Tristate newSameSense) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurveSegment_SameSense(), newSameSense);
	}
	...
	public IfcCurve getParentCurve() {
		return (IfcCurve) eGet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurveSegment_ParentCurve(), true);
	}
	...
	public void setParentCurve(IfcCurve newParentCurve) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurveSegment_ParentCurve(), newParentCurve);
	}
