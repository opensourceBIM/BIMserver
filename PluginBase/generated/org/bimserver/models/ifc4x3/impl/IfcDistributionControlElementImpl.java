 ...
 * </p>
 * <ul>
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcDistributionControlElementImpl#getAssignedToFlowElement <em>Assigned To Flow Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfcDistributionControlElementImpl extends IfcDistributionElementImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcDistributionControlElement();
	}
	...
	public EList<IfcRelFlowControlElements> getAssignedToFlowElement() {
		return (EList<IfcRelFlowControlElements>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcDistributionControlElement_AssignedToFlowElement(), true);
	}
	...
	public void unsetAssignedToFlowElement() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcDistributionControlElement_AssignedToFlowElement());
	}
	...
	public boolean isSetAssignedToFlowElement() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcDistributionControlElement_AssignedToFlowElement());
	}
