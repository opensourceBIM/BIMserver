...
public class IfcPlanarExtentImpl extends IfcGeometricRepresentationItemImpl implements IfcPlanarExtent {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_PLANAR_EXTENT;
	}
	...
	public double getSizeInX() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_PLANAR_EXTENT__SIZE_IN_X, true);
	}
	...
	public void setSizeInX(double newSizeInX) {
		eSet(Ifc4x3Package.Literals.IFC_PLANAR_EXTENT__SIZE_IN_X, newSizeInX);
	}
	...
	public String getSizeInXAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_PLANAR_EXTENT__SIZE_IN_XAS_STRING, true);
	}
	...
	public void setSizeInXAsString(String newSizeInXAsString) {
		eSet(Ifc4x3Package.Literals.IFC_PLANAR_EXTENT__SIZE_IN_XAS_STRING, newSizeInXAsString);
	}
	...
	public double getSizeInY() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_PLANAR_EXTENT__SIZE_IN_Y, true);
	}
	...
	public void setSizeInY(double newSizeInY) {
		eSet(Ifc4x3Package.Literals.IFC_PLANAR_EXTENT__SIZE_IN_Y, newSizeInY);
	}
	...
	public String getSizeInYAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_PLANAR_EXTENT__SIZE_IN_YAS_STRING, true);
	}
	...
	public void setSizeInYAsString(String newSizeInYAsString) {
		eSet(Ifc4x3Package.Literals.IFC_PLANAR_EXTENT__SIZE_IN_YAS_STRING, newSizeInYAsString);
	}
