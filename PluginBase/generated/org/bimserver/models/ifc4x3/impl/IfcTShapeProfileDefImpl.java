...
public class IfcTShapeProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcTShapeProfileDef {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF;
	}
	...
	public double getDepth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__DEPTH, true);
	}
	...
	public void setDepth(double newDepth) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__DEPTH, newDepth);
	}
	...
	public String getDepthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__DEPTH_AS_STRING, true);
	}
	...
	public void setDepthAsString(String newDepthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__DEPTH_AS_STRING, newDepthAsString);
	}
	...
	public double getFlangeWidth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_WIDTH, true);
	}
	...
	public void setFlangeWidth(double newFlangeWidth) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_WIDTH, newFlangeWidth);
	}
	...
	public String getFlangeWidthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_WIDTH_AS_STRING, true);
	}
	...
	public void setFlangeWidthAsString(String newFlangeWidthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_WIDTH_AS_STRING, newFlangeWidthAsString);
	}
	...
	public double getWebThickness() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_THICKNESS, true);
	}
	...
	public void setWebThickness(double newWebThickness) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_THICKNESS, newWebThickness);
	}
	...
	public String getWebThicknessAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, true);
	}
	...
	public void setWebThicknessAsString(String newWebThicknessAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, newWebThicknessAsString);
	}
	...
	public double getFlangeThickness() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_THICKNESS, true);
	}
	...
	public void setFlangeThickness(double newFlangeThickness) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_THICKNESS, newFlangeThickness);
	}
	...
	public String getFlangeThicknessAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING, true);
	}
	...
	public void setFlangeThicknessAsString(String newFlangeThicknessAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING, newFlangeThicknessAsString);
	}
	...
	public double getFilletRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS, true);
	}
	...
	public void setFilletRadius(double newFilletRadius) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS, newFilletRadius);
	}
	...
	public void unsetFilletRadius() {
		eUnset(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS);
	}
	...
	public boolean isSetFilletRadius() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS);
	}
	...
	public String getFilletRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING, true);
	}
	...
	public void setFilletRadiusAsString(String newFilletRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING, newFilletRadiusAsString);
	}
	...
	public void unsetFilletRadiusAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING);
	}
	...
	public boolean isSetFilletRadiusAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING);
	}
	...
	public double getFlangeEdgeRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS, true);
	}
	...
	public void setFlangeEdgeRadius(double newFlangeEdgeRadius) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS, newFlangeEdgeRadius);
	}
	...
	public String getFlangeEdgeRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS_AS_STRING, true);
	}
	...
	public void setFlangeEdgeRadiusAsString(String newFlangeEdgeRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS_AS_STRING, newFlangeEdgeRadiusAsString);
	}
	...
	public boolean isSetFlangeEdgeRadiusAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS_AS_STRING);
	}
	...
	public double getWebEdgeRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS, true);
	}
	...
	public void setWebEdgeRadius(double newWebEdgeRadius) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS, newWebEdgeRadius);
	}
	...
	public void unsetWebEdgeRadius() {
		eUnset(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS);
	}
	...
	public boolean isSetWebEdgeRadius() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS);
	}
	...
	public String getWebEdgeRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS_AS_STRING, true);
	}
	...
	public void setWebEdgeRadiusAsString(String newWebEdgeRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS_AS_STRING, newWebEdgeRadiusAsString);
	}
	...
	public void unsetWebEdgeRadiusAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS_AS_STRING);
	}
	...
	public boolean isSetWebEdgeRadiusAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS_AS_STRING);
	}
	...
	public double getWebSlope() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE, true);
	}
	...
	public void setWebSlope(double newWebSlope) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE, newWebSlope);
	}
	...
	public void unsetWebSlope() {
		eUnset(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE);
	}
	...
	public boolean isSetWebSlope() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE);
	}
	...
	public String getWebSlopeAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE_AS_STRING, true);
	}
	...
	public void setWebSlopeAsString(String newWebSlopeAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE_AS_STRING, newWebSlopeAsString);
	}
	...
	public void unsetWebSlopeAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE_AS_STRING);
	}
	...
	public boolean isSetWebSlopeAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE_AS_STRING);
	}
	...
	public double getFlangeSlope() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE, true);
	}
	...
	public void setFlangeSlope(double newFlangeSlope) {
		eSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE, newFlangeSlope);
	}
	...
	public void unsetFlangeSlope() {
		eUnset(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE);
	}
	...
	public boolean isSetFlangeSlope() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE);
	}
	...
	public String getFlangeSlopeAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING, true);
	}
	...
	public void unsetFlangeSlopeAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING);
	}
	...
	public boolean isSetFlangeSlopeAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING);
	}
