...
public class IfcTimeSeriesImpl extends IdEObjectImpl implements IfcTimeSeries {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_TIME_SERIES;
	}
	...
	public String getName() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TIME_SERIES__NAME, true);
	}
	...
	public void setName(String newName) {
		eSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__NAME, newName);
	}
	...
	public String getDescription() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TIME_SERIES__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(Ifc4x3Package.Literals.IFC_TIME_SERIES__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__DESCRIPTION);
	}
	...
	public String getStartTime() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TIME_SERIES__START_TIME, true);
	}
	...
	public void setStartTime(String newStartTime) {
		eSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__START_TIME, newStartTime);
	}
	...
	public String getEndTime() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TIME_SERIES__END_TIME, true);
	}
	...
	public void setEndTime(String newEndTime) {
		eSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__END_TIME, newEndTime);
	}
	...
	public IfcTimeSeriesDataTypeEnum getTimeSeriesDataType() {
		return (IfcTimeSeriesDataTypeEnum) eGet(Ifc4x3Package.Literals.IFC_TIME_SERIES__TIME_SERIES_DATA_TYPE, true);
	}
	...
	public void setTimeSeriesDataType(IfcTimeSeriesDataTypeEnum newTimeSeriesDataType) {
		eSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__TIME_SERIES_DATA_TYPE, newTimeSeriesDataType);
	}
	...
	public IfcDataOriginEnum getDataOrigin() {
		return (IfcDataOriginEnum) eGet(Ifc4x3Package.Literals.IFC_TIME_SERIES__DATA_ORIGIN, true);
	}
	...
	public void setDataOrigin(IfcDataOriginEnum newDataOrigin) {
		eSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__DATA_ORIGIN, newDataOrigin);
	}
	...
	public String getUserDefinedDataOrigin() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TIME_SERIES__USER_DEFINED_DATA_ORIGIN, true);
	}
	...
	public void setUserDefinedDataOrigin(String newUserDefinedDataOrigin) {
		eSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__USER_DEFINED_DATA_ORIGIN, newUserDefinedDataOrigin);
	}
	...
	public void unsetUserDefinedDataOrigin() {
		eUnset(Ifc4x3Package.Literals.IFC_TIME_SERIES__USER_DEFINED_DATA_ORIGIN);
	}
	...
	public boolean isSetUserDefinedDataOrigin() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__USER_DEFINED_DATA_ORIGIN);
	}
	...
	public IfcUnit getUnit() {
		return (IfcUnit) eGet(Ifc4x3Package.Literals.IFC_TIME_SERIES__UNIT, true);
	}
	...
	public void setUnit(IfcUnit newUnit) {
		eSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__UNIT, newUnit);
	}
	...
	public void unsetUnit() {
		eUnset(Ifc4x3Package.Literals.IFC_TIME_SERIES__UNIT);
	}
	...
	public boolean isSetUnit() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__UNIT);
	}
	...
	public EList<IfcExternalReferenceRelationship> getHasExternalReference() {
		return (EList<IfcExternalReferenceRelationship>) eGet(
				Ifc4x3Package.Literals.IFC_TIME_SERIES__HAS_EXTERNAL_REFERENCE, true);
	}
	...
	public void unsetHasExternalReference() {
		eUnset(Ifc4x3Package.Literals.IFC_TIME_SERIES__HAS_EXTERNAL_REFERENCE);
	}
	...
	public boolean isSetHasExternalReference() {
		return eIsSet(Ifc4x3Package.Literals.IFC_TIME_SERIES__HAS_EXTERNAL_REFERENCE);
	}
