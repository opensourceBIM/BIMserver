...
public class IfcReinforcingBarImpl extends IfcReinforcingElementImpl implements IfcReinforcingBar {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_REINFORCING_BAR;
	}
	...
	public double getNominalDiameter() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER, true);
	}
	...
	public void setNominalDiameter(double newNominalDiameter) {
		eSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER, newNominalDiameter);
	}
	...
	public String getNominalDiameterAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER_AS_STRING, true);
	}
	...
	public void setNominalDiameterAsString(String newNominalDiameterAsString) {
		eSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER_AS_STRING, newNominalDiameterAsString);
	}
	...
	public void unsetNominalDiameterAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER_AS_STRING);
	}
	...
	public boolean isSetNominalDiameterAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__NOMINAL_DIAMETER_AS_STRING);
	}
	...
	public double getCrossSectionArea() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA, true);
	}
	...
	public void setCrossSectionArea(double newCrossSectionArea) {
		eSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA, newCrossSectionArea);
	}
	...
	public void unsetCrossSectionArea() {
		eUnset(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA);
	}
	...
	public boolean isSetCrossSectionArea() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA);
	}
	...
	public String getCrossSectionAreaAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA_AS_STRING, true);
	}
	...
	public void setCrossSectionAreaAsString(String newCrossSectionAreaAsString) {
		eSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA_AS_STRING, newCrossSectionAreaAsString);
	}
	...
	public void unsetCrossSectionAreaAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA_AS_STRING);
	}
	...
	public boolean isSetCrossSectionAreaAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__CROSS_SECTION_AREA_AS_STRING);
	}
	...
	public double getBarLength() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH, true);
	}
	...
	public void setBarLength(double newBarLength) {
		eSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH, newBarLength);
	}
	...
	public void unsetBarLength() {
		eUnset(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH);
	}
	...
	public boolean isSetBarLength() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH);
	}
	...
	public String getBarLengthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING, true);
	}
	...
	public void setBarLengthAsString(String newBarLengthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING, newBarLengthAsString);
	}
	...
	public void unsetBarLengthAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING);
	}
	...
	public boolean isSetBarLengthAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_LENGTH_AS_STRING);
	}
	...
	public IfcReinforcingBarTypeEnum getPredefinedType() {
		return (IfcReinforcingBarTypeEnum) eGet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcReinforcingBarTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__PREDEFINED_TYPE);
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__PREDEFINED_TYPE);
	}
	...
	public IfcReinforcingBarSurfaceEnum getBarSurface() {
		return (IfcReinforcingBarSurfaceEnum) eGet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_SURFACE, true);
	}
	...
	public void setBarSurface(IfcReinforcingBarSurfaceEnum newBarSurface) {
		eSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_SURFACE, newBarSurface);
	}
	...
	public void unsetBarSurface() {
		eUnset(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_SURFACE);
	}
	...
	public boolean isSetBarSurface() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REINFORCING_BAR__BAR_SURFACE);
	}
