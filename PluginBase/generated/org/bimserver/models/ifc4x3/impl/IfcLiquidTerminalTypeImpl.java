...
public class IfcLiquidTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcLiquidTerminalType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcLiquidTerminalType();
	}
	...
	public IfcLiquidTerminalTypeEnum getPredefinedType() {
		return (IfcLiquidTerminalTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcLiquidTerminalType_PredefinedType(),
				true);
	}
	...
	public void setPredefinedType(IfcLiquidTerminalTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcLiquidTerminalType_PredefinedType(), newPredefinedType);
	}
