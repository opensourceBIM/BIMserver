...
public class IfcMaterialProfileSetUsageImpl extends IfcMaterialUsageDefinitionImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE;
	}
	...
	public IfcMaterialProfileSet getForProfileSet() {
		return (IfcMaterialProfileSet) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__FOR_PROFILE_SET,
				true);
	}
	...
	public void setForProfileSet(IfcMaterialProfileSet newForProfileSet) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__FOR_PROFILE_SET, newForProfileSet);
	}
	...
	public long getCardinalPoint() {
		return (Long) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__CARDINAL_POINT, true);
	}
	...
	public void setCardinalPoint(long newCardinalPoint) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__CARDINAL_POINT, newCardinalPoint);
	}
	...
	public void unsetCardinalPoint() {
		eUnset(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__CARDINAL_POINT);
	}
	...
	public boolean isSetCardinalPoint() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__CARDINAL_POINT);
	}
	...
	public double getReferenceExtent() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__REFERENCE_EXTENT, true);
	}
	...
	public void setReferenceExtent(double newReferenceExtent) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__REFERENCE_EXTENT, newReferenceExtent);
	}
	...
	public void unsetReferenceExtent() {
		eUnset(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__REFERENCE_EXTENT);
	}
	...
	public boolean isSetReferenceExtent() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__REFERENCE_EXTENT);
	}
	...
	public String getReferenceExtentAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__REFERENCE_EXTENT_AS_STRING, true);
	}
	...
	public void setReferenceExtentAsString(String newReferenceExtentAsString) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__REFERENCE_EXTENT_AS_STRING,
	...
	public void unsetReferenceExtentAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__REFERENCE_EXTENT_AS_STRING);
	}
	...
	public boolean isSetReferenceExtentAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MATERIAL_PROFILE_SET_USAGE__REFERENCE_EXTENT_AS_STRING);
	}
