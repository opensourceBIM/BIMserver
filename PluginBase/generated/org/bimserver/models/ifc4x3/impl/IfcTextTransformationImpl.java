...
public class IfcTextTransformationImpl extends IdEObjectImpl implements IfcTextTransformation {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcTextTransformation();
	}
	...
	public String getWrappedValue() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcTextTransformation_WrappedValue(), true);
	}
	...
	public void setWrappedValue(String newWrappedValue) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcTextTransformation_WrappedValue(), newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcTextTransformation_WrappedValue());
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcTextTransformation_WrappedValue());
	}
