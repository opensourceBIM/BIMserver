...
public class IfcBoilerImpl extends IfcEnergyConversionDeviceImpl implements IfcBoiler {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcBoiler();
	}
	...
	public IfcBoilerTypeEnum getPredefinedType() {
		return (IfcBoilerTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcBoiler_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcBoilerTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBoiler_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcBoiler_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcBoiler_PredefinedType());
	}
