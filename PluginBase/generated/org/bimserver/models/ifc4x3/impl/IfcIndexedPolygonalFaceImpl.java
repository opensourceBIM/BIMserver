...
public class IfcIndexedPolygonalFaceImpl extends IfcTessellatedItemImpl implements IfcIndexedPolygonalFace {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcIndexedPolygonalFace();
	}
	...
	public EList<Long> getCoordIndex() {
		return (EList<Long>) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolygonalFace_CoordIndex(), true);
	}
	...
	public EList<IfcPolygonalFaceSet> getToFaceSet() {
		return (EList<IfcPolygonalFaceSet>) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolygonalFace_ToFaceSet(), true);
	}
	...
	public void unsetToFaceSet() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcIndexedPolygonalFace_ToFaceSet());
	}
	...
	public boolean isSetToFaceSet() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolygonalFace_ToFaceSet());
	}
	...
	public EList<IfcTextureCoordinateIndices> getHasTexCoords() {
		return (EList<IfcTextureCoordinateIndices>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcIndexedPolygonalFace_HasTexCoords(), true);
	}
	...
	public void unsetHasTexCoords() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcIndexedPolygonalFace_HasTexCoords());
	}
	...
	public boolean isSetHasTexCoords() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolygonalFace_HasTexCoords());
	}
