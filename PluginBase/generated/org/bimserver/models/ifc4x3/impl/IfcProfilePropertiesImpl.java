...
public class IfcProfilePropertiesImpl extends IfcExtendedPropertiesImpl implements IfcProfileProperties {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcProfileProperties();
	}
	...
	public IfcProfileDef getProfileDefinition() {
		return (IfcProfileDef) eGet(Ifc4x3Package.eINSTANCE.getIfcProfileProperties_ProfileDefinition(), true);
	}
	...
	public void setProfileDefinition(IfcProfileDef newProfileDefinition) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcProfileProperties_ProfileDefinition(), newProfileDefinition);
	}
