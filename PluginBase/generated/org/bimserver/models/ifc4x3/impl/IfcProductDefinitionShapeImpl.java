...
public class IfcProductDefinitionShapeImpl extends IfcProductRepresentationImpl implements IfcProductDefinitionShape {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE;
	}
	...
	public EList<IfcProduct> getShapeOfProduct() {
		return (EList<IfcProduct>) eGet(Ifc4x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE__SHAPE_OF_PRODUCT, true);
	}
	...
	public void unsetShapeOfProduct() {
		eUnset(Ifc4x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE__SHAPE_OF_PRODUCT);
	}
	...
	public boolean isSetShapeOfProduct() {
		return eIsSet(Ifc4x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE__SHAPE_OF_PRODUCT);
	}
	...
	public EList<IfcShapeAspect> getHasShapeAspects() {
		return (EList<IfcShapeAspect>) eGet(Ifc4x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE__HAS_SHAPE_ASPECTS,
				true);
	}
	...
	public void unsetHasShapeAspects() {
		eUnset(Ifc4x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE__HAS_SHAPE_ASPECTS);
	}
	...
	public boolean isSetHasShapeAspects() {
		return eIsSet(Ifc4x3Package.Literals.IFC_PRODUCT_DEFINITION_SHAPE__HAS_SHAPE_ASPECTS);
	}
