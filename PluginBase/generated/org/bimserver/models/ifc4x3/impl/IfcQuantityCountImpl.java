...
public class IfcQuantityCountImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityCount {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcQuantityCount();
	}
	...
	public long getCountValue() {
		return (Long) eGet(Ifc4x3Package.eINSTANCE.getIfcQuantityCount_CountValue(), true);
	}
	...
	public void setCountValue(long newCountValue) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcQuantityCount_CountValue(), newCountValue);
	}
	...
	public String getFormula() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcQuantityCount_Formula(), true);
	}
	...
	public void setFormula(String newFormula) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcQuantityCount_Formula(), newFormula);
	}
	...
	public void unsetFormula() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcQuantityCount_Formula());
	}
	...
	public boolean isSetFormula() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcQuantityCount_Formula());
	}
