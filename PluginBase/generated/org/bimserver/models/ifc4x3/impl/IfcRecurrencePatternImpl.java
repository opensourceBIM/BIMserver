...
public class IfcRecurrencePatternImpl extends IdEObjectImpl implements IfcRecurrencePattern {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN;
	}
	...
	public IfcRecurrenceTypeEnum getRecurrenceType() {
		return (IfcRecurrenceTypeEnum) eGet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__RECURRENCE_TYPE, true);
	}
	...
	public void setRecurrenceType(IfcRecurrenceTypeEnum newRecurrenceType) {
		eSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__RECURRENCE_TYPE, newRecurrenceType);
	}
	...
	public EList<Long> getDayComponent() {
		return (EList<Long>) eGet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__DAY_COMPONENT, true);
	}
	...
	public void unsetDayComponent() {
		eUnset(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__DAY_COMPONENT);
	}
	...
	public boolean isSetDayComponent() {
		return eIsSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__DAY_COMPONENT);
	}
	...
	public EList<Long> getWeekdayComponent() {
		return (EList<Long>) eGet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__WEEKDAY_COMPONENT, true);
	}
	...
	public void unsetWeekdayComponent() {
		eUnset(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__WEEKDAY_COMPONENT);
	}
	...
	public boolean isSetWeekdayComponent() {
		return eIsSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__WEEKDAY_COMPONENT);
	}
	...
	public EList<Long> getMonthComponent() {
		return (EList<Long>) eGet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__MONTH_COMPONENT, true);
	}
	...
	public void unsetMonthComponent() {
		eUnset(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__MONTH_COMPONENT);
	}
	...
	public boolean isSetMonthComponent() {
		return eIsSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__MONTH_COMPONENT);
	}
	...
	public long getPosition() {
		return (Long) eGet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__POSITION, true);
	}
	...
	public void setPosition(long newPosition) {
		eSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__POSITION, newPosition);
	}
	...
	public void unsetPosition() {
		eUnset(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__POSITION);
	}
	...
	public boolean isSetPosition() {
		return eIsSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__POSITION);
	}
	...
	public long getInterval() {
		return (Long) eGet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__INTERVAL, true);
	}
	...
	public void setInterval(long newInterval) {
		eSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__INTERVAL, newInterval);
	}
	...
	public void unsetInterval() {
		eUnset(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__INTERVAL);
	}
	...
	public boolean isSetInterval() {
		return eIsSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__INTERVAL);
	}
	...
	public long getOccurrences() {
		return (Long) eGet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__OCCURRENCES, true);
	}
	...
	public void setOccurrences(long newOccurrences) {
		eSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__OCCURRENCES, newOccurrences);
	}
	...
	public void unsetOccurrences() {
		eUnset(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__OCCURRENCES);
	}
	...
	public boolean isSetOccurrences() {
		return eIsSet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__OCCURRENCES);
	}
	...
	public EList<IfcTimePeriod> getTimePeriods() {
		return (EList<IfcTimePeriod>) eGet(Ifc4x3Package.Literals.IFC_RECURRENCE_PATTERN__TIME_PERIODS, true);
	}
