...
public class IfcRelConnectsWithRealizingElementsImpl extends IfcRelConnectsElementsImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelConnectsWithRealizingElements();
	}
	...
	public EList<IfcElement> getRealizingElements() {
		return (EList<IfcElement>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcRelConnectsWithRealizingElements_RealizingElements(), true);
	}
	...
	public String getConnectionType() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsWithRealizingElements_ConnectionType(), true);
	}
	...
	public void setConnectionType(String newConnectionType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsWithRealizingElements_ConnectionType(), newConnectionType);
	}
	...
	public void unsetConnectionType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRelConnectsWithRealizingElements_ConnectionType());
	}
	...
	public boolean isSetConnectionType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsWithRealizingElements_ConnectionType());
	}
