...
public class IfcSimplePropertyTemplateImpl extends IfcPropertyTemplateImpl implements IfcSimplePropertyTemplate {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE;
	}
	...
	public IfcSimplePropertyTemplateTypeEnum getTemplateType() {
		return (IfcSimplePropertyTemplateTypeEnum) eGet(
				Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__TEMPLATE_TYPE, true);
	}
	...
	public void setTemplateType(IfcSimplePropertyTemplateTypeEnum newTemplateType) {
		eSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__TEMPLATE_TYPE, newTemplateType);
	}
	...
	public void unsetTemplateType() {
		eUnset(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__TEMPLATE_TYPE);
	}
	...
	public boolean isSetTemplateType() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__TEMPLATE_TYPE);
	}
	...
	public String getPrimaryMeasureType() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__PRIMARY_MEASURE_TYPE, true);
	}
	...
	public void setPrimaryMeasureType(String newPrimaryMeasureType) {
		eSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__PRIMARY_MEASURE_TYPE, newPrimaryMeasureType);
	}
	...
	public void unsetPrimaryMeasureType() {
		eUnset(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__PRIMARY_MEASURE_TYPE);
	}
	...
	public boolean isSetPrimaryMeasureType() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__PRIMARY_MEASURE_TYPE);
	}
	...
	public String getSecondaryMeasureType() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__SECONDARY_MEASURE_TYPE, true);
	}
	...
	public void setSecondaryMeasureType(String newSecondaryMeasureType) {
		eSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__SECONDARY_MEASURE_TYPE, newSecondaryMeasureType);
	}
	...
	public void unsetSecondaryMeasureType() {
		eUnset(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__SECONDARY_MEASURE_TYPE);
	}
	...
	public boolean isSetSecondaryMeasureType() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__SECONDARY_MEASURE_TYPE);
	}
	...
	public IfcPropertyEnumeration getEnumerators() {
		return (IfcPropertyEnumeration) eGet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__ENUMERATORS, true);
	}
	...
	public void setEnumerators(IfcPropertyEnumeration newEnumerators) {
		eSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__ENUMERATORS, newEnumerators);
	}
	...
	public void unsetEnumerators() {
		eUnset(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__ENUMERATORS);
	}
	...
	public boolean isSetEnumerators() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__ENUMERATORS);
	}
	...
	public IfcUnit getPrimaryUnit() {
		return (IfcUnit) eGet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__PRIMARY_UNIT, true);
	}
	...
	public void setPrimaryUnit(IfcUnit newPrimaryUnit) {
		eSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__PRIMARY_UNIT, newPrimaryUnit);
	}
	...
	public IfcUnit getSecondaryUnit() {
		return (IfcUnit) eGet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__SECONDARY_UNIT, true);
	}
	...
	public void setSecondaryUnit(IfcUnit newSecondaryUnit) {
		eSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__SECONDARY_UNIT, newSecondaryUnit);
	}
	...
	public void unsetSecondaryUnit() {
		eUnset(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__SECONDARY_UNIT);
	}
	...
	public boolean isSetSecondaryUnit() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__SECONDARY_UNIT);
	}
	...
	public String getExpression() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__EXPRESSION, true);
	}
	...
	public void setExpression(String newExpression) {
		eSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__EXPRESSION, newExpression);
	}
	...
	public boolean isSetExpression() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__EXPRESSION);
	}
	...
	public IfcStateEnum getAccessState() {
		return (IfcStateEnum) eGet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__ACCESS_STATE, true);
	}
	...
	public void setAccessState(IfcStateEnum newAccessState) {
		eSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__ACCESS_STATE, newAccessState);
	}
	...
	public void unsetAccessState() {
		eUnset(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__ACCESS_STATE);
	}
	...
	public boolean isSetAccessState() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SIMPLE_PROPERTY_TEMPLATE__ACCESS_STATE);
	}
