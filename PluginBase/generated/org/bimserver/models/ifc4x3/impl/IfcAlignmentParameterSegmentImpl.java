...
public class IfcAlignmentParameterSegmentImpl extends IdEObjectImpl implements IfcAlignmentParameterSegment {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment();
	}
	...
	public String getStartTag() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment_StartTag(), true);
	}
	...
	public void setStartTag(String newStartTag) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment_StartTag(), newStartTag);
	}
	...
	public void unsetStartTag() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment_StartTag());
	}
	...
	public boolean isSetStartTag() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment_StartTag());
	}
	...
	public String getEndTag() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment_EndTag(), true);
	}
	...
	public void setEndTag(String newEndTag) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment_EndTag(), newEndTag);
	}
	...
	public void unsetEndTag() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment_EndTag());
	}
	...
	public boolean isSetEndTag() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentParameterSegment_EndTag());
	}
