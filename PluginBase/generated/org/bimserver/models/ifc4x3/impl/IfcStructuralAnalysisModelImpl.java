...
public class IfcStructuralAnalysisModelImpl extends IfcSystemImpl implements IfcStructuralAnalysisModel {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL;
	}
	...
	public IfcAnalysisModelTypeEnum getPredefinedType() {
		return (IfcAnalysisModelTypeEnum) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__PREDEFINED_TYPE,
				true);
	}
	...
	public void setPredefinedType(IfcAnalysisModelTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__PREDEFINED_TYPE, newPredefinedType);
	}
	...
	public IfcAxis2Placement3D getOrientationOf2DPlane() {
		return (IfcAxis2Placement3D) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__ORIENTATION_OF2_DPLANE,
				true);
	}
	...
	public void setOrientationOf2DPlane(IfcAxis2Placement3D newOrientationOf2DPlane) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__ORIENTATION_OF2_DPLANE, newOrientationOf2DPlane);
	}
	...
	public void unsetOrientationOf2DPlane() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__ORIENTATION_OF2_DPLANE);
	}
	...
	public boolean isSetOrientationOf2DPlane() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__ORIENTATION_OF2_DPLANE);
	}
	...
	public EList<IfcStructuralLoadGroup> getLoadedBy() {
		return (EList<IfcStructuralLoadGroup>) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__LOADED_BY,
				true);
	}
	...
	public void unsetLoadedBy() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__LOADED_BY);
	}
	...
	public boolean isSetLoadedBy() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__LOADED_BY);
	}
	...
	public EList<IfcStructuralResultGroup> getHasResults() {
		return (EList<IfcStructuralResultGroup>) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__HAS_RESULTS,
				true);
	}
	...
	public void unsetHasResults() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__HAS_RESULTS);
	}
	...
	public boolean isSetHasResults() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__HAS_RESULTS);
	}
	...
	public IfcObjectPlacement getSharedPlacement() {
		return (IfcObjectPlacement) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__SHARED_PLACEMENT, true);
	}
	...
	public void setSharedPlacement(IfcObjectPlacement newSharedPlacement) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__SHARED_PLACEMENT, newSharedPlacement);
	}
	...
	public void unsetSharedPlacement() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__SHARED_PLACEMENT);
	}
	...
	public boolean isSetSharedPlacement() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_ANALYSIS_MODEL__SHARED_PLACEMENT);
	}
