...
public class IfcTextureCoordinateIndicesImpl extends IdEObjectImpl implements IfcTextureCoordinateIndices {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcTextureCoordinateIndices();
	}
	...
	public EList<Long> getTexCoordIndex() {
		return (EList<Long>) eGet(Ifc4x3Package.eINSTANCE.getIfcTextureCoordinateIndices_TexCoordIndex(), true);
	}
	...
	public IfcIndexedPolygonalFace getTexCoordsOf() {
		return (IfcIndexedPolygonalFace) eGet(Ifc4x3Package.eINSTANCE.getIfcTextureCoordinateIndices_TexCoordsOf(),
				true);
	}
	...
	public void setTexCoordsOf(IfcIndexedPolygonalFace newTexCoordsOf) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcTextureCoordinateIndices_TexCoordsOf(), newTexCoordsOf);
	}
	...
	public IfcIndexedPolygonalTextureMap getToTexMap() {
		return (IfcIndexedPolygonalTextureMap) eGet(Ifc4x3Package.eINSTANCE.getIfcTextureCoordinateIndices_ToTexMap(),
				true);
	}
	...
	public void setToTexMap(IfcIndexedPolygonalTextureMap newToTexMap) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcTextureCoordinateIndices_ToTexMap(), newToTexMap);
	}
	...
	public void unsetToTexMap() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcTextureCoordinateIndices_ToTexMap());
	}
	...
	public boolean isSetToTexMap() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcTextureCoordinateIndices_ToTexMap());
	}
