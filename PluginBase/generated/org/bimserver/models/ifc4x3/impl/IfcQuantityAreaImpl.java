...
public class IfcQuantityAreaImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityArea {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcQuantityArea();
	}
	...
	public double getAreaValue() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcQuantityArea_AreaValue(), true);
	}
	...
	public void setAreaValue(double newAreaValue) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcQuantityArea_AreaValue(), newAreaValue);
	}
	...
	public String getAreaValueAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcQuantityArea_AreaValueAsString(), true);
	}
	...
	public void setAreaValueAsString(String newAreaValueAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcQuantityArea_AreaValueAsString(), newAreaValueAsString);
	}
	...
	public String getFormula() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcQuantityArea_Formula(), true);
	}
	...
	public void setFormula(String newFormula) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcQuantityArea_Formula(), newFormula);
	}
	...
	public void unsetFormula() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcQuantityArea_Formula());
	}
	...
	public boolean isSetFormula() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcQuantityArea_Formula());
	}
