...
public class IfcCurveStyleFontAndScalingImpl extends IfcPresentationItemImpl implements IfcCurveStyleFontAndScaling {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling();
	}
	...
	public String getName() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_Name(), true);
	}
	...
	public void setName(String newName) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_Name(), newName);
	}
	...
	public void unsetName() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_Name());
	}
	...
	public boolean isSetName() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_Name());
	}
	...
	public IfcCurveStyleFontSelect getCurveStyleFont() {
		return (IfcCurveStyleFontSelect) eGet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_CurveStyleFont(),
				true);
	}
	...
	public void setCurveStyleFont(IfcCurveStyleFontSelect newCurveStyleFont) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_CurveStyleFont(), newCurveStyleFont);
	}
	...
	public double getCurveFontScaling() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_CurveFontScaling(), true);
	}
	...
	public void setCurveFontScaling(double newCurveFontScaling) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_CurveFontScaling(), newCurveFontScaling);
	}
	...
	public String getCurveFontScalingAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_CurveFontScalingAsString(), true);
	}
	...
	public void setCurveFontScalingAsString(String newCurveFontScalingAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCurveStyleFontAndScaling_CurveFontScalingAsString(),
