...
public class IfcRelAssociatesProfileDefImpl extends IfcRelAssociatesImpl implements IfcRelAssociatesProfileDef {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelAssociatesProfileDef();
	}
	...
	public IfcProfileDef getRelatingProfileDef() {
		return (IfcProfileDef) eGet(Ifc4x3Package.eINSTANCE.getIfcRelAssociatesProfileDef_RelatingProfileDef(), true);
	}
	...
	public void setRelatingProfileDef(IfcProfileDef newRelatingProfileDef) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelAssociatesProfileDef_RelatingProfileDef(), newRelatingProfileDef);
	}
