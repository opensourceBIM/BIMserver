...
public class IfcStructuralCurveMemberImpl extends IfcStructuralMemberImpl implements IfcStructuralCurveMember {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcStructuralCurveMember();
	}
	...
	public IfcStructuralCurveMemberTypeEnum getPredefinedType() {
		return (IfcStructuralCurveMemberTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcStructuralCurveMember_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcStructuralCurveMemberTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcStructuralCurveMember_PredefinedType(), newPredefinedType);
	}
	...
	public IfcDirection getAxis() {
		return (IfcDirection) eGet(Ifc4x3Package.eINSTANCE.getIfcStructuralCurveMember_Axis(), true);
	}
	...
	public void setAxis(IfcDirection newAxis) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcStructuralCurveMember_Axis(), newAxis);
	}
