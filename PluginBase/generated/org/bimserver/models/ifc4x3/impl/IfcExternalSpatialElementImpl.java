...
public class IfcExternalSpatialElementImpl extends IfcExternalSpatialStructureElementImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcExternalSpatialElement();
	}
	...
	public IfcExternalSpatialElementTypeEnum getPredefinedType() {
		return (IfcExternalSpatialElementTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcExternalSpatialElement_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcExternalSpatialElementTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcExternalSpatialElement_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcExternalSpatialElement_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcExternalSpatialElement_PredefinedType());
	}
	...
	public EList<IfcRelSpaceBoundary> getBoundedBy() {
		return (EList<IfcRelSpaceBoundary>) eGet(Ifc4x3Package.eINSTANCE.getIfcExternalSpatialElement_BoundedBy(),
				true);
	}
	...
	public void unsetBoundedBy() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcExternalSpatialElement_BoundedBy());
	}
	...
	public boolean isSetBoundedBy() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcExternalSpatialElement_BoundedBy());
	}
