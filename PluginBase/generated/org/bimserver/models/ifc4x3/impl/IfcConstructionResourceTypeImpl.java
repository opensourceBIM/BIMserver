...
public class IfcConstructionResourceTypeImpl extends IfcTypeResourceImpl implements IfcConstructionResourceType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcConstructionResourceType();
	}
	...
	public EList<IfcAppliedValue> getBaseCosts() {
		return (EList<IfcAppliedValue>) eGet(Ifc4x3Package.eINSTANCE.getIfcConstructionResourceType_BaseCosts(), true);
	}
	...
	public void unsetBaseCosts() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcConstructionResourceType_BaseCosts());
	}
	...
	public boolean isSetBaseCosts() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcConstructionResourceType_BaseCosts());
	}
	...
	public IfcPhysicalQuantity getBaseQuantity() {
		return (IfcPhysicalQuantity) eGet(Ifc4x3Package.eINSTANCE.getIfcConstructionResourceType_BaseQuantity(), true);
	}
	...
	public void setBaseQuantity(IfcPhysicalQuantity newBaseQuantity) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcConstructionResourceType_BaseQuantity(), newBaseQuantity);
	}
	...
	public void unsetBaseQuantity() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcConstructionResourceType_BaseQuantity());
	}
	...
	public boolean isSetBaseQuantity() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcConstructionResourceType_BaseQuantity());
	}
