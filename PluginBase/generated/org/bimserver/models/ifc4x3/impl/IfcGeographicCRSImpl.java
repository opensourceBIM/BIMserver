...
public class IfcGeographicCRSImpl extends IfcCoordinateReferenceSystemImpl implements IfcGeographicCRS {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcGeographicCRS();
	}
	...
	public String getPrimeMeridian() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_PrimeMeridian(), true);
	}
	...
	public void setPrimeMeridian(String newPrimeMeridian) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_PrimeMeridian(), newPrimeMeridian);
	}
	...
	public void unsetPrimeMeridian() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_PrimeMeridian());
	}
	...
	public boolean isSetPrimeMeridian() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_PrimeMeridian());
	}
	...
	public IfcNamedUnit getAngleUnit() {
		return (IfcNamedUnit) eGet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_AngleUnit(), true);
	}
	...
	public void setAngleUnit(IfcNamedUnit newAngleUnit) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_AngleUnit(), newAngleUnit);
	}
	...
	public void unsetAngleUnit() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_AngleUnit());
	}
	...
	public boolean isSetAngleUnit() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_AngleUnit());
	}
	...
	public IfcNamedUnit getHeightUnit() {
		return (IfcNamedUnit) eGet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_HeightUnit(), true);
	}
	...
	public void setHeightUnit(IfcNamedUnit newHeightUnit) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_HeightUnit(), newHeightUnit);
	}
	...
	public void unsetHeightUnit() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_HeightUnit());
	}
	...
	public boolean isSetHeightUnit() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcGeographicCRS_HeightUnit());
	}
