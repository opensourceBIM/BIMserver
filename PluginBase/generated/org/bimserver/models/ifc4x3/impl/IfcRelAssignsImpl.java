...
public class IfcRelAssignsImpl extends IfcRelationshipImpl implements IfcRelAssigns {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelAssigns();
	}
	...
	public EList<IfcObjectDefinition> getRelatedObjects() {
		return (EList<IfcObjectDefinition>) eGet(Ifc4x3Package.eINSTANCE.getIfcRelAssigns_RelatedObjects(), true);
	}
	...
	public Tristate getRelatedObjectsType() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcRelAssigns_RelatedObjectsType(), true);
	}
	...
	public void setRelatedObjectsType(Tristate newRelatedObjectsType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelAssigns_RelatedObjectsType(), newRelatedObjectsType);
	}
	...
	public void unsetRelatedObjectsType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRelAssigns_RelatedObjectsType());
	}
	...
	public boolean isSetRelatedObjectsType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRelAssigns_RelatedObjectsType());
	}
