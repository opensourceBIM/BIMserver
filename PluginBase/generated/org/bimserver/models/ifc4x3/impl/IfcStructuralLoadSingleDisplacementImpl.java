...
public class IfcStructuralLoadSingleDisplacementImpl extends IfcStructuralLoadStaticImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT;
	}
	...
	public double getDisplacementX() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_X, true);
	}
	...
	public void setDisplacementX(double newDisplacementX) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_X, newDisplacementX);
	}
	...
	public void unsetDisplacementX() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_X);
	}
	...
	public boolean isSetDisplacementX() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_X);
	}
	...
	public String getDisplacementXAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_XAS_STRING,
				true);
	}
	...
	public void setDisplacementXAsString(String newDisplacementXAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_XAS_STRING,
	...
	public void unsetDisplacementXAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_XAS_STRING);
	}
	...
	public boolean isSetDisplacementXAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_XAS_STRING);
	}
	...
	public double getDisplacementY() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Y, true);
	}
	...
	public void setDisplacementY(double newDisplacementY) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Y, newDisplacementY);
	}
	...
	public void unsetDisplacementY() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Y);
	}
	...
	public boolean isSetDisplacementY() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Y);
	}
	...
	public String getDisplacementYAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_YAS_STRING,
				true);
	}
	...
	public void setDisplacementYAsString(String newDisplacementYAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_YAS_STRING,
	...
	public void unsetDisplacementYAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_YAS_STRING);
	}
	...
	public boolean isSetDisplacementYAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_YAS_STRING);
	}
	...
	public double getDisplacementZ() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Z, true);
	}
	...
	public void setDisplacementZ(double newDisplacementZ) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Z, newDisplacementZ);
	}
	...
	public void unsetDisplacementZ() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Z);
	}
	...
	public boolean isSetDisplacementZ() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Z);
	}
	...
	public String getDisplacementZAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_ZAS_STRING,
				true);
	}
	...
	public void setDisplacementZAsString(String newDisplacementZAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_ZAS_STRING,
	...
	public void unsetDisplacementZAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_ZAS_STRING);
	}
	...
	public boolean isSetDisplacementZAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_ZAS_STRING);
	}
	...
	public double getRotationalDisplacementRX() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RX,
				true);
	}
	...
	public void setRotationalDisplacementRX(double newRotationalDisplacementRX) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RX,
	...
	public void unsetRotationalDisplacementRX() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RX);
	}
	...
	public String getRotationalDisplacementRXAsString() {
		return (String) eGet(
				Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RX_AS_STRING,
				true);
	}
	...
	public void setRotationalDisplacementRXAsString(String newRotationalDisplacementRXAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RX_AS_STRING,
	...
	public double getRotationalDisplacementRY() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RY,
				true);
	}
	...
	public void unsetRotationalDisplacementRY() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RY);
	}
	...
	public String getRotationalDisplacementRYAsString() {
		return (String) eGet(
				Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RY_AS_STRING,
				true);
	}
	...
	public void setRotationalDisplacementRYAsString(String newRotationalDisplacementRYAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RY_AS_STRING,
	...
	public void unsetRotationalDisplacementRYAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RY_AS_STRING);
	}
	...
	public double getRotationalDisplacementRZ() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RZ,
				true);
	}
	...
	public void setRotationalDisplacementRZ(double newRotationalDisplacementRZ) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RZ,
	...
	public void unsetRotationalDisplacementRZ() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RZ);
	}
	...
	public boolean isSetRotationalDisplacementRZ() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RZ);
	}
	...
	public String getRotationalDisplacementRZAsString() {
		return (String) eGet(
				Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RZ_AS_STRING,
				true);
	}
	...
	public void setRotationalDisplacementRZAsString(String newRotationalDisplacementRZAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RZ_AS_STRING,
	...
	public void unsetRotationalDisplacementRZAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RZ_AS_STRING);
	}
