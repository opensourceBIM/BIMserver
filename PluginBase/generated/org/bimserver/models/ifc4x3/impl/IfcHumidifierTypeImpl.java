...
public class IfcHumidifierTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcHumidifierType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcHumidifierType();
	}
	...
	public IfcHumidifierTypeEnum getPredefinedType() {
		return (IfcHumidifierTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcHumidifierType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcHumidifierTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcHumidifierType_PredefinedType(), newPredefinedType);
	}
