...
public class IfcNamedUnitImpl extends IdEObjectImpl implements IfcNamedUnit {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcNamedUnit();
	}
	...
	public IfcDimensionalExponents getDimensions() {
		return (IfcDimensionalExponents) eGet(Ifc4x3Package.eINSTANCE.getIfcNamedUnit_Dimensions(), true);
	}
	...
	public void setDimensions(IfcDimensionalExponents newDimensions) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcNamedUnit_Dimensions(), newDimensions);
	}
	...
	public IfcUnitEnum getUnitType() {
		return (IfcUnitEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcNamedUnit_UnitType(), true);
	}
	...
	public void setUnitType(IfcUnitEnum newUnitType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcNamedUnit_UnitType(), newUnitType);
	}
