...
public class IfcPropertyReferenceValueImpl extends IfcSimplePropertyImpl implements IfcPropertyReferenceValue {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue();
	}
	...
	public String getUsageName() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue_UsageName(), true);
	}
	...
	public void setUsageName(String newUsageName) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue_UsageName(), newUsageName);
	}
	...
	public void unsetUsageName() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue_UsageName());
	}
	...
	public boolean isSetUsageName() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue_UsageName());
	}
	...
	public IfcObjectReferenceSelect getPropertyReference() {
		return (IfcObjectReferenceSelect) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue_PropertyReference(),
				true);
	}
	...
	public void setPropertyReference(IfcObjectReferenceSelect newPropertyReference) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue_PropertyReference(), newPropertyReference);
	}
	...
	public void unsetPropertyReference() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue_PropertyReference());
	}
	...
	public boolean isSetPropertyReference() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertyReferenceValue_PropertyReference());
	}
