...
public class IfcSegmentedReferenceCurveImpl extends IfcCompositeCurveImpl implements IfcSegmentedReferenceCurve {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSegmentedReferenceCurve();
	}
	...
	public IfcBoundedCurve getBaseCurve() {
		return (IfcBoundedCurve) eGet(Ifc4x3Package.eINSTANCE.getIfcSegmentedReferenceCurve_BaseCurve(), true);
	}
	...
	public void setBaseCurve(IfcBoundedCurve newBaseCurve) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSegmentedReferenceCurve_BaseCurve(), newBaseCurve);
	}
	...
	public IfcPlacement getEndPoint() {
		return (IfcPlacement) eGet(Ifc4x3Package.eINSTANCE.getIfcSegmentedReferenceCurve_EndPoint(), true);
	}
	...
	public void setEndPoint(IfcPlacement newEndPoint) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSegmentedReferenceCurve_EndPoint(), newEndPoint);
	}
	...
	public void unsetEndPoint() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSegmentedReferenceCurve_EndPoint());
	}
	...
	public boolean isSetEndPoint() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSegmentedReferenceCurve_EndPoint());
	}
