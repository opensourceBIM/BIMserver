...
public class IfcSurfaceCurveSweptAreaSolidImpl extends IfcDirectrixCurveSweptAreaSolidImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSurfaceCurveSweptAreaSolid();
	}
	...
	public IfcSurface getReferenceSurface() {
		return (IfcSurface) eGet(Ifc4x3Package.eINSTANCE.getIfcSurfaceCurveSweptAreaSolid_ReferenceSurface(), true);
	}
	...
	public void setReferenceSurface(IfcSurface newReferenceSurface) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceCurveSweptAreaSolid_ReferenceSurface(), newReferenceSurface);
	}
