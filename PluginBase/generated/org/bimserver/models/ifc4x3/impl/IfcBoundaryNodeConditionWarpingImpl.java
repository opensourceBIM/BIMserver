...
public class IfcBoundaryNodeConditionWarpingImpl extends IfcBoundaryNodeConditionImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcBoundaryNodeConditionWarping();
	}
	...
	public IfcWarpingStiffnessSelect getWarpingStiffness() {
		return (IfcWarpingStiffnessSelect) eGet(
				Ifc4x3Package.eINSTANCE.getIfcBoundaryNodeConditionWarping_WarpingStiffness(), true);
	}
	...
	public void setWarpingStiffness(IfcWarpingStiffnessSelect newWarpingStiffness) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBoundaryNodeConditionWarping_WarpingStiffness(), newWarpingStiffness);
	}
	...
	public void unsetWarpingStiffness() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcBoundaryNodeConditionWarping_WarpingStiffness());
	}
	...
	public boolean isSetWarpingStiffness() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcBoundaryNodeConditionWarping_WarpingStiffness());
	}
