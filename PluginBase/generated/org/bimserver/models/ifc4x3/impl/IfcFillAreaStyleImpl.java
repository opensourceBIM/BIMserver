...
public class IfcFillAreaStyleImpl extends IfcPresentationStyleImpl implements IfcFillAreaStyle {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcFillAreaStyle();
	}
	...
	public EList<IfcFillStyleSelect> getFillStyles() {
		return (EList<IfcFillStyleSelect>) eGet(Ifc4x3Package.eINSTANCE.getIfcFillAreaStyle_FillStyles(), true);
	}
	...
	public Tristate getModelOrDraughting() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcFillAreaStyle_ModelOrDraughting(), true);
	}
	...
	public void setModelOrDraughting(Tristate newModelOrDraughting) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcFillAreaStyle_ModelOrDraughting(), newModelOrDraughting);
	}
	...
	public void unsetModelOrDraughting() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcFillAreaStyle_ModelOrDraughting());
	}
	...
	public boolean isSetModelOrDraughting() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcFillAreaStyle_ModelOrDraughting());
	}
