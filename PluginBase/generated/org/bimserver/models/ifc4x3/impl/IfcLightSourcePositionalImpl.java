...
public class IfcLightSourcePositionalImpl extends IfcLightSourceImpl implements IfcLightSourcePositional {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL;
	}
	...
	public IfcCartesianPoint getPosition() {
		return (IfcCartesianPoint) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__POSITION, true);
	}
	...
	public void setPosition(IfcCartesianPoint newPosition) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__POSITION, newPosition);
	}
	...
	public double getRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__RADIUS, true);
	}
	...
	public void setRadius(double newRadius) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__RADIUS, newRadius);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__RADIUS_AS_STRING, true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__RADIUS_AS_STRING, newRadiusAsString);
	}
	...
	public double getConstantAttenuation() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__CONSTANT_ATTENUATION, true);
	}
	...
	public void setConstantAttenuation(double newConstantAttenuation) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__CONSTANT_ATTENUATION, newConstantAttenuation);
	}
	...
	public String getConstantAttenuationAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__CONSTANT_ATTENUATION_AS_STRING, true);
	}
	...
	public void setConstantAttenuationAsString(String newConstantAttenuationAsString) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__CONSTANT_ATTENUATION_AS_STRING,
	...
	public double getDistanceAttenuation() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__DISTANCE_ATTENUATION, true);
	}
	...
	public void setDistanceAttenuation(double newDistanceAttenuation) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__DISTANCE_ATTENUATION, newDistanceAttenuation);
	}
	...
	public String getDistanceAttenuationAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__DISTANCE_ATTENUATION_AS_STRING, true);
	}
	...
	public void setDistanceAttenuationAsString(String newDistanceAttenuationAsString) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__DISTANCE_ATTENUATION_AS_STRING,
	...
	public double getQuadricAttenuation() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__QUADRIC_ATTENUATION, true);
	}
	...
	public void setQuadricAttenuation(double newQuadricAttenuation) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__QUADRIC_ATTENUATION, newQuadricAttenuation);
	}
	...
	public String getQuadricAttenuationAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__QUADRIC_ATTENUATION_AS_STRING, true);
	}
	...
	public void setQuadricAttenuationAsString(String newQuadricAttenuationAsString) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_POSITIONAL__QUADRIC_ATTENUATION_AS_STRING,
