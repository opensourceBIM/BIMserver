...
public class IfcAlignmentHorizontalSegmentImpl extends IfcAlignmentParameterSegmentImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment();
	}
	...
	public IfcCartesianPoint getStartPoint() {
		return (IfcCartesianPoint) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartPoint(), true);
	}
	...
	public void setStartPoint(IfcCartesianPoint newStartPoint) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartPoint(), newStartPoint);
	}
	...
	public double getStartDirection() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartDirection(), true);
	}
	...
	public void setStartDirection(double newStartDirection) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartDirection(), newStartDirection);
	}
	...
	public String getStartDirectionAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartDirectionAsString(), true);
	}
	...
	public void setStartDirectionAsString(String newStartDirectionAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartDirectionAsString(),
	...
	public double getStartRadiusOfCurvature() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartRadiusOfCurvature(), true);
	}
	...
	public void setStartRadiusOfCurvature(double newStartRadiusOfCurvature) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartRadiusOfCurvature(),
	...
	public String getStartRadiusOfCurvatureAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartRadiusOfCurvatureAsString(),
				true);
	}
	...
	public void setStartRadiusOfCurvatureAsString(String newStartRadiusOfCurvatureAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_StartRadiusOfCurvatureAsString(),
	...
	public double getEndRadiusOfCurvature() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_EndRadiusOfCurvature(), true);
	}
	...
	public void setEndRadiusOfCurvature(double newEndRadiusOfCurvature) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_EndRadiusOfCurvature(), newEndRadiusOfCurvature);
	}
	...
	public String getEndRadiusOfCurvatureAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_EndRadiusOfCurvatureAsString(),
				true);
	}
	...
	public void setEndRadiusOfCurvatureAsString(String newEndRadiusOfCurvatureAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_EndRadiusOfCurvatureAsString(),
	...
	public double getSegmentLength() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_SegmentLength(), true);
	}
	...
	public void setSegmentLength(double newSegmentLength) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_SegmentLength(), newSegmentLength);
	}
	...
	public String getSegmentLengthAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_SegmentLengthAsString(), true);
	}
	...
	public void setSegmentLengthAsString(String newSegmentLengthAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_SegmentLengthAsString(),
	...
	public double getGravityCenterLineHeight() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_GravityCenterLineHeight(), true);
	}
	...
	public void setGravityCenterLineHeight(double newGravityCenterLineHeight) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_GravityCenterLineHeight(),
	...
	public void unsetGravityCenterLineHeight() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_GravityCenterLineHeight());
	}
	...
	public boolean isSetGravityCenterLineHeight() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_GravityCenterLineHeight());
	}
	...
	public String getGravityCenterLineHeightAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_GravityCenterLineHeightAsString(),
				true);
	}
	...
	public void setGravityCenterLineHeightAsString(String newGravityCenterLineHeightAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_GravityCenterLineHeightAsString(),
	...
	public void unsetGravityCenterLineHeightAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_GravityCenterLineHeightAsString());
	}
	...
	public boolean isSetGravityCenterLineHeightAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_GravityCenterLineHeightAsString());
	}
	...
	public IfcAlignmentHorizontalSegmentTypeEnum getPredefinedType() {
		return (IfcAlignmentHorizontalSegmentTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcAlignmentHorizontalSegmentTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentHorizontalSegment_PredefinedType(), newPredefinedType);
	}
