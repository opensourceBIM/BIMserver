 ...
 * </p>
 * <ul>
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcRelDefinesByTemplateImpl#getRelatedPropertySets <em>Related Property Sets</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcRelDefinesByTemplateImpl#getRelatingTemplate <em>Relating Template</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfcRelDefinesByTemplateImpl extends IfcRelDefinesImpl implements IfcRelDefinesByTemplate {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_REL_DEFINES_BY_TEMPLATE;
	}
	...
	public EList<IfcPropertySetDefinition> getRelatedPropertySets() {
		return (EList<IfcPropertySetDefinition>) eGet(
				Ifc4x3Package.Literals.IFC_REL_DEFINES_BY_TEMPLATE__RELATED_PROPERTY_SETS, true);
	}
	...
	public IfcPropertySetTemplate getRelatingTemplate() {
		return (IfcPropertySetTemplate) eGet(Ifc4x3Package.Literals.IFC_REL_DEFINES_BY_TEMPLATE__RELATING_TEMPLATE,
				true);
	}
	...
	public void setRelatingTemplate(IfcPropertySetTemplate newRelatingTemplate) {
		eSet(Ifc4x3Package.Literals.IFC_REL_DEFINES_BY_TEMPLATE__RELATING_TEMPLATE, newRelatingTemplate);
	}
