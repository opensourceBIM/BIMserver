...
public class IfcRelDefinesByTemplateImpl extends IfcRelDefinesImpl implements IfcRelDefinesByTemplate {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelDefinesByTemplate();
	}
	...
	public EList<IfcPropertySetDefinition> getRelatedPropertySets() {
		return (EList<IfcPropertySetDefinition>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcRelDefinesByTemplate_RelatedPropertySets(), true);
	}
	...
	public IfcPropertySetTemplate getRelatingTemplate() {
		return (IfcPropertySetTemplate) eGet(Ifc4x3Package.eINSTANCE.getIfcRelDefinesByTemplate_RelatingTemplate(),
				true);
	}
	...
	public void setRelatingTemplate(IfcPropertySetTemplate newRelatingTemplate) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelDefinesByTemplate_RelatingTemplate(), newRelatingTemplate);
	}
