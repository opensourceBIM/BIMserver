...
public class IfcBoundaryConditionImpl extends IdEObjectImpl implements IfcBoundaryCondition {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcBoundaryCondition();
	}
	...
	public String getName() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcBoundaryCondition_Name(), true);
	}
	...
	public void setName(String newName) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBoundaryCondition_Name(), newName);
	}
	...
	public void unsetName() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcBoundaryCondition_Name());
	}
	...
	public boolean isSetName() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcBoundaryCondition_Name());
	}
