...
public class IfcResourceImpl extends IfcObjectImpl implements IfcResource {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcResource();
	}
	...
	public String getIdentification() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcResource_Identification(), true);
	}
	...
	public void setIdentification(String newIdentification) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcResource_Identification(), newIdentification);
	}
	...
	public void unsetIdentification() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcResource_Identification());
	}
	...
	public boolean isSetIdentification() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcResource_Identification());
	}
	...
	public String getLongDescription() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcResource_LongDescription(), true);
	}
	...
	public void setLongDescription(String newLongDescription) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcResource_LongDescription(), newLongDescription);
	}
	...
	public void unsetLongDescription() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcResource_LongDescription());
	}
	...
	public boolean isSetLongDescription() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcResource_LongDescription());
	}
	...
	public EList<IfcRelAssignsToResource> getResourceOf() {
		return (EList<IfcRelAssignsToResource>) eGet(Ifc4x3Package.eINSTANCE.getIfcResource_ResourceOf(), true);
	}
	...
	public void unsetResourceOf() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcResource_ResourceOf());
	}
	...
	public boolean isSetResourceOf() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcResource_ResourceOf());
	}
