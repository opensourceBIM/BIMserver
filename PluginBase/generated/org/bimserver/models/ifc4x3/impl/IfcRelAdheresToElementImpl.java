...
public class IfcRelAdheresToElementImpl extends IfcRelDecomposesImpl implements IfcRelAdheresToElement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelAdheresToElement();
	}
	...
	public IfcElement getRelatingElement() {
		return (IfcElement) eGet(Ifc4x3Package.eINSTANCE.getIfcRelAdheresToElement_RelatingElement(), true);
	}
	...
	public void setRelatingElement(IfcElement newRelatingElement) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelAdheresToElement_RelatingElement(), newRelatingElement);
	}
	...
	public EList<IfcSurfaceFeature> getRelatedSurfaceFeatures() {
		return (EList<IfcSurfaceFeature>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcRelAdheresToElement_RelatedSurfaceFeatures(), true);
	}
