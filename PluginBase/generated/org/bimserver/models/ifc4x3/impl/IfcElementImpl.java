...
public class IfcElementImpl extends IfcProductImpl implements IfcElement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_ELEMENT;
	}
	...
	public String getTag() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__TAG, true);
	}
	...
	public void setTag(String newTag) {
		eSet(Ifc4x3Package.Literals.IFC_ELEMENT__TAG, newTag);
	}
	...
	public void unsetTag() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__TAG);
	}
	...
	public boolean isSetTag() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__TAG);
	}
	...
	public EList<IfcRelFillsElement> getFillsVoids() {
		return (EList<IfcRelFillsElement>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__FILLS_VOIDS, true);
	}
	...
	public void unsetFillsVoids() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__FILLS_VOIDS);
	}
	...
	public boolean isSetFillsVoids() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__FILLS_VOIDS);
	}
	...
	public EList<IfcRelConnectsElements> getConnectedTo() {
		return (EList<IfcRelConnectsElements>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__CONNECTED_TO, true);
	}
	...
	public void unsetConnectedTo() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__CONNECTED_TO);
	}
	...
	public boolean isSetConnectedTo() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__CONNECTED_TO);
	}
	...
	public EList<IfcRelInterferesElements> getIsInterferedByElements() {
		return (EList<IfcRelInterferesElements>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__IS_INTERFERED_BY_ELEMENTS,
				true);
	}
	...
	public void unsetIsInterferedByElements() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__IS_INTERFERED_BY_ELEMENTS);
	}
	...
	public boolean isSetIsInterferedByElements() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__IS_INTERFERED_BY_ELEMENTS);
	}
	...
	public EList<IfcRelInterferesElements> getInterferesElements() {
		return (EList<IfcRelInterferesElements>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__INTERFERES_ELEMENTS, true);
	}
	...
	public void unsetInterferesElements() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__INTERFERES_ELEMENTS);
	}
	...
	public boolean isSetInterferesElements() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__INTERFERES_ELEMENTS);
	}
	...
	public EList<IfcRelProjectsElement> getHasProjections() {
		return (EList<IfcRelProjectsElement>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_PROJECTIONS, true);
	}
	...
	public boolean isSetHasProjections() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_PROJECTIONS);
	}
	...
	public EList<IfcRelVoidsElement> getHasOpenings() {
		return (EList<IfcRelVoidsElement>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_OPENINGS, true);
	}
	...
	public void unsetHasOpenings() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_OPENINGS);
	}
	...
	public boolean isSetHasOpenings() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_OPENINGS);
	}
	...
	public EList<IfcRelConnectsWithRealizingElements> getIsConnectionRealization() {
		return (EList<IfcRelConnectsWithRealizingElements>) eGet(
				Ifc4x3Package.Literals.IFC_ELEMENT__IS_CONNECTION_REALIZATION, true);
	}
	...
	public void unsetIsConnectionRealization() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__IS_CONNECTION_REALIZATION);
	}
	...
	public boolean isSetIsConnectionRealization() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__IS_CONNECTION_REALIZATION);
	}
	...
	public EList<IfcRelSpaceBoundary> getProvidesBoundaries() {
		return (EList<IfcRelSpaceBoundary>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__PROVIDES_BOUNDARIES, true);
	}
	...
	public void unsetProvidesBoundaries() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__PROVIDES_BOUNDARIES);
	}
	...
	public boolean isSetProvidesBoundaries() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__PROVIDES_BOUNDARIES);
	}
	...
	public EList<IfcRelConnectsElements> getConnectedFrom() {
		return (EList<IfcRelConnectsElements>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__CONNECTED_FROM, true);
	}
	...
	public void unsetConnectedFrom() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__CONNECTED_FROM);
	}
	...
	public boolean isSetConnectedFrom() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__CONNECTED_FROM);
	}
	...
	public EList<IfcRelContainedInSpatialStructure> getContainedInStructure() {
		return (EList<IfcRelContainedInSpatialStructure>) eGet(
				Ifc4x3Package.Literals.IFC_ELEMENT__CONTAINED_IN_STRUCTURE, true);
	}
	...
	public void unsetContainedInStructure() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__CONTAINED_IN_STRUCTURE);
	}
	...
	public boolean isSetContainedInStructure() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__CONTAINED_IN_STRUCTURE);
	}
	...
	public EList<IfcRelCoversBldgElements> getHasCoverings() {
		return (EList<IfcRelCoversBldgElements>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_COVERINGS, true);
	}
	...
	public void unsetHasCoverings() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_COVERINGS);
	}
	...
	public boolean isSetHasCoverings() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_COVERINGS);
	}
	...
	public EList<IfcRelAdheresToElement> getHasSurfaceFeatures() {
		return (EList<IfcRelAdheresToElement>) eGet(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_SURFACE_FEATURES, true);
	}
	...
	public void unsetHasSurfaceFeatures() {
		eUnset(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_SURFACE_FEATURES);
	}
	...
	public boolean isSetHasSurfaceFeatures() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ELEMENT__HAS_SURFACE_FEATURES);
	}
