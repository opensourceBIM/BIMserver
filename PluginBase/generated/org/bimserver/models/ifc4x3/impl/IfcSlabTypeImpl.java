...
public class IfcSlabTypeImpl extends IfcBuiltElementTypeImpl implements IfcSlabType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSlabType();
	}
	...
	public IfcSlabTypeEnum getPredefinedType() {
		return (IfcSlabTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcSlabType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcSlabTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSlabType_PredefinedType(), newPredefinedType);
	}
