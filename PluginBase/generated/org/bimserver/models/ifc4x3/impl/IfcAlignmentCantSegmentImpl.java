...
public class IfcAlignmentCantSegmentImpl extends IfcAlignmentParameterSegmentImpl implements IfcAlignmentCantSegment {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment();
	}
	...
	public double getStartDistAlong() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartDistAlong(), true);
	}
	...
	public void setStartDistAlong(double newStartDistAlong) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartDistAlong(), newStartDistAlong);
	}
	...
	public String getStartDistAlongAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartDistAlongAsString(), true);
	}
	...
	public void setStartDistAlongAsString(String newStartDistAlongAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartDistAlongAsString(), newStartDistAlongAsString);
	}
	...
	public double getHorizontalLength() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_HorizontalLength(), true);
	}
	...
	public void setHorizontalLength(double newHorizontalLength) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_HorizontalLength(), newHorizontalLength);
	}
	...
	public String getHorizontalLengthAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_HorizontalLengthAsString(), true);
	}
	...
	public void setHorizontalLengthAsString(String newHorizontalLengthAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_HorizontalLengthAsString(),
	...
	public double getStartCantLeft() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartCantLeft(), true);
	}
	...
	public void setStartCantLeft(double newStartCantLeft) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartCantLeft(), newStartCantLeft);
	}
	...
	public String getStartCantLeftAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartCantLeftAsString(), true);
	}
	...
	public void setStartCantLeftAsString(String newStartCantLeftAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartCantLeftAsString(), newStartCantLeftAsString);
	}
	...
	public double getEndCantLeft() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantLeft(), true);
	}
	...
	public void setEndCantLeft(double newEndCantLeft) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantLeft(), newEndCantLeft);
	}
	...
	public void unsetEndCantLeft() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantLeft());
	}
	...
	public boolean isSetEndCantLeft() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantLeft());
	}
	...
	public String getEndCantLeftAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantLeftAsString(), true);
	}
	...
	public void setEndCantLeftAsString(String newEndCantLeftAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantLeftAsString(), newEndCantLeftAsString);
	}
	...
	public void unsetEndCantLeftAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantLeftAsString());
	}
	...
	public boolean isSetEndCantLeftAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantLeftAsString());
	}
	...
	public double getStartCantRight() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartCantRight(), true);
	}
	...
	public void setStartCantRight(double newStartCantRight) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartCantRight(), newStartCantRight);
	}
	...
	public String getStartCantRightAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartCantRightAsString(), true);
	}
	...
	public void setStartCantRightAsString(String newStartCantRightAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_StartCantRightAsString(), newStartCantRightAsString);
	}
	...
	public double getEndCantRight() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantRight(), true);
	}
	...
	public void setEndCantRight(double newEndCantRight) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantRight(), newEndCantRight);
	}
	...
	public void unsetEndCantRight() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantRight());
	}
	...
	public boolean isSetEndCantRight() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantRight());
	}
	...
	public String getEndCantRightAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantRightAsString(), true);
	}
	...
	public void setEndCantRightAsString(String newEndCantRightAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantRightAsString(), newEndCantRightAsString);
	}
	...
	public void unsetEndCantRightAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantRightAsString());
	}
	...
	public boolean isSetEndCantRightAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_EndCantRightAsString());
	}
	...
	public IfcAlignmentCantSegmentTypeEnum getPredefinedType() {
		return (IfcAlignmentCantSegmentTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcAlignmentCantSegmentTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCantSegment_PredefinedType(), newPredefinedType);
	}
