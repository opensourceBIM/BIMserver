...
public class IfcCompositeCurveImpl extends IfcBoundedCurveImpl implements IfcCompositeCurve {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCompositeCurve();
	}
	...
	public EList<IfcSegment> getSegments() {
		return (EList<IfcSegment>) eGet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_Segments(), true);
	}
	...
	public Tristate getSelfIntersect() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_SelfIntersect(), true);
	}
	...
	public void setSelfIntersect(Tristate newSelfIntersect) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_SelfIntersect(), newSelfIntersect);
	}
	...
	public Tristate getClosedCurve() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_ClosedCurve(), true);
	}
	...
	public void setClosedCurve(Tristate newClosedCurve) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_ClosedCurve(), newClosedCurve);
	}
	...
	public void unsetClosedCurve() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_ClosedCurve());
	}
	...
	public boolean isSetClosedCurve() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_ClosedCurve());
	}
	...
	public long getNSegments() {
		return (Long) eGet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_NSegments(), true);
	}
	...
	public void setNSegments(long newNSegments) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_NSegments(), newNSegments);
	}
	...
	public void unsetNSegments() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_NSegments());
	}
	...
	public boolean isSetNSegments() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCompositeCurve_NSegments());
	}
