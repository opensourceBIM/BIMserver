...
public class IfcPropertySingleValueImpl extends IfcSimplePropertyImpl implements IfcPropertySingleValue {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue();
	}
	...
	public IfcValue getNominalValue() {
		return (IfcValue) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue_NominalValue(), true);
	}
	...
	public void setNominalValue(IfcValue newNominalValue) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue_NominalValue(), newNominalValue);
	}
	...
	public void unsetNominalValue() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue_NominalValue());
	}
	...
	public boolean isSetNominalValue() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue_NominalValue());
	}
	...
	public IfcUnit getUnit() {
		return (IfcUnit) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue_Unit(), true);
	}
	...
	public void setUnit(IfcUnit newUnit) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue_Unit(), newUnit);
	}
	...
	public void unsetUnit() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue_Unit());
	}
	...
	public boolean isSetUnit() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertySingleValue_Unit());
	}
