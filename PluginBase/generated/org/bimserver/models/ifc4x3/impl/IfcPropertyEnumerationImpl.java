...
public class IfcPropertyEnumerationImpl extends IfcPropertyAbstractionImpl implements IfcPropertyEnumeration {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPropertyEnumeration();
	}
	...
	public String getName() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertyEnumeration_Name(), true);
	}
	...
	public void setName(String newName) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPropertyEnumeration_Name(), newName);
	}
	...
	public EList<IfcValue> getEnumerationValues() {
		return (EList<IfcValue>) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertyEnumeration_EnumerationValues(), true);
	}
	...
	public IfcUnit getUnit() {
		return (IfcUnit) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertyEnumeration_Unit(), true);
	}
	...
	public void setUnit(IfcUnit newUnit) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPropertyEnumeration_Unit(), newUnit);
	}
	...
	public void unsetUnit() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertyEnumeration_Unit());
	}
	...
	public boolean isSetUnit() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertyEnumeration_Unit());
	}
