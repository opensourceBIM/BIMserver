...
public class IfcCartesianPointImpl extends IfcPointImpl implements IfcCartesianPoint {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCartesianPoint();
	}
	...
	public EList<Double> getCoordinates() {
		return (EList<Double>) eGet(Ifc4x3Package.eINSTANCE.getIfcCartesianPoint_Coordinates(), true);
	}
	...
	public EList<String> getCoordinatesAsString() {
		return (EList<String>) eGet(Ifc4x3Package.eINSTANCE.getIfcCartesianPoint_CoordinatesAsString(), true);
	}
