...
public class IfcCoilImpl extends IfcEnergyConversionDeviceImpl implements IfcCoil {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCoil();
	}
	...
	public IfcCoilTypeEnum getPredefinedType() {
		return (IfcCoilTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcCoil_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcCoilTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCoil_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCoil_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCoil_PredefinedType());
	}
