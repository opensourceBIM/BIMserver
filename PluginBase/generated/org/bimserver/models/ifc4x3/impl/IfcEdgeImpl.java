...
public class IfcEdgeImpl extends IfcTopologicalRepresentationItemImpl implements IfcEdge {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcEdge();
	}
	...
	public IfcVertex getEdgeStart() {
		return (IfcVertex) eGet(Ifc4x3Package.eINSTANCE.getIfcEdge_EdgeStart(), true);
	}
	...
	public void setEdgeStart(IfcVertex newEdgeStart) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcEdge_EdgeStart(), newEdgeStart);
	}
	...
	public IfcVertex getEdgeEnd() {
		return (IfcVertex) eGet(Ifc4x3Package.eINSTANCE.getIfcEdge_EdgeEnd(), true);
	}
	...
	public void setEdgeEnd(IfcVertex newEdgeEnd) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcEdge_EdgeEnd(), newEdgeEnd);
	}
