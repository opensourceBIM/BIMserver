...
public class IfcMetricImpl extends IfcConstraintImpl implements IfcMetric {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_METRIC;
	}
	...
	public IfcBenchmarkEnum getBenchmark() {
		return (IfcBenchmarkEnum) eGet(Ifc4x3Package.Literals.IFC_METRIC__BENCHMARK, true);
	}
	...
	public void setBenchmark(IfcBenchmarkEnum newBenchmark) {
		eSet(Ifc4x3Package.Literals.IFC_METRIC__BENCHMARK, newBenchmark);
	}
	...
	public String getValueSource() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_METRIC__VALUE_SOURCE, true);
	}
	...
	public void setValueSource(String newValueSource) {
		eSet(Ifc4x3Package.Literals.IFC_METRIC__VALUE_SOURCE, newValueSource);
	}
	...
	public void unsetValueSource() {
		eUnset(Ifc4x3Package.Literals.IFC_METRIC__VALUE_SOURCE);
	}
	...
	public boolean isSetValueSource() {
		return eIsSet(Ifc4x3Package.Literals.IFC_METRIC__VALUE_SOURCE);
	}
	...
	public IfcMetricValueSelect getDataValue() {
		return (IfcMetricValueSelect) eGet(Ifc4x3Package.Literals.IFC_METRIC__DATA_VALUE, true);
	}
	...
	public void setDataValue(IfcMetricValueSelect newDataValue) {
		eSet(Ifc4x3Package.Literals.IFC_METRIC__DATA_VALUE, newDataValue);
	}
	...
	public void unsetDataValue() {
		eUnset(Ifc4x3Package.Literals.IFC_METRIC__DATA_VALUE);
	}
	...
	public boolean isSetDataValue() {
		return eIsSet(Ifc4x3Package.Literals.IFC_METRIC__DATA_VALUE);
	}
	...
	public IfcReference getReferencePath() {
		return (IfcReference) eGet(Ifc4x3Package.Literals.IFC_METRIC__REFERENCE_PATH, true);
	}
	...
	public void setReferencePath(IfcReference newReferencePath) {
		eSet(Ifc4x3Package.Literals.IFC_METRIC__REFERENCE_PATH, newReferencePath);
	}
	...
	public void unsetReferencePath() {
		eUnset(Ifc4x3Package.Literals.IFC_METRIC__REFERENCE_PATH);
	}
	...
	public boolean isSetReferencePath() {
		return eIsSet(Ifc4x3Package.Literals.IFC_METRIC__REFERENCE_PATH);
	}
