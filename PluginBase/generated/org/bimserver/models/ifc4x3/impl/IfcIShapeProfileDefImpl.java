...
public class IfcIShapeProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcIShapeProfileDef {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF;
	}
	...
	public double getOverallWidth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_WIDTH, true);
	}
	...
	public void setOverallWidth(double newOverallWidth) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_WIDTH, newOverallWidth);
	}
	...
	public String getOverallWidthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_WIDTH_AS_STRING, true);
	}
	...
	public void setOverallWidthAsString(String newOverallWidthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_WIDTH_AS_STRING, newOverallWidthAsString);
	}
	...
	public double getOverallDepth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_DEPTH, true);
	}
	...
	public void setOverallDepth(double newOverallDepth) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_DEPTH, newOverallDepth);
	}
	...
	public String getOverallDepthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_DEPTH_AS_STRING, true);
	}
	...
	public void setOverallDepthAsString(String newOverallDepthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__OVERALL_DEPTH_AS_STRING, newOverallDepthAsString);
	}
	...
	public double getWebThickness() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__WEB_THICKNESS, true);
	}
	...
	public void setWebThickness(double newWebThickness) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__WEB_THICKNESS, newWebThickness);
	}
	...
	public String getWebThicknessAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, true);
	}
	...
	public void setWebThicknessAsString(String newWebThicknessAsString) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING, newWebThicknessAsString);
	}
	...
	public double getFlangeThickness() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_THICKNESS, true);
	}
	...
	public void setFlangeThickness(double newFlangeThickness) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_THICKNESS, newFlangeThickness);
	}
	...
	public String getFlangeThicknessAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING, true);
	}
	...
	public void setFlangeThicknessAsString(String newFlangeThicknessAsString) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING, newFlangeThicknessAsString);
	}
	...
	public double getFilletRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS, true);
	}
	...
	public void setFilletRadius(double newFilletRadius) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS, newFilletRadius);
	}
	...
	public void unsetFilletRadius() {
		eUnset(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS);
	}
	...
	public boolean isSetFilletRadius() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS);
	}
	...
	public String getFilletRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING, true);
	}
	...
	public void setFilletRadiusAsString(String newFilletRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING, newFilletRadiusAsString);
	}
	...
	public void unsetFilletRadiusAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING);
	}
	...
	public boolean isSetFilletRadiusAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING);
	}
	...
	public double getFlangeEdgeRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS, true);
	}
	...
	public void setFlangeEdgeRadius(double newFlangeEdgeRadius) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS, newFlangeEdgeRadius);
	}
	...
	public void unsetFlangeEdgeRadius() {
		eUnset(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS);
	}
	...
	public boolean isSetFlangeEdgeRadius() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS);
	}
	...
	public String getFlangeEdgeRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS_AS_STRING, true);
	}
	...
	public void setFlangeEdgeRadiusAsString(String newFlangeEdgeRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS_AS_STRING, newFlangeEdgeRadiusAsString);
	}
	...
	public boolean isSetFlangeEdgeRadiusAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS_AS_STRING);
	}
	...
	public double getFlangeSlope() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_SLOPE, true);
	}
	...
	public void setFlangeSlope(double newFlangeSlope) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_SLOPE, newFlangeSlope);
	}
	...
	public void unsetFlangeSlope() {
		eUnset(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_SLOPE);
	}
	...
	public boolean isSetFlangeSlope() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_SLOPE);
	}
	...
	public String getFlangeSlopeAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING, true);
	}
	...
	public void setFlangeSlopeAsString(String newFlangeSlopeAsString) {
		eSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING, newFlangeSlopeAsString);
	}
	...
	public void unsetFlangeSlopeAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING);
	}
	...
	public boolean isSetFlangeSlopeAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ISHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING);
	}
