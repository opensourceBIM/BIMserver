...
public class IfcDirectrixCurveSweptAreaSolidImpl extends IfcSweptAreaSolidImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid();
	}
	...
	public IfcCurve getDirectrix() {
		return (IfcCurve) eGet(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_Directrix(), true);
	}
	...
	public void setDirectrix(IfcCurve newDirectrix) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_Directrix(), newDirectrix);
	}
	...
	public IfcCurveMeasureSelect getStartParam() {
		return (IfcCurveMeasureSelect) eGet(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_StartParam(),
				true);
	}
	...
	public void setStartParam(IfcCurveMeasureSelect newStartParam) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_StartParam(), newStartParam);
	}
	...
	public void unsetStartParam() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_StartParam());
	}
	...
	public boolean isSetStartParam() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_StartParam());
	}
	...
	public IfcCurveMeasureSelect getEndParam() {
		return (IfcCurveMeasureSelect) eGet(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_EndParam(),
				true);
	}
	...
	public void setEndParam(IfcCurveMeasureSelect newEndParam) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_EndParam(), newEndParam);
	}
	...
	public void unsetEndParam() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_EndParam());
	}
	...
	public boolean isSetEndParam() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcDirectrixCurveSweptAreaSolid_EndParam());
	}
