...
public class IfcAlignmentCantImpl extends IfcLinearElementImpl implements IfcAlignmentCant {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcAlignmentCant();
	}
	...
	public double getRailHeadDistance() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCant_RailHeadDistance(), true);
	}
	...
	public void setRailHeadDistance(double newRailHeadDistance) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCant_RailHeadDistance(), newRailHeadDistance);
	}
	...
	public String getRailHeadDistanceAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCant_RailHeadDistanceAsString(), true);
	}
	...
	public void setRailHeadDistanceAsString(String newRailHeadDistanceAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAlignmentCant_RailHeadDistanceAsString(), newRailHeadDistanceAsString);
	}
