...
public class IfcSurfaceStyleShadingImpl extends IfcPresentationItemImpl implements IfcSurfaceStyleShading {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading();
	}
	...
	public IfcColourRgb getSurfaceColour() {
		return (IfcColourRgb) eGet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_SurfaceColour(), true);
	}
	...
	public void setSurfaceColour(IfcColourRgb newSurfaceColour) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_SurfaceColour(), newSurfaceColour);
	}
	...
	public double getTransparency() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_Transparency(), true);
	}
	...
	public void setTransparency(double newTransparency) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_Transparency(), newTransparency);
	}
	...
	public void unsetTransparency() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_Transparency());
	}
	...
	public boolean isSetTransparency() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_Transparency());
	}
	...
	public String getTransparencyAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_TransparencyAsString(), true);
	}
	...
	public void setTransparencyAsString(String newTransparencyAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_TransparencyAsString(), newTransparencyAsString);
	}
	...
	public void unsetTransparencyAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_TransparencyAsString());
	}
	...
	public boolean isSetTransparencyAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleShading_TransparencyAsString());
	}
