...
public class IfcIndexedPolyCurveImpl extends IfcBoundedCurveImpl implements IfcIndexedPolyCurve {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve();
	}
	...
	public IfcCartesianPointList getPoints() {
		return (IfcCartesianPointList) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_Points(), true);
	}
	...
	public void setPoints(IfcCartesianPointList newPoints) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_Points(), newPoints);
	}
	...
	public EList<IfcSegmentIndexSelect> getSegments() {
		return (EList<IfcSegmentIndexSelect>) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_Segments(), true);
	}
	...
	public void unsetSegments() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_Segments());
	}
	...
	public boolean isSetSegments() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_Segments());
	}
	...
	public Tristate getSelfIntersect() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_SelfIntersect(), true);
	}
	...
	public void setSelfIntersect(Tristate newSelfIntersect) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_SelfIntersect(), newSelfIntersect);
	}
	...
	public void unsetSelfIntersect() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_SelfIntersect());
	}
	...
	public boolean isSetSelfIntersect() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcIndexedPolyCurve_SelfIntersect());
	}
