...
public class IfcPointOnCurveImpl extends IfcPointImpl implements IfcPointOnCurve {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPointOnCurve();
	}
	...
	public IfcCurve getBasisCurve() {
		return (IfcCurve) eGet(Ifc4x3Package.eINSTANCE.getIfcPointOnCurve_BasisCurve(), true);
	}
	...
	public void setBasisCurve(IfcCurve newBasisCurve) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPointOnCurve_BasisCurve(), newBasisCurve);
	}
	...
	public double getPointParameter() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcPointOnCurve_PointParameter(), true);
	}
	...
	public void setPointParameter(double newPointParameter) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPointOnCurve_PointParameter(), newPointParameter);
	}
	...
	public String getPointParameterAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcPointOnCurve_PointParameterAsString(), true);
	}
	...
	public void setPointParameterAsString(String newPointParameterAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPointOnCurve_PointParameterAsString(), newPointParameterAsString);
	}
