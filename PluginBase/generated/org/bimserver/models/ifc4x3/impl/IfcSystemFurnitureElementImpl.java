...
public class IfcSystemFurnitureElementImpl extends IfcFurnishingElementImpl implements IfcSystemFurnitureElement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSystemFurnitureElement();
	}
	...
	public IfcSystemFurnitureElementTypeEnum getPredefinedType() {
		return (IfcSystemFurnitureElementTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcSystemFurnitureElement_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcSystemFurnitureElementTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSystemFurnitureElement_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSystemFurnitureElement_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSystemFurnitureElement_PredefinedType());
	}
