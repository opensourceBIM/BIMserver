...
public class IfcBuildingStoreyImpl extends IfcSpatialStructureElementImpl implements IfcBuildingStorey {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcBuildingStorey();
	}
	...
	public double getElevation() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcBuildingStorey_Elevation(), true);
	}
	...
	public void setElevation(double newElevation) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBuildingStorey_Elevation(), newElevation);
	}
	...
	public void unsetElevation() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcBuildingStorey_Elevation());
	}
	...
	public boolean isSetElevation() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcBuildingStorey_Elevation());
	}
	...
	public String getElevationAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcBuildingStorey_ElevationAsString(), true);
	}
	...
	public void setElevationAsString(String newElevationAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBuildingStorey_ElevationAsString(), newElevationAsString);
	}
	...
	public void unsetElevationAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcBuildingStorey_ElevationAsString());
	}
	...
	public boolean isSetElevationAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcBuildingStorey_ElevationAsString());
	}
