...
public class IfcCShapeProfileDefImpl extends IfcParameterizedProfileDefImpl implements IfcCShapeProfileDef {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF;
	}
	...
	public double getDepth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__DEPTH, true);
	}
	...
	public void setDepth(double newDepth) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__DEPTH, newDepth);
	}
	...
	public String getDepthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__DEPTH_AS_STRING, true);
	}
	...
	public void setDepthAsString(String newDepthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__DEPTH_AS_STRING, newDepthAsString);
	}
	...
	public double getWidth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__WIDTH, true);
	}
	...
	public void setWidth(double newWidth) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__WIDTH, newWidth);
	}
	...
	public String getWidthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__WIDTH_AS_STRING, true);
	}
	...
	public void setWidthAsString(String newWidthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__WIDTH_AS_STRING, newWidthAsString);
	}
	...
	public double getWallThickness() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__WALL_THICKNESS, true);
	}
	...
	public void setWallThickness(double newWallThickness) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__WALL_THICKNESS, newWallThickness);
	}
	...
	public String getWallThicknessAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__WALL_THICKNESS_AS_STRING, true);
	}
	...
	public void setWallThicknessAsString(String newWallThicknessAsString) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__WALL_THICKNESS_AS_STRING, newWallThicknessAsString);
	}
	...
	public double getGirth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__GIRTH, true);
	}
	...
	public void setGirth(double newGirth) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__GIRTH, newGirth);
	}
	...
	public String getGirthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__GIRTH_AS_STRING, true);
	}
	...
	public void setGirthAsString(String newGirthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__GIRTH_AS_STRING, newGirthAsString);
	}
	...
	public double getInternalFilletRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS, true);
	}
	...
	public void setInternalFilletRadius(double newInternalFilletRadius) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS, newInternalFilletRadius);
	}
	...
	public void unsetInternalFilletRadius() {
		eUnset(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS);
	}
	...
	public boolean isSetInternalFilletRadius() {
		return eIsSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS);
	}
	...
	public String getInternalFilletRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS_AS_STRING, true);
	}
	...
	public void setInternalFilletRadiusAsString(String newInternalFilletRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS_AS_STRING,
	...
	public void unsetInternalFilletRadiusAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS_AS_STRING);
	}
	...
	public boolean isSetInternalFilletRadiusAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_CSHAPE_PROFILE_DEF__INTERNAL_FILLET_RADIUS_AS_STRING);
	}
