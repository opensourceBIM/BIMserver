...
public class IfcLightSourceGoniometricImpl extends IfcLightSourceImpl implements IfcLightSourceGoniometric {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC;
	}
	...
	public IfcAxis2Placement3D getPosition() {
		return (IfcAxis2Placement3D) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__POSITION, true);
	}
	...
	public void setPosition(IfcAxis2Placement3D newPosition) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__POSITION, newPosition);
	}
	...
	public IfcColourRgb getColourAppearance() {
		return (IfcColourRgb) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE, true);
	}
	...
	public void setColourAppearance(IfcColourRgb newColourAppearance) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE, newColourAppearance);
	}
	...
	public void unsetColourAppearance() {
		eUnset(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE);
	}
	...
	public double getColourTemperature() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE, true);
	}
	...
	public void setColourTemperature(double newColourTemperature) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE, newColourTemperature);
	}
	...
	public String getColourTemperatureAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE_AS_STRING, true);
	}
	...
	public double getLuminousFlux() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX, true);
	}
	...
	public void setLuminousFlux(double newLuminousFlux) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX, newLuminousFlux);
	}
	...
	public String getLuminousFluxAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX_AS_STRING, true);
	}
	...
	public void setLuminousFluxAsString(String newLuminousFluxAsString) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX_AS_STRING, newLuminousFluxAsString);
	}
	...
	public IfcLightEmissionSourceEnum getLightEmissionSource() {
		return (IfcLightEmissionSourceEnum) eGet(
				Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_EMISSION_SOURCE, true);
	}
	...
	public void setLightEmissionSource(IfcLightEmissionSourceEnum newLightEmissionSource) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_EMISSION_SOURCE, newLightEmissionSource);
	}
	...
	public IfcLightDistributionDataSourceSelect getLightDistributionDataSource() {
		return (IfcLightDistributionDataSourceSelect) eGet(
				Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_DISTRIBUTION_DATA_SOURCE, true);
	}
	...
	public void setLightDistributionDataSource(IfcLightDistributionDataSourceSelect newLightDistributionDataSource) {
		eSet(Ifc4x3Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_DISTRIBUTION_DATA_SOURCE,
