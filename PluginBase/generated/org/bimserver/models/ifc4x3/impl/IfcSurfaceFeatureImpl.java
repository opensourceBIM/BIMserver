...
public class IfcSurfaceFeatureImpl extends IfcFeatureElementImpl implements IfcSurfaceFeature {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature();
	}
	...
	public IfcSurfaceFeatureTypeEnum getPredefinedType() {
		return (IfcSurfaceFeatureTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcSurfaceFeatureTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature_PredefinedType());
	}
	...
	public IfcRelAdheresToElement getAdheresToElement() {
		return (IfcRelAdheresToElement) eGet(Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature_AdheresToElement(), true);
	}
	...
	public void setAdheresToElement(IfcRelAdheresToElement newAdheresToElement) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature_AdheresToElement(), newAdheresToElement);
	}
	...
	public void unsetAdheresToElement() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature_AdheresToElement());
	}
	...
	public boolean isSetAdheresToElement() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSurfaceFeature_AdheresToElement());
	}
