...
public class IfcMooringDeviceImpl extends IfcBuiltElementImpl implements IfcMooringDevice {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcMooringDevice();
	}
	...
	public IfcMooringDeviceTypeEnum getPredefinedType() {
		return (IfcMooringDeviceTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcMooringDevice_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcMooringDeviceTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMooringDevice_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcMooringDevice_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcMooringDevice_PredefinedType());
	}
