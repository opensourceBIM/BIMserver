...
public class IfcGradientCurveImpl extends IfcCompositeCurveImpl implements IfcGradientCurve {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcGradientCurve();
	}
	...
	public IfcBoundedCurve getBaseCurve() {
		return (IfcBoundedCurve) eGet(Ifc4x3Package.eINSTANCE.getIfcGradientCurve_BaseCurve(), true);
	}
	...
	public void setBaseCurve(IfcBoundedCurve newBaseCurve) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcGradientCurve_BaseCurve(), newBaseCurve);
	}
	...
	public IfcPlacement getEndPoint() {
		return (IfcPlacement) eGet(Ifc4x3Package.eINSTANCE.getIfcGradientCurve_EndPoint(), true);
	}
	...
	public void setEndPoint(IfcPlacement newEndPoint) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcGradientCurve_EndPoint(), newEndPoint);
	}
	...
	public void unsetEndPoint() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcGradientCurve_EndPoint());
	}
	...
	public boolean isSetEndPoint() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcGradientCurve_EndPoint());
	}
