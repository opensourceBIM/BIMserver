...
public class IfcOpenCrossProfileDefImpl extends IfcProfileDefImpl implements IfcOpenCrossProfileDef {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef();
	}
	...
	public Tristate getHorizontalWidths() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_HorizontalWidths(), true);
	}
	...
	public void setHorizontalWidths(Tristate newHorizontalWidths) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_HorizontalWidths(), newHorizontalWidths);
	}
	...
	public EList<Double> getWidths() {
		return (EList<Double>) eGet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_Widths(), true);
	}
	...
	public EList<String> getWidthsAsString() {
		return (EList<String>) eGet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_WidthsAsString(), true);
	}
	...
	public EList<Double> getSlopes() {
		return (EList<Double>) eGet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_Slopes(), true);
	}
	...
	public EList<String> getSlopesAsString() {
		return (EList<String>) eGet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_SlopesAsString(), true);
	}
	...
	public EList<String> getTags() {
		return (EList<String>) eGet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_Tags(), true);
	}
	...
	public void unsetTags() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_Tags());
	}
	...
	public boolean isSetTags() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_Tags());
	}
	...
	public IfcCartesianPoint getOffsetPoint() {
		return (IfcCartesianPoint) eGet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_OffsetPoint(), true);
	}
	...
	public void setOffsetPoint(IfcCartesianPoint newOffsetPoint) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_OffsetPoint(), newOffsetPoint);
	}
	...
	public void unsetOffsetPoint() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_OffsetPoint());
	}
	...
	public boolean isSetOffsetPoint() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcOpenCrossProfileDef_OffsetPoint());
	}
