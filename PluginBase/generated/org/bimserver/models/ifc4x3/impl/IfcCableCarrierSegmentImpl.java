...
public class IfcCableCarrierSegmentImpl extends IfcFlowSegmentImpl implements IfcCableCarrierSegment {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCableCarrierSegment();
	}
	...
	public IfcCableCarrierSegmentTypeEnum getPredefinedType() {
		return (IfcCableCarrierSegmentTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcCableCarrierSegment_PredefinedType(),
				true);
	}
	...
	public void setPredefinedType(IfcCableCarrierSegmentTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCableCarrierSegment_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCableCarrierSegment_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCableCarrierSegment_PredefinedType());
	}
