...
public class IfcStructuralLoadPlanarForceImpl extends IfcStructuralLoadStaticImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE;
	}
	...
	public double getPlanarForceX() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_X, true);
	}
	...
	public void setPlanarForceX(double newPlanarForceX) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_X, newPlanarForceX);
	}
	...
	public void unsetPlanarForceX() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_X);
	}
	...
	public String getPlanarForceXAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_XAS_STRING, true);
	}
	...
	public void setPlanarForceXAsString(String newPlanarForceXAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_XAS_STRING, newPlanarForceXAsString);
	}
	...
	public void unsetPlanarForceXAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_XAS_STRING);
	}
	...
	public boolean isSetPlanarForceXAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_XAS_STRING);
	}
	...
	public double getPlanarForceY() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Y, true);
	}
	...
	public void setPlanarForceY(double newPlanarForceY) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Y, newPlanarForceY);
	}
	...
	public boolean isSetPlanarForceY() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Y);
	}
	...
	public String getPlanarForceYAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_YAS_STRING, true);
	}
	...
	public void setPlanarForceYAsString(String newPlanarForceYAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_YAS_STRING, newPlanarForceYAsString);
	}
	...
	public void unsetPlanarForceYAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_YAS_STRING);
	}
	...
	public boolean isSetPlanarForceYAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_YAS_STRING);
	}
	...
	public double getPlanarForceZ() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Z, true);
	}
	...
	public void setPlanarForceZ(double newPlanarForceZ) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Z, newPlanarForceZ);
	}
	...
	public void unsetPlanarForceZ() {
		eUnset(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Z);
	}
	...
	public boolean isSetPlanarForceZ() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Z);
	}
	...
	public String getPlanarForceZAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_ZAS_STRING, true);
	}
	...
	public void setPlanarForceZAsString(String newPlanarForceZAsString) {
		eSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_ZAS_STRING, newPlanarForceZAsString);
	}
	...
	public boolean isSetPlanarForceZAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_ZAS_STRING);
	}
