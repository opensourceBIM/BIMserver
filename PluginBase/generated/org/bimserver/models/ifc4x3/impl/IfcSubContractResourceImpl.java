...
public class IfcSubContractResourceImpl extends IfcConstructionResourceImpl implements IfcSubContractResource {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSubContractResource();
	}
	...
	public IfcSubContractResourceTypeEnum getPredefinedType() {
		return (IfcSubContractResourceTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcSubContractResource_PredefinedType(),
				true);
	}
	...
	public void setPredefinedType(IfcSubContractResourceTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSubContractResource_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSubContractResource_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSubContractResource_PredefinedType());
	}
