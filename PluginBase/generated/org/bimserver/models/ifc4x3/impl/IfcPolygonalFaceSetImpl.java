...
public class IfcPolygonalFaceSetImpl extends IfcTessellatedFaceSetImpl implements IfcPolygonalFaceSet {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet();
	}
	...
	public Tristate getClosed() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet_Closed(), true);
	}
	...
	public void setClosed(Tristate newClosed) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet_Closed(), newClosed);
	}
	...
	public void unsetClosed() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet_Closed());
	}
	...
	public boolean isSetClosed() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet_Closed());
	}
	...
	public EList<IfcIndexedPolygonalFace> getFaces() {
		return (EList<IfcIndexedPolygonalFace>) eGet(Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet_Faces(), true);
	}
	...
	public EList<Long> getPnIndex() {
		return (EList<Long>) eGet(Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet_PnIndex(), true);
	}
	...
	public void unsetPnIndex() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet_PnIndex());
	}
	...
	public boolean isSetPnIndex() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPolygonalFaceSet_PnIndex());
	}
