...
public class IfcGridPlacementImpl extends IfcObjectPlacementImpl implements IfcGridPlacement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcGridPlacement();
	}
	...
	public IfcVirtualGridIntersection getPlacementLocation() {
		return (IfcVirtualGridIntersection) eGet(Ifc4x3Package.eINSTANCE.getIfcGridPlacement_PlacementLocation(), true);
	}
	...
	public void setPlacementLocation(IfcVirtualGridIntersection newPlacementLocation) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcGridPlacement_PlacementLocation(), newPlacementLocation);
	}
	...
	public IfcGridPlacementDirectionSelect getPlacementRefDirection() {
		return (IfcGridPlacementDirectionSelect) eGet(
				Ifc4x3Package.eINSTANCE.getIfcGridPlacement_PlacementRefDirection(), true);
	}
	...
	public void setPlacementRefDirection(IfcGridPlacementDirectionSelect newPlacementRefDirection) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcGridPlacement_PlacementRefDirection(), newPlacementRefDirection);
	}
	...
	public void unsetPlacementRefDirection() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcGridPlacement_PlacementRefDirection());
	}
	...
	public boolean isSetPlacementRefDirection() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcGridPlacement_PlacementRefDirection());
	}
