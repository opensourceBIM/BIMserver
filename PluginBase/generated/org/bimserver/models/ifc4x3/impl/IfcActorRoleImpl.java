...
public class IfcActorRoleImpl extends IdEObjectImpl implements IfcActorRole {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_ACTOR_ROLE;
	}
	...
	public IfcRoleEnum getRole() {
		return (IfcRoleEnum) eGet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__ROLE, true);
	}
	...
	public void setRole(IfcRoleEnum newRole) {
		eSet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__ROLE, newRole);
	}
	...
	public String getUserDefinedRole() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__USER_DEFINED_ROLE, true);
	}
	...
	public void setUserDefinedRole(String newUserDefinedRole) {
		eSet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__USER_DEFINED_ROLE, newUserDefinedRole);
	}
	...
	public void unsetUserDefinedRole() {
		eUnset(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__USER_DEFINED_ROLE);
	}
	...
	public boolean isSetUserDefinedRole() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__USER_DEFINED_ROLE);
	}
	...
	public String getDescription() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__DESCRIPTION, true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__DESCRIPTION, newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__DESCRIPTION);
	}
	...
	public boolean isSetDescription() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__DESCRIPTION);
	}
	...
	public EList<IfcExternalReferenceRelationship> getHasExternalReference() {
		return (EList<IfcExternalReferenceRelationship>) eGet(
				Ifc4x3Package.Literals.IFC_ACTOR_ROLE__HAS_EXTERNAL_REFERENCE, true);
	}
	...
	public void unsetHasExternalReference() {
		eUnset(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__HAS_EXTERNAL_REFERENCE);
	}
	...
	public boolean isSetHasExternalReference() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ACTOR_ROLE__HAS_EXTERNAL_REFERENCE);
	}
