...
public class IfcSectionReinforcementPropertiesImpl extends IfcPreDefinedPropertiesImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES;
	}
	...
	public double getLongitudinalStartPosition() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_START_POSITION,
				true);
	}
	...
	public void setLongitudinalStartPosition(double newLongitudinalStartPosition) {
		eSet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_START_POSITION,
	...
	public String getLongitudinalStartPositionAsString() {
		return (String) eGet(
				Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_START_POSITION_AS_STRING,
				true);
	}
	...
	public double getLongitudinalEndPosition() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_END_POSITION,
				true);
	}
	...
	public void setLongitudinalEndPosition(double newLongitudinalEndPosition) {
		eSet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_END_POSITION,
	...
	public String getLongitudinalEndPositionAsString() {
		return (String) eGet(
				Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_END_POSITION_AS_STRING, true);
	}
	...
	public double getTransversePosition() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION, true);
	}
	...
	public void setTransversePosition(double newTransversePosition) {
		eSet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION, newTransversePosition);
	}
	...
	public void unsetTransversePosition() {
		eUnset(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION);
	}
	...
	public boolean isSetTransversePosition() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION);
	}
	...
	public String getTransversePositionAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION_AS_STRING,
				true);
	}
	...
	public void setTransversePositionAsString(String newTransversePositionAsString) {
		eSet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION_AS_STRING,
	...
	public void unsetTransversePositionAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION_AS_STRING);
	}
	...
	public boolean isSetTransversePositionAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION_AS_STRING);
	}
	...
	public IfcReinforcingBarRoleEnum getReinforcementRole() {
		return (IfcReinforcingBarRoleEnum) eGet(
				Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__REINFORCEMENT_ROLE, true);
	}
	...
	public void setReinforcementRole(IfcReinforcingBarRoleEnum newReinforcementRole) {
		eSet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__REINFORCEMENT_ROLE, newReinforcementRole);
	}
	...
	public IfcSectionProperties getSectionDefinition() {
		return (IfcSectionProperties) eGet(
				Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__SECTION_DEFINITION, true);
	}
	...
	public void setSectionDefinition(IfcSectionProperties newSectionDefinition) {
		eSet(Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__SECTION_DEFINITION, newSectionDefinition);
	}
	...
	public EList<IfcReinforcementBarProperties> getCrossSectionReinforcementDefinitions() {
		return (EList<IfcReinforcementBarProperties>) eGet(
				Ifc4x3Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__CROSS_SECTION_REINFORCEMENT_DEFINITIONS,
				true);
	}
