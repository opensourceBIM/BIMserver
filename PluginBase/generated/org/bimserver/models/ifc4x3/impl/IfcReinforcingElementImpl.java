...
public class IfcReinforcingElementImpl extends IfcElementComponentImpl implements IfcReinforcingElement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcReinforcingElement();
	}
	...
	public String getSteelGrade() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcReinforcingElement_SteelGrade(), true);
	}
	...
	public void setSteelGrade(String newSteelGrade) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcReinforcingElement_SteelGrade(), newSteelGrade);
	}
	...
	public void unsetSteelGrade() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcReinforcingElement_SteelGrade());
	}
	...
	public boolean isSetSteelGrade() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcReinforcingElement_SteelGrade());
	}
