...
public class IfcApprovalRelationshipImpl extends IfcResourceLevelRelationshipImpl implements IfcApprovalRelationship {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcApprovalRelationship();
	}
	...
	public IfcApproval getRelatingApproval() {
		return (IfcApproval) eGet(Ifc4x3Package.eINSTANCE.getIfcApprovalRelationship_RelatingApproval(), true);
	}
	...
	public void setRelatingApproval(IfcApproval newRelatingApproval) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcApprovalRelationship_RelatingApproval(), newRelatingApproval);
	}
	...
	public EList<IfcApproval> getRelatedApprovals() {
		return (EList<IfcApproval>) eGet(Ifc4x3Package.eINSTANCE.getIfcApprovalRelationship_RelatedApprovals(), true);
	}
