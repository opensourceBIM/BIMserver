...
public class IfcVibrationIsolatorTypeImpl extends IfcElementComponentTypeImpl implements IfcVibrationIsolatorType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcVibrationIsolatorType();
	}
	...
	public IfcVibrationIsolatorTypeEnum getPredefinedType() {
		return (IfcVibrationIsolatorTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcVibrationIsolatorType_PredefinedType(),
				true);
	}
	...
	public void setPredefinedType(IfcVibrationIsolatorTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcVibrationIsolatorType_PredefinedType(), newPredefinedType);
	}
