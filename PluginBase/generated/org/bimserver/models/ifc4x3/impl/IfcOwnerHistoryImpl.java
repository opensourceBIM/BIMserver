...
public class IfcOwnerHistoryImpl extends IdEObjectImpl implements IfcOwnerHistory {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_OWNER_HISTORY;
	}
	...
	public IfcPersonAndOrganization getOwningUser() {
		return (IfcPersonAndOrganization) eGet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__OWNING_USER, true);
	}
	...
	public void setOwningUser(IfcPersonAndOrganization newOwningUser) {
		eSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__OWNING_USER, newOwningUser);
	}
	...
	public IfcApplication getOwningApplication() {
		return (IfcApplication) eGet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__OWNING_APPLICATION, true);
	}
	...
	public void setOwningApplication(IfcApplication newOwningApplication) {
		eSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__OWNING_APPLICATION, newOwningApplication);
	}
	...
	public IfcStateEnum getState() {
		return (IfcStateEnum) eGet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__STATE, true);
	}
	...
	public void setState(IfcStateEnum newState) {
		eSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__STATE, newState);
	}
	...
	public void unsetState() {
		eUnset(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__STATE);
	}
	...
	public boolean isSetState() {
		return eIsSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__STATE);
	}
	...
	public IfcChangeActionEnum getChangeAction() {
		return (IfcChangeActionEnum) eGet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__CHANGE_ACTION, true);
	}
	...
	public void setChangeAction(IfcChangeActionEnum newChangeAction) {
		eSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__CHANGE_ACTION, newChangeAction);
	}
	...
	public void unsetChangeAction() {
		eUnset(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__CHANGE_ACTION);
	}
	...
	public boolean isSetChangeAction() {
		return eIsSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__CHANGE_ACTION);
	}
	...
	public long getLastModifiedDate() {
		return (Long) eGet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFIED_DATE, true);
	}
	...
	public void setLastModifiedDate(long newLastModifiedDate) {
		eSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFIED_DATE, newLastModifiedDate);
	}
	...
	public void unsetLastModifiedDate() {
		eUnset(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFIED_DATE);
	}
	...
	public boolean isSetLastModifiedDate() {
		return eIsSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFIED_DATE);
	}
	...
	public IfcPersonAndOrganization getLastModifyingUser() {
		return (IfcPersonAndOrganization) eGet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFYING_USER, true);
	}
	...
	public void setLastModifyingUser(IfcPersonAndOrganization newLastModifyingUser) {
		eSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFYING_USER, newLastModifyingUser);
	}
	...
	public void unsetLastModifyingUser() {
		eUnset(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFYING_USER);
	}
	...
	public IfcApplication getLastModifyingApplication() {
		return (IfcApplication) eGet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFYING_APPLICATION, true);
	}
	...
	public void setLastModifyingApplication(IfcApplication newLastModifyingApplication) {
		eSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFYING_APPLICATION, newLastModifyingApplication);
	}
	...
	public void unsetLastModifyingApplication() {
		eUnset(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFYING_APPLICATION);
	}
	...
	public boolean isSetLastModifyingApplication() {
		return eIsSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__LAST_MODIFYING_APPLICATION);
	}
	...
	public long getCreationDate() {
		return (Long) eGet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__CREATION_DATE, true);
	}
	...
	public void setCreationDate(long newCreationDate) {
		eSet(Ifc4x3Package.Literals.IFC_OWNER_HISTORY__CREATION_DATE, newCreationDate);
	}
