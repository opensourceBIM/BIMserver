...
public class IfcQuantityVolumeImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityVolume {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcQuantityVolume();
	}
	...
	public double getVolumeValue() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcQuantityVolume_VolumeValue(), true);
	}
	...
	public void setVolumeValue(double newVolumeValue) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcQuantityVolume_VolumeValue(), newVolumeValue);
	}
	...
	public String getVolumeValueAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcQuantityVolume_VolumeValueAsString(), true);
	}
	...
	public void setVolumeValueAsString(String newVolumeValueAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcQuantityVolume_VolumeValueAsString(), newVolumeValueAsString);
	}
	...
	public String getFormula() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcQuantityVolume_Formula(), true);
	}
	...
	public void setFormula(String newFormula) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcQuantityVolume_Formula(), newFormula);
	}
	...
	public void unsetFormula() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcQuantityVolume_Formula());
	}
	...
	public boolean isSetFormula() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcQuantityVolume_Formula());
	}
