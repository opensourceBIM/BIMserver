...
public class IfcStructuralLoadSingleDisplacementDistortionImpl extends IfcStructuralLoadSingleDisplacementImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion();
	}
	...
	public double getDistortion() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion_Distortion(),
				true);
	}
	...
	public void setDistortion(double newDistortion) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion_Distortion(), newDistortion);
	}
	...
	public void unsetDistortion() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion_Distortion());
	}
	...
	public boolean isSetDistortion() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion_Distortion());
	}
	...
	public String getDistortionAsString() {
		return (String) eGet(
				Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion_DistortionAsString(), true);
	}
	...
	public void setDistortionAsString(String newDistortionAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion_DistortionAsString(),
	...
	public void unsetDistortionAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion_DistortionAsString());
	}
	...
	public boolean isSetDistortionAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcStructuralLoadSingleDisplacementDistortion_DistortionAsString());
	}
