...
public class IfcBridgeImpl extends IfcFacilityImpl implements IfcBridge {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcBridge();
	}
	...
	public IfcBridgeTypeEnum getPredefinedType() {
		return (IfcBridgeTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcBridge_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcBridgeTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBridge_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcBridge_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcBridge_PredefinedType());
	}
