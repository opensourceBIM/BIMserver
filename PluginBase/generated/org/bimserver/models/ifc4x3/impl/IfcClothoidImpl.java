...
public class IfcClothoidImpl extends IfcSpiralImpl implements IfcClothoid {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcClothoid();
	}
	...
	public double getClothoidConstant() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcClothoid_ClothoidConstant(), true);
	}
	...
	public void setClothoidConstant(double newClothoidConstant) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcClothoid_ClothoidConstant(), newClothoidConstant);
	}
	...
	public String getClothoidConstantAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcClothoid_ClothoidConstantAsString(), true);
	}
	...
	public void setClothoidConstantAsString(String newClothoidConstantAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcClothoid_ClothoidConstantAsString(), newClothoidConstantAsString);
	}
