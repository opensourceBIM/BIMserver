...
public class IfcRelCoversSpacesImpl extends IfcRelConnectsImpl implements IfcRelCoversSpaces {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelCoversSpaces();
	}
	...
	public IfcSpace getRelatingSpace() {
		return (IfcSpace) eGet(Ifc4x3Package.eINSTANCE.getIfcRelCoversSpaces_RelatingSpace(), true);
	}
	...
	public void setRelatingSpace(IfcSpace newRelatingSpace) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelCoversSpaces_RelatingSpace(), newRelatingSpace);
	}
	...
	public EList<IfcCovering> getRelatedCoverings() {
		return (EList<IfcCovering>) eGet(Ifc4x3Package.eINSTANCE.getIfcRelCoversSpaces_RelatedCoverings(), true);
	}
