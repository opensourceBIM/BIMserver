...
public class IfcPhysicalQuantityImpl extends IdEObjectImpl implements IfcPhysicalQuantity {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity();
	}
	...
	public String getName() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_Name(), true);
	}
	...
	public void setName(String newName) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_Name(), newName);
	}
	...
	public String getDescription() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_Description(), true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_Description(), newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_Description());
	}
	...
	public boolean isSetDescription() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_Description());
	}
	...
	public EList<IfcExternalReferenceRelationship> getHasExternalReferences() {
		return (EList<IfcExternalReferenceRelationship>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_HasExternalReferences(), true);
	}
	...
	public void unsetHasExternalReferences() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_HasExternalReferences());
	}
	...
	public boolean isSetHasExternalReferences() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_HasExternalReferences());
	}
	...
	public EList<IfcPhysicalComplexQuantity> getPartOfComplex() {
		return (EList<IfcPhysicalComplexQuantity>) eGet(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_PartOfComplex(),
				true);
	}
	...
	public void unsetPartOfComplex() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_PartOfComplex());
	}
	...
	public boolean isSetPartOfComplex() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPhysicalQuantity_PartOfComplex());
	}
