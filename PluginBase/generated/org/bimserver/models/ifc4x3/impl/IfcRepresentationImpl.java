...
public class IfcRepresentationImpl extends IdEObjectImpl implements IfcRepresentation {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_REPRESENTATION;
	}
	...
	public IfcRepresentationContext getContextOfItems() {
		return (IfcRepresentationContext) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION__CONTEXT_OF_ITEMS, true);
	}
	...
	public void setContextOfItems(IfcRepresentationContext newContextOfItems) {
		eSet(Ifc4x3Package.Literals.IFC_REPRESENTATION__CONTEXT_OF_ITEMS, newContextOfItems);
	}
	...
	public String getRepresentationIdentifier() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_IDENTIFIER, true);
	}
	...
	public void setRepresentationIdentifier(String newRepresentationIdentifier) {
		eSet(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_IDENTIFIER, newRepresentationIdentifier);
	}
	...
	public void unsetRepresentationIdentifier() {
		eUnset(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_IDENTIFIER);
	}
	...
	public boolean isSetRepresentationIdentifier() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_IDENTIFIER);
	}
	...
	public String getRepresentationType() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_TYPE, true);
	}
	...
	public void setRepresentationType(String newRepresentationType) {
		eSet(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_TYPE, newRepresentationType);
	}
	...
	public void unsetRepresentationType() {
		eUnset(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_TYPE);
	}
	...
	public boolean isSetRepresentationType() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_TYPE);
	}
	...
	public EList<IfcRepresentationItem> getItems() {
		return (EList<IfcRepresentationItem>) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION__ITEMS, true);
	}
	...
	public EList<IfcRepresentationMap> getRepresentationMap() {
		return (EList<IfcRepresentationMap>) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_MAP, true);
	}
	...
	public void unsetRepresentationMap() {
		eUnset(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_MAP);
	}
	...
	public boolean isSetRepresentationMap() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REPRESENTATION__REPRESENTATION_MAP);
	}
	...
	public EList<IfcPresentationLayerAssignment> getLayerAssignments() {
		return (EList<IfcPresentationLayerAssignment>) eGet(
				Ifc4x3Package.Literals.IFC_REPRESENTATION__LAYER_ASSIGNMENTS, true);
	}
	...
	public void unsetLayerAssignments() {
		eUnset(Ifc4x3Package.Literals.IFC_REPRESENTATION__LAYER_ASSIGNMENTS);
	}
	...
	public boolean isSetLayerAssignments() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REPRESENTATION__LAYER_ASSIGNMENTS);
	}
	...
	public EList<IfcProductRepresentation> getOfProductRepresentation() {
		return (EList<IfcProductRepresentation>) eGet(
				Ifc4x3Package.Literals.IFC_REPRESENTATION__OF_PRODUCT_REPRESENTATION, true);
	}
	...
	public void unsetOfProductRepresentation() {
		eUnset(Ifc4x3Package.Literals.IFC_REPRESENTATION__OF_PRODUCT_REPRESENTATION);
	}
	...
	public boolean isSetOfProductRepresentation() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REPRESENTATION__OF_PRODUCT_REPRESENTATION);
	}
