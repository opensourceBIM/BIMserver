...
public class IfcConstructionProductResourceImpl extends IfcConstructionResourceImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcConstructionProductResource();
	}
	...
	public IfcConstructionProductResourceTypeEnum getPredefinedType() {
		return (IfcConstructionProductResourceTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcConstructionProductResource_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcConstructionProductResourceTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcConstructionProductResource_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcConstructionProductResource_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcConstructionProductResource_PredefinedType());
	}
