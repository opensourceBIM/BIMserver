...
public class IfcRigidOperationImpl extends IfcCoordinateOperationImpl implements IfcRigidOperation {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRigidOperation();
	}
	...
	public IfcMeasureValue getFirstCoordinate() {
		return (IfcMeasureValue) eGet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_FirstCoordinate(), true);
	}
	...
	public void setFirstCoordinate(IfcMeasureValue newFirstCoordinate) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_FirstCoordinate(), newFirstCoordinate);
	}
	...
	public IfcMeasureValue getSecondCoordinate() {
		return (IfcMeasureValue) eGet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_SecondCoordinate(), true);
	}
	...
	public void setSecondCoordinate(IfcMeasureValue newSecondCoordinate) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_SecondCoordinate(), newSecondCoordinate);
	}
	...
	public double getHeight() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_Height(), true);
	}
	...
	public void setHeight(double newHeight) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_Height(), newHeight);
	}
	...
	public void unsetHeight() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_Height());
	}
	...
	public boolean isSetHeight() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_Height());
	}
	...
	public String getHeightAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_HeightAsString(), true);
	}
	...
	public void setHeightAsString(String newHeightAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_HeightAsString(), newHeightAsString);
	}
	...
	public void unsetHeightAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_HeightAsString());
	}
	...
	public boolean isSetHeightAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRigidOperation_HeightAsString());
	}
