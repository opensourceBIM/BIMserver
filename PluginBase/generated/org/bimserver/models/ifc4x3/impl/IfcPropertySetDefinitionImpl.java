...
public class IfcPropertySetDefinitionImpl extends IfcPropertyDefinitionImpl implements IfcPropertySetDefinition {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition();
	}
	...
	public EList<IfcTypeObject> getDefinesType() {
		return (EList<IfcTypeObject>) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_DefinesType(), true);
	}
	...
	public void unsetDefinesType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_DefinesType());
	}
	...
	public boolean isSetDefinesType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_DefinesType());
	}
	...
	public EList<IfcRelDefinesByTemplate> getIsDefinedBy() {
		return (EList<IfcRelDefinesByTemplate>) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_IsDefinedBy(),
				true);
	}
	...
	public void unsetIsDefinedBy() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_IsDefinedBy());
	}
	...
	public boolean isSetIsDefinedBy() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_IsDefinedBy());
	}
	...
	public EList<IfcRelDefinesByProperties> getDefinesOccurrence() {
		return (EList<IfcRelDefinesByProperties>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_DefinesOccurrence(), true);
	}
	...
	public void unsetDefinesOccurrence() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_DefinesOccurrence());
	}
	...
	public boolean isSetDefinesOccurrence() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertySetDefinition_DefinesOccurrence());
	}
