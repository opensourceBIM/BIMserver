...
public class IfcDistributionElementImpl extends IfcElementImpl implements IfcDistributionElement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcDistributionElement();
	}
	...
	public EList<IfcRelConnectsPortToElement> getHasPorts() {
		return (EList<IfcRelConnectsPortToElement>) eGet(Ifc4x3Package.eINSTANCE.getIfcDistributionElement_HasPorts(),
				true);
	}
	...
	public void unsetHasPorts() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcDistributionElement_HasPorts());
	}
	...
	public boolean isSetHasPorts() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcDistributionElement_HasPorts());
	}
