...
public class IfcAssetImpl extends IfcGroupImpl implements IfcAsset {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_ASSET;
	}
	...
	public String getIdentification() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ASSET__IDENTIFICATION, true);
	}
	...
	public void setIdentification(String newIdentification) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__IDENTIFICATION, newIdentification);
	}
	...
	public boolean isSetIdentification() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__IDENTIFICATION);
	}
	...
	public IfcCostValue getOriginalValue() {
		return (IfcCostValue) eGet(Ifc4x3Package.Literals.IFC_ASSET__ORIGINAL_VALUE, true);
	}
	...
	public void setOriginalValue(IfcCostValue newOriginalValue) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__ORIGINAL_VALUE, newOriginalValue);
	}
	...
	public void unsetOriginalValue() {
		eUnset(Ifc4x3Package.Literals.IFC_ASSET__ORIGINAL_VALUE);
	}
	...
	public boolean isSetOriginalValue() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__ORIGINAL_VALUE);
	}
	...
	public IfcCostValue getCurrentValue() {
		return (IfcCostValue) eGet(Ifc4x3Package.Literals.IFC_ASSET__CURRENT_VALUE, true);
	}
	...
	public void setCurrentValue(IfcCostValue newCurrentValue) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__CURRENT_VALUE, newCurrentValue);
	}
	...
	public void unsetCurrentValue() {
		eUnset(Ifc4x3Package.Literals.IFC_ASSET__CURRENT_VALUE);
	}
	...
	public boolean isSetCurrentValue() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__CURRENT_VALUE);
	}
	...
	public IfcCostValue getTotalReplacementCost() {
		return (IfcCostValue) eGet(Ifc4x3Package.Literals.IFC_ASSET__TOTAL_REPLACEMENT_COST, true);
	}
	...
	public void setTotalReplacementCost(IfcCostValue newTotalReplacementCost) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__TOTAL_REPLACEMENT_COST, newTotalReplacementCost);
	}
	...
	public void unsetTotalReplacementCost() {
		eUnset(Ifc4x3Package.Literals.IFC_ASSET__TOTAL_REPLACEMENT_COST);
	}
	...
	public boolean isSetTotalReplacementCost() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__TOTAL_REPLACEMENT_COST);
	}
	...
	public IfcActorSelect getOwner() {
		return (IfcActorSelect) eGet(Ifc4x3Package.Literals.IFC_ASSET__OWNER, true);
	}
	...
	public void setOwner(IfcActorSelect newOwner) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__OWNER, newOwner);
	}
	...
	public void unsetOwner() {
		eUnset(Ifc4x3Package.Literals.IFC_ASSET__OWNER);
	}
	...
	public boolean isSetOwner() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__OWNER);
	}
	...
	public IfcActorSelect getUser() {
		return (IfcActorSelect) eGet(Ifc4x3Package.Literals.IFC_ASSET__USER, true);
	}
	...
	public void setUser(IfcActorSelect newUser) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__USER, newUser);
	}
	...
	public void unsetUser() {
		eUnset(Ifc4x3Package.Literals.IFC_ASSET__USER);
	}
	...
	public boolean isSetUser() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__USER);
	}
	...
	public IfcPerson getResponsiblePerson() {
		return (IfcPerson) eGet(Ifc4x3Package.Literals.IFC_ASSET__RESPONSIBLE_PERSON, true);
	}
	...
	public void setResponsiblePerson(IfcPerson newResponsiblePerson) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__RESPONSIBLE_PERSON, newResponsiblePerson);
	}
	...
	public void unsetResponsiblePerson() {
		eUnset(Ifc4x3Package.Literals.IFC_ASSET__RESPONSIBLE_PERSON);
	}
	...
	public boolean isSetResponsiblePerson() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__RESPONSIBLE_PERSON);
	}
	...
	public String getIncorporationDate() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_ASSET__INCORPORATION_DATE, true);
	}
	...
	public void setIncorporationDate(String newIncorporationDate) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__INCORPORATION_DATE, newIncorporationDate);
	}
	...
	public void unsetIncorporationDate() {
		eUnset(Ifc4x3Package.Literals.IFC_ASSET__INCORPORATION_DATE);
	}
	...
	public boolean isSetIncorporationDate() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__INCORPORATION_DATE);
	}
	...
	public IfcCostValue getDepreciatedValue() {
		return (IfcCostValue) eGet(Ifc4x3Package.Literals.IFC_ASSET__DEPRECIATED_VALUE, true);
	}
	...
	public void setDepreciatedValue(IfcCostValue newDepreciatedValue) {
		eSet(Ifc4x3Package.Literals.IFC_ASSET__DEPRECIATED_VALUE, newDepreciatedValue);
	}
	...
	public void unsetDepreciatedValue() {
		eUnset(Ifc4x3Package.Literals.IFC_ASSET__DEPRECIATED_VALUE);
	}
	...
	public boolean isSetDepreciatedValue() {
		return eIsSet(Ifc4x3Package.Literals.IFC_ASSET__DEPRECIATED_VALUE);
	}
