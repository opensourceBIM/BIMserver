...
public class IfcCurveSegmentImpl extends IfcSegmentImpl implements IfcCurveSegment {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCurveSegment();
	}
	...
	public IfcPlacement getPlacement() {
		return (IfcPlacement) eGet(Ifc4x3Package.eINSTANCE.getIfcCurveSegment_Placement(), true);
	}
	...
	public void setPlacement(IfcPlacement newPlacement) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCurveSegment_Placement(), newPlacement);
	}
	...
	public IfcCurveMeasureSelect getSegmentStart() {
		return (IfcCurveMeasureSelect) eGet(Ifc4x3Package.eINSTANCE.getIfcCurveSegment_SegmentStart(), true);
	}
	...
	public void setSegmentStart(IfcCurveMeasureSelect newSegmentStart) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCurveSegment_SegmentStart(), newSegmentStart);
	}
	...
	public IfcCurveMeasureSelect getSegmentLength() {
		return (IfcCurveMeasureSelect) eGet(Ifc4x3Package.eINSTANCE.getIfcCurveSegment_SegmentLength(), true);
	}
	...
	public void setSegmentLength(IfcCurveMeasureSelect newSegmentLength) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCurveSegment_SegmentLength(), newSegmentLength);
	}
	...
	public IfcCurve getParentCurve() {
		return (IfcCurve) eGet(Ifc4x3Package.eINSTANCE.getIfcCurveSegment_ParentCurve(), true);
	}
	...
	public void setParentCurve(IfcCurve newParentCurve) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCurveSegment_ParentCurve(), newParentCurve);
	}
