...
public class IfcPermeableCoveringPropertiesImpl extends IfcPreDefinedPropertySetImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES;
	}
	...
	public IfcPermeableCoveringOperationEnum getOperationType() {
		return (IfcPermeableCoveringOperationEnum) eGet(
				Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE, true);
	}
	...
	public void setOperationType(IfcPermeableCoveringOperationEnum newOperationType) {
		eSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE, newOperationType);
	}
	...
	public IfcWindowPanelPositionEnum getPanelPosition() {
		return (IfcWindowPanelPositionEnum) eGet(
				Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__PANEL_POSITION, true);
	}
	...
	public void setPanelPosition(IfcWindowPanelPositionEnum newPanelPosition) {
		eSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__PANEL_POSITION, newPanelPosition);
	}
	...
	public double getFrameDepth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH, true);
	}
	...
	public void setFrameDepth(double newFrameDepth) {
		eSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH, newFrameDepth);
	}
	...
	public boolean isSetFrameDepth() {
		return eIsSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH);
	}
	...
	public String getFrameDepthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING, true);
	}
	...
	public void setFrameDepthAsString(String newFrameDepthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING, newFrameDepthAsString);
	}
	...
	public void unsetFrameDepthAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING);
	}
	...
	public boolean isSetFrameDepthAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING);
	}
	...
	public double getFrameThickness() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS, true);
	}
	...
	public void setFrameThickness(double newFrameThickness) {
		eSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS, newFrameThickness);
	}
	...
	public void unsetFrameThickness() {
		eUnset(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS);
	}
	...
	public boolean isSetFrameThickness() {
		return eIsSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS);
	}
	...
	public String getFrameThicknessAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING, true);
	}
	...
	public void unsetFrameThicknessAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING);
	}
	...
	public IfcShapeAspect getShapeAspectStyle() {
		return (IfcShapeAspect) eGet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE,
				true);
	}
	...
	public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
		eSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE, newShapeAspectStyle);
	}
	...
	public boolean isSetShapeAspectStyle() {
		return eIsSet(Ifc4x3Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
