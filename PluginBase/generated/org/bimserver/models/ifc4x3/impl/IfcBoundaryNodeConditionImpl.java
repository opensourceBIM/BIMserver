...
public class IfcBoundaryNodeConditionImpl extends IfcBoundaryConditionImpl implements IfcBoundaryNodeCondition {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION;
	}
	...
	public IfcTranslationalStiffnessSelect getTranslationalStiffnessX() {
		return (IfcTranslationalStiffnessSelect) eGet(
				Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_X, true);
	}
	...
	public void setTranslationalStiffnessX(IfcTranslationalStiffnessSelect newTranslationalStiffnessX) {
		eSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_X, newTranslationalStiffnessX);
	}
	...
	public boolean isSetTranslationalStiffnessX() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_X);
	}
	...
	public IfcTranslationalStiffnessSelect getTranslationalStiffnessY() {
		return (IfcTranslationalStiffnessSelect) eGet(
				Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_Y, true);
	}
	...
	public void setTranslationalStiffnessY(IfcTranslationalStiffnessSelect newTranslationalStiffnessY) {
		eSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_Y, newTranslationalStiffnessY);
	}
	...
	public void unsetTranslationalStiffnessY() {
		eUnset(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_Y);
	}
	...
	public boolean isSetTranslationalStiffnessY() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_Y);
	}
	...
	public IfcTranslationalStiffnessSelect getTranslationalStiffnessZ() {
		return (IfcTranslationalStiffnessSelect) eGet(
				Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_Z, true);
	}
	...
	public void unsetTranslationalStiffnessZ() {
		eUnset(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_Z);
	}
	...
	public boolean isSetTranslationalStiffnessZ() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__TRANSLATIONAL_STIFFNESS_Z);
	}
	...
	public IfcRotationalStiffnessSelect getRotationalStiffnessX() {
		return (IfcRotationalStiffnessSelect) eGet(
				Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_X, true);
	}
	...
	public void setRotationalStiffnessX(IfcRotationalStiffnessSelect newRotationalStiffnessX) {
		eSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_X, newRotationalStiffnessX);
	}
	...
	public void unsetRotationalStiffnessX() {
		eUnset(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_X);
	}
	...
	public boolean isSetRotationalStiffnessX() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_X);
	}
	...
	public IfcRotationalStiffnessSelect getRotationalStiffnessY() {
		return (IfcRotationalStiffnessSelect) eGet(
				Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_Y, true);
	}
	...
	public void setRotationalStiffnessY(IfcRotationalStiffnessSelect newRotationalStiffnessY) {
		eSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_Y, newRotationalStiffnessY);
	}
	...
	public void unsetRotationalStiffnessY() {
		eUnset(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_Y);
	}
	...
	public boolean isSetRotationalStiffnessY() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_Y);
	}
	...
	public IfcRotationalStiffnessSelect getRotationalStiffnessZ() {
		return (IfcRotationalStiffnessSelect) eGet(
				Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_Z, true);
	}
	...
	public void setRotationalStiffnessZ(IfcRotationalStiffnessSelect newRotationalStiffnessZ) {
		eSet(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_Z, newRotationalStiffnessZ);
	}
	...
	public void unsetRotationalStiffnessZ() {
		eUnset(Ifc4x3Package.Literals.IFC_BOUNDARY_NODE_CONDITION__ROTATIONAL_STIFFNESS_Z);
	}
