...
public class IfcDoorTypeImpl extends IfcBuiltElementTypeImpl implements IfcDoorType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcDoorType();
	}
	...
	public IfcDoorTypeEnum getPredefinedType() {
		return (IfcDoorTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcDoorType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcDoorTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcDoorType_PredefinedType(), newPredefinedType);
	}
	...
	public IfcDoorTypeOperationEnum getOperationType() {
		return (IfcDoorTypeOperationEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcDoorType_OperationType(), true);
	}
	...
	public void setOperationType(IfcDoorTypeOperationEnum newOperationType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcDoorType_OperationType(), newOperationType);
	}
	...
	public Tristate getParameterTakesPrecedence() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcDoorType_ParameterTakesPrecedence(), true);
	}
	...
	public void setParameterTakesPrecedence(Tristate newParameterTakesPrecedence) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcDoorType_ParameterTakesPrecedence(), newParameterTakesPrecedence);
	}
	...
	public void unsetParameterTakesPrecedence() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcDoorType_ParameterTakesPrecedence());
	}
	...
	public boolean isSetParameterTakesPrecedence() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcDoorType_ParameterTakesPrecedence());
	}
	...
	public String getUserDefinedOperationType() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcDoorType_UserDefinedOperationType(), true);
	}
	...
	public void setUserDefinedOperationType(String newUserDefinedOperationType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcDoorType_UserDefinedOperationType(), newUserDefinedOperationType);
	}
	...
	public void unsetUserDefinedOperationType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcDoorType_UserDefinedOperationType());
	}
	...
	public boolean isSetUserDefinedOperationType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcDoorType_UserDefinedOperationType());
	}
