...
public class IfcPipeSegmentImpl extends IfcFlowSegmentImpl implements IfcPipeSegment {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPipeSegment();
	}
	...
	public IfcPipeSegmentTypeEnum getPredefinedType() {
		return (IfcPipeSegmentTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcPipeSegment_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcPipeSegmentTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPipeSegment_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPipeSegment_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPipeSegment_PredefinedType());
	}
