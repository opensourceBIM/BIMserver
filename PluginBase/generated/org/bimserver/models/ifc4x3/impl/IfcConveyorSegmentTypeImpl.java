...
public class IfcConveyorSegmentTypeImpl extends IfcFlowSegmentTypeImpl implements IfcConveyorSegmentType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcConveyorSegmentType();
	}
	...
	public IfcConveyorSegmentTypeEnum getPredefinedType() {
		return (IfcConveyorSegmentTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcConveyorSegmentType_PredefinedType(),
				true);
	}
	...
	public void setPredefinedType(IfcConveyorSegmentTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcConveyorSegmentType_PredefinedType(), newPredefinedType);
	}
