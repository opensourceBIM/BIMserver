...
public class IfcPlanarBoxImpl extends IfcPlanarExtentImpl implements IfcPlanarBox {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPlanarBox();
	}
	...
	public IfcAxis2Placement getPlacement() {
		return (IfcAxis2Placement) eGet(Ifc4x3Package.eINSTANCE.getIfcPlanarBox_Placement(), true);
	}
	...
	public void setPlacement(IfcAxis2Placement newPlacement) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPlanarBox_Placement(), newPlacement);
	}
