...
public class IfcSanitaryTerminalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcSanitaryTerminalType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSanitaryTerminalType();
	}
	...
	public IfcSanitaryTerminalTypeEnum getPredefinedType() {
		return (IfcSanitaryTerminalTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcSanitaryTerminalType_PredefinedType(),
				true);
	}
	...
	public void setPredefinedType(IfcSanitaryTerminalTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSanitaryTerminalType_PredefinedType(), newPredefinedType);
	}
