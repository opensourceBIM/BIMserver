...
public class IfcCurrencyRelationshipImpl extends IfcResourceLevelRelationshipImpl implements IfcCurrencyRelationship {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP;
	}
	...
	public IfcMonetaryUnit getRelatingMonetaryUnit() {
		return (IfcMonetaryUnit) eGet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RELATING_MONETARY_UNIT, true);
	}
	...
	public void setRelatingMonetaryUnit(IfcMonetaryUnit newRelatingMonetaryUnit) {
		eSet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RELATING_MONETARY_UNIT, newRelatingMonetaryUnit);
	}
	...
	public IfcMonetaryUnit getRelatedMonetaryUnit() {
		return (IfcMonetaryUnit) eGet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RELATED_MONETARY_UNIT, true);
	}
	...
	public void setRelatedMonetaryUnit(IfcMonetaryUnit newRelatedMonetaryUnit) {
		eSet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RELATED_MONETARY_UNIT, newRelatedMonetaryUnit);
	}
	...
	public double getExchangeRate() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__EXCHANGE_RATE, true);
	}
	...
	public void setExchangeRate(double newExchangeRate) {
		eSet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__EXCHANGE_RATE, newExchangeRate);
	}
	...
	public String getExchangeRateAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__EXCHANGE_RATE_AS_STRING, true);
	}
	...
	public void setExchangeRateAsString(String newExchangeRateAsString) {
		eSet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__EXCHANGE_RATE_AS_STRING, newExchangeRateAsString);
	}
	...
	public String getRateDateTime() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_DATE_TIME, true);
	}
	...
	public void setRateDateTime(String newRateDateTime) {
		eSet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_DATE_TIME, newRateDateTime);
	}
	...
	public void unsetRateDateTime() {
		eUnset(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_DATE_TIME);
	}
	...
	public boolean isSetRateDateTime() {
		return eIsSet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_DATE_TIME);
	}
	...
	public IfcLibraryInformation getRateSource() {
		return (IfcLibraryInformation) eGet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_SOURCE, true);
	}
	...
	public void setRateSource(IfcLibraryInformation newRateSource) {
		eSet(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_SOURCE, newRateSource);
	}
	...
	public void unsetRateSource() {
		eUnset(Ifc4x3Package.Literals.IFC_CURRENCY_RELATIONSHIP__RATE_SOURCE);
	}
