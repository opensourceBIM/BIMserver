...
public class IfcTransformerTypeImpl extends IfcEnergyConversionDeviceTypeImpl implements IfcTransformerType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_TRANSFORMER_TYPE;
	}
	...
	public IfcTransformerTypeEnum getPredefinedType() {
		return (IfcTransformerTypeEnum) eGet(Ifc4x3Package.Literals.IFC_TRANSFORMER_TYPE__PREDEFINED_TYPE, true);
	}
	...
	public void setPredefinedType(IfcTransformerTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.Literals.IFC_TRANSFORMER_TYPE__PREDEFINED_TYPE, newPredefinedType);
	}
