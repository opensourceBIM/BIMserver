...
public class IfcCoveringImpl extends IfcBuiltElementImpl implements IfcCovering {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCovering();
	}
	...
	public IfcCoveringTypeEnum getPredefinedType() {
		return (IfcCoveringTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcCovering_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcCoveringTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCovering_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCovering_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCovering_PredefinedType());
	}
	...
	public EList<IfcRelCoversSpaces> getCoversSpaces() {
		return (EList<IfcRelCoversSpaces>) eGet(Ifc4x3Package.eINSTANCE.getIfcCovering_CoversSpaces(), true);
	}
	...
	public void unsetCoversSpaces() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCovering_CoversSpaces());
	}
	...
	public boolean isSetCoversSpaces() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCovering_CoversSpaces());
	}
	...
	public EList<IfcRelCoversBldgElements> getCoversElements() {
		return (EList<IfcRelCoversBldgElements>) eGet(Ifc4x3Package.eINSTANCE.getIfcCovering_CoversElements(), true);
	}
	...
	public void unsetCoversElements() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCovering_CoversElements());
	}
	...
	public boolean isSetCoversElements() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCovering_CoversElements());
	}
