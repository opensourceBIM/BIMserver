...
public class IfcShapeAspectImpl extends IdEObjectImpl implements IfcShapeAspect {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcShapeAspect();
	}
	...
	public EList<IfcShapeModel> getShapeRepresentations() {
		return (EList<IfcShapeModel>) eGet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_ShapeRepresentations(), true);
	}
	...
	public String getName() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_Name(), true);
	}
	...
	public void setName(String newName) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_Name(), newName);
	}
	...
	public void unsetName() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_Name());
	}
	...
	public boolean isSetName() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_Name());
	}
	...
	public String getDescription() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_Description(), true);
	}
	...
	public void setDescription(String newDescription) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_Description(), newDescription);
	}
	...
	public void unsetDescription() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_Description());
	}
	...
	public boolean isSetDescription() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_Description());
	}
	...
	public Tristate getProductDefinitional() {
		return (Tristate) eGet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_ProductDefinitional(), true);
	}
	...
	public void setProductDefinitional(Tristate newProductDefinitional) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_ProductDefinitional(), newProductDefinitional);
	}
	...
	public IfcProductRepresentationSelect getPartOfProductDefinitionShape() {
		return (IfcProductRepresentationSelect) eGet(
				Ifc4x3Package.eINSTANCE.getIfcShapeAspect_PartOfProductDefinitionShape(), true);
	}
	...
	public void setPartOfProductDefinitionShape(IfcProductRepresentationSelect newPartOfProductDefinitionShape) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_PartOfProductDefinitionShape(), newPartOfProductDefinitionShape);
	}
	...
	public void unsetPartOfProductDefinitionShape() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_PartOfProductDefinitionShape());
	}
	...
	public boolean isSetPartOfProductDefinitionShape() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_PartOfProductDefinitionShape());
	}
	...
	public EList<IfcExternalReferenceRelationship> getHasExternalReferences() {
		return (EList<IfcExternalReferenceRelationship>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcShapeAspect_HasExternalReferences(), true);
	}
	...
	public void unsetHasExternalReferences() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_HasExternalReferences());
	}
	...
	public boolean isSetHasExternalReferences() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcShapeAspect_HasExternalReferences());
	}
