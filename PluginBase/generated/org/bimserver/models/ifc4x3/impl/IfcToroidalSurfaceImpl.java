...
public class IfcToroidalSurfaceImpl extends IfcElementarySurfaceImpl implements IfcToroidalSurface {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE;
	}
	...
	public double getMajorRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE__MAJOR_RADIUS, true);
	}
	...
	public void setMajorRadius(double newMajorRadius) {
		eSet(Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE__MAJOR_RADIUS, newMajorRadius);
	}
	...
	public String getMajorRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE__MAJOR_RADIUS_AS_STRING, true);
	}
	...
	public void setMajorRadiusAsString(String newMajorRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE__MAJOR_RADIUS_AS_STRING, newMajorRadiusAsString);
	}
	...
	public double getMinorRadius() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE__MINOR_RADIUS, true);
	}
	...
	public void setMinorRadius(double newMinorRadius) {
		eSet(Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE__MINOR_RADIUS, newMinorRadius);
	}
	...
	public String getMinorRadiusAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE__MINOR_RADIUS_AS_STRING, true);
	}
	...
	public void setMinorRadiusAsString(String newMinorRadiusAsString) {
		eSet(Ifc4x3Package.Literals.IFC_TOROIDAL_SURFACE__MINOR_RADIUS_AS_STRING, newMinorRadiusAsString);
	}
