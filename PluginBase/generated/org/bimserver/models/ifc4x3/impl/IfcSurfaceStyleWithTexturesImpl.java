...
public class IfcSurfaceStyleWithTexturesImpl extends IfcPresentationItemImpl implements IfcSurfaceStyleWithTextures {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleWithTextures();
	}
	...
	public EList<IfcSurfaceTexture> getTextures() {
		return (EList<IfcSurfaceTexture>) eGet(Ifc4x3Package.eINSTANCE.getIfcSurfaceStyleWithTextures_Textures(), true);
	}
