...
public class IfcReinforcementDefinitionPropertiesImpl extends IfcPreDefinedPropertySetImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcReinforcementDefinitionProperties();
	}
	...
	public String getDefinitionType() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcReinforcementDefinitionProperties_DefinitionType(), true);
	}
	...
	public void setDefinitionType(String newDefinitionType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcReinforcementDefinitionProperties_DefinitionType(), newDefinitionType);
	}
	...
	public void unsetDefinitionType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcReinforcementDefinitionProperties_DefinitionType());
	}
	...
	public boolean isSetDefinitionType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcReinforcementDefinitionProperties_DefinitionType());
	}
	...
	public EList<IfcSectionReinforcementProperties> getReinforcementSectionDefinitions() {
		return (EList<IfcSectionReinforcementProperties>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcReinforcementDefinitionProperties_ReinforcementSectionDefinitions(),
				true);
	}
