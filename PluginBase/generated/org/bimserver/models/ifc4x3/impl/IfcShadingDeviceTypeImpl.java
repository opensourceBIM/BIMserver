...
public class IfcShadingDeviceTypeImpl extends IfcBuiltElementTypeImpl implements IfcShadingDeviceType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcShadingDeviceType();
	}
	...
	public IfcShadingDeviceTypeEnum getPredefinedType() {
		return (IfcShadingDeviceTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcShadingDeviceType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcShadingDeviceTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcShadingDeviceType_PredefinedType(), newPredefinedType);
	}
