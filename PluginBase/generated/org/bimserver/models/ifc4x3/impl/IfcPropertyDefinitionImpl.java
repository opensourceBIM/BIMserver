...
public class IfcPropertyDefinitionImpl extends IfcRootImpl implements IfcPropertyDefinition {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPropertyDefinition();
	}
	...
	public EList<IfcRelDeclares> getHasContext() {
		return (EList<IfcRelDeclares>) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertyDefinition_HasContext(), true);
	}
	...
	public void unsetHasContext() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertyDefinition_HasContext());
	}
	...
	public boolean isSetHasContext() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertyDefinition_HasContext());
	}
	...
	public EList<IfcRelAssociates> getHasAssociations() {
		return (EList<IfcRelAssociates>) eGet(Ifc4x3Package.eINSTANCE.getIfcPropertyDefinition_HasAssociations(), true);
	}
	...
	public void unsetHasAssociations() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertyDefinition_HasAssociations());
	}
	...
	public boolean isSetHasAssociations() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertyDefinition_HasAssociations());
	}
