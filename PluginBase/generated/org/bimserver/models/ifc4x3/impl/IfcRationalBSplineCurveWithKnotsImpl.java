...
public class IfcRationalBSplineCurveWithKnotsImpl extends IfcBSplineCurveWithKnotsImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots();
	}
	...
	public EList<Double> getWeightsData() {
		return (EList<Double>) eGet(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_WeightsData(), true);
	}
	...
	public EList<String> getWeightsDataAsString() {
		return (EList<String>) eGet(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_WeightsDataAsString(),
				true);
	}
	...
	public double getWeights() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_Weights(), true);
	}
	...
	public void setWeights(double newWeights) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_Weights(), newWeights);
	}
	...
	public void unsetWeights() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_Weights());
	}
	...
	public boolean isSetWeights() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_Weights());
	}
	...
	public String getWeightsAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_WeightsAsString(), true);
	}
	...
	public void setWeightsAsString(String newWeightsAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_WeightsAsString(), newWeightsAsString);
	}
	...
	public void unsetWeightsAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_WeightsAsString());
	}
	...
	public boolean isSetWeightsAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRationalBSplineCurveWithKnots_WeightsAsString());
	}
