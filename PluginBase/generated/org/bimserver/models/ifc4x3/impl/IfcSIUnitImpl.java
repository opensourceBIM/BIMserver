...
public class IfcSIUnitImpl extends IfcNamedUnitImpl implements IfcSIUnit {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSIUnit();
	}
	...
	public IfcSIPrefix getPrefix() {
		return (IfcSIPrefix) eGet(Ifc4x3Package.eINSTANCE.getIfcSIUnit_Prefix(), true);
	}
	...
	public void setPrefix(IfcSIPrefix newPrefix) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSIUnit_Prefix(), newPrefix);
	}
	...
	public void unsetPrefix() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSIUnit_Prefix());
	}
	...
	public boolean isSetPrefix() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSIUnit_Prefix());
	}
	...
	public IfcSIUnitName getName() {
		return (IfcSIUnitName) eGet(Ifc4x3Package.eINSTANCE.getIfcSIUnit_Name(), true);
	}
	...
	public void setName(IfcSIUnitName newName) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSIUnit_Name(), newName);
	}
