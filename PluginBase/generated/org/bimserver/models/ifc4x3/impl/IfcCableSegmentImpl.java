...
public class IfcCableSegmentImpl extends IfcFlowSegmentImpl implements IfcCableSegment {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCableSegment();
	}
	...
	public IfcCableSegmentTypeEnum getPredefinedType() {
		return (IfcCableSegmentTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcCableSegment_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcCableSegmentTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCableSegment_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCableSegment_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCableSegment_PredefinedType());
	}
