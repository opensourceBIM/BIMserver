...
public class IfcAxis2PlacementLinearImpl extends IfcPlacementImpl implements IfcAxis2PlacementLinear {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear();
	}
	...
	public IfcDirection getAxis() {
		return (IfcDirection) eGet(Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear_Axis(), true);
	}
	...
	public void setAxis(IfcDirection newAxis) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear_Axis(), newAxis);
	}
	...
	public void unsetAxis() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear_Axis());
	}
	...
	public boolean isSetAxis() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear_Axis());
	}
	...
	public IfcDirection getRefDirection() {
		return (IfcDirection) eGet(Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear_RefDirection(), true);
	}
	...
	public void setRefDirection(IfcDirection newRefDirection) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear_RefDirection(), newRefDirection);
	}
	...
	public void unsetRefDirection() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear_RefDirection());
	}
	...
	public boolean isSetRefDirection() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcAxis2PlacementLinear_RefDirection());
	}
