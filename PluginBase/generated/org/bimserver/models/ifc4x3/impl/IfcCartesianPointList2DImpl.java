...
public class IfcCartesianPointList2DImpl extends IfcCartesianPointListImpl implements IfcCartesianPointList2D {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCartesianPointList2D();
	}
	...
	public EList<ListOfIfcLengthMeasure> getCoordList() {
		return (EList<ListOfIfcLengthMeasure>) eGet(Ifc4x3Package.eINSTANCE.getIfcCartesianPointList2D_CoordList(),
				true);
	}
	...
	public EList<String> getTagList() {
		return (EList<String>) eGet(Ifc4x3Package.eINSTANCE.getIfcCartesianPointList2D_TagList(), true);
	}
	...
	public void unsetTagList() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcCartesianPointList2D_TagList());
	}
	...
	public boolean isSetTagList() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcCartesianPointList2D_TagList());
	}
