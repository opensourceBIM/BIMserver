...
public class IfcKerbImpl extends IfcBuiltElementImpl implements IfcKerb {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcKerb();
	}
	...
	public IfcKerbTypeEnum getPredefinedType() {
		return (IfcKerbTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcKerb_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcKerbTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcKerb_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcKerb_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcKerb_PredefinedType());
	}
