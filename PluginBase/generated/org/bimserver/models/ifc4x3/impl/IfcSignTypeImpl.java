...
public class IfcSignTypeImpl extends IfcElementComponentTypeImpl implements IfcSignType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSignType();
	}
	...
	public IfcSignTypeEnum getPredefinedType() {
		return (IfcSignTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcSignType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcSignTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSignType_PredefinedType(), newPredefinedType);
	}
