...
public class IfcLinearPlacementImpl extends IfcObjectPlacementImpl implements IfcLinearPlacement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcLinearPlacement();
	}
	...
	public IfcAxis2PlacementLinear getRelativePlacement() {
		return (IfcAxis2PlacementLinear) eGet(Ifc4x3Package.eINSTANCE.getIfcLinearPlacement_RelativePlacement(), true);
	}
	...
	public void setRelativePlacement(IfcAxis2PlacementLinear newRelativePlacement) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcLinearPlacement_RelativePlacement(), newRelativePlacement);
	}
	...
	public IfcAxis2Placement3D getCartesianPosition() {
		return (IfcAxis2Placement3D) eGet(Ifc4x3Package.eINSTANCE.getIfcLinearPlacement_CartesianPosition(), true);
	}
	...
	public void setCartesianPosition(IfcAxis2Placement3D newCartesianPosition) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcLinearPlacement_CartesianPosition(), newCartesianPosition);
	}
	...
	public void unsetCartesianPosition() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcLinearPlacement_CartesianPosition());
	}
	...
	public boolean isSetCartesianPosition() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcLinearPlacement_CartesianPosition());
	}
