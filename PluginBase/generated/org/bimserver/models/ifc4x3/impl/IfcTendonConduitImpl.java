...
public class IfcTendonConduitImpl extends IfcReinforcingElementImpl implements IfcTendonConduit {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcTendonConduit();
	}
	...
	public IfcTendonConduitTypeEnum getPredefinedType() {
		return (IfcTendonConduitTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcTendonConduit_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcTendonConduitTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcTendonConduit_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcTendonConduit_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcTendonConduit_PredefinedType());
	}
