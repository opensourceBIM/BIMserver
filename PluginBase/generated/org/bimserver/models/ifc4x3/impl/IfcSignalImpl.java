...
public class IfcSignalImpl extends IfcFlowTerminalImpl implements IfcSignal {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSignal();
	}
	...
	public IfcSignalTypeEnum getPredefinedType() {
		return (IfcSignalTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcSignal_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcSignalTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSignal_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSignal_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSignal_PredefinedType());
	}
