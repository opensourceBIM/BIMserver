...
public class IfcSpaceTypeImpl extends IfcSpatialStructureElementTypeImpl implements IfcSpaceType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSpaceType();
	}
	...
	public IfcSpaceTypeEnum getPredefinedType() {
		return (IfcSpaceTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcSpaceType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcSpaceTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSpaceType_PredefinedType(), newPredefinedType);
	}
	...
	public String getLongName() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcSpaceType_LongName(), true);
	}
	...
	public void setLongName(String newLongName) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSpaceType_LongName(), newLongName);
	}
	...
	public void unsetLongName() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSpaceType_LongName());
	}
	...
	public boolean isSetLongName() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSpaceType_LongName());
	}
