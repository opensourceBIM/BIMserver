...
public class IfcMaterialLayerSetUsageImpl extends IfcMaterialUsageDefinitionImpl implements IfcMaterialLayerSetUsage {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE;
	}
	...
	public IfcMaterialLayerSet getForLayerSet() {
		return (IfcMaterialLayerSet) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__FOR_LAYER_SET, true);
	}
	...
	public void setForLayerSet(IfcMaterialLayerSet newForLayerSet) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__FOR_LAYER_SET, newForLayerSet);
	}
	...
	public IfcLayerSetDirectionEnum getLayerSetDirection() {
		return (IfcLayerSetDirectionEnum) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__LAYER_SET_DIRECTION,
				true);
	}
	...
	public void setLayerSetDirection(IfcLayerSetDirectionEnum newLayerSetDirection) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__LAYER_SET_DIRECTION, newLayerSetDirection);
	}
	...
	public IfcDirectionSenseEnum getDirectionSense() {
		return (IfcDirectionSenseEnum) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__DIRECTION_SENSE, true);
	}
	...
	public void setDirectionSense(IfcDirectionSenseEnum newDirectionSense) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__DIRECTION_SENSE, newDirectionSense);
	}
	...
	public double getOffsetFromReferenceLine() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__OFFSET_FROM_REFERENCE_LINE, true);
	}
	...
	public String getOffsetFromReferenceLineAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__OFFSET_FROM_REFERENCE_LINE_AS_STRING,
				true);
	}
	...
	public void setOffsetFromReferenceLineAsString(String newOffsetFromReferenceLineAsString) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__OFFSET_FROM_REFERENCE_LINE_AS_STRING,
	...
	public double getReferenceExtent() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__REFERENCE_EXTENT, true);
	}
	...
	public void setReferenceExtent(double newReferenceExtent) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__REFERENCE_EXTENT, newReferenceExtent);
	}
	...
	public void unsetReferenceExtent() {
		eUnset(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__REFERENCE_EXTENT);
	}
	...
	public boolean isSetReferenceExtent() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__REFERENCE_EXTENT);
	}
	...
	public String getReferenceExtentAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__REFERENCE_EXTENT_AS_STRING, true);
	}
	...
	public void setReferenceExtentAsString(String newReferenceExtentAsString) {
		eSet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__REFERENCE_EXTENT_AS_STRING,
	...
	public void unsetReferenceExtentAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__REFERENCE_EXTENT_AS_STRING);
	}
	...
	public boolean isSetReferenceExtentAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MATERIAL_LAYER_SET_USAGE__REFERENCE_EXTENT_AS_STRING);
	}
