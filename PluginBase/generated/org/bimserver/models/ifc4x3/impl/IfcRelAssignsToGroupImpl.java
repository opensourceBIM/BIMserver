...
public class IfcRelAssignsToGroupImpl extends IfcRelAssignsImpl implements IfcRelAssignsToGroup {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelAssignsToGroup();
	}
	...
	public IfcGroup getRelatingGroup() {
		return (IfcGroup) eGet(Ifc4x3Package.eINSTANCE.getIfcRelAssignsToGroup_RelatingGroup(), true);
	}
	...
	public void setRelatingGroup(IfcGroup newRelatingGroup) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelAssignsToGroup_RelatingGroup(), newRelatingGroup);
	}
