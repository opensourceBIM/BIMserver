...
public class IfcPositioningElementImpl extends IfcProductImpl implements IfcPositioningElement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPositioningElement();
	}
	...
	public EList<IfcRelContainedInSpatialStructure> getContainedInStructure() {
		return (EList<IfcRelContainedInSpatialStructure>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcPositioningElement_ContainedInStructure(), true);
	}
	...
	public void unsetContainedInStructure() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPositioningElement_ContainedInStructure());
	}
	...
	public boolean isSetContainedInStructure() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPositioningElement_ContainedInStructure());
	}
	...
	public EList<IfcRelPositions> getPositions() {
		return (EList<IfcRelPositions>) eGet(Ifc4x3Package.eINSTANCE.getIfcPositioningElement_Positions(), true);
	}
	...
	public void unsetPositions() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPositioningElement_Positions());
	}
	...
	public boolean isSetPositions() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPositioningElement_Positions());
	}
