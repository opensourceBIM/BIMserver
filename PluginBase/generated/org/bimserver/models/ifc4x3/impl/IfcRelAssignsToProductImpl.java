...
public class IfcRelAssignsToProductImpl extends IfcRelAssignsImpl implements IfcRelAssignsToProduct {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelAssignsToProduct();
	}
	...
	public IfcProductSelect getRelatingProduct() {
		return (IfcProductSelect) eGet(Ifc4x3Package.eINSTANCE.getIfcRelAssignsToProduct_RelatingProduct(), true);
	}
	...
	public void setRelatingProduct(IfcProductSelect newRelatingProduct) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelAssignsToProduct_RelatingProduct(), newRelatingProduct);
	}
