...
public class IfcPropertyEnumeratedValueImpl extends IfcSimplePropertyImpl implements IfcPropertyEnumeratedValue {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_PROPERTY_ENUMERATED_VALUE;
	}
	...
	public EList<IfcValue> getEnumerationValues() {
		return (EList<IfcValue>) eGet(Ifc4x3Package.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_VALUES, true);
	}
	...
	public boolean isSetEnumerationValues() {
		return eIsSet(Ifc4x3Package.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_VALUES);
	}
	...
	public IfcPropertyEnumeration getEnumerationReference() {
		return (IfcPropertyEnumeration) eGet(
				Ifc4x3Package.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_REFERENCE, true);
	}
	...
	public void setEnumerationReference(IfcPropertyEnumeration newEnumerationReference) {
		eSet(Ifc4x3Package.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_REFERENCE, newEnumerationReference);
	}
	...
	public void unsetEnumerationReference() {
		eUnset(Ifc4x3Package.Literals.IFC_PROPERTY_ENUMERATED_VALUE__ENUMERATION_REFERENCE);
	}
