...
public class IfcRelCoversBldgElementsImpl extends IfcRelConnectsImpl implements IfcRelCoversBldgElements {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelCoversBldgElements();
	}
	...
	public IfcElement getRelatingBuildingElement() {
		return (IfcElement) eGet(Ifc4x3Package.eINSTANCE.getIfcRelCoversBldgElements_RelatingBuildingElement(), true);
	}
	...
	public void setRelatingBuildingElement(IfcElement newRelatingBuildingElement) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelCoversBldgElements_RelatingBuildingElement(), newRelatingBuildingElement);
	}
	...
	public EList<IfcCovering> getRelatedCoverings() {
		return (EList<IfcCovering>) eGet(Ifc4x3Package.eINSTANCE.getIfcRelCoversBldgElements_RelatedCoverings(), true);
	}
