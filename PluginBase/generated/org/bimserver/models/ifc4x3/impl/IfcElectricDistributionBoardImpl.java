...
public class IfcElectricDistributionBoardImpl extends IfcFlowControllerImpl implements IfcElectricDistributionBoard {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcElectricDistributionBoard();
	}
	...
	public IfcElectricDistributionBoardTypeEnum getPredefinedType() {
		return (IfcElectricDistributionBoardTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcElectricDistributionBoard_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcElectricDistributionBoardTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcElectricDistributionBoard_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcElectricDistributionBoard_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcElectricDistributionBoard_PredefinedType());
	}
