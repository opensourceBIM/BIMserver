...
public class IfcChimneyImpl extends IfcBuiltElementImpl implements IfcChimney {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcChimney();
	}
	...
	public IfcChimneyTypeEnum getPredefinedType() {
		return (IfcChimneyTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcChimney_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcChimneyTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcChimney_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcChimney_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcChimney_PredefinedType());
	}
