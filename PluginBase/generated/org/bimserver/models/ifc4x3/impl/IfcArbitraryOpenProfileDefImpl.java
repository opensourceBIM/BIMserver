...
public class IfcArbitraryOpenProfileDefImpl extends IfcProfileDefImpl implements IfcArbitraryOpenProfileDef {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcArbitraryOpenProfileDef();
	}
	...
	public IfcBoundedCurve getCurve() {
		return (IfcBoundedCurve) eGet(Ifc4x3Package.eINSTANCE.getIfcArbitraryOpenProfileDef_Curve(), true);
	}
	...
	public void setCurve(IfcBoundedCurve newCurve) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcArbitraryOpenProfileDef_Curve(), newCurve);
	}
