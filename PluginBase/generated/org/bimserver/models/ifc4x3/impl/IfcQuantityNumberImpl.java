...
public class IfcQuantityNumberImpl extends IfcPhysicalSimpleQuantityImpl implements IfcQuantityNumber {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER;
	}
	...
	public double getNumberValue() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER__NUMBER_VALUE, true);
	}
	...
	public void setNumberValue(double newNumberValue) {
		eSet(Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER__NUMBER_VALUE, newNumberValue);
	}
	...
	public String getNumberValueAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER__NUMBER_VALUE_AS_STRING, true);
	}
	...
	public void setNumberValueAsString(String newNumberValueAsString) {
		eSet(Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER__NUMBER_VALUE_AS_STRING, newNumberValueAsString);
	}
	...
	public String getFormula() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER__FORMULA, true);
	}
	...
	public void setFormula(String newFormula) {
		eSet(Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER__FORMULA, newFormula);
	}
	...
	public void unsetFormula() {
		eUnset(Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER__FORMULA);
	}
	...
	public boolean isSetFormula() {
		return eIsSet(Ifc4x3Package.Literals.IFC_QUANTITY_NUMBER__FORMULA);
	}
