...
public class IfcStructuralCurveActionImpl extends IfcStructuralActionImpl implements IfcStructuralCurveAction {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcStructuralCurveAction();
	}
	...
	public IfcProjectedOrTrueLengthEnum getProjectedOrTrue() {
		return (IfcProjectedOrTrueLengthEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcStructuralCurveAction_ProjectedOrTrue(), true);
	}
	...
	public void setProjectedOrTrue(IfcProjectedOrTrueLengthEnum newProjectedOrTrue) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcStructuralCurveAction_ProjectedOrTrue(), newProjectedOrTrue);
	}
	...
	public void unsetProjectedOrTrue() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcStructuralCurveAction_ProjectedOrTrue());
	}
	...
	public boolean isSetProjectedOrTrue() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcStructuralCurveAction_ProjectedOrTrue());
	}
	...
	public IfcStructuralCurveActivityTypeEnum getPredefinedType() {
		return (IfcStructuralCurveActivityTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcStructuralCurveAction_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcStructuralCurveActivityTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcStructuralCurveAction_PredefinedType(), newPredefinedType);
	}
