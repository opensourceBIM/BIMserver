...
public class IfcBuildingImpl extends IfcFacilityImpl implements IfcBuilding {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_BUILDING;
	}
	...
	public double getElevationOfRefHeight() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT, true);
	}
	...
	public void setElevationOfRefHeight(double newElevationOfRefHeight) {
		eSet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT, newElevationOfRefHeight);
	}
	...
	public void unsetElevationOfRefHeight() {
		eUnset(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT);
	}
	...
	public boolean isSetElevationOfRefHeight() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT);
	}
	...
	public String getElevationOfRefHeightAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT_AS_STRING, true);
	}
	...
	public void setElevationOfRefHeightAsString(String newElevationOfRefHeightAsString) {
		eSet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT_AS_STRING, newElevationOfRefHeightAsString);
	}
	...
	public void unsetElevationOfRefHeightAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT_AS_STRING);
	}
	...
	public boolean isSetElevationOfRefHeightAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT_AS_STRING);
	}
	...
	public double getElevationOfTerrain() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN, true);
	}
	...
	public void setElevationOfTerrain(double newElevationOfTerrain) {
		eSet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN, newElevationOfTerrain);
	}
	...
	public void unsetElevationOfTerrain() {
		eUnset(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN);
	}
	...
	public boolean isSetElevationOfTerrain() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN);
	}
	...
	public String getElevationOfTerrainAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN_AS_STRING, true);
	}
	...
	public void setElevationOfTerrainAsString(String newElevationOfTerrainAsString) {
		eSet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN_AS_STRING, newElevationOfTerrainAsString);
	}
	...
	public boolean isSetElevationOfTerrainAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN_AS_STRING);
	}
	...
	public IfcPostalAddress getBuildingAddress() {
		return (IfcPostalAddress) eGet(Ifc4x3Package.Literals.IFC_BUILDING__BUILDING_ADDRESS, true);
	}
	...
	public void setBuildingAddress(IfcPostalAddress newBuildingAddress) {
		eSet(Ifc4x3Package.Literals.IFC_BUILDING__BUILDING_ADDRESS, newBuildingAddress);
	}
	...
	public void unsetBuildingAddress() {
		eUnset(Ifc4x3Package.Literals.IFC_BUILDING__BUILDING_ADDRESS);
	}
	...
	public boolean isSetBuildingAddress() {
		return eIsSet(Ifc4x3Package.Literals.IFC_BUILDING__BUILDING_ADDRESS);
	}
