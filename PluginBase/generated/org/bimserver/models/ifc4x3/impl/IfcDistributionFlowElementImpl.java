...
public class IfcDistributionFlowElementImpl extends IfcDistributionElementImpl implements IfcDistributionFlowElement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcDistributionFlowElement();
	}
	...
	public EList<IfcRelFlowControlElements> getHasControlElements() {
		return (EList<IfcRelFlowControlElements>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcDistributionFlowElement_HasControlElements(), true);
	}
	...
	public void unsetHasControlElements() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcDistributionFlowElement_HasControlElements());
	}
	...
	public boolean isSetHasControlElements() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcDistributionFlowElement_HasControlElements());
	}
