...
public class IfcTankImpl extends IfcFlowStorageDeviceImpl implements IfcTank {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcTank();
	}
	...
	public IfcTankTypeEnum getPredefinedType() {
		return (IfcTankTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcTank_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcTankTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcTank_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcTank_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcTank_PredefinedType());
	}
