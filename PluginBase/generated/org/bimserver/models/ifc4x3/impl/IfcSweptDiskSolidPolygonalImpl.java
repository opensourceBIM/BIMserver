...
public class IfcSweptDiskSolidPolygonalImpl extends IfcSweptDiskSolidImpl implements IfcSweptDiskSolidPolygonal {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal();
	}
	...
	public double getFilletRadius() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal_FilletRadius(), true);
	}
	...
	public void setFilletRadius(double newFilletRadius) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal_FilletRadius(), newFilletRadius);
	}
	...
	public void unsetFilletRadius() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal_FilletRadius());
	}
	...
	public boolean isSetFilletRadius() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal_FilletRadius());
	}
	...
	public String getFilletRadiusAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal_FilletRadiusAsString(), true);
	}
	...
	public void setFilletRadiusAsString(String newFilletRadiusAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal_FilletRadiusAsString(), newFilletRadiusAsString);
	}
	...
	public void unsetFilletRadiusAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal_FilletRadiusAsString());
	}
	...
	public boolean isSetFilletRadiusAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSweptDiskSolidPolygonal_FilletRadiusAsString());
	}
