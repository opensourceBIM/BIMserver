...
public class IfcVectorImpl extends IfcGeometricRepresentationItemImpl implements IfcVector {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_VECTOR;
	}
	...
	public IfcDirection getOrientation() {
		return (IfcDirection) eGet(Ifc4x3Package.Literals.IFC_VECTOR__ORIENTATION, true);
	}
	...
	public void setOrientation(IfcDirection newOrientation) {
		eSet(Ifc4x3Package.Literals.IFC_VECTOR__ORIENTATION, newOrientation);
	}
	...
	public double getMagnitude() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_VECTOR__MAGNITUDE, true);
	}
	...
	public void setMagnitude(double newMagnitude) {
		eSet(Ifc4x3Package.Literals.IFC_VECTOR__MAGNITUDE, newMagnitude);
	}
	...
	public String getMagnitudeAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_VECTOR__MAGNITUDE_AS_STRING, true);
	}
	...
	public void setMagnitudeAsString(String newMagnitudeAsString) {
		eSet(Ifc4x3Package.Literals.IFC_VECTOR__MAGNITUDE_AS_STRING, newMagnitudeAsString);
	}
	...
	@Override
	public long getDim() {
		return (Long) eGet(Ifc4x3Package.Literals.IFC_VECTOR__DIM, true);
	}
	...
	public void setDim(long newDim) {
		eSet(Ifc4x3Package.Literals.IFC_VECTOR__DIM, newDim);
	}
	...
	public void unsetDim() {
		eUnset(Ifc4x3Package.Literals.IFC_VECTOR__DIM);
	}
	...
	public boolean isSetDim() {
		return eIsSet(Ifc4x3Package.Literals.IFC_VECTOR__DIM);
	}
