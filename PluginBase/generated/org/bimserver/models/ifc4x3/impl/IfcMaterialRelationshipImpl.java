...
public class IfcMaterialRelationshipImpl extends IfcResourceLevelRelationshipImpl implements IfcMaterialRelationship {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcMaterialRelationship();
	}
	...
	public IfcMaterial getRelatingMaterial() {
		return (IfcMaterial) eGet(Ifc4x3Package.eINSTANCE.getIfcMaterialRelationship_RelatingMaterial(), true);
	}
	...
	public void setRelatingMaterial(IfcMaterial newRelatingMaterial) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMaterialRelationship_RelatingMaterial(), newRelatingMaterial);
	}
	...
	public EList<IfcMaterial> getRelatedMaterials() {
		return (EList<IfcMaterial>) eGet(Ifc4x3Package.eINSTANCE.getIfcMaterialRelationship_RelatedMaterials(), true);
	}
	...
	public String getMaterialExpression() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcMaterialRelationship_MaterialExpression(), true);
	}
	...
	public void setMaterialExpression(String newMaterialExpression) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMaterialRelationship_MaterialExpression(), newMaterialExpression);
	}
	...
	public void unsetMaterialExpression() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcMaterialRelationship_MaterialExpression());
	}
	...
	public boolean isSetMaterialExpression() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcMaterialRelationship_MaterialExpression());
	}
