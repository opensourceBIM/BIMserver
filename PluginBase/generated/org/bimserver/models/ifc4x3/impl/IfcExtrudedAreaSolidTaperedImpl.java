...
public class IfcExtrudedAreaSolidTaperedImpl extends IfcExtrudedAreaSolidImpl implements IfcExtrudedAreaSolidTapered {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcExtrudedAreaSolidTapered();
	}
	...
	public IfcProfileDef getEndSweptArea() {
		return (IfcProfileDef) eGet(Ifc4x3Package.eINSTANCE.getIfcExtrudedAreaSolidTapered_EndSweptArea(), true);
	}
	...
	public void setEndSweptArea(IfcProfileDef newEndSweptArea) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcExtrudedAreaSolidTapered_EndSweptArea(), newEndSweptArea);
	}
