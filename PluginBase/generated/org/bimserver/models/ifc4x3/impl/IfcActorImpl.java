...
public class IfcActorImpl extends IfcObjectImpl implements IfcActor {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcActor();
	}
	...
	public IfcActorSelect getTheActor() {
		return (IfcActorSelect) eGet(Ifc4x3Package.eINSTANCE.getIfcActor_TheActor(), true);
	}
	...
	public void setTheActor(IfcActorSelect newTheActor) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcActor_TheActor(), newTheActor);
	}
	...
	public EList<IfcRelAssignsToActor> getIsActingUpon() {
		return (EList<IfcRelAssignsToActor>) eGet(Ifc4x3Package.eINSTANCE.getIfcActor_IsActingUpon(), true);
	}
	...
	public void unsetIsActingUpon() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcActor_IsActingUpon());
	}
	...
	public boolean isSetIsActingUpon() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcActor_IsActingUpon());
	}
