...
public class IfcElectricFlowTreatmentDeviceImpl extends IfcFlowTreatmentDeviceImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcElectricFlowTreatmentDevice();
	}
	...
	public IfcElectricFlowTreatmentDeviceTypeEnum getPredefinedType() {
		return (IfcElectricFlowTreatmentDeviceTypeEnum) eGet(
				Ifc4x3Package.eINSTANCE.getIfcElectricFlowTreatmentDevice_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcElectricFlowTreatmentDeviceTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcElectricFlowTreatmentDevice_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcElectricFlowTreatmentDevice_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcElectricFlowTreatmentDevice_PredefinedType());
	}
