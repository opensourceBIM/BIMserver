...
public class IfcDistributionBoardTypeImpl extends IfcFlowControllerTypeImpl implements IfcDistributionBoardType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcDistributionBoardType();
	}
	...
	public IfcDistributionBoardTypeEnum getPredefinedType() {
		return (IfcDistributionBoardTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcDistributionBoardType_PredefinedType(),
				true);
	}
	...
	public void setPredefinedType(IfcDistributionBoardTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcDistributionBoardType_PredefinedType(), newPredefinedType);
	}
