...
public class IfcBoxedHalfSpaceImpl extends IfcHalfSpaceSolidImpl implements IfcBoxedHalfSpace {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcBoxedHalfSpace();
	}
	...
	public IfcBoundingBox getEnclosure() {
		return (IfcBoundingBox) eGet(Ifc4x3Package.eINSTANCE.getIfcBoxedHalfSpace_Enclosure(), true);
	}
	...
	public void setEnclosure(IfcBoundingBox newEnclosure) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcBoxedHalfSpace_Enclosure(), newEnclosure);
	}
