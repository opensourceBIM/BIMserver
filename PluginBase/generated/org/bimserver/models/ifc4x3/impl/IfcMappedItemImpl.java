 ...
 * </p>
 * <ul>
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcMappedItemImpl#getMappingSource <em>Mapping Source</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4x3.impl.IfcMappedItemImpl#getMappingTarget <em>Mapping Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfcMappedItemImpl extends IfcRepresentationItemImpl implements IfcMappedItem {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_MAPPED_ITEM;
	}
	...
	public IfcRepresentationMap getMappingSource() {
		return (IfcRepresentationMap) eGet(Ifc4x3Package.Literals.IFC_MAPPED_ITEM__MAPPING_SOURCE, true);
	}
	...
	public void setMappingSource(IfcRepresentationMap newMappingSource) {
		eSet(Ifc4x3Package.Literals.IFC_MAPPED_ITEM__MAPPING_SOURCE, newMappingSource);
	}
	...
	public IfcCartesianTransformationOperator getMappingTarget() {
		return (IfcCartesianTransformationOperator) eGet(Ifc4x3Package.Literals.IFC_MAPPED_ITEM__MAPPING_TARGET, true);
	}
	...
	public void setMappingTarget(IfcCartesianTransformationOperator newMappingTarget) {
		eSet(Ifc4x3Package.Literals.IFC_MAPPED_ITEM__MAPPING_TARGET, newMappingTarget);
	}
