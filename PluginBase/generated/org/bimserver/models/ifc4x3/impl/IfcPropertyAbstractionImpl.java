...
public class IfcPropertyAbstractionImpl extends IdEObjectImpl implements IfcPropertyAbstraction {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPropertyAbstraction();
	}
	...
	public EList<IfcExternalReferenceRelationship> getHasExternalReferences() {
		return (EList<IfcExternalReferenceRelationship>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcPropertyAbstraction_HasExternalReferences(), true);
	}
	...
	public void unsetHasExternalReferences() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPropertyAbstraction_HasExternalReferences());
	}
	...
	public boolean isSetHasExternalReferences() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPropertyAbstraction_HasExternalReferences());
	}
