...
public class IfcOffsetCurveByDistancesImpl extends IfcOffsetCurveImpl implements IfcOffsetCurveByDistances {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcOffsetCurveByDistances();
	}
	...
	public EList<IfcPointByDistanceExpression> getOffsetValues() {
		return (EList<IfcPointByDistanceExpression>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcOffsetCurveByDistances_OffsetValues(), true);
	}
	...
	public String getTag() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcOffsetCurveByDistances_Tag(), true);
	}
	...
	public void setTag(String newTag) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcOffsetCurveByDistances_Tag(), newTag);
	}
	...
	public void unsetTag() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcOffsetCurveByDistances_Tag());
	}
	...
	public boolean isSetTag() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcOffsetCurveByDistances_Tag());
	}
