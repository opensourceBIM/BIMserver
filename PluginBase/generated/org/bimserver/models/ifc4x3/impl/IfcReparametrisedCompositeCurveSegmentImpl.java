...
public class IfcReparametrisedCompositeCurveSegmentImpl extends IfcCompositeCurveSegmentImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcReparametrisedCompositeCurveSegment();
	}
	...
	public double getParamLength() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcReparametrisedCompositeCurveSegment_ParamLength(), true);
	}
	...
	public void setParamLength(double newParamLength) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcReparametrisedCompositeCurveSegment_ParamLength(), newParamLength);
	}
	...
	public String getParamLengthAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcReparametrisedCompositeCurveSegment_ParamLengthAsString(),
				true);
	}
	...
	public void setParamLengthAsString(String newParamLengthAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcReparametrisedCompositeCurveSegment_ParamLengthAsString(),
