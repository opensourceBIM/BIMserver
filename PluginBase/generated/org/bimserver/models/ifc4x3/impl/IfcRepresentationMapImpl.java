...
public class IfcRepresentationMapImpl extends IdEObjectImpl implements IfcRepresentationMap {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP;
	}
	...
	public IfcAxis2Placement getMappingOrigin() {
		return (IfcAxis2Placement) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__MAPPING_ORIGIN, true);
	}
	...
	public void setMappingOrigin(IfcAxis2Placement newMappingOrigin) {
		eSet(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__MAPPING_ORIGIN, newMappingOrigin);
	}
	...
	public IfcRepresentation getMappedRepresentation() {
		return (IfcRepresentation) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__MAPPED_REPRESENTATION, true);
	}
	...
	public EList<IfcShapeAspect> getHasShapeAspects() {
		return (EList<IfcShapeAspect>) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__HAS_SHAPE_ASPECTS, true);
	}
	...
	public void unsetHasShapeAspects() {
		eUnset(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__HAS_SHAPE_ASPECTS);
	}
	...
	public boolean isSetHasShapeAspects() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__HAS_SHAPE_ASPECTS);
	}
	...
	public EList<IfcMappedItem> getMapUsage() {
		return (EList<IfcMappedItem>) eGet(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__MAP_USAGE, true);
	}
	...
	public void unsetMapUsage() {
		eUnset(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__MAP_USAGE);
	}
	...
	public boolean isSetMapUsage() {
		return eIsSet(Ifc4x3Package.Literals.IFC_REPRESENTATION_MAP__MAP_USAGE);
	}
