...
public class IfcRelConnectsPortsImpl extends IfcRelConnectsImpl implements IfcRelConnectsPorts {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts();
	}
	...
	public IfcPort getRelatingPort() {
		return (IfcPort) eGet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts_RelatingPort(), true);
	}
	...
	public void setRelatingPort(IfcPort newRelatingPort) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts_RelatingPort(), newRelatingPort);
	}
	...
	public IfcPort getRelatedPort() {
		return (IfcPort) eGet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts_RelatedPort(), true);
	}
	...
	public void setRelatedPort(IfcPort newRelatedPort) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts_RelatedPort(), newRelatedPort);
	}
	...
	public IfcElement getRealizingElement() {
		return (IfcElement) eGet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts_RealizingElement(), true);
	}
	...
	public void setRealizingElement(IfcElement newRealizingElement) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts_RealizingElement(), newRealizingElement);
	}
	...
	public void unsetRealizingElement() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts_RealizingElement());
	}
	...
	public boolean isSetRealizingElement() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRelConnectsPorts_RealizingElement());
	}
