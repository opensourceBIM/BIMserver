...
public class IfcStructuralLoadConfigurationImpl extends IfcStructuralLoadImpl
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcStructuralLoadConfiguration();
	}
	...
	public EList<IfcStructuralLoadOrResult> getValues() {
		return (EList<IfcStructuralLoadOrResult>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcStructuralLoadConfiguration_Values(), true);
	}
	...
	public EList<ListOfIfcLengthMeasure> getLocations() {
		return (EList<ListOfIfcLengthMeasure>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcStructuralLoadConfiguration_Locations(), true);
	}
