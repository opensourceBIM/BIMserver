...
public class IfcIndexedColourMapImpl extends IfcPresentationItemImpl implements IfcIndexedColourMap {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap();
	}
	...
	public IfcTessellatedFaceSet getMappedTo() {
		return (IfcTessellatedFaceSet) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_MappedTo(), true);
	}
	...
	public void setMappedTo(IfcTessellatedFaceSet newMappedTo) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_MappedTo(), newMappedTo);
	}
	...
	public double getOpacity() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_Opacity(), true);
	}
	...
	public void setOpacity(double newOpacity) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_Opacity(), newOpacity);
	}
	...
	public void unsetOpacity() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_Opacity());
	}
	...
	public boolean isSetOpacity() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_Opacity());
	}
	...
	public String getOpacityAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_OpacityAsString(), true);
	}
	...
	public void setOpacityAsString(String newOpacityAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_OpacityAsString(), newOpacityAsString);
	}
	...
	public void unsetOpacityAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_OpacityAsString());
	}
	...
	public boolean isSetOpacityAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_OpacityAsString());
	}
	...
	public IfcColourRgbList getColours() {
		return (IfcColourRgbList) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_Colours(), true);
	}
	...
	public void setColours(IfcColourRgbList newColours) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_Colours(), newColours);
	}
	...
	public EList<Long> getColourIndex() {
		return (EList<Long>) eGet(Ifc4x3Package.eINSTANCE.getIfcIndexedColourMap_ColourIndex(), true);
	}
