...
public class IfcVirtualGridIntersectionImpl extends IdEObjectImpl implements IfcVirtualGridIntersection {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcVirtualGridIntersection();
	}
	...
	public EList<IfcGridAxis> getIntersectingAxes() {
		return (EList<IfcGridAxis>) eGet(Ifc4x3Package.eINSTANCE.getIfcVirtualGridIntersection_IntersectingAxes(),
				true);
	}
	...
	public EList<Double> getOffsetDistances() {
		return (EList<Double>) eGet(Ifc4x3Package.eINSTANCE.getIfcVirtualGridIntersection_OffsetDistances(), true);
	}
	...
	public EList<String> getOffsetDistancesAsString() {
		return (EList<String>) eGet(Ifc4x3Package.eINSTANCE.getIfcVirtualGridIntersection_OffsetDistancesAsString(),
				true);
	}
