...
public class IfcPileImpl extends IfcDeepFoundationImpl implements IfcPile {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPile();
	}
	...
	public IfcPileTypeEnum getPredefinedType() {
		return (IfcPileTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcPile_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcPileTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPile_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPile_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPile_PredefinedType());
	}
	...
	public IfcPileConstructionEnum getConstructionType() {
		return (IfcPileConstructionEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcPile_ConstructionType(), true);
	}
	...
	public void setConstructionType(IfcPileConstructionEnum newConstructionType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPile_ConstructionType(), newConstructionType);
	}
	...
	public void unsetConstructionType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPile_ConstructionType());
	}
	...
	public boolean isSetConstructionType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPile_ConstructionType());
	}
