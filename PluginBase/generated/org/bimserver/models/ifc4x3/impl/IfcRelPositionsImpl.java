...
public class IfcRelPositionsImpl extends IfcRelConnectsImpl implements IfcRelPositions {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRelPositions();
	}
	...
	public IfcPositioningElement getRelatingPositioningElement() {
		return (IfcPositioningElement) eGet(Ifc4x3Package.eINSTANCE.getIfcRelPositions_RelatingPositioningElement(),
				true);
	}
	...
	public void setRelatingPositioningElement(IfcPositioningElement newRelatingPositioningElement) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRelPositions_RelatingPositioningElement(), newRelatingPositioningElement);
	}
	...
	public EList<IfcProduct> getRelatedProducts() {
		return (EList<IfcProduct>) eGet(Ifc4x3Package.eINSTANCE.getIfcRelPositions_RelatedProducts(), true);
	}
