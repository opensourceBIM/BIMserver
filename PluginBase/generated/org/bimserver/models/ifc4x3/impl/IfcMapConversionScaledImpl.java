...
public class IfcMapConversionScaledImpl extends IfcMapConversionImpl implements IfcMapConversionScaled {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled();
	}
	...
	public double getFactorX() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorX(), true);
	}
	...
	public void setFactorX(double newFactorX) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorX(), newFactorX);
	}
	...
	public String getFactorXAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorXAsString(), true);
	}
	...
	public void setFactorXAsString(String newFactorXAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorXAsString(), newFactorXAsString);
	}
	...
	public double getFactorY() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorY(), true);
	}
	...
	public void setFactorY(double newFactorY) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorY(), newFactorY);
	}
	...
	public String getFactorYAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorYAsString(), true);
	}
	...
	public void setFactorYAsString(String newFactorYAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorYAsString(), newFactorYAsString);
	}
	...
	public double getFactorZ() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorZ(), true);
	}
	...
	public void setFactorZ(double newFactorZ) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorZ(), newFactorZ);
	}
	...
	public String getFactorZAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorZAsString(), true);
	}
	...
	public void setFactorZAsString(String newFactorZAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcMapConversionScaled_FactorZAsString(), newFactorZAsString);
	}
