...
public class IfcColumnImpl extends IfcBuiltElementImpl implements IfcColumn {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcColumn();
	}
	...
	public IfcColumnTypeEnum getPredefinedType() {
		return (IfcColumnTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcColumn_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcColumnTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcColumn_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcColumn_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcColumn_PredefinedType());
	}
