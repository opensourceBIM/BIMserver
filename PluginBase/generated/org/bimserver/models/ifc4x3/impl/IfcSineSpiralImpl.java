...
public class IfcSineSpiralImpl extends IfcSpiralImpl implements IfcSineSpiral {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSineSpiral();
	}
	...
	public double getSineTerm() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_SineTerm(), true);
	}
	...
	public void setSineTerm(double newSineTerm) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_SineTerm(), newSineTerm);
	}
	...
	public String getSineTermAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_SineTermAsString(), true);
	}
	...
	public void setSineTermAsString(String newSineTermAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_SineTermAsString(), newSineTermAsString);
	}
	...
	public double getLinearTerm() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_LinearTerm(), true);
	}
	...
	public void setLinearTerm(double newLinearTerm) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_LinearTerm(), newLinearTerm);
	}
	...
	public void unsetLinearTerm() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_LinearTerm());
	}
	...
	public boolean isSetLinearTerm() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_LinearTerm());
	}
	...
	public String getLinearTermAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_LinearTermAsString(), true);
	}
	...
	public void setLinearTermAsString(String newLinearTermAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_LinearTermAsString(), newLinearTermAsString);
	}
	...
	public void unsetLinearTermAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_LinearTermAsString());
	}
	...
	public boolean isSetLinearTermAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_LinearTermAsString());
	}
	...
	public double getConstantTerm() {
		return (Double) eGet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_ConstantTerm(), true);
	}
	...
	public void setConstantTerm(double newConstantTerm) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_ConstantTerm(), newConstantTerm);
	}
	...
	public void unsetConstantTerm() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_ConstantTerm());
	}
	...
	public boolean isSetConstantTerm() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_ConstantTerm());
	}
	...
	public String getConstantTermAsString() {
		return (String) eGet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_ConstantTermAsString(), true);
	}
	...
	public void setConstantTermAsString(String newConstantTermAsString) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_ConstantTermAsString(), newConstantTermAsString);
	}
	...
	public void unsetConstantTermAsString() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_ConstantTermAsString());
	}
	...
	public boolean isSetConstantTermAsString() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcSineSpiral_ConstantTermAsString());
	}
