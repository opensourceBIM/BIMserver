...
public class IfcRailwayPartImpl extends IfcFacilityPartImpl implements IfcRailwayPart {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRailwayPart();
	}
	...
	public IfcRailwayPartTypeEnum getPredefinedType() {
		return (IfcRailwayPartTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcRailwayPart_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcRailwayPartTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRailwayPart_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRailwayPart_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRailwayPart_PredefinedType());
	}
