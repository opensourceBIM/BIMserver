...
public class IfcColourRgbImpl extends IfcColourSpecificationImpl implements IfcColourRgb {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_COLOUR_RGB;
	}
	...
	public double getRed() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__RED, true);
	}
	...
	public void setRed(double newRed) {
		eSet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__RED, newRed);
	}
	...
	public String getRedAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__RED_AS_STRING, true);
	}
	...
	public void setRedAsString(String newRedAsString) {
		eSet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__RED_AS_STRING, newRedAsString);
	}
	...
	public double getGreen() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__GREEN, true);
	}
	...
	public void setGreen(double newGreen) {
		eSet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__GREEN, newGreen);
	}
	...
	public String getGreenAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__GREEN_AS_STRING, true);
	}
	...
	public void setGreenAsString(String newGreenAsString) {
		eSet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__GREEN_AS_STRING, newGreenAsString);
	}
	...
	public double getBlue() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__BLUE, true);
	}
	...
	public void setBlue(double newBlue) {
		eSet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__BLUE, newBlue);
	}
	...
	public String getBlueAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__BLUE_AS_STRING, true);
	}
	...
	public void setBlueAsString(String newBlueAsString) {
		eSet(Ifc4x3Package.Literals.IFC_COLOUR_RGB__BLUE_AS_STRING, newBlueAsString);
	}
