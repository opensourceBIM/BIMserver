...
public class IfcRoofImpl extends IfcBuiltElementImpl implements IfcRoof {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcRoof();
	}
	...
	public IfcRoofTypeEnum getPredefinedType() {
		return (IfcRoofTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcRoof_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcRoofTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcRoof_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcRoof_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcRoof_PredefinedType());
	}
