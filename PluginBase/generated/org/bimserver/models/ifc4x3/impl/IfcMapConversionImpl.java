...
public class IfcMapConversionImpl extends IfcCoordinateOperationImpl implements IfcMapConversion {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_MAP_CONVERSION;
	}
	...
	public double getEastings() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__EASTINGS, true);
	}
	...
	public void setEastings(double newEastings) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__EASTINGS, newEastings);
	}
	...
	public String getEastingsAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__EASTINGS_AS_STRING, true);
	}
	...
	public void setEastingsAsString(String newEastingsAsString) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__EASTINGS_AS_STRING, newEastingsAsString);
	}
	...
	public double getNorthings() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__NORTHINGS, true);
	}
	...
	public void setNorthings(double newNorthings) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__NORTHINGS, newNorthings);
	}
	...
	public String getNorthingsAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__NORTHINGS_AS_STRING, true);
	}
	...
	public void setNorthingsAsString(String newNorthingsAsString) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__NORTHINGS_AS_STRING, newNorthingsAsString);
	}
	...
	public double getOrthogonalHeight() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__ORTHOGONAL_HEIGHT, true);
	}
	...
	public void setOrthogonalHeight(double newOrthogonalHeight) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__ORTHOGONAL_HEIGHT, newOrthogonalHeight);
	}
	...
	public String getOrthogonalHeightAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__ORTHOGONAL_HEIGHT_AS_STRING, true);
	}
	...
	public double getXAxisAbscissa() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ABSCISSA, true);
	}
	...
	public void setXAxisAbscissa(double newXAxisAbscissa) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ABSCISSA, newXAxisAbscissa);
	}
	...
	public void unsetXAxisAbscissa() {
		eUnset(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ABSCISSA);
	}
	...
	public boolean isSetXAxisAbscissa() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ABSCISSA);
	}
	...
	public String getXAxisAbscissaAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ABSCISSA_AS_STRING, true);
	}
	...
	public void setXAxisAbscissaAsString(String newXAxisAbscissaAsString) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ABSCISSA_AS_STRING, newXAxisAbscissaAsString);
	}
	...
	public void unsetXAxisAbscissaAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ABSCISSA_AS_STRING);
	}
	...
	public boolean isSetXAxisAbscissaAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ABSCISSA_AS_STRING);
	}
	...
	public double getXAxisOrdinate() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ORDINATE, true);
	}
	...
	public void setXAxisOrdinate(double newXAxisOrdinate) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ORDINATE, newXAxisOrdinate);
	}
	...
	public void unsetXAxisOrdinate() {
		eUnset(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ORDINATE);
	}
	...
	public boolean isSetXAxisOrdinate() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ORDINATE);
	}
	...
	public String getXAxisOrdinateAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ORDINATE_AS_STRING, true);
	}
	...
	public void setXAxisOrdinateAsString(String newXAxisOrdinateAsString) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ORDINATE_AS_STRING, newXAxisOrdinateAsString);
	}
	...
	public void unsetXAxisOrdinateAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ORDINATE_AS_STRING);
	}
	...
	public boolean isSetXAxisOrdinateAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__XAXIS_ORDINATE_AS_STRING);
	}
	...
	public double getScale() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__SCALE, true);
	}
	...
	public void setScale(double newScale) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__SCALE, newScale);
	}
	...
	public void unsetScale() {
		eUnset(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__SCALE);
	}
	...
	public boolean isSetScale() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__SCALE);
	}
	...
	public String getScaleAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__SCALE_AS_STRING, true);
	}
	...
	public void setScaleAsString(String newScaleAsString) {
		eSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__SCALE_AS_STRING, newScaleAsString);
	}
	...
	public boolean isSetScaleAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_MAP_CONVERSION__SCALE_AS_STRING);
	}
