...
public class IfcSignalTypeImpl extends IfcFlowTerminalTypeImpl implements IfcSignalType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcSignalType();
	}
	...
	public IfcSignalTypeEnum getPredefinedType() {
		return (IfcSignalTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcSignalType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcSignalTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcSignalType_PredefinedType(), newPredefinedType);
	}
