...
public class IfcHeatExchangerImpl extends IfcEnergyConversionDeviceImpl implements IfcHeatExchanger {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcHeatExchanger();
	}
	...
	public IfcHeatExchangerTypeEnum getPredefinedType() {
		return (IfcHeatExchangerTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcHeatExchanger_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcHeatExchangerTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcHeatExchanger_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcHeatExchanger_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcHeatExchanger_PredefinedType());
	}
