...
public class IfcPavementImpl extends IfcBuiltElementImpl implements IfcPavement {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcPavement();
	}
	...
	public IfcPavementTypeEnum getPredefinedType() {
		return (IfcPavementTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcPavement_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcPavementTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcPavement_PredefinedType(), newPredefinedType);
	}
	...
	public void unsetPredefinedType() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcPavement_PredefinedType());
	}
	...
	public boolean isSetPredefinedType() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcPavement_PredefinedType());
	}
