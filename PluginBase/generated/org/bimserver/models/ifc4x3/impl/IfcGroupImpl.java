...
public class IfcGroupImpl extends IfcObjectImpl implements IfcGroup {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcGroup();
	}
	...
	public EList<IfcRelAssignsToGroup> getIsGroupedBy() {
		return (EList<IfcRelAssignsToGroup>) eGet(Ifc4x3Package.eINSTANCE.getIfcGroup_IsGroupedBy(), true);
	}
	...
	public void unsetIsGroupedBy() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcGroup_IsGroupedBy());
	}
	...
	public boolean isSetIsGroupedBy() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcGroup_IsGroupedBy());
	}
	...
	public EList<IfcRelReferencedInSpatialStructure> getReferencedInStructures() {
		return (EList<IfcRelReferencedInSpatialStructure>) eGet(
				Ifc4x3Package.eINSTANCE.getIfcGroup_ReferencedInStructures(), true);
	}
	...
	public void unsetReferencedInStructures() {
		eUnset(Ifc4x3Package.eINSTANCE.getIfcGroup_ReferencedInStructures());
	}
	...
	public boolean isSetReferencedInStructures() {
		return eIsSet(Ifc4x3Package.eINSTANCE.getIfcGroup_ReferencedInStructures());
	}
