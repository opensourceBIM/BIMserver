...
public class IfcCableSegmentTypeImpl extends IfcFlowSegmentTypeImpl implements IfcCableSegmentType {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.eINSTANCE.getIfcCableSegmentType();
	}
	...
	public IfcCableSegmentTypeEnum getPredefinedType() {
		return (IfcCableSegmentTypeEnum) eGet(Ifc4x3Package.eINSTANCE.getIfcCableSegmentType_PredefinedType(), true);
	}
	...
	public void setPredefinedType(IfcCableSegmentTypeEnum newPredefinedType) {
		eSet(Ifc4x3Package.eINSTANCE.getIfcCableSegmentType_PredefinedType(), newPredefinedType);
	}
