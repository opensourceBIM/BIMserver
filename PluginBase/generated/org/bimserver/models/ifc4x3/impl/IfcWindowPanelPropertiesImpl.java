...
public class IfcWindowPanelPropertiesImpl extends IfcPreDefinedPropertySetImpl implements IfcWindowPanelProperties {
	...
	protected EClass eStaticClass() {
		return Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES;
	}
	...
	public IfcWindowPanelOperationEnum getOperationType() {
		return (IfcWindowPanelOperationEnum) eGet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__OPERATION_TYPE,
				true);
	}
	...
	public void setOperationType(IfcWindowPanelOperationEnum newOperationType) {
		eSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__OPERATION_TYPE, newOperationType);
	}
	...
	public IfcWindowPanelPositionEnum getPanelPosition() {
		return (IfcWindowPanelPositionEnum) eGet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__PANEL_POSITION,
				true);
	}
	...
	public void setPanelPosition(IfcWindowPanelPositionEnum newPanelPosition) {
		eSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__PANEL_POSITION, newPanelPosition);
	}
	...
	public double getFrameDepth() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_DEPTH, true);
	}
	...
	public void setFrameDepth(double newFrameDepth) {
		eSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_DEPTH, newFrameDepth);
	}
	...
	public void unsetFrameDepth() {
		eUnset(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_DEPTH);
	}
	...
	public boolean isSetFrameDepth() {
		return eIsSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_DEPTH);
	}
	...
	public String getFrameDepthAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_DEPTH_AS_STRING, true);
	}
	...
	public void setFrameDepthAsString(String newFrameDepthAsString) {
		eSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_DEPTH_AS_STRING, newFrameDepthAsString);
	}
	...
	public void unsetFrameDepthAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_DEPTH_AS_STRING);
	}
	...
	public boolean isSetFrameDepthAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_DEPTH_AS_STRING);
	}
	...
	public double getFrameThickness() {
		return (Double) eGet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_THICKNESS, true);
	}
	...
	public void setFrameThickness(double newFrameThickness) {
		eSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_THICKNESS, newFrameThickness);
	}
	...
	public void unsetFrameThickness() {
		eUnset(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_THICKNESS);
	}
	...
	public boolean isSetFrameThickness() {
		return eIsSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_THICKNESS);
	}
	...
	public String getFrameThicknessAsString() {
		return (String) eGet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_THICKNESS_AS_STRING, true);
	}
	...
	public void setFrameThicknessAsString(String newFrameThicknessAsString) {
		eSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_THICKNESS_AS_STRING, newFrameThicknessAsString);
	}
	...
	public void unsetFrameThicknessAsString() {
		eUnset(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_THICKNESS_AS_STRING);
	}
	...
	public boolean isSetFrameThicknessAsString() {
		return eIsSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__FRAME_THICKNESS_AS_STRING);
	}
	...
	public IfcShapeAspect getShapeAspectStyle() {
		return (IfcShapeAspect) eGet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE, true);
	}
	...
	public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
		eSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE, newShapeAspectStyle);
	}
	...
	public void unsetShapeAspectStyle() {
		eUnset(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
	...
	public boolean isSetShapeAspectStyle() {
		return eIsSet(Ifc4x3Package.Literals.IFC_WINDOW_PANEL_PROPERTIES__SHAPE_ASPECT_STYLE);
	}
