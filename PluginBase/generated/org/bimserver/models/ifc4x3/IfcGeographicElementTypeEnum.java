...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Geographic Element Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3.Ifc4x3Package#getIfcGeographicElementTypeEnum()
 * @model
 * @generated
 */
public enum IfcGeographicElementTypeEnum implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>SOIL BORING POINT</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #SOIL_BORING_POINT_VALUE
	 * @generated
	 * @ordered
	 */
	SOIL_BORING_POINT(3, "SOIL_BORING_POINT", "SOIL_BORING_POINT"),
	 ...
	 * @ordered
	 */
	VEGETATION(5, "VEGETATION", "VEGETATION");
	...
	/**
	 * The '<em><b>SOIL BORING POINT</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #SOIL_BORING_POINT
	 * @model
	 * @generated
	 * @ordered
	 */
	public static final int SOIL_BORING_POINT_VALUE = 3;
	 ...
	 * @ordered
	 */
	public static final int VEGETATION_VALUE = 5;
	...
	private static final IfcGeographicElementTypeEnum[] VALUES_ARRAY = new IfcGeographicElementTypeEnum[] { NULL,
			NOTDEFINED, TERRAIN, SOIL_BORING_POINT, USERDEFINED, VEGETATION, };
	...
	public static IfcGeographicElementTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcGeographicElementTypeEnum result = VALUES_ARRAY[i];
	...
	public static IfcGeographicElementTypeEnum get(int value) {
		...
		case TERRAIN_VALUE:
			return TERRAIN;
		case SOIL_BORING_POINT_VALUE:
			return SOIL_BORING_POINT;
	 ...
	 * @generated
	 */
	private IfcGeographicElementTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
