 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3.Ifc4x3Package#getIfcSpatialZoneTypeEnum()
 * @model
 * @generated
 */
public enum IfcSpatialZoneTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	RESERVATION(4, "RESERVATION", "RESERVATION"),
	 ...
	 * @ordered
	 */
	FIRESAFETY(5, "FIRESAFETY", "FIRESAFETY"),
	 ...
	 * @ordered
	 */
	CONSTRUCTION(6, "CONSTRUCTION", "CONSTRUCTION"),
	 ...
	 * @ordered
	 */
	INTERFERENCE(8, "INTERFERENCE", "INTERFERENCE"),
	 ...
	 * @ordered
	 */
	OCCUPANCY(12, "OCCUPANCY", "OCCUPANCY");
	 ...
	 * @ordered
	 */
	public static final int FIRESAFETY_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int CONSTRUCTION_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int INTERFERENCE_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int LIGHTING_VALUE = 9;
	 ...
	 * @ordered
	 */
	public static final int THERMAL_VALUE = 11;
	 ...
	 * @ordered
	 */
	public static final int OCCUPANCY_VALUE = 12;
	...
	private static final IfcSpatialZoneTypeEnum[] VALUES_ARRAY = new IfcSpatialZoneTypeEnum[] { NULL, TRANSPORT,
			NOTDEFINED, VENTILATION, RESERVATION, FIRESAFETY, CONSTRUCTION, SECURITY, INTERFERENCE, LIGHTING,
			USERDEFINED, THERMAL, OCCUPANCY, };
