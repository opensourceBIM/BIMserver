...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Electric Distribution Board Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3.Ifc4x3Package#getIfcElectricDistributionBoardTypeEnum()
 * @model
 * @generated
 */
public enum IfcElectricDistributionBoardTypeEnum implements Enumerator {
	/**
	...
	public static IfcElectricDistributionBoardTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcElectricDistributionBoardTypeEnum result = VALUES_ARRAY[i];
