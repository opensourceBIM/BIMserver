...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Space Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4x3.Ifc4x3Package#getIfcSpaceTypeEnum()
 * @model
 * @generated
 */
public enum IfcSpaceTypeEnum implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int BERTH_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int GFA_VALUE = 4;
	 ...
	 * @generated
	 */
	private static final IfcSpaceTypeEnum[] VALUES_ARRAY = new IfcSpaceTypeEnum[] { NULL, SPACE, BERTH, NOTDEFINED, GFA,
	...
	public static IfcSpaceTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcSpaceTypeEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private IfcSpaceTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
