...
public class IfcIsothermalMoistureCapacityMeasureImpl extends IdEObjectImpl
	...
	public double getWrappedValue() {
		return (Double) eGet(Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE, true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE, newWrappedValue);
	}
