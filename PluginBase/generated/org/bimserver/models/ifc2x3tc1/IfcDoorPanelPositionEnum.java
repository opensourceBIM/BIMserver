...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Door Panel Position Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc2x3tc1.Ifc2x3tc1Package#getIfcDoorPanelPositionEnum()
 * @model
 * @generated
 */
public enum IfcDoorPanelPositionEnum implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final IfcDoorPanelPositionEnum[] VALUES_ARRAY = new IfcDoorPanelPositionEnum[] { NULL, NOTDEFINED, LEFT, RIGHT, MIDDLE, };
	...
	/**
	 * Returns the '<em><b>Ifc Door Panel Position Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Ifc Door Panel Position Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	private IfcDoorPanelPositionEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
