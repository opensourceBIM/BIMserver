...
@XmlRootElement
public class SInternalServicePluginConfiguration extends SPluginConfiguration implements SDataBase
{
	private long oid = -1;
	private UUID uuid;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SInternalServicePluginConfiguration.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SInternalServicePluginConfiguration other = (SInternalServicePluginConfiguration) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
