...
@XmlRootElement
public class SDeserializerPluginConfiguration extends SPluginConfiguration implements SDataBase
{
	private long oid = -1;
	private UUID uuid;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SDeserializerPluginConfiguration.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SDeserializerPluginConfiguration other = (SDeserializerPluginConfiguration) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
