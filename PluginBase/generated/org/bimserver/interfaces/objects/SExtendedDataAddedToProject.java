...
@XmlRootElement
public class SExtendedDataAddedToProject extends SLogAction implements SDataBase
{
	private long oid = -1;
	private UUID uuid;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SExtendedDataAddedToProject.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SExtendedDataAddedToProject other = (SExtendedDataAddedToProject) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
