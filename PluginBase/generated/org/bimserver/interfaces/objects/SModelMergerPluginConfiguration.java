...
@XmlRootElement
public class SModelMergerPluginConfiguration extends SPluginConfiguration implements SDataBase
{
	private long oid = -1;
	private UUID uuid;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SModelMergerPluginConfiguration.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SModelMergerPluginConfiguration other = (SModelMergerPluginConfiguration) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
