...
@XmlRootElement
@XmlSeeAlso(value={SNewCheckoutAdded.class})
public class SCheckoutRelated extends SLogAction implements SDataBase
{
	private long oid = -1;
	private UUID uuid;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SCheckoutRelated.sClass = sClass;
	}
	...
	public Object sGet(SField sField) {
		...
		if (sField.getName().equals("checkoutId")) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SCheckoutRelated other = (SCheckoutRelated) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
