...
public class SConverter {
	...
	public SGeometryData convertToSObject(GeometryData input) {
		...
		result.setType(input.getType());
		result.setNormalsQuantized(input.getNormalsQuantized());
		result.setVerticesQuantized(input.getVerticesQuantized());
		result.setColorsQuantized(input.getColorsQuantized());
