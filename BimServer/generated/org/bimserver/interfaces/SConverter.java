...
public class SConverter {
	...
	public LogAction convertFromSObject(SLogAction input, LogAction result, DatabaseSession session) throws BimserverDatabaseException {
		...
		if (input instanceof SDatabaseCreated) {
	...
	public SUserSettings convertToSObject(UserSettings input) {
		...
		result.setServices(listservices);
		List<Long> listmessagingSerializerPlugins = new ArrayList<Long>();
	...
	public SPluginConfiguration convertToSObject(PluginConfiguration input) {
		...
		if (input instanceof RenderEnginePluginConfiguration) {
	...
	public PluginConfiguration convertFromSObject(SPluginConfiguration input, PluginConfiguration result, DatabaseSession session) throws BimserverDatabaseException {
		...
		if (input instanceof SRenderEnginePluginConfiguration) {
	...
	public Set<SModelCheckerPluginDescriptor> convertToSSetModelCheckerPluginDescriptor(Collection<ModelCheckerPluginDescriptor> input) {
		Set<SModelCheckerPluginDescriptor> result = new HashSet<SModelCheckerPluginDescriptor>();
	...
	public Set<ModelCheckerPluginDescriptor> convertFromSSetModelCheckerPluginDescriptor(Collection<SModelCheckerPluginDescriptor> input, DatabaseSession session) throws BimserverDatabaseException {
		Set<ModelCheckerPluginDescriptor> result = new HashSet<ModelCheckerPluginDescriptor>();
	...
	public List<SModelCheckerPluginDescriptor> convertToSListModelCheckerPluginDescriptor(Collection<ModelCheckerPluginDescriptor> input) {
		List<SModelCheckerPluginDescriptor> result = new ArrayList<SModelCheckerPluginDescriptor>();
		for (ModelCheckerPluginDescriptor o : input) {
			result.add(convertToSObject(o));
		}
		return result;
	...
	public List<ModelCheckerPluginDescriptor> convertFromSListModelCheckerPluginDescriptor(Collection<SModelCheckerPluginDescriptor> input, DatabaseSession session) throws BimserverDatabaseException {
		List<ModelCheckerPluginDescriptor> result = new ArrayList<ModelCheckerPluginDescriptor>();
		for (SModelCheckerPluginDescriptor o : input) {
			result.add(convertFromSObject(o, session));
		}
		return result;
	...
	public Set<SPluginVersion> convertToSSetPluginVersion(Collection<PluginVersion> input) {
		Set<SPluginVersion> result = new HashSet<SPluginVersion>();
		for (PluginVersion o : input) {
			result.add(convertToSObject(o));
		}
		return result;
	}

	public Set<PluginVersion> convertFromSSetPluginVersion(Collection<SPluginVersion> input, DatabaseSession session) throws BimserverDatabaseException {
		Set<PluginVersion> result = new HashSet<PluginVersion>();
		for (SPluginVersion o : input) {
			result.add(convertFromSObject(o, session));
		}
		return result;
	}

	public List<SPluginVersion> convertToSListPluginVersion(Collection<PluginVersion> input) {
		List<SPluginVersion> result = new ArrayList<SPluginVersion>();
		for (PluginVersion o : input) {
			result.add(convertToSObject(o));
		}
		return result;
	...
	public List<PluginVersion> convertFromSListPluginVersion(Collection<SPluginVersion> input, DatabaseSession session) throws BimserverDatabaseException {
		List<PluginVersion> result = new ArrayList<PluginVersion>();
		for (SPluginVersion o : input) {
			result.add(convertFromSObject(o, session));
		}
		return result;
	...
	public SPluginVersion convertToSObject(PluginVersion input) {
		if (input == null) {
			return null;
		}
		
		SPluginVersion result = new SPluginVersion();
		result.setOid(input.getOid());
		result.setRid(input.getRid());
		result.setVersion(input.getVersion());
	...
	public PluginVersion convertFromSObject(SPluginVersion input, DatabaseSession session) throws BimserverDatabaseException {
		PluginVersion result = convertFromSObject(input, StoreFactory.eINSTANCE.createPluginVersion(), session);
	...
	public PluginVersion convertFromSObject(SPluginVersion input, PluginVersion result, DatabaseSession session) throws BimserverDatabaseException {
		if (input == null) {
			return null;
		}
		result.setVersion(input.getVersion());
	...
	public Set<SPluginUpdateInformation> convertToSSetPluginUpdateInformation(Collection<PluginUpdateInformation> input) {
		Set<SPluginUpdateInformation> result = new HashSet<SPluginUpdateInformation>();
		for (PluginUpdateInformation o : input) {
			result.add(convertToSObject(o));
		}
		return result;
	}

	public Set<PluginUpdateInformation> convertFromSSetPluginUpdateInformation(Collection<SPluginUpdateInformation> input, DatabaseSession session) throws BimserverDatabaseException {
		Set<PluginUpdateInformation> result = new HashSet<PluginUpdateInformation>();
		for (SPluginUpdateInformation o : input) {
			result.add(convertFromSObject(o, session));
		}
		return result;
	}

	public List<SPluginUpdateInformation> convertToSListPluginUpdateInformation(Collection<PluginUpdateInformation> input) {
		List<SPluginUpdateInformation> result = new ArrayList<SPluginUpdateInformation>();
		for (PluginUpdateInformation o : input) {
			result.add(convertToSObject(o));
		}
		return result;
	...
	public List<PluginUpdateInformation> convertFromSListPluginUpdateInformation(Collection<SPluginUpdateInformation> input, DatabaseSession session) throws BimserverDatabaseException {
		List<PluginUpdateInformation> result = new ArrayList<PluginUpdateInformation>();
		for (SPluginUpdateInformation o : input) {
			result.add(convertFromSObject(o, session));
		}
		return result;
	...
	public SPluginUpdateInformation convertToSObject(PluginUpdateInformation input) {
		if (input == null) {
			return null;
		}
		
		SPluginUpdateInformation result = new SPluginUpdateInformation();
		result.setOid(input.getOid());
		result.setRid(input.getRid());
		result.setName(input.getName());
		PluginVersion currentVersionVal = input.getCurrentVersion();
		result.setCurrentVersionId(currentVersionVal == null ? -1 : currentVersionVal.getOid());
		List<Long> listavailableVersions = new ArrayList<Long>();
		for (PluginVersion v : input.getAvailableVersions()) {
			listavailableVersions.add(v.getOid());
		}
		result.setAvailableVersions(listavailableVersions);
		return result;
	}
	public PluginUpdateInformation convertFromSObject(SPluginUpdateInformation input, DatabaseSession session) throws BimserverDatabaseException {
		PluginUpdateInformation result = convertFromSObject(input, StoreFactory.eINSTANCE.createPluginUpdateInformation(), session);
	...
	public PluginUpdateInformation convertFromSObject(SPluginUpdateInformation input, PluginUpdateInformation result, DatabaseSession session) throws BimserverDatabaseException {
		if (input == null) {
			return null;
		}
		result.setName(input.getName());
		result.setCurrentVersion((PluginVersion)session.get(StorePackage.eINSTANCE.getPluginVersion(), input.getCurrentVersionId(), OldQuery.getDefault()));
		List<PluginVersion> listavailableVersions = result.getAvailableVersions();
		for (long oid : input.getAvailableVersions()) {
			listavailableVersions.add((PluginVersion)session.get(StorePackage.eINSTANCE.getPluginVersion(), oid, OldQuery.getDefault()));
		}
		return result;
	}
}