...
public class ProtocolBuffersServiceInterfaceImplementation implements org.bimserver.shared.ServiceInterface {
	...
	public java.util.List<org.bimserver.interfaces.objects.SUser> getAllNonAuthorizedUsersOfProject(java.lang.Long poid) {
		try {
			...
			for (ProtocolBuffersService.SUser val : originalList) {
				...
				v.setNotificationUrl(val.getNotificationUrl());
				realResult.add(v);
			}
		return realResult;
		} catch (Exception e) {}
	...
	public org.bimserver.shared.SSerializerPluginDescriptor getSerializerPluginDescriptor(java.lang.String type) {
		try {
	...
	public org.bimserver.interfaces.objects.SUser getLoggedInUser() {
		try {
			...
			ProtocolBuffersService.SUser val = response.getValue();
				...
				realResult.setNotificationUrl(val.getNotificationUrl());
			return realResult;
		} catch (Exception e) {}
		return null;
	}
	...
	public java.util.List<org.bimserver.interfaces.objects.SDeserializer> getAllDeserializers(java.lang.Boolean oid) {
		try {
	...
	public void registerNewRevisionListener() {
		try {
			RegisterNewRevisionListenerRequest.Builder requestBuilder = RegisterNewRevisionListenerRequest.newBuilder();
			RegisterNewRevisionListenerRequest request = requestBuilder.build();
			service.registerNewRevisionListener(rpcController, request);
		} catch (Exception e) {}
	}

	public void setHttpCallback(java.lang.Long uoid, java.lang.String address) {
		try {
			SetHttpCallbackRequest.Builder requestBuilder = SetHttpCallbackRequest.newBuilder();
			requestBuilder.setUoid(uoid);
			requestBuilder.setAddress(address);
			SetHttpCallbackRequest request = requestBuilder.build();
			service.setHttpCallback(rpcController, request);
		} catch (Exception e) {}
	}
