...
public class ProtocolBuffersServiceInterfaceImplementation implements org.bimserver.shared.ServiceInterface {
	...
	public java.lang.String checkout(long roid, org.bimserver.shared.ResultType resultType, boolean sync) {
		try {
	...
	public java.lang.String checkoutLastRevision(long poid, org.bimserver.shared.ResultType resultType, boolean sync) {
		try {
	...
	public java.lang.String downloadByOids(java.util.Set<java.lang.Long> roids, java.util.Set<java.lang.Long> oids, org.bimserver.shared.ResultType resultType, boolean sync) {
		try {
	...
	public java.lang.String downloadOfType(long roid, java.lang.String className, org.bimserver.shared.ResultType resultType, boolean sync) {
		try {
	...
	public java.lang.String downloadByGuids(java.util.Set<java.lang.Long> roids, java.util.Set<java.lang.String> guids, org.bimserver.shared.ResultType resultType, boolean sync) {
		try {
	...
	public java.lang.String downloadProjects(java.util.Set<java.lang.Long> roids, org.bimserver.shared.ResultType resultType, boolean sync) {
		try {
	...
	public org.bimserver.shared.SDownloadResult getDownloadData(java.lang.String actionID) {
		try {
	...
	public org.bimserver.shared.LongActionState getDownloadState(java.lang.String actionID) {
		try {
	...
	public long addUser(java.lang.String username, java.lang.String name, org.bimserver.interfaces.objects.SUserType type, boolean selfRegistration) {
		try {
			...
			Service.SUserType newEnum = Service.SUserType.values()[type.ordinal()];
			requestBuilder.setType(newEnum);
	...
	public void changeUserType(long uoid, org.bimserver.interfaces.objects.SUserType userType) {
		try {
			...
			Service.SUserType newEnum = Service.SUserType.values()[userType.ordinal()];
			requestBuilder.setUserType(newEnum);
	...
	public java.util.List<org.bimserver.interfaces.objects.SProject> getAllProjects() {
		try {
			...
			for (Service.SProject val : originalList) {
				...
				for (java.lang.Long o : val.getSubProjectsList()) {
					v.getSubProjects().add(o);
				}
				v.setOid(val.getOid());
				for (java.lang.Long o : val.getHasAuthorizedUsersList()) {
					v.getHasAuthorizedUsers().add(o);
				}
				for (java.lang.Long o : val.getConcreteRevisionsList()) {
					v.getConcreteRevisions().add(o);
				}
				for (java.lang.Long o : val.getRevisionsList()) {
					v.getRevisions().add(o);
				}
				v.setLastConcreteRevisionId(val.getLastConcreteRevisionId());
				v.setLastRevisionId(val.getLastRevisionId());
				for (java.lang.Long o : val.getCheckoutsList()) {
					v.getCheckouts().add(o);
				}
	...
	public java.util.List<org.bimserver.interfaces.objects.SUser> getAllUsers() {
		try {
			...
			for (Service.SUser val : originalList) {
				...
				v.setCreatedById(val.getCreatedById());
				for (java.lang.Long o : val.getHasRightsOnList()) {
					v.getHasRightsOn().add(o);
				}
...
//				}
	...
	public java.util.Set<org.bimserver.shared.ResultType> getEnabledResultTypes() {
		try {
			GetEnabledResultTypesRequest.Builder requestBuilder = GetEnabledResultTypesRequest.newBuilder();
			GetEnabledResultTypesRequest request = requestBuilder.build();
			GetEnabledResultTypesResponse response = service.getEnabledResultTypes(rpcController, request);
	...
	public java.util.Set<org.bimserver.shared.ResultType> getAllResultTypes() {
		try {
			GetAllResultTypesRequest.Builder requestBuilder = GetAllResultTypesRequest.newBuilder();
			GetAllResultTypesRequest request = requestBuilder.build();
			GetAllResultTypesResponse response = service.getAllResultTypes(rpcController, request);
			java.util.Set<org.bimserver.shared.ResultType> realResult = new HashSet<org.bimserver.shared.ResultType>();
			List<Service.ResultType> originalList = response.getValueList();
			for (Service.ResultType val : originalList) {
				realResult.add(org.bimserver.shared.ResultType.values()[val.ordinal()]);
	...
	public void sendCompareEmail(org.bimserver.shared.SCompareResult.SCompareType sCompareType, long poid, long roid1, long roid2, java.lang.String address) {
		try {
			SendCompareEmailRequest.Builder requestBuilder = SendCompareEmailRequest.newBuilder();
			Service.SCompareType newEnum = Service.SCompareType.values()[sCompareType.ordinal()];
			requestBuilder.setSCompareType(newEnum);
			requestBuilder.setPoid(poid);
	...
	public org.bimserver.shared.SCompareResult compare(long roid1, long roid2, org.bimserver.shared.SCompareResult.SCompareType sCompareType) {
		try {
	...
	public java.lang.String download(long roid, org.bimserver.shared.ResultType resultType, boolean sync) {
		try {
