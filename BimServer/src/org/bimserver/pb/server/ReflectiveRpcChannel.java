...
public class ReflectiveRpcChannel implements BlockingRpcChannel {
	...
	private Object convertObject(Map<Object, Object> convertedObjects, Descriptor descriptor, Object object) {
		...
		for (FieldDescriptor fieldDescriptor : descriptor.getFields()) {
			try {
				Method getMethod = clazz.getMethod("get" + StringUtils.firstUpperCase(fieldDescriptor.getName()));
				Object value = getMethod.invoke(object);
				if (value != null) {
					if (value.getClass().isPrimitive() || value.getClass() == String.class || value.getClass() == Long.class || value.getClass() == Float.class || value.getClass() == Integer.class) {
