...
public class Step0045 extends Migration {

	@Override
	public void migrate(Schema schema, DatabaseSession databaseSession) {
		EClass longActionState = schema.getEClass("store", "LongActionState");
		schema.createEAttribute(longActionState, "topicId", EcorePackage.eINSTANCE.getELong());
	...
	public String getDescription() {
		return "Added topicId to LongActionState";
	}
}