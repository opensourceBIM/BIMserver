...
public class Step0001 extends Migration {
	...
	public void migrate(Schema schema) {
		...
		revisionCheckouts.setEOpposite(checkoutCheckin);
	...
	private void createSIPrefixEnum() {
		...
		schema.createEEnumLiteral(siPrefixEnum, "metameter", 6);
	...
	private void createRevisionClass() {
		...
		schema.createEAttribute(revisionClass, "state", ecorePackage.getEInt(), Multiplicity.SINGLE);
		schema.createEReference(revisionClass, "lastClashes", clashClass, Multiplicity.MANY);
		schema.createEAttribute(revisionClass, "tag", ecorePackage.getEInt(), Multiplicity.SINGLE);
		schema.createEAttribute(revisionClass, "lastError", ecorePackage.getEInt(), Multiplicity.SINGLE);
	...
	private void createConcreteRevisionClass() {
		...
		schema.createEAttribute(concreteRevisionClass, "state", ecorePackage.getEInt(), Multiplicity.SINGLE);
	...
	private void createUserClass() {
		...
		userHasRightsOn = schema.createEReference(userClass, "hasRightsOn", projectClass, Multiplicity.SINGLE);
		schema.createEReference(userClass, "revisions", revisionClass, Multiplicity.MANY);
		schema.createEAttribute(userClass, "state", ecorePackage.getEInt(), Multiplicity.SINGLE);
		schema.createEAttribute(userClass, "createdOn", ecorePackage.getEInt(), Multiplicity.SINGLE);
		schema.createEReference(userClass, "createdBy", userClass, Multiplicity.SINGLE);
		schema.createEAttribute(userClass, "userType", ecorePackage.getEInt(), Multiplicity.SINGLE);
		schema.createEAttribute(userClass, "username", ecorePackage.getEInt(), Multiplicity.SINGLE);
		schema.createEAttribute(userClass, "lastSeen", ecorePackage.getEInt(), Multiplicity.SINGLE);
		schema.createEAttribute(userClass, "validationToken", ecorePackage.getEInt(), Multiplicity.SINGLE);
		schema.createEAttribute(userClass, "validationTokenCreated", ecorePackage.getEInt(), Multiplicity.SINGLE);
	}
