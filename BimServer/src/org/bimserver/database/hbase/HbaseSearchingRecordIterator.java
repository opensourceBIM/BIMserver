...
//
//public class HbaseSearchingRecordIterator implements RecordIterator {
//
//	private Scanner scanner;
//
//	public HbaseSearchingRecordIterator(HTable table, byte[] keyStart) {
//		try {
//			scanner = table.getScanner(new byte[][]{"value:".getBytes("UTF-8")}, keyStart);
