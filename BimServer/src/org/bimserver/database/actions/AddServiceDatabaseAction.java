...
public class AddServiceDatabaseAction extends AddDatabaseAction<EService> {

	private Authorization authorization;

	public AddServiceDatabaseAction(DatabaseSession databaseSession, AccessMethod accessMethod, Authorization authorization, EService eService) {
