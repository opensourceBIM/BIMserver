...
public abstract class BimDatabaseAction<T> {
	...
	public abstract T execute(BimDatabaseSession bimDatabaseSession)
	...
	private static boolean allModelsSameScale(Set<IfcModel> ifcModels,
			float foundPrefix) {
		for (IfcModel ifcModel : ifcModels) {
	...
	private static void setIfcAsymmetricIShapeProfileDef(IdEObject idEObject,
			float scale) {
		setIfcIShapeProfileDef(idEObject, scale);
	...
	private static void setIfcCenterLineProfileDef(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcChamferEdgeFeature(IdEObject idEObject,
			float scale) {
		setIfcEdgeFeature(idEObject, scale);
	...
	private static void setIfcDoorLiningProperties(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcDoorPanelProperties(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcGeneralProfileProperties(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcCircleHollowProfileDef(IdEObject idEObject,
			float scale) {
		setIfcCircleProfileDef(idEObject, scale);
	...
	private static void setIfcCraneRailAShapeProfileDef(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcCraneRailFShapeProfileDef(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcConnectionPointEccentricity(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcCurveStyleFontPattern(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcLightSourcePositional(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcMaterialLayerSetUsage(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcMechanicalConcreteMaterialProperties(
	...
	private static void setIfcMechanicalFastener(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcPermeableCoveringProperties(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcRectangleHollowProfileDef(IdEObject idEObject,
			float scale) {
		setIfcRectangleProfileDef(idEObject, scale);
	...
	private static void setIfcRectangleProfileDef(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcRectangularPyramid(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcReinforcementBarProperties(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcRelConnectsStructuralMember(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcRibPlateProfileProperties(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcRightCircularCylinder(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcRoundedEdgeFeature(IdEObject idEObject,
			float scale) {
		setIfcEdgeFeature(idEObject, scale);
	...
	private static void setIfcRoundedRectangleProfileDef(IdEObject idEObject,
			float scale) {
		setIfcRectangleProfileDef(idEObject, scale);
	...
	private static void setIfcSectionReinforcementProperties(
			IdEObject idEObject, float scale) {
	...
	private static void setIfcSlippageConnectionCondition(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcStructuralLoadSingleDisplacement(
			IdEObject idEObject, float scale) {
	...
	private static void setIfcStructuralProfileProperties(IdEObject idEObject,
			float scale) {
		setIfcGeneralProfileProperties(idEObject, scale);
	...
	private static void setIfcStructuralSurfaceMember(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcStructuralSurfaceMemberVarying(
			IdEObject idEObject, float scale) {
		setIfcStructuralSurfaceMember(idEObject, scale);
	...
	private static void setIfcSurfaceOfLinearExtrusion(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcTextStyleWithBoxCharacteristics(
			IdEObject idEObject, float scale) {
	...
	private static void setIfcTrapeziumProfileDef(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcVirtualGridIntersection(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcWindowLiningProperties(IdEObject idEObject,
			float scale) {
	...
	private static void setIfcWindowPanelProperties(IdEObject idEObject,
			float scale) {
	...
	private static void setLengthUnitMeasure(IfcModel model, SIPrefix prefix) {
		Map<Long, IdEObject> objects = model.getObjects();
		boolean prefixFound = false;
		for (IdEObject object : objects.values()) {
			if (object instanceof IfcProject) {
