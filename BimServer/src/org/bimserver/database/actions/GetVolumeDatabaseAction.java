...
public class GetVolumeDatabaseAction extends BimDatabaseAction<Double> {

	private BimServer bimServer;
	private long roid;
	private long oid;

	public GetVolumeDatabaseAction(BimServer bimServer, DatabaseSession databaseSession, AccessMethod accessMethod, long roid, long oid, Authorization authorization) {
