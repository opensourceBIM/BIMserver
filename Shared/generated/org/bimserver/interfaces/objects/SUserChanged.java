...
@XmlRootElement
public class SUserChanged extends SLogAction implements SBase
{
	private long oid = -1;
	private static final SClass sClass = new SClass("SUserChanged");
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SUserChanged other = (SUserChanged) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
