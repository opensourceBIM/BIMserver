...
@XmlRootElement
public class SNewUserAdded extends SUserRelated implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SNewUserAdded other = (SNewUserAdded) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
