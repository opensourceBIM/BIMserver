...
@XmlRootElement
@XmlSeeAlso(value={SProjectUndeleted.class, SProjectDeleted.class, SProjectUpdated.class, SNewProjectAdded.class})
public class SProjectRelated extends SLogAction implements SDataBase
{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SProjectRelated other = (SProjectRelated) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
