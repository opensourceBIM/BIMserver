...
@XmlRootElement
public class SModelCheckerPluginConfiguration extends SPluginConfiguration implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SModelCheckerPluginConfiguration.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SModelCheckerPluginConfiguration other = (SModelCheckerPluginConfiguration) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
