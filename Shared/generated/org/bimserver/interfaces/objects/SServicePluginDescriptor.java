...
@XmlRootElement
public class SServicePluginDescriptor extends SPluginDescriptor implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SServicePluginDescriptor.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SServicePluginDescriptor other = (SServicePluginDescriptor) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
