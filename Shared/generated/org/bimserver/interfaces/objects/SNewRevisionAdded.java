...
@XmlRootElement
public class SNewRevisionAdded extends SLogAction implements SBase
{
	private long oid;
	private static final SClass sClass = new SClass("SNewRevisionAdded");
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SNewRevisionAdded other = (SNewRevisionAdded) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
