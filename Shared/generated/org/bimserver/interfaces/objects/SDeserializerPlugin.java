...
@XmlRootElement
public class SDeserializerPlugin extends SPlugin implements SDataBase
{
	private long oid = -1;
	...
	public static void setSClass(SClass sClass) {
		SDeserializerPlugin.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SDeserializerPlugin other = (SDeserializerPlugin) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
