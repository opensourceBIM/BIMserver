...
@XmlRootElement
public class SModelComparePlugin extends SPlugin implements SDataBase
{
	private long oid = -1;
	...
	public static void setSClass(SClass sClass) {
		SModelComparePlugin.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SModelComparePlugin other = (SModelComparePlugin) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
