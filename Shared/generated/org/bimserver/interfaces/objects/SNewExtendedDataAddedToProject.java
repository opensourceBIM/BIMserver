...
@XmlRootElement
public class SNewExtendedDataAddedToProject extends SLogAction implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SNewExtendedDataAddedToProject.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SNewExtendedDataAddedToProject other = (SNewExtendedDataAddedToProject) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
