...
@XmlRootElement
public class SIfcEnginePluginDescriptor extends SPluginDescriptor implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SIfcEnginePluginDescriptor.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SIfcEnginePluginDescriptor other = (SIfcEnginePluginDescriptor) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
