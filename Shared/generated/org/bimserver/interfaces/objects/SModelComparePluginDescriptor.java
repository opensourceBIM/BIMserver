...
@XmlRootElement
public class SModelComparePluginDescriptor extends SPluginDescriptor implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SModelComparePluginDescriptor.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SModelComparePluginDescriptor other = (SModelComparePluginDescriptor) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
