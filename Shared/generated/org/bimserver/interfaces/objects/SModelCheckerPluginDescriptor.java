...
@XmlRootElement
public class SModelCheckerPluginDescriptor extends SPluginDescriptor implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SModelCheckerPluginDescriptor.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SModelCheckerPluginDescriptor other = (SModelCheckerPluginDescriptor) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
