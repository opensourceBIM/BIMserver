...
@XmlRootElement
public class SDeserializerPluginDescriptor extends SPluginDescriptor implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public SDeserializerPluginDescriptor() {
	}
	...
	public static void setSClass(SClass sClass) {
		SDeserializerPluginDescriptor.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SDeserializerPluginDescriptor other = (SDeserializerPluginDescriptor) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
