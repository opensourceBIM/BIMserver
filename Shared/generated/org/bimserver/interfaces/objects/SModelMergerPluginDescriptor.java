...
@XmlRootElement
public class SModelMergerPluginDescriptor extends SPluginDescriptor implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SModelMergerPluginDescriptor.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SModelMergerPluginDescriptor other = (SModelMergerPluginDescriptor) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
