...
@XmlRootElement
public class SNewGuidanceProviderUploaded extends SLogAction implements SBase
{
	private long oid = -1;
	private static final SClass sClass = new SClass("SNewGuidanceProviderUploaded");
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SNewGuidanceProviderUploaded other = (SNewGuidanceProviderUploaded) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
