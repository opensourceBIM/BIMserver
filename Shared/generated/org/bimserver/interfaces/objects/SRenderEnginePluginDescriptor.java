...
@XmlRootElement
public class SRenderEnginePluginDescriptor extends SPluginDescriptor implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SRenderEnginePluginDescriptor.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SRenderEnginePluginDescriptor other = (SRenderEnginePluginDescriptor) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
