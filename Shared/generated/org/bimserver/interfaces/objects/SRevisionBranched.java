...
@XmlRootElement
public class SRevisionBranched extends SLogAction implements SBase
{
	private long oid = -1;
	private static final SClass sClass = new SClass("SRevisionBranched");
	...
	static {
		...
		sClass.addField(new SField("oldrevisionId", long.class));
		sClass.addField(new SField("newrevisionId", long.class));
