...
@XmlRootElement
public class SUserDeleted extends SLogAction implements SBase
{
	private long oid;
	private static final SClass sClass = new SClass("SUserDeleted");
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SUserDeleted other = (SUserDeleted) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
