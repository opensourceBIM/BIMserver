...
@XmlRootElement
public class SProjectDeleted extends SLogAction implements SBase
{
	private long oid = -1;
	private static final SClass sClass = new SClass("SProjectDeleted");
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SProjectDeleted other = (SProjectDeleted) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
