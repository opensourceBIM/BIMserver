...
@XmlRootElement
public class SWebModulePluginDescriptor extends SPluginDescriptor implements SDataBase
{
	private long oid = -1;
	private int rid = 0;
	...
	public static void setSClass(SClass sClass) {
		SWebModulePluginDescriptor.sClass = sClass;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SWebModulePluginDescriptor other = (SWebModulePluginDescriptor) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
