...
@XmlRootElement
public class SSettingsSaved extends SLogAction implements SBase
{
	private long oid;
	private static final SClass sClass = new SClass("SSettingsSaved");
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SSettingsSaved other = (SSettingsSaved) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
