...
@XmlRootElement
public class SNewObjectIDMUploaded extends SLogAction implements SBase
{
	private long oid = -1;
	private static final SClass sClass = new SClass("SNewObjectIDMUploaded");
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SNewObjectIDMUploaded other = (SNewObjectIDMUploaded) obj;
		if (oid != other.oid)
			return false;
		return true;
	}
