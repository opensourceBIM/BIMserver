...
private Reflector reflector;
	...
	public void newLogAction(org.bimserver.interfaces.objects.SLogAction logAction, java.lang.String serviceIdentifier, java.lang.String profileIdentifer, org.bimserver.interfaces.objects.SToken token, java.lang.String apiUrl) throws org.bimserver.shared.exceptions.UserException, org.bimserver.shared.exceptions.ServerException {
		reflector.callMethod("NotificationInterface", "newLogAction", void.class, new KeyValuePair("logAction", logAction), new KeyValuePair("serviceIdentifier", serviceIdentifier), new KeyValuePair("profileIdentifer", profileIdentifer), new KeyValuePair("token", token), new KeyValuePair("apiUrl", apiUrl));
	}
