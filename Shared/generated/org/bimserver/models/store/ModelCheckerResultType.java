...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Model Checker Result Type</b></em>',
...
public enum ModelCheckerResultType implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>Model Checker Result Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public static ModelCheckerResultType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ModelCheckerResultType result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private ModelCheckerResultType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
