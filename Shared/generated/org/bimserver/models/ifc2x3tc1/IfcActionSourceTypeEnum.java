...
public enum IfcActionSourceTypeEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcActionSourceTypeEnum[] VALUES_ARRAY = new IfcActionSourceTypeEnum[] { NULL, NOTDEFINED, PRESTRESSING_P, SNOW_S, ERECTION, SETTLEMENT_U, IMPACT, LIVE_LOAD_Q, COMPLETION_G1, BUOYANCY,
			EARTHQUAKE_E, CURRENT, FIRE, WAVE, TEMPERATURE_T, ICE, CREEP, RAIN, PROPPING, SYSTEM_IMPERFECTION, TRANSPORT, IMPULSE, BRAKES, USERDEFINED, SHRINKAGE, DEAD_LOAD_G, WIND_W, LACK_OF_FIT, };
