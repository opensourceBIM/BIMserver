...
public enum IfcDerivedUnitEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	MODULUSOFSUBGRADEREACTIONUNIT(14, "MODULUSOFSUBGRADEREACTIONUNIT",
	 ...
	 * @ordered
	 */
	ROTATIONALSTIFFNESSUNIT(16, "ROTATIONALSTIFFNESSUNIT",
	 ...
	 * @ordered
	 */
	TEMPERATUREGRADIENTUNIT(20, "TEMPERATUREGRADIENTUNIT",
	 ...
	 * @ordered
	 */
	COMPOUNDPLANEANGLEUNIT(28, "COMPOUNDPLANEANGLEUNIT",
	 ...
	 * @ordered
	 */
	ISOTHERMALMOISTURECAPACITYUNIT(29, "ISOTHERMALMOISTURECAPACITYUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFROTATIONALSUBGRADEREACTIONUNIT(32,
	 ...
	 * @ordered
	 */
	MOISTUREDIFFUSIVITYUNIT(34, "MOISTUREDIFFUSIVITYUNIT",
	 ...
	 * @ordered
	 */
	SECTIONAREAINTEGRALUNIT(35, "SECTIONAREAINTEGRALUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFELASTICITYUNIT(36, "MODULUSOFELASTICITYUNIT",
	 ...
	 * @ordered
	 */
	LUMINOUSINTENSITYDISTRIBUTIONUNIT(43, "LUMINOUSINTENSITYDISTRIBUTIONUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFLINEARSUBGRADEREACTIONUNIT(46,
	 ...
	 * @ordered
	 */
	THERMALCONDUCTANCEUNIT(49, "THERMALCONDUCTANCEUNIT",
	...
	private static final IfcDerivedUnitEnum[] VALUES_ARRAY = new IfcDerivedUnitEnum[] {
			...
			TORQUEUNIT, THERMALRESISTANCEUNIT, SHEARMODULUSUNIT,
			MODULUSOFSUBGRADEREACTIONUNIT, DYNAMICVISCOSITYUNIT,
			ROTATIONALSTIFFNESSUNIT, MASSDENSITYUNIT, LINEARSTIFFNESSUNIT,
			VAPORPERMEABILITYUNIT, TEMPERATUREGRADIENTUNIT,
			ANGULARVELOCITYUNIT, CURVATUREUNIT, WARPINGMOMENTUNIT,
			ROTATIONALMASSUNIT, THERMALADMITTANCEUNIT, MASSFLOWRATEUNIT,
			SOUNDPOWERUNIT, COMPOUNDPLANEANGLEUNIT,
			...
			LINEARFORCEUNIT, LUMINOUSINTENSITYDISTRIBUTIONUNIT, PHUNIT,
			THERMALEXPANSIONCOEFFICIENTUNIT,
			MODULUSOFLINEARSUBGRADEREACTIONUNIT, WARPINGCONSTANTUNIT,
			USERDEFINED, THERMALCONDUCTANCEUNIT, };
