...
public enum IfcDerivedUnitEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	MODULUSOFROTATIONALSUBGRADEREACTIONUNIT(32, "MODULUSOFROTATIONALSUBGRADEREACTIONUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFLINEARSUBGRADEREACTIONUNIT(46, "MODULUSOFLINEARSUBGRADEREACTIONUNIT",
	...
	private static final IfcDerivedUnitEnum[] VALUES_ARRAY = new IfcDerivedUnitEnum[] { NULL, MOMENTOFINERTIAUNIT,
			...
			HEATINGVALUEUNIT, TORQUEUNIT, THERMALRESISTANCEUNIT, SHEARMODULUSUNIT, MODULUSOFSUBGRADEREACTIONUNIT,
			DYNAMICVISCOSITYUNIT, ROTATIONALSTIFFNESSUNIT, MASSDENSITYUNIT, LINEARSTIFFNESSUNIT, VAPORPERMEABILITYUNIT,
			TEMPERATUREGRADIENTUNIT, ANGULARVELOCITYUNIT, CURVATUREUNIT, WARPINGMOMENTUNIT, ROTATIONALMASSUNIT,
			THERMALADMITTANCEUNIT, MASSFLOWRATEUNIT, SOUNDPOWERUNIT, COMPOUNDPLANEANGLEUNIT,
			ISOTHERMALMOISTURECAPACITYUNIT, IONCONCENTRATIONUNIT, ACCELERATIONUNIT,
			MODULUSOFROTATIONALSUBGRADEREACTIONUNIT, PLANARFORCEUNIT, MOISTUREDIFFUSIVITYUNIT, SECTIONAREAINTEGRALUNIT,
			MODULUSOFELASTICITYUNIT, LINEARVELOCITYUNIT, MASSPERLENGTHUNIT, INTEGERCOUNTRATEUNIT, LINEARMOMENTUNIT,
			SOUNDPRESSUREUNIT, LINEARFORCEUNIT, LUMINOUSINTENSITYDISTRIBUTIONUNIT, PHUNIT,
			THERMALEXPANSIONCOEFFICIENTUNIT, MODULUSOFLINEARSUBGRADEREACTIONUNIT, WARPINGCONSTANTUNIT, USERDEFINED,
