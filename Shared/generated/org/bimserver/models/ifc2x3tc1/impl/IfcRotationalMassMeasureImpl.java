...
public class IfcRotationalMassMeasureImpl extends IdEObjectImpl implements
	...
	public double getWrappedValue() {
		return (Double) eGet(
				Ifc2x3tc1Package.Literals.IFC_ROTATIONAL_MASS_MEASURE__WRAPPED_VALUE,
				true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc2x3tc1Package.Literals.IFC_ROTATIONAL_MASS_MEASURE__WRAPPED_VALUE,
				newWrappedValue);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(
				Ifc2x3tc1Package.Literals.IFC_ROTATIONAL_MASS_MEASURE__WRAPPED_VALUE_AS_STRING,
				true);
	}
	...
	public void setWrappedValueAsString(String newWrappedValueAsString) {
		eSet(Ifc2x3tc1Package.Literals.IFC_ROTATIONAL_MASS_MEASURE__WRAPPED_VALUE_AS_STRING,
