...
public class IfcElementImpl extends IfcProductImpl implements IfcElement {
	...
	public EList<IfcRelConnectsStructuralElement> getHasStructuralMember() {
		return (EList<IfcRelConnectsStructuralElement>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__HAS_STRUCTURAL_MEMBER,
				true);
	}
	...
	public EList<IfcRelFillsElement> getFillsVoids() {
		return (EList<IfcRelFillsElement>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__FILLS_VOIDS, true);
	}
	...
	public EList<IfcRelConnectsElements> getConnectedTo() {
		return (EList<IfcRelConnectsElements>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__CONNECTED_TO, true);
	}
	...
	public EList<IfcRelCoversBldgElements> getHasCoverings() {
		return (EList<IfcRelCoversBldgElements>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__HAS_COVERINGS, true);
	}
	...
	public EList<IfcRelProjectsElement> getHasProjections() {
		return (EList<IfcRelProjectsElement>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__HAS_PROJECTIONS, true);
	}
	...
	public EList<IfcRelReferencedInSpatialStructure> getReferencedInStructures() {
		return (EList<IfcRelReferencedInSpatialStructure>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__REFERENCED_IN_STRUCTURES,
				true);
	}
	...
	public EList<IfcRelConnectsPortToElement> getHasPorts() {
		return (EList<IfcRelConnectsPortToElement>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__HAS_PORTS, true);
	}
	...
	public EList<IfcRelVoidsElement> getHasOpenings() {
		return (EList<IfcRelVoidsElement>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__HAS_OPENINGS, true);
	}
	...
	public EList<IfcRelConnectsWithRealizingElements> getIsConnectionRealization() {
		return (EList<IfcRelConnectsWithRealizingElements>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__IS_CONNECTION_REALIZATION,
				true);
	}
	...
	public EList<IfcRelSpaceBoundary> getProvidesBoundaries() {
		return (EList<IfcRelSpaceBoundary>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__PROVIDES_BOUNDARIES,
				true);
	}
	...
	public EList<IfcRelConnectsElements> getConnectedFrom() {
		return (EList<IfcRelConnectsElements>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__CONNECTED_FROM, true);
	}
	...
	public EList<IfcRelContainedInSpatialStructure> getContainedInStructure() {
		return (EList<IfcRelContainedInSpatialStructure>) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELEMENT__CONTAINED_IN_STRUCTURE,
				true);
	}
