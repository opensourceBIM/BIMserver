...
public class IfcElectricConductanceMeasureImpl extends IdEObjectImpl implements
	...
	public double getWrappedValue() {
		return (Double) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELECTRIC_CONDUCTANCE_MEASURE__WRAPPED_VALUE,
				true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc2x3tc1Package.Literals.IFC_ELECTRIC_CONDUCTANCE_MEASURE__WRAPPED_VALUE,
				newWrappedValue);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(
				Ifc2x3tc1Package.Literals.IFC_ELECTRIC_CONDUCTANCE_MEASURE__WRAPPED_VALUE_AS_STRING,
				true);
	}
