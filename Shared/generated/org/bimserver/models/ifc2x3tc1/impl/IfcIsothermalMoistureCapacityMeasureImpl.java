...
public class IfcIsothermalMoistureCapacityMeasureImpl extends IdEObjectImpl
	...
	public double getWrappedValue() {
		return (Double) eGet(
				Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE,
				true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE,
				newWrappedValue);
	}
	...
	public void unsetWrappedValue() {
		eUnset(Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE);
	}
	...
	public boolean isSetWrappedValue() {
		return eIsSet(Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(
				Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE_AS_STRING,
				true);
	}
	...
	public void unsetWrappedValueAsString() {
		eUnset(Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE_AS_STRING);
	}
	...
	public boolean isSetWrappedValueAsString() {
		return eIsSet(Ifc2x3tc1Package.Literals.IFC_ISOTHERMAL_MOISTURE_CAPACITY_MEASURE__WRAPPED_VALUE_AS_STRING);
	}
