 ...
 * @generated
 */
public class IfcCartesianTransformationOperator3DnonUniformImpl extends
		IfcCartesianTransformationOperator3DImpl implements
	...
	public double getScale2() {
		return (Double) eGet(
				Ifc2x3tc1Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR3_DNON_UNIFORM__SCALE2,
				true);
	}
	...
	public void setScale2(double newScale2) {
		eSet(Ifc2x3tc1Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR3_DNON_UNIFORM__SCALE2,
				newScale2);
	}
	...
	public String getScale2AsString() {
		return (String) eGet(
				Ifc2x3tc1Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR3_DNON_UNIFORM__SCALE2_AS_STRING,
				true);
	}
	...
	public double getScale3() {
		return (Double) eGet(
				Ifc2x3tc1Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR3_DNON_UNIFORM__SCALE3,
				true);
	}
	...
	public void setScale3(double newScale3) {
		eSet(Ifc2x3tc1Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR3_DNON_UNIFORM__SCALE3,
				newScale3);
	}
	...
	public String getScale3AsString() {
		return (String) eGet(
				Ifc2x3tc1Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR3_DNON_UNIFORM__SCALE3_AS_STRING,
				true);
	}
