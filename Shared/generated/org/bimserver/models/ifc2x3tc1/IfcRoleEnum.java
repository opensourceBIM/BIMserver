...
public enum IfcRoleEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcRoleEnum[] VALUES_ARRAY = new IfcRoleEnum[] { NULL, COSTENGINEER, COMISSIONINGENGINEER, BUILDINGOPERATOR, RESELLER, ENGINEER, ARCHITECT, PROJECTMANAGER, CLIENT, ELECTRICALENGINEER,
			CIVILENGINEER, SUPPLIER, CONTRACTOR, FIELDCONSTRUCTIONMANAGER, FACILITIESMANAGER, OWNER, CONSTRUCTIONMANAGER, STRUCTURALENGINEER, MECHANICALENGINEER, USERDEFINED, CONSULTANT, MANUFACTURER, SUBCONTRACTOR,
			BUILDINGOWNER, };
