...
public enum IfcCurrencyEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcCurrencyEnum[] VALUES_ARRAY = new IfcCurrencyEnum[] { NULL, CNY, JPY, KYD, TTD, LKR, MXN, XEU, CAD, ZAR, AUD, DEM, NOK, ILS, AES, FAK, PKR, BBD, THB, SCR, FKP, ATS, FIM, IDR, AED, PGK, GIP,
			QAR, BHD, BWP, BSD, IRP, DKK, SEK, MYR, FJD, DDP, GRX, KRW, JMD, EST, BGL, ZWD, CZK, FRF, KWD, VEB, VND, TRL, JOD, NZD, CLP, GBP, KES, CHF, EGL, MUR, SAR, BZD, INR, PTN, TWD, BMD, ITL, OMR, SGD, NLG, SKP,
			HKD, RUR, GMD, CYS, CBD, BRL, EUR, ICK, BEG, PHP, HUF, PLN, USD, MTL, LUF, BND, };
