 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcCondenserTypeEnum()
 * @model
 * @generated
 */
public enum IfcCondenserTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	WATERCOOLED(4, "WATERCOOLED", "WATERCOOLED"),
	 ...
	 * @ordered
	 */
	WATERCOOLEDSHELLTUBE(5, "WATERCOOLEDSHELLTUBE", "WATERCOOLEDSHELLTUBE"),
	 ...
	 * @ordered
	 */
	WATERCOOLEDTUBEINTUBE(6, "WATERCOOLEDTUBEINTUBE", "WATERCOOLEDTUBEINTUBE"),
	 ...
	 * @ordered
	 */
	WATERCOOLEDBRAZEDPLATE(8, "WATERCOOLEDBRAZEDPLATE",
	 ...
	 * @ordered
	 */
	AIRCOOLED(9, "AIRCOOLED", "AIRCOOLED");
	 ...
	 * @ordered
	 */
	public static final int WATERCOOLED_VALUE = 4;
	 ...
	 * @ordered
	 */
	public static final int WATERCOOLEDSHELLTUBE_VALUE = 5;
	 ...
	 * @ordered
	 */
	public static final int WATERCOOLEDTUBEINTUBE_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int WATERCOOLEDBRAZEDPLATE_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int AIRCOOLED_VALUE = 9;
	...
	private static final IfcCondenserTypeEnum[] VALUES_ARRAY = new IfcCondenserTypeEnum[] {
			NULL, EVAPORATIVECOOLED, NOTDEFINED, USERDEFINED, WATERCOOLED,
			WATERCOOLEDSHELLTUBE, WATERCOOLEDTUBEINTUBE, WATERCOOLEDSHELLCOIL,
