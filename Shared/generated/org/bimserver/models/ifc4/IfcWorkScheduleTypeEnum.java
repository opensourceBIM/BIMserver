...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Work Schedule Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcWorkScheduleTypeEnum()
 * @model
 * @generated
 */
public enum IfcWorkScheduleTypeEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Ifc Work Schedule Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final IfcWorkScheduleTypeEnum[] VALUES_ARRAY = new IfcWorkScheduleTypeEnum[] {
	...
	public static IfcWorkScheduleTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcWorkScheduleTypeEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private IfcWorkScheduleTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
