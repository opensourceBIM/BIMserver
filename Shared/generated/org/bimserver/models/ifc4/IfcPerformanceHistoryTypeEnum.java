...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Performance History Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcPerformanceHistoryTypeEnum()
 * @model
 * @generated
 */
public enum IfcPerformanceHistoryTypeEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Ifc Performance History Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final IfcPerformanceHistoryTypeEnum[] VALUES_ARRAY = new IfcPerformanceHistoryTypeEnum[] {
	...
	public static IfcPerformanceHistoryTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcPerformanceHistoryTypeEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private IfcPerformanceHistoryTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
