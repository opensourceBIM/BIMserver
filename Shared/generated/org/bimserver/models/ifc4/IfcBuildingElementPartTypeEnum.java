 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcBuildingElementPartTypeEnum()
 * @model
 * @generated
 */
public enum IfcBuildingElementPartTypeEnum implements Enumerator {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>PRECASTPANEL</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #PRECASTPANEL
	 ...
	 * @generated
	 */
	private static final IfcBuildingElementPartTypeEnum[] VALUES_ARRAY = new IfcBuildingElementPartTypeEnum[] {
			NULL, NOTDEFINED, PRECASTPANEL, USERDEFINED, INSULATION, };
	 ...
	 * @generated
	 */
	private IfcBuildingElementPartTypeEnum(int value, String name,
			String literal) {
		this.value = value;
		this.name = name;
