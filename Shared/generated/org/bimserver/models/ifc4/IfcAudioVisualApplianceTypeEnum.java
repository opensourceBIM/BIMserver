...
public enum IfcAudioVisualApplianceTypeEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcAudioVisualApplianceTypeEnum[] VALUES_ARRAY = new IfcAudioVisualApplianceTypeEnum[] {
			NULL, PROJECTOR, PLAYER, NOTDEFINED, RECEIVER, MICROPHONE, CAMERA,
			USERDEFINED, AMPLIFIER, TELEPHONE, DISPLAY, TUNER, SWITCHER,
			SPEAKER, };
	 ...
	 * @generated
	 */
	private IfcAudioVisualApplianceTypeEnum(int value, String name,
			String literal) {
		this.value = value;
		this.name = name;
