...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Event Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcEventTypeEnum()
 * @model
 * @generated
 */
public enum IfcEventTypeEnum implements Enumerator {
	/**
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>STARTEVENT</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #STARTEVENT
	 ...
	 * @generated
	 */
	public static IfcEventTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcEventTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Ifc Event Type Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static IfcEventTypeEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcEventTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Ifc Event Type Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static IfcEventTypeEnum get(int value) {
		switch (value) {
		case NULL_VALUE:
			return NULL;
	 ...
	 * @generated
	 */
	private IfcEventTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
