 ...
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getScheduleUsageAsString <em>Schedule Usage As String</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getScheduleStart <em>Schedule Start</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getScheduleFinish <em>Schedule Finish</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getScheduleContour <em>Schedule Contour</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getLevelingDelay <em>Leveling Delay</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getIsOverAllocated <em>Is Over Allocated</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getStatusTime <em>Status Time</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getActualWork <em>Actual Work</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getActualUsage <em>Actual Usage</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getActualUsageAsString <em>Actual Usage As String</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getActualStart <em>Actual Start</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getActualFinish <em>Actual Finish</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getRemainingWork <em>Remaining Work</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getRemainingUsage <em>Remaining Usage</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.IfcResourceTime#getRemainingUsageAsString <em>Remaining Usage As String</em>}</li>
