 ...
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcCableCarrierFittingTypeEnum()
 * @model
 * @generated
 */
public enum IfcCableCarrierFittingTypeEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcCableCarrierFittingTypeEnum[] VALUES_ARRAY = new IfcCableCarrierFittingTypeEnum[] {
			NULL, NOTDEFINED, TEE, REDUCER, CROSS, USERDEFINED, BEND, };
	 ...
	 * @generated
	 */
	private IfcCableCarrierFittingTypeEnum(int value, String name,
			String literal) {
		this.value = value;
		this.name = name;
