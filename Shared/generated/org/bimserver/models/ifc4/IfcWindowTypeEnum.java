...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Ifc Window Type Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.bimserver.models.ifc4.Ifc4Package#getIfcWindowTypeEnum()
 * @model
 * @generated
 */
public enum IfcWindowTypeEnum implements Enumerator {
	 ...
	 * @generated
	 */
	private static final IfcWindowTypeEnum[] VALUES_ARRAY = new IfcWindowTypeEnum[] {
			NULL, LIGHTDOME, WINDOW, NOTDEFINED, SKYLIGHT, USERDEFINED, };
	 ...
	 * @generated
	 */
	public static final List<IfcWindowTypeEnum> VALUES = Collections
	...
	public static IfcWindowTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IfcWindowTypeEnum result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private IfcWindowTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
