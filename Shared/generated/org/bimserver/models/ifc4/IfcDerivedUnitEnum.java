...
public enum IfcDerivedUnitEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	ROTATIONALFREQUENCYUNIT(5, "ROTATIONALFREQUENCYUNIT",
	 ...
	 * @ordered
	 */
	THERMALTRANSMITTANCEUNIT(6, "THERMALTRANSMITTANCEUNIT",
	 ...
	 * @ordered
	 */
	VOLUMETRICFLOWRATEUNIT(8, "VOLUMETRICFLOWRATEUNIT",
	 ...
	 * @ordered
	 */
	SPECIFICHEATCAPACITYUNIT(9, "SPECIFICHEATCAPACITYUNIT",
	 ...
	 * @ordered
	 */
	SOUNDPRESSURELEVELUNIT(11, "SOUNDPRESSURELEVELUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFSUBGRADEREACTIONUNIT(15, "MODULUSOFSUBGRADEREACTIONUNIT",
	 ...
	 * @ordered
	 */
	ROTATIONALSTIFFNESSUNIT(17, "ROTATIONALSTIFFNESSUNIT",
	 ...
	 * @ordered
	 */
	TEMPERATUREGRADIENTUNIT(22, "TEMPERATUREGRADIENTUNIT",
	 ...
	 * @ordered
	 */
	COMPOUNDPLANEANGLEUNIT(30, "COMPOUNDPLANEANGLEUNIT",
	 ...
	 * @ordered
	 */
	ISOTHERMALMOISTURECAPACITYUNIT(31, "ISOTHERMALMOISTURECAPACITYUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFROTATIONALSUBGRADEREACTIONUNIT(34,
	 ...
	 * @ordered
	 */
	MOISTUREDIFFUSIVITYUNIT(36, "MOISTUREDIFFUSIVITYUNIT",
	 ...
	 * @ordered
	 */
	SECTIONAREAINTEGRALUNIT(37, "SECTIONAREAINTEGRALUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFELASTICITYUNIT(38, "MODULUSOFELASTICITYUNIT",
	 ...
	 * @ordered
	 */
	LUMINOUSINTENSITYDISTRIBUTIONUNIT(45, "LUMINOUSINTENSITYDISTRIBUTIONUNIT",
	 ...
	 * @ordered
	 */
	THERMALEXPANSIONCOEFFICIENTUNIT(47, "THERMALEXPANSIONCOEFFICIENTUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFLINEARSUBGRADEREACTIONUNIT(49,
	 ...
	 * @ordered
	 */
	TEMPERATURERATEOFCHANGEUNIT(52, "TEMPERATURERATEOFCHANGEUNIT",
	 ...
	 * @ordered
	 */
	THERMALCONDUCTANCEUNIT(53, "THERMALCONDUCTANCEUNIT",
	 ...
	 * @generated
	 */
	private static final IfcDerivedUnitEnum[] VALUES_ARRAY = new IfcDerivedUnitEnum[] {
			NULL, MOMENTOFINERTIAUNIT, MOLECULARWEIGHTUNIT, SECTIONMODULUSUNIT,
			HEATFLUXDENSITYUNIT, ROTATIONALFREQUENCYUNIT,
			THERMALTRANSMITTANCEUNIT, KINEMATICVISCOSITYUNIT,
			VOLUMETRICFLOWRATEUNIT, SPECIFICHEATCAPACITYUNIT, HEATINGVALUEUNIT,
			SOUNDPRESSURELEVELUNIT, TORQUEUNIT, THERMALRESISTANCEUNIT,
			SHEARMODULUSUNIT, MODULUSOFSUBGRADEREACTIONUNIT,
			DYNAMICVISCOSITYUNIT, ROTATIONALSTIFFNESSUNIT, AREADENSITYUNIT,
			MASSDENSITYUNIT, LINEARSTIFFNESSUNIT, VAPORPERMEABILITYUNIT,
			TEMPERATUREGRADIENTUNIT, WARPINGMOMENTUNIT, ANGULARVELOCITYUNIT,
			CURVATUREUNIT, ROTATIONALMASSUNIT, THERMALADMITTANCEUNIT,
			MASSFLOWRATEUNIT, SOUNDPOWERUNIT, COMPOUNDPLANEANGLEUNIT,
			ISOTHERMALMOISTURECAPACITYUNIT, IONCONCENTRATIONUNIT,
			ACCELERATIONUNIT, MODULUSOFROTATIONALSUBGRADEREACTIONUNIT,
			PLANARFORCEUNIT, MOISTUREDIFFUSIVITYUNIT, SECTIONAREAINTEGRALUNIT,
			MODULUSOFELASTICITYUNIT, LINEARVELOCITYUNIT, MASSPERLENGTHUNIT,
			INTEGERCOUNTRATEUNIT, LINEARMOMENTUNIT, SOUNDPRESSUREUNIT,
			LINEARFORCEUNIT, LUMINOUSINTENSITYDISTRIBUTIONUNIT,
			SOUNDPOWERLEVELUNIT, THERMALEXPANSIONCOEFFICIENTUNIT, PHUNIT,
			MODULUSOFLINEARSUBGRADEREACTIONUNIT, WARPINGCONSTANTUNIT,
			USERDEFINED, TEMPERATURERATEOFCHANGEUNIT, THERMALCONDUCTANCEUNIT, };
	 ...
	 * @generated
	 */
	public static final List<IfcDerivedUnitEnum> VALUES = Collections
