...
public enum IfcDerivedUnitEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	MODULUSOFROTATIONALSUBGRADEREACTIONUNIT(34, "MODULUSOFROTATIONALSUBGRADEREACTIONUNIT",
	 ...
	 * @ordered
	 */
	MODULUSOFLINEARSUBGRADEREACTIONUNIT(49, "MODULUSOFLINEARSUBGRADEREACTIONUNIT",
	 ...
	 * @generated
	 */
	private static final IfcDerivedUnitEnum[] VALUES_ARRAY = new IfcDerivedUnitEnum[] { NULL, MOMENTOFINERTIAUNIT,
			MOLECULARWEIGHTUNIT, SECTIONMODULUSUNIT, HEATFLUXDENSITYUNIT, ROTATIONALFREQUENCYUNIT,
			THERMALTRANSMITTANCEUNIT, KINEMATICVISCOSITYUNIT, VOLUMETRICFLOWRATEUNIT, SPECIFICHEATCAPACITYUNIT,
			HEATINGVALUEUNIT, SOUNDPRESSURELEVELUNIT, TORQUEUNIT, THERMALRESISTANCEUNIT, SHEARMODULUSUNIT,
			MODULUSOFSUBGRADEREACTIONUNIT, DYNAMICVISCOSITYUNIT, ROTATIONALSTIFFNESSUNIT, AREADENSITYUNIT,
			MASSDENSITYUNIT, LINEARSTIFFNESSUNIT, VAPORPERMEABILITYUNIT, TEMPERATUREGRADIENTUNIT, WARPINGMOMENTUNIT,
			ANGULARVELOCITYUNIT, CURVATUREUNIT, ROTATIONALMASSUNIT, THERMALADMITTANCEUNIT, MASSFLOWRATEUNIT,
			SOUNDPOWERUNIT, COMPOUNDPLANEANGLEUNIT, ISOTHERMALMOISTURECAPACITYUNIT, IONCONCENTRATIONUNIT,
			ACCELERATIONUNIT, MODULUSOFROTATIONALSUBGRADEREACTIONUNIT, PLANARFORCEUNIT, MOISTUREDIFFUSIVITYUNIT,
			SECTIONAREAINTEGRALUNIT, MODULUSOFELASTICITYUNIT, LINEARVELOCITYUNIT, MASSPERLENGTHUNIT,
			INTEGERCOUNTRATEUNIT, LINEARMOMENTUNIT, SOUNDPRESSUREUNIT, LINEARFORCEUNIT,
			LUMINOUSINTENSITYDISTRIBUTIONUNIT, SOUNDPOWERLEVELUNIT, THERMALEXPANSIONCOEFFICIENTUNIT, PHUNIT,
			MODULUSOFLINEARSUBGRADEREACTIONUNIT, WARPINGCONSTANTUNIT, USERDEFINED, TEMPERATURERATEOFCHANGEUNIT,
