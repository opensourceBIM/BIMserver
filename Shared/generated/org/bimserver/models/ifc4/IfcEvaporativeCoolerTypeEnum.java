...
public enum IfcEvaporativeCoolerTypeEnum implements Enumerator {
	 ...
	 * @ordered
	 */
	INDIRECTDIRECTCOMBINATION(3, "INDIRECTDIRECTCOMBINATION",
	 ...
	 * @ordered
	 */
	DIRECTEVAPORATIVERIGIDMEDIAAIRCOOLER(4,
	 ...
	 * @ordered
	 */
	DIRECTEVAPORATIVESLINGERSPACKAGEDAIRCOOLER(5,
	 ...
	 * @ordered
	 */
	INDIRECTEVAPORATIVEWETCOIL(9, "INDIRECTEVAPORATIVEWETCOIL",
	 ...
	 * @ordered
	 */
	DIRECTEVAPORATIVEAIRWASHER(10, "DIRECTEVAPORATIVEAIRWASHER",
	 ...
	 * @ordered
	 */
	DIRECTEVAPORATIVEPACKAGEDROTARYAIRCOOLER(11,
	 ...
	 * @generated
	 */
	private static final IfcEvaporativeCoolerTypeEnum[] VALUES_ARRAY = new IfcEvaporativeCoolerTypeEnum[] {
			NULL, DIRECTEVAPORATIVERANDOMMEDIAAIRCOOLER, NOTDEFINED,
			INDIRECTDIRECTCOMBINATION, DIRECTEVAPORATIVERIGIDMEDIAAIRCOOLER,
			DIRECTEVAPORATIVESLINGERSPACKAGEDAIRCOOLER, USERDEFINED,
			INDIRECTEVAPORATIVEPACKAGEAIRCOOLER,
			INDIRECTEVAPORATIVECOOLINGTOWERORCOILCOOLER,
			INDIRECTEVAPORATIVEWETCOIL, DIRECTEVAPORATIVEAIRWASHER,
			DIRECTEVAPORATIVEPACKAGEDROTARYAIRCOOLER, };
