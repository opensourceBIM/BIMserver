...
public class IfcThermalExpansionCoefficientMeasureImpl extends IdEObjectImpl
	...
	protected EClass eStaticClass() {
		return Ifc4Package.Literals.IFC_THERMAL_EXPANSION_COEFFICIENT_MEASURE;
	}
	...
	public double getWrappedValue() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_THERMAL_EXPANSION_COEFFICIENT_MEASURE__WRAPPED_VALUE,
				true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc4Package.Literals.IFC_THERMAL_EXPANSION_COEFFICIENT_MEASURE__WRAPPED_VALUE,
				newWrappedValue);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_THERMAL_EXPANSION_COEFFICIENT_MEASURE__WRAPPED_VALUE_AS_STRING,
				true);
	}
