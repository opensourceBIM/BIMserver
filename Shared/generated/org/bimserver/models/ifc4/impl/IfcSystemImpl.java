 ...
 * <ul>
 *   <li>{@link org.bimserver.models.ifc4.impl.IfcSystemImpl#getServicesBuildings <em>Services Buildings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcSystemImpl extends IfcGroupImpl implements IfcSystem {
	...
	public EList<IfcRelServicesBuildings> getServicesBuildings() {
		return (EList<IfcRelServicesBuildings>) eGet(
				Ifc4Package.Literals.IFC_SYSTEM__SERVICES_BUILDINGS, true);
	}
