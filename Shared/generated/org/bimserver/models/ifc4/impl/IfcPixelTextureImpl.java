...
public class IfcPixelTextureImpl extends IfcSurfaceTextureImpl implements
	 ...
	 */
	public int getWidth() {
		return (Integer) eGet(Ifc4Package.Literals.IFC_PIXEL_TEXTURE__WIDTH,
				true);
	}
	...
	public int getHeight() {
		return (Integer) eGet(Ifc4Package.Literals.IFC_PIXEL_TEXTURE__HEIGHT,
				true);
	}
	...
	public int getColourComponents() {
		return (Integer) eGet(
				Ifc4Package.Literals.IFC_PIXEL_TEXTURE__COLOUR_COMPONENTS, true);
	}
	...
	public void setColourComponents(int newColourComponents) {
		eSet(Ifc4Package.Literals.IFC_PIXEL_TEXTURE__COLOUR_COMPONENTS,
				newColourComponents);
	}
