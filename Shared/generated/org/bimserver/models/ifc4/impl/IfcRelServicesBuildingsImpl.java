...
public class IfcRelServicesBuildingsImpl extends IfcRelConnectsImpl implements
	...
	public IfcSystem getRelatingSystem() {
		return (IfcSystem) eGet(
				Ifc4Package.Literals.IFC_REL_SERVICES_BUILDINGS__RELATING_SYSTEM,
				true);
	}
	...
	public void setRelatingSystem(IfcSystem newRelatingSystem) {
		eSet(Ifc4Package.Literals.IFC_REL_SERVICES_BUILDINGS__RELATING_SYSTEM,
				newRelatingSystem);
	}
	...
	public EList<IfcSpatialElement> getRelatedBuildings() {
		return (EList<IfcSpatialElement>) eGet(
				Ifc4Package.Literals.IFC_REL_SERVICES_BUILDINGS__RELATED_BUILDINGS,
				true);
	}
