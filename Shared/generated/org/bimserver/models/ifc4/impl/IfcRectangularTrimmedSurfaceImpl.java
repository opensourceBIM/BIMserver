...
public class IfcRectangularTrimmedSurfaceImpl extends IfcBoundedSurfaceImpl
	...
	public IfcSurface getBasisSurface() {
		return (IfcSurface) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__BASIS_SURFACE,
				true);
	}
	...
	public void setBasisSurface(IfcSurface newBasisSurface) {
		eSet(Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__BASIS_SURFACE,
				newBasisSurface);
	}
	...
	public double getU1() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U1, true);
	}
	...
	public String getU1AsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U1_AS_STRING,
				true);
	}
	...
	public void setU1AsString(String newU1AsString) {
		eSet(Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U1_AS_STRING,
				newU1AsString);
	}
	...
	public double getV1() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V1, true);
	}
	...
	public String getV1AsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V1_AS_STRING,
				true);
	}
	...
	public void setV1AsString(String newV1AsString) {
		eSet(Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V1_AS_STRING,
				newV1AsString);
	}
	...
	public double getU2() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U2, true);
	}
	...
	public String getU2AsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U2_AS_STRING,
				true);
	}
	...
	public void setU2AsString(String newU2AsString) {
		eSet(Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__U2_AS_STRING,
				newU2AsString);
	}
	...
	public double getV2() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V2, true);
	}
	...
	public String getV2AsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V2_AS_STRING,
				true);
	}
	...
	public void setV2AsString(String newV2AsString) {
		eSet(Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__V2_AS_STRING,
				newV2AsString);
	}
	...
	public Tristate getUsense() {
		return (Tristate) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__USENSE,
				true);
	}
	...
	public void setUsense(Tristate newUsense) {
		eSet(Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__USENSE,
				newUsense);
	}
	...
	public Tristate getVsense() {
		return (Tristate) eGet(
				Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__VSENSE,
				true);
	}
	...
	public void setVsense(Tristate newVsense) {
		eSet(Ifc4Package.Literals.IFC_RECTANGULAR_TRIMMED_SURFACE__VSENSE,
				newVsense);
	}
