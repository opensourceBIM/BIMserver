...
public class IfcPropertySingleValueImpl extends IfcSimplePropertyImpl implements
	...
	public IfcValue getNominalValue() {
		return (IfcValue) eGet(
				Ifc4Package.Literals.IFC_PROPERTY_SINGLE_VALUE__NOMINAL_VALUE,
				true);
	}
	...
	public void setNominalValue(IfcValue newNominalValue) {
		eSet(Ifc4Package.Literals.IFC_PROPERTY_SINGLE_VALUE__NOMINAL_VALUE,
				newNominalValue);
	}
	...
	public IfcUnit getUnit() {
		return (IfcUnit) eGet(
				Ifc4Package.Literals.IFC_PROPERTY_SINGLE_VALUE__UNIT, true);
	}
