...
public class IfcStructuralLoadSingleDisplacementImpl extends
	...
	public double getDisplacementX() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_X,
				true);
	}
	...
	public void setDisplacementX(double newDisplacementX) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_X,
				newDisplacementX);
	}
	...
	public String getDisplacementXAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_XAS_STRING,
				true);
	}
	...
	public double getDisplacementY() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Y,
				true);
	}
	...
	public void setDisplacementY(double newDisplacementY) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Y,
				newDisplacementY);
	}
	...
	public String getDisplacementYAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_YAS_STRING,
				true);
	}
	...
	public double getDisplacementZ() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Z,
				true);
	}
	...
	public void setDisplacementZ(double newDisplacementZ) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_Z,
				newDisplacementZ);
	}
	...
	public String getDisplacementZAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__DISPLACEMENT_ZAS_STRING,
				true);
	}
	...
	public double getRotationalDisplacementRX() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RX,
				true);
	}
	...
	public double getRotationalDisplacementRY() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RY,
				true);
	}
	...
	public double getRotationalDisplacementRZ() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_SINGLE_DISPLACEMENT__ROTATIONAL_DISPLACEMENT_RZ,
				true);
	}
