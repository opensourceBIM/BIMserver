 ...
 * @generated
 */
public class IfcDoorLiningPropertiesImpl extends IfcPreDefinedPropertySetImpl
		implements IfcDoorLiningProperties {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public double getLiningDepth() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_DEPTH,
				true);
	}
	...
	public void setLiningDepth(double newLiningDepth) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_DEPTH,
				newLiningDepth);
	}
	...
	public String getLiningDepthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_DEPTH_AS_STRING,
				true);
	}
	...
	public void setLiningDepthAsString(String newLiningDepthAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_DEPTH_AS_STRING,
	...
	public double getLiningThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_THICKNESS,
				true);
	}
	...
	public void setLiningThickness(double newLiningThickness) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_THICKNESS,
				newLiningThickness);
	}
	...
	public String getLiningThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_THICKNESS_AS_STRING,
				true);
	}
	...
	public void setLiningThicknessAsString(String newLiningThicknessAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_THICKNESS_AS_STRING,
	...
	public double getThresholdDepth() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_DEPTH,
				true);
	}
	...
	public void setThresholdDepth(double newThresholdDepth) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_DEPTH,
				newThresholdDepth);
	}
	...
	public String getThresholdDepthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_DEPTH_AS_STRING,
				true);
	}
	...
	public void setThresholdDepthAsString(String newThresholdDepthAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_DEPTH_AS_STRING,
	...
	public double getThresholdThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_THICKNESS,
				true);
	}
	...
	public void setThresholdThickness(double newThresholdThickness) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_THICKNESS,
				newThresholdThickness);
	}
	...
	public String getThresholdThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_THICKNESS_AS_STRING,
				true);
	}
	 ...
	 * @generated
	 */
	public void setThresholdThicknessAsString(
			String newThresholdThicknessAsString) {
	...
	public double getTransomThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__TRANSOM_THICKNESS,
				true);
	}
	...
	public void setTransomThickness(double newTransomThickness) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__TRANSOM_THICKNESS,
				newTransomThickness);
	}
	...
	public String getTransomThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__TRANSOM_THICKNESS_AS_STRING,
				true);
	}
	...
	public void setTransomThicknessAsString(String newTransomThicknessAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__TRANSOM_THICKNESS_AS_STRING,
	...
	public double getTransomOffset() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__TRANSOM_OFFSET,
				true);
	}
	...
	public void setTransomOffset(double newTransomOffset) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__TRANSOM_OFFSET,
				newTransomOffset);
	}
	...
	public String getTransomOffsetAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__TRANSOM_OFFSET_AS_STRING,
				true);
	}
	...
	public void setTransomOffsetAsString(String newTransomOffsetAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__TRANSOM_OFFSET_AS_STRING,
				newTransomOffsetAsString);
	}
	...
	public double getLiningOffset() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_OFFSET,
				true);
	}
	...
	public void setLiningOffset(double newLiningOffset) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_OFFSET,
				newLiningOffset);
	}
	...
	public String getLiningOffsetAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_OFFSET_AS_STRING,
				true);
	}
	...
	public void setLiningOffsetAsString(String newLiningOffsetAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_OFFSET_AS_STRING,
				newLiningOffsetAsString);
	}
	...
	public double getThresholdOffset() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_OFFSET,
				true);
	}
	...
	public void setThresholdOffset(double newThresholdOffset) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_OFFSET,
				newThresholdOffset);
	}
	...
	public String getThresholdOffsetAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_OFFSET_AS_STRING,
				true);
	}
	...
	public void setThresholdOffsetAsString(String newThresholdOffsetAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__THRESHOLD_OFFSET_AS_STRING,
	...
	public double getCasingThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__CASING_THICKNESS,
				true);
	}
	...
	public void setCasingThickness(double newCasingThickness) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__CASING_THICKNESS,
				newCasingThickness);
	}
	...
	public String getCasingThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__CASING_THICKNESS_AS_STRING,
				true);
	}
	...
	public void setCasingThicknessAsString(String newCasingThicknessAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__CASING_THICKNESS_AS_STRING,
	...
	public double getCasingDepth() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__CASING_DEPTH,
				true);
	}
	...
	public void setCasingDepth(double newCasingDepth) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__CASING_DEPTH,
				newCasingDepth);
	}
	...
	public String getCasingDepthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__CASING_DEPTH_AS_STRING,
				true);
	}
	...
	public void setCasingDepthAsString(String newCasingDepthAsString) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__CASING_DEPTH_AS_STRING,
				newCasingDepthAsString);
	}
	...
	public IfcShapeAspect getShapeAspectStyle() {
		return (IfcShapeAspect) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__SHAPE_ASPECT_STYLE,
				true);
	}
	...
	public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__SHAPE_ASPECT_STYLE,
				newShapeAspectStyle);
	}
	...
	public double getLiningToPanelOffsetX() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_TO_PANEL_OFFSET_X,
				true);
	}
	...
	public void setLiningToPanelOffsetX(double newLiningToPanelOffsetX) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_TO_PANEL_OFFSET_X,
				newLiningToPanelOffsetX);
	}
	...
	public String getLiningToPanelOffsetXAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_TO_PANEL_OFFSET_XAS_STRING,
				true);
	}
	 ...
	 * @generated
	 */
	public void setLiningToPanelOffsetXAsString(
			String newLiningToPanelOffsetXAsString) {
	...
	public double getLiningToPanelOffsetY() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_TO_PANEL_OFFSET_Y,
				true);
	}
	...
	public void setLiningToPanelOffsetY(double newLiningToPanelOffsetY) {
		eSet(Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_TO_PANEL_OFFSET_Y,
				newLiningToPanelOffsetY);
	}
	...
	public String getLiningToPanelOffsetYAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOOR_LINING_PROPERTIES__LINING_TO_PANEL_OFFSET_YAS_STRING,
				true);
	}
	 ...
	 * @generated
	 */
	public void setLiningToPanelOffsetYAsString(
			String newLiningToPanelOffsetYAsString) {
