 ...
 * @generated
 */
public class IfcTelecomAddressImpl extends IfcAddressImpl implements
		IfcTelecomAddress {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<String> getTelephoneNumbers() {
		return (EList<String>) eGet(
				Ifc4Package.Literals.IFC_TELECOM_ADDRESS__TELEPHONE_NUMBERS,
				true);
	}
	...
	public EList<String> getFacsimileNumbers() {
		return (EList<String>) eGet(
				Ifc4Package.Literals.IFC_TELECOM_ADDRESS__FACSIMILE_NUMBERS,
				true);
	}
	...
	public String getPagerNumber() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TELECOM_ADDRESS__PAGER_NUMBER, true);
	}
	...
	public void setPagerNumber(String newPagerNumber) {
		eSet(Ifc4Package.Literals.IFC_TELECOM_ADDRESS__PAGER_NUMBER,
				newPagerNumber);
	}
	...
	public EList<String> getElectronicMailAddresses() {
		return (EList<String>) eGet(
				Ifc4Package.Literals.IFC_TELECOM_ADDRESS__ELECTRONIC_MAIL_ADDRESSES,
				true);
	}
	...
	public String getWWWHomePageURL() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TELECOM_ADDRESS__WWW_HOME_PAGE_URL,
				true);
	}
	...
	public void setWWWHomePageURL(String newWWWHomePageURL) {
		eSet(Ifc4Package.Literals.IFC_TELECOM_ADDRESS__WWW_HOME_PAGE_URL,
				newWWWHomePageURL);
	}
	...
	public EList<String> getMessagingIDs() {
		return (EList<String>) eGet(
				Ifc4Package.Literals.IFC_TELECOM_ADDRESS__MESSAGING_IDS, true);
	}
