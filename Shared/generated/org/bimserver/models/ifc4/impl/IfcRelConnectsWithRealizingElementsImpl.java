...
public class IfcRelConnectsWithRealizingElementsImpl extends
	...
	public EList<IfcElement> getRealizingElements() {
		return (EList<IfcElement>) eGet(
				Ifc4Package.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS__REALIZING_ELEMENTS,
				true);
	}
	...
	public String getConnectionType() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS__CONNECTION_TYPE,
				true);
	}
	...
	public void setConnectionType(String newConnectionType) {
		eSet(Ifc4Package.Literals.IFC_REL_CONNECTS_WITH_REALIZING_ELEMENTS__CONNECTION_TYPE,
				newConnectionType);
	}
