...
public class IfcRelConnectsPortsImpl extends IfcRelConnectsImpl implements
	...
	public IfcPort getRelatingPort() {
		return (IfcPort) eGet(
				Ifc4Package.Literals.IFC_REL_CONNECTS_PORTS__RELATING_PORT,
				true);
	}
	...
	public void setRelatingPort(IfcPort newRelatingPort) {
		eSet(Ifc4Package.Literals.IFC_REL_CONNECTS_PORTS__RELATING_PORT,
				newRelatingPort);
	}
	...
	public IfcPort getRelatedPort() {
		return (IfcPort) eGet(
				Ifc4Package.Literals.IFC_REL_CONNECTS_PORTS__RELATED_PORT, true);
	}
	...
	public void setRelatedPort(IfcPort newRelatedPort) {
		eSet(Ifc4Package.Literals.IFC_REL_CONNECTS_PORTS__RELATED_PORT,
				newRelatedPort);
	}
	...
	public IfcElement getRealizingElement() {
		return (IfcElement) eGet(
				Ifc4Package.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT,
				true);
	}
	...
	public void setRealizingElement(IfcElement newRealizingElement) {
		eSet(Ifc4Package.Literals.IFC_REL_CONNECTS_PORTS__REALIZING_ELEMENT,
				newRealizingElement);
	}
