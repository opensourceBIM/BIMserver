...
public class IfcRelConnectsElementsImpl extends IfcRelConnectsImpl implements
	...
	public IfcConnectionGeometry getConnectionGeometry() {
		return (IfcConnectionGeometry) eGet(
				Ifc4Package.Literals.IFC_REL_CONNECTS_ELEMENTS__CONNECTION_GEOMETRY,
				true);
	}
	...
	public void setConnectionGeometry(
		...
		eSet(Ifc4Package.Literals.IFC_REL_CONNECTS_ELEMENTS__CONNECTION_GEOMETRY,
	...
	public IfcElement getRelatingElement() {
		return (IfcElement) eGet(
				Ifc4Package.Literals.IFC_REL_CONNECTS_ELEMENTS__RELATING_ELEMENT,
				true);
	}
	...
	public void setRelatingElement(IfcElement newRelatingElement) {
		eSet(Ifc4Package.Literals.IFC_REL_CONNECTS_ELEMENTS__RELATING_ELEMENT,
				newRelatingElement);
	}
	...
	public IfcElement getRelatedElement() {
		return (IfcElement) eGet(
				Ifc4Package.Literals.IFC_REL_CONNECTS_ELEMENTS__RELATED_ELEMENT,
				true);
	}
	...
	public void setRelatedElement(IfcElement newRelatedElement) {
		eSet(Ifc4Package.Literals.IFC_REL_CONNECTS_ELEMENTS__RELATED_ELEMENT,
				newRelatedElement);
	}
