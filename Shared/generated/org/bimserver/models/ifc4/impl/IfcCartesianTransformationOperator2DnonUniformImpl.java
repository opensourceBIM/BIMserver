...
public class IfcCartesianTransformationOperator2DnonUniformImpl extends
	...
	public double getScale2() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2,
				true);
	}
	...
	public void setScale2(double newScale2) {
		eSet(Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2,
				newScale2);
	}
	...
	public String getScale2AsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR2_DNON_UNIFORM__SCALE2_AS_STRING,
				true);
	}
