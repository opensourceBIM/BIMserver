...
public class IfcThermalConductivityMeasureImpl extends IdEObjectImpl implements
	...
	public double getWrappedValue() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_THERMAL_CONDUCTIVITY_MEASURE__WRAPPED_VALUE,
				true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc4Package.Literals.IFC_THERMAL_CONDUCTIVITY_MEASURE__WRAPPED_VALUE,
				newWrappedValue);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_THERMAL_CONDUCTIVITY_MEASURE__WRAPPED_VALUE_AS_STRING,
				true);
	}
	...
	public void setWrappedValueAsString(String newWrappedValueAsString) {
		eSet(Ifc4Package.Literals.IFC_THERMAL_CONDUCTIVITY_MEASURE__WRAPPED_VALUE_AS_STRING,
