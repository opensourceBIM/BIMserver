...
public class IfcDerivedUnitImpl extends IdEObjectImpl implements IfcDerivedUnit {
	...
	public EList<IfcDerivedUnitElement> getElements() {
		return (EList<IfcDerivedUnitElement>) eGet(
				Ifc4Package.Literals.IFC_DERIVED_UNIT__ELEMENTS, true);
	}
	...
	public IfcDerivedUnitEnum getUnitType() {
		return (IfcDerivedUnitEnum) eGet(
				Ifc4Package.Literals.IFC_DERIVED_UNIT__UNIT_TYPE, true);
	}
	...
	public String getUserDefinedType() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DERIVED_UNIT__USER_DEFINED_TYPE, true);
	}
	...
	public void setUserDefinedType(String newUserDefinedType) {
		eSet(Ifc4Package.Literals.IFC_DERIVED_UNIT__USER_DEFINED_TYPE,
				newUserDefinedType);
	}
