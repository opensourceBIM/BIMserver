...
public class IfcBooleanResultImpl extends IfcGeometricRepresentationItemImpl
	...
	public IfcBooleanOperator getOperator() {
		return (IfcBooleanOperator) eGet(
				Ifc4Package.Literals.IFC_BOOLEAN_RESULT__OPERATOR, true);
	}
	...
	public IfcBooleanOperand getFirstOperand() {
		return (IfcBooleanOperand) eGet(
				Ifc4Package.Literals.IFC_BOOLEAN_RESULT__FIRST_OPERAND, true);
	}
	...
	public void setFirstOperand(IfcBooleanOperand newFirstOperand) {
		eSet(Ifc4Package.Literals.IFC_BOOLEAN_RESULT__FIRST_OPERAND,
				newFirstOperand);
	}
	...
	public IfcBooleanOperand getSecondOperand() {
		return (IfcBooleanOperand) eGet(
				Ifc4Package.Literals.IFC_BOOLEAN_RESULT__SECOND_OPERAND, true);
	}
	...
	public void setSecondOperand(IfcBooleanOperand newSecondOperand) {
		eSet(Ifc4Package.Literals.IFC_BOOLEAN_RESULT__SECOND_OPERAND,
				newSecondOperand);
	}
	 ...
	 */
	public int getDim() {
		return (Integer) eGet(Ifc4Package.Literals.IFC_BOOLEAN_RESULT__DIM,
				true);
	}
