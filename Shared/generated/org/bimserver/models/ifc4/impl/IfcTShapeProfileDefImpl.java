...
public class IfcTShapeProfileDefImpl extends IfcParameterizedProfileDefImpl
	...
	public double getDepth() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__DEPTH, true);
	}
	...
	public String getDepthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__DEPTH_AS_STRING,
				true);
	}
	...
	public void setDepthAsString(String newDepthAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__DEPTH_AS_STRING,
				newDepthAsString);
	}
	...
	public double getFlangeWidth() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_WIDTH, true);
	}
	...
	public void setFlangeWidth(double newFlangeWidth) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_WIDTH,
				newFlangeWidth);
	}
	...
	public String getFlangeWidthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_WIDTH_AS_STRING,
				true);
	}
	...
	public void setFlangeWidthAsString(String newFlangeWidthAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_WIDTH_AS_STRING,
	...
	public double getWebThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_THICKNESS,
				true);
	}
	...
	public void setWebThickness(double newWebThickness) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_THICKNESS,
				newWebThickness);
	}
	...
	public String getWebThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING,
				true);
	}
	...
	public void setWebThicknessAsString(String newWebThicknessAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_THICKNESS_AS_STRING,
	...
	public double getFlangeThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_THICKNESS,
				true);
	}
	...
	public void setFlangeThickness(double newFlangeThickness) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_THICKNESS,
				newFlangeThickness);
	}
	...
	public String getFlangeThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING,
				true);
	}
	...
	public void setFlangeThicknessAsString(String newFlangeThicknessAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_THICKNESS_AS_STRING,
	...
	public double getFilletRadius() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS,
				true);
	}
	...
	public void setFilletRadius(double newFilletRadius) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS,
				newFilletRadius);
	}
	...
	public String getFilletRadiusAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING,
				true);
	}
	...
	public void setFilletRadiusAsString(String newFilletRadiusAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FILLET_RADIUS_AS_STRING,
	...
	public double getFlangeEdgeRadius() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS,
				true);
	}
	...
	public void setFlangeEdgeRadius(double newFlangeEdgeRadius) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS,
				newFlangeEdgeRadius);
	}
	...
	public String getFlangeEdgeRadiusAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS_AS_STRING,
				true);
	}
	...
	public void setFlangeEdgeRadiusAsString(String newFlangeEdgeRadiusAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_EDGE_RADIUS_AS_STRING,
	...
	public double getWebEdgeRadius() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS,
				true);
	}
	...
	public void setWebEdgeRadius(double newWebEdgeRadius) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS,
				newWebEdgeRadius);
	}
	...
	public String getWebEdgeRadiusAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS_AS_STRING,
				true);
	}
	...
	public void setWebEdgeRadiusAsString(String newWebEdgeRadiusAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_EDGE_RADIUS_AS_STRING,
	...
	public double getWebSlope() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE, true);
	}
	...
	public void setWebSlope(double newWebSlope) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE,
				newWebSlope);
	}
	...
	public String getWebSlopeAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE_AS_STRING,
				true);
	}
	...
	public void setWebSlopeAsString(String newWebSlopeAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__WEB_SLOPE_AS_STRING,
				newWebSlopeAsString);
	}
	...
	public double getFlangeSlope() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE, true);
	}
	...
	public void setFlangeSlope(double newFlangeSlope) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE,
				newFlangeSlope);
	}
	...
	public String getFlangeSlopeAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING,
				true);
	}
	...
	public void setFlangeSlopeAsString(String newFlangeSlopeAsString) {
		eSet(Ifc4Package.Literals.IFC_TSHAPE_PROFILE_DEF__FLANGE_SLOPE_AS_STRING,
