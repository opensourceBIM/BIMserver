...
public class IfcMagneticFluxDensityMeasureImpl extends IdEObjectImpl implements
	...
	public double getWrappedValue() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_MAGNETIC_FLUX_DENSITY_MEASURE__WRAPPED_VALUE,
				true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc4Package.Literals.IFC_MAGNETIC_FLUX_DENSITY_MEASURE__WRAPPED_VALUE,
				newWrappedValue);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_MAGNETIC_FLUX_DENSITY_MEASURE__WRAPPED_VALUE_AS_STRING,
				true);
	}
	...
	public void setWrappedValueAsString(String newWrappedValueAsString) {
		eSet(Ifc4Package.Literals.IFC_MAGNETIC_FLUX_DENSITY_MEASURE__WRAPPED_VALUE_AS_STRING,
