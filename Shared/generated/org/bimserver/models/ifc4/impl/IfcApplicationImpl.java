...
public class IfcApplicationImpl extends IdEObjectImpl implements IfcApplication {
	...
	public IfcOrganization getApplicationDeveloper() {
		return (IfcOrganization) eGet(
				Ifc4Package.Literals.IFC_APPLICATION__APPLICATION_DEVELOPER,
				true);
	}
	...
	public void setApplicationDeveloper(IfcOrganization newApplicationDeveloper) {
		eSet(Ifc4Package.Literals.IFC_APPLICATION__APPLICATION_DEVELOPER,
	...
	public String getVersion() {
		return (String) eGet(Ifc4Package.Literals.IFC_APPLICATION__VERSION,
				true);
	}
	...
	public String getApplicationFullName() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_APPLICATION__APPLICATION_FULL_NAME,
				true);
	}
	...
	public void setApplicationFullName(String newApplicationFullName) {
		eSet(Ifc4Package.Literals.IFC_APPLICATION__APPLICATION_FULL_NAME,
	...
	public String getApplicationIdentifier() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_APPLICATION__APPLICATION_IDENTIFIER,
				true);
	}
	...
	public void setApplicationIdentifier(String newApplicationIdentifier) {
		eSet(Ifc4Package.Literals.IFC_APPLICATION__APPLICATION_IDENTIFIER,
