...
public class IfcQuantityAreaImpl extends IfcPhysicalSimpleQuantityImpl
	...
	public double getAreaValue() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_QUANTITY_AREA__AREA_VALUE, true);
	}
	...
	public String getAreaValueAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_QUANTITY_AREA__AREA_VALUE_AS_STRING,
				true);
	}
	...
	public void setAreaValueAsString(String newAreaValueAsString) {
		eSet(Ifc4Package.Literals.IFC_QUANTITY_AREA__AREA_VALUE_AS_STRING,
	...
	public String getFormula() {
		return (String) eGet(Ifc4Package.Literals.IFC_QUANTITY_AREA__FORMULA,
				true);
	}
