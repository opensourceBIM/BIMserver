 ...
 * @generated
 */
public class IfcReinforcingMeshImpl extends IfcReinforcingElementImpl implements
		IfcReinforcingMesh {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public double getMeshLength() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__MESH_LENGTH, true);
	}
	...
	public void setMeshLength(double newMeshLength) {
		eSet(Ifc4Package.Literals.IFC_REINFORCING_MESH__MESH_LENGTH,
				newMeshLength);
	}
	...
	public String getMeshLengthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__MESH_LENGTH_AS_STRING,
				true);
	}
	...
	public void setMeshLengthAsString(String newMeshLengthAsString) {
		eSet(Ifc4Package.Literals.IFC_REINFORCING_MESH__MESH_LENGTH_AS_STRING,
	...
	public double getMeshWidth() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__MESH_WIDTH, true);
	}
	...
	public void setMeshWidth(double newMeshWidth) {
		eSet(Ifc4Package.Literals.IFC_REINFORCING_MESH__MESH_WIDTH,
				newMeshWidth);
	}
	...
	public String getMeshWidthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__MESH_WIDTH_AS_STRING,
				true);
	}
	...
	public void setMeshWidthAsString(String newMeshWidthAsString) {
		eSet(Ifc4Package.Literals.IFC_REINFORCING_MESH__MESH_WIDTH_AS_STRING,
	...
	public double getLongitudinalBarNominalDiameter() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_NOMINAL_DIAMETER,
				true);
	}
	...
	public String getLongitudinalBarNominalDiameterAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_NOMINAL_DIAMETER_AS_STRING,
				true);
	}
	...
	public double getTransverseBarNominalDiameter() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_NOMINAL_DIAMETER,
				true);
	}
	...
	public String getTransverseBarNominalDiameterAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_NOMINAL_DIAMETER_AS_STRING,
				true);
	}
	...
	public double getLongitudinalBarCrossSectionArea() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_CROSS_SECTION_AREA,
				true);
	}
	...
	public String getLongitudinalBarCrossSectionAreaAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_CROSS_SECTION_AREA_AS_STRING,
				true);
	}
	...
	public double getTransverseBarCrossSectionArea() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_CROSS_SECTION_AREA,
				true);
	}
	...
	public String getTransverseBarCrossSectionAreaAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_CROSS_SECTION_AREA_AS_STRING,
				true);
	}
	...
	public double getLongitudinalBarSpacing() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_SPACING,
				true);
	}
	...
	public void setLongitudinalBarSpacing(double newLongitudinalBarSpacing) {
		eSet(Ifc4Package.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_SPACING,
	...
	public String getLongitudinalBarSpacingAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__LONGITUDINAL_BAR_SPACING_AS_STRING,
				true);
	}
	...
	public double getTransverseBarSpacing() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_SPACING,
				true);
	}
	...
	public void setTransverseBarSpacing(double newTransverseBarSpacing) {
		eSet(Ifc4Package.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_SPACING,
	...
	public String getTransverseBarSpacingAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__TRANSVERSE_BAR_SPACING_AS_STRING,
				true);
	}
	...
	public IfcReinforcingMeshTypeEnum getPredefinedType() {
		return (IfcReinforcingMeshTypeEnum) eGet(
				Ifc4Package.Literals.IFC_REINFORCING_MESH__PREDEFINED_TYPE,
				true);
	}
	...
	public void setPredefinedType(IfcReinforcingMeshTypeEnum newPredefinedType) {
		eSet(Ifc4Package.Literals.IFC_REINFORCING_MESH__PREDEFINED_TYPE,
				newPredefinedType);
	}
