 ...
 * <ul>
 *   <li>{@link org.bimserver.models.ifc4.impl.IfcThermodynamicTemperatureMeasureImpl#getWrappedValue <em>Wrapped Value</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.impl.IfcThermodynamicTemperatureMeasureImpl#getWrappedValueAsString <em>Wrapped Value As String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcThermodynamicTemperatureMeasureImpl extends IdEObjectImpl
	...
	protected EClass eStaticClass() {
		return Ifc4Package.Literals.IFC_THERMODYNAMIC_TEMPERATURE_MEASURE;
	}
	...
	public double getWrappedValue() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_THERMODYNAMIC_TEMPERATURE_MEASURE__WRAPPED_VALUE,
				true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc4Package.Literals.IFC_THERMODYNAMIC_TEMPERATURE_MEASURE__WRAPPED_VALUE,
				newWrappedValue);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_THERMODYNAMIC_TEMPERATURE_MEASURE__WRAPPED_VALUE_AS_STRING,
				true);
	}
