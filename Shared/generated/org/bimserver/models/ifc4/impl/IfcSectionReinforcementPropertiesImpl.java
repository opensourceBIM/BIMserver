 ...
 * @generated
 */
public class IfcSectionReinforcementPropertiesImpl extends
		IfcPreDefinedPropertiesImpl implements
	...
	public double getLongitudinalStartPosition() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_START_POSITION,
				true);
	}
	...
	public String getLongitudinalStartPositionAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_START_POSITION_AS_STRING,
				true);
	}
	 ...
	 * @generated
	 */
	public void setLongitudinalStartPositionAsString(
			String newLongitudinalStartPositionAsString) {
	...
	public double getLongitudinalEndPosition() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_END_POSITION,
				true);
	}
	...
	public String getLongitudinalEndPositionAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__LONGITUDINAL_END_POSITION_AS_STRING,
				true);
	}
	 ...
	 * @generated
	 */
	public void setLongitudinalEndPositionAsString(
			String newLongitudinalEndPositionAsString) {
	...
	public double getTransversePosition() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION,
				true);
	}
	...
	public void setTransversePosition(double newTransversePosition) {
		eSet(Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION,
	...
	public String getTransversePositionAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__TRANSVERSE_POSITION_AS_STRING,
				true);
	}
	 ...
	 * @generated
	 */
	public void setTransversePositionAsString(
			String newTransversePositionAsString) {
	...
	public IfcReinforcingBarRoleEnum getReinforcementRole() {
		return (IfcReinforcingBarRoleEnum) eGet(
				Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__REINFORCEMENT_ROLE,
				true);
	}
	 ...
	 * @generated
	 */
	public void setReinforcementRole(
			IfcReinforcingBarRoleEnum newReinforcementRole) {
		eSet(Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__REINFORCEMENT_ROLE,
				newReinforcementRole);
	}
	...
	public IfcSectionProperties getSectionDefinition() {
		return (IfcSectionProperties) eGet(
				Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__SECTION_DEFINITION,
				true);
	}
	...
	public void setSectionDefinition(IfcSectionProperties newSectionDefinition) {
		eSet(Ifc4Package.Literals.IFC_SECTION_REINFORCEMENT_PROPERTIES__SECTION_DEFINITION,
				newSectionDefinition);
	}
