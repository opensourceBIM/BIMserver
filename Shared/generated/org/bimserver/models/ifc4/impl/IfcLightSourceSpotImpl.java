...
public class IfcLightSourceSpotImpl extends IfcLightSourcePositionalImpl
	...
	public IfcDirection getOrientation() {
		return (IfcDirection) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__ORIENTATION, true);
	}
	...
	public void setOrientation(IfcDirection newOrientation) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__ORIENTATION,
				newOrientation);
	}
	...
	public double getConcentrationExponent() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT,
				true);
	}
	...
	public void setConcentrationExponent(double newConcentrationExponent) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT,
	...
	public String getConcentrationExponentAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__CONCENTRATION_EXPONENT_AS_STRING,
				true);
	}
	...
	public double getSpreadAngle() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__SPREAD_ANGLE, true);
	}
	...
	public void setSpreadAngle(double newSpreadAngle) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__SPREAD_ANGLE,
				newSpreadAngle);
	}
	...
	public String getSpreadAngleAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__SPREAD_ANGLE_AS_STRING,
				true);
	}
	...
	public void setSpreadAngleAsString(String newSpreadAngleAsString) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__SPREAD_ANGLE_AS_STRING,
	...
	public double getBeamWidthAngle() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__BEAM_WIDTH_ANGLE,
				true);
	}
	...
	public void setBeamWidthAngle(double newBeamWidthAngle) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__BEAM_WIDTH_ANGLE,
				newBeamWidthAngle);
	}
	...
	public String getBeamWidthAngleAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__BEAM_WIDTH_ANGLE_AS_STRING,
				true);
	}
	...
	public void setBeamWidthAngleAsString(String newBeamWidthAngleAsString) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_SPOT__BEAM_WIDTH_ANGLE_AS_STRING,
