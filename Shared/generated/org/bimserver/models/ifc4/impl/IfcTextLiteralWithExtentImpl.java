...
public class IfcTextLiteralWithExtentImpl extends IfcTextLiteralImpl implements
	...
	public IfcPlanarExtent getExtent() {
		return (IfcPlanarExtent) eGet(
				Ifc4Package.Literals.IFC_TEXT_LITERAL_WITH_EXTENT__EXTENT, true);
	}
	...
	public void setExtent(IfcPlanarExtent newExtent) {
		eSet(Ifc4Package.Literals.IFC_TEXT_LITERAL_WITH_EXTENT__EXTENT,
				newExtent);
	}
	...
	public String getBoxAlignment() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TEXT_LITERAL_WITH_EXTENT__BOX_ALIGNMENT,
				true);
	}
	...
	public void setBoxAlignment(String newBoxAlignment) {
		eSet(Ifc4Package.Literals.IFC_TEXT_LITERAL_WITH_EXTENT__BOX_ALIGNMENT,
				newBoxAlignment);
	}
