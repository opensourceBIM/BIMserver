...
public class IfcReinforcementDefinitionPropertiesImpl extends
		IfcPreDefinedPropertySetImpl implements
	...
	public String getDefinitionType() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES__DEFINITION_TYPE,
				true);
	}
	...
	public void setDefinitionType(String newDefinitionType) {
		eSet(Ifc4Package.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES__DEFINITION_TYPE,
				newDefinitionType);
	}
	...
	public EList<IfcSectionReinforcementProperties> getReinforcementSectionDefinitions() {
		return (EList<IfcSectionReinforcementProperties>) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_DEFINITION_PROPERTIES__REINFORCEMENT_SECTION_DEFINITIONS,
				true);
	}
