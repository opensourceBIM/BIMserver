 ...
 * <ul>
 *   <li>{@link org.bimserver.models.ifc4.impl.IfcActorImpl#getTheActor <em>The Actor</em>}</li>
 *   <li>{@link org.bimserver.models.ifc4.impl.IfcActorImpl#getIsActingUpon <em>Is Acting Upon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfcActorImpl extends IfcObjectImpl implements IfcActor {
	...
	public IfcActorSelect getTheActor() {
		return (IfcActorSelect) eGet(Ifc4Package.Literals.IFC_ACTOR__THE_ACTOR,
				true);
	}
	...
	public EList<IfcRelAssignsToActor> getIsActingUpon() {
		return (EList<IfcRelAssignsToActor>) eGet(
				Ifc4Package.Literals.IFC_ACTOR__IS_ACTING_UPON, true);
	}
