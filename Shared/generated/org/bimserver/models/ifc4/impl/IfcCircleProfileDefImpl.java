...
public class IfcCircleProfileDefImpl extends IfcParameterizedProfileDefImpl
	...
	public double getRadius() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_CIRCLE_PROFILE_DEF__RADIUS, true);
	}
	...
	public String getRadiusAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_CIRCLE_PROFILE_DEF__RADIUS_AS_STRING,
				true);
	}
	...
	public void setRadiusAsString(String newRadiusAsString) {
		eSet(Ifc4Package.Literals.IFC_CIRCLE_PROFILE_DEF__RADIUS_AS_STRING,
				newRadiusAsString);
	}
