...
public class IfcPropertyReferenceValueImpl extends IfcSimplePropertyImpl
	...
	public String getUsageName() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_PROPERTY_REFERENCE_VALUE__USAGE_NAME,
				true);
	}
	...
	public void setUsageName(String newUsageName) {
		eSet(Ifc4Package.Literals.IFC_PROPERTY_REFERENCE_VALUE__USAGE_NAME,
				newUsageName);
	}
	...
	public IfcObjectReferenceSelect getPropertyReference() {
		return (IfcObjectReferenceSelect) eGet(
				Ifc4Package.Literals.IFC_PROPERTY_REFERENCE_VALUE__PROPERTY_REFERENCE,
				true);
	}
	...
	public void setPropertyReference(
		...
		eSet(Ifc4Package.Literals.IFC_PROPERTY_REFERENCE_VALUE__PROPERTY_REFERENCE,
