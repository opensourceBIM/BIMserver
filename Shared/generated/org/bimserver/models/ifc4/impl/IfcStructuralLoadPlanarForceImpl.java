...
public class IfcStructuralLoadPlanarForceImpl extends
	...
	public double getPlanarForceX() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_X,
				true);
	}
	...
	public void setPlanarForceX(double newPlanarForceX) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_X,
				newPlanarForceX);
	}
	...
	public String getPlanarForceXAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_XAS_STRING,
				true);
	}
	...
	public void setPlanarForceXAsString(String newPlanarForceXAsString) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_XAS_STRING,
	...
	public double getPlanarForceY() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Y,
				true);
	}
	...
	public void setPlanarForceY(double newPlanarForceY) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Y,
				newPlanarForceY);
	}
	...
	public String getPlanarForceYAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_YAS_STRING,
				true);
	}
	...
	public void setPlanarForceYAsString(String newPlanarForceYAsString) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_YAS_STRING,
	...
	public double getPlanarForceZ() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Z,
				true);
	}
	...
	public void setPlanarForceZ(double newPlanarForceZ) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_Z,
				newPlanarForceZ);
	}
	...
	public String getPlanarForceZAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_ZAS_STRING,
				true);
	}
	...
	public void setPlanarForceZAsString(String newPlanarForceZAsString) {
		eSet(Ifc4Package.Literals.IFC_STRUCTURAL_LOAD_PLANAR_FORCE__PLANAR_FORCE_ZAS_STRING,
