...
public class IfcLightSourceGoniometricImpl extends IfcLightSourceImpl implements
	...
	public IfcAxis2Placement3D getPosition() {
		return (IfcAxis2Placement3D) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__POSITION,
				true);
	}
	...
	public void setPosition(IfcAxis2Placement3D newPosition) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__POSITION,
				newPosition);
	}
	...
	public IfcColourRgb getColourAppearance() {
		return (IfcColourRgb) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE,
				true);
	}
	...
	public void setColourAppearance(IfcColourRgb newColourAppearance) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_APPEARANCE,
				newColourAppearance);
	}
	...
	public double getColourTemperature() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE,
				true);
	}
	...
	public void setColourTemperature(double newColourTemperature) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE,
	...
	public String getColourTemperatureAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__COLOUR_TEMPERATURE_AS_STRING,
				true);
	}
	...
	public double getLuminousFlux() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX,
				true);
	}
	...
	public void setLuminousFlux(double newLuminousFlux) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX,
				newLuminousFlux);
	}
	...
	public String getLuminousFluxAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX_AS_STRING,
				true);
	}
	...
	public void setLuminousFluxAsString(String newLuminousFluxAsString) {
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LUMINOUS_FLUX_AS_STRING,
	...
	public IfcLightEmissionSourceEnum getLightEmissionSource() {
		return (IfcLightEmissionSourceEnum) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_EMISSION_SOURCE,
				true);
	}
	...
	public IfcLightDistributionDataSourceSelect getLightDistributionDataSource() {
		return (IfcLightDistributionDataSourceSelect) eGet(
				Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_DISTRIBUTION_DATA_SOURCE,
				true);
	}
	...
	public void setLightDistributionDataSource(
		...
		eSet(Ifc4Package.Literals.IFC_LIGHT_SOURCE_GONIOMETRIC__LIGHT_DISTRIBUTION_DATA_SOURCE,
