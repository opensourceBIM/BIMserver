...
public class IfcRectangleProfileDefImpl extends IfcParameterizedProfileDefImpl
	...
	public double getXDim() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_PROFILE_DEF__XDIM, true);
	}
	...
	public String getXDimAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_PROFILE_DEF__XDIM_AS_STRING,
				true);
	}
	...
	public void setXDimAsString(String newXDimAsString) {
		eSet(Ifc4Package.Literals.IFC_RECTANGLE_PROFILE_DEF__XDIM_AS_STRING,
				newXDimAsString);
	}
	...
	public double getYDim() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_PROFILE_DEF__YDIM, true);
	}
	...
	public String getYDimAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_PROFILE_DEF__YDIM_AS_STRING,
				true);
	}
	...
	public void setYDimAsString(String newYDimAsString) {
		eSet(Ifc4Package.Literals.IFC_RECTANGLE_PROFILE_DEF__YDIM_AS_STRING,
				newYDimAsString);
	}
