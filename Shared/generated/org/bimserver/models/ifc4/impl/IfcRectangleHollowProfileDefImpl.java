 ...
 * @generated
 */
public class IfcRectangleHollowProfileDefImpl extends
		IfcRectangleProfileDefImpl implements IfcRectangleHollowProfileDef {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public double getWallThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS,
				true);
	}
	...
	public void setWallThickness(double newWallThickness) {
		eSet(Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS,
				newWallThickness);
	}
	...
	public String getWallThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING,
				true);
	}
	...
	public void setWallThicknessAsString(String newWallThicknessAsString) {
		eSet(Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING,
	...
	public double getInnerFilletRadius() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS,
				true);
	}
	...
	public void setInnerFilletRadius(double newInnerFilletRadius) {
		eSet(Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS,
				newInnerFilletRadius);
	}
	...
	public String getInnerFilletRadiusAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__INNER_FILLET_RADIUS_AS_STRING,
				true);
	}
	...
	public double getOuterFilletRadius() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS,
				true);
	}
	...
	public void setOuterFilletRadius(double newOuterFilletRadius) {
		eSet(Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS,
				newOuterFilletRadius);
	}
	...
	public String getOuterFilletRadiusAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_RECTANGLE_HOLLOW_PROFILE_DEF__OUTER_FILLET_RADIUS_AS_STRING,
				true);
	}
