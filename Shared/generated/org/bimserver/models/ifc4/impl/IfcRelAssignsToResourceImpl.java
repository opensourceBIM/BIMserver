...
public class IfcRelAssignsToResourceImpl extends IfcRelAssignsImpl implements
	...
	public IfcResourceSelect getRelatingResource() {
		return (IfcResourceSelect) eGet(
				Ifc4Package.Literals.IFC_REL_ASSIGNS_TO_RESOURCE__RELATING_RESOURCE,
				true);
	}
	...
	public void setRelatingResource(IfcResourceSelect newRelatingResource) {
		eSet(Ifc4Package.Literals.IFC_REL_ASSIGNS_TO_RESOURCE__RELATING_RESOURCE,
				newRelatingResource);
	}
