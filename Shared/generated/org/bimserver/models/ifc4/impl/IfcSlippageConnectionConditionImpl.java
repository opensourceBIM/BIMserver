...
public class IfcSlippageConnectionConditionImpl extends
	...
	public double getSlippageX() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_X,
				true);
	}
	...
	public void setSlippageX(double newSlippageX) {
		eSet(Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_X,
				newSlippageX);
	}
	...
	public String getSlippageXAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_XAS_STRING,
				true);
	}
	...
	public void setSlippageXAsString(String newSlippageXAsString) {
		eSet(Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_XAS_STRING,
	...
	public double getSlippageY() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_Y,
				true);
	}
	...
	public void setSlippageY(double newSlippageY) {
		eSet(Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_Y,
				newSlippageY);
	}
	...
	public String getSlippageYAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_YAS_STRING,
				true);
	}
	...
	public void setSlippageYAsString(String newSlippageYAsString) {
		eSet(Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_YAS_STRING,
	...
	public double getSlippageZ() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_Z,
				true);
	}
	...
	public void setSlippageZ(double newSlippageZ) {
		eSet(Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_Z,
				newSlippageZ);
	}
	...
	public String getSlippageZAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_ZAS_STRING,
				true);
	}
	...
	public void setSlippageZAsString(String newSlippageZAsString) {
		eSet(Ifc4Package.Literals.IFC_SLIPPAGE_CONNECTION_CONDITION__SLIPPAGE_ZAS_STRING,
