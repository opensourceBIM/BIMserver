...
public class IfcCircleHollowProfileDefImpl extends IfcCircleProfileDefImpl
	...
	public double getWallThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS,
				true);
	}
	...
	public void setWallThickness(double newWallThickness) {
		eSet(Ifc4Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS,
				newWallThickness);
	}
	...
	public String getWallThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING,
				true);
	}
	...
	public void setWallThicknessAsString(String newWallThicknessAsString) {
		eSet(Ifc4Package.Literals.IFC_CIRCLE_HOLLOW_PROFILE_DEF__WALL_THICKNESS_AS_STRING,
