 ...
 * @generated
 */
public class IfcTemperatureRateOfChangeMeasureImpl extends IdEObjectImpl
		implements IfcTemperatureRateOfChangeMeasure {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public double getWrappedValue() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_TEMPERATURE_RATE_OF_CHANGE_MEASURE__WRAPPED_VALUE,
				true);
	}
	...
	public void setWrappedValue(double newWrappedValue) {
		eSet(Ifc4Package.Literals.IFC_TEMPERATURE_RATE_OF_CHANGE_MEASURE__WRAPPED_VALUE,
				newWrappedValue);
	}
	...
	public String getWrappedValueAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_TEMPERATURE_RATE_OF_CHANGE_MEASURE__WRAPPED_VALUE_AS_STRING,
				true);
	}
