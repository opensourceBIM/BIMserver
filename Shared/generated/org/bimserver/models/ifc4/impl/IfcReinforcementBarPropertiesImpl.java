 ...
 * @generated
 */
public class IfcReinforcementBarPropertiesImpl extends
		IfcPreDefinedPropertiesImpl implements IfcReinforcementBarProperties {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public double getTotalCrossSectionArea() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__TOTAL_CROSS_SECTION_AREA,
				true);
	}
	...
	public void setTotalCrossSectionArea(double newTotalCrossSectionArea) {
		eSet(Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__TOTAL_CROSS_SECTION_AREA,
	...
	public String getTotalCrossSectionAreaAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__TOTAL_CROSS_SECTION_AREA_AS_STRING,
				true);
	}
	 ...
	 * @generated
	 */
	public void setTotalCrossSectionAreaAsString(
			String newTotalCrossSectionAreaAsString) {
	...
	public String getSteelGrade() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__STEEL_GRADE,
				true);
	}
	...
	public void setSteelGrade(String newSteelGrade) {
		eSet(Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__STEEL_GRADE,
				newSteelGrade);
	}
	...
	public IfcReinforcingBarSurfaceEnum getBarSurface() {
		return (IfcReinforcingBarSurfaceEnum) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__BAR_SURFACE,
				true);
	}
	...
	public void setBarSurface(IfcReinforcingBarSurfaceEnum newBarSurface) {
		eSet(Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__BAR_SURFACE,
				newBarSurface);
	}
	...
	public double getEffectiveDepth() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__EFFECTIVE_DEPTH,
				true);
	}
	...
	public void setEffectiveDepth(double newEffectiveDepth) {
		eSet(Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__EFFECTIVE_DEPTH,
				newEffectiveDepth);
	}
	...
	public String getEffectiveDepthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__EFFECTIVE_DEPTH_AS_STRING,
				true);
	}
	...
	public double getNominalBarDiameter() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__NOMINAL_BAR_DIAMETER,
				true);
	}
	...
	public void setNominalBarDiameter(double newNominalBarDiameter) {
		eSet(Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__NOMINAL_BAR_DIAMETER,
				newNominalBarDiameter);
	}
	...
	public String getNominalBarDiameterAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__NOMINAL_BAR_DIAMETER_AS_STRING,
				true);
	}
	 ...
	 * @generated
	 */
	public void setNominalBarDiameterAsString(
			String newNominalBarDiameterAsString) {
	...
	public double getBarCount() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__BAR_COUNT,
				true);
	}
	...
	public void setBarCount(double newBarCount) {
		eSet(Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__BAR_COUNT,
				newBarCount);
	}
	...
	public String getBarCountAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__BAR_COUNT_AS_STRING,
				true);
	}
	...
	public void setBarCountAsString(String newBarCountAsString) {
		eSet(Ifc4Package.Literals.IFC_REINFORCEMENT_BAR_PROPERTIES__BAR_COUNT_AS_STRING,
				newBarCountAsString);
	}
