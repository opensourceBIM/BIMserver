 ...
 * @generated
 */
public class IfcSubContractResourceTypeImpl extends
		IfcConstructionResourceTypeImpl implements IfcSubContractResourceType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public IfcSubContractResourceTypeEnum getPredefinedType() {
		return (IfcSubContractResourceTypeEnum) eGet(
				Ifc4Package.Literals.IFC_SUB_CONTRACT_RESOURCE_TYPE__PREDEFINED_TYPE,
				true);
	}
	...
	public void setPredefinedType(
			IfcSubContractResourceTypeEnum newPredefinedType) {
		eSet(Ifc4Package.Literals.IFC_SUB_CONTRACT_RESOURCE_TYPE__PREDEFINED_TYPE,
				newPredefinedType);
	}
