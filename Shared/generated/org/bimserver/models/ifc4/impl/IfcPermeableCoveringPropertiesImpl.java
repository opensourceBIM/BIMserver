...
public class IfcPermeableCoveringPropertiesImpl extends
		IfcPreDefinedPropertySetImpl implements IfcPermeableCoveringProperties {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public IfcPermeableCoveringOperationEnum getOperationType() {
		return (IfcPermeableCoveringOperationEnum) eGet(
				Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE,
				true);
	}
	...
	public void setOperationType(
		...
		eSet(Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__OPERATION_TYPE,
				newOperationType);
	}
	...
	public IfcWindowPanelPositionEnum getPanelPosition() {
		return (IfcWindowPanelPositionEnum) eGet(
				Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__PANEL_POSITION,
				true);
	}
	...
	public void setPanelPosition(IfcWindowPanelPositionEnum newPanelPosition) {
		eSet(Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__PANEL_POSITION,
				newPanelPosition);
	}
	...
	public double getFrameDepth() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH,
				true);
	}
	...
	public void setFrameDepth(double newFrameDepth) {
		eSet(Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH,
				newFrameDepth);
	}
	...
	public String getFrameDepthAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING,
				true);
	}
	...
	public void setFrameDepthAsString(String newFrameDepthAsString) {
		eSet(Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_DEPTH_AS_STRING,
	...
	public double getFrameThickness() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS,
				true);
	}
	...
	public void setFrameThickness(double newFrameThickness) {
		eSet(Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS,
				newFrameThickness);
	}
	...
	public String getFrameThicknessAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__FRAME_THICKNESS_AS_STRING,
				true);
	}
	...
	public IfcShapeAspect getShapeAspectStyle() {
		return (IfcShapeAspect) eGet(
				Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE,
				true);
	}
	...
	public void setShapeAspectStyle(IfcShapeAspect newShapeAspectStyle) {
		eSet(Ifc4Package.Literals.IFC_PERMEABLE_COVERING_PROPERTIES__SHAPE_ASPECT_STYLE,
				newShapeAspectStyle);
	}
