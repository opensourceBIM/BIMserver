...
public class IfcCartesianTransformationOperatorImpl extends
	...
	public IfcDirection getAxis1() {
		return (IfcDirection) eGet(
				Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__AXIS1,
				true);
	}
	...
	public void setAxis1(IfcDirection newAxis1) {
		eSet(Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__AXIS1,
				newAxis1);
	}
	...
	public IfcDirection getAxis2() {
		return (IfcDirection) eGet(
				Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__AXIS2,
				true);
	}
	...
	public void setAxis2(IfcDirection newAxis2) {
		eSet(Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__AXIS2,
				newAxis2);
	}
	...
	public IfcCartesianPoint getLocalOrigin() {
		return (IfcCartesianPoint) eGet(
				Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__LOCAL_ORIGIN,
				true);
	}
	...
	public void setLocalOrigin(IfcCartesianPoint newLocalOrigin) {
		eSet(Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__LOCAL_ORIGIN,
				newLocalOrigin);
	}
	...
	public double getScale() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__SCALE,
				true);
	}
	...
	public void setScale(double newScale) {
		eSet(Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__SCALE,
				newScale);
	}
	...
	public String getScaleAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__SCALE_AS_STRING,
				true);
	}
	...
	public void setScaleAsString(String newScaleAsString) {
		eSet(Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__SCALE_AS_STRING,
				newScaleAsString);
	}
	...
	public int getDim() {
		return (Integer) eGet(
				Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__DIM,
				true);
	}
	...
	public void setDim(int newDim) {
		eSet(Ifc4Package.Literals.IFC_CARTESIAN_TRANSFORMATION_OPERATOR__DIM,
				newDim);
	}
