...
public class IfcOffsetCurve2DImpl extends IfcCurveImpl implements
	...
	public IfcCurve getBasisCurve() {
		return (IfcCurve) eGet(
				Ifc4Package.Literals.IFC_OFFSET_CURVE2_D__BASIS_CURVE, true);
	}
	...
	public void setBasisCurve(IfcCurve newBasisCurve) {
		eSet(Ifc4Package.Literals.IFC_OFFSET_CURVE2_D__BASIS_CURVE,
				newBasisCurve);
	}
	...
	public double getDistance() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_OFFSET_CURVE2_D__DISTANCE, true);
	}
	...
	public String getDistanceAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_OFFSET_CURVE2_D__DISTANCE_AS_STRING,
				true);
	}
	...
	public void setDistanceAsString(String newDistanceAsString) {
		eSet(Ifc4Package.Literals.IFC_OFFSET_CURVE2_D__DISTANCE_AS_STRING,
				newDistanceAsString);
	}
	...
	public boolean isSelfIntersect() {
		return (Boolean) eGet(
				Ifc4Package.Literals.IFC_OFFSET_CURVE2_D__SELF_INTERSECT, true);
	}
	...
	public void setSelfIntersect(boolean newSelfIntersect) {
		eSet(Ifc4Package.Literals.IFC_OFFSET_CURVE2_D__SELF_INTERSECT,
				newSelfIntersect);
	}
