 ...
 * @generated
 */
public class IfcDocumentInformationRelationshipImpl extends
	...
	public IfcDocumentInformation getRelatingDocument() {
		return (IfcDocumentInformation) eGet(
				Ifc4Package.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATING_DOCUMENT,
				true);
	}
	...
	public void setRelatingDocument(IfcDocumentInformation newRelatingDocument) {
		eSet(Ifc4Package.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATING_DOCUMENT,
				newRelatingDocument);
	}
	...
	public EList<IfcDocumentInformation> getRelatedDocuments() {
		return (EList<IfcDocumentInformation>) eGet(
				Ifc4Package.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATED_DOCUMENTS,
				true);
	}
	...
	public String getRelationshipType() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATIONSHIP_TYPE,
				true);
	}
	...
	public void setRelationshipType(String newRelationshipType) {
		eSet(Ifc4Package.Literals.IFC_DOCUMENT_INFORMATION_RELATIONSHIP__RELATIONSHIP_TYPE,
				newRelationshipType);
	}
