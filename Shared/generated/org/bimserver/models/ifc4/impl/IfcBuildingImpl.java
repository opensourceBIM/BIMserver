...
public class IfcBuildingImpl extends IfcSpatialStructureElementImpl implements
	...
	public double getElevationOfRefHeight() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT,
				true);
	}
	...
	public void setElevationOfRefHeight(double newElevationOfRefHeight) {
		eSet(Ifc4Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT,
	...
	public String getElevationOfRefHeightAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT_AS_STRING,
				true);
	}
	...
	public void setElevationOfRefHeightAsString(
		...
		eSet(Ifc4Package.Literals.IFC_BUILDING__ELEVATION_OF_REF_HEIGHT_AS_STRING,
	...
	public double getElevationOfTerrain() {
		return (Double) eGet(
				Ifc4Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN, true);
	}
	...
	public void setElevationOfTerrain(double newElevationOfTerrain) {
		eSet(Ifc4Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN,
	...
	public String getElevationOfTerrainAsString() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN_AS_STRING,
				true);
	}
	...
	public void setElevationOfTerrainAsString(
		...
		eSet(Ifc4Package.Literals.IFC_BUILDING__ELEVATION_OF_TERRAIN_AS_STRING,
	...
	public IfcPostalAddress getBuildingAddress() {
		return (IfcPostalAddress) eGet(
				Ifc4Package.Literals.IFC_BUILDING__BUILDING_ADDRESS, true);
	}
	...
	public void setBuildingAddress(IfcPostalAddress newBuildingAddress) {
		eSet(Ifc4Package.Literals.IFC_BUILDING__BUILDING_ADDRESS,
				newBuildingAddress);
	}
