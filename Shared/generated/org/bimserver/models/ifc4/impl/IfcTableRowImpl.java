...
public class IfcTableRowImpl extends IdEObjectImpl implements IfcTableRow {
	...
	public EList<IfcValue> getRowCells() {
		return (EList<IfcValue>) eGet(
				Ifc4Package.Literals.IFC_TABLE_ROW__ROW_CELLS, true);
	}
	...
	public Tristate getIsHeading() {
		return (Tristate) eGet(Ifc4Package.Literals.IFC_TABLE_ROW__IS_HEADING,
				true);
	}
	...
	public IfcTable getOfTable() {
		return (IfcTable) eGet(Ifc4Package.Literals.IFC_TABLE_ROW__OF_TABLE,
				true);
	}
