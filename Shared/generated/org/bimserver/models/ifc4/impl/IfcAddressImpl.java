...
public class IfcAddressImpl extends IdEObjectImpl implements IfcAddress {
	...
	public IfcAddressTypeEnum getPurpose() {
		return (IfcAddressTypeEnum) eGet(
				Ifc4Package.Literals.IFC_ADDRESS__PURPOSE, true);
	}
	...
	public String getDescription() {
		return (String) eGet(Ifc4Package.Literals.IFC_ADDRESS__DESCRIPTION,
				true);
	}
	...
	public String getUserDefinedPurpose() {
		return (String) eGet(
				Ifc4Package.Literals.IFC_ADDRESS__USER_DEFINED_PURPOSE, true);
	}
	...
	public void setUserDefinedPurpose(String newUserDefinedPurpose) {
		eSet(Ifc4Package.Literals.IFC_ADDRESS__USER_DEFINED_PURPOSE,
	...
	public EList<IfcPerson> getOfPerson() {
		return (EList<IfcPerson>) eGet(
				Ifc4Package.Literals.IFC_ADDRESS__OF_PERSON, true);
	}
	...
	public EList<IfcOrganization> getOfOrganization() {
		return (EList<IfcOrganization>) eGet(
				Ifc4Package.Literals.IFC_ADDRESS__OF_ORGANIZATION, true);
	}
